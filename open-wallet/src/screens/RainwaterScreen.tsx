...
export function RainwaterScreen({ onClose }: Props) {
  ...
  const s = useMemo(() => StyleSheet.create({
    ...
    sysName: { color: t.text.primary, fontSize: fonts.md, fontWeight: fonts.bold },
    sysMeta: { color: t.text.muted, fontSize: fonts.sm, marginTop: 4 },
    ...
    levelText: { color: t.text.muted, fontSize: fonts.sm, width: 60, textAlign: 'right' },
