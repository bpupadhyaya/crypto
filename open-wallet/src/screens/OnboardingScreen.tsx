...
export function OnboardingScreen() {
  ...
  const handleDevWallet = async (w: any) => {
    ...
    try {
      ...
      // Always verify the vault matches this wallet's mnemonic.
      // If vault exists with wrong mnemonic (from old session), recreate it.
      ...
      if (alreadyExists) {
        try {
          ...
          if (contents.mnemonic === w.mnemonic) {
            ...
            logMsg('Vault has different mnemonic, recreating...');
          }
        } catch {
          logMsg('Recreating wallet...');
        }
      }
