...
export function DelegationScreen({ onClose }: Props) {
  ...
  const s = useMemo(() => StyleSheet.create({
    ...
    summaryValue: { color: t.accent.green, fontSize: 32, fontWeight: '800', marginTop: 4 },
    ...
    sortChipText: { color: t.text.secondary, fontSize: 12, fontWeight: '600' },
    ...
    validatorName: { color: t.text.primary, fontSize: 15, fontWeight: '700' },
    ...
    delegationName: { color: t.text.primary, fontSize: 15, fontWeight: '700' },
    delegationRow: { flexDirection: 'row', justifyContent: 'space-between', marginTop: 6 },
    delegationLabel: { color: t.text.muted, fontSize: 13 },
    delegationValue: { color: t.text.secondary, fontSize: 13, fontWeight: '600' },
    ...
    countdown: { color: t.accent.orange, fontSize: 14, fontWeight: '700', marginTop: 8 },
    ...
    detailValue: { color: t.text.primary, fontSize: 14, fontWeight: '600' },
    ...
    return (
      <SafeAreaView style={s.container}>
        ...
        <ScrollView>
          ...
          <Text style={{ color: t.accent.orange, fontSize: 13, textAlign: 'center', marginTop: 16, marginHorizontal: 24, lineHeight: 20, fontWeight: '600' }}>
