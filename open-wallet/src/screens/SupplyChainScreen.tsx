...
export function SupplyChainScreen({ onClose }: Props) {
  ...
  const st = useMemo(() => StyleSheet.create({
    ...
    journeyStage: { color: t.text.primary, fontSize: fonts.md, fontWeight: fonts.bold },
    journeyLocation: { color: t.text.secondary, fontSize: fonts.sm, marginTop: 2 },
    journeyHandler: { color: t.text.muted, fontSize: fonts.sm, marginTop: 2 },
    journeyDate: { color: t.text.muted, fontSize: fonts.xs, marginTop: 2 },
    journeyTx: { color: t.accent.blue, fontSize: fonts.xs, marginTop: 2 },
    verifiedBadge: { color: t.accent.green, fontSize: fonts.xs, fontWeight: fonts.bold, marginTop: 2 },
    ...
    certText: { fontSize: fonts.xs, fontWeight: fonts.bold, color: '#fff' },
    ...
    producerName: { color: t.text.primary, fontSize: fonts.lg, fontWeight: fonts.bold, marginBottom: 2 },
    producerLoc: { color: t.text.secondary, fontSize: fonts.sm, marginBottom: 8 },
    certCard: { backgroundColor: t.bg.card, borderRadius: 16, padding: 16, marginBottom: 12 },
    certIcon: { fontSize: fonts.xxxl, marginBottom: 8 },
    certName: { color: t.text.primary, fontSize: fonts.lg, fontWeight: fonts.bold, marginBottom: 4 },
    certDesc: { color: t.text.secondary, fontSize: fonts.sm, lineHeight: 18, marginBottom: 8 },
