...
export function SupplyChainScreen({ onClose }: Props) {
  ...
  const st = useMemo(() => StyleSheet.create({
    ...
    journeyStage: { color: t.text.primary, fontSize: 14, fontWeight: '700' },
    ...
    verifiedBadge: { color: t.accent.green, fontSize: 11, fontWeight: '700', marginTop: 2 },
    ...
    certText: { fontSize: 11, fontWeight: '700', color: '#fff' },
    ...
    producerName: { color: t.text.primary, fontSize: 16, fontWeight: '700', marginBottom: 2 },
    ...
    certName: { color: t.text.primary, fontSize: 16, fontWeight: '700', marginBottom: 4 },
