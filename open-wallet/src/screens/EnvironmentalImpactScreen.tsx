...
export function EnvironmentalImpactScreen({ onClose }: Props) {
  ...
  const s = useMemo(() => StyleSheet.create({
    ...
    scoreValue: { color: t.accent.green, fontSize: 56, fontWeight: fonts.heavy, marginTop: 4 },
    scoreMax: { color: t.text.muted, fontSize: fonts.xl, fontWeight: fonts.semibold },
    scoreRow: { flexDirection: 'row', gap: 32, marginTop: 16 },
    scoreItem: { alignItems: 'center' },
    scoreItemValue: { color: t.text.primary, fontSize: fonts.xxl, fontWeight: fonts.heavy },
    scoreItemLabel: { color: t.text.muted, fontSize: fonts.xs, marginTop: 2 },
    ecoOTKText: { color: t.accent.green, fontSize: fonts.md, fontWeight: fonts.bold, marginTop: 12 },

    // Carbon tracker
    carbonCard: { backgroundColor: t.bg.secondary, borderRadius: 16, padding: 20, marginHorizontal: 20, marginBottom: 16 },
    cardTitle: { color: t.text.primary, fontSize: fonts.lg, fontWeight: fonts.bold, marginBottom: 12 },
    carbonRow: { flexDirection: 'row', justifyContent: 'space-between', paddingVertical: 6 },
    carbonLabel: { color: t.text.muted, fontSize: fonts.sm },
    carbonValue: { color: t.text.primary, fontSize: fonts.sm, fontWeight: fonts.semibold },
    ...
    carbonNetLabel: { color: t.text.primary, fontSize: fonts.md, fontWeight: fonts.bold },
    carbonNetValue: { fontSize: fonts.md, fontWeight: fonts.heavy },
    ...
    zoneInfo: { flex: 1 },
    zoneName: { color: t.text.primary, fontSize: fonts.md, fontWeight: fonts.semibold },
    zoneIssue: { color: t.text.muted, fontSize: fonts.sm, marginTop: 2 },
    zoneScore: { color: t.text.primary, fontSize: fonts.lg, fontWeight: fonts.heavy, marginLeft: 8 },
    ...
    pledgeGoal: { color: t.text.primary, fontSize: fonts.md, fontWeight: fonts.semibold },
    pledgeMeta: { color: t.text.muted, fontSize: fonts.sm, marginTop: 4 },
    ...
    pledgeCommitText: { color: '#fff', fontSize: fonts.sm, fontWeight: fonts.semibold },
    pledgeCommitted: { color: t.accent.green, fontSize: fonts.sm, fontWeight: fonts.semibold, marginTop: 8 },
    ...
    activityOTK: { color: t.accent.green, fontSize: fonts.md, fontWeight: fonts.bold },
    activityCarbon: { color: t.text.muted, fontSize: fonts.xs, marginTop: 2 },
    verifiedBadge: { color: t.accent.green, fontSize: fonts.xs, fontWeight: fonts.semibold, marginTop: 2 },
    ...
    projectName: { color: t.text.primary, fontSize: fonts.lg, fontWeight: fonts.bold },
    projectCategory: { color: t.accent.green, fontSize: fonts.sm, fontWeight: fonts.semibold, marginTop: 4 },
    projectMeta: { color: t.text.muted, fontSize: fonts.sm, marginTop: 4, lineHeight: 18 },
    ...
    projectStat: { color: t.text.muted, fontSize: fonts.sm },
    projectStatBold: { color: t.text.primary, fontWeight: fonts.bold },
    ...
    challengeTitle: { color: t.text.primary, fontSize: fonts.lg, fontWeight: fonts.bold },
    challengeDesc: { color: t.text.muted, fontSize: fonts.sm, marginTop: 4, lineHeight: 19 },
    ...
    challengeReward: { color: t.accent.green, fontSize: fonts.md, fontWeight: fonts.bold },
    challengeDays: { color: t.accent.orange, fontSize: fonts.sm, fontWeight: fonts.semibold },
    challengeParticipants: { color: t.text.muted, fontSize: fonts.sm },
    challengeCategory: { color: t.accent.blue, fontSize: fonts.xs, fontWeight: fonts.semibold, marginTop: 4 },
    ...
    heroSub: { color: t.text.muted, fontSize: fonts.sm, textAlign: 'center', marginTop: 6 },
    ...
    logStatValue: { color: t.text.primary, fontSize: fonts.xl, fontWeight: fonts.heavy },
    logStatLabel: { color: t.text.muted, fontSize: fonts.xs, marginTop: 2 },
  }), [t]);
