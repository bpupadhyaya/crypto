...
export function EnvironmentalImpactScreen({ onClose }: Props) {
  ...
  const s = useMemo(() => StyleSheet.create({
    ...
    scoreMax: { color: t.text.muted, fontSize: 18, fontWeight: fonts.semibold },
    scoreRow: { flexDirection: 'row', gap: 32, marginTop: 16 },
    scoreItem: { alignItems: 'center' },
    scoreItemValue: { color: t.text.primary, fontSize: 22, fontWeight: fonts.heavy },
    scoreItemLabel: { color: t.text.muted, fontSize: 11, marginTop: 2 },
    ecoOTKText: { color: t.accent.green, fontSize: 14, fontWeight: fonts.bold, marginTop: 12 },

    // Carbon tracker
    carbonCard: { backgroundColor: t.bg.secondary, borderRadius: 16, padding: 20, marginHorizontal: 20, marginBottom: 16 },
    cardTitle: { color: t.text.primary, fontSize: 16, fontWeight: fonts.bold, marginBottom: 12 },
    carbonRow: { flexDirection: 'row', justifyContent: 'space-between', paddingVertical: 6 },
    carbonLabel: { color: t.text.muted, fontSize: 13 },
    carbonValue: { color: t.text.primary, fontSize: 13, fontWeight: fonts.semibold },
    ...
    carbonNetLabel: { color: t.text.primary, fontSize: 14, fontWeight: fonts.bold },
    carbonNetValue: { fontSize: 14, fontWeight: fonts.heavy },
    ...
    zoneInfo: { flex: 1 },
    zoneName: { color: t.text.primary, fontSize: 14, fontWeight: fonts.semibold },
    zoneIssue: { color: t.text.muted, fontSize: 12, marginTop: 2 },
    zoneScore: { color: t.text.primary, fontSize: 16, fontWeight: fonts.heavy, marginLeft: 8 },
    ...
    pledgeGoal: { color: t.text.primary, fontSize: 14, fontWeight: fonts.semibold },
    ...
    pledgeCommitText: { color: '#fff', fontSize: 12, fontWeight: fonts.semibold },
    pledgeCommitted: { color: t.accent.green, fontSize: 12, fontWeight: fonts.semibold, marginTop: 8 },
    ...
    activityOTK: { color: t.accent.green, fontSize: 14, fontWeight: fonts.bold },
    activityCarbon: { color: t.text.muted, fontSize: 11, marginTop: 2 },
    verifiedBadge: { color: t.accent.green, fontSize: 11, fontWeight: fonts.semibold, marginTop: 2 },
    ...
    projectName: { color: t.text.primary, fontSize: 16, fontWeight: fonts.bold },
    projectCategory: { color: t.accent.green, fontSize: 12, fontWeight: fonts.semibold, marginTop: 4 },
    ...
    challengeTitle: { color: t.text.primary, fontSize: 16, fontWeight: fonts.bold },
    ...
    challengeReward: { color: t.accent.green, fontSize: 14, fontWeight: fonts.bold },
    challengeDays: { color: t.accent.orange, fontSize: 13, fontWeight: fonts.semibold },
    challengeParticipants: { color: t.text.muted, fontSize: 12 },
    challengeCategory: { color: t.accent.blue, fontSize: 11, fontWeight: fonts.semibold, marginTop: 4 },
    ...
    logStatValue: { color: t.text.primary, fontSize: 18, fontWeight: fonts.heavy },
