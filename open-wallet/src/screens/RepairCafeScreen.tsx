...
export function RepairCafeScreen({ onClose }: Props) {
  ...
  const s = useMemo(() => StyleSheet.create({
    ...
    fixIconText: { color: t.accent.orange, fontSize: 14, fontWeight: '700' },
    fixInfo: { flex: 1 },
    fixName: { color: t.text.primary, fontSize: 14, fontWeight: '600' },
    fixMeta: { color: t.text.muted, fontSize: 12, marginTop: 2 },
    fixStatus: { paddingHorizontal: 10, paddingVertical: 4, borderRadius: 8 },
    fixStatusText: { fontSize: 11, fontWeight: '700' },
    // Volunteers
    ...
    volunteerName: { color: t.text.primary, fontSize: 14, fontWeight: '600', flex: 1 },
    volunteerAvail: { paddingHorizontal: 8, paddingVertical: 3, borderRadius: 6 },
    volunteerAvailText: { fontSize: 10, fontWeight: '700' },
    ...
    volunteerStatText: { color: t.text.muted, fontSize: 12 },
    volunteerStatBold: { color: t.text.primary, fontWeight: '700' },
    registerSection: { backgroundColor: t.accent.green + '08', borderRadius: 16, padding: 20, marginHorizontal: 20, marginBottom: 16 },
    registerTitle: { color: t.text.primary, fontSize: 15, fontWeight: '700', marginBottom: 12 },
    // Guides
