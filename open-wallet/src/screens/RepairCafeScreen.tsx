...
export function RepairCafeScreen({ onClose }: Props) {
  ...
  const s = useMemo(() => StyleSheet.create({
    ...
    eventTypeText: { color: t.accent.blue, fontSize: 11, fontWeight: fonts.semibold },
    eventFooter: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', marginTop: 12 },
    eventReward: { color: t.accent.green, fontSize: 14, fontWeight: fonts.bold },
    eventAttend: { backgroundColor: t.accent.green, paddingHorizontal: 16, paddingVertical: 8, borderRadius: 10 },
    eventAttendText: { color: '#fff', fontSize: 13, fontWeight: fonts.semibold },
    // Fix request
    ...
    fixIconText: { color: t.accent.orange, fontSize: 14, fontWeight: fonts.bold },
    fixInfo: { flex: 1 },
    fixName: { color: t.text.primary, fontSize: 14, fontWeight: fonts.semibold },
    fixMeta: { color: t.text.muted, fontSize: 12, marginTop: 2 },
    fixStatus: { paddingHorizontal: 10, paddingVertical: 4, borderRadius: 8 },
    fixStatusText: { fontSize: 11, fontWeight: fonts.bold },
    // Volunteers
    ...
    volunteerName: { color: t.text.primary, fontSize: 14, fontWeight: fonts.semibold, flex: 1 },
    volunteerAvail: { paddingHorizontal: 8, paddingVertical: 3, borderRadius: 6 },
    volunteerAvailText: { fontSize: 10, fontWeight: fonts.bold },
    ...
    registerTitle: { color: t.text.primary, fontSize: 15, fontWeight: fonts.bold, marginBottom: 12 },
    // Guides
    ...
    guideDifficultyText: { fontSize: 11, fontWeight: fonts.bold },
    ...
    guideOpenText: { color: '#fff', fontSize: 12, fontWeight: fonts.semibold },
