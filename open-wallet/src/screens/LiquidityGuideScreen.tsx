...
export function LiquidityGuideScreen({ onClose }: Props) {
  ...
  const s = useMemo(() => StyleSheet.create({
    ...
    cardTitle: { color: t.text.secondary, fontSize: fonts.md, fontWeight: fonts.heavy, marginBottom: 12 },
    cardBody: { color: t.text.primary, fontSize: fonts.sm, lineHeight: 20 },
    sectionHeader: { color: t.text.secondary, fontSize: fonts.sm, fontWeight: fonts.bold, textTransform: 'uppercase', letterSpacing: 1.5, marginBottom: 10, marginTop: 8 },
    // Calculator
    calcCard: { backgroundColor: t.bg.card, borderRadius: 16, padding: 20, marginBottom: 16 },
    calcLabel: { color: t.text.muted, fontSize: fonts.sm, fontWeight: fonts.semibold, marginBottom: 6, textTransform: 'uppercase', letterSpacing: 1 },
    calcInput: { backgroundColor: t.bg.primary, color: t.text.primary, fontSize: fonts.xl, fontWeight: fonts.bold, padding: 14, borderRadius: 12, marginBottom: 16 },
    calcResult: { alignItems: 'center', paddingVertical: 16, borderTopWidth: 1, borderTopColor: t.border },
    calcResultLabel: { color: t.text.muted, fontSize: fonts.sm, marginBottom: 4 },
    calcResultValue: { fontSize: fonts.xxxl, fontWeight: fonts.heavy },
    ...
    calcRowLabel: { color: t.text.muted, fontSize: fonts.sm },
    calcRowValue: { color: t.text.primary, fontSize: fonts.sm, fontWeight: fonts.semibold },
    // Strategies
    ...
    strategyName: { color: t.text.primary, fontSize: fonts.lg, fontWeight: fonts.heavy, flex: 1 },
    riskBadge: { paddingHorizontal: 10, paddingVertical: 4, borderRadius: 8 },
    riskText: { fontSize: fonts.xs, fontWeight: fonts.heavy, color: t.bg.primary },
    strategyDesc: { color: t.text.primary, fontSize: fonts.sm, lineHeight: 20, marginBottom: 12 },
    strategyMeta: { flexDirection: 'row', justifyContent: 'space-between', marginBottom: 6 },
    strategyMetaLabel: { color: t.text.muted, fontSize: fonts.sm },
    strategyMetaValue: { color: t.text.primary, fontSize: fonts.sm, fontWeight: fonts.semibold },
    // Glossary
    glossaryCard: { backgroundColor: t.bg.card, borderRadius: 16, padding: 20, marginBottom: 12 },
    glossaryTerm: { color: t.accent.green, fontSize: fonts.md, fontWeight: fonts.heavy, marginBottom: 8 },
    glossaryDef: { color: t.text.primary, fontSize: fonts.sm, lineHeight: 20 },
    ...
    tableCell: { flex: 1, color: t.text.primary, fontSize: fonts.sm, textAlign: 'center' },
    tableCellMuted: { flex: 1, color: t.text.muted, fontSize: fonts.sm, textAlign: 'center' },
