...
export function AmbassadorScreen({ onClose }: Props) {
  ...
  const s = useMemo(() => StyleSheet.create({
    ...
    levelTitle: { fontSize: 20, fontWeight: fonts.heavy, marginBottom: 4 },
    ...
    inviteLabel: { color: t.text.muted, fontSize: 11, fontWeight: fonts.semibold, marginBottom: 4 },
    inviteText: { color: t.text.primary, fontSize: 20, fontWeight: fonts.heavy, letterSpacing: 2 },
    ...
    leaderRank: { width: 30, color: t.text.muted, fontSize: 14, fontWeight: fonts.heavy },
    leaderName: { flex: 1, color: t.text.primary, fontSize: 14, fontWeight: fonts.bold },
    leaderBadge: { paddingHorizontal: 8, paddingVertical: 2, borderRadius: 6, marginRight: 8 },
    leaderBadgeText: { fontSize: 11, fontWeight: fonts.bold },
    leaderStats: { color: t.text.secondary, fontSize: 12, fontWeight: fonts.semibold, width: 50, textAlign: 'right' },
    leaderGOTK: { color: t.accent.green, fontSize: 12, fontWeight: fonts.bold, width: 70, textAlign: 'right' },
    // Resources
    talkingCard: { backgroundColor: t.bg.card, borderRadius: 12, padding: 16, marginBottom: 12 },
    talkingTitle: { color: t.text.primary, fontSize: 15, fontWeight: fonts.bold, marginBottom: 6 },
    ...
    levelRowInfo: { flex: 1 },
    levelRowTitle: { fontSize: 14, fontWeight: fonts.bold },
    levelRowReq: { color: t.text.muted, fontSize: 12, marginTop: 2 },
    levelRowRate: { color: t.accent.green, fontSize: 13, fontWeight: fonts.bold },
  }), [t]);
