...
export function AmbassadorScreen({ onClose }: Props) {
  ...
  const s = useMemo(() => StyleSheet.create({
    ...
    levelTitle: { fontSize: fonts.xl, fontWeight: fonts.heavy, marginBottom: 4 },
    levelDesc: { color: t.text.secondary, fontSize: fonts.sm, textAlign: 'center' },
    ...
    progressTitle: { color: t.text.primary, fontSize: fonts.md, fontWeight: fonts.bold, marginBottom: 8 },
    progressBarBg: { height: 8, backgroundColor: t.border, borderRadius: 4, overflow: 'hidden' },
    progressBarFill: { height: 8, borderRadius: 4 },
    progressLabel: { color: t.text.muted, fontSize: fonts.sm, marginTop: 6 },
    ...
    inviteLabel: { color: t.text.muted, fontSize: fonts.xs, fontWeight: fonts.semibold, marginBottom: 4 },
    inviteText: { color: t.text.primary, fontSize: fonts.xl, fontWeight: fonts.heavy, letterSpacing: 2 },
    quote: { color: t.text.secondary, fontSize: fonts.md, fontStyle: 'italic', textAlign: 'center', lineHeight: 22, marginBottom: 24, paddingHorizontal: 12 },
    // Leaderboard
    leaderRow: { flexDirection: 'row', alignItems: 'center', backgroundColor: t.bg.card, borderRadius: 12, padding: 14, marginBottom: 8 },
    leaderRank: { width: 30, color: t.text.muted, fontSize: fonts.md, fontWeight: fonts.heavy },
    leaderName: { flex: 1, color: t.text.primary, fontSize: fonts.md, fontWeight: fonts.bold },
    leaderBadge: { paddingHorizontal: 8, paddingVertical: 2, borderRadius: 6, marginRight: 8 },
    leaderBadgeText: { fontSize: fonts.xs, fontWeight: fonts.bold },
    leaderStats: { color: t.text.secondary, fontSize: fonts.sm, fontWeight: fonts.semibold, width: 50, textAlign: 'right' },
    leaderGOTK: { color: t.accent.green, fontSize: fonts.sm, fontWeight: fonts.bold, width: 70, textAlign: 'right' },
    // Resources
    talkingCard: { backgroundColor: t.bg.card, borderRadius: 12, padding: 16, marginBottom: 12 },
    talkingTitle: { color: t.text.primary, fontSize: fonts.md, fontWeight: fonts.bold, marginBottom: 6 },
    talkingContent: { color: t.text.secondary, fontSize: fonts.md, lineHeight: 22 },
    ...
    levelRowIcon: { fontSize: fonts.xxl },
    levelRowInfo: { flex: 1 },
    levelRowTitle: { fontSize: fonts.md, fontWeight: fonts.bold },
    levelRowReq: { color: t.text.muted, fontSize: fonts.sm, marginTop: 2 },
    levelRowRate: { color: t.accent.green, fontSize: fonts.sm, fontWeight: fonts.bold },
  }), [t]);
