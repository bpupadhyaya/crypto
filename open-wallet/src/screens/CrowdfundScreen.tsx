...
export function CrowdfundScreen({ onClose }: Props) {
  ...
  const s = useMemo(() => StyleSheet.create({
    ...
    campaignTitle: { color: t.text.primary, fontSize: 15, fontWeight: '700' },
    ...
    raisedText: { color: t.accent.green, fontSize: 14, fontWeight: '700' },
    goalText: { color: t.text.muted, fontSize: 12 },
    backersText: { color: t.accent.blue, fontSize: 12, fontWeight: '600', marginTop: 4 },
    ...
    pledgeText: { color: '#fff', fontSize: 13, fontWeight: '600' },
    ...
    backedText: { color: t.accent.green, fontSize: 12, fontWeight: '600' },
    ...
    tierMin: { color: t.accent.purple, fontSize: 12, fontWeight: '600' },
    tierReward: { color: t.text.muted, fontSize: 12, flex: 1, marginLeft: 10 },
    tiersLabel: { color: t.text.primary, fontSize: 13, fontWeight: '700', marginTop: 12, marginBottom: 6 },
    ...
    myPledge: { color: t.accent.blue, fontSize: 12, fontWeight: '600', marginTop: 4 },
    deadlineText: { color: t.accent.orange, fontSize: 12, fontWeight: '600', marginTop: 4 },
  }), [t]);
