...
export function TimelineScreen({ onClose }: Props) {
  ...
  const s = useMemo(() => StyleSheet.create({
    ...
    toggleText: { color: t.text.secondary, fontSize: 13, fontWeight: fonts.bold },
    ...
    timelineDate: { color: t.accent.blue, fontSize: 12, fontWeight: fonts.bold, marginBottom: 4 },
    timelineIcon: { fontSize: 24, marginRight: 8 },
    timelineHeader: { flexDirection: 'row', alignItems: 'center', marginBottom: 6 },
    timelineTitle: { color: t.text.primary, fontSize: 15, fontWeight: fonts.bold, flex: 1 },
    ...
    chainBadgeText: { color: t.accent.green, fontSize: 10, fontWeight: fonts.bold },
    ...
    otkBadgeText: { color: t.accent.orange, fontSize: 10, fontWeight: fonts.bold },
    significanceDot: { width: 8, height: 8, borderRadius: 4, marginRight: 6 },
    yearHeader: { color: t.text.primary, fontSize: 18, fontWeight: fonts.heavy, marginLeft: 24, marginTop: 20, marginBottom: 8 },
    // Add form
    ...
    sigChipLabel: { color: t.text.secondary, fontSize: 12, fontWeight: fonts.bold },
    // Share
    ...
    shareLabel: { color: t.text.primary, fontSize: 15, fontWeight: fonts.semibold },
    ...
    exportTitle: { color: t.text.primary, fontSize: 16, fontWeight: fonts.bold, textAlign: 'center' },
