...
export function TimelineScreen({ onClose }: Props) {
  ...
  const s = useMemo(() => StyleSheet.create({
    ...
    toggleText: { color: t.text.secondary, fontSize: fonts.sm, fontWeight: fonts.bold },
    ...
    timelineDate: { color: t.accent.blue, fontSize: fonts.sm, fontWeight: fonts.bold, marginBottom: 4 },
    timelineIcon: { fontSize: fonts.xxl, marginRight: 8 },
    timelineHeader: { flexDirection: 'row', alignItems: 'center', marginBottom: 6 },
    timelineTitle: { color: t.text.primary, fontSize: fonts.md, fontWeight: fonts.bold, flex: 1 },
    timelineDesc: { color: t.text.secondary, fontSize: fonts.sm, lineHeight: 20 },
    ...
    chainRef: { color: t.text.muted, fontSize: fonts.xs, fontFamily: 'Courier' },
    otkBadge: { backgroundColor: t.accent.orange + '20', paddingHorizontal: 8, paddingVertical: 2, borderRadius: 8, marginLeft: 4 },
    otkBadgeText: { color: t.accent.orange, fontSize: fonts.xs, fontWeight: fonts.bold },
    significanceDot: { width: 8, height: 8, borderRadius: 4, marginRight: 6 },
    yearHeader: { color: t.text.primary, fontSize: fonts.xl, fontWeight: fonts.heavy, marginLeft: 24, marginTop: 20, marginBottom: 8 },
    // Add form
    ...
    sigChipLabel: { color: t.text.secondary, fontSize: fonts.sm, fontWeight: fonts.bold },
    // Share
    ...
    shareLabel: { color: t.text.primary, fontSize: fonts.md, fontWeight: fonts.semibold },
    shareDesc: { color: t.text.muted, fontSize: fonts.sm, marginTop: 2 },
    ...
    exportTitle: { color: t.text.primary, fontSize: fonts.lg, fontWeight: fonts.bold, textAlign: 'center' },
    exportDesc: { color: t.text.muted, fontSize: fonts.sm, textAlign: 'center', marginTop: 6, lineHeight: 20 },
