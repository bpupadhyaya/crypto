...
export function FarmToTableScreen({ onClose }: Props) {
  ...
  const s = useMemo(() => StyleSheet.create({
    ...
    producerName: { color: t.text.primary, fontSize: 16, fontWeight: '700' },
    ...
    iconText: { color: t.accent.green, fontSize: 18, fontWeight: '800' },
    producerRow: { flexDirection: 'row', alignItems: 'center', marginBottom: 12 },
    ratingText: { color: t.accent.orange || '#FF9500', fontSize: 13, fontWeight: '700' },
    ...
    productTagText: { color: t.accent.green, fontSize: 11, fontWeight: '600' },
    ...
    pickupName: { color: t.text.primary, fontSize: 14, fontWeight: '700' },
    ...
    storyProducer: { color: t.accent.green, fontSize: 12, fontWeight: '600', marginTop: 8 },
    ...
    seasonTitle: { color: t.accent.green, fontSize: 14, fontWeight: '700', marginBottom: 8, textTransform: 'capitalize' },
    ...
    cartPrice: { color: t.accent.green, fontSize: 13, fontWeight: '700' },
