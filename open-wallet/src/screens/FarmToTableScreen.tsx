...
export function FarmToTableScreen({ onClose }: Props) {
  ...
  const s = useMemo(() => StyleSheet.create({
    ...
    producerName: { color: t.text.primary, fontSize: fonts.lg, fontWeight: fonts.bold },
    producerType: { color: t.text.muted, fontSize: fonts.sm, textTransform: 'uppercase', letterSpacing: 1 },
    ...
    iconText: { color: t.accent.green, fontSize: fonts.xl, fontWeight: fonts.heavy },
    producerRow: { flexDirection: 'row', alignItems: 'center', marginBottom: 12 },
    ratingText: { color: t.accent.orange || '#FF9500', fontSize: fonts.sm, fontWeight: fonts.bold },
    ...
    productTagText: { color: t.accent.green, fontSize: fonts.xs, fontWeight: fonts.semibold },
    ...
    harvestProduct: { color: t.text.primary, fontSize: fonts.md, fontWeight: fonts.bold },
    harvestProducer: { color: t.text.muted, fontSize: fonts.sm, marginTop: 2 },
    priceText: { color: t.accent.green, fontSize: fonts.lg, fontWeight: fonts.heavy },
    organicBadge: { backgroundColor: '#34C759' + '20', paddingHorizontal: 8, paddingVertical: 2, borderRadius: 8 },
    organicText: { color: '#34C759', fontSize: fonts.xs, fontWeight: fonts.bold },
    addBtn: { backgroundColor: t.accent.green, paddingHorizontal: 16, paddingVertical: 8, borderRadius: 12, marginTop: 10 },
    addBtnText: { color: '#fff', fontSize: fonts.sm, fontWeight: fonts.bold, textAlign: 'center' },
    orderSummary: { backgroundColor: t.accent.green + '10', borderRadius: 16, padding: 16, marginHorizontal: 20, marginBottom: 16 },
    orderTotal: { color: t.accent.green, fontSize: fonts.xxl, fontWeight: fonts.heavy },
    orderLabel: { color: t.text.muted, fontSize: fonts.sm, textTransform: 'uppercase', letterSpacing: 1 },
    ...
    pickupName: { color: t.text.primary, fontSize: fonts.md, fontWeight: fonts.bold },
    pickupAddress: { color: t.text.muted, fontSize: fonts.sm, marginTop: 2 },
    pickupHours: { color: t.accent.blue, fontSize: fonts.sm, marginTop: 4 },
    ...
    placeOrderText: { color: '#fff', fontSize: fonts.lg, fontWeight: fonts.heavy },
    ...
    storyProducer: { color: t.accent.green, fontSize: fonts.sm, fontWeight: fonts.semibold, marginTop: 8 },
    highlightItem: { color: t.text.primary, fontSize: fonts.sm, marginTop: 4, paddingLeft: 8 },
    seasonCard: { backgroundColor: t.accent.green + '10', borderRadius: 16, padding: 16, marginHorizontal: 20, marginBottom: 16 },
    seasonTitle: { color: t.accent.green, fontSize: fonts.md, fontWeight: fonts.bold, marginBottom: 8, textTransform: 'capitalize' },
    seasonItem: { color: t.text.primary, fontSize: fonts.sm, marginLeft: 8, marginBottom: 4 },
    detailBack: { color: t.accent.blue, fontSize: fonts.md, marginHorizontal: 20, marginBottom: 12 },
    detailBio: { color: t.text.primary, fontSize: fonts.md, lineHeight: 22, marginBottom: 12 },
    detailPractices: { color: t.text.muted, fontSize: fonts.sm, fontStyle: 'italic', marginBottom: 8 },
    ...
    cartProduct: { color: t.text.primary, fontSize: fonts.sm },
    cartPrice: { color: t.accent.green, fontSize: fonts.sm, fontWeight: fonts.bold },
