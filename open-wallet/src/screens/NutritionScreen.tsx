...
export function NutritionScreen({ onClose }: Props) {
  ...
  const s = useMemo(() => StyleSheet.create({
    ...
    scoreItemValue: { color: t.text.primary, fontSize: 18, fontWeight: '700' },
    ...
    streakText: { color: t.accent.orange, fontSize: 13, fontWeight: '700' },
    ...
    mealIconText: { color: '#fff', fontSize: 14, fontWeight: '700' },
    mealInfo: { flex: 1 },
    mealName: { color: t.text.primary, fontSize: 14, fontWeight: '600' },
    mealMeta: { color: t.text.muted, fontSize: 12, marginTop: 2 },
    mealCalories: { alignItems: 'flex-end' },
    mealCalText: { color: t.text.primary, fontSize: 16, fontWeight: '800' },
    ...
    planTitle: { color: t.text.primary, fontSize: 15, fontWeight: '700' },
    ...
    planCalories: { color: t.text.primary, fontSize: 13, fontWeight: '600' },
    ...
    planUseBtnText: { color: '#fff', fontSize: 13, fontWeight: '600' },
    guideCard: { backgroundColor: t.bg.secondary, borderRadius: 14, padding: 16, marginHorizontal: 20, marginBottom: 12 },
    guideCategory: { color: t.accent.blue, fontSize: 11, fontWeight: '700', textTransform: 'uppercase', letterSpacing: 1 },
    guideTitle: { color: t.text.primary, fontSize: 15, fontWeight: '700', marginTop: 4 },
    guideSummary: { color: t.text.muted, fontSize: 13, marginTop: 6, lineHeight: 20 },
    guideRead: { color: t.accent.blue, fontSize: 12, fontWeight: '600', marginTop: 8 },
    ...
    teachingText: { color: t.accent.green, fontSize: 11, fontWeight: '700' },
