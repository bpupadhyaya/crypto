...
export function NutritionScreen({ onClose }: Props) {
  ...
  const s = useMemo(() => StyleSheet.create({
    ...
    scoreItemValue: { color: t.text.primary, fontSize: fonts.xl, fontWeight: fonts.bold },
    ...
    streakText: { color: t.accent.orange, fontSize: fonts.sm, fontWeight: fonts.bold },
    ...
    mealIconText: { color: '#fff', fontSize: fonts.md, fontWeight: fonts.bold },
    mealInfo: { flex: 1 },
    mealName: { color: t.text.primary, fontSize: fonts.md, fontWeight: fonts.semibold },
    mealMeta: { color: t.text.muted, fontSize: fonts.sm, marginTop: 2 },
    mealCalories: { alignItems: 'flex-end' },
    mealCalText: { color: t.text.primary, fontSize: fonts.lg, fontWeight: fonts.heavy },
    mealCalLabel: { color: t.text.muted, fontSize: fonts.xs },
    ...
    planTitle: { color: t.text.primary, fontSize: fonts.md, fontWeight: fonts.bold },
    planSource: { color: t.accent.blue, fontSize: fonts.sm, marginTop: 2 },
    planMeals: { marginTop: 10 },
    planMealItem: { color: t.text.muted, fontSize: fonts.sm, marginTop: 4 },
    ...
    planCalories: { color: t.text.primary, fontSize: fonts.sm, fontWeight: fonts.semibold },
    planProduce: { color: t.accent.green, fontSize: fonts.xs },
    planUseBtn: { backgroundColor: t.accent.blue, paddingHorizontal: 14, paddingVertical: 8, borderRadius: 10 },
    planUseBtnText: { color: '#fff', fontSize: fonts.sm, fontWeight: fonts.semibold },
    guideCard: { backgroundColor: t.bg.secondary, borderRadius: 14, padding: 16, marginHorizontal: 20, marginBottom: 12 },
    guideCategory: { color: t.accent.blue, fontSize: fonts.xs, fontWeight: fonts.bold, textTransform: 'uppercase', letterSpacing: 1 },
    guideTitle: { color: t.text.primary, fontSize: fonts.md, fontWeight: fonts.bold, marginTop: 4 },
    guideSummary: { color: t.text.muted, fontSize: fonts.sm, marginTop: 6, lineHeight: 20 },
    guideRead: { color: t.accent.blue, fontSize: fonts.sm, fontWeight: fonts.semibold, marginTop: 8 },
    ...
    teachingText: { color: t.accent.green, fontSize: fonts.xs, fontWeight: fonts.bold },
