...
export function MemorialScreen({ onClose }: Props) {
  ...
  const s = useMemo(() => StyleSheet.create({
    ...
    cardName: { color: t.text.primary, fontSize: 16, fontWeight: fonts.bold, flex: 1 },
    ...
    eventDate: { color: t.accent.blue, fontSize: 13, fontWeight: fonts.semibold, marginTop: 4 },
    ...
    tributeChipLabel: { color: t.text.secondary, fontSize: 12, fontWeight: fonts.semibold },
    ...
    recentLabel: { color: t.text.secondary, fontSize: 11, fontWeight: fonts.bold, textTransform: 'uppercase', letterSpacing: 1, marginBottom: 8 },
    ...
    fundBalance: { color: t.accent.green, fontSize: 28, fontWeight: fonts.heavy },
    ...
    fundStatValue: { color: t.text.primary, fontSize: 20, fontWeight: fonts.heavy },
