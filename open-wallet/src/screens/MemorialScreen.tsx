...
export function MemorialScreen({ onClose }: Props) {
  ...
  const s = useMemo(() => StyleSheet.create({
    ...
    cardName: { color: t.text.primary, fontSize: 16, fontWeight: '700', flex: 1 },
    cardDates: { color: t.text.secondary, fontSize: 12, marginBottom: 6 },
    cardMessage: { color: t.text.primary, fontSize: 14, lineHeight: 22, fontStyle: 'italic' },
    cardMeta: { color: t.text.muted, fontSize: 11, marginTop: 8 },
    cardPhoto: { color: t.text.muted, fontSize: 10, fontFamily: 'Courier', marginTop: 4 },
    ...
    eventDate: { color: t.accent.blue, fontSize: 13, fontWeight: '600', marginTop: 4 },
    eventLocation: { color: t.text.secondary, fontSize: 12, marginTop: 2 },
    eventDesc: { color: t.text.primary, fontSize: 13, lineHeight: 20, marginTop: 8 },
    eventAttendees: { color: t.text.muted, fontSize: 12, marginTop: 8 },
    ...
    tributeChipIcon: { fontSize: 24, marginBottom: 4 },
    tributeChipLabel: { color: t.text.secondary, fontSize: 12, fontWeight: '600' },
    ...
    selectChipText: { color: t.text.secondary, fontSize: 12, fontWeight: '600' },
    ...
    recentLabel: { color: t.text.secondary, fontSize: 11, fontWeight: '700', textTransform: 'uppercase', letterSpacing: 1, marginBottom: 8 },
    recentMessage: { color: t.text.primary, fontSize: 14, lineHeight: 22, fontStyle: 'italic' },
    recentMeta: { color: t.text.muted, fontSize: 12, marginTop: 8 },
    fundCard: { backgroundColor: t.accent.green + '10', borderRadius: 24, padding: 24, marginHorizontal: 20, marginTop: 12, alignItems: 'center' },
    fundBalance: { color: t.accent.green, fontSize: 28, fontWeight: '800' },
    fundLabel: { color: t.text.muted, fontSize: 13, marginTop: 4 },
    ...
    fundStatValue: { color: t.text.primary, fontSize: 20, fontWeight: '800' },
    fundStatLabel: { color: t.text.muted, fontSize: 11, marginTop: 2 },
