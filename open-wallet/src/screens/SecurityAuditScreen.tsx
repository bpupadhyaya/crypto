...
export const SecurityAuditScreen = React.memo(({ onClose }: Props) => {
  ...
  const s = useMemo(() => StyleSheet.create({
    ...
    scoreLabel: { color: t.text.secondary, fontSize: fonts.md, marginTop: 4 },
    sectionTitle: {
    ...
    checkContent: { flex: 1 },
    checkLabel: { color: t.text.primary, fontSize: fonts.md, fontWeight: fonts.semibold },
    checkDesc: { color: t.text.muted, fontSize: fonts.sm, marginTop: 2 },
    checkPoints: { color: t.text.secondary, fontSize: fonts.sm, fontWeight: fonts.semibold },
    ...
    recBullet: { fontSize: fonts.md, marginRight: 10, marginTop: 1 },
    recText: { color: t.text.primary, fontSize: fonts.md, flex: 1, lineHeight: 20 },
    wipeBtn: {
    ...
    wipeBtnText: { color: t.accent.red, fontSize: fonts.lg, fontWeight: fonts.bold },
    wipeWarning: {
      color: t.text.muted, fontSize: fonts.xs, textAlign: 'center',
