...
export function EducationHubScreen({ onClose }: Props) {
  ...
  const s = useMemo(() => StyleSheet.create({
    ...
    milestoneBadge: { fontSize: fonts.xxxl, marginRight: 12 },
    ...
    childName: { color: t.text.primary, fontSize: fonts.md, fontWeight: fonts.bold },
    childEOTK: { color: t.accent.green, fontSize: fonts.sm, fontWeight: fonts.semibold },
    ...
    typeChipText: { color: t.text.secondary, fontSize: fonts.sm },
    typeChipTextActive: { color: t.accent.green, fontWeight: fonts.semibold },
    submitBtn: { backgroundColor: t.accent.green, borderRadius: 14, paddingVertical: 14, alignItems: 'center', marginTop: 12 },
    submitBtnText: { color: t.bg.primary, fontSize: fonts.lg, fontWeight: fonts.bold },
    // Stats
    statsCard: { backgroundColor: t.bg.card, borderRadius: 16, padding: 14, marginBottom: 10 },
    statsRegion: { color: t.text.primary, fontSize: fonts.md, fontWeight: fonts.bold },
    statsRow: { flexDirection: 'row', justifyContent: 'space-between', marginTop: 8 },
    statsItem: { alignItems: 'center', flex: 1 },
    statsValue: { color: t.accent.blue, fontSize: fonts.lg, fontWeight: fonts.heavy },
    statsLabel: { color: t.text.muted, fontSize: fonts.xs, marginTop: 2, textAlign: 'center' },
    ...
    studentUid: { color: t.text.muted, fontSize: fonts.xs, marginTop: 2 },
    studentDetail: { flexDirection: 'row', justifyContent: 'space-between', marginTop: 8 },
    studentDetailText: { color: t.text.secondary, fontSize: fonts.sm },
  }), [t]);
