...
export function EducationHubScreen({ onClose }: Props) {
  ...
  const s = useMemo(() => StyleSheet.create({
    ...
    childName: { color: t.text.primary, fontSize: 15, fontWeight: fonts.bold },
    childEOTK: { color: t.accent.green, fontSize: 13, fontWeight: fonts.semibold },
    ...
    submitBtnText: { color: t.bg.primary, fontSize: 16, fontWeight: fonts.bold },
    // Stats
    statsCard: { backgroundColor: t.bg.card, borderRadius: 16, padding: 14, marginBottom: 10 },
    statsRegion: { color: t.text.primary, fontSize: 14, fontWeight: fonts.bold },
    statsRow: { flexDirection: 'row', justifyContent: 'space-between', marginTop: 8 },
    statsItem: { alignItems: 'center', flex: 1 },
    statsValue: { color: t.accent.blue, fontSize: 16, fontWeight: fonts.heavy },
