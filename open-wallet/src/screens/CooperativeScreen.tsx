...
export function CooperativeScreen({ onClose }: Props) {
  ...
  const s = useMemo(() => StyleSheet.create({
    ...
    filterChipText: { color: t.text.muted, fontSize: fonts.xs, fontWeight: fonts.semibold },
    ...
    cardName: { color: t.text.primary, fontSize: fonts.lg, fontWeight: fonts.bold },
    cardDesc: { color: t.text.secondary, fontSize: fonts.sm, marginTop: 6, lineHeight: 19 },
    typeBadge: { alignSelf: 'flex-start', paddingHorizontal: 10, paddingVertical: 3, borderRadius: 10, marginTop: 8 },
    typeText: { color: '#fff', fontSize: fonts.xs, fontWeight: fonts.bold, textTransform: 'uppercase' },
    cardMeta: { flexDirection: 'row', flexWrap: 'wrap', gap: 12, marginTop: 10 },
    cardMetaItem: { flexDirection: 'row', alignItems: 'center', gap: 4 },
    cardMetaLabel: { color: t.text.muted, fontSize: fonts.xs },
    cardMetaValue: { color: t.text.primary, fontSize: fonts.sm, fontWeight: fonts.bold },
    sectionTitle: { color: t.text.primary, fontSize: fonts.lg, fontWeight: fonts.bold, marginBottom: 12, marginHorizontal: 20 },
    sectionLabel: { color: t.text.secondary, fontSize: fonts.sm, fontWeight: fonts.bold, textTransform: 'uppercase', letterSpacing: 1.5, marginLeft: 20, marginBottom: 8, marginTop: 20 },
    backBtn: { color: t.accent.blue, fontSize: fonts.lg },
    detailHeader: { paddingHorizontal: 20, paddingTop: 8 },
    detailName: { color: t.text.primary, fontSize: fonts.xxl, fontWeight: fonts.heavy },
    detailDesc: { color: t.text.secondary, fontSize: fonts.md, lineHeight: 22, marginTop: 8 },
    detailMeta: { flexDirection: 'row', flexWrap: 'wrap', gap: 12, marginTop: 12 },
    metaItem: { flexDirection: 'row', alignItems: 'center', gap: 4 },
    metaLabel: { color: t.text.muted, fontSize: fonts.xs },
    metaValue: { color: t.text.primary, fontSize: fonts.sm, fontWeight: fonts.bold },
    ...
    detailTabText: { color: t.text.muted, fontSize: fonts.sm, fontWeight: fonts.semibold },
    ...
    teamName: { color: t.text.primary, fontSize: fonts.md, fontWeight: fonts.semibold },
    teamRole: { fontSize: fonts.xs, fontWeight: fonts.bold, textTransform: 'uppercase', letterSpacing: 0.5 },
    teamStats: { color: t.text.muted, fontSize: fonts.xs, marginTop: 2 },
    dividendCard: { backgroundColor: t.bg.secondary, borderRadius: 12, padding: 14, marginHorizontal: 20, marginBottom: 8 },
    dividendPeriod: { color: t.text.primary, fontSize: fonts.md, fontWeight: fonts.bold },
    dividendAmount: { color: t.accent.green, fontSize: fonts.xl, fontWeight: fonts.heavy, marginTop: 4 },
    dividendTotal: { color: t.text.muted, fontSize: fonts.sm, marginTop: 2 },
    dividendStatus: { alignSelf: 'flex-start', paddingHorizontal: 10, paddingVertical: 4, borderRadius: 10, marginTop: 8 },
    dividendStatusText: { color: '#fff', fontSize: fonts.xs, fontWeight: fonts.bold },
    ...
    claimBtnText: { color: '#fff', fontSize: fonts.sm, fontWeight: fonts.bold },
    proposalCard: { backgroundColor: t.bg.secondary, borderRadius: 12, padding: 14, marginHorizontal: 20, marginBottom: 8 },
    proposalTitle: { color: t.text.primary, fontSize: fonts.md, fontWeight: fonts.bold },
    proposalDesc: { color: t.text.secondary, fontSize: fonts.sm, lineHeight: 19, marginTop: 4 },
    proposalMeta: { color: t.text.muted, fontSize: fonts.xs, marginTop: 6 },
    proposalStatusBadge: { alignSelf: 'flex-start', paddingHorizontal: 8, paddingVertical: 3, borderRadius: 8, marginTop: 6 },
    proposalStatusText: { color: '#fff', fontSize: fonts.xs, fontWeight: fonts.bold, textTransform: 'uppercase' },
    ...
    voteLabel: { color: t.text.muted, fontSize: fonts.xs, marginTop: 4 },
    voteRow: { flexDirection: 'row', gap: 10, marginTop: 8 },
    voteBtn: { flex: 1, borderRadius: 10, paddingVertical: 10, alignItems: 'center' },
    voteBtnText: { color: '#fff', fontSize: fonts.sm, fontWeight: fonts.bold },
    resourceCard: { backgroundColor: t.bg.secondary, borderRadius: 12, padding: 14, marginHorizontal: 20, marginBottom: 8 },
    resourceName: { color: t.text.primary, fontSize: fonts.md, fontWeight: fonts.semibold },
    resourceDesc: { color: t.text.muted, fontSize: fonts.sm, marginTop: 4 },
    resourceMeta: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', marginTop: 8 },
    resourceValue: { color: t.text.secondary, fontSize: fonts.sm, fontWeight: fonts.semibold },
    resourceAvail: { fontSize: fonts.xs, fontWeight: fonts.bold, paddingHorizontal: 8, paddingVertical: 3, borderRadius: 8 },
    ...
    checkoutBtnText: { color: '#fff', fontSize: fonts.sm, fontWeight: fonts.bold },
    ...
    govLabel: { color: t.text.secondary, fontSize: fonts.sm, fontWeight: fonts.semibold },
    govValue: { color: t.text.primary, fontSize: fonts.sm, fontWeight: fonts.bold },
    ...
    modelLabel: { color: t.text.primary, fontSize: fonts.md, fontWeight: fonts.semibold },
    modelLabelActive: { color: t.accent.blue },
    modelDesc: { color: t.text.muted, fontSize: fonts.sm, marginTop: 2 },
    ...
    emptyText: { color: t.text.muted, fontSize: fonts.md, textAlign: 'center', marginTop: 40, marginHorizontal: 40, lineHeight: 22 },
    ...
    summaryLabel: { color: t.text.secondary, fontSize: fonts.sm },
    summaryValue: { color: t.text.primary, fontSize: fonts.sm, fontWeight: fonts.bold },
  }), [t]);
