...
export function CooperativeScreen({ onClose }: Props) {
  ...
  const s = useMemo(() => StyleSheet.create({
    ...
    filterChipText: { color: t.text.muted, fontSize: 11, fontWeight: '600' },
    ...
    cardName: { color: t.text.primary, fontSize: 16, fontWeight: '700' },
    ...
    cardMetaValue: { color: t.text.primary, fontSize: 13, fontWeight: '700' },
    sectionTitle: { color: t.text.primary, fontSize: 16, fontWeight: '700', marginBottom: 12, marginHorizontal: 20 },
    sectionLabel: { color: t.text.secondary, fontSize: 12, fontWeight: '700', textTransform: 'uppercase', letterSpacing: 1.5, marginLeft: 20, marginBottom: 8, marginTop: 20 },
    backBtn: { color: t.accent.blue, fontSize: 16 },
    detailHeader: { paddingHorizontal: 20, paddingTop: 8 },
    detailName: { color: t.text.primary, fontSize: 22, fontWeight: '800' },
    ...
    detailTabText: { color: t.text.muted, fontSize: 12, fontWeight: '600' },
    ...
    teamName: { color: t.text.primary, fontSize: 14, fontWeight: '600' },
    teamRole: { fontSize: 11, fontWeight: '700', textTransform: 'uppercase', letterSpacing: 0.5 },
    ...
    dividendPeriod: { color: t.text.primary, fontSize: 14, fontWeight: '700' },
    dividendAmount: { color: t.accent.green, fontSize: 18, fontWeight: '800', marginTop: 4 },
    ...
    dividendStatusText: { color: '#fff', fontSize: 11, fontWeight: '700' },
    ...
    proposalTitle: { color: t.text.primary, fontSize: 14, fontWeight: '700' },
    ...
    proposalStatusText: { color: '#fff', fontSize: 10, fontWeight: '700', textTransform: 'uppercase' },
    ...
    resourceName: { color: t.text.primary, fontSize: 14, fontWeight: '600' },
    ...
    resourceValue: { color: t.text.secondary, fontSize: 12, fontWeight: '600' },
    resourceAvail: { fontSize: 11, fontWeight: '700', paddingHorizontal: 8, paddingVertical: 3, borderRadius: 8 },
    ...
    govLabel: { color: t.text.secondary, fontSize: 13, fontWeight: '600' },
    govValue: { color: t.text.primary, fontSize: 13, fontWeight: '700' },
    ...
    modelLabel: { color: t.text.primary, fontSize: 14, fontWeight: '600' },
    ...
    summaryValue: { color: t.text.primary, fontSize: 13, fontWeight: '700' },
  }), [t]);
