...
export function RewardsScreen({ onClose }: Props) {
  ...
  const s = useMemo(() => StyleSheet.create({
    ...
    section: { color: t.text.secondary, fontSize: 12, fontWeight: '700', textTransform: 'uppercase', letterSpacing: 1.5, marginLeft: 24, marginBottom: 12, marginTop: 20 },
    ...
    channelAmount: { color: t.accent.green, fontSize: 14, fontWeight: '700' },
    ...
    claimBtnText: { color: '#fff', fontSize: 17, fontWeight: '700' },
    ...
    chartTitle: { color: t.text.primary, fontSize: 14, fontWeight: '700', marginBottom: 12 },
    ...
    lifetimeValue: { color: t.text.primary, fontSize: 18, fontWeight: '800' },
