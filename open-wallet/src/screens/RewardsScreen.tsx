...
export function RewardsScreen({ onClose }: Props) {
  ...
  const s = useMemo(() => StyleSheet.create({
    ...
    section: { color: t.text.secondary, fontSize: fonts.sm, fontWeight: fonts.bold, textTransform: 'uppercase', letterSpacing: 1.5, marginLeft: 24, marginBottom: 12, marginTop: 20 },
    ...
    channelAmount: { color: t.accent.green, fontSize: fonts.md, fontWeight: fonts.bold },
    ...
    lifetimeLabel: { color: t.text.secondary, fontSize: fonts.md },
    lifetimeValue: { color: t.text.primary, fontSize: fonts.xl, fontWeight: fonts.heavy },
