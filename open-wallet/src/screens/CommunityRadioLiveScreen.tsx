...
export function CommunityRadioLiveScreen({ onClose }: Props) {
  ...
  const s = useMemo(() => StyleSheet.create({
    ...
    liveBadgeText: { color: '#fff', fontSize: 12, fontWeight: fonts.heavy },
    liveIcon: { fontSize: 48, marginBottom: 12 },
    liveTitle: { color: t.text.primary, fontSize: 20, fontWeight: fonts.heavy, textAlign: 'center', marginBottom: 4 },
    ...
    liveStatNum: { color: t.text.primary, fontSize: 18, fontWeight: fonts.heavy },
    ...
    tuneInText: { color: '#fff', fontSize: 16, fontWeight: fonts.heavy },
    ...
    dayHeader: { color: t.text.primary, fontSize: 14, fontWeight: fonts.bold, marginTop: 12, marginBottom: 8, backgroundColor: t.bg.card, borderRadius: 8, paddingHorizontal: 12, paddingVertical: 6 },
    ...
    scheduleTime: { color: t.accent.blue, fontSize: 13, fontWeight: fonts.bold, width: 70 },
    scheduleIcon: { fontSize: 20 },
    scheduleInfo: { flex: 1 },
    scheduleTitle: { color: t.text.primary, fontSize: 14, fontWeight: fonts.semibold },
    ...
    archiveInfo: { flex: 1 },
    archiveTitle: { color: t.text.primary, fontSize: 14, fontWeight: fonts.bold, marginBottom: 2 },
    ...
    archivePlayText: { color: '#fff', fontSize: 12, fontWeight: fonts.bold },
