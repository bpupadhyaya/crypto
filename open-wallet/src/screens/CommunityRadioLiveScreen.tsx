...
export function CommunityRadioLiveScreen({ onClose }: Props) {
  ...
  const s = useMemo(() => StyleSheet.create({
    ...
    liveBadgeText: { color: '#fff', fontSize: fonts.sm, fontWeight: fonts.heavy },
    liveIcon: { fontSize: 48, marginBottom: 12 },
    liveTitle: { color: t.text.primary, fontSize: fonts.xl, fontWeight: fonts.heavy, textAlign: 'center', marginBottom: 4 },
    liveHost: { color: t.text.secondary, fontSize: fonts.md, marginBottom: 8 },
    liveTopic: { color: t.text.secondary, fontSize: fonts.sm, textAlign: 'center', lineHeight: 20, marginBottom: 12, paddingHorizontal: 10 },
    liveStats: { flexDirection: 'row', gap: 20, marginBottom: 16 },
    liveStat: { alignItems: 'center' },
    liveStatNum: { color: t.text.primary, fontSize: fonts.xl, fontWeight: fonts.heavy },
    liveStatLabel: { color: t.text.muted, fontSize: fonts.xs },
    tuneInBtn: { backgroundColor: '#ef4444', borderRadius: 14, paddingVertical: 14, paddingHorizontal: 40 },
    tuneInText: { color: '#fff', fontSize: fonts.lg, fontWeight: fonts.heavy },
    ...
    noLiveText: { color: t.text.muted, fontSize: fonts.md, textAlign: 'center' },
    sectionTitle: { color: t.text.primary, fontSize: fonts.lg, fontWeight: fonts.heavy, marginBottom: 12 },
    dayHeader: { color: t.text.primary, fontSize: fonts.md, fontWeight: fonts.bold, marginTop: 12, marginBottom: 8, backgroundColor: t.bg.card, borderRadius: 8, paddingHorizontal: 12, paddingVertical: 6 },
    ...
    scheduleTime: { color: t.accent.blue, fontSize: fonts.sm, fontWeight: fonts.bold, width: 70 },
    scheduleIcon: { fontSize: fonts.xl },
    scheduleInfo: { flex: 1 },
    scheduleTitle: { color: t.text.primary, fontSize: fonts.md, fontWeight: fonts.semibold },
    scheduleHost: { color: t.text.muted, fontSize: fonts.sm },
    ...
    archiveIcon: { fontSize: fonts.xxl },
    archiveInfo: { flex: 1 },
    archiveTitle: { color: t.text.primary, fontSize: fonts.md, fontWeight: fonts.bold, marginBottom: 2 },
    archiveMeta: { color: t.text.muted, fontSize: fonts.sm },
    archivePlay: { backgroundColor: t.accent.blue, borderRadius: 8, paddingHorizontal: 12, paddingVertical: 8 },
    archivePlayText: { color: '#fff', fontSize: fonts.sm, fontWeight: fonts.bold },
    archiveListens: { color: t.text.muted, fontSize: fonts.xs, marginTop: 2 },
  }), [t]);
