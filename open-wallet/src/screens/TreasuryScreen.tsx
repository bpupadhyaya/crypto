...
export function TreasuryScreen({ onClose }: Props) {
  ...
  const s = useMemo(() => StyleSheet.create({
    ...
    channelAmount: { color: t.text.secondary, fontSize: fonts.md },
    ...
    distProposal: { color: t.accent.blue, fontSize: fonts.sm, fontWeight: fonts.semibold },
    distDetail: { color: t.text.muted, fontSize: fonts.sm, marginTop: 2 },
  }), [t]);
