...
export function FeedbackScreen({ onClose }: Props) {
  ...
  const s = useMemo(() => StyleSheet.create({
    ...
    commentInput: { backgroundColor: t.bg.primary, borderRadius: 12, padding: 14, color: t.text.primary, fontSize: fonts.md, minHeight: 100, textAlignVertical: 'top' },
    ...
    anonHint: { color: t.text.muted, fontSize: fonts.sm, marginLeft: 24, marginTop: 4 },
    ...
    cardSubtitle: { color: t.text.muted, fontSize: fonts.sm, marginTop: 2 },
    cardBody: { color: t.text.secondary, fontSize: fonts.md, lineHeight: 20, marginTop: 8 },
    ratingBadge: { flexDirection: 'row', alignItems: 'center', gap: 4, marginTop: 6 },
    ratingText: { color: t.text.primary, fontSize: fonts.md, fontWeight: fonts.bold },
    ...
    scoreCount: { color: t.text.muted, fontSize: fonts.sm },
    scoreTrend: { fontSize: fonts.md, fontWeight: fonts.bold },
    ...
    responseLabel: { color: t.accent.blue, fontSize: fonts.xs, fontWeight: fonts.bold, textTransform: 'uppercase', letterSpacing: 1 },
    responseText: { color: t.text.secondary, fontSize: fonts.sm, lineHeight: 20, marginTop: 6 },
    responseMeta: { color: t.text.muted, fontSize: fonts.xs, marginTop: 6 },
          ...
          return (
            <View key={fb.id} style={s.card}>
              ...
              <View style={s.ratingBadge}>
                {[1, 2, 3, 4, 5].map((star) => (
                  <Text key={star} style={{ fontSize: fonts.md, color: star <= fb.rating ? '#eab308' : t.border }}>
                    {'\u2605'}
                  </Text>
                ))}
