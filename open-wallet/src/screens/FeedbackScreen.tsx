...
export function FeedbackScreen({ onClose }: Props) {
  ...
  const s = useMemo(() => StyleSheet.create({
    ...
    categoryLabel: { color: t.text.secondary, fontSize: 13, fontWeight: fonts.semibold },
    ...
    ratingText: { color: t.text.primary, fontSize: 14, fontWeight: fonts.bold },
    ...
    scoreTrend: { fontSize: 14, fontWeight: fonts.bold },
    ...
    responseLabel: { color: t.accent.blue, fontSize: 11, fontWeight: fonts.bold, textTransform: 'uppercase', letterSpacing: 1 },
