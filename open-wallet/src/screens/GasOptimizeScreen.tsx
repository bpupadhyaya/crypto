...
export function GasOptimizeScreen({ onClose }: Props) {
  ...
  const s = useMemo(() => StyleSheet.create({
    ...
    currentGas: { fontSize: 24, fontWeight: fonts.heavy },
    gasUnit: { color: t.text.muted, fontSize: 12 },
    ...
    gasLevelLabel: { color: t.text.muted, fontSize: 11 },
    gasLevelValue: { color: t.text.secondary, fontSize: 14, fontWeight: fonts.semibold, marginTop: 2 },
    updatedText: { color: t.text.muted, fontSize: 11, marginTop: 6 },
    sectionTitle: { color: t.text.primary, fontSize: 16, fontWeight: fonts.bold, paddingHorizontal: 16, marginBottom: 10, marginTop: 8 },
    ...
    chartChainText: { color: t.text.secondary, fontSize: 12 },
    ...
    optimalChain: { color: t.text.primary, fontSize: 15, fontWeight: fonts.bold },
    optimalTime: { color: t.accent.green, fontSize: 14, fontWeight: fonts.semibold, marginTop: 4 },
    optimalGas: { color: t.text.secondary, fontSize: 13, marginTop: 2 },
    optimalSavings: { color: t.accent.blue, fontSize: 12, fontWeight: fonts.semibold, marginTop: 4 },
    batchCard: { backgroundColor: t.bg.card, marginHorizontal: 16, borderRadius: 16, padding: 16, marginBottom: 12 },
    batchDesc: { color: t.text.primary, fontSize: 14, fontWeight: fonts.semibold },
    batchMeta: { color: t.text.secondary, fontSize: 13, marginTop: 4 },
    batchSavings: { color: t.accent.green, fontSize: 14, fontWeight: fonts.bold, marginTop: 6 },
    batchBtn: { backgroundColor: t.accent.green, borderRadius: 10, paddingVertical: 8, alignItems: 'center', marginTop: 10 },
    batchBtnText: { color: '#fff', fontSize: 13, fontWeight: fonts.semibold },
    ...
    alertInfo: { flex: 1 },
    alertChain: { color: t.text.primary, fontSize: 15, fontWeight: fonts.bold },
    alertThreshold: { color: t.text.secondary, fontSize: 13, marginTop: 2 },
    alertDate: { color: t.text.muted, fontSize: 11, marginTop: 4 },
    ...
    addAlertBtnText: { color: '#fff', fontSize: 14, fontWeight: fonts.bold },
