...
export function GasOptimizeScreen({ onClose }: Props) {
  ...
  const s = useMemo(() => StyleSheet.create({
    ...
    currentGas: { fontSize: 24, fontWeight: '800' },
    ...
    gasLevelValue: { color: t.text.secondary, fontSize: 14, fontWeight: '600', marginTop: 2 },
    ...
    chartChainTextActive: { color: '#fff', fontWeight: '600' },
    optimalCard: { backgroundColor: t.bg.card, marginHorizontal: 16, borderRadius: 16, padding: 16, marginBottom: 12 },
    optimalChain: { color: t.text.primary, fontSize: 15, fontWeight: '700' },
    optimalTime: { color: t.accent.green, fontSize: 14, fontWeight: '600', marginTop: 4 },
    optimalGas: { color: t.text.secondary, fontSize: 13, marginTop: 2 },
    optimalSavings: { color: t.accent.blue, fontSize: 12, fontWeight: '600', marginTop: 4 },
    batchCard: { backgroundColor: t.bg.card, marginHorizontal: 16, borderRadius: 16, padding: 16, marginBottom: 12 },
    batchDesc: { color: t.text.primary, fontSize: 14, fontWeight: '600' },
    batchMeta: { color: t.text.secondary, fontSize: 13, marginTop: 4 },
    batchSavings: { color: t.accent.green, fontSize: 14, fontWeight: '700', marginTop: 6 },
    ...
    alertInfo: { flex: 1 },
    alertChain: { color: t.text.primary, fontSize: 15, fontWeight: '700' },
    ...
    addAlertBtnText: { color: '#fff', fontSize: 14, fontWeight: '700' },
