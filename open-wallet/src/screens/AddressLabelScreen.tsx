...
export function AddressLabelScreen({ onClose }: Props) {
  ...
  const st = useMemo(() => StyleSheet.create({
    ...
    labelName: { color: t.text.primary, fontSize: fonts.lg, fontWeight: fonts.bold },
    addressText: { color: t.text.muted, fontSize: fonts.sm, fontFamily: 'Courier', marginTop: 4 },
    chainBadge: { paddingVertical: 2, paddingHorizontal: 8, borderRadius: 8 },
    chainText: { fontSize: fonts.xs, fontWeight: fonts.bold, textTransform: 'uppercase', color: '#fff' },
    metaRow: { flexDirection: 'row', justifyContent: 'space-between', marginTop: 8 },
    metaText: { color: t.text.muted, fontSize: fonts.sm },
    actionRow: { flexDirection: 'row', gap: 16, marginTop: 8 },
    deleteText: { color: t.accent.red, fontSize: fonts.sm },
    editText: { color: t.accent.blue, fontSize: fonts.sm },
    ...
    customText: { color: t.accent.purple, fontSize: fonts.xs, fontWeight: fonts.semibold },
    autoBadge: { paddingVertical: 1, paddingHorizontal: 6, borderRadius: 6, backgroundColor: t.accent.yellow + '20', marginLeft: 8 },
    autoText: { color: t.accent.yellow, fontSize: fonts.xs, fontWeight: fonts.semibold },
  }), [t]);
