...
export function NeighborhoodScreen({ onClose }: Props) {
  ...
  const s = useMemo(() => StyleSheet.create({
    ...
    tabText: { color: t.text.muted, fontSize: 11, fontWeight: '600', marginTop: 2 },
    ...
    heroName: { color: t.text.primary, fontSize: 22, fontWeight: '800', textAlign: 'center' },
    heroMotto: { color: t.accent.blue, fontSize: 14, fontWeight: '600', fontStyle: 'italic', textAlign: 'center', marginTop: 4 },
    heroStats: { flexDirection: 'row', gap: 24, marginTop: 16 },
    heroStat: { alignItems: 'center' },
    heroStatNum: { color: t.text.primary, fontSize: 18, fontWeight: '800' },
    heroStatLabel: { color: t.text.muted, fontSize: 11, marginTop: 2 },
    ...
    cardTitle: { color: t.text.primary, fontSize: 15, fontWeight: '700', marginBottom: 6 },
    cardDesc: { color: t.text.secondary, fontSize: 13, lineHeight: 20 },
    ...
    valueText: { color: t.accent.blue, fontSize: 13, fontWeight: '600' },

    welcomeCard: { backgroundColor: t.accent.green + '10', borderRadius: 16, padding: 20, marginHorizontal: 20, marginBottom: 12 },
    welcomeTitle: { color: t.accent.green, fontSize: 15, fontWeight: '700', marginBottom: 8 },
    welcomeText: { color: t.text.secondary, fontSize: 13, lineHeight: 20 },
    ...
    landmarkIcon: { fontSize: 32 },
    landmarkName: { color: t.text.primary, fontSize: 15, fontWeight: '700' },
    landmarkDesc: { color: t.text.muted, fontSize: 12, marginTop: 2 },
    ...
    scoreOverallNum: { color: t.accent.blue, fontSize: 48, fontWeight: '900' },
    scoreOverallLabel: { color: t.text.muted, fontSize: 13, fontWeight: '600', marginTop: 4 },
    ...
    scoreTrend: { fontSize: 14, fontWeight: '700', marginLeft: 6 },
    ...
    achieveIcon: { fontSize: 36 },
    achieveTitle: { color: t.text.primary, fontSize: 15, fontWeight: '700' },
    achieveDesc: { color: t.text.secondary, fontSize: 12, marginTop: 2, lineHeight: 18 },
    achieveDate: { color: t.text.muted, fontSize: 11, marginTop: 4, fontWeight: '600' },
    ...
    achieveBadgeText: { color: t.accent.purple, fontSize: 11, fontWeight: '700' },
    ...
    goalTitle: { color: t.text.primary, fontSize: 15, fontWeight: '700' },
    goalDesc: { color: t.text.secondary, fontSize: 13, lineHeight: 20, marginBottom: 10 },
    ...
    goalPercent: { color: t.accent.blue, fontSize: 14, fontWeight: '800' },
    goalTarget: { color: t.text.muted, fontSize: 12 },

    emptyCard: { backgroundColor: t.bg.card, borderRadius: 16, padding: 32, marginHorizontal: 20, alignItems: 'center', marginTop: 20 },
    emptyIcon: { fontSize: 48, marginBottom: 12 },
    emptyTitle: { color: t.text.primary, fontSize: 17, fontWeight: '700', marginBottom: 6 },
    ...
    demoBadgeText: { color: t.accent.purple, fontSize: 11, fontWeight: '700' },
  }), [t]);
