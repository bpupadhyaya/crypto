...
export function NeighborhoodScreen({ onClose }: Props) {
  ...
  const s = useMemo(() => StyleSheet.create({
    ...
    heroName: { color: t.text.primary, fontSize: 22, fontWeight: fonts.heavy, textAlign: 'center' },
    heroMotto: { color: t.accent.blue, fontSize: 14, fontWeight: fonts.semibold, fontStyle: 'italic', textAlign: 'center', marginTop: 4 },
    heroStats: { flexDirection: 'row', gap: 24, marginTop: 16 },
    heroStat: { alignItems: 'center' },
    heroStatNum: { color: t.text.primary, fontSize: 18, fontWeight: fonts.heavy },
    ...
    cardTitle: { color: t.text.primary, fontSize: 15, fontWeight: fonts.bold, marginBottom: 6 },
    ...
    valueText: { color: t.accent.blue, fontSize: 13, fontWeight: fonts.semibold },

    welcomeCard: { backgroundColor: t.accent.green + '10', borderRadius: 16, padding: 20, marginHorizontal: 20, marginBottom: 12 },
    welcomeTitle: { color: t.accent.green, fontSize: 15, fontWeight: fonts.bold, marginBottom: 8 },
    ...
    landmarkName: { color: t.text.primary, fontSize: 15, fontWeight: fonts.bold },
    ...
    scoreOverallLabel: { color: t.text.muted, fontSize: 13, fontWeight: fonts.semibold, marginTop: 4 },
    ...
    scoreLabel: { color: t.text.primary, fontSize: 15, fontWeight: fonts.bold },
    scoreNum: { fontSize: 20, fontWeight: fonts.heavy },
    scoreTrend: { fontSize: 14, fontWeight: fonts.bold, marginLeft: 6 },
    ...
    achieveTitle: { color: t.text.primary, fontSize: 15, fontWeight: fonts.bold },
    achieveDesc: { color: t.text.secondary, fontSize: 12, marginTop: 2, lineHeight: 18 },
    achieveDate: { color: t.text.muted, fontSize: 11, marginTop: 4, fontWeight: fonts.semibold },
    ...
    achieveBadgeText: { color: t.accent.purple, fontSize: 11, fontWeight: fonts.bold },
    ...
    goalPercent: { color: t.accent.blue, fontSize: 14, fontWeight: fonts.heavy },
