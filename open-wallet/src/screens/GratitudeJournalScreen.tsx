...
export function GratitudeJournalScreen({ onClose }: Props) {
  ...
  const s = useMemo(() => StyleSheet.create({
    ...
    streakNumber: { color: t.text.primary, fontSize: 28, fontWeight: '800' },
    streakLabel: { color: t.text.muted, fontSize: 11, fontWeight: '600', marginTop: 2, textTransform: 'uppercase', letterSpacing: 1 },
    ...
    inputNumber: { color: t.accent.purple, fontSize: 16, fontWeight: '800', marginRight: 8 },
    ...
    cardDate: { color: t.accent.purple, fontSize: 12, fontWeight: '700', textTransform: 'uppercase', letterSpacing: 1 },
    ...
    linkedText: { color: t.accent.purple, fontSize: 12, fontWeight: '700' },
    ...
    themeLabel: { color: t.text.primary, fontSize: 15, fontWeight: '700' },
    ...
    monthTitle: { color: t.text.primary, fontSize: 16, fontWeight: '800', textAlign: 'center' },
    ...
    monthStatNumber: { color: t.text.primary, fontSize: 22, fontWeight: '800' },
    ...
    communityTitle: { color: t.text.primary, fontSize: 15, fontWeight: '700', marginTop: 8 },
    ...
    communityBtnText: { color: '#fff', fontSize: 14, fontWeight: '700' },
