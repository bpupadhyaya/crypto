...
export function EldercareScreen({ onClose }: Props) {
  ...
  const s = useMemo(() => StyleSheet.create({
    ...
    scoreValue: { color: t.text.primary, fontSize: fonts.xxl, fontWeight: fonts.heavy },
    ...
    levelBadge: { fontSize: fonts.hero },
    levelTitle: { color: t.text.primary, fontSize: fonts.lg, fontWeight: fonts.heavy },
    levelSub: { color: t.text.muted, fontSize: fonts.sm, marginTop: 2 },
    logItem: { backgroundColor: t.bg.card, borderRadius: 14, padding: 14, marginHorizontal: 20, marginTop: 8 },
    logHeader: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center' },
    logType: { color: t.text.primary, fontSize: fonts.md, fontWeight: fonts.bold },
    logDate: { color: t.text.muted, fontSize: fonts.sm },
    logDesc: { color: t.text.secondary, fontSize: fonts.sm, marginTop: 6, lineHeight: 19 },
    logFooter: { flexDirection: 'row', justifyContent: 'space-between', marginTop: 8 },
    logHours: { color: t.accent.blue, fontSize: fonts.sm, fontWeight: fonts.semibold },
    logOTK: { color: t.accent.green, fontSize: fonts.sm, fontWeight: fonts.bold },
    recipientCard: { backgroundColor: t.bg.card, borderRadius: 14, padding: 16, marginHorizontal: 20, marginTop: 8 },
    recipientName: { color: t.text.primary, fontSize: fonts.md, fontWeight: fonts.bold },
    recipientRel: { color: t.text.muted, fontSize: fonts.sm, marginTop: 2 },
    recipientStats: { flexDirection: 'row', gap: 16, marginTop: 8 },
    recipientStat: { color: t.text.secondary, fontSize: fonts.sm },
    ...
    milestoneBadge: { fontSize: fonts.xxxl },
    milestoneTitle: { color: t.text.primary, fontSize: fonts.md, fontWeight: fonts.bold },
    milestoneDesc: { color: t.text.muted, fontSize: fonts.sm, marginTop: 2, lineHeight: 17 },
    ...
    milestoneReward: { color: t.accent.purple, fontSize: fonts.sm, fontWeight: fonts.bold, marginTop: 6 },
    communityStatRow: { flexDirection: 'row', justifyContent: 'space-between', paddingVertical: 8 },
    communityLabel: { color: t.text.secondary, fontSize: fonts.sm },
    communityValue: { color: t.text.primary, fontSize: fonts.sm, fontWeight: fonts.bold },
    ...
    descInput: { backgroundColor: t.bg.primary, borderRadius: 12, padding: 14, color: t.text.primary, fontSize: fonts.md, minHeight: 80, textAlignVertical: 'top' },
    ...
    careChipIcon: { fontSize: fonts.xl, marginBottom: 2 },
    careChipLabel: { color: t.text.secondary, fontSize: fonts.xs, fontWeight: fonts.semibold },
    ...
    logBtnText: { color: '#fff', fontSize: fonts.lg, fontWeight: fonts.bold },
    achievedBadge: { color: t.accent.green, fontSize: fonts.sm, fontWeight: fonts.bold, marginTop: 4 },
  }), [t]);
          ...
          <>
            ...
            {CARE_LEVELS.map(cl => (
              <View key={cl.label} style={[s.card, { flexDirection: 'row', gap: 12, alignItems: 'center' }]}>
                <Text style={{ fontSize: fonts.xxl }}>{cl.badge}</Text>
                <View>
                  <Text style={{ color: t.text.primary, fontSize: fonts.md, fontWeight: fonts.bold }}>{cl.label}</Text>
