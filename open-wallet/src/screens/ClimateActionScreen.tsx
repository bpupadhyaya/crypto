...
export function ClimateActionScreen({ onClose }: Props) {
  ...
  const st = useMemo(() => StyleSheet.create({
    ...
    bigNum: { fontSize: 36, fontWeight: '800', textAlign: 'center', marginBottom: 4 },
    ...
    categoryMeta: { flex: 1 },
    categoryLabel: { color: t.text.primary, fontSize: 14, fontWeight: '600' },
    ...
    pledgePercent: { fontSize: 14, fontWeight: '800', width: 45, textAlign: 'right' },
    ...
    otkReward: { color: t.accent.green, fontSize: 12, fontWeight: '700' },
    offsetCard: { backgroundColor: t.bg.card, borderRadius: 14, padding: 16, marginBottom: 12 },
    offsetName: { color: t.text.primary, fontSize: 15, fontWeight: '700', marginBottom: 4 },
    offsetType: { fontSize: 10, fontWeight: '700', textTransform: 'uppercase', letterSpacing: 1, marginBottom: 6 },
    ...
    offsetBtnText: { color: '#fff', fontSize: 13, fontWeight: '700' },
  }), [t]);
