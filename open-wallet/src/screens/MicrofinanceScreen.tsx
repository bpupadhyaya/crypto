...
export function MicrofinanceScreen({ onClose }: Props) {
  ...
  const st = useMemo(() => StyleSheet.create({
    ...
    memberStatus: { fontSize: fonts.sm, fontWeight: fonts.semibold },
    ...
    loanLabel: { color: t.text.secondary, fontSize: fonts.sm },
    loanValue: { color: t.text.primary, fontSize: fonts.sm, fontWeight: fonts.semibold },
    ...
    loanSelectText: { color: t.text.primary, fontSize: fonts.md, fontWeight: fonts.semibold },
    loanSelectSub: { color: t.text.muted, fontSize: fonts.sm, marginTop: 2 },
