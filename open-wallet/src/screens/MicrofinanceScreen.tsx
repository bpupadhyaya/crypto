...
export function MicrofinanceScreen({ onClose }: Props) {
  ...
  const st = useMemo(() => StyleSheet.create({
    ...
    statNumber: { color: t.text.primary, fontSize: 22, fontWeight: '700' },
    ...
    highlight: { color: t.accent.blue, fontWeight: '700' },
    ...
    loanValue: { color: t.text.primary, fontSize: 13, fontWeight: '600' },
    ...
    loanSelectText: { color: t.text.primary, fontSize: 14, fontWeight: '600' },
