...
export function WeatherScreen({ onClose }: Props) {
  ...
  const st = useMemo(() => StyleSheet.create({
    ...
    detailLabel: { color: t.text.muted, fontSize: 10, fontWeight: fonts.semibold, marginBottom: 2 },
    detailVal: { color: t.text.primary, fontSize: 16, fontWeight: fonts.bold },
    ...
    aqiValue: { fontSize: 36, fontWeight: fonts.heavy, marginBottom: 2 },
    aqiLabel: { fontSize: 14, fontWeight: fonts.bold, marginBottom: 8 },
    ...
    reportReporter: { color: t.text.primary, fontSize: 13, fontWeight: fonts.bold },
    ...
    alertTitle: { color: '#fff', fontSize: 15, fontWeight: fonts.bold, marginBottom: 4 },
    ...
    advisoryCrop: { color: t.text.primary, fontSize: 15, fontWeight: fonts.bold, marginBottom: 2 },
    advisoryText: { color: t.text.secondary, fontSize: 12, lineHeight: 18, marginBottom: 6 },
    advisoryAction: { color: t.text.primary, fontSize: 12, fontWeight: fonts.semibold, lineHeight: 18 },
    ...
    sunTime: { color: t.text.primary, fontSize: 14, fontWeight: fonts.semibold },
