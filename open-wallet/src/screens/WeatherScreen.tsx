...
export function WeatherScreen({ onClose }: Props) {
  ...
  const st = useMemo(() => StyleSheet.create({
    ...
    conditionText: { fontSize: fonts.xl, color: t.text.secondary, textAlign: 'center', marginBottom: 4 },
    conditionIcon: { fontSize: 48, textAlign: 'center', marginBottom: 4 },
    feelsLike: { color: t.text.muted, fontSize: fonts.sm, textAlign: 'center', marginBottom: 16 },
    ...
    detailIcon: { fontSize: fonts.xl, marginBottom: 4 },
    detailLabel: { color: t.text.muted, fontSize: fonts.xs, fontWeight: fonts.semibold, marginBottom: 2 },
    detailVal: { color: t.text.primary, fontSize: fonts.lg, fontWeight: fonts.bold },
    detailUnit: { color: t.text.muted, fontSize: fonts.xs },
    aqiCard: { backgroundColor: t.bg.card, borderRadius: 14, padding: 16, marginBottom: 12, alignItems: 'center' },
    aqiValue: { fontSize: fonts.hero, fontWeight: fonts.heavy, marginBottom: 2 },
    aqiLabel: { fontSize: fonts.md, fontWeight: fonts.bold, marginBottom: 8 },
    aqiRec: { color: t.text.muted, fontSize: fonts.sm, textAlign: 'center', lineHeight: 18 },
    ...
    reportIcon: { fontSize: fonts.xxl },
    reportReporter: { color: t.text.primary, fontSize: fonts.sm, fontWeight: fonts.bold },
    reportTime: { color: t.text.muted, fontSize: fonts.xs },
    reportText: { color: t.text.secondary, fontSize: fonts.sm, lineHeight: 19 },
    reportLocation: { color: t.text.muted, fontSize: fonts.xs, marginTop: 4 },
    alertCard: { borderRadius: 14, padding: 16, marginBottom: 12 },
    alertTitle: { color: '#fff', fontSize: fonts.md, fontWeight: fonts.bold, marginBottom: 4 },
    alertDesc: { color: 'rgba(255,255,255,0.9)', fontSize: fonts.sm, lineHeight: 18, marginBottom: 8 },
    alertMeta: { color: 'rgba(255,255,255,0.7)', fontSize: fonts.xs },
    advisoryCard: { backgroundColor: t.bg.card, borderRadius: 14, padding: 16, marginBottom: 12 },
    advisoryCrop: { color: t.text.primary, fontSize: fonts.md, fontWeight: fonts.bold, marginBottom: 2 },
    advisoryText: { color: t.text.secondary, fontSize: fonts.sm, lineHeight: 18, marginBottom: 6 },
    advisoryAction: { color: t.text.primary, fontSize: fonts.sm, fontWeight: fonts.semibold, lineHeight: 18 },
    ...
    seasonLabel: { color: t.text.muted, fontSize: fonts.xxs, textAlign: 'center', marginTop: 2 },
    ...
    sunIcon: { fontSize: fonts.xxl, marginBottom: 2 },
    sunTime: { color: t.text.primary, fontSize: fonts.md, fontWeight: fonts.semibold },
    sunLabel: { color: t.text.muted, fontSize: fonts.xs },
  }), [t]);
            ...
            <View key={adv.id} style={st.advisoryCard}>
              <View style={st.row}>
                <View style={{ flexDirection: 'row', alignItems: 'center', gap: 8 }}>
                  <Text style={{ fontSize: fonts.xxl }}>{adv.icon}</Text>
