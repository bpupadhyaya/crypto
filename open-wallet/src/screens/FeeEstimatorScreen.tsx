...
export function FeeEstimatorScreen({ onClose }: Props) {
  ...
  const s = useMemo(() => StyleSheet.create({
    ...
    chainText: { color: t.text.muted, fontSize: fonts.sm, fontWeight: fonts.semibold },
    ...
    resultFee: { color: t.accent.green, fontSize: fonts.xxxl, fontWeight: fonts.heavy },
    resultUSD: { color: t.text.muted, fontSize: fonts.md, marginTop: 4 },
    resultMeta: { color: t.text.secondary, fontSize: fonts.sm, marginTop: 8, textAlign: 'center' },
    compareRow: { flexDirection: 'row', alignItems: 'center', paddingVertical: 14, borderBottomColor: t.bg.primary, borderBottomWidth: 1 },
    compareInfo: { flex: 1 },
    compareName: { color: t.text.primary, fontSize: fonts.md, fontWeight: fonts.bold },
    compareMeta: { color: t.text.muted, fontSize: fonts.sm, marginTop: 2 },
    compareRight: { alignItems: 'flex-end' },
    compareFee: { color: t.text.primary, fontSize: fonts.md, fontWeight: fonts.heavy },
    compareUSD: { color: t.text.muted, fontSize: fonts.sm, marginTop: 2 },
    congestionDot: { width: 8, height: 8, borderRadius: 4, marginRight: 6 },
    congestionRow: { flexDirection: 'row', alignItems: 'center', marginTop: 4 },
    congestionText: { fontSize: fonts.xs, fontWeight: fonts.semibold },
    histRow: { flexDirection: 'row', alignItems: 'center', paddingVertical: 12, borderBottomColor: t.bg.primary, borderBottomWidth: 1 },
    histInfo: { flex: 1 },
    histChain: { color: t.text.primary, fontSize: fonts.md, fontWeight: fonts.semibold },
    histMeta: { color: t.text.muted, fontSize: fonts.sm, marginTop: 2 },
    histFee: { color: t.text.secondary, fontSize: fonts.md, fontWeight: fonts.bold },
