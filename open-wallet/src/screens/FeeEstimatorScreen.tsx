...
export function FeeEstimatorScreen({ onClose }: Props) {
  ...
  const s = useMemo(() => StyleSheet.create({
    ...
    chainText: { color: t.text.muted, fontSize: 13, fontWeight: '600' },
    ...
    resultFee: { color: t.accent.green, fontSize: 28, fontWeight: '900' },
    ...
    compareInfo: { flex: 1 },
    compareName: { color: t.text.primary, fontSize: 15, fontWeight: '700' },
    compareMeta: { color: t.text.muted, fontSize: 12, marginTop: 2 },
    compareRight: { alignItems: 'flex-end' },
    compareFee: { color: t.text.primary, fontSize: 15, fontWeight: '800' },
