...
export function TrustNetworkScreen({ onClose }: Props) {
  ...
  const st = useMemo(() => StyleSheet.create({
    ...
    tabText: { color: theme.text.secondary, fontSize: 12, fontWeight: '600' },
    ...
    val: { color: theme.text.secondary, fontSize: 12, fontWeight: '600' },
    ...
    summaryLabel: { color: theme.text.muted, fontSize: 10, fontWeight: '600', textAlign: 'center' },
    nameText: { color: theme.text.primary, fontSize: 15, fontWeight: '700' },
    ...
    filterText: { color: theme.text.secondary, fontSize: 11, fontWeight: '600' },
    filterTextActive: { color: '#fff' },
    statusDot: { width: 8, height: 8, borderRadius: 4, marginRight: 8 },
    claimTitle: { color: theme.text.primary, fontSize: 14, fontWeight: '700', marginBottom: 2 },
    claimDesc: { color: theme.text.secondary, fontSize: 12, lineHeight: 17 },
    candidateScore: { fontSize: 18, fontWeight: '800' },
  }), [theme]);
