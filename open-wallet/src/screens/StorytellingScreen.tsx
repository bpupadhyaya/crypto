...
export function StorytellingScreen({ onClose }: Props) {
  ...
  const s = useMemo(() => StyleSheet.create({
    ...
    catText: { color: t.text.secondary, fontSize: 11, fontWeight: fonts.semibold },
    catTextActive: { color: '#fff' },
    storyCard: { backgroundColor: t.bg.card, borderRadius: 16, padding: 16, marginHorizontal: 20, marginBottom: 12 },
    storyTitle: { color: t.text.primary, fontSize: 16, fontWeight: fonts.bold, marginBottom: 4 },
    storyAuthor: { color: t.accent.blue, fontSize: 13, fontWeight: fonts.semibold, marginBottom: 4 },
    storyCategory: { color: t.accent.purple, fontSize: 11, fontWeight: fonts.bold, textTransform: 'uppercase', letterSpacing: 1, marginBottom: 8 },
    storyBody: { color: t.text.secondary, fontSize: 14, lineHeight: 22, marginBottom: 12 },
    storyMeta: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center' },
    storyMetaText: { color: t.text.muted, fontSize: 12 },
    storyOTK: { color: t.accent.green, fontSize: 13, fontWeight: fonts.bold },
    storyFeatured: { color: t.accent.orange || '#FF9500', fontSize: 11, fontWeight: fonts.bold, marginBottom: 4 },
    ...
    gratitudeBtnText: { color: t.accent.purple, fontSize: 13, fontWeight: fonts.bold },
    tipRow: { flexDirection: 'row', gap: 8, marginTop: 8, alignItems: 'center' },
    tipInput: { flex: 1, backgroundColor: t.bg.primary, borderRadius: 10, padding: 10, color: t.text.primary, fontSize: 14 },
    tipSendBtn: { backgroundColor: t.accent.green, paddingVertical: 10, paddingHorizontal: 16, borderRadius: 10 },
    tipSendText: { color: '#fff', fontSize: 13, fontWeight: fonts.bold },
    // Share tab
    ...
    storyInput: { backgroundColor: t.bg.primary, borderRadius: 12, padding: 14, color: t.text.primary, fontSize: 15, minHeight: 160, textAlignVertical: 'top' },
    ...
    circleTitle: { color: t.text.primary, fontSize: 16, fontWeight: fonts.bold, marginBottom: 4 },
    circleHost: { color: t.accent.blue, fontSize: 13, fontWeight: fonts.semibold, marginBottom: 4 },
    circleTheme: { color: t.text.secondary, fontSize: 13, lineHeight: 20, marginBottom: 8 },
    circleDetail: { color: t.text.muted, fontSize: 12, marginBottom: 2 },
    circleJoinBtn: { backgroundColor: t.accent.green, paddingVertical: 10, borderRadius: 12, alignItems: 'center', marginTop: 10 },
    circleJoinText: { color: '#fff', fontSize: 14, fontWeight: fonts.bold },
    ...
    circleLiveText: { color: '#fff', fontSize: 10, fontWeight: fonts.heavy },
    circleSpots: { color: t.accent.orange || '#FF9500', fontSize: 12, fontWeight: fonts.semibold, marginTop: 4 },
    // Featured tab
    ...
    featuredName: { color: t.text.primary, fontSize: 22, fontWeight: fonts.heavy, marginBottom: 4 },
    featuredWeek: { color: t.accent.purple, fontSize: 12, fontWeight: fonts.bold, textTransform: 'uppercase', letterSpacing: 1.5, marginBottom: 12 },
    featuredBio: { color: t.text.secondary, fontSize: 14, lineHeight: 22, textAlign: 'center', marginBottom: 16 },
    featuredStatsRow: { flexDirection: 'row', gap: 20, marginBottom: 12 },
    featuredStat: { alignItems: 'center' },
    featuredStatValue: { color: t.text.primary, fontSize: 20, fontWeight: fonts.heavy },
    featuredStatLabel: { color: t.text.muted, fontSize: 11, marginTop: 2 },
    featuredCategory: { color: t.accent.purple, fontSize: 13, fontWeight: fonts.bold },
