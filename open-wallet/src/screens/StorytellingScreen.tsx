...
export function StorytellingScreen({ onClose }: Props) {
  ...
  const s = useMemo(() => StyleSheet.create({
    ...
    storyTitle: { color: t.text.primary, fontSize: 16, fontWeight: '700', marginBottom: 4 },
    storyAuthor: { color: t.accent.blue, fontSize: 13, fontWeight: '600', marginBottom: 4 },
    storyCategory: { color: t.accent.purple, fontSize: 11, fontWeight: '700', textTransform: 'uppercase', letterSpacing: 1, marginBottom: 8 },
    ...
    storyOTK: { color: t.accent.green, fontSize: 13, fontWeight: '700' },
    storyFeatured: { color: t.accent.orange || '#FF9500', fontSize: 11, fontWeight: '700', marginBottom: 4 },
    ...
    gratitudeBtnText: { color: t.accent.purple, fontSize: 13, fontWeight: '700' },
    ...
    tipSendText: { color: '#fff', fontSize: 13, fontWeight: '700' },
    // Share tab
    ...
    circleTitle: { color: t.text.primary, fontSize: 16, fontWeight: '700', marginBottom: 4 },
    circleHost: { color: t.accent.blue, fontSize: 13, fontWeight: '600', marginBottom: 4 },
    ...
    circleJoinText: { color: '#fff', fontSize: 14, fontWeight: '700' },
    ...
    circleLiveText: { color: '#fff', fontSize: 10, fontWeight: '800' },
    circleSpots: { color: t.accent.orange || '#FF9500', fontSize: 12, fontWeight: '600', marginTop: 4 },
    // Featured tab
    ...
    featuredName: { color: t.text.primary, fontSize: 22, fontWeight: '800', marginBottom: 4 },
    featuredWeek: { color: t.accent.purple, fontSize: 12, fontWeight: '700', textTransform: 'uppercase', letterSpacing: 1.5, marginBottom: 12 },
    ...
    featuredStatValue: { color: t.text.primary, fontSize: 20, fontWeight: '800' },
    featuredStatLabel: { color: t.text.muted, fontSize: 11, marginTop: 2 },
    featuredCategory: { color: t.accent.purple, fontSize: 13, fontWeight: '700' },
