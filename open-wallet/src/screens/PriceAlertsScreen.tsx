...
export const PriceAlertsScreen = React.memo(({ onClose }: Props) => {
  ...
  const s = useMemo(() => StyleSheet.create({
    ...
    alertInfo: { flex: 1 },
    alertSymbol: { color: t.text.primary, fontSize: fonts.lg, fontWeight: fonts.semibold },
    alertTarget: { color: t.text.secondary, fontSize: fonts.md, marginTop: 2 },
    alertTriggered: { color: t.accent.green, fontSize: fonts.sm, fontWeight: fonts.bold, marginTop: 2 },
    alertActions: { flexDirection: 'row', alignItems: 'center', gap: 12 },
    deleteBtn: { color: t.accent.red, fontSize: fonts.xl, fontWeight: fonts.bold },
