...
export const PriceAlertsScreen = React.memo(({ onClose }: Props) => {
  ...
  const s = useMemo(() => StyleSheet.create({
    ...
    alertInfo: { flex: 1 },
    alertSymbol: { color: t.text.primary, fontSize: 16, fontWeight: fonts.semibold },
    alertTarget: { color: t.text.secondary, fontSize: 14, marginTop: 2 },
    alertTriggered: { color: t.accent.green, fontSize: 12, fontWeight: fonts.bold, marginTop: 2 },
    alertActions: { flexDirection: 'row', alignItems: 'center', gap: 12 },
    deleteBtn: { color: t.accent.red, fontSize: 18, fontWeight: fonts.bold },
