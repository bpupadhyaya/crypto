...
export function SoilScreen({ onClose }: Props) {
  ...
  const s = useMemo(() => StyleSheet.create({
    ...
    iconText: { color: '#fff', fontSize: fonts.lg, fontWeight: fonts.heavy },
    cardInfo: { flex: 1 },
    ...
    cardDesc: { color: t.text.muted, fontSize: fonts.sm, marginTop: 4, lineHeight: 18 },
    ...
    stepNumber: { color: t.accent.green, fontSize: fonts.sm, fontWeight: fonts.heavy, width: 20 },
    stepText: { color: t.text.secondary, fontSize: fonts.sm, flex: 1, lineHeight: 20 },
    ...
    toolText: { color: t.accent.green, fontSize: fonts.xs, fontWeight: fonts.semibold },
    pillRow: { flexDirection: 'row', flexWrap: 'wrap', marginTop: 4 },
    idealRange: { color: t.accent.blue, fontSize: fonts.sm, fontWeight: fonts.semibold, marginTop: 8 },
    ...
    materialText: { color: t.accent.blue, fontSize: fonts.xs, fontWeight: fonts.semibold },
    bestFor: { color: t.text.muted, fontSize: fonts.sm, fontStyle: 'italic', marginTop: 6 },
    ...
    seasonText: { color: t.accent.blue, fontSize: fonts.xs, fontWeight: fonts.semibold },
    ...
    nitrogenText: { color: t.accent.green, fontSize: fonts.xs, fontWeight: fonts.bold },
    cropBenefit: { color: t.text.secondary, fontSize: fonts.sm, marginTop: 6 },
    cropGrowth: { color: t.text.muted, fontSize: fonts.sm, marginTop: 4 },
    workshopCard: { backgroundColor: t.bg.card, borderRadius: 16, padding: 16, marginHorizontal: 20, marginBottom: 10 },
    workshopTitle: { color: t.text.primary, fontSize: fonts.md, fontWeight: fonts.bold },
    workshopInstructor: { color: t.text.secondary, fontSize: fonts.sm, marginTop: 2 },
    ...
    metaText: { color: t.text.secondary, fontSize: fonts.xs, fontWeight: fonts.semibold },
    eotkBadge: { backgroundColor: t.accent.purple + '15', borderRadius: 8, paddingHorizontal: 10, paddingVertical: 4 },
    eotkText: { color: t.accent.purple, fontSize: fonts.xs, fontWeight: fonts.bold },
    ...
    topicText: { color: t.accent.green, fontSize: fonts.xs, fontWeight: fonts.semibold },
    ...
    regenName: { color: t.text.primary, fontSize: fonts.md, fontWeight: fonts.bold },
    regenDesc: { color: t.text.secondary, fontSize: fonts.sm, lineHeight: 20, marginTop: 8 },
    ...
    benefitText: { color: t.accent.green, fontSize: fonts.xs, fontWeight: fonts.semibold },
    ...
    soilMapTitle: { color: t.text.primary, fontSize: fonts.md, fontWeight: fonts.bold, marginTop: 8 },
    soilMapDesc: { color: t.text.muted, fontSize: fonts.sm, textAlign: 'center', marginTop: 4 },
    soilMapBtn: { backgroundColor: t.accent.green, borderRadius: 10, paddingVertical: 10, paddingHorizontal: 24, marginTop: 12 },
    soilMapBtnText: { color: '#fff', fontSize: fonts.sm, fontWeight: fonts.bold },
  ...
  const renderTest = () => (
    <>
      ...
      <View style={s.soilMapCard}>
        <Text style={{ fontSize: fonts.hero }}>M</Text>
          ...
          <View style={s.cropHeader}>
            <View style={{ flexDirection: 'row', alignItems: 'center', gap: 10 }}>
              <View style={[s.iconCircle, { backgroundColor: crop.nitrogenFixer ? t.accent.green : t.accent.blue, width: 40, height: 40, borderRadius: 20 }]}>
                <Text style={[s.iconText, { fontSize: fonts.sm }]}>{crop.icon}</Text>
              </View>
