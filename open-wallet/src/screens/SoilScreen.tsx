...
export function SoilScreen({ onClose }: Props) {
  ...
  const s = useMemo(() => StyleSheet.create({
    ...
    iconText: { color: '#fff', fontSize: 16, fontWeight: fonts.heavy },
    cardInfo: { flex: 1 },
    ...
    difficultyText: { fontSize: 11, fontWeight: fonts.bold, textTransform: 'uppercase' },
    ...
    stepNumber: { color: t.accent.green, fontSize: 13, fontWeight: fonts.heavy, width: 20 },
    ...
    toolText: { color: t.accent.green, fontSize: 11, fontWeight: fonts.semibold },
    pillRow: { flexDirection: 'row', flexWrap: 'wrap', marginTop: 4 },
    idealRange: { color: t.accent.blue, fontSize: 12, fontWeight: fonts.semibold, marginTop: 8 },
    ...
    materialText: { color: t.accent.blue, fontSize: 11, fontWeight: fonts.semibold },
    ...
    cropName: { color: t.text.primary, fontSize: 15, fontWeight: fonts.bold },
    seasonBadge: { backgroundColor: t.accent.blue + '15', borderRadius: 6, paddingHorizontal: 8, paddingVertical: 2 },
    seasonText: { color: t.accent.blue, fontSize: 11, fontWeight: fonts.semibold },
    ...
    nitrogenText: { color: t.accent.green, fontSize: 11, fontWeight: fonts.bold },
    ...
    workshopTitle: { color: t.text.primary, fontSize: 15, fontWeight: fonts.bold },
    ...
    metaText: { color: t.text.secondary, fontSize: 11, fontWeight: fonts.semibold },
    eotkBadge: { backgroundColor: t.accent.purple + '15', borderRadius: 8, paddingHorizontal: 10, paddingVertical: 4 },
    eotkText: { color: t.accent.purple, fontSize: 11, fontWeight: fonts.bold },
    ...
    topicText: { color: t.accent.green, fontSize: 11, fontWeight: fonts.semibold },
    ...
    regenName: { color: t.text.primary, fontSize: 15, fontWeight: fonts.bold },
    ...
    benefitText: { color: t.accent.green, fontSize: 11, fontWeight: fonts.semibold },
    ...
    soilMapTitle: { color: t.text.primary, fontSize: 15, fontWeight: fonts.bold, marginTop: 8 },
    ...
    soilMapBtnText: { color: '#fff', fontSize: 13, fontWeight: fonts.bold },
