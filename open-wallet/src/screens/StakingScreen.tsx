...
export function StakingScreen({ onClose }: Props) {
  ...
  const s = useMemo(() => StyleSheet.create({
    ...
    validatorName: { color: t.text.primary, fontSize: 16, fontWeight: fonts.bold, flex: 1 },
    validatorBadge: { backgroundColor: t.accent.green + '20', paddingHorizontal: 8, paddingVertical: 2, borderRadius: 6 },
    validatorBadgeText: { color: t.accent.green, fontSize: 11, fontWeight: fonts.bold },
    ...
    stakeInputLabel: { color: t.text.secondary, fontSize: 13, fontWeight: fonts.semibold, marginBottom: 8 },
    stakeInput: { backgroundColor: t.bg.primary, borderRadius: 12, padding: 14, color: t.text.primary, fontSize: 18, fontWeight: fonts.bold, textAlign: 'center' },
    ...
    claimBtnText: { color: t.accent.green, fontSize: 13, fontWeight: fonts.bold },
