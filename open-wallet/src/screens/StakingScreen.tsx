...
export function StakingScreen({ onClose }: Props) {
  ...
  const s = useMemo(() => StyleSheet.create({
    ...
    validatorName: { color: t.text.primary, fontSize: fonts.lg, fontWeight: fonts.bold, flex: 1 },
    validatorBadge: { backgroundColor: t.accent.green + '20', paddingHorizontal: 8, paddingVertical: 2, borderRadius: 6 },
    validatorBadgeText: { color: t.accent.green, fontSize: fonts.xs, fontWeight: fonts.bold },
    ...
    validatorValue: { color: t.text.secondary, fontSize: fonts.sm },
    stakeInputCard: { backgroundColor: t.bg.card, borderRadius: 16, padding: 20, marginHorizontal: 20, marginTop: 16 },
    stakeInputLabel: { color: t.text.secondary, fontSize: fonts.sm, fontWeight: fonts.semibold, marginBottom: 8 },
    stakeInput: { backgroundColor: t.bg.primary, borderRadius: 12, padding: 14, color: t.text.primary, fontSize: fonts.xl, fontWeight: fonts.bold, textAlign: 'center' },
    ...
    stakeBtnText: { color: '#fff', fontSize: fonts.lg, fontWeight: fonts.bold },
    positionCard: { backgroundColor: t.bg.card, borderRadius: 16, padding: 16, marginHorizontal: 20, marginBottom: 10 },
    positionName: { color: t.text.primary, fontSize: fonts.md, fontWeight: fonts.bold },
    positionRow: { flexDirection: 'row', justifyContent: 'space-between', marginTop: 6 },
    positionLabel: { color: t.text.muted, fontSize: fonts.sm },
    positionValue: { color: t.text.secondary, fontSize: fonts.sm, fontWeight: fonts.semibold },
    ...
    claimBtnText: { color: t.accent.green, fontSize: fonts.sm, fontWeight: fonts.bold },
