...
export function GovernanceHistoryScreen({ onClose }: Props) {
  ...
  const s = useMemo(() => StyleSheet.create({
    ...
    cardDesc: { color: t.text.secondary, fontSize: fonts.sm, marginTop: 4, lineHeight: 18 },
    ...
    gotkEarned: { color: t.accent.green, fontSize: fonts.sm, fontWeight: fonts.bold, marginTop: 6 },
    ...
    timelineDate: { color: t.text.muted, fontSize: fonts.xs },
    timelineEvent: { color: t.text.primary, fontSize: fonts.md, fontWeight: fonts.semibold, marginTop: 2 },
    timelineDeltas: { flexDirection: 'row', gap: 12, marginTop: 4 },
    deltaText: { fontSize: fonts.sm, fontWeight: fonts.semibold },
