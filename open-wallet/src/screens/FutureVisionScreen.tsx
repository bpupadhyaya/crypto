...
export function FutureVisionScreen({ onClose }: Props) {
  ...
  const styles = useMemo(() => StyleSheet.create({
    ...
    tabText: { fontSize: fonts.sm, color: t.text.secondary },
    ...
    sectionTitle: { fontSize: fonts.lg, fontWeight: fonts.semibold, color: t.text.primary, marginBottom: 8 },
    overallBox: {
    ...
    overallLabel: { fontSize: fonts.md, color: t.text.secondary, marginTop: 4 },
    card: {
      backgroundColor: t.bg.card, borderRadius: 12, padding: 14,
      marginBottom: 12, borderWidth: 1, borderColor: t.border,
    },
    row: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center' },
    value: { fontSize: fonts.md, color: t.text.primary, fontWeight: fonts.semibold },
    label: { fontSize: fonts.sm, color: t.text.secondary },
    desc: { fontSize: fonts.sm, color: t.text.secondary, lineHeight: 18, marginTop: 4 },
    ...
    milestoneText: { fontSize: fonts.xs, color: t.text.primary },
    chipRow: { flexDirection: 'row', flexWrap: 'wrap' },
    contribution: {
      fontSize: fonts.sm, color: t.accent.green, fontWeight: fonts.medium,
    ...
    pledgeName: { fontSize: fonts.md, fontWeight: fonts.semibold, color: t.text.primary },
    pledgeMessage: { fontSize: fonts.sm, color: t.text.primary, lineHeight: 20, marginTop: 4 },
    pledgeDate: { fontSize: fonts.xs, color: t.text.secondary, marginTop: 4 },
    input: {
      borderWidth: 1, borderColor: t.border, borderRadius: 8,
      padding: 10, fontSize: fonts.md, color: t.text.primary, marginBottom: 10,
    ...
    buttonText: { color: '#fff', fontWeight: fonts.semibold, fontSize: fonts.md },
