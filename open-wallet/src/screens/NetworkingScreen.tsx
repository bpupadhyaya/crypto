...
export function NetworkingScreen({ onClose }: Props) {
  ...
  const s = useMemo(() => StyleSheet.create({
    ...
    matchScoreText: { color: t.accent.green, fontSize: 13, fontWeight: '800' },
    ...
    eventType: { color: t.accent.blue, fontSize: 11, fontWeight: '700', textTransform: 'uppercase', letterSpacing: 1 },
    ...
    mentorLink: { color: t.accent.purple, fontSize: 13, fontWeight: '600', marginTop: 12 },
    ...
    editBtnText: { color: t.accent.blue, fontSize: 13, fontWeight: '700' },
  }), [t]);
