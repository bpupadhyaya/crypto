...
export function NetworkingScreen({ onClose }: Props) {
  ...
  const s = useMemo(() => StyleSheet.create({
    ...
    cardSub: { color: t.text.secondary, fontSize: fonts.sm, marginTop: 4 },
    cardMeta: { color: t.text.muted, fontSize: fonts.xs, marginTop: 2 },
    ...
    skillTagText: { fontSize: fonts.xs, fontWeight: fonts.semibold },
    ...
    profileText: { color: t.text.secondary, fontSize: fonts.sm, lineHeight: 20 },
    ...
    matchReason: { color: t.text.muted, fontSize: fonts.sm, fontStyle: 'italic', marginTop: 6, lineHeight: 18 },
    mutualText: { color: t.text.secondary, fontSize: fonts.xs, marginTop: 4 },
    ...
    participantText: { color: t.text.muted, fontSize: fonts.xs, marginTop: 4 },
    eventType: { color: t.accent.blue, fontSize: fonts.xs, fontWeight: fonts.bold, textTransform: 'uppercase', letterSpacing: 1 },
    eventDesc: { color: t.text.secondary, fontSize: fonts.sm, lineHeight: 20, marginTop: 8 },
    proposalStatus: { paddingVertical: 4, paddingHorizontal: 10, borderRadius: 8 },
    interestedText: { color: t.text.secondary, fontSize: fonts.sm, marginTop: 8 },
    mentorLink: { color: t.accent.purple, fontSize: fonts.sm, fontWeight: fonts.semibold, marginTop: 12 },
    ...
    editBtnText: { color: t.accent.blue, fontSize: fonts.sm, fontWeight: fonts.bold },
  }), [t]);
