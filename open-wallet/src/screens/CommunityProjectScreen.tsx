...
export function CommunityProjectScreen({ onClose }: Props) {
  ...
  const s = useMemo(() => StyleSheet.create({
    ...
    categoryTag: { color: t.text.muted, fontSize: 11, fontWeight: '600', textTransform: 'uppercase', letterSpacing: 1, marginTop: 8 },
    ...
    milestoneCheckText: { fontSize: 14, fontWeight: '700' },
    milestoneName: { color: t.text.primary, fontSize: 14, fontWeight: '600', flex: 1 },
    milestoneDesc: { color: t.text.muted, fontSize: 12, marginTop: 4, marginLeft: 34 },
    milestoneReward: { color: t.accent.green, fontSize: 12, fontWeight: '700', marginTop: 4, marginLeft: 34 },
    ...
    activityType: { fontSize: 10, fontWeight: '700', textTransform: 'uppercase', letterSpacing: 1, marginBottom: 4 },
    ...
    impactValue: { color: t.text.primary, fontSize: 24, fontWeight: '900' },
    ...
    catChipText: { color: t.text.muted, fontSize: 13, fontWeight: '600' },
