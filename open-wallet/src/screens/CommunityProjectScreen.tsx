...
export function CommunityProjectScreen({ onClose }: Props) {
  ...
  const s = useMemo(() => StyleSheet.create({
    ...
    categoryTag: { color: t.text.muted, fontSize: fonts.xs, fontWeight: fonts.semibold, textTransform: 'uppercase', letterSpacing: 1, marginTop: 8 },
    progressBar: { height: 6, backgroundColor: t.border, borderRadius: 3, marginTop: 10 },
    progressFill: { height: 6, borderRadius: 3 },
    progressLabel: { color: t.text.muted, fontSize: fonts.xs, marginTop: 4 },
    ...
    milestoneCheckText: { fontSize: fonts.md, fontWeight: fonts.bold },
    milestoneName: { color: t.text.primary, fontSize: fonts.md, fontWeight: fonts.semibold, flex: 1 },
    milestoneDesc: { color: t.text.muted, fontSize: fonts.sm, marginTop: 4, marginLeft: 34 },
    milestoneReward: { color: t.accent.green, fontSize: fonts.sm, fontWeight: fonts.bold, marginTop: 4, marginLeft: 34 },
    ...
    activityType: { fontSize: fonts.xs, fontWeight: fonts.bold, textTransform: 'uppercase', letterSpacing: 1, marginBottom: 4 },
    activityDesc: { color: t.text.primary, fontSize: fonts.sm, lineHeight: 19 },
    activityMeta: { color: t.text.muted, fontSize: fonts.xs, marginTop: 4 },
    ...
    impactLabel: { color: t.text.muted, fontSize: fonts.xs, marginTop: 4, textAlign: 'center' },
    ...
    catChipText: { color: t.text.muted, fontSize: fonts.sm, fontWeight: fonts.semibold },
    ...
    fundInput: { backgroundColor: t.bg.primary, borderRadius: 12, padding: 12, color: t.text.primary, fontSize: fonts.md, flex: 1 },
        ...
        <ScrollView contentContainerStyle={s.scroll}>
          ...
          <View style={[s.card, { marginTop: 0 }]}>
            <View style={{ flexDirection: 'row', justifyContent: 'space-between' }}>
              <Text style={[s.metaValue, { fontSize: fonts.xl }]}>{proj.fundingRaised.toLocaleString()} OTK</Text>
