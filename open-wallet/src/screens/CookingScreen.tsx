...
export function CookingScreen({ onClose }: Props) {
  ...
  const s = useMemo(() => StyleSheet.create({
    ...
    recipeTitle: { color: t.text.primary, fontSize: 15, fontWeight: fonts.bold },
    ...
    recipeSectionLabel: { color: t.text.primary, fontSize: 13, fontWeight: fonts.bold, marginBottom: 6, textTransform: 'uppercase', letterSpacing: 1 },
    ...
    attendingText: { color: t.accent.orange, fontSize: 13, fontWeight: fonts.semibold },
    virtualBadge: { backgroundColor: t.accent.blue + '20', paddingHorizontal: 8, paddingVertical: 2, borderRadius: 8 },
    virtualText: { color: t.accent.blue, fontSize: 10, fontWeight: fonts.bold },
    ...
    storyRecipe: { color: t.accent.orange, fontSize: 14, fontWeight: fonts.bold },
    ...
    ingredientName: { color: t.text.primary, fontSize: 14, fontWeight: fonts.semibold },
    ingredientQty: { color: t.accent.green, fontSize: 13, fontWeight: fonts.semibold, marginTop: 2 },
    ...
    chefName: { color: t.text.primary, fontSize: 20, fontWeight: fonts.heavy, marginTop: 8 },
    chefSpecialty: { color: t.accent.orange, fontSize: 13, fontWeight: fonts.semibold, marginTop: 2 },
    ...
    chefStatValue: { color: t.text.primary, fontSize: 20, fontWeight: fonts.heavy },
