...
export function CookingScreen({ onClose }: Props) {
  ...
  const s = useMemo(() => StyleSheet.create({
    ...
    filterText: { color: t.text.muted, fontSize: 11, fontWeight: '600' },
    ...
    recipeTitle: { color: t.text.primary, fontSize: 15, fontWeight: '700' },
    recipeMeta: { color: t.text.muted, fontSize: 12, marginTop: 4 },
    diffBadge: { paddingHorizontal: 8, paddingVertical: 2, borderRadius: 8, alignSelf: 'flex-start', marginTop: 6 },
    diffText: { color: '#fff', fontSize: 10, fontWeight: '700', textTransform: 'uppercase' },
    recipeStats: { flexDirection: 'row', gap: 16, marginTop: 8 },
    recipeStat: { color: t.text.muted, fontSize: 12 },
    recipeSection: { marginTop: 12 },
    recipeSectionLabel: { color: t.text.primary, fontSize: 13, fontWeight: '700', marginBottom: 6, textTransform: 'uppercase', letterSpacing: 1 },
    ingredientText: { color: t.text.secondary, fontSize: 13, lineHeight: 22 },
    stepText: { color: t.text.secondary, fontSize: 13, lineHeight: 22, marginBottom: 4 },
    ...
    attendingText: { color: t.accent.orange, fontSize: 13, fontWeight: '600' },
    virtualBadge: { backgroundColor: t.accent.blue + '20', paddingHorizontal: 8, paddingVertical: 2, borderRadius: 8 },
    virtualText: { color: t.accent.blue, fontSize: 10, fontWeight: '700' },
    ...
    storyRecipe: { color: t.accent.orange, fontSize: 14, fontWeight: '700' },
    storyOrigin: { color: t.text.muted, fontSize: 12, marginTop: 2 },
    storyText: { color: t.text.secondary, fontSize: 13, marginTop: 8, lineHeight: 22 },
    storyAuthor: { color: t.text.muted, fontSize: 11, marginTop: 8, fontStyle: 'italic' },
    ingredientCard: { backgroundColor: t.bg.secondary, borderRadius: 14, padding: 16, marginHorizontal: 20, marginBottom: 12 },
    ingredientName: { color: t.text.primary, fontSize: 14, fontWeight: '600' },
    ingredientQty: { color: t.accent.green, fontSize: 13, fontWeight: '600', marginTop: 2 },
    ingredientLocation: { color: t.text.muted, fontSize: 12, marginTop: 4 },
    ...
    chefName: { color: t.text.primary, fontSize: 20, fontWeight: '800', marginTop: 8 },
    chefSpecialty: { color: t.accent.orange, fontSize: 13, fontWeight: '600', marginTop: 2 },
    chefBio: { color: t.text.secondary, fontSize: 13, textAlign: 'center', marginTop: 10, lineHeight: 20 },
    chefStats: { flexDirection: 'row', gap: 24, marginTop: 12 },
    chefStatItem: { alignItems: 'center' },
    chefStatValue: { color: t.text.primary, fontSize: 20, fontWeight: '800' },
    chefStatLabel: { color: t.text.muted, fontSize: 11, marginTop: 2 },
    chefSignature: { color: t.text.muted, fontSize: 12, marginTop: 10, fontStyle: 'italic' },
