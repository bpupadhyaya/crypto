...
export function DebateScreen({ onClose }: Props) {
  ...
  const s = useMemo(() => StyleSheet.create({
    ...
    outlineBtnText: { color: t.accent.purple, fontSize: 14, fontWeight: fonts.bold },
    ...
    positionLabel: { color: t.accent.purple, fontSize: 13, fontWeight: fonts.bold, textAlign: 'center', marginBottom: 4 },
    ...
    formatStepName: { color: t.text.primary, fontSize: 14, fontWeight: fonts.semibold, flex: 1 },
    ...
    guidelineNumber: { color: t.accent.purple, fontSize: 24, fontWeight: fonts.heavy, marginBottom: 4 },
    guidelineTitle: { color: t.text.primary, fontSize: 15, fontWeight: fonts.bold, marginBottom: 4 },
    ...
    outcomeLabel: { color: t.accent.purple, fontSize: 12, fontWeight: fonts.bold, textTransform: 'uppercase', letterSpacing: 1, marginBottom: 6 },
    ...
    voteCount: { color: t.text.muted, fontSize: 13, fontWeight: fonts.semibold },
    gotkBadge: { backgroundColor: '#f59e0b20', borderRadius: 8, paddingHorizontal: 10, paddingVertical: 4 },
    gotkText: { color: '#f59e0b', fontSize: 12, fontWeight: fonts.bold },
