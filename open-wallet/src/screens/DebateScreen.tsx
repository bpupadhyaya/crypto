...
export function DebateScreen({ onClose }: Props) {
  ...
  const s = useMemo(() => StyleSheet.create({
    ...
    tabLabel: { color: t.text.secondary, fontSize: fonts.xs, fontWeight: fonts.semibold, marginTop: 2 },
    ...
    cardSubtitle: { color: t.accent.purple, fontSize: fonts.sm, fontWeight: fonts.semibold, marginBottom: 6 },
    cardDesc: { color: t.text.secondary, fontSize: fonts.sm, lineHeight: 20, marginBottom: 10 },
    ...
    metaText: { color: t.text.muted, fontSize: fonts.sm, fontWeight: fonts.semibold },
    ...
    secondaryBtnText: { color: t.accent.purple, fontSize: fonts.md, fontWeight: fonts.bold },
    outlineBtn: { borderWidth: 1, borderColor: t.accent.purple, borderRadius: 12, paddingVertical: 12, alignItems: 'center', marginTop: 4 },
    outlineBtnText: { color: t.accent.purple, fontSize: fonts.md, fontWeight: fonts.bold },
    ...
    positionLabel: { color: t.accent.purple, fontSize: fonts.sm, fontWeight: fonts.bold, textAlign: 'center', marginBottom: 4 },
    positionAdvocate: { color: t.text.secondary, fontSize: fonts.sm, textAlign: 'center' },
    ...
    formatIcon: { fontSize: fonts.xxl, marginRight: 12 },
    formatStepName: { color: t.text.primary, fontSize: fonts.md, fontWeight: fonts.semibold, flex: 1 },
    formatStepDuration: { color: t.text.muted, fontSize: fonts.sm },
    guidelineCard: { backgroundColor: t.bg.card, borderRadius: 16, padding: 16, marginHorizontal: 20, marginBottom: 12 },
    guidelineNumber: { color: t.accent.purple, fontSize: fonts.xxl, fontWeight: fonts.heavy, marginBottom: 4 },
    guidelineTitle: { color: t.text.primary, fontSize: fonts.md, fontWeight: fonts.bold, marginBottom: 4 },
    guidelineDesc: { color: t.text.secondary, fontSize: fonts.sm, lineHeight: 20 },
    outcomeCard: { backgroundColor: t.accent.purple + '10', borderRadius: 12, padding: 14, marginTop: 8, marginBottom: 8 },
    outcomeLabel: { color: t.accent.purple, fontSize: fonts.sm, fontWeight: fonts.bold, textTransform: 'uppercase', letterSpacing: 1, marginBottom: 6 },
    outcomeText: { color: t.text.primary, fontSize: fonts.sm, lineHeight: 20 },
    takeawayItem: { flexDirection: 'row', marginBottom: 6, paddingRight: 16 },
    takeawayBullet: { color: t.accent.purple, fontSize: fonts.md, marginRight: 8, marginTop: 1 },
    takeawayText: { color: t.text.secondary, fontSize: fonts.sm, lineHeight: 20, flex: 1 },
    voteRow: { flexDirection: 'row', alignItems: 'center', gap: 12, marginTop: 8 },
    voteCount: { color: t.text.muted, fontSize: fonts.sm, fontWeight: fonts.semibold },
    gotkBadge: { backgroundColor: '#f59e0b20', borderRadius: 8, paddingHorizontal: 10, paddingVertical: 4 },
    gotkText: { color: '#f59e0b', fontSize: fonts.sm, fontWeight: fonts.bold },
    statusBadge: { borderRadius: 8, paddingHorizontal: 10, paddingVertical: 4 },
    statusUpcoming: { backgroundColor: '#3b82f620' },
    statusLive: { backgroundColor: '#22c55e20' },
    statusText: { fontSize: fonts.sm, fontWeight: fonts.bold },
