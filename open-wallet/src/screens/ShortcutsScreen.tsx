...
export function ShortcutsScreen({ onClose }: Props) {
  ...
  const st = useMemo(() => StyleSheet.create({
    ...
    section: { color: t.text.secondary, fontSize: 12, fontWeight: fonts.bold, textTransform: 'uppercase', letterSpacing: 1.5, marginTop: 16, marginBottom: 10, marginLeft: 4 },
    ...
    gridLabel: { color: t.text.primary, fontSize: 11, fontWeight: fonts.semibold, textAlign: 'center' },
    ...
    listContent: { flex: 1 },
    listLabel: { color: t.text.primary, fontSize: 14, fontWeight: fonts.semibold },
    ...
    catHeaderText: { color: t.text.primary, fontSize: 15, fontWeight: fonts.bold },
    ...
    suggestLabel: { color: t.text.primary, fontSize: 14, fontWeight: fonts.bold },
    ...
    resetText: { color: '#FF3B30', fontSize: 14, fontWeight: fonts.bold },
    ...
    alreadyAdded: { color: t.text.muted, fontSize: 11, fontWeight: fonts.semibold },
  }), [t]);
