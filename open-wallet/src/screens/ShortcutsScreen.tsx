...
export function ShortcutsScreen({ onClose }: Props) {
  ...
  const st = useMemo(() => StyleSheet.create({
    ...
    section: { color: t.text.secondary, fontSize: fonts.sm, fontWeight: fonts.bold, textTransform: 'uppercase', letterSpacing: 1.5, marginTop: 16, marginBottom: 10, marginLeft: 4 },
    ...
    gridIcon: { fontSize: fonts.xxxl, marginBottom: 6 },
    gridLabel: { color: t.text.primary, fontSize: fonts.xs, fontWeight: fonts.semibold, textAlign: 'center' },
    listItem: { flexDirection: 'row', alignItems: 'center', backgroundColor: t.bg.card, borderRadius: 12, padding: 12, marginBottom: 8, gap: 12 },
    listIcon: { fontSize: fonts.xxl },
    listContent: { flex: 1 },
    listLabel: { color: t.text.primary, fontSize: fonts.md, fontWeight: fonts.semibold },
    listCategory: { color: t.text.muted, fontSize: fonts.xs, marginTop: 2 },
    ...
    catHeaderText: { color: t.text.primary, fontSize: fonts.md, fontWeight: fonts.bold },
    catChevron: { color: t.text.muted, fontSize: fonts.lg },
    ...
    suggestIcon: { fontSize: fonts.xxxl },
    suggestContent: { flex: 1 },
    suggestLabel: { color: t.text.primary, fontSize: fonts.md, fontWeight: fonts.bold },
    suggestReason: { color: t.text.secondary, fontSize: fonts.sm, marginTop: 2 },
    suggestUsage: { color: t.text.muted, fontSize: fonts.xs, marginTop: 2 },
    ...
    resetText: { color: '#FF3B30', fontSize: fonts.md, fontWeight: fonts.bold },
    countText: { color: t.text.muted, fontSize: fonts.sm, textAlign: 'center', marginBottom: 12 },
    ...
    alreadyAdded: { color: t.text.muted, fontSize: fonts.xs, fontWeight: fonts.semibold },
  }), [t]);
