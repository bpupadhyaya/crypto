...
export function JobBoardScreen({ onClose }: Props) {
  ...
  const s = useMemo(() => StyleSheet.create({
    ...
    jobTitle: { fontSize: fonts.md, fontWeight: fonts.bold, color: t.text.primary, marginBottom: 4 },
    jobCompany: { fontSize: fonts.sm, color: t.accent.blue, marginBottom: 6 },
    jobDesc: { fontSize: fonts.sm, color: t.text.secondary, marginBottom: 8, lineHeight: 18 },
    ...
    jobTagTxt: { fontSize: fonts.xs, color: t.text.muted },
    jobFooter: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center' },
    jobPay: { fontSize: fonts.md, fontWeight: fonts.bold, color: '#34C759' },
    jobApplicants: { fontSize: fonts.sm, color: t.text.muted },
    applyBtn: { backgroundColor: t.accent.blue, paddingHorizontal: 16, paddingVertical: 8, borderRadius: 8 },
    applyBtnTxt: { fontSize: fonts.sm, fontWeight: fonts.semibold, color: '#FFFFFF' },
    ...
    appTitle: { fontSize: fonts.md, fontWeight: fonts.bold, color: t.text.primary, marginBottom: 2 },
    appCompany: { fontSize: fonts.sm, color: t.text.secondary, marginBottom: 8 },
    appRow: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center' },
    appDate: { fontSize: fonts.sm, color: t.text.muted },
    appStatus: { paddingHorizontal: 10, paddingVertical: 3, borderRadius: 10 },
    appStatusTxt: { fontSize: fonts.sm, fontWeight: fonts.semibold, color: '#FFFFFF' },
