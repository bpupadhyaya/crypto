...
export function IntergenerationScreen({ onClose }: Props) {
  ...
  const s = useMemo(() => StyleSheet.create({
    ...
    tabText: { color: t.text.secondary, fontSize: fonts.sm, fontWeight: fonts.bold },
    ...
    genLabel: { color: t.text.muted, fontSize: fonts.xs, fontWeight: fonts.bold, textTransform: 'uppercase', letterSpacing: 1.5, marginBottom: 6 },
    ...
    genBadge: { fontSize: fonts.xxxl },
    genName: { color: t.text.primary, fontSize: fonts.md, fontWeight: fonts.bold, flex: 1 },
    genStats: { flexDirection: 'row', gap: 16, marginTop: 8 },
    genStat: { alignItems: 'center' },
    genStatValue: { color: t.text.primary, fontSize: fonts.md, fontWeight: fonts.bold },
    genStatLabel: { color: t.text.muted, fontSize: fonts.xs },
    genDeceasedBadge: { color: t.text.muted, fontSize: fonts.xs, fontStyle: 'italic', marginTop: 4 },
    // Arrow connector
    arrowContainer: { alignItems: 'center', marginVertical: 4, marginHorizontal: 20 },
    arrow: { color: t.text.muted, fontSize: fonts.xl },
    arrowLabel: { color: t.text.muted, fontSize: fonts.xs, fontStyle: 'italic' },
    // Cascade styles
    ...
    cascadeFrom: { color: t.accent.purple, fontSize: fonts.md, fontWeight: fonts.bold },
    cascadeDate: { color: t.text.muted, fontSize: fonts.sm },
    cascadeArrow: { color: t.text.muted, fontSize: fonts.sm, marginTop: 4 },
    cascadeTo: { color: t.accent.blue, fontSize: fonts.md, fontWeight: fonts.bold, marginTop: 2 },
    cascadeMessage: { color: t.text.secondary, fontSize: fonts.sm, marginTop: 8, fontStyle: 'italic', lineHeight: 19 },
    cascadeFooter: { flexDirection: 'row', justifyContent: 'space-between', marginTop: 8 },
    cascadeAmount: { color: t.accent.green, fontSize: fonts.sm, fontWeight: fonts.bold },
    cascadeDepth: { color: t.accent.orange, fontSize: fonts.sm, fontWeight: fonts.semibold },
    // Impact styles
    ...
    impactBadge: { fontSize: fonts.xxxl },
    impactAncestor: { color: t.text.primary, fontSize: fonts.md, fontWeight: fonts.bold },
    impactDesc: { color: t.text.secondary, fontSize: fonts.sm, marginTop: 6, lineHeight: 19 },
    impactGen: { color: t.accent.blue, fontSize: fonts.sm, fontWeight: fonts.bold, marginTop: 6 },
    // Legacy styles
    ...
    legacyScore: { color: t.accent.purple, fontSize: fonts.hero, fontWeight: fonts.heavy },
    legacyLabel: { color: t.text.primary, fontSize: fonts.lg, fontWeight: fonts.bold, marginTop: 4 },
    legacySub: { color: t.text.muted, fontSize: fonts.sm, textAlign: 'center', marginTop: 8, lineHeight: 20 },
    legacyRow: { flexDirection: 'row', justifyContent: 'space-around', marginTop: 16, width: '100%' },
    legacyItem: { alignItems: 'center' },
    legacyItemValue: { color: t.text.primary, fontSize: fonts.xl, fontWeight: fonts.heavy },
    legacyItemLabel: { color: t.text.muted, fontSize: fonts.xs, marginTop: 2 },
  }), [t]);
          ...
          <>
            ...
            <View style={s.card}>
              <View style={{ flexDirection: 'row', justifyContent: 'space-between', paddingVertical: 6 }}>
                <Text style={{ color: t.text.secondary, fontSize: fonts.sm }}>Generations Represented</Text>
                <Text style={{ color: t.text.primary, fontSize: fonts.sm, fontWeight: fonts.bold }}>4</Text>
              </View>
              <View style={{ flexDirection: 'row', justifyContent: 'space-between', paddingVertical: 6 }}>
                <Text style={{ color: t.text.secondary, fontSize: fonts.sm }}>Total Family Members</Text>
                <Text style={{ color: t.text.primary, fontSize: fonts.sm, fontWeight: fonts.bold }}>8</Text>
              </View>
              <View style={{ flexDirection: 'row', justifyContent: 'space-between', paddingVertical: 6 }}>
                <Text style={{ color: t.text.secondary, fontSize: fonts.sm }}>Gratitude Transactions</Text>
                <Text style={{ color: t.text.primary, fontSize: fonts.sm, fontWeight: fonts.bold }}>731</Text>
              </View>
              <View style={{ flexDirection: 'row', justifyContent: 'space-between', paddingVertical: 6 }}>
                <Text style={{ color: t.text.secondary, fontSize: fonts.sm }}>Oldest Record</Text>
                <Text style={{ color: t.text.primary, fontSize: fonts.sm, fontWeight: fonts.bold }}>Great-Grandmother Amara</Text>
              </View>
            </View>
          </>
        )}
        ...
        {tab === 'legacy' && (
          <>
            ...
            {groupedGenerations.filter(g => g.generation !== 'future').map(group => {
              ...
              return (
                <View key={group.generation} style={s.card}>
                  <Text style={{ color: t.text.primary, fontSize: fonts.md, fontWeight: fonts.bold }}>{group.label}</Text>
                  <View style={{ flexDirection: 'row', gap: 20, marginTop: 8 }}>
                    ...
                    <Text style={{ color: t.accent.purple, fontSize: fonts.sm, fontWeight: fonts.semibold }}>
            ...
            <View style={[s.card, { marginTop: 16, marginBottom: 8 }]}>
              <Text style={{ color: t.text.secondary, fontSize: fonts.sm, lineHeight: 20, fontStyle: 'italic', textAlign: 'center' }}>
