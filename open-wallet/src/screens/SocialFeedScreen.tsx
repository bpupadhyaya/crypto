...
export function SocialFeedScreen({ onClose }: Props) {
  ...
  const st = useMemo(() => StyleSheet.create({
    ...
    feedIcon: { fontSize: fonts.xxl, marginRight: 10 },
    feedTypeLabel: { fontSize: fonts.xs, fontWeight: fonts.bold, textTransform: 'uppercase', letterSpacing: 1 },
    feedTime: { color: t.text.muted, fontSize: fonts.xs, marginLeft: 'auto' },
    feedDesc: { color: t.text.primary, fontSize: fonts.md, lineHeight: 20, marginBottom: 8 },
    feedActor: { color: t.text.muted, fontSize: fonts.sm },
    ...
    metaText: { color: t.text.secondary, fontSize: fonts.xs },
    ...
    statNumber: { color: t.text.primary, fontSize: fonts.xl, fontWeight: fonts.bold },
