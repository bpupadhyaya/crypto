...
export function NotificationHistoryScreen({ onClose }: NotificationHistoryScreenProps) {
  ...
  const st = useMemo(() => StyleSheet.create({
    ...
    chain: { color: t.accent.blue, fontSize: fonts.xs, fontWeight: fonts.bold, textTransform: 'uppercase', letterSpacing: 1 },
    timestamp: { color: t.text.muted, fontSize: fonts.xs },
    amount: { color: t.accent.green, fontSize: fonts.xl, fontWeight: fonts.bold, marginTop: 6 },
    sender: { color: t.text.secondary, fontSize: fonts.sm, fontFamily: 'monospace', marginTop: 4 },
    senderLabel: { color: t.text.muted, fontSize: fonts.xs, marginTop: 8 },
    txHash: { color: t.text.muted, fontSize: fonts.xs, fontFamily: 'monospace', marginTop: 4 },
    emptyText: { color: t.text.muted, fontSize: fonts.md, textAlign: 'center', paddingVertical: 60, lineHeight: 22 },
    clearBtn: { backgroundColor: t.accent.red + '20', borderRadius: 12, paddingVertical: 14, alignItems: 'center', marginTop: 16 },
    clearText: { color: t.accent.red, fontSize: fonts.md, fontWeight: fonts.bold },
