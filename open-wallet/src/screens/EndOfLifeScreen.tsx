...
export function EndOfLifeScreen({ onClose }: Props) {
  ...
  const s = useMemo(() => StyleSheet.create({
    ...
    badgeText: { color: t.accent.green, fontSize: 11, fontWeight: '700' },
    proxyRow: { flexDirection: 'row', alignItems: 'center', backgroundColor: t.bg.primary, borderRadius: 12, padding: 12, marginTop: 8 },
    proxyLabel: { color: t.text.secondary, fontSize: 12, fontWeight: '600' },
    proxyUid: { color: t.accent.blue, fontSize: 13, fontWeight: '700', marginLeft: 8 },
    letterCard: { backgroundColor: t.bg.card, borderRadius: 16, padding: 16, marginHorizontal: 20, marginBottom: 12 },
    letterSubject: { color: t.text.primary, fontSize: 15, fontWeight: '700' },
    ...
    encryptedText: { color: t.accent.green, fontSize: 11, fontWeight: '700' },
    memorialSection: { backgroundColor: t.bg.card, borderRadius: 16, padding: 16, marginHorizontal: 20, marginBottom: 12 },
    memLabel: { color: t.text.secondary, fontSize: 12, fontWeight: '700', textTransform: 'uppercase', letterSpacing: 1, marginBottom: 6 },
    ...
    estateLabel: { color: t.text.secondary, fontSize: 13, fontWeight: '600' },
    estateName: { color: t.text.primary, fontSize: 14, fontWeight: '700' },
    ...
    guardianLabel: { color: t.text.secondary, fontSize: 12, fontWeight: '600' },
    guardianName: { color: t.text.primary, fontSize: 14, fontWeight: '700' },
