...
export function TimeBankScreen({ onClose }: Props) {
  ...
  const s = useMemo(() => StyleSheet.create({
    ...
    balanceNum: { fontSize: 42, fontWeight: fonts.heavy },
    balanceLabel: { color: t.text.muted, fontSize: fonts.sm, textTransform: 'uppercase', letterSpacing: 1, marginTop: 2, textAlign: 'center' },
    balanceDivider: { color: t.text.muted, fontSize: fonts.xxl, fontWeight: '300' },
    netBalance: { marginTop: 8, paddingHorizontal: 14, paddingVertical: 6, borderRadius: 20, alignSelf: 'center' },
    netBalanceText: { fontSize: fonts.md, fontWeight: fonts.bold },
    ...
    philosophyTitle: { color: t.accent.purple, fontSize: fonts.md, fontWeight: fonts.heavy, textTransform: 'uppercase', letterSpacing: 1.5, marginBottom: 8 },
    philosophyText: { color: t.text.primary, fontSize: fonts.md, textAlign: 'center', lineHeight: 22 },
    // Active exchanges
    ...
    exchangeIconText: { fontSize: fonts.md, fontWeight: fonts.bold },
    exchangeInfo: { flex: 1 },
    ...
    communityValue: { color: t.text.primary, fontSize: fonts.xxl, fontWeight: fonts.heavy },
    communityLabel: { color: t.text.muted, fontSize: fonts.xs, marginTop: 2, textAlign: 'center' },
    skillBar: { flexDirection: 'row', alignItems: 'center', marginBottom: 8 },
    skillLabel: { color: t.text.primary, fontSize: fonts.sm, fontWeight: fonts.semibold, width: 80 },
    ...
    skillHours: { color: t.text.muted, fontSize: fonts.xs, marginLeft: 8, width: 40, textAlign: 'right' },
    // Offer form
    ...
    offerTitle: { color: t.text.primary, fontSize: fonts.md, fontWeight: fonts.bold },
    ...
    offerRating: { color: t.accent.orange, fontSize: fonts.sm, fontWeight: fonts.bold },
    offerAvailable: { color: t.accent.purple, fontSize: fonts.sm, fontWeight: fonts.bold },
    // Service request
    serviceCard: { backgroundColor: t.bg.secondary, borderRadius: 14, padding: 16, marginHorizontal: 20, marginBottom: 12 },
    serviceTitle: { color: t.text.primary, fontSize: fonts.md, fontWeight: fonts.bold },
    serviceMeta: { color: t.text.muted, fontSize: fonts.sm, marginTop: 4 },
    serviceProvider: { color: t.text.secondary, fontSize: fonts.sm, fontWeight: fonts.semibold, marginTop: 6 },
    ...
    requestBtnText: { color: '#fff', fontSize: fonts.sm, fontWeight: fonts.semibold },
    // History
    ...
    historyIconText: { color: '#fff', fontSize: fonts.md, fontWeight: fonts.bold },
    historyInfo: { flex: 1 },
    ...
    historyFeedback: { color: t.text.secondary, fontSize: fonts.sm, fontStyle: 'italic', marginTop: 4 },
    historyRight: { alignItems: 'flex-end' },
    historyHours: { fontSize: fonts.lg, fontWeight: fonts.heavy },
    historyRating: { color: t.accent.orange, fontSize: fonts.xs, marginTop: 2 },
    // Demo tag
