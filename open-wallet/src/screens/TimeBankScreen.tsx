...
export function TimeBankScreen({ onClose }: Props) {
  ...
  const s = useMemo(() => StyleSheet.create({
    ...
    netBalanceText: { fontSize: 14, fontWeight: fonts.bold },
    ...
    philosophyTitle: { color: t.accent.purple, fontSize: 14, fontWeight: fonts.heavy, textTransform: 'uppercase', letterSpacing: 1.5, marginBottom: 8 },
    ...
    exchangeIconText: { fontSize: 14, fontWeight: fonts.bold },
    exchangeInfo: { flex: 1 },
    ...
    communityValue: { color: t.text.primary, fontSize: 22, fontWeight: fonts.heavy },
    ...
    skillLabel: { color: t.text.primary, fontSize: 13, fontWeight: fonts.semibold, width: 80 },
    ...
    offerTitle: { color: t.text.primary, fontSize: 15, fontWeight: fonts.bold },
    ...
    offerRating: { color: t.accent.orange, fontSize: 13, fontWeight: fonts.bold },
    offerAvailable: { color: t.accent.purple, fontSize: 13, fontWeight: fonts.bold },
    // Service request
    serviceCard: { backgroundColor: t.bg.secondary, borderRadius: 14, padding: 16, marginHorizontal: 20, marginBottom: 12 },
    serviceTitle: { color: t.text.primary, fontSize: 15, fontWeight: fonts.bold },
    serviceMeta: { color: t.text.muted, fontSize: 12, marginTop: 4 },
    serviceProvider: { color: t.text.secondary, fontSize: 13, fontWeight: fonts.semibold, marginTop: 6 },
    ...
    requestBtnText: { color: '#fff', fontSize: 13, fontWeight: fonts.semibold },
    // History
    ...
    historyIconText: { color: '#fff', fontSize: 14, fontWeight: fonts.bold },
    historyInfo: { flex: 1 },
    ...
    historyHours: { fontSize: 16, fontWeight: fonts.heavy },
