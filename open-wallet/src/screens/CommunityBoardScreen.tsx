...
export function CommunityBoardScreen({ onClose }: Props) {
  ...
  const s = useMemo(() => StyleSheet.create({
    ...
    oppReward: { color: t.accent.green, fontSize: 14, fontWeight: '700' },
    ...
    signupText: { color: '#fff', fontSize: 13, fontWeight: '600' },
    signedUpBadge: { backgroundColor: t.accent.green + '20', paddingHorizontal: 12, paddingVertical: 6, borderRadius: 10 },
    signedUpText: { color: t.accent.green, fontSize: 12, fontWeight: '600' },
    ...
    partTitle: { color: t.text.primary, fontSize: 14, fontWeight: '600', flex: 1 },
    partMeta: { color: t.text.muted, fontSize: 12, marginTop: 2 },
    partStatus: { fontSize: 12, fontWeight: '600' },
    gratCard: { backgroundColor: t.bg.secondary, borderRadius: 14, padding: 14, marginHorizontal: 20, marginBottom: 10 },
    gratFrom: { color: t.accent.purple, fontSize: 13, fontWeight: '700' },
    gratMessage: { color: t.text.primary, fontSize: 14, marginTop: 4, fontStyle: 'italic' },
    gratAmount: { color: t.accent.green, fontSize: 13, fontWeight: '600', marginTop: 4 },
        ...
        {DEMO_PARTICIPATIONS.map((p) => (
          <View key={p.opportunityId} style={s.participationRow}>
            ...
            <View style={{ alignItems: 'flex-end' }}>
              ...
              {p.cotkEarned > 0 && (
                <Text style={{ color: t.accent.green, fontSize: 12, fontWeight: '600', marginTop: 2 }}>
                  +{p.cotkEarned} cOTK
                </Text>
              )}
            </View>
