...
export function MentorDirectoryScreen({ onClose }: Props) {
  ...
  const s = useMemo(() => StyleSheet.create({
    ...
    mentorTitle: { color: t.accent.blue, fontSize: 13, fontWeight: fonts.semibold, marginTop: 2 },
    ...
    mentorStatVal: { color: t.text.primary, fontSize: 16, fontWeight: fonts.heavy },
    ...
    availability: { fontSize: 12, fontWeight: fonts.bold },
    connectBtn: { backgroundColor: t.accent.blue, paddingHorizontal: 16, paddingVertical: 8, borderRadius: 10 },
    connectBtnText: { color: '#fff', fontSize: 13, fontWeight: fonts.semibold },
    ...
    expertiseLabel: { color: t.text.primary, fontSize: 15, fontWeight: fonts.bold },
    ...
    connectionStatusText: { color: '#fff', fontSize: 11, fontWeight: fonts.bold },
