...
export function MentorDirectoryScreen({ onClose }: Props) {
  ...
  const s = useMemo(() => StyleSheet.create({
    ...
    mentorTitle: { color: t.accent.blue, fontSize: 13, fontWeight: '600', marginTop: 2 },
    mentorBio: { color: t.text.muted, fontSize: 13, marginTop: 8, lineHeight: 20 },
    tagRow: { flexDirection: 'row', flexWrap: 'wrap', gap: 6, marginTop: 8 },
    tag: { backgroundColor: t.accent.blue + '15', paddingHorizontal: 10, paddingVertical: 4, borderRadius: 8 },
    tagText: { color: t.accent.blue, fontSize: 11, fontWeight: '600' },
    ...
    mentorStatVal: { color: t.text.primary, fontSize: 16, fontWeight: '800' },
    mentorStatLabel: { color: t.text.muted, fontSize: 10, marginTop: 2 },
    mentorFooter: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', marginTop: 12 },
    availability: { fontSize: 12, fontWeight: '700' },
    ...
    expertiseLabel: { color: t.text.primary, fontSize: 15, fontWeight: '700' },
    expertiseCount: { color: t.text.muted, fontSize: 13 },
    connectionCard: { backgroundColor: t.bg.secondary, borderRadius: 14, padding: 16, marginHorizontal: 20, marginBottom: 12 },
    connectionName: { color: t.text.primary, fontSize: 15, fontWeight: '700' },
    connectionTopic: { color: t.text.muted, fontSize: 13, marginTop: 4 },
    connectionStatus: { paddingHorizontal: 10, paddingVertical: 3, borderRadius: 8, alignSelf: 'flex-start', marginTop: 8 },
    connectionStatusText: { color: '#fff', fontSize: 11, fontWeight: '700' },
    connectionDate: { color: t.text.muted, fontSize: 11, marginTop: 6 },
    langRow: { flexDirection: 'row', gap: 6, marginTop: 4 },
    langText: { color: t.text.muted, fontSize: 11 },
