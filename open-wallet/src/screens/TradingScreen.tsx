...
export function TradingScreen({ onClose }: Props) {
  ...
  const s = useMemo(() => StyleSheet.create({
    ...
    pairSymbol: { color: t.text.primary, fontSize: 18, fontWeight: fonts.heavy },
    pairPrice: { color: t.accent.green, fontSize: 16, fontWeight: fonts.bold },
    pairChange: { fontSize: 13, fontWeight: fonts.bold },
    ...
    pairOptionText: { color: t.text.primary, fontSize: 14, fontWeight: fonts.semibold },
    ...
    statValue: { color: t.text.primary, fontSize: 12, fontWeight: fonts.bold, marginTop: 2 },
    // Order form
    ...
    sideText: { fontSize: 14, fontWeight: fonts.heavy },
    ...
    typeText: { fontSize: 13, fontWeight: fonts.semibold },
    typeTextActive: { color: t.accent.blue },
    typeTextInactive: { color: t.text.muted },
    inputLabel: { color: t.text.muted, fontSize: 12, fontWeight: fonts.semibold, marginBottom: 6, textTransform: 'uppercase', letterSpacing: 1 },
    input: { backgroundColor: t.bg.primary, color: t.text.primary, fontSize: 16, fontWeight: fonts.bold, padding: 14, borderRadius: 12, marginBottom: 14 },
    totalRow: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', marginBottom: 16 },
    totalLabel: { color: t.text.muted, fontSize: 13 },
    totalValue: { color: t.text.primary, fontSize: 16, fontWeight: fonts.heavy },
    ...
    bookHeaderText: { flex: 1, color: t.text.muted, fontSize: 11, fontWeight: fonts.bold, textTransform: 'uppercase' },
    ...
    bookPrice: { flex: 1, fontSize: 12, fontWeight: fonts.semibold },
    ...
    spreadValue: { color: t.text.primary, fontSize: 12, fontWeight: fonts.bold, marginLeft: 6 },
    // Trade history
    tradeRow: { flexDirection: 'row', paddingVertical: 8, borderBottomWidth: 1, borderBottomColor: t.border },
    tradePrice: { flex: 1, fontSize: 13, fontWeight: fonts.semibold },
    ...
    sectionLabel: { color: t.text.secondary, fontSize: 12, fontWeight: fonts.bold, textTransform: 'uppercase', letterSpacing: 1.5, marginBottom: 10, marginTop: 8 },
