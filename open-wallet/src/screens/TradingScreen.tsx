...
export function TradingScreen({ onClose }: Props) {
  ...
  const s = useMemo(() => StyleSheet.create({
    ...
    tabText: { fontSize: fonts.sm, fontWeight: fonts.bold },
    ...
    pairSymbol: { color: t.text.primary, fontSize: fonts.xl, fontWeight: fonts.heavy },
    pairPrice: { color: t.accent.green, fontSize: fonts.lg, fontWeight: fonts.bold },
    pairChange: { fontSize: fonts.sm, fontWeight: fonts.bold },
    pairChangePos: { color: t.accent.green },
    pairChangeNeg: { color: t.accent.red },
    pairChevron: { color: t.text.muted, fontSize: fonts.lg },
    ...
    pairOptionText: { color: t.text.primary, fontSize: fonts.md, fontWeight: fonts.semibold },
    pairOptionPrice: { color: t.text.muted, fontSize: fonts.sm },
    // Stats bar
    statsBar: { flexDirection: 'row', paddingHorizontal: 20, marginBottom: 12 },
    statItem: { flex: 1, alignItems: 'center' },
    statLabel: { color: t.text.muted, fontSize: fonts.xs, textTransform: 'uppercase', letterSpacing: 0.5 },
    statValue: { color: t.text.primary, fontSize: fonts.sm, fontWeight: fonts.bold, marginTop: 2 },
    // Order form
    ...
    sideText: { fontSize: fonts.md, fontWeight: fonts.heavy },
    ...
    typeText: { fontSize: fonts.sm, fontWeight: fonts.semibold },
    typeTextActive: { color: t.accent.blue },
    typeTextInactive: { color: t.text.muted },
    inputLabel: { color: t.text.muted, fontSize: fonts.sm, fontWeight: fonts.semibold, marginBottom: 6, textTransform: 'uppercase', letterSpacing: 1 },
    input: { backgroundColor: t.bg.primary, color: t.text.primary, fontSize: fonts.lg, fontWeight: fonts.bold, padding: 14, borderRadius: 12, marginBottom: 14 },
    totalRow: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', marginBottom: 16 },
    totalLabel: { color: t.text.muted, fontSize: fonts.sm },
    totalValue: { color: t.text.primary, fontSize: fonts.lg, fontWeight: fonts.heavy },
    ...
    submitText: { color: t.bg.primary, fontSize: fonts.lg, fontWeight: fonts.heavy },
    // Orders list
    orderCard: { backgroundColor: t.bg.card, borderRadius: 14, padding: 16, marginBottom: 10 },
    orderHeader: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', marginBottom: 8 },
    orderPair: { color: t.text.primary, fontSize: fonts.md, fontWeight: fonts.bold },
    orderSideBadge: { paddingHorizontal: 8, paddingVertical: 3, borderRadius: 6 },
    orderSideText: { fontSize: fonts.xs, fontWeight: fonts.heavy, color: t.bg.primary },
    orderRow: { flexDirection: 'row', justifyContent: 'space-between', marginBottom: 4 },
    orderLabel: { color: t.text.muted, fontSize: fonts.sm },
    orderValue: { color: t.text.primary, fontSize: fonts.sm, fontWeight: fonts.semibold },
    cancelBtn: { marginTop: 8, paddingVertical: 8, borderRadius: 8, backgroundColor: t.accent.red + '20', alignItems: 'center' },
    cancelText: { color: t.accent.red, fontSize: fonts.sm, fontWeight: fonts.bold },
    ...
    bookHeaderText: { flex: 1, color: t.text.muted, fontSize: fonts.xs, fontWeight: fonts.bold, textTransform: 'uppercase' },
    ...
    bookPrice: { flex: 1, fontSize: fonts.sm, fontWeight: fonts.semibold },
    bookPriceBid: { color: t.accent.green },
    bookPriceAsk: { color: t.accent.red },
    bookAmount: { flex: 1, color: t.text.primary, fontSize: fonts.sm, textAlign: 'center' },
    bookTotal: { flex: 1, color: t.text.muted, fontSize: fonts.sm, textAlign: 'right' },
    ...
    spreadText: { color: t.text.muted, fontSize: fonts.sm },
    spreadValue: { color: t.text.primary, fontSize: fonts.sm, fontWeight: fonts.bold, marginLeft: 6 },
    // Trade history
    tradeRow: { flexDirection: 'row', paddingVertical: 8, borderBottomWidth: 1, borderBottomColor: t.border },
    tradePrice: { flex: 1, fontSize: fonts.sm, fontWeight: fonts.semibold },
    tradeAmount: { flex: 1, color: t.text.primary, fontSize: fonts.sm, textAlign: 'center' },
    tradeTime: { flex: 1, color: t.text.muted, fontSize: fonts.sm, textAlign: 'right' },
    // Empty state
    emptyText: { color: t.text.muted, fontSize: fonts.md, textAlign: 'center', paddingVertical: 20 },
    sectionLabel: { color: t.text.secondary, fontSize: fonts.sm, fontWeight: fonts.bold, textTransform: 'uppercase', letterSpacing: 1.5, marginBottom: 10, marginTop: 8 },
    demoBanner: { backgroundColor: t.accent.blue + '20', paddingVertical: 8, paddingHorizontal: 16, borderRadius: 10, marginBottom: 12 },
    demoBannerText: { color: t.accent.blue, fontSize: fonts.sm, fontWeight: fonts.semibold, textAlign: 'center' },
  }), [t]);
