...
export function PublicSpeakingScreen({ onClose }: Props) {
  ...
  const s = useMemo(() => StyleSheet.create({
    ...
    eOTKText: { color: t.accent.green, fontSize: 12, fontWeight: '700' },
    ...
    tagText: { color: t.accent.purple, fontSize: 11, fontWeight: '600' },
    tipIcon: { fontSize: 28, marginBottom: 8 },
    tipCategory: { color: t.accent.purple, fontSize: 11, fontWeight: '700', textTransform: 'uppercase', letterSpacing: 1 },
    ...
    mentorLink: { color: t.accent.blue, fontSize: 13, fontWeight: '600', marginTop: 8 },
  }), [t]);
