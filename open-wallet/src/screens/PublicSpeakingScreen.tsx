...
export function PublicSpeakingScreen({ onClose }: Props) {
  ...
  const s = useMemo(() => StyleSheet.create({
    ...
    eOTKText: { color: t.accent.green, fontSize: fonts.sm, fontWeight: fonts.bold },
    ...
    tagText: { color: t.accent.purple, fontSize: fonts.xs, fontWeight: fonts.semibold },
    tipIcon: { fontSize: fonts.xxxl, marginBottom: 8 },
    tipCategory: { color: t.accent.purple, fontSize: fonts.xs, fontWeight: fonts.bold, textTransform: 'uppercase', letterSpacing: 1 },
    tipSummary: { color: t.text.secondary, fontSize: fonts.sm, lineHeight: 20, marginTop: 8 },
    ...
    mentorLink: { color: t.accent.blue, fontSize: fonts.sm, fontWeight: fonts.semibold, marginTop: 8 },
  }), [t]);
