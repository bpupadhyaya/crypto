...
export function CleanupDriveScreen({ onClose }: Props) {
  ...
  const s = useMemo(() => StyleSheet.create({
    ...
    driveTypeText: { color: '#fff', fontSize: 14, fontWeight: '700' },
    driveInfo: { flex: 1 },
    driveTitle: { color: t.text.primary, fontSize: 15, fontWeight: '700' },
    ...
    hashValue: { color: t.accent.blue, fontSize: 11, fontWeight: '600' },
    cotkBadge: { alignItems: 'center', marginTop: 12 },
    cotkText: { color: t.accent.green, fontSize: 18, fontWeight: '800' },
    cotkLabel: { color: t.text.muted, fontSize: 11, marginTop: 2 },
    verifiedBadge: { color: t.accent.green, fontSize: 11, fontWeight: '600', marginTop: 4 },
    ...
    leaderTrashText: { color: t.accent.green, fontSize: 16, fontWeight: '800' },
