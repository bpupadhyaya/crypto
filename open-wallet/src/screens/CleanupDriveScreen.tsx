...
export function CleanupDriveScreen({ onClose }: Props) {
  ...
  const s = useMemo(() => StyleSheet.create({
    ...
    driveTypeText: { color: '#fff', fontSize: fonts.md, fontWeight: fonts.bold },
    driveInfo: { flex: 1 },
    driveTitle: { color: t.text.primary, fontSize: fonts.md, fontWeight: fonts.bold },
    driveMeta: { color: t.text.muted, fontSize: fonts.sm, marginTop: 2 },
    driveSupplies: { color: t.text.muted, fontSize: fonts.xs, marginTop: 6, fontStyle: 'italic' },
    driveFooter: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', marginTop: 10 },
    volunteerProgress: { flex: 1 },
    volunteerText: { color: t.text.muted, fontSize: fonts.sm },
    ...
    hashValue: { color: t.accent.blue, fontSize: fonts.xs, fontWeight: fonts.semibold },
    cotkBadge: { alignItems: 'center', marginTop: 12 },
    cotkText: { color: t.accent.green, fontSize: fonts.xl, fontWeight: fonts.heavy },
    cotkLabel: { color: t.text.muted, fontSize: fonts.xs, marginTop: 2 },
    verifiedBadge: { color: t.accent.green, fontSize: fonts.xs, fontWeight: fonts.semibold, marginTop: 4 },
    ...
    leaderTrashText: { color: t.accent.green, fontSize: fonts.lg, fontWeight: fonts.heavy },
    leaderTrashLabel: { color: t.text.muted, fontSize: fonts.xs },
