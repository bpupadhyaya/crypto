  ...
  const styles = useMemo(
    () =>
      StyleSheet.create({
        ...
        balanceValue: { fontSize: 18, fontWeight: fonts.bold, color: t.accent.green },
        ...
        shopName: { fontSize: 15, fontWeight: fonts.bold, color: t.text.primary, marginBottom: 2 },
        ...
        shopCost: { fontSize: 14, fontWeight: fonts.bold, color: t.accent.green },
        redeemButton: { paddingHorizontal: 14, paddingVertical: 8, backgroundColor: t.accent.green, borderRadius: 8 },
        redeemButtonText: { fontSize: 13, fontWeight: fonts.semibold, color: '#FFFFFF' },
        ...
        redeemName: { fontSize: 14, fontWeight: fonts.bold, color: t.text.primary, marginBottom: 2 },
        redeemDesc: { fontSize: 12, color: t.text.secondary },
        redeemCostValue: { fontSize: 16, fontWeight: fonts.bold, color: t.accent.green },
        ...
        historyInfo: { flex: 1 },
        historyItem: { fontSize: 14, fontWeight: fonts.semibold, color: t.text.primary, marginBottom: 2 },
        historyMeta: { fontSize: 12, color: t.text.secondary },
        historyOtk: { fontSize: 14, fontWeight: fonts.bold, color: t.text.primary },
        ...
        totalSpentValue: { fontSize: 20, fontWeight: fonts.bold, color: t.text.primary },
      }),
    [t],
  );
