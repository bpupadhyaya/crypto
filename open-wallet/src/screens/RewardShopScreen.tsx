  ...
  const styles = useMemo(
    () =>
      StyleSheet.create({
        ...
        balanceLabel: { fontSize: fonts.md, color: t.text.secondary, marginRight: 8 },
        balanceValue: { fontSize: fonts.xl, fontWeight: fonts.bold, color: t.accent.green },
        ...
        shopName: { fontSize: fonts.md, fontWeight: fonts.bold, color: t.text.primary, marginBottom: 2 },
        shopProvider: { fontSize: fonts.sm, color: t.accent.green, marginBottom: 6 },
        shopDesc: { fontSize: fonts.sm, color: t.text.secondary, lineHeight: 18, marginBottom: 8 },
        shopFooter: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center' },
        shopMeta: { fontSize: fonts.sm, color: t.text.secondary },
        shopCost: { fontSize: fonts.md, fontWeight: fonts.bold, color: t.accent.green },
        redeemButton: { paddingHorizontal: 14, paddingVertical: 8, backgroundColor: t.accent.green, borderRadius: 8 },
        redeemButtonText: { fontSize: fonts.sm, fontWeight: fonts.semibold, color: '#FFFFFF' },
        ...
        redeemName: { fontSize: fonts.md, fontWeight: fonts.bold, color: t.text.primary, marginBottom: 2 },
        redeemDesc: { fontSize: fonts.sm, color: t.text.secondary },
        redeemCostValue: { fontSize: fonts.lg, fontWeight: fonts.bold, color: t.accent.green },
        ...
        historyInfo: { flex: 1 },
        historyItem: { fontSize: fonts.md, fontWeight: fonts.semibold, color: t.text.primary, marginBottom: 2 },
        historyMeta: { fontSize: fonts.sm, color: t.text.secondary },
        historyOtk: { fontSize: fonts.md, fontWeight: fonts.bold, color: t.text.primary },
        ...
        totalSpentValue: { fontSize: fonts.xl, fontWeight: fonts.bold, color: t.text.primary },
      }),
    [t],
  );
