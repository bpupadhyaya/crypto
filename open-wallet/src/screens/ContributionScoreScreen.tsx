...
export function ContributionScoreScreen({ onClose }: Props) {
  ...
  const s = useMemo(() => StyleSheet.create({
    ...
    rankNumber: { color: t.text.primary, fontSize: fonts.xl, fontWeight: fonts.heavy },
    rankLabel: { color: t.text.muted, fontSize: fonts.xs, marginTop: 2 },
    formula: { color: t.text.muted, fontSize: fonts.xs, marginTop: 16, textAlign: 'center', lineHeight: 16 },
    ...
    rowInfo: { flex: 1 },
    rowUid: { color: t.text.primary, fontSize: fonts.md, fontWeight: fonts.semibold },
    rowScore: { color: t.text.muted, fontSize: fonts.sm, marginTop: 2 },
    ...
    youBadge: { color: t.accent.green, fontSize: fonts.xs, fontWeight: fonts.bold },
  }), [t]);
