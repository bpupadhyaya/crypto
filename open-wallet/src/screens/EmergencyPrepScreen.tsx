...
export function EmergencyPrepScreen({ onClose }: Props) {
  ...
  const s = useMemo(() => StyleSheet.create({
    ...
    scoreLabel: { fontSize: 16, fontWeight: fonts.bold, marginTop: 4 },
    ...
    breakdownLabel: { color: t.text.primary, fontSize: 14, fontWeight: fonts.semibold, flex: 1 },
    ...
    breakdownScore: { color: t.text.muted, fontSize: 13, fontWeight: fonts.bold, width: 40, textAlign: 'right' },
    ...
    checkMark: { color: '#fff', fontSize: 12, fontWeight: fonts.heavy },
    checkInfo: { flex: 1 },
    ...
    planSectionTitle: { color: t.text.primary, fontSize: 14, fontWeight: fonts.bold, marginBottom: 10 },
    ...
    meetingTypeText: { color: '#fff', fontSize: 9, fontWeight: fonts.bold, textTransform: 'uppercase' },
    meetingInfo: { flex: 1 },
    meetingName: { color: t.text.primary, fontSize: 14, fontWeight: fonts.semibold },
    ...
    contactOrderText: { color: '#fff', fontSize: 13, fontWeight: fonts.bold },
    contactInfo: { flex: 1 },
    ...
    routeName: { color: t.text.primary, fontSize: 14, fontWeight: fonts.semibold },
    routeDesc: { color: t.text.secondary, fontSize: 12, marginTop: 2 },
    routeDest: { color: t.accent.blue, fontSize: 12, fontWeight: fonts.semibold, marginTop: 4 },
    ...
    drillTitle: { color: t.text.primary, fontSize: 15, fontWeight: fonts.bold, flex: 1 },
    drillType: { color: t.accent.orange, fontSize: 11, fontWeight: fonts.semibold, marginBottom: 4 },
    ...
    registerText: { fontSize: 13, fontWeight: fonts.semibold },
    ...
    trainingTitle: { color: t.text.primary, fontSize: 15, fontWeight: fonts.bold, flex: 1 },
    completedBadge: { paddingHorizontal: 8, paddingVertical: 3, borderRadius: 8 },
    completedText: { fontSize: 10, fontWeight: fonts.bold },
    trainingType: { color: t.accent.blue, fontSize: 12, fontWeight: fonts.semibold, marginBottom: 4 },
    ...
    startText: { color: '#fff', fontSize: 13, fontWeight: fonts.semibold },
