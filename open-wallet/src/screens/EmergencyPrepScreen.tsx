...
export function EmergencyPrepScreen({ onClose }: Props) {
  ...
  const s = useMemo(() => StyleSheet.create({
    ...
    scoreValue: { color: t.text.primary, fontSize: 64, fontWeight: fonts.heavy },
    scoreLabel: { fontSize: fonts.lg, fontWeight: fonts.bold, marginTop: 4 },
    scoreSubLabel: { color: t.text.muted, fontSize: fonts.sm, marginTop: 2 },
    breakdownRow: { flexDirection: 'row', alignItems: 'center', paddingVertical: 10, borderBottomColor: t.bg.primary, borderBottomWidth: 1 },
    breakdownLabel: { color: t.text.primary, fontSize: fonts.md, fontWeight: fonts.semibold, flex: 1 },
    ...
    breakdownScore: { color: t.text.muted, fontSize: fonts.sm, fontWeight: fonts.bold, width: 40, textAlign: 'right' },
    categoryCard: { backgroundColor: t.bg.secondary, borderRadius: 14, padding: 16, marginHorizontal: 20, marginBottom: 12 },
    categoryHeader: { flexDirection: 'row', alignItems: 'center', marginBottom: 12 },
    categoryIcon: { fontSize: fonts.xl, marginRight: 10 },
    categoryName: { color: t.text.primary, fontSize: fonts.md, fontWeight: fonts.bold, flex: 1 },
    categoryCount: { color: t.text.muted, fontSize: fonts.sm },
    ...
    checkMark: { color: '#fff', fontSize: fonts.sm, fontWeight: fonts.heavy },
    checkInfo: { flex: 1 },
    checkName: { color: t.text.primary, fontSize: fonts.md },
    checkNameDone: { color: t.text.muted, fontSize: fonts.md, textDecorationLine: 'line-through' },
    checkMeta: { color: t.text.muted, fontSize: fonts.xs, marginTop: 2 },
    planCard: { backgroundColor: t.bg.secondary, borderRadius: 14, padding: 16, marginHorizontal: 20, marginBottom: 12 },
    planSectionTitle: { color: t.text.primary, fontSize: fonts.md, fontWeight: fonts.bold, marginBottom: 10 },
    ...
    meetingTypeText: { color: '#fff', fontSize: fonts.xxs, fontWeight: fonts.bold, textTransform: 'uppercase' },
    meetingInfo: { flex: 1 },
    meetingName: { color: t.text.primary, fontSize: fonts.md, fontWeight: fonts.semibold },
    meetingAddress: { color: t.text.muted, fontSize: fonts.sm, marginTop: 2 },
    ...
    contactOrderText: { color: '#fff', fontSize: fonts.sm, fontWeight: fonts.bold },
    contactInfo: { flex: 1 },
    contactName: { color: t.text.primary, fontSize: fonts.md, fontWeight: fonts.semibold },
    contactRole: { color: t.text.muted, fontSize: fonts.sm, marginTop: 1 },
    contactPhone: { color: t.accent.blue, fontSize: fonts.sm, fontWeight: fonts.semibold },
    routeRow: { paddingVertical: 10, borderBottomColor: t.bg.primary, borderBottomWidth: 1 },
    routeName: { color: t.text.primary, fontSize: fonts.md, fontWeight: fonts.semibold },
    routeDesc: { color: t.text.secondary, fontSize: fonts.sm, marginTop: 2 },
    routeDest: { color: t.accent.blue, fontSize: fonts.sm, fontWeight: fonts.semibold, marginTop: 4 },
    ...
    drillTitle: { color: t.text.primary, fontSize: fonts.md, fontWeight: fonts.bold, flex: 1 },
    drillType: { color: t.accent.orange, fontSize: fonts.xs, fontWeight: fonts.semibold, marginBottom: 4 },
    drillMeta: { color: t.text.muted, fontSize: fonts.sm, marginBottom: 4 },
    drillParticipants: { color: t.text.secondary, fontSize: fonts.sm, marginBottom: 8 },
    ...
    registerText: { fontSize: fonts.sm, fontWeight: fonts.semibold },
    ...
    trainingTitle: { color: t.text.primary, fontSize: fonts.md, fontWeight: fonts.bold, flex: 1 },
    completedBadge: { paddingHorizontal: 8, paddingVertical: 3, borderRadius: 8 },
    completedText: { fontSize: fonts.xs, fontWeight: fonts.bold },
    trainingType: { color: t.accent.blue, fontSize: fonts.sm, fontWeight: fonts.semibold, marginBottom: 4 },
    trainingDuration: { color: t.text.muted, fontSize: fonts.sm, marginBottom: 4 },
    trainingDesc: { color: t.text.secondary, fontSize: fonts.sm, lineHeight: 18 },
    trainingDate: { color: t.text.muted, fontSize: fonts.xs, marginTop: 6 },
    ...
    startText: { color: '#fff', fontSize: fonts.sm, fontWeight: fonts.semibold },
