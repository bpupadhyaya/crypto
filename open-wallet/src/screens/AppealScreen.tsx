...
export function AppealScreen({ onClose }: Props) {
  ...
  const st = useMemo(() => StyleSheet.create({
    ...
    cardDesc: { color: t.text.secondary, fontSize: fonts.sm, lineHeight: 19, marginBottom: 8 },
    ...
    negOTK: { color: t.accent.red, fontSize: fonts.lg, fontWeight: fonts.heavy },
    channelChip: { paddingHorizontal: 10, paddingVertical: 4, borderRadius: 8, alignSelf: 'flex-start', marginBottom: 8 },
    channelText: { fontSize: fonts.xs, fontWeight: fonts.bold, color: '#fff' },
    ...
    infoText: { color: t.accent.blue, fontSize: fonts.sm, lineHeight: 19, fontWeight: fonts.semibold },
    ...
    section: { color: t.text.secondary, fontSize: fonts.sm, fontWeight: fonts.bold, textTransform: 'uppercase', letterSpacing: 1.2, marginTop: 12, marginBottom: 6 },
    ...
    timelineLabel: { color: t.text.primary, fontSize: fonts.sm, fontWeight: fonts.semibold },
    timelineDate: { color: t.text.muted, fontSize: fonts.xs, marginTop: 2 },
    // Evidence and witness items
    evidenceItem: { backgroundColor: t.bg.primary, borderRadius: 10, padding: 12, marginBottom: 8 },
    evidenceType: { fontSize: fonts.xs, fontWeight: fonts.bold, textTransform: 'uppercase', letterSpacing: 0.8, marginBottom: 4 },
    evidenceLabel: { color: t.text.primary, fontSize: fonts.sm, fontWeight: fonts.semibold },
    evidenceHash: { color: t.text.muted, fontSize: fonts.xs, fontFamily: 'Courier', marginTop: 2 },
    witnessItem: { backgroundColor: t.bg.primary, borderRadius: 10, padding: 12, marginBottom: 8 },
    witnessUID: { color: t.text.primary, fontSize: fonts.sm, fontWeight: fonts.semibold },
    witnessStatus: { fontSize: fonts.xs, fontWeight: fonts.bold, marginTop: 2 },
    witnessStatement: { color: t.text.secondary, fontSize: fonts.sm, lineHeight: 17, marginTop: 4, fontStyle: 'italic' },
    // Hearing card
    ...
    hearingTitle: { color: t.accent.blue, fontSize: fonts.md, fontWeight: fonts.bold, marginBottom: 8 },
    // Summary stats
    statsRow: { flexDirection: 'row', gap: 8, marginBottom: 16 },
    statCard: { flex: 1, backgroundColor: t.bg.card, borderRadius: 12, padding: 12, alignItems: 'center' },
    statNum: { fontSize: fonts.xl, fontWeight: fonts.heavy, marginBottom: 2 },
    statLabel: { color: t.text.muted, fontSize: fonts.xs, fontWeight: fonts.semibold, textTransform: 'uppercase' },
  }), [t]);
                  ...
                  <View style={{ flexDirection: 'row', justifyContent: 'space-between', marginTop: 4 }}>
                    {appeal.timeline.map((step, i) => (
                      <View key={step.stage} style={{ alignItems: 'center', flex: 1 }}>
                        ...
                        <Text style={{ color: step.completed ? t.text.secondary : t.text.muted, fontSize: fonts.xxs, fontWeight: fonts.semibold }}>
