...
export function TokenomicsScreen({ onClose }: Props) {
  ...
  const s = useMemo(() => StyleSheet.create({
    ...
    statLabel: { color: t.text.secondary, fontSize: fonts.md },
    ...
    channelName: { color: t.text.primary, fontSize: fonts.md, flex: 1 },
    channelPct: { color: t.text.secondary, fontSize: fonts.md, fontWeight: fonts.bold },
    barBg: { height: 8, backgroundColor: t.border, borderRadius: 4, marginTop: 4 },
    barFill: { height: 8, borderRadius: 4 },
    earnIcon: { fontSize: fonts.xxxl, marginRight: 12 },
    ...
    ringNumText: { color: t.accent.blue, fontSize: fonts.md, fontWeight: fonts.heavy },
    ringLabel: { color: t.text.primary, fontSize: fonts.md, fontWeight: fonts.bold },
    ringAttr: { color: t.accent.green, fontSize: fonts.sm, fontWeight: fonts.bold },
    ringDesc: { color: t.text.muted, fontSize: fonts.sm, marginTop: 2 },
    ...
    compareHeaderCell: { flex: 1, color: t.text.primary, fontSize: fonts.sm, fontWeight: fonts.heavy, textAlign: 'center' },
    ...
    compareCell: { flex: 1, fontSize: fonts.xs, lineHeight: 16, paddingHorizontal: 2 },
    ...
    treasuryTitle: { color: t.accent.purple, fontSize: fonts.md, fontWeight: fonts.bold },
    treasuryDesc: { color: t.text.secondary, fontSize: fonts.sm, lineHeight: 20, marginTop: 8 },
    ...
    stakingLabel: { color: t.text.secondary, fontSize: fonts.md },
    stakingValue: { color: t.accent.green, fontSize: fonts.md, fontWeight: fonts.bold },
