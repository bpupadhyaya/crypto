...
export function TokenomicsScreen({ onClose }: Props) {
  ...
  const s = useMemo(() => StyleSheet.create({
    ...
    channelPct: { color: t.text.secondary, fontSize: 14, fontWeight: '700' },
    ...
    ringNumText: { color: t.accent.blue, fontSize: 14, fontWeight: '800' },
    ringLabel: { color: t.text.primary, fontSize: 14, fontWeight: '700' },
    ringAttr: { color: t.accent.green, fontSize: 13, fontWeight: '700' },
    ...
    compareHeaderCell: { flex: 1, color: t.text.primary, fontSize: 12, fontWeight: '800', textAlign: 'center' },
    ...
    compareLabelCell: { color: t.text.primary, fontWeight: '700' },
    ...
    treasuryTitle: { color: t.accent.purple, fontSize: 15, fontWeight: '700' },
    ...
    stakingValue: { color: t.accent.green, fontSize: 14, fontWeight: '700' },
    maxApy: { color: t.accent.blue, fontWeight: '800' },
  }), [t]);
