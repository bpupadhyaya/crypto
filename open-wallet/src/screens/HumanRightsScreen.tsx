...
export function HumanRightsScreen({ onClose }: Props) {
  ...
  const s = useMemo(() => StyleSheet.create({
    ...
    articleText: { color: '#AF52DE', fontSize: fonts.md, fontWeight: fonts.heavy },
    rightTitle: { color: t.text.primary, fontSize: fonts.md, fontWeight: fonts.bold, flex: 1 },
    rightSummary: { color: t.text.muted, fontSize: fonts.sm, marginTop: 8, lineHeight: 19 },
    ...
    scoreText: { fontSize: fonts.md, fontWeight: fonts.bold, width: 40 },
    monitorCard: { backgroundColor: t.bg.secondary, borderRadius: 14, padding: 16, marginHorizontal: 20, marginBottom: 12 },
    monArea: { color: t.text.primary, fontSize: fonts.md, fontWeight: fonts.bold },
    monMeta: { color: t.text.muted, fontSize: fonts.sm, marginTop: 4 },
    ...
    trendText: { color: '#fff', fontSize: fonts.xs, fontWeight: fonts.semibold, textTransform: 'uppercase' },
    repCard: { backgroundColor: t.bg.secondary, borderRadius: 14, padding: 16, marginHorizontal: 20, marginBottom: 12 },
    repTitle: { color: t.text.primary, fontSize: fonts.md, fontWeight: fonts.bold },
    repMeta: { color: t.text.muted, fontSize: fonts.sm, marginTop: 4 },
    badgeRow: { flexDirection: 'row', gap: 8, marginTop: 8 },
    badge: { paddingHorizontal: 8, paddingVertical: 2, borderRadius: 8 },
    badgeText: { color: '#fff', fontSize: fonts.xs, fontWeight: fonts.semibold, textTransform: 'uppercase' },
    supporters: { color: t.text.muted, fontSize: fonts.sm, marginTop: 6 },
    ...
    eduMeta: { color: t.text.muted, fontSize: fonts.sm, marginTop: 4 },
    eduDesc: { color: t.text.muted, fontSize: fonts.sm, marginTop: 6, lineHeight: 19 },
    ...
    typeText: { color: '#AF52DE', fontSize: fonts.xs, fontWeight: fonts.semibold },
