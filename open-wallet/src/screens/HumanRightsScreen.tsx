...
export function HumanRightsScreen({ onClose }: Props) {
  ...
  const s = useMemo(() => StyleSheet.create({
    ...
    articleText: { color: '#AF52DE', fontSize: 14, fontWeight: '800' },
    rightTitle: { color: t.text.primary, fontSize: 15, fontWeight: '700', flex: 1 },
    ...
    trendText: { color: '#fff', fontSize: 11, fontWeight: '600', textTransform: 'uppercase' },
    repCard: { backgroundColor: t.bg.secondary, borderRadius: 14, padding: 16, marginHorizontal: 20, marginBottom: 12 },
    repTitle: { color: t.text.primary, fontSize: 14, fontWeight: '700' },
    ...
    typeText: { color: '#AF52DE', fontSize: 11, fontWeight: '600' },
