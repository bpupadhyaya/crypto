...
export function PenPalScreen({ onClose }: Props) {
  ...
  const s = useMemo(() => StyleSheet.create({
    ...
    heroTitle: { color: t.text.primary, fontSize: 18, fontWeight: fonts.heavy, textAlign: 'center' as const },
    heroSubtitle: { color: t.text.muted, fontSize: 13, textAlign: 'center' as const, marginTop: 4, lineHeight: 20 },
    ...
    statLabel: { color: t.text.muted, fontSize: 11, marginTop: 2, textTransform: 'uppercase' as const, letterSpacing: 1 },
    // Pal cards
    palCard: { backgroundColor: t.bg.secondary, borderRadius: 16, padding: 16, marginHorizontal: 20, marginBottom: 12 },
    palName: { color: t.text.primary, fontSize: 17, fontWeight: fonts.bold },
    palInfo: { color: t.text.muted, fontSize: 13, marginTop: 2 },
    palLanguages: { color: t.accent.purple, fontSize: 12, fontWeight: fonts.semibold, marginTop: 4 },
    palInterests: { color: t.text.secondary, fontSize: 12, marginTop: 4 },
    ...
    palMetaText: { color: t.text.muted, fontSize: 11 },
    // Letters
    letterCard: { backgroundColor: t.bg.secondary, borderRadius: 16, padding: 16, marginHorizontal: 20, marginBottom: 12 },
    letterFrom: { color: t.accent.blue, fontSize: 13, fontWeight: fonts.bold },
    letterTopic: { color: t.text.primary, fontSize: 15, fontWeight: fonts.bold, marginTop: 4 },
    letterPreview: { color: t.text.secondary, fontSize: 13, marginTop: 6, lineHeight: 20 },
    letterDate: { color: t.text.muted, fontSize: 11, marginTop: 8 },
    letterEncrypted: { color: t.accent.green, fontSize: 11, fontWeight: fonts.semibold },
    // Full letter view
    fullLetterCard: { backgroundColor: t.bg.secondary, borderRadius: 20, padding: 24, marginHorizontal: 20, marginBottom: 16 },
    fullLetterBody: { color: t.text.primary, fontSize: 15, lineHeight: 24, marginTop: 12 },
    backBtn: { color: t.accent.blue, fontSize: 14, fontWeight: fonts.semibold, marginLeft: 20, marginBottom: 12 },
    // Write tab
    ...
    inputLabel: { color: t.text.secondary, fontSize: 13, fontWeight: fonts.semibold, marginBottom: 8, textTransform: 'uppercase' as const, letterSpacing: 1 },
    ...
    palChipText: { color: t.text.secondary, fontSize: 13, fontWeight: fonts.semibold },
    ...
    topicIcon: { color: t.text.muted, fontSize: 14, fontWeight: fonts.bold },
    topicIconActive: { color: '#fff' },
    topicLabel: { color: t.text.secondary, fontSize: 12, fontWeight: fonts.semibold },
    topicLabelActive: { color: '#fff' },
    letterInput: { backgroundColor: t.bg.primary, borderRadius: 12, padding: 14, color: t.text.primary, fontSize: 15, minHeight: 180, textAlignVertical: 'top' as const },
    charCount: { color: t.text.muted, fontSize: 11, textAlign: 'right' as const, marginTop: 4 },
    ...
    matchName: { color: t.text.primary, fontSize: 17, fontWeight: fonts.bold },
    matchScore: { color: t.accent.green, fontSize: 14, fontWeight: fonts.heavy },
    matchRegion: { color: t.text.muted, fontSize: 13, marginTop: 2 },
    matchLanguages: { color: t.accent.purple, fontSize: 12, fontWeight: fonts.semibold, marginTop: 4 },
    matchInterests: { color: t.text.secondary, fontSize: 12, marginTop: 4 },
    matchReason: { color: t.text.muted, fontSize: 12, fontStyle: 'italic', marginTop: 8 },
    connectBtn: { backgroundColor: t.accent.blue, borderRadius: 12, paddingVertical: 10, alignItems: 'center' as const, marginTop: 12 },
    connectBtnText: { color: '#fff', fontSize: 14, fontWeight: fonts.bold },
    // Safety tab
    safetyCard: { backgroundColor: t.bg.secondary, borderRadius: 16, padding: 16, marginHorizontal: 20, marginBottom: 12 },
    safetyTitle: { color: t.text.primary, fontSize: 15, fontWeight: fonts.bold },
    safetyDesc: { color: t.text.secondary, fontSize: 13, marginTop: 4, lineHeight: 20 },
    ...
    safetyHeroTitle: { color: '#FF3B30', fontSize: 16, fontWeight: fonts.heavy, marginTop: 8 },
    safetyHeroSubtitle: { color: t.text.muted, fontSize: 13, textAlign: 'center' as const, marginTop: 4, lineHeight: 20 },
    demoTag: { color: t.accent.orange, fontSize: 11, fontWeight: fonts.bold, textAlign: 'center' as const, marginBottom: 8 },
    emptyText: { color: t.text.muted, fontSize: 14, textAlign: 'center' as const, paddingVertical: 40 },
  }), [t]);
