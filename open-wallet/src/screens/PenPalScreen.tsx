...
export function PenPalScreen({ onClose }: Props) {
  ...
  const s = useMemo(() => StyleSheet.create({
    ...
    heroTitle: { color: t.text.primary, fontSize: 18, fontWeight: '800', textAlign: 'center' as const },
    ...
    palName: { color: t.text.primary, fontSize: 17, fontWeight: '700' },
    palInfo: { color: t.text.muted, fontSize: 13, marginTop: 2 },
    palLanguages: { color: t.accent.purple, fontSize: 12, fontWeight: '600', marginTop: 4 },
    ...
    letterFrom: { color: t.accent.blue, fontSize: 13, fontWeight: '700' },
    letterTopic: { color: t.text.primary, fontSize: 15, fontWeight: '700', marginTop: 4 },
    ...
    letterEncrypted: { color: t.accent.green, fontSize: 11, fontWeight: '600' },
    // Full letter view
    ...
    backBtn: { color: t.accent.blue, fontSize: 14, fontWeight: '600', marginLeft: 20, marginBottom: 12 },
    // Write tab
    ...
    inputLabel: { color: t.text.secondary, fontSize: 13, fontWeight: '600', marginBottom: 8, textTransform: 'uppercase' as const, letterSpacing: 1 },
    ...
    palChipText: { color: t.text.secondary, fontSize: 13, fontWeight: '600' },
    ...
    topicIcon: { color: t.text.muted, fontSize: 14, fontWeight: '700' },
    topicIconActive: { color: '#fff' },
    topicLabel: { color: t.text.secondary, fontSize: 12, fontWeight: '600' },
    ...
    matchName: { color: t.text.primary, fontSize: 17, fontWeight: '700' },
    matchScore: { color: t.accent.green, fontSize: 14, fontWeight: '800' },
    matchRegion: { color: t.text.muted, fontSize: 13, marginTop: 2 },
    matchLanguages: { color: t.accent.purple, fontSize: 12, fontWeight: '600', marginTop: 4 },
    ...
    safetyTitle: { color: t.text.primary, fontSize: 15, fontWeight: '700' },
    ...
    safetyHeroTitle: { color: '#FF3B30', fontSize: 16, fontWeight: '800', marginTop: 8 },
    safetyHeroSubtitle: { color: t.text.muted, fontSize: 13, textAlign: 'center' as const, marginTop: 4, lineHeight: 20 },
    demoTag: { color: t.accent.orange, fontSize: 11, fontWeight: '700', textAlign: 'center' as const, marginBottom: 8 },
