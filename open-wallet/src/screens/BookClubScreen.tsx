...
export function BookClubScreen({ onClose }: Props) {
  ...
  const s = useMemo(() => StyleSheet.create({
    ...
    clubName: { color: t.text.primary, fontSize: 16, fontWeight: fonts.bold },
    clubBook: { color: t.accent.purple, fontSize: 14, fontWeight: fonts.semibold, marginTop: 4 },
    clubAuthor: { color: t.text.muted, fontSize: 13 },
    clubMeta: { color: t.text.muted, fontSize: 12, marginTop: 6 },
    ...
    eotkText: { color: t.accent.purple, fontSize: 14, fontWeight: fonts.bold },
    joinedBadge: { backgroundColor: t.accent.green + '20', paddingHorizontal: 12, paddingVertical: 6, borderRadius: 10 },
    joinedText: { color: t.accent.green, fontSize: 12, fontWeight: fonts.bold },
    ...
    challengeTitle: { color: t.text.primary, fontSize: 17, fontWeight: fonts.heavy },
    challengeDesc: { color: t.text.secondary, fontSize: 13, marginTop: 6, lineHeight: 20 },
    ...
    progressText: { color: t.text.muted, fontSize: 12, marginTop: 6 },
    challengeStats: { flexDirection: 'row', justifyContent: 'space-around', marginTop: 14 },
    challengeStat: { alignItems: 'center' },
    challengeStatValue: { color: t.text.primary, fontSize: 18, fontWeight: fonts.heavy },
    challengeStatLabel: { color: t.text.muted, fontSize: 11, marginTop: 2 },
    challengeJoinBtn: { backgroundColor: t.accent.purple, borderRadius: 12, paddingVertical: 12, alignItems: 'center', marginTop: 14 },
    challengeJoinText: { color: '#fff', fontSize: 15, fontWeight: fonts.bold },
    // Discussions
    threadCard: { backgroundColor: t.bg.secondary, borderRadius: 14, padding: 16, marginHorizontal: 20, marginBottom: 12 },
    threadBook: { color: t.accent.purple, fontSize: 12, fontWeight: fonts.bold, textTransform: 'uppercase', letterSpacing: 1 },
    threadTopic: { color: t.text.primary, fontSize: 14, fontWeight: fonts.bold, marginTop: 4 },
    threadMeta: { color: t.text.muted, fontSize: 12, marginTop: 6 },
    threadFooter: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', marginTop: 10 },
    threadReplies: { color: t.text.secondary, fontSize: 13, fontWeight: fonts.semibold },
    threadEotk: { color: t.accent.purple, fontSize: 12, fontWeight: fonts.semibold },
    discussBtn: { backgroundColor: t.accent.blue, paddingHorizontal: 14, paddingVertical: 6, borderRadius: 8 },
    discussBtnText: { color: '#fff', fontSize: 12, fontWeight: fonts.semibold },
    // Recommendations
    ...
    genreText: { color: t.text.muted, fontSize: 12, fontWeight: fonts.semibold },
    ...
    recTitle: { color: t.text.primary, fontSize: 15, fontWeight: fonts.bold },
    recAuthor: { color: t.text.muted, fontSize: 13 },
    recDesc: { color: t.text.secondary, fontSize: 13, marginTop: 6, lineHeight: 20 },
    recFooter: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', marginTop: 10 },
    recGenre: { color: t.accent.purple, fontSize: 11, fontWeight: fonts.bold, textTransform: 'uppercase', letterSpacing: 1 },
    ...
    upvoteText: { color: t.text.secondary, fontSize: 13, fontWeight: fonts.semibold },
    // Misc
