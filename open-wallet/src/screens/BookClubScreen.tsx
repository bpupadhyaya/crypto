...
export function BookClubScreen({ onClose }: Props) {
  ...
  const s = useMemo(() => StyleSheet.create({
    ...
    clubName: { color: t.text.primary, fontSize: 16, fontWeight: '700' },
    clubBook: { color: t.accent.purple, fontSize: 14, fontWeight: '600', marginTop: 4 },
    ...
    eotkText: { color: t.accent.purple, fontSize: 14, fontWeight: '700' },
    joinedBadge: { backgroundColor: t.accent.green + '20', paddingHorizontal: 12, paddingVertical: 6, borderRadius: 10 },
    joinedText: { color: t.accent.green, fontSize: 12, fontWeight: '700' },
    ...
    challengeTitle: { color: t.text.primary, fontSize: 17, fontWeight: '800' },
    ...
    challengeStatValue: { color: t.text.primary, fontSize: 18, fontWeight: '800' },
    ...
    challengeJoinText: { color: '#fff', fontSize: 15, fontWeight: '700' },
    // Discussions
    threadCard: { backgroundColor: t.bg.secondary, borderRadius: 14, padding: 16, marginHorizontal: 20, marginBottom: 12 },
    threadBook: { color: t.accent.purple, fontSize: 12, fontWeight: '700', textTransform: 'uppercase', letterSpacing: 1 },
    threadTopic: { color: t.text.primary, fontSize: 14, fontWeight: '700', marginTop: 4 },
    ...
    threadReplies: { color: t.text.secondary, fontSize: 13, fontWeight: '600' },
    threadEotk: { color: t.accent.purple, fontSize: 12, fontWeight: '600' },
    discussBtn: { backgroundColor: t.accent.blue, paddingHorizontal: 14, paddingVertical: 6, borderRadius: 8 },
    discussBtnText: { color: '#fff', fontSize: 12, fontWeight: '600' },
    // Recommendations
    ...
    genreText: { color: t.text.muted, fontSize: 12, fontWeight: '600' },
    ...
    recTitle: { color: t.text.primary, fontSize: 15, fontWeight: '700' },
    ...
    recGenre: { color: t.accent.purple, fontSize: 11, fontWeight: '700', textTransform: 'uppercase', letterSpacing: 1 },
