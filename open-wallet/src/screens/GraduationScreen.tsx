...
export function GraduationScreen({ onClose }: Props) {
  ...
  const s = useMemo(() => StyleSheet.create({
    ...
    ceremonyTitle: { color: t.text.primary, fontSize: 16, fontWeight: '700' },
    ceremonyInst: { color: t.accent.blue, fontSize: 13, fontWeight: '600', marginTop: 2 },
    ...
    certTitle: { color: t.text.primary, fontSize: 15, fontWeight: '700', flex: 1 },
    certType: { paddingHorizontal: 8, paddingVertical: 3, borderRadius: 6 },
    certTypeText: { color: '#fff', fontSize: 10, fontWeight: '700' },
    certMeta: { color: t.text.muted, fontSize: 12, marginTop: 4 },
    certGrade: { color: t.accent.green, fontSize: 13, fontWeight: '700', marginTop: 4 },
    certHash: { color: t.accent.blue, fontSize: 11, marginTop: 4, fontFamily: 'monospace' },
    certEotk: { color: t.accent.green, fontSize: 14, fontWeight: '800', marginTop: 6 },
    ...
    celName: { color: t.text.primary, fontSize: 15, fontWeight: '700' },
    celAchievement: { color: t.accent.blue, fontSize: 13, fontWeight: '600', marginTop: 2 },
    ...
    celBtnText: { color: '#fff', fontSize: 12, fontWeight: '600' },
