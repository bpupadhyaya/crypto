...
export function GraduationScreen({ onClose }: Props) {
  ...
  const s = useMemo(() => StyleSheet.create({
    ...
    ceremonyTitle: { color: t.text.primary, fontSize: fonts.lg, fontWeight: fonts.bold },
    ceremonyInst: { color: t.accent.blue, fontSize: fonts.sm, fontWeight: fonts.semibold, marginTop: 2 },
    ceremonyMeta: { color: t.text.muted, fontSize: fonts.sm, marginTop: 6, lineHeight: 18 },
    ...
    rsvpBtnText: { color: '#fff', fontSize: fonts.sm, fontWeight: fonts.semibold },
    rsvpClosed: { color: t.text.muted, fontSize: fonts.sm, fontStyle: 'italic', marginTop: 10 },
    ...
    certTitle: { color: t.text.primary, fontSize: fonts.md, fontWeight: fonts.bold, flex: 1 },
    certType: { paddingHorizontal: 8, paddingVertical: 3, borderRadius: 6 },
    certTypeText: { color: '#fff', fontSize: fonts.xs, fontWeight: fonts.bold },
    certMeta: { color: t.text.muted, fontSize: fonts.sm, marginTop: 4 },
    certGrade: { color: t.accent.green, fontSize: fonts.sm, fontWeight: fonts.bold, marginTop: 4 },
    certHash: { color: t.accent.blue, fontSize: fonts.xs, marginTop: 4, fontFamily: 'monospace' },
    certEotk: { color: t.accent.green, fontSize: fonts.md, fontWeight: fonts.heavy, marginTop: 6 },
    ...
    celName: { color: t.text.primary, fontSize: fonts.md, fontWeight: fonts.bold },
    celAchievement: { color: t.accent.blue, fontSize: fonts.sm, fontWeight: fonts.semibold, marginTop: 2 },
    celMessage: { color: t.text.muted, fontSize: fonts.sm, marginTop: 8, lineHeight: 20, fontStyle: 'italic' },
    celFooter: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', marginTop: 10 },
    celLikes: { color: t.text.muted, fontSize: fonts.sm },
    celBtn: { backgroundColor: t.accent.green, paddingHorizontal: 14, paddingVertical: 6, borderRadius: 8 },
    celBtnText: { color: '#fff', fontSize: fonts.sm, fontWeight: fonts.semibold },
