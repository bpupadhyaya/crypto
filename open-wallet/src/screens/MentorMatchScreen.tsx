...
export function MentorMatchScreen({ onClose }: Props) {
  ...
  const s = useMemo(() => StyleSheet.create({
    ...
    roleTag: { fontSize: fonts.xs, fontWeight: fonts.bold, textTransform: 'uppercase', letterSpacing: 1 },
    partnerName: { color: t.text.primary, fontSize: fonts.md, fontWeight: fonts.bold, marginTop: 4 },
    expertiseLabel: { color: t.text.secondary, fontSize: fonts.sm, marginTop: 2 },
    statsRow: { flexDirection: 'row', justifyContent: 'space-between', marginTop: 10, flexWrap: 'wrap' },
    statChip: { color: t.text.secondary, fontSize: fonts.sm },
    ...
    nextSessionText: { color: t.accent.blue, fontSize: fonts.xs, fontWeight: fonts.semibold },
    ...
    viewAgreementText: { color: t.accent.purple, fontSize: fonts.sm, fontWeight: fonts.bold },
    ...
    agreementTitle: { color: t.text.primary, fontSize: fonts.lg, fontWeight: fonts.heavy, marginBottom: 12 },
    agreementRow: { flexDirection: 'row', justifyContent: 'space-between', paddingVertical: 6 },
    agreementLabel: { color: t.text.muted, fontSize: fonts.sm },
    agreementValue: { color: t.text.primary, fontSize: fonts.sm, fontWeight: fonts.semibold },
    goalItem: { flexDirection: 'row', alignItems: 'center', paddingVertical: 4 },
    goalBullet: { color: t.accent.purple, fontSize: fonts.md, marginRight: 8 },
    goalText: { color: t.text.secondary, fontSize: fonts.sm, flex: 1 },
    ...
    chainBadgeText: { color: t.accent.green, fontSize: fonts.xs, fontWeight: fonts.bold },
    ...
    matchName: { color: t.text.primary, fontSize: fonts.md, fontWeight: fonts.bold },
    matchScoreBadge: { borderRadius: 12, paddingVertical: 4, paddingHorizontal: 10 },
    matchScoreText: { fontSize: fonts.sm, fontWeight: fonts.heavy },
    matchBio: { color: t.text.secondary, fontSize: fonts.sm, marginTop: 6, lineHeight: 18 },
    matchDetail: { color: t.text.muted, fontSize: fonts.xs, marginTop: 4 },
    ...
    overlapTagText: { color: t.accent.green, fontSize: fonts.xs, fontWeight: fonts.bold },
    ...
    matchStat: { color: t.text.secondary, fontSize: fonts.sm },
    ...
    requestBtnText: { color: '#fff', fontSize: fonts.sm, fontWeight: fonts.bold },

    /* ── Sessions ── */
    sessionCard: { backgroundColor: t.bg.card, borderRadius: 16, padding: 16, marginBottom: 12, borderLeftWidth: 3 },
    sessionDate: { color: t.text.primary, fontSize: fonts.md, fontWeight: fonts.bold },
    sessionPartner: { color: t.text.secondary, fontSize: fonts.sm, marginTop: 2 },
    sessionDuration: { color: t.text.muted, fontSize: fonts.xs, marginTop: 2 },
    sessionNotes: { color: t.text.secondary, fontSize: fonts.sm, marginTop: 8, lineHeight: 18, fontStyle: 'italic' },
    sessionEOTK: { color: t.accent.green, fontSize: fonts.sm, fontWeight: fonts.bold, marginTop: 6 },
    ...
    feedbackLabel: { color: t.text.muted, fontSize: fonts.xs, fontWeight: fonts.semibold },
    feedbackContent: { color: t.text.secondary, fontSize: fonts.sm, marginTop: 4, lineHeight: 18 },
    feedbackRating: { color: t.accent.orange, fontSize: fonts.sm, fontWeight: fonts.bold, marginTop: 2 },
    ...
    giveFeedbackText: { color: t.accent.purple, fontSize: fonts.sm, fontWeight: fonts.bold },
    ...
    feedbackFormTitle: { color: t.text.primary, fontSize: fonts.md, fontWeight: fonts.bold, marginBottom: 10 },
    ...
    ratingBtnText: { fontSize: fonts.md, fontWeight: fonts.bold, color: t.text.muted },
    ratingBtnTextActive: { color: '#fff' },
    feedbackInput: { backgroundColor: t.bg.primary, borderRadius: 10, padding: 12, color: t.text.primary, fontSize: fonts.sm, borderWidth: 1, borderColor: t.border, height: 70, textAlignVertical: 'top' },
    ...
    registerTitle: { color: t.text.primary, fontSize: fonts.lg, fontWeight: fonts.heavy, marginBottom: 4 },
    registerSub: { color: t.text.muted, fontSize: fonts.sm, marginBottom: 16, lineHeight: 18 },
    registerLabel: { color: t.text.primary, fontSize: fonts.md, fontWeight: fonts.semibold, marginBottom: 8, marginTop: 12 },
    ...
    chipTextActive: { color: t.accent.blue, fontWeight: fonts.semibold },
    input: { backgroundColor: t.bg.primary, borderRadius: 12, padding: 14, color: t.text.primary, fontSize: fonts.md, borderWidth: 1, borderColor: t.border, height: 80, textAlignVertical: 'top' },
    registerBtn: { backgroundColor: t.accent.green, borderRadius: 14, paddingVertical: 14, alignItems: 'center', marginTop: 16 },
    registerBtnText: { color: '#fff', fontSize: fonts.lg, fontWeight: fonts.bold },
