...
export function MentorMatchScreen({ onClose }: Props) {
  ...
  const s = useMemo(() => StyleSheet.create({
    ...
    roleTag: { fontSize: 11, fontWeight: fonts.bold, textTransform: 'uppercase', letterSpacing: 1 },
    partnerName: { color: t.text.primary, fontSize: 15, fontWeight: fonts.bold, marginTop: 4 },
    ...
    nextSessionText: { color: t.accent.blue, fontSize: 11, fontWeight: fonts.semibold },
    ...
    viewAgreementText: { color: t.accent.purple, fontSize: 13, fontWeight: fonts.bold },
    ...
    agreementTitle: { color: t.text.primary, fontSize: 16, fontWeight: fonts.heavy, marginBottom: 12 },
    ...
    agreementValue: { color: t.text.primary, fontSize: 13, fontWeight: fonts.semibold },
    ...
    chainBadgeText: { color: t.accent.green, fontSize: 11, fontWeight: fonts.bold },
    ...
    matchScoreText: { fontSize: 13, fontWeight: fonts.heavy },
    ...
    overlapTagText: { color: t.accent.green, fontSize: 10, fontWeight: fonts.bold },
    skillTag: { backgroundColor: t.accent.blue + '20', paddingVertical: 3, paddingHorizontal: 8, borderRadius: 6 },
    skillTagText: { color: t.accent.blue, fontSize: 10, fontWeight: fonts.semibold },
    ...
    requestBtnText: { color: '#fff', fontSize: 13, fontWeight: fonts.bold },

    /* ── Sessions ── */
    sessionCard: { backgroundColor: t.bg.card, borderRadius: 16, padding: 16, marginBottom: 12, borderLeftWidth: 3 },
    sessionDate: { color: t.text.primary, fontSize: 14, fontWeight: fonts.bold },
    ...
    sessionEOTK: { color: t.accent.green, fontSize: 13, fontWeight: fonts.bold, marginTop: 6 },
    ...
    feedbackLabel: { color: t.text.muted, fontSize: 11, fontWeight: fonts.semibold },
    feedbackContent: { color: t.text.secondary, fontSize: 12, marginTop: 4, lineHeight: 18 },
    feedbackRating: { color: t.accent.orange, fontSize: 12, fontWeight: fonts.bold, marginTop: 2 },
    ...
    giveFeedbackText: { color: t.accent.purple, fontSize: 13, fontWeight: fonts.bold },
    ...
    feedbackFormTitle: { color: t.text.primary, fontSize: 14, fontWeight: fonts.bold, marginBottom: 10 },
    ...
    ratingBtnText: { fontSize: 14, fontWeight: fonts.bold, color: t.text.muted },
    ...
    submitBtnText: { color: '#fff', fontSize: 14, fontWeight: fonts.bold },

    /* ── Become a mentor ── */
    registerCard: { backgroundColor: t.bg.card, borderRadius: 20, padding: 20, marginBottom: 16 },
    registerTitle: { color: t.text.primary, fontSize: 16, fontWeight: fonts.heavy, marginBottom: 4 },
    registerSub: { color: t.text.muted, fontSize: 12, marginBottom: 16, lineHeight: 18 },
    registerLabel: { color: t.text.primary, fontSize: 14, fontWeight: fonts.semibold, marginBottom: 8, marginTop: 12 },
    ...
    registerBtnText: { color: '#fff', fontSize: 16, fontWeight: fonts.bold },
