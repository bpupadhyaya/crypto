...
export function CulturalHeritageScreen({ onClose }: Props) {
  ...
  const s = useMemo(() => StyleSheet.create({
    ...
    filterChipText: { color: t.text.muted, fontSize: fonts.sm, fontWeight: fonts.semibold },
    ...
    heritageTitle: { color: t.text.primary, fontSize: fonts.md, fontWeight: fonts.bold, flex: 1 },
    ...
    heritageDesc: { color: t.text.muted, fontSize: fonts.sm, lineHeight: 19, marginBottom: 10 },
    ...
    hashText: { color: t.accent.blue, fontSize: fonts.xs, fontWeight: fonts.semibold },
    ...
    keeperName: { color: t.text.primary, fontSize: fonts.lg, fontWeight: fonts.bold },
    keeperRegion: { color: t.accent.orange, fontSize: fonts.sm, fontWeight: fonts.semibold, marginTop: 2 },
    ...
    specialtyText: { color: t.accent.orange, fontSize: fonts.xs, fontWeight: fonts.semibold },
    alertCard: { borderRadius: 14, padding: 16, marginHorizontal: 20, marginBottom: 12 },
    alertTitle: { color: t.text.primary, fontSize: fonts.md, fontWeight: fonts.bold },
    alertPractitioners: { fontSize: fonts.xxxl, fontWeight: fonts.heavy, marginTop: 6 },
    alertLabel: { color: t.text.muted, fontSize: fonts.xs, textTransform: 'uppercase', letterSpacing: 1 },
    alertRegion: { color: t.text.muted, fontSize: fonts.sm, marginTop: 6 },
    ...
    fundText: { color: t.accent.green, fontSize: fonts.sm, fontWeight: fonts.bold },
    apprenticeCard: { backgroundColor: t.bg.secondary, borderRadius: 14, padding: 16, marginHorizontal: 20, marginBottom: 12 },
    apprenticeTitle: { color: t.text.primary, fontSize: fonts.md, fontWeight: fonts.bold },
    apprenticeMeta: { color: t.text.muted, fontSize: fonts.sm, marginTop: 4 },
    ...
    detailValue: { color: t.text.primary, fontSize: fonts.md, fontWeight: fonts.bold },
    ...
    applyText: { color: '#fff', fontSize: fonts.md, fontWeight: fonts.bold },
    exchangeCard: { backgroundColor: t.bg.secondary, borderRadius: 14, padding: 16, marginHorizontal: 20, marginBottom: 12 },
    exchangeRoute: { color: t.accent.orange, fontSize: fonts.sm, fontWeight: fonts.bold },
    exchangeTradition: { color: t.text.primary, fontSize: fonts.md, fontWeight: fonts.bold, marginTop: 4 },
    exchangeMeta: { color: t.text.muted, fontSize: fonts.sm, marginTop: 4 },
    ...
    fundTotal: { color: t.accent.green, fontSize: fonts.hero, fontWeight: fonts.heavy },
    fundTotalLabel: { color: t.text.muted, fontSize: fonts.sm, textTransform: 'uppercase', letterSpacing: 1, marginTop: 2 },
    ...
    proposeText: { color: '#fff', fontSize: fonts.md, fontWeight: fonts.bold },
    noHashText: { color: t.text.muted, fontSize: fonts.xs, fontStyle: 'italic' },
  }), [t]);
        ...
        {DEMO_HERITAGE.map((item) => {
          ...
          return (
            <View key={item.id} style={{ flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', paddingVertical: 10, borderBottomColor: t.bg.primary, borderBottomWidth: 1 }}>
              <View style={{ flex: 1 }}>
                <Text style={{ color: t.text.primary, fontSize: fonts.sm, fontWeight: fonts.semibold }}>{item.title}</Text>
                <Text style={{ color: t.text.muted, fontSize: fonts.xs }}>{item.practitioners} practitioners</Text>
              </View>
              <View style={[s.endangeredBadge, { backgroundColor: riskColor + '20' }]}>
                <Text style={[s.endangeredText, { color: riskColor }]}>{riskLevel.toUpperCase()}</Text>
              </View>
