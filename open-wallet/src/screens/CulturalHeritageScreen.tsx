...
export function CulturalHeritageScreen({ onClose }: Props) {
  ...
  const s = useMemo(() => StyleSheet.create({
    ...
    heritageTitle: { color: t.text.primary, fontSize: 15, fontWeight: '700', flex: 1 },
    ...
    hashText: { color: t.accent.blue, fontSize: 11, fontWeight: '600' },
    ...
    keeperName: { color: t.text.primary, fontSize: 16, fontWeight: '700' },
    keeperRegion: { color: t.accent.orange, fontSize: 12, fontWeight: '600', marginTop: 2 },
    ...
    specialtyText: { color: t.accent.orange, fontSize: 11, fontWeight: '600' },
    alertCard: { borderRadius: 14, padding: 16, marginHorizontal: 20, marginBottom: 12 },
    alertTitle: { color: t.text.primary, fontSize: 15, fontWeight: '700' },
    alertPractitioners: { fontSize: 28, fontWeight: '900', marginTop: 6 },
    ...
    fundText: { color: t.accent.green, fontSize: 13, fontWeight: '700' },
    apprenticeCard: { backgroundColor: t.bg.secondary, borderRadius: 14, padding: 16, marginHorizontal: 20, marginBottom: 12 },
    apprenticeTitle: { color: t.text.primary, fontSize: 15, fontWeight: '700' },
    ...
    detailValue: { color: t.text.primary, fontSize: 14, fontWeight: '700' },
    ...
    exchangeRoute: { color: t.accent.orange, fontSize: 13, fontWeight: '700' },
    exchangeTradition: { color: t.text.primary, fontSize: 15, fontWeight: '700', marginTop: 4 },
    ...
    fundTotal: { color: t.accent.green, fontSize: 36, fontWeight: '900' },
    ...
    proposeText: { color: '#fff', fontSize: 14, fontWeight: '700' },
        ...
        {DEMO_HERITAGE.map((item) => {
          ...
          return (
            <View key={item.id} style={{ flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', paddingVertical: 10, borderBottomColor: t.bg.primary, borderBottomWidth: 1 }}>
              <View style={{ flex: 1 }}>
                <Text style={{ color: t.text.primary, fontSize: 13, fontWeight: '600' }}>{item.title}</Text>
