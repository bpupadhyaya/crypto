...
export function DataDashboardScreen({ onClose }: Props) {
  ...
  const styles = useMemo(() => StyleSheet.create({
    ...
    scoreLabel: { fontSize: fonts.md, color: t.text.secondary, marginTop: 4 },
    ...
    flowLabel: { fontSize: fonts.sm, color: t.text.primary, width: 80 },
    flowValue: { fontSize: fonts.sm, fontWeight: fonts.semibold, width: 60, textAlign: 'right' },
    ...
    channelName: { fontSize: fonts.md, color: t.text.primary, width: 90 },
    channelPct: { fontSize: fonts.md, fontWeight: fonts.semibold, width: 45, textAlign: 'right' },
