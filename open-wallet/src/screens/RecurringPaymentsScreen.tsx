...
export const RecurringPaymentsScreen = React.memo(({ onClose }: Props) => {
  ...
  const s = useMemo(() => StyleSheet.create({
    ...
    freqText: { color: t.text.secondary, fontSize: fonts.md, fontWeight: fonts.semibold },
    ...
    cardLabel: { color: t.text.primary, fontSize: fonts.md, fontWeight: fonts.bold, flex: 1 },
    cardAmount: { color: t.accent.green, fontSize: fonts.lg, fontWeight: fonts.heavy },
    cardRecipient: { color: t.text.muted, fontSize: fonts.sm, marginBottom: 4 },
    ...
    nextDate: { color: t.text.secondary, fontSize: fonts.sm },
    overdueText: { color: t.accent.red, fontSize: fonts.sm, fontWeight: fonts.semibold },
    ...
    actionText: { fontSize: fonts.sm, fontWeight: fonts.semibold },
    historyRow: { backgroundColor: t.bg.card, marginHorizontal: 16, borderRadius: 12, padding: 14, marginBottom: 8 },
    historyHeader: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center' },
    historyAmount: { color: t.text.primary, fontSize: fonts.md, fontWeight: fonts.semibold },
    historyDate: { color: t.text.muted, fontSize: fonts.sm },
    historyRecipient: { color: t.text.muted, fontSize: fonts.xs, marginTop: 2 },
