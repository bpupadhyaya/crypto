...
export const RecurringPaymentsScreen = React.memo(({ onClose }: Props) => {
  ...
  const s = useMemo(() => StyleSheet.create({
    ...
    freqText: { color: t.text.secondary, fontSize: 14, fontWeight: fonts.semibold },
    ...
    cardLabel: { color: t.text.primary, fontSize: 15, fontWeight: fonts.bold, flex: 1 },
    cardAmount: { color: t.accent.green, fontSize: 16, fontWeight: fonts.heavy },
    ...
    overdueText: { color: t.accent.red, fontSize: 12, fontWeight: fonts.semibold },
    ...
    actionText: { fontSize: 13, fontWeight: fonts.semibold },
    historyRow: { backgroundColor: t.bg.card, marginHorizontal: 16, borderRadius: 12, padding: 14, marginBottom: 8 },
    historyHeader: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center' },
    historyAmount: { color: t.text.primary, fontSize: 14, fontWeight: fonts.semibold },
