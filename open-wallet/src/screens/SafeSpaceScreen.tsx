...
export function SafeSpaceScreen({ onClose }: Props) {
  ...
  const s = useMemo(() => StyleSheet.create({
    ...
    urgentTitle: { color: '#ef4444', fontSize: fonts.md, fontWeight: fonts.heavy, marginBottom: 4 },
    urgentText: { color: t.text.secondary, fontSize: fonts.sm, lineHeight: 20 },
    urgentBtn: { backgroundColor: '#ef4444', borderRadius: 10, paddingVertical: 10, alignItems: 'center', marginTop: 10 },
    urgentBtnText: { color: '#fff', fontSize: fonts.md, fontWeight: fonts.bold },
    ...
    spaceName: { flex: 1, color: t.text.primary, fontSize: fonts.md, fontWeight: fonts.bold },
    spaceAvail: { paddingHorizontal: 8, paddingVertical: 3, borderRadius: 6 },
    spaceAvailText: { fontSize: fonts.xs, fontWeight: fonts.bold, color: '#fff' },
    spaceDetails: { flexDirection: 'row', gap: 12, marginBottom: 6 },
    spaceDetail: { color: t.text.muted, fontSize: fonts.sm },
    ...
    reportTitle: { color: t.text.primary, fontSize: fonts.xl, fontWeight: fonts.heavy, marginBottom: 8 },
    reportDesc: { color: t.text.secondary, fontSize: fonts.md, textAlign: 'center', lineHeight: 22, marginBottom: 16 },
    ...
    privacyText: { color: t.accent.green, fontSize: fonts.sm, fontWeight: fonts.semibold, textAlign: 'center', lineHeight: 20 },
    ...
    resourceIcon: { fontSize: fonts.xxxl },
    resourceInfo: { flex: 1 },
    resourceTitle: { color: t.text.primary, fontSize: fonts.md, fontWeight: fonts.bold, marginBottom: 2 },
    resourceCat: { color: t.text.muted, fontSize: fonts.xs, fontWeight: fonts.semibold, textTransform: 'uppercase', letterSpacing: 1, marginBottom: 4 },
