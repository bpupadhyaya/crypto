...
export function SafeSpaceScreen({ onClose }: Props) {
  ...
  const s = useMemo(() => StyleSheet.create({
    ...
    urgentTitle: { color: '#ef4444', fontSize: 15, fontWeight: fonts.heavy, marginBottom: 4 },
    ...
    urgentBtnText: { color: '#fff', fontSize: 14, fontWeight: fonts.bold },
    ...
    spaceName: { flex: 1, color: t.text.primary, fontSize: 15, fontWeight: fonts.bold },
    spaceAvail: { paddingHorizontal: 8, paddingVertical: 3, borderRadius: 6 },
    spaceAvailText: { fontSize: 10, fontWeight: fonts.bold, color: '#fff' },
    ...
    reportTitle: { color: t.text.primary, fontSize: 18, fontWeight: fonts.heavy, marginBottom: 8 },
    ...
    privacyText: { color: t.accent.green, fontSize: 13, fontWeight: fonts.semibold, textAlign: 'center', lineHeight: 20 },
    ...
    resourceInfo: { flex: 1 },
    resourceTitle: { color: t.text.primary, fontSize: 14, fontWeight: fonts.bold, marginBottom: 2 },
    resourceCat: { color: t.text.muted, fontSize: 11, fontWeight: fonts.semibold, textTransform: 'uppercase', letterSpacing: 1, marginBottom: 4 },
