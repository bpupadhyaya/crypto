...
export function SkillSwapScreen({ onClose }: Props) {
  ...
  const s = useMemo(() => StyleSheet.create({
    ...
    matchScoreText: { color: t.accent.green, fontSize: 12, fontWeight: '800' },
    ...
    matchLabel: { color: t.text.muted, fontSize: 11, fontWeight: '600', textTransform: 'uppercase' },
    matchSkill: { color: t.text.primary, fontSize: 14, fontWeight: '600' },
    ...
    matchProposeText: { color: '#fff', fontSize: 14, fontWeight: '700' },
    ...
    skillIconText: { fontSize: 14, fontWeight: '700' },
    skillInfo: { flex: 1 },
    ...
    skillLevelText: { fontSize: 10, fontWeight: '700' },
    ...
    addToggleText: { color: t.text.muted, fontSize: 13, fontWeight: '600' },
    ...
    swapPartner: { color: t.text.primary, fontSize: 14, fontWeight: '600' },
    swapStatus: { paddingHorizontal: 8, paddingVertical: 3, borderRadius: 6 },
    swapStatusText: { fontSize: 10, fontWeight: '700' },
    ...
    swapSide: { flex: 1 },
    swapLabel: { color: t.text.muted, fontSize: 10, fontWeight: '600', textTransform: 'uppercase' },
    swapSkill: { color: t.text.primary, fontSize: 13, fontWeight: '600', marginTop: 2 },
    ...
    swapRating: { color: t.accent.orange, fontSize: 13, fontWeight: '700' },
    ...
    swapRateText: { color: '#fff', fontSize: 12, fontWeight: '600' },
    // Skill map
    ...
    mapSkillName: { color: t.text.primary, fontSize: 14, fontWeight: '600', flex: 1 },
    mapCategory: { color: t.text.muted, fontSize: 11 },
    mapStats: { alignItems: 'flex-end' },
    mapDemand: { fontSize: 13, fontWeight: '800' },
