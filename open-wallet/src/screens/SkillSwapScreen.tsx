...
export function SkillSwapScreen({ onClose }: Props) {
  ...
  const s = useMemo(() => StyleSheet.create({
    ...
    matchScoreText: { color: t.accent.green, fontSize: fonts.sm, fontWeight: fonts.heavy },
    matchExchange: { backgroundColor: t.bg.primary, borderRadius: 12, padding: 14, marginTop: 10 },
    matchArrow: { textAlign: 'center', color: t.text.muted, fontSize: fonts.xl, marginVertical: 4 },
    matchSkillRow: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center' },
    matchLabel: { color: t.text.muted, fontSize: fonts.xs, fontWeight: fonts.semibold, textTransform: 'uppercase' },
    matchSkill: { color: t.text.primary, fontSize: fonts.md, fontWeight: fonts.semibold },
    matchDistance: { color: t.text.muted, fontSize: fonts.sm, marginTop: 8 },
    matchProposeBtn: { backgroundColor: t.accent.blue, borderRadius: 10, paddingVertical: 10, alignItems: 'center', marginTop: 12 },
    matchProposeText: { color: '#fff', fontSize: fonts.md, fontWeight: fonts.bold },
    noMatchText: { color: t.text.muted, fontSize: fonts.md, textAlign: 'center', marginTop: 20, marginHorizontal: 20 },
    // My skills
    ...
    skillIconText: { fontSize: fonts.md, fontWeight: fonts.bold },
    skillInfo: { flex: 1 },
    skillName: { color: t.text.primary, fontSize: fonts.md, fontWeight: fonts.semibold },
    skillCategory: { color: t.text.muted, fontSize: fonts.sm, marginTop: 2 },
    skillLevel: { paddingHorizontal: 8, paddingVertical: 3, borderRadius: 6 },
    skillLevelText: { fontSize: fonts.xs, fontWeight: fonts.bold },
    ...
    addToggleText: { color: t.text.muted, fontSize: fonts.sm, fontWeight: fonts.semibold },
    ...
    levelBtnText: { fontSize: fonts.sm, fontWeight: fonts.semibold },
    ...
    swapPartner: { color: t.text.primary, fontSize: fonts.md, fontWeight: fonts.semibold },
    swapStatus: { paddingHorizontal: 8, paddingVertical: 3, borderRadius: 6 },
    swapStatusText: { fontSize: fonts.xs, fontWeight: fonts.bold },
    ...
    swapSide: { flex: 1 },
    swapLabel: { color: t.text.muted, fontSize: fonts.xs, fontWeight: fonts.semibold, textTransform: 'uppercase' },
    swapSkill: { color: t.text.primary, fontSize: fonts.sm, fontWeight: fonts.semibold, marginTop: 2 },
    swapDivider: { width: 1, backgroundColor: t.text.muted + '30', marginHorizontal: 12 },
    swapMeta: { color: t.text.muted, fontSize: fonts.sm, marginTop: 8 },
    swapRating: { color: t.accent.orange, fontSize: fonts.sm, fontWeight: fonts.bold },
    ...
    swapRateText: { color: '#fff', fontSize: fonts.sm, fontWeight: fonts.semibold },
    // Skill map
    ...
    mapSkillName: { color: t.text.primary, fontSize: fonts.md, fontWeight: fonts.semibold, flex: 1 },
    mapCategory: { color: t.text.muted, fontSize: fonts.xs },
    mapStats: { alignItems: 'flex-end' },
    mapDemand: { fontSize: fonts.sm, fontWeight: fonts.heavy },
    mapSubtext: { color: t.text.muted, fontSize: fonts.xs, marginTop: 1 },
    ...
    mapLegendText: { color: t.text.muted, fontSize: fonts.xs },
