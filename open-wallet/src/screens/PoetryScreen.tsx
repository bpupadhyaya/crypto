...
export function PoetryScreen({ onClose }: Props) {
  ...
  const s = useMemo(() => StyleSheet.create({
    ...
    poemTitle: { color: t.text.primary, fontSize: 17, fontWeight: '700', fontStyle: 'italic' },
    ...
    featuredLabel: { color: t.accent.orange, fontSize: 11, fontWeight: '800', textTransform: 'uppercase', letterSpacing: 1.5, marginBottom: 8 },
    ...
    featuredStatValue: { color: t.text.primary, fontSize: 18, fontWeight: '800', textAlign: 'center' },
    ...
    eventType: { color: t.accent.purple, fontSize: 11, fontWeight: '700', textTransform: 'uppercase', letterSpacing: 1, marginTop: 4 },
    ...
    eventPrize: { color: t.accent.orange, fontSize: 12, fontWeight: '600', marginTop: 2 },
    ...
    styleLabel: { color: t.text.secondary, fontSize: 12, fontWeight: '600' },
    ...
    circleName: { color: t.text.primary, fontSize: 17, fontWeight: '700' },
    ...
    circleMembers: { color: t.accent.green, fontSize: 12, fontWeight: '600', marginTop: 4 },
