...
export function PoetryScreen({ onClose }: Props) {
  ...
  const s = useMemo(() => StyleSheet.create({
    ...
    poemTitle: { color: t.text.primary, fontSize: fonts.lg, fontWeight: fonts.bold, fontStyle: 'italic' },
    poemMeta: { color: t.text.muted, fontSize: fonts.sm, marginTop: 4 },
    poemText: { color: t.text.secondary, fontSize: fonts.md, marginTop: 12, lineHeight: 22, fontStyle: 'italic' },
    ...
    featuredLabel: { color: t.accent.orange, fontSize: fonts.xs, fontWeight: fonts.heavy, textTransform: 'uppercase', letterSpacing: 1.5, marginBottom: 8 },
    featuredName: { color: t.text.primary, fontSize: fonts.xl, fontWeight: fonts.heavy },
    featuredBio: { color: t.text.secondary, fontSize: fonts.sm, marginTop: 8, lineHeight: 20 },
    ...
    featuredStatValue: { color: t.text.primary, fontSize: fonts.xl, fontWeight: fonts.heavy, textAlign: 'center' },
    featuredStatLabel: { color: t.text.muted, fontSize: fonts.xs, textAlign: 'center', marginTop: 2 },
    ...
    eventType: { color: t.accent.purple, fontSize: fonts.xs, fontWeight: fonts.bold, textTransform: 'uppercase', letterSpacing: 1, marginTop: 4 },
    ...
    eventPrize: { color: t.accent.orange, fontSize: fonts.sm, fontWeight: fonts.semibold, marginTop: 2 },
    ...
    poemInput: { backgroundColor: t.bg.primary, borderRadius: 12, padding: 14, color: t.text.primary, fontSize: fonts.md, minHeight: 160, textAlignVertical: 'top' },
    ...
    styleLabel: { color: t.text.secondary, fontSize: fonts.sm, fontWeight: fonts.semibold },
    ...
    circleFocus: { color: t.text.secondary, fontSize: fonts.sm, marginTop: 6, lineHeight: 19 },
    circleMeta: { color: t.text.muted, fontSize: fonts.sm, marginTop: 8 },
    circleMembers: { color: t.accent.green, fontSize: fonts.sm, fontWeight: fonts.semibold, marginTop: 4 },
