...
export function CivicScreen({ onClose }: Props) {
  ...
  const s = useMemo(() => StyleSheet.create({
    ...
    levelText: { color: '#fff', fontSize: 14, fontWeight: '700', textTransform: 'uppercase' },
    gotkText: { color: t.text.primary, fontSize: 48, fontWeight: '900', marginTop: 4 },
    gotkLabel: { color: t.text.muted, fontSize: 13, textTransform: 'uppercase', letterSpacing: 1 },
    ...
    participationText: { color: t.text.muted, fontSize: 12, marginTop: 6, textAlign: 'center' },
    ...
    activityGotk: { color: t.accent.blue, fontSize: 14, fontWeight: '700' },
    activityOutcome: { fontSize: 11, marginTop: 2 },
    nudgeCard: { backgroundColor: t.accent.orange + '12', borderRadius: 16, padding: 16, marginHorizontal: 20, marginBottom: 12 },
    nudgeTitle: { color: t.text.primary, fontSize: 15, fontWeight: '700' },
    nudgeMeta: { color: t.text.muted, fontSize: 12, marginTop: 4 },
    nudgeVotes: { flexDirection: 'row', gap: 16, marginTop: 8 },
    nudgeVoteText: { fontSize: 13, fontWeight: '600' },
    ...
    nudgeDaysLeft: { color: t.accent.orange, fontSize: 13, fontWeight: '700' },
    voteNowBtn: { backgroundColor: t.accent.blue, paddingHorizontal: 16, paddingVertical: 8, borderRadius: 10 },
    voteNowText: { color: '#fff', fontSize: 13, fontWeight: '600' },
    ...
    leaderName: { color: t.text.primary, fontSize: 14, fontWeight: '600' },
    leaderMeta: { color: t.text.muted, fontSize: 12, marginTop: 2 },
    leaderRight: { alignItems: 'flex-end' },
    leaderGotk: { color: t.accent.blue, fontSize: 16, fontWeight: '800' },
    leaderGlabel: { color: t.text.muted, fontSize: 10 },
