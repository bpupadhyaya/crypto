...
export function CivicScreen({ onClose }: Props) {
  ...
  const s = useMemo(() => StyleSheet.create({
    ...
    activityGotk: { color: t.accent.blue, fontSize: 14, fontWeight: fonts.bold },
    ...
    nudgeTitle: { color: t.text.primary, fontSize: 15, fontWeight: fonts.bold },
    nudgeMeta: { color: t.text.muted, fontSize: 12, marginTop: 4 },
    nudgeVotes: { flexDirection: 'row', gap: 16, marginTop: 8 },
    nudgeVoteText: { fontSize: 13, fontWeight: fonts.semibold },
    ...
    nudgeDaysLeft: { color: t.accent.orange, fontSize: 13, fontWeight: fonts.bold },
    voteNowBtn: { backgroundColor: t.accent.blue, paddingHorizontal: 16, paddingVertical: 8, borderRadius: 10 },
    voteNowText: { color: '#fff', fontSize: 13, fontWeight: fonts.semibold },
    ...
    leaderGotk: { color: t.accent.blue, fontSize: 16, fontWeight: fonts.heavy },
