...
export function WildlifeScreen({ onClose }: Props) {
  ...
  const s = useMemo(() => StyleSheet.create({
    ...
    statValue: { color: t.text.primary, fontSize: 22, fontWeight: '900' },
    statLabel: { color: t.text.muted, fontSize: 11, marginTop: 2, textTransform: 'uppercase', letterSpacing: 0.5 },
    ...
    sightingSpecies: { color: t.text.primary, fontSize: 15, fontWeight: '700', flex: 1 },
    endangeredBadge: { backgroundColor: '#FF3B30' + '20', paddingHorizontal: 8, paddingVertical: 2, borderRadius: 6 },
    endangeredText: { color: '#FF3B30', fontSize: 10, fontWeight: '700' },
    sightingSciName: { color: t.text.muted, fontSize: 12, fontStyle: 'italic', marginTop: 2 },
    sightingMeta: { color: t.text.muted, fontSize: 12, marginTop: 6 },
    sightingNotes: { color: t.text.secondary, fontSize: 13, marginTop: 8, lineHeight: 20 },
    ...
    sightingHash: { color: t.text.muted, fontSize: 10, fontFamily: 'monospace' },
    sightingCotk: { color: t.accent.green, fontSize: 14, fontWeight: '700' },
    verifiedTag: { color: t.accent.green, fontSize: 11, fontWeight: '600' },
    pendingTag: { color: t.accent.orange, fontSize: 11, fontWeight: '600' },
    ...
    bioScoreNum: { color: t.accent.green, fontSize: 64, fontWeight: '900' },
    bioScoreLabel: { color: t.text.muted, fontSize: 13, textTransform: 'uppercase', letterSpacing: 1, marginTop: 4 },
    bioRegion: { color: t.text.primary, fontSize: 16, fontWeight: '700', marginTop: 8 },
    bioTrend: { fontSize: 13, fontWeight: '600', marginTop: 4 },
    bioDetailRow: { flexDirection: 'row', justifyContent: 'space-around', marginTop: 20, width: '100%' },
    bioDetailItem: { alignItems: 'center' },
    bioDetailValue: { color: t.text.primary, fontSize: 20, fontWeight: '800' },
    bioDetailLabel: { color: t.text.muted, fontSize: 11, marginTop: 2 },
    alertCard: { backgroundColor: '#FF3B30' + '10', borderRadius: 14, padding: 16, marginHorizontal: 20, marginBottom: 16 },
    alertTitle: { color: '#FF3B30', fontSize: 14, fontWeight: '700' },
    alertText: { color: t.text.secondary, fontSize: 13, marginTop: 4, lineHeight: 20 },
    projectCard: { backgroundColor: t.bg.secondary, borderRadius: 14, padding: 16, marginHorizontal: 20, marginBottom: 12 },
    projectTitle: { color: t.text.primary, fontSize: 15, fontWeight: '700' },
    projectCategory: { color: t.accent.green, fontSize: 11, fontWeight: '700', textTransform: 'uppercase', letterSpacing: 1, marginTop: 2 },
    projectDesc: { color: t.text.secondary, fontSize: 13, marginTop: 8, lineHeight: 20 },
    projectMeta: { color: t.text.muted, fontSize: 12, marginTop: 8 },
    ...
    projectCotk: { color: t.accent.green, fontSize: 14, fontWeight: '700' },
    ...
    eventTitle: { color: t.text.primary, fontSize: 15, fontWeight: '700' },
    eventType: { color: t.accent.blue, fontSize: 11, fontWeight: '700', textTransform: 'uppercase', letterSpacing: 1, marginTop: 2 },
    eventMeta: { color: t.text.muted, fontSize: 12, marginTop: 6 },
    eventDesc: { color: t.text.secondary, fontSize: 13, marginTop: 8, lineHeight: 20 },
    eventFooter: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', marginTop: 10 },
    eventCotk: { color: t.accent.green, fontSize: 14, fontWeight: '700' },
