...
export function WildlifeScreen({ onClose }: Props) {
  ...
  const s = useMemo(() => StyleSheet.create({
    ...
    sightingSpecies: { color: t.text.primary, fontSize: 15, fontWeight: fonts.bold, flex: 1 },
    ...
    sightingCotk: { color: t.accent.green, fontSize: 14, fontWeight: fonts.bold },
    verifiedTag: { color: t.accent.green, fontSize: 11, fontWeight: fonts.semibold },
    pendingTag: { color: t.accent.orange, fontSize: 11, fontWeight: fonts.semibold },
    ...
    bioRegion: { color: t.text.primary, fontSize: 16, fontWeight: fonts.bold, marginTop: 8 },
    bioTrend: { fontSize: 13, fontWeight: fonts.semibold, marginTop: 4 },
    bioDetailRow: { flexDirection: 'row', justifyContent: 'space-around', marginTop: 20, width: '100%' },
    bioDetailItem: { alignItems: 'center' },
    bioDetailValue: { color: t.text.primary, fontSize: 20, fontWeight: fonts.heavy },
    ...
    alertTitle: { color: '#FF3B30', fontSize: 14, fontWeight: fonts.bold },
    ...
    projectTitle: { color: t.text.primary, fontSize: 15, fontWeight: fonts.bold },
    projectCategory: { color: t.accent.green, fontSize: 11, fontWeight: fonts.bold, textTransform: 'uppercase', letterSpacing: 1, marginTop: 2 },
    ...
    projectCotk: { color: t.accent.green, fontSize: 14, fontWeight: fonts.bold },
    ...
    eventType: { color: t.accent.blue, fontSize: 11, fontWeight: fonts.bold, textTransform: 'uppercase', letterSpacing: 1, marginTop: 2 },
    ...
    eventCotk: { color: t.accent.green, fontSize: 14, fontWeight: fonts.bold },
