...
export function ChildcareScreen({ onClose }: Props) {
  ...
  const s = useMemo(() => StyleSheet.create({
    ...
    coopName: { color: t.text.primary, fontSize: 18, fontWeight: fonts.heavy, textAlign: 'center', marginBottom: 4 },
    coopSince: { color: t.text.muted, fontSize: 12, textAlign: 'center', marginBottom: 16 },
    sessionCard: { backgroundColor: t.bg.secondary, borderRadius: 14, padding: 16, marginHorizontal: 20, marginBottom: 12 },
    sessionHeader: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center' },
    sessionName: { color: t.text.primary, fontSize: 15, fontWeight: fonts.bold },
    sessionStatus: { paddingHorizontal: 8, paddingVertical: 2, borderRadius: 6 },
    sessionStatusText: { fontSize: 10, fontWeight: fonts.bold },
    sessionMeta: { color: t.text.muted, fontSize: 12, marginTop: 4 },
    sessionDetail: { color: t.text.primary, fontSize: 13, marginTop: 6 },
    sessionNOTK: { color: t.accent.green, fontSize: 14, fontWeight: fonts.bold, marginTop: 6 },
    ...
    caregiverName: { color: t.text.primary, fontSize: 16, fontWeight: fonts.bold },
    caregiverRating: { flexDirection: 'row', alignItems: 'center' },
    ratingText: { color: t.accent.orange, fontSize: 14, fontWeight: fonts.bold },
    reviewCount: { color: t.text.muted, fontSize: 11, marginLeft: 4 },
    caregiverMeta: { color: t.text.muted, fontSize: 12, marginTop: 4 },
    caregiverSkill: { color: t.accent.blue, fontSize: 12, fontWeight: fonts.semibold, marginTop: 4 },
    ...
    tagText: { color: t.accent.green, fontSize: 11, fontWeight: fonts.semibold },
    ...
    verifiedText: { color: t.accent.green, fontSize: 10, fontWeight: fonts.bold },
    ...
    balanceSign: { fontSize: 14, fontWeight: fonts.bold, marginTop: 4 },
    hourRow: { flexDirection: 'row', justifyContent: 'space-around', marginTop: 16, width: '100%' },
    hourItem: { alignItems: 'center' },
    hourValue: { fontSize: 20, fontWeight: fonts.heavy },
    hourLabel: { color: t.text.muted, fontSize: 11, marginTop: 2 },
    monthlyCard: { backgroundColor: t.bg.secondary, borderRadius: 14, padding: 16, marginHorizontal: 20, marginBottom: 12 },
    monthlyTitle: { color: t.text.primary, fontSize: 14, fontWeight: fonts.bold, marginBottom: 8 },
    monthlyRow: { flexDirection: 'row', justifyContent: 'space-between' },
    monthlyLabel: { color: t.text.muted, fontSize: 13 },
    monthlyValue: { color: t.text.primary, fontSize: 13, fontWeight: fonts.bold },
