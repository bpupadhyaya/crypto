...
export function ChildcareScreen({ onClose }: Props) {
  ...
  const s = useMemo(() => StyleSheet.create({
    ...
    coopName: { color: t.text.primary, fontSize: 18, fontWeight: '800', textAlign: 'center', marginBottom: 4 },
    ...
    sessionName: { color: t.text.primary, fontSize: 15, fontWeight: '700' },
    ...
    sessionNOTK: { color: t.accent.green, fontSize: 14, fontWeight: '700', marginTop: 6 },
    ...
    caregiverName: { color: t.text.primary, fontSize: 16, fontWeight: '700' },
    caregiverRating: { flexDirection: 'row', alignItems: 'center' },
    ratingText: { color: t.accent.orange, fontSize: 14, fontWeight: '700' },
    reviewCount: { color: t.text.muted, fontSize: 11, marginLeft: 4 },
    caregiverMeta: { color: t.text.muted, fontSize: 12, marginTop: 4 },
    caregiverSkill: { color: t.accent.blue, fontSize: 12, fontWeight: '600', marginTop: 4 },
    ...
    tagText: { color: t.accent.green, fontSize: 11, fontWeight: '600' },
    ...
    verifiedText: { color: t.accent.green, fontSize: 10, fontWeight: '700' },
    ...
    monthlyTitle: { color: t.text.primary, fontSize: 14, fontWeight: '700', marginBottom: 8 },
    monthlyRow: { flexDirection: 'row', justifyContent: 'space-between' },
    monthlyLabel: { color: t.text.muted, fontSize: 13 },
    monthlyValue: { color: t.text.primary, fontSize: 13, fontWeight: '700' },
