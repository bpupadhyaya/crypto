...
export function GriefSupportScreen({ onClose }: Props) {
  ...
  const s = useMemo(() => StyleSheet.create({
    ...
    typeIcon: { fontSize: fonts.lg, fontWeight: fonts.bold, color: t.text.secondary, marginBottom: 2 },
    typeIconActive: { color: '#fff' },
    typeLabel: { color: t.text.secondary, fontSize: fonts.xs, fontWeight: fonts.semibold },
    ...
    stageNumberText: { color: t.accent.purple, fontSize: fonts.sm, fontWeight: fonts.bold },
    stageInfo: { flex: 1 },
    stageTitle: { color: t.text.primary, fontSize: fonts.md, fontWeight: fonts.bold },
    stageDesc: { color: t.text.muted, fontSize: fonts.sm, marginTop: 2, lineHeight: 18 },
    circleCard: { backgroundColor: t.bg.secondary, borderRadius: 16, padding: 16, marginHorizontal: 20, marginBottom: 12 },
    circleName: { color: t.text.primary, fontSize: fonts.md, fontWeight: fonts.bold },
    circleType: { color: t.accent.purple, fontSize: fonts.xs, fontWeight: fonts.semibold, textTransform: 'uppercase', letterSpacing: 1, marginTop: 2 },
    circleDesc: { color: t.text.muted, fontSize: fonts.sm, marginTop: 8, lineHeight: 19 },
    circleMetaRow: { flexDirection: 'row', justifyContent: 'space-between', marginTop: 12 },
    circleMeta: { color: t.text.secondary, fontSize: fonts.sm },
    circleAnon: { color: t.accent.green, fontSize: fonts.xs, fontWeight: fonts.semibold },
    ...
    resourceMeta: { color: t.text.secondary, fontSize: fonts.sm, marginTop: 8 },
    ...
    memorialName: { color: t.text.primary, fontSize: fonts.lg, fontWeight: fonts.heavy },
    memorialMessage: { color: t.text.secondary, fontSize: fonts.md, marginTop: 8, lineHeight: 21, fontStyle: 'italic' },
    memorialMeta: { color: t.text.muted, fontSize: fonts.xs, marginTop: 10 },
    memorialPhoto: { color: t.accent.blue, fontSize: fonts.xs, marginTop: 4 },
    input: { backgroundColor: t.bg.primary, borderRadius: 12, padding: 14, color: t.text.primary, fontSize: fonts.md, marginBottom: 12 },
    messageInput: { backgroundColor: t.bg.primary, borderRadius: 12, padding: 14, color: t.text.primary, fontSize: fonts.md, minHeight: 100, textAlignVertical: 'top', marginBottom: 12 },
    anonRow: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', marginBottom: 16 },
    anonLabel: { color: t.text.secondary, fontSize: fonts.md, fontWeight: fonts.semibold },
    ...
    anonToggleText: { color: t.accent.purple, fontSize: fonts.sm, fontWeight: fonts.semibold },
    ...
    referralBtnText: { color: t.accent.blue, fontSize: fonts.md, fontWeight: fonts.semibold },
    referralCard: { backgroundColor: t.bg.secondary, borderRadius: 12, padding: 14, marginHorizontal: 20, marginBottom: 10 },
    referralName: { color: t.text.primary, fontSize: fonts.md, fontWeight: fonts.bold },
    referralSpecialty: { color: t.accent.purple, fontSize: fonts.sm, marginTop: 2 },
    referralDetails: { flexDirection: 'row', justifyContent: 'space-between', marginTop: 8 },
    referralRegion: { color: t.text.muted, fontSize: fonts.sm },
    referralStatus: { fontSize: fonts.sm, fontWeight: fonts.semibold },
    referralRating: { color: t.text.secondary, fontSize: fonts.sm, marginTop: 4 },
    disclaimer: { color: t.text.muted, fontSize: fonts.xs, textAlign: 'center', marginHorizontal: 32, marginTop: 8, marginBottom: 16, lineHeight: 16 },
    emptyText: { color: t.text.muted, fontSize: fonts.md, textAlign: 'center', marginTop: 24 },
  }), [t]);
