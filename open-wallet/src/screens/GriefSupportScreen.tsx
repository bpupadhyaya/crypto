...
export function GriefSupportScreen({ onClose }: Props) {
  ...
  const s = useMemo(() => StyleSheet.create({
    ...
    typeIcon: { fontSize: 16, fontWeight: '700', color: t.text.secondary, marginBottom: 2 },
    typeIconActive: { color: '#fff' },
    typeLabel: { color: t.text.secondary, fontSize: 11, fontWeight: '600' },
    ...
    stageNumberText: { color: t.accent.purple, fontSize: 13, fontWeight: '700' },
    stageInfo: { flex: 1 },
    stageTitle: { color: t.text.primary, fontSize: 14, fontWeight: '700' },
    ...
    circleName: { color: t.text.primary, fontSize: 15, fontWeight: '700' },
    circleType: { color: t.accent.purple, fontSize: 11, fontWeight: '600', textTransform: 'uppercase', letterSpacing: 1, marginTop: 2 },
    ...
    circleAnon: { color: t.accent.green, fontSize: 11, fontWeight: '600' },
    ...
    memorialName: { color: t.text.primary, fontSize: 16, fontWeight: '800' },
    ...
    anonToggleText: { color: t.accent.purple, fontSize: 13, fontWeight: '600' },
    ...
    referralBtnText: { color: t.accent.blue, fontSize: 14, fontWeight: '600' },
    referralCard: { backgroundColor: t.bg.secondary, borderRadius: 12, padding: 14, marginHorizontal: 20, marginBottom: 10 },
    referralName: { color: t.text.primary, fontSize: 14, fontWeight: '700' },
