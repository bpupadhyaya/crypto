...
export function CorrectionScreen({ onClose }: Props) {
  ...
  const st = useMemo(() => StyleSheet.create({
    ...
    warningText: { color: t.accent.red, fontSize: fonts.sm, lineHeight: 19, fontWeight: fonts.semibold },
    ...
    channelBtnText: { color: t.text.secondary, fontSize: fonts.sm, fontWeight: fonts.semibold },
    ...
    contestBtnText: { color: '#fff', fontSize: fonts.md, fontWeight: fonts.bold },
    ...
    verifierLabel: { color: t.text.muted, fontSize: fonts.xs },
    verifierResult: { fontSize: fonts.xs, fontWeight: fonts.bold },
      ...
      <ScrollView style={st.scroll}>
        ...
        {activeTab !== 'verify' && (
          <TouchableOpacity style={[st.card, { alignItems: 'center', borderWidth: 1, borderColor: t.accent.red + '40', borderStyle: 'dashed' }]}
            ...
            <Text style={{ color: t.accent.red, fontSize: fonts.md, fontWeight: fonts.bold }}>+ Submit Correction Report</Text>
          </TouchableOpacity>
        )}
