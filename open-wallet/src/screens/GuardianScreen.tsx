...
export function GuardianScreen({ onClose }: Props) {
  ...
  const st = useMemo(() => StyleSheet.create({
    ...
    badgeText: { color: t.accent.yellow, fontSize: 11, fontWeight: '700' },
    ...
    guardianText: { color: t.accent.blue, fontSize: 12, fontWeight: '600' },
    ...
    emergencyText: { color: t.accent.red, fontSize: 14, fontWeight: '700' },
            ...
            <TouchableOpacity key={d.uid} style={st.card} onPress={() => setSelectedDependent(d)}>
              <View style={st.statusRow}>
                ...
                <View style={[st.relChip, { backgroundColor: d.relationship === 'child' ? t.accent.blue + '20' : t.accent.yellow + '20' }]}>
                  <Text style={{ color: d.relationship === 'child' ? t.accent.blue : t.accent.yellow, fontSize: 11, fontWeight: '700' }}>{d.relationship}</Text>
                </View>
              </View>
        ...
        {tab === 'approvals' && (
          ...
          approvals.map(a => (
            <View key={a.id} style={st.approvalCard}>
              ...
              {a.amount && <Text style={[st.cardSub, { marginTop: 4, fontWeight: '600', color: t.text.primary }]}>{(a.amount / 1000000).toFixed(2)} OTK</Text>}
