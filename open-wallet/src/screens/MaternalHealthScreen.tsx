...
export function MaternalHealthScreen({ onClose }: Props) {
  ...
  const s = useMemo(() => StyleSheet.create({
    ...
    countdownNumber: { color: t.accent.orange, fontSize: 48, fontWeight: '900' },
    countdownLabel: { color: t.text.muted, fontSize: 14, fontWeight: '600', marginTop: 4 },
    ...
    timelineWeek: { color: t.accent.purple, fontSize: 12, fontWeight: '700', textTransform: 'uppercase', letterSpacing: 1 },
    ...
    timelineHOTK: { color: t.accent.green, fontSize: 13, fontWeight: '700', marginTop: 6 },
    ...
    careIconText: { fontSize: 14, fontWeight: '700' },
    careInfo: { flex: 1 },
    careTitle: { color: t.text.primary, fontSize: 14, fontWeight: '600' },
    careMeta: { color: t.text.muted, fontSize: 12, marginTop: 2 },
    careRight: { alignItems: 'flex-end' },
    careHOTK: { color: t.accent.green, fontSize: 13, fontWeight: '700' },
    careStatus: { fontSize: 11, fontWeight: '600', marginTop: 2 },
    // Category filter
    ...
    midwifeName: { color: t.text.primary, fontSize: 16, fontWeight: '700' },
    ...
    midwifeAvailable: { color: t.accent.green, fontSize: 13, fontWeight: '700' },
    midwifeNOTK: { color: t.accent.purple, fontSize: 12, fontWeight: '600', marginTop: 4 },
    // Support
    ...
    supportIconText: { fontSize: 13, fontWeight: '700' },
    supportTitle: { color: t.text.primary, fontSize: 15, fontWeight: '700' },
    ...
    communityAuthor: { color: t.accent.purple, fontSize: 13, fontWeight: '700' },
    communityQuestion: { color: t.text.primary, fontSize: 14, fontWeight: '600', marginTop: 4 },
    communityMeta: { color: t.text.muted, fontSize: 12, marginTop: 8 },
    communityHOTK: { color: t.accent.green, fontSize: 12, fontWeight: '700' },
    // Education
