...
export function MaternalHealthScreen({ onClose }: Props) {
  ...
  const s = useMemo(() => StyleSheet.create({
    ...
    countdownLabel: { color: t.text.muted, fontSize: 14, fontWeight: fonts.semibold, marginTop: 4 },
    countdownDate: { color: t.text.secondary, fontSize: 13, marginTop: 8 },
    // Progress bar
    ...
    progressText: { color: t.text.muted, fontSize: 12, marginTop: 6, textAlign: 'center' },
    // Section
    sectionTitle: { color: t.text.primary, fontSize: 16, fontWeight: fonts.bold, marginBottom: 12, marginHorizontal: 20, marginTop: 20 },
    // Timeline
    ...
    timelineWeek: { color: t.accent.purple, fontSize: 12, fontWeight: fonts.bold, textTransform: 'uppercase', letterSpacing: 1 },
    ...
    timelineHOTK: { color: t.accent.green, fontSize: 13, fontWeight: fonts.bold, marginTop: 6 },
    ...
    careIconText: { fontSize: 14, fontWeight: fonts.bold },
    careInfo: { flex: 1 },
    careTitle: { color: t.text.primary, fontSize: 14, fontWeight: fonts.semibold },
    careMeta: { color: t.text.muted, fontSize: 12, marginTop: 2 },
    careRight: { alignItems: 'flex-end' },
    careHOTK: { color: t.accent.green, fontSize: 13, fontWeight: fonts.bold },
    careStatus: { fontSize: 11, fontWeight: fonts.semibold, marginTop: 2 },
    // Category filter
    ...
    midwifeName: { color: t.text.primary, fontSize: 16, fontWeight: fonts.bold },
    midwifeSpecialty: { color: t.text.muted, fontSize: 13, marginTop: 2 },
    midwifeRow: { flexDirection: 'row', justifyContent: 'space-between', marginTop: 10 },
    midwifeDetail: { color: t.text.secondary, fontSize: 13 },
    midwifeAvailable: { color: t.accent.green, fontSize: 13, fontWeight: fonts.bold },
    midwifeNOTK: { color: t.accent.purple, fontSize: 12, fontWeight: fonts.semibold, marginTop: 4 },
    // Support
    ...
    supportIconText: { fontSize: 13, fontWeight: fonts.bold },
    supportTitle: { color: t.text.primary, fontSize: 15, fontWeight: fonts.bold },
    supportDesc: { color: t.text.muted, fontSize: 13, marginTop: 4, lineHeight: 20 },
    supportMeta: { color: t.text.secondary, fontSize: 12, marginTop: 8 },
    // Community
    communityCard: { backgroundColor: t.bg.secondary, borderRadius: 16, padding: 16, marginHorizontal: 20, marginBottom: 12 },
    communityAuthor: { color: t.accent.purple, fontSize: 13, fontWeight: fonts.bold },
    communityQuestion: { color: t.text.primary, fontSize: 14, fontWeight: fonts.semibold, marginTop: 4 },
    communityMeta: { color: t.text.muted, fontSize: 12, marginTop: 8 },
    communityHOTK: { color: t.accent.green, fontSize: 12, fontWeight: fonts.bold },
    // Education
