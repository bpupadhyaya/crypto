...
export function WaterSanitationScreen({ onClose }: Props) {
  ...
  const st = useMemo(() => StyleSheet.create({
    ...
    sourceName: { color: t.text.primary, fontSize: fonts.lg, fontWeight: fonts.bold, marginBottom: 2 },
    sourceType: { color: t.accent.blue, fontSize: fonts.xs, fontWeight: fonts.semibold, textTransform: 'uppercase', letterSpacing: 0.8, marginBottom: 4 },
    sourceLocation: { color: t.text.muted, fontSize: fonts.sm, marginBottom: 8 },
    ...
    qualityText: { fontSize: fonts.xs, fontWeight: fonts.bold, color: '#fff' },
    issueCard: { backgroundColor: t.bg.card, borderRadius: 14, padding: 16, marginBottom: 12, borderLeftWidth: 4 },
    issueTitle: { color: t.text.primary, fontSize: fonts.md, fontWeight: fonts.bold, marginBottom: 4 },
    issueDesc: { color: t.text.secondary, fontSize: fonts.sm, lineHeight: 18, marginBottom: 6 },
    issueMeta: { color: t.text.muted, fontSize: fonts.xs, marginBottom: 2 },
    ...
    reportTypeText: { color: t.text.secondary, fontSize: fonts.sm, fontWeight: fonts.semibold },
    reportTypeTextActive: { color: '#fff' },
    projectCard: { backgroundColor: t.bg.card, borderRadius: 14, padding: 16, marginBottom: 12 },
    projectName: { color: t.text.primary, fontSize: fonts.md, fontWeight: fonts.bold, marginBottom: 4 },
    projectDesc: { color: t.text.secondary, fontSize: fonts.sm, lineHeight: 18, marginBottom: 8 },
    projectMeta: { color: t.text.muted, fontSize: fonts.xs, marginBottom: 2 },
    progressRow: { flexDirection: 'row', alignItems: 'center', marginTop: 8, marginBottom: 4 },
    progressLabel: { color: t.text.muted, fontSize: fonts.xs, width: 60 },
    ...
    progressPct: { color: t.text.secondary, fontSize: fonts.xs, fontWeight: fonts.bold, width: 40, textAlign: 'right' },
    impactText: { color: t.accent.green, fontSize: fonts.sm, fontWeight: fonts.semibold, fontStyle: 'italic', marginTop: 6 },
    ...
    testSource: { color: t.text.primary, fontSize: fonts.md, fontWeight: fonts.bold, marginBottom: 4 },
    testMeta: { color: t.text.muted, fontSize: fonts.xs, marginBottom: 6 },
    testRow: { flexDirection: 'row', justifyContent: 'space-between', marginBottom: 3 },
    testLabel: { color: t.text.muted, fontSize: fonts.xs },
    testVal: { color: t.text.secondary, fontSize: fonts.xs, fontWeight: fonts.semibold },
    verifiedBadge: { paddingHorizontal: 6, paddingVertical: 2, borderRadius: 4, alignSelf: 'flex-start', marginTop: 6 },
    verifiedText: { fontSize: fonts.xxs, fontWeight: fonts.bold, color: '#fff' },
    tipCard: { backgroundColor: t.bg.card, borderRadius: 12, padding: 14, marginBottom: 10 },
    tipTitle: { color: t.text.primary, fontSize: fonts.md, fontWeight: fonts.bold, marginBottom: 4 },
    tipDesc: { color: t.text.secondary, fontSize: fonts.sm, lineHeight: 18, marginBottom: 6 },
    tipMeta: { flexDirection: 'row', justifyContent: 'space-between' },
    tipSavings: { color: t.accent.green, fontSize: fonts.xs, fontWeight: fonts.semibold },
    tipDifficulty: { fontSize: fonts.xs, fontWeight: fonts.bold, paddingHorizontal: 6, paddingVertical: 2, borderRadius: 4, overflow: 'hidden', color: '#fff' },
