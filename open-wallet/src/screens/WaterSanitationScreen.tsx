...
export function WaterSanitationScreen({ onClose }: Props) {
  ...
  const st = useMemo(() => StyleSheet.create({
    ...
    sourceName: { color: t.text.primary, fontSize: 16, fontWeight: fonts.bold, marginBottom: 2 },
    sourceType: { color: t.accent.blue, fontSize: 11, fontWeight: fonts.semibold, textTransform: 'uppercase', letterSpacing: 0.8, marginBottom: 4 },
    ...
    qualityText: { fontSize: 10, fontWeight: fonts.bold, color: '#fff' },
    issueCard: { backgroundColor: t.bg.card, borderRadius: 14, padding: 16, marginBottom: 12, borderLeftWidth: 4 },
    issueTitle: { color: t.text.primary, fontSize: 15, fontWeight: fonts.bold, marginBottom: 4 },
    ...
    upvoteText: { color: t.text.secondary, fontSize: 12, fontWeight: fonts.semibold },
    reportBtn: { backgroundColor: '#f97316', borderRadius: 10, paddingVertical: 12, alignItems: 'center', marginTop: 12, marginBottom: 8 },
    reportBtnText: { color: '#fff', fontSize: 14, fontWeight: fonts.bold },
    ...
    reportTypeText: { color: t.text.secondary, fontSize: 12, fontWeight: fonts.semibold },
    reportTypeTextActive: { color: '#fff' },
    projectCard: { backgroundColor: t.bg.card, borderRadius: 14, padding: 16, marginBottom: 12 },
    projectName: { color: t.text.primary, fontSize: 15, fontWeight: fonts.bold, marginBottom: 4 },
    ...
    progressPct: { color: t.text.secondary, fontSize: 11, fontWeight: fonts.bold, width: 40, textAlign: 'right' },
    impactText: { color: t.accent.green, fontSize: 12, fontWeight: fonts.semibold, fontStyle: 'italic', marginTop: 6 },
    ...
    testSource: { color: t.text.primary, fontSize: 14, fontWeight: fonts.bold, marginBottom: 4 },
    ...
    testVal: { color: t.text.secondary, fontSize: 11, fontWeight: fonts.semibold },
    verifiedBadge: { paddingHorizontal: 6, paddingVertical: 2, borderRadius: 4, alignSelf: 'flex-start', marginTop: 6 },
    verifiedText: { fontSize: 9, fontWeight: fonts.bold, color: '#fff' },
    tipCard: { backgroundColor: t.bg.card, borderRadius: 12, padding: 14, marginBottom: 10 },
    tipTitle: { color: t.text.primary, fontSize: 14, fontWeight: fonts.bold, marginBottom: 4 },
    ...
    tipSavings: { color: t.accent.green, fontSize: 11, fontWeight: fonts.semibold },
    tipDifficulty: { fontSize: 10, fontWeight: fonts.bold, paddingHorizontal: 6, paddingVertical: 2, borderRadius: 4, overflow: 'hidden', color: '#fff' },
