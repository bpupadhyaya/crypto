...
export function MentorshipScreen({ onClose }: Props) {
  ...
  const s = useMemo(() => StyleSheet.create({
    ...
    activeRole: { fontSize: 11, fontWeight: '700', textTransform: 'uppercase', letterSpacing: 1 },
    activeName: { color: t.text.primary, fontSize: 15, fontWeight: '700', marginTop: 4 },
    ...
    gratitudeBtnText: { color: t.accent.green, fontSize: 13, fontWeight: '700' },
    // Milestones
    ...
    regSkillTextActive: { color: t.accent.blue, fontWeight: '600' },
