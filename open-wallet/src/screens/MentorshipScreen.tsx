...
export function MentorshipScreen({ onClose }: Props) {
  ...
  const s = useMemo(() => StyleSheet.create({
    ...
    mentorUid: { color: t.text.muted, fontSize: 11, marginTop: 2 },
    ...
    mentorStat: { color: t.text.secondary, fontSize: 12 },
    ...
    activeRole: { fontSize: 11, fontWeight: fonts.bold, textTransform: 'uppercase', letterSpacing: 1 },
    activeName: { color: t.text.primary, fontSize: 15, fontWeight: fonts.bold, marginTop: 4 },
    activeSkill: { color: t.text.secondary, fontSize: 13, marginTop: 2 },
    activeStats: { flexDirection: 'row', justifyContent: 'space-between', marginTop: 10 },
    activeStat: { color: t.text.secondary, fontSize: 12 },
    ...
    gratitudeBtnText: { color: t.accent.green, fontSize: 13, fontWeight: fonts.bold },
    // Milestones
    ...
    milestoneName: { color: t.text.primary, fontSize: 14, fontWeight: fonts.semibold },
    milestoneDate: { color: t.text.muted, fontSize: 11, marginTop: 2 },
    milestoneEOTK: { color: t.accent.green, fontSize: 13, fontWeight: fonts.bold },
    milestoneMentee: { color: t.text.secondary, fontSize: 11, marginTop: 2 },
    // Register
    registerLabel: { color: t.text.primary, fontSize: 14, fontWeight: fonts.semibold, marginBottom: 8, marginTop: 16 },
    ...
    regSkillText: { color: t.text.secondary, fontSize: 13 },
    regSkillTextActive: { color: t.accent.blue, fontWeight: fonts.semibold },
    input: { backgroundColor: t.bg.card, borderRadius: 12, padding: 14, color: t.text.primary, fontSize: 14, borderWidth: 1, borderColor: t.border, height: 80, textAlignVertical: 'top' },
    ...
    impactQuote: { color: t.text.muted, fontSize: 13, fontStyle: 'italic', textAlign: 'center', lineHeight: 20, marginTop: 16 },
  }), [t]);
