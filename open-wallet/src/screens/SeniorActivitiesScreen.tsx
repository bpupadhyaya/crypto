...
export function SeniorActivitiesScreen({ onClose }: Props) {
  ...
  const s = useMemo(() => StyleSheet.create({
    ...
    scoreValue: { color: t.accent.green, fontSize: fonts.xxl, fontWeight: fonts.heavy },
    ...
    activityTitle: { color: t.text.primary, fontSize: fonts.lg, fontWeight: fonts.bold },
    activityMeta: { color: t.text.muted, fontSize: fonts.sm, marginTop: 4 },
    activityRow: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', marginTop: 10 },
    activityDetail: { color: t.text.secondary, fontSize: fonts.sm },
    activitySpots: { fontSize: fonts.sm, fontWeight: fonts.bold },
    ...
    transportText: { color: t.accent.blue, fontSize: fonts.xs, fontWeight: fonts.bold },
    nOTKBadge: { color: t.accent.green, fontSize: fonts.md, fontWeight: fonts.bold, marginTop: 8 },
    // Category showcase
    ...
    categoryIconText: { fontSize: fonts.xl, fontWeight: fonts.bold },
    categoryLabel: { color: t.text.primary, fontSize: fonts.md, fontWeight: fonts.bold },
    categoryDesc: { color: t.text.muted, fontSize: fonts.sm, marginTop: 2 },
    // Companion card
    companionCard: { backgroundColor: t.bg.secondary, borderRadius: 16, padding: 20, marginHorizontal: 20, marginBottom: 12 },
    companionName: { color: t.text.primary, fontSize: fonts.lg, fontWeight: fonts.bold },
    companionMatch: { color: t.accent.purple, fontSize: fonts.md, fontWeight: fonts.semibold, marginTop: 4 },
    companionDetail: { color: t.text.muted, fontSize: fonts.sm, marginTop: 2 },
    ...
    companionStatValue: { color: t.text.primary, fontSize: fonts.xl, fontWeight: fonts.heavy },
    companionStatLabel: { color: t.text.muted, fontSize: fonts.xs, marginTop: 2 },
    ...
    specialtyText: { color: t.accent.green, fontSize: fonts.xs, fontWeight: fonts.semibold },
    // Wellness
    ...
    wellnessName: { color: t.text.primary, fontSize: fonts.md, fontWeight: fonts.bold },
    wellnessDate: { color: t.text.muted, fontSize: fonts.sm },
    wellnessRow: { flexDirection: 'row', justifyContent: 'space-between', marginTop: 10 },
    wellnessLabel: { color: t.text.muted, fontSize: fonts.sm },
    wellnessValue: { color: t.text.primary, fontSize: fonts.sm, fontWeight: fonts.semibold },
    wellnessNotes: { color: t.text.secondary, fontSize: fonts.sm, marginTop: 8, fontStyle: 'italic', lineHeight: 20 },
    wellnessCheckedBy: { color: t.text.muted, fontSize: fonts.xs, marginTop: 6 },
    ...
    scheduleDayTitle: { color: t.text.primary, fontSize: fonts.lg, fontWeight: fonts.bold, marginBottom: 8 },
    scheduleItem: { flexDirection: 'row', paddingVertical: 8, borderBottomColor: t.bg.primary, borderBottomWidth: 1 },
    scheduleTime: { color: t.accent.green, fontSize: fonts.sm, fontWeight: fonts.bold, width: 80 },
    scheduleTitle: { color: t.text.primary, fontSize: fonts.md, fontWeight: fonts.semibold, flex: 1 },
    scheduleCategory: { color: t.text.muted, fontSize: fonts.sm },
    // Education
