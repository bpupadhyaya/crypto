...
export function SeniorActivitiesScreen({ onClose }: Props) {
  ...
  const s = useMemo(() => StyleSheet.create({
    ...
    scoreValue: { color: t.accent.green, fontSize: 24, fontWeight: fonts.heavy },
    ...
    categoryChipText: { color: t.text.muted, fontSize: 12, fontWeight: fonts.semibold },
    ...
    activityTitle: { color: t.text.primary, fontSize: 16, fontWeight: fonts.bold },
    ...
    activitySpots: { fontSize: 13, fontWeight: fonts.bold },
    ...
    transportText: { color: t.accent.blue, fontSize: 11, fontWeight: fonts.bold },
    nOTKBadge: { color: t.accent.green, fontSize: 14, fontWeight: fonts.bold, marginTop: 8 },
    // Category showcase
    ...
    categoryIconText: { fontSize: 18, fontWeight: fonts.bold },
    categoryLabel: { color: t.text.primary, fontSize: 15, fontWeight: fonts.bold },
    ...
    companionName: { color: t.text.primary, fontSize: 17, fontWeight: fonts.bold },
    companionMatch: { color: t.accent.purple, fontSize: 14, fontWeight: fonts.semibold, marginTop: 4 },
    ...
    companionStatValue: { color: t.text.primary, fontSize: 18, fontWeight: fonts.heavy },
    ...
    specialtyText: { color: t.accent.green, fontSize: 11, fontWeight: fonts.semibold },
    // Wellness
    ...
    wellnessName: { color: t.text.primary, fontSize: 15, fontWeight: fonts.bold },
    ...
    wellnessValue: { color: t.text.primary, fontSize: 13, fontWeight: fonts.semibold },
    ...
    scheduleDayTitle: { color: t.text.primary, fontSize: 16, fontWeight: fonts.bold, marginBottom: 8 },
    scheduleItem: { flexDirection: 'row', paddingVertical: 8, borderBottomColor: t.bg.primary, borderBottomWidth: 1 },
    scheduleTime: { color: t.accent.green, fontSize: 13, fontWeight: fonts.bold, width: 80 },
    scheduleTitle: { color: t.text.primary, fontSize: 14, fontWeight: fonts.semibold, flex: 1 },
