...
export function CarbonTrackerScreen({ onClose }: Props) {
  ...
  const s = useMemo(() => StyleSheet.create({
    ...
    catIconText: { color: t.accent.green, fontSize: 14, fontWeight: '700' },
    catInfo: { flex: 1 },
    catLabel: { color: t.text.primary, fontSize: 14, fontWeight: '600' },
    catMeta: { color: t.text.muted, fontSize: 12, marginTop: 2 },
    catValue: { color: t.text.primary, fontSize: 15, fontWeight: '800', textAlign: 'right' },
    ...
    savingsText: { color: t.text.primary, fontSize: 15, fontWeight: '600', textAlign: 'center', lineHeight: 22 },
    ...
    tipDiffText: { color: '#fff', fontSize: 10, fontWeight: '700' },
    tipDesc: { color: t.text.muted, fontSize: 13, marginTop: 6, lineHeight: 20 },
    tipSavings: { color: t.accent.green, fontSize: 13, fontWeight: '700', marginTop: 6 },
    ...
    tipAdoptText: { color: '#fff', fontSize: 13, fontWeight: '600' },
    tipAdopted: { color: t.accent.green, fontSize: 12, fontWeight: '700', marginTop: 8 },
    offsetCard: { backgroundColor: t.bg.secondary, borderRadius: 14, padding: 16, marginHorizontal: 20, marginBottom: 12 },
    offsetName: { color: t.text.primary, fontSize: 16, fontWeight: '700' },
    offsetLoc: { color: t.accent.blue, fontSize: 12, fontWeight: '600', marginTop: 2 },
    ...
    offsetCost: { color: t.text.primary, fontSize: 15, fontWeight: '800' },
    offsetBtn: { backgroundColor: t.accent.blue, paddingHorizontal: 16, paddingVertical: 8, borderRadius: 10 },
    offsetBtnText: { color: '#fff', fontSize: 13, fontWeight: '600' },
