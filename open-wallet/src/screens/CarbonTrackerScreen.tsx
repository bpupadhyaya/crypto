...
export function CarbonTrackerScreen({ onClose }: Props) {
  ...
  const s = useMemo(() => StyleSheet.create({
    ...
    catIconText: { color: t.accent.green, fontSize: fonts.md, fontWeight: fonts.bold },
    catInfo: { flex: 1 },
    catLabel: { color: t.text.primary, fontSize: fonts.md, fontWeight: fonts.semibold },
    catMeta: { color: t.text.muted, fontSize: fonts.sm, marginTop: 2 },
    catValue: { color: t.text.primary, fontSize: fonts.md, fontWeight: fonts.heavy, textAlign: 'right' },
    ...
    savingsText: { color: t.text.primary, fontSize: fonts.md, fontWeight: fonts.semibold, textAlign: 'center', lineHeight: 22 },
    ...
    tipDiffText: { color: '#fff', fontSize: fonts.xs, fontWeight: fonts.bold },
    tipDesc: { color: t.text.muted, fontSize: fonts.sm, marginTop: 6, lineHeight: 20 },
    tipSavings: { color: t.accent.green, fontSize: fonts.sm, fontWeight: fonts.bold, marginTop: 6 },
    ...
    tipAdoptText: { color: '#fff', fontSize: fonts.sm, fontWeight: fonts.semibold },
    tipAdopted: { color: t.accent.green, fontSize: fonts.sm, fontWeight: fonts.bold, marginTop: 8 },
    offsetCard: { backgroundColor: t.bg.secondary, borderRadius: 14, padding: 16, marginHorizontal: 20, marginBottom: 12 },
    offsetName: { color: t.text.primary, fontSize: fonts.lg, fontWeight: fonts.bold },
    offsetLoc: { color: t.accent.blue, fontSize: fonts.sm, fontWeight: fonts.semibold, marginTop: 2 },
    offsetDesc: { color: t.text.muted, fontSize: fonts.sm, marginTop: 6 },
    offsetFooter: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', marginTop: 12 },
    offsetCost: { color: t.text.primary, fontSize: fonts.md, fontWeight: fonts.heavy },
    offsetBtn: { backgroundColor: t.accent.blue, paddingHorizontal: 16, paddingVertical: 8, borderRadius: 10 },
    offsetBtnText: { color: '#fff', fontSize: fonts.sm, fontWeight: fonts.semibold },
