...
export function CompostScreen({ onClose }: Props) {
  ...
  const s = useMemo(() => StyleSheet.create({
    ...
    siteName: { color: t.text.primary, fontSize: 15, fontWeight: '700' },
    ...
    outputSite: { color: t.text.primary, fontSize: 14, fontWeight: '700' },
    outputMeta: { color: t.text.muted, fontSize: 12, marginTop: 4 },
    outputVolume: { color: t.accent.green, fontSize: 16, fontWeight: '800', marginTop: 6 },
