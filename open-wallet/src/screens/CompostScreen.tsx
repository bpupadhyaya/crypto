...
export function CompostScreen({ onClose }: Props) {
  ...
  const s = useMemo(() => StyleSheet.create({
    ...
    siteName: { color: t.text.primary, fontSize: fonts.md, fontWeight: fonts.bold },
    siteMeta: { color: t.text.muted, fontSize: fonts.sm, marginTop: 4 },
    ...
    fillText: { color: t.text.muted, fontSize: fonts.xs, width: 45, textAlign: 'right' },
    ...
    typeTagText: { color: t.text.muted, fontSize: fonts.xs },
    ...
    outputSite: { color: t.text.primary, fontSize: fonts.md, fontWeight: fonts.bold },
    outputMeta: { color: t.text.muted, fontSize: fonts.sm, marginTop: 4 },
    outputVolume: { color: t.accent.green, fontSize: fonts.lg, fontWeight: fonts.heavy, marginTop: 6 },
    qualityBadge: { paddingHorizontal: 8, paddingVertical: 2, borderRadius: 8, alignSelf: 'flex-start', marginTop: 6 },
    qualityText: { color: '#fff', fontSize: fonts.xs, fontWeight: fonts.semibold },
