...
export function BarrierFreeScreen({ onClose }: Props) {
  ...
  const s = useMemo(() => StyleSheet.create({
    ...
    scoreValue: { fontSize: 32, fontWeight: fonts.heavy },
    scoreLabel: { color: t.text.muted, fontSize: 12, fontWeight: fonts.semibold },
    ...
    locType: { color: t.accent.blue, fontSize: 11, fontWeight: fonts.bold, textTransform: 'uppercase', marginTop: 4 },
    ...
    locScore: { color: t.text.primary, fontSize: 14, fontWeight: fonts.bold, marginTop: 10 },
    ...
    barrierCategory: { fontSize: 12, fontWeight: fonts.bold },
    barrierPriority: { fontSize: 11, fontWeight: fonts.bold, paddingHorizontal: 8, paddingVertical: 3, borderRadius: 8, overflow: 'hidden', color: '#fff' },
    barrierLocation: { color: t.text.primary, fontSize: 14, fontWeight: fonts.semibold, marginTop: 6 },
    barrierDesc: { color: t.text.secondary, fontSize: 13, lineHeight: 20, marginTop: 6 },
    barrierStatus: { color: t.text.muted, fontSize: 12, marginTop: 8, fontWeight: fonts.semibold },
    guideCard: { backgroundColor: t.bg.card, borderRadius: 16, padding: 16, marginHorizontal: 20, marginBottom: 12 },
    guideTitle: { color: t.text.primary, fontSize: 15, fontWeight: fonts.bold, marginBottom: 10 },
    ...
    champInfo: { flex: 1 },
    champName: { color: t.text.primary, fontSize: 15, fontWeight: fonts.bold },
    champStats: { color: t.text.muted, fontSize: 12, marginTop: 2 },
    champLevel: { fontSize: 12, fontWeight: fonts.bold, marginTop: 4, textTransform: 'uppercase' },
    ...
    ratingSelectorText: { fontSize: 14, fontWeight: fonts.bold },
    ...
    categoryBtnText: { fontSize: 12, fontWeight: fonts.semibold },
