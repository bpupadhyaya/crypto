...
export function BarrierFreeScreen({ onClose }: Props) {
  ...
  const s = useMemo(() => StyleSheet.create({
    ...
    scoreLabel: { color: t.text.muted, fontSize: fonts.sm, fontWeight: fonts.semibold },
    ...
    locAddress: { color: t.text.muted, fontSize: fonts.sm, marginTop: 2 },
    locType: { color: t.accent.blue, fontSize: fonts.xs, fontWeight: fonts.bold, textTransform: 'uppercase', marginTop: 4 },
    ratingRow: { flexDirection: 'row', justifyContent: 'space-between', marginTop: 12 },
    ratingItem: { alignItems: 'center', flex: 1 },
    ratingLabel: { color: t.text.muted, fontSize: fonts.xs, marginBottom: 4 },
    ratingDots: { flexDirection: 'row', gap: 3 },
    ratingDot: { width: 8, height: 8, borderRadius: 4 },
    locScore: { color: t.text.primary, fontSize: fonts.md, fontWeight: fonts.bold, marginTop: 10 },
    locNotes: { color: t.text.secondary, fontSize: fonts.sm, lineHeight: 18, marginTop: 6 },
    locAuditor: { color: t.text.muted, fontSize: fonts.xs, marginTop: 4 },
    ...
    barrierCategory: { fontSize: fonts.sm, fontWeight: fonts.bold },
    barrierPriority: { fontSize: fonts.xs, fontWeight: fonts.bold, paddingHorizontal: 8, paddingVertical: 3, borderRadius: 8, overflow: 'hidden', color: '#fff' },
    barrierLocation: { color: t.text.primary, fontSize: fonts.md, fontWeight: fonts.semibold, marginTop: 6 },
    barrierDesc: { color: t.text.secondary, fontSize: fonts.sm, lineHeight: 20, marginTop: 6 },
    barrierStatus: { color: t.text.muted, fontSize: fonts.sm, marginTop: 8, fontWeight: fonts.semibold },
    guideCard: { backgroundColor: t.bg.card, borderRadius: 16, padding: 16, marginHorizontal: 20, marginBottom: 12 },
    guideTitle: { color: t.text.primary, fontSize: fonts.md, fontWeight: fonts.bold, marginBottom: 10 },
    guideItem: { color: t.text.secondary, fontSize: fonts.sm, lineHeight: 22, paddingLeft: 12 },
    ...
    champBadgeText: { fontSize: fonts.xl },
    champInfo: { flex: 1 },
    champName: { color: t.text.primary, fontSize: fonts.md, fontWeight: fonts.bold },
    champStats: { color: t.text.muted, fontSize: fonts.sm, marginTop: 2 },
    champLevel: { fontSize: fonts.sm, fontWeight: fonts.bold, marginTop: 4, textTransform: 'uppercase' },
    ...
    ratingSelectorText: { fontSize: fonts.md, fontWeight: fonts.bold },
    ...
    categoryBtnText: { fontSize: fonts.sm, fontWeight: fonts.semibold },
