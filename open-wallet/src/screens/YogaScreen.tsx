...
export function YogaScreen({ onClose }: Props) {
  ...
  const s = useMemo(() => StyleSheet.create({
    ...
    poseIconText: { color: '#fff', fontSize: fonts.lg, fontWeight: fonts.bold },
    poseName: { color: t.text.primary, fontSize: fonts.lg, fontWeight: fonts.bold, flex: 1 },
    poseSanskrit: { color: t.text.muted, fontSize: fonts.sm, fontStyle: 'italic' },
    poseDifficulty: { paddingHorizontal: 10, paddingVertical: 3, borderRadius: 10 },
    poseDifficultyText: { color: '#fff', fontSize: fonts.xs, fontWeight: fonts.bold, textTransform: 'uppercase' },
    poseDescription: { color: t.text.muted, fontSize: fonts.sm, lineHeight: 19, marginTop: 4 },
    poseBenefits: { color: t.accent.green, fontSize: fonts.sm, fontWeight: fonts.semibold, marginTop: 6 },
    poseHold: { color: t.text.muted, fontSize: fonts.sm, marginTop: 4 },
    sessionCard: { backgroundColor: t.bg.secondary, borderRadius: 16, padding: 16, marginHorizontal: 20, marginBottom: 12 },
    sessionTitle: { color: t.text.primary, fontSize: fonts.md, fontWeight: fonts.bold },
    sessionMeta: { color: t.text.muted, fontSize: fonts.sm, marginTop: 4 },
    sessionInstructor: { color: t.accent.blue, fontSize: fonts.sm, fontWeight: fonts.semibold, marginTop: 4 },
    sessionLevel: { paddingHorizontal: 10, paddingVertical: 3, borderRadius: 10, alignSelf: 'flex-start', marginTop: 6 },
    sessionLevelText: { color: '#fff', fontSize: fonts.xs, fontWeight: fonts.bold, textTransform: 'uppercase' },
    sessionFooter: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', marginTop: 12 },
    sessionParticipants: { color: t.text.muted, fontSize: fonts.sm },
    sessionReward: { color: t.accent.green, fontSize: fonts.sm, fontWeight: fonts.bold },
    ...
    breathingIconText: { color: t.accent.blue, fontSize: fonts.xl, fontWeight: fonts.bold },
    breathingName: { color: t.text.primary, fontSize: fonts.md, fontWeight: fonts.bold },
    breathingTechnique: { color: t.accent.blue, fontSize: fonts.sm, fontWeight: fonts.semibold },
    breathingDesc: { color: t.text.muted, fontSize: fonts.sm, lineHeight: 19, marginBottom: 8 },
    breathingMeta: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center' },
    breathingDuration: { color: t.text.muted, fontSize: fonts.sm },
    startBtn: { backgroundColor: t.accent.blue, borderRadius: 12, paddingHorizontal: 16, paddingVertical: 8 },
    startBtnText: { color: '#fff', fontSize: fonts.sm, fontWeight: fonts.bold },
    ...
    challengeDesc: { color: t.text.muted, fontSize: fonts.sm, lineHeight: 19, marginTop: 4 },
    ...
    challengeMetaText: { color: t.text.muted, fontSize: fonts.sm },
    challengeReward: { color: t.accent.green, fontSize: fonts.sm, fontWeight: fonts.bold },
    ...
    activeTagText: { color: t.accent.green, fontSize: fonts.xs, fontWeight: fonts.bold },
    instructorSection: { backgroundColor: t.accent.blue + '12', borderRadius: 16, padding: 20, marginHorizontal: 20, marginBottom: 16 },
    instructorTitle: { color: t.text.primary, fontSize: fonts.md, fontWeight: fonts.bold, marginBottom: 8 },
    instructorDesc: { color: t.text.muted, fontSize: fonts.sm, lineHeight: 19, marginBottom: 12 },
    ...
    streakLabel: { color: t.text.muted, fontSize: fonts.md, fontWeight: fonts.semibold, marginTop: 4 },
    ...
    <>
      ...
      <View style={s.card}>
        ...
        <View style={[s.statRow, { marginTop: 12 }]}>
          ...
          <View style={s.statItem}>
            <Text style={[s.statValue, { fontSize: fonts.md }]}>{stats.favoriteStyle}</Text>
    ...
    <>
      ...
      {breathing.map((exercise) => (
        <View key={exercise.id} style={s.breathingCard}>
          ...
          <Text style={[s.breathingDesc, { color: t.accent.green, fontWeight: fonts.semibold, marginBottom: 4 }]}>
            Benefits: {exercise.benefits}
          </Text>
