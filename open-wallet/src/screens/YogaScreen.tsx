...
export function YogaScreen({ onClose }: Props) {
  ...
  const s = useMemo(() => StyleSheet.create({
    ...
    poseIconText: { color: '#fff', fontSize: 16, fontWeight: fonts.bold },
    poseName: { color: t.text.primary, fontSize: 16, fontWeight: fonts.bold, flex: 1 },
    ...
    poseDifficultyText: { color: '#fff', fontSize: 11, fontWeight: fonts.bold, textTransform: 'uppercase' },
    poseDescription: { color: t.text.muted, fontSize: 13, lineHeight: 19, marginTop: 4 },
    poseBenefits: { color: t.accent.green, fontSize: 12, fontWeight: fonts.semibold, marginTop: 6 },
    ...
    sessionTitle: { color: t.text.primary, fontSize: 15, fontWeight: fonts.bold },
    sessionMeta: { color: t.text.muted, fontSize: 12, marginTop: 4 },
    sessionInstructor: { color: t.accent.blue, fontSize: 13, fontWeight: fonts.semibold, marginTop: 4 },
    sessionLevel: { paddingHorizontal: 10, paddingVertical: 3, borderRadius: 10, alignSelf: 'flex-start', marginTop: 6 },
    sessionLevelText: { color: '#fff', fontSize: 11, fontWeight: fonts.bold, textTransform: 'uppercase' },
    ...
    sessionReward: { color: t.accent.green, fontSize: 13, fontWeight: fonts.bold },
    ...
    breathingIconText: { color: t.accent.blue, fontSize: 18, fontWeight: fonts.bold },
    breathingName: { color: t.text.primary, fontSize: 15, fontWeight: fonts.bold },
    breathingTechnique: { color: t.accent.blue, fontSize: 12, fontWeight: fonts.semibold },
    ...
    challengeReward: { color: t.accent.green, fontSize: 13, fontWeight: fonts.bold },
    ...
    activeTagText: { color: t.accent.green, fontSize: 11, fontWeight: fonts.bold },
    instructorSection: { backgroundColor: t.accent.blue + '12', borderRadius: 16, padding: 20, marginHorizontal: 20, marginBottom: 16 },
    instructorTitle: { color: t.text.primary, fontSize: 15, fontWeight: fonts.bold, marginBottom: 8 },
