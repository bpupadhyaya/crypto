...
export function AquaponicsScreen({ onClose }: Props) {
  ...
  const s = useMemo(() => StyleSheet.create({
    ...
    systemName: { color: t.text.primary, fontSize: 16, fontWeight: '700' },
    ...
    prosConsCol: { flex: 1 },
    prosConsTitle: { color: t.text.primary, fontSize: 12, fontWeight: '700', marginBottom: 4 },
    prosItem: { color: t.accent.green, fontSize: 11, lineHeight: 18 },
    consItem: { color: t.accent.orange, fontSize: 11, lineHeight: 18 },
    bestFor: { color: t.accent.blue, fontSize: 12, fontWeight: '600', marginTop: 8 },
    ...
    communityType: { color: t.accent.blue, fontSize: 12, fontWeight: '600', marginTop: 2 },
    ...
    guideInfo: { flex: 1 },
    guideTitle: { color: t.text.primary, fontSize: 14, fontWeight: '700' },
    guideType: { color: t.accent.blue, fontSize: 11, fontWeight: '600', marginTop: 2 },
    ...
    stepNum: { color: t.accent.blue, fontSize: 13, fontWeight: '800', width: 24 },
    ...
    harvestInfo: { flex: 1 },
    harvestCrop: { color: t.text.primary, fontSize: 14, fontWeight: '600' },
    harvestSystem: { color: t.text.muted, fontSize: 11, marginTop: 2 },
    harvestQty: { color: t.accent.green, fontSize: 15, fontWeight: '700' },
    ...
    classTitle: { color: t.text.primary, fontSize: 16, fontWeight: '800', textAlign: 'center', marginTop: 8 },
    classInstructor: { color: t.accent.purple, fontSize: 13, fontWeight: '600', textAlign: 'center', marginTop: 4 },
    ...
    classStatValue: { color: t.text.primary, fontSize: 18, fontWeight: '800', textAlign: 'center' },
