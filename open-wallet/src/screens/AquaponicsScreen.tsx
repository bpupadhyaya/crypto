...
export function AquaponicsScreen({ onClose }: Props) {
  ...
  const s = useMemo(() => StyleSheet.create({
    ...
    badge: { fontSize: fonts.hero, marginRight: 12 },
    ...
    systemIcon: { fontSize: fonts.hero, marginRight: 12 },
    systemName: { color: t.text.primary, fontSize: fonts.lg, fontWeight: fonts.bold },
    systemDesc: { color: t.text.secondary, fontSize: fonts.sm, marginTop: 8, lineHeight: 20 },
    systemHow: { color: t.text.muted, fontSize: fonts.sm, marginTop: 8, lineHeight: 18 },
    prosConsRow: { flexDirection: 'row', marginTop: 12, gap: 12 },
    prosConsCol: { flex: 1 },
    prosConsTitle: { color: t.text.primary, fontSize: fonts.sm, fontWeight: fonts.bold, marginBottom: 4 },
    prosItem: { color: t.accent.green, fontSize: fonts.xs, lineHeight: 18 },
    consItem: { color: t.accent.orange, fontSize: fonts.xs, lineHeight: 18 },
    bestFor: { color: t.accent.blue, fontSize: fonts.sm, fontWeight: fonts.semibold, marginTop: 8 },
    expandArrow: { color: t.text.muted, fontSize: fonts.lg, marginLeft: 'auto' },
    // Community systems
    ...
    communityType: { color: t.accent.blue, fontSize: fonts.sm, fontWeight: fonts.semibold, marginTop: 2 },
    communityLocation: { color: t.text.muted, fontSize: fonts.xs, marginTop: 2 },
    ...
    cropText: { color: t.text.secondary, fontSize: fonts.xs },
    ...
    guideIcon: { fontSize: fonts.hero, marginRight: 12 },
    guideInfo: { flex: 1 },
    guideTitle: { color: t.text.primary, fontSize: fonts.md, fontWeight: fonts.bold },
    guideType: { color: t.accent.blue, fontSize: fonts.xs, fontWeight: fonts.semibold, marginTop: 2 },
    guideMeta: { flexDirection: 'row', gap: 12, marginTop: 8 },
    guideMetaText: { color: t.text.muted, fontSize: fonts.xs },
    ...
    stepNum: { color: t.accent.blue, fontSize: fonts.sm, fontWeight: fonts.heavy, width: 24 },
    ...
    harvestIcon: { fontSize: fonts.xxxl, marginRight: 12 },
    harvestInfo: { flex: 1 },
    harvestCrop: { color: t.text.primary, fontSize: fonts.md, fontWeight: fonts.semibold },
    harvestSystem: { color: t.text.muted, fontSize: fonts.xs, marginTop: 2 },
    harvestQty: { color: t.accent.green, fontSize: fonts.md, fontWeight: fonts.bold },
    harvestDate: { color: t.text.muted, fontSize: fonts.xs, marginTop: 2, textAlign: 'right' },
    // Class
    classCard: { backgroundColor: t.accent.purple + '10', borderRadius: 20, padding: 20, marginBottom: 16 },
    classTitle: { color: t.text.primary, fontSize: fonts.lg, fontWeight: fonts.heavy, textAlign: 'center', marginTop: 8 },
    classInstructor: { color: t.accent.purple, fontSize: fonts.sm, fontWeight: fonts.semibold, textAlign: 'center', marginTop: 4 },
    classDetail: { color: t.text.secondary, fontSize: fonts.sm, textAlign: 'center', marginTop: 2 },
    classStats: { flexDirection: 'row', justifyContent: 'space-around', marginTop: 16 },
    classStatValue: { color: t.text.primary, fontSize: fonts.xl, fontWeight: fonts.heavy, textAlign: 'center' },
    classStatLabel: { color: t.text.muted, fontSize: fonts.xs, textAlign: 'center', marginTop: 2 },
      ...
      {DEMO_COMMUNITY_SYSTEMS.map((cs) => (
        <View key={cs.id} style={s.communityCard}>
          ...
          <View style={s.communityStats}>
            ...
            <View style={s.statItem}>
              <Text style={[s.statValue, { color: t.accent.green, fontSize: fonts.lg }]}>{cs.eOTKEarned}</Text>
