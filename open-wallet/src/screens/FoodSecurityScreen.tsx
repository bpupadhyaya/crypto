...
export function FoodSecurityScreen({ onClose }: Props) {
  ...
  const st = useMemo(() => StyleSheet.create({
    ...
    gardenName: { color: t.text.primary, fontSize: 16, fontWeight: '700', marginBottom: 2 },
    ...
    shareType: { fontSize: 11, fontWeight: '700', paddingHorizontal: 8, paddingVertical: 3, borderRadius: 6, overflow: 'hidden', alignSelf: 'flex-start', marginBottom: 6 },
    shareDesc: { color: t.text.primary, fontSize: 15, fontWeight: '600', marginBottom: 4 },
    ...
    dietaryText: { fontSize: 9, fontWeight: '600' },
    ...
    cropIconText: { fontSize: 14, fontWeight: '800', color: '#fff' },
    cropName: { color: t.text.primary, fontSize: 14, fontWeight: '700' },
    cropTiming: { color: t.text.muted, fontSize: 11 },
    cropTip: { color: t.text.secondary, fontSize: 11, fontStyle: 'italic', marginTop: 2 },
    cropStatus: { fontSize: 10, fontWeight: '700', paddingHorizontal: 6, paddingVertical: 2, borderRadius: 4, overflow: 'hidden', color: '#fff' },
    alertCard: { backgroundColor: t.bg.card, borderRadius: 12, padding: 14, marginBottom: 10, borderLeftWidth: 4, borderLeftColor: '#f97316' },
    alertItem: { color: t.text.primary, fontSize: 14, fontWeight: '700', marginBottom: 2 },
    alertMeta: { color: t.text.muted, fontSize: 11 },
    guideCard: { backgroundColor: t.bg.card, borderRadius: 12, padding: 14, marginBottom: 10 },
    guideCategory: { color: t.accent.blue, fontSize: 10, fontWeight: '700', textTransform: 'uppercase', letterSpacing: 1, marginBottom: 4 },
    guideTitle: { color: t.text.primary, fontSize: 15, fontWeight: '700', marginBottom: 4 },
    ...
    fbName: { color: t.text.primary, fontSize: 14, fontWeight: '700', marginBottom: 6 },
    fbNeedBadge: { paddingHorizontal: 8, paddingVertical: 3, borderRadius: 6, alignSelf: 'flex-start', marginBottom: 8 },
    fbNeedText: { fontSize: 10, fontWeight: '700', color: '#fff' },
  }), [t]);
