...
export function FoodSecurityScreen({ onClose }: Props) {
  ...
  const st = useMemo(() => StyleSheet.create({
    ...
    scoreLabel: { fontSize: 14, fontWeight: fonts.bold, textAlign: 'center', marginBottom: 2 },
    ...
    gardenName: { color: t.text.primary, fontSize: 16, fontWeight: fonts.bold, marginBottom: 2 },
    gardenLocation: { color: t.text.muted, fontSize: 12, marginBottom: 8 },
    tagRow: { flexDirection: 'row', flexWrap: 'wrap', gap: 6, marginBottom: 8 },
    tag: { paddingHorizontal: 8, paddingVertical: 3, borderRadius: 6, backgroundColor: t.bg.primary },
    tagText: { color: t.text.secondary, fontSize: 10, fontWeight: fonts.semibold },
    ...
    shareType: { fontSize: 11, fontWeight: fonts.bold, paddingHorizontal: 8, paddingVertical: 3, borderRadius: 6, overflow: 'hidden', alignSelf: 'flex-start', marginBottom: 6 },
    shareDesc: { color: t.text.primary, fontSize: 15, fontWeight: fonts.semibold, marginBottom: 4 },
    shareMeta: { color: t.text.muted, fontSize: 11, marginBottom: 2 },
    dietaryTag: { paddingHorizontal: 6, paddingVertical: 2, borderRadius: 4, marginRight: 4, marginTop: 4 },
    dietaryText: { fontSize: 9, fontWeight: fonts.semibold },
    ...
    secondaryBtnText: { color: t.accent.blue, fontSize: 14, fontWeight: fonts.bold },
    ...
    cropIconText: { fontSize: 14, fontWeight: fonts.heavy, color: '#fff' },
    cropName: { color: t.text.primary, fontSize: 14, fontWeight: fonts.bold },
    cropTiming: { color: t.text.muted, fontSize: 11 },
    cropTip: { color: t.text.secondary, fontSize: 11, fontStyle: 'italic', marginTop: 2 },
    cropStatus: { fontSize: 10, fontWeight: fonts.bold, paddingHorizontal: 6, paddingVertical: 2, borderRadius: 4, overflow: 'hidden', color: '#fff' },
    alertCard: { backgroundColor: t.bg.card, borderRadius: 12, padding: 14, marginBottom: 10, borderLeftWidth: 4, borderLeftColor: '#f97316' },
    alertItem: { color: t.text.primary, fontSize: 14, fontWeight: fonts.bold, marginBottom: 2 },
    alertMeta: { color: t.text.muted, fontSize: 11 },
    guideCard: { backgroundColor: t.bg.card, borderRadius: 12, padding: 14, marginBottom: 10 },
    guideCategory: { color: t.accent.blue, fontSize: 10, fontWeight: fonts.bold, textTransform: 'uppercase', letterSpacing: 1, marginBottom: 4 },
    guideTitle: { color: t.text.primary, fontSize: 15, fontWeight: fonts.bold, marginBottom: 4 },
    guideSummary: { color: t.text.secondary, fontSize: 12, lineHeight: 18, marginBottom: 4 },
    guideRead: { color: t.text.muted, fontSize: 10 },
    ...
    fbName: { color: t.text.primary, fontSize: 14, fontWeight: fonts.bold, marginBottom: 6 },
    fbNeedBadge: { paddingHorizontal: 8, paddingVertical: 3, borderRadius: 6, alignSelf: 'flex-start', marginBottom: 8 },
    fbNeedText: { fontSize: 10, fontWeight: fonts.bold, color: '#fff' },
  }), [t]);
