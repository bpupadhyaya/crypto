...
export function IdentityScreen({ onClose }: Props) {
  ...
  const s = useMemo(() => StyleSheet.create({
    ...
    idValue: { color: t.text.primary, fontSize: 14, fontWeight: '700', fontFamily: 'monospace', marginTop: 4 },
    // Reputation section
    ...
    repTitle: { color: t.text.primary, fontSize: 17, fontWeight: '700' },
    repBadge: { width: 40, height: 40, borderRadius: 20, justifyContent: 'center', alignItems: 'center' },
    repBadgeText: { color: '#fff', fontSize: 18, fontWeight: '800' },
    repScore: { color: t.text.primary, fontSize: 36, fontWeight: '800', textAlign: 'center' },
    repScoreLabel: { color: t.text.muted, fontSize: 12, textAlign: 'center', marginTop: 2 },
    repLevel: { textAlign: 'center', fontSize: 16, fontWeight: '700', marginTop: 8 },
    ...
    breakdownValue: { color: t.text.primary, fontSize: 14, fontWeight: '600' },
    ...
    chainInfo: { flex: 1 },
    chainName: { color: t.text.primary, fontSize: 15, fontWeight: '600' },
    ...
    verifiedText: { color: t.accent.green, fontSize: 11, fontWeight: '700' },
    unverifiedBadge: { backgroundColor: t.accent.yellow + '20', paddingHorizontal: 8, paddingVertical: 3, borderRadius: 6 },
    unverifiedText: { color: t.accent.yellow, fontSize: 11, fontWeight: '700' },
    ...
    selectorTitle: { color: t.text.primary, fontSize: 16, fontWeight: '700', marginBottom: 12 },
    ...
    cancelText: { color: t.accent.red, fontSize: 15, fontWeight: '600' },
    // QR
    ...
    emptyTitle: { color: t.text.primary, fontSize: 18, fontWeight: '700', textAlign: 'center', marginBottom: 8 },
                ...
                >
                  ...
                  {linked ? (
                    ...
                    linkingState !== 'idle' && selectedChain === chain.id ? (
                      ...
                      <Text style={{ color: t.accent.blue, fontSize: 13, fontWeight: '600' }}>+ Link</Text>
                    )
                  )}
                </TouchableOpacity>
              </View>
        ...
        <View style={s.qrCard}>
          {showQR ? (
            ...
            <TouchableOpacity onPress={() => setShowQR(true)} style={{ alignItems: 'center' }}>
              ...
              <Text style={{ color: t.accent.blue, fontSize: 15, fontWeight: '600' }}>Show QR Code</Text>
            </TouchableOpacity>
          )}
