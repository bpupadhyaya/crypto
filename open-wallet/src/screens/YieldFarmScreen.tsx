...
export function YieldFarmScreen({ onClose }: Props) {
  ...
  const s = useMemo(() => StyleSheet.create({
    ...
    harvestBtnText: { color: '#000', fontSize: 15, fontWeight: fonts.heavy },
    ...
    farmName: { color: t.text.primary, fontSize: 16, fontWeight: fonts.bold },
    farmApy: { color: t.accent.green, fontSize: 14, fontWeight: fonts.bold },
    farmStats: { flexDirection: 'row', justifyContent: 'space-between', marginBottom: 6 },
    farmStatLabel: { color: t.text.muted, fontSize: 12 },
    farmStatValue: { color: t.text.secondary, fontSize: 12, fontWeight: fonts.semibold },
    ...
    rewardValue: { color: t.accent.green, fontSize: 12, fontWeight: fonts.bold },
    ...
    stakeBtnText: { color: t.accent.green, fontSize: 13, fontWeight: fonts.bold },
    unstakeBtnText: { color: t.accent.red, fontSize: 13, fontWeight: fonts.bold },
    claimBtnText: { color: t.accent.purple, fontSize: 13, fontWeight: fonts.bold },
    multiplierTag: { backgroundColor: t.accent.purple + '20', borderRadius: 6, paddingHorizontal: 6, paddingVertical: 2 },
    multiplierText: { color: t.accent.purple, fontSize: 10, fontWeight: fonts.bold },
