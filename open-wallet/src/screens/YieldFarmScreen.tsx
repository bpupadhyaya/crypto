...
export function YieldFarmScreen({ onClose }: Props) {
  ...
  const s = useMemo(() => StyleSheet.create({
    ...
    harvestBtnText: { color: '#000', fontSize: fonts.md, fontWeight: fonts.heavy },
    ...
    farmName: { color: t.text.primary, fontSize: fonts.lg, fontWeight: fonts.bold },
    farmApy: { color: t.accent.green, fontSize: fonts.md, fontWeight: fonts.bold },
    farmStats: { flexDirection: 'row', justifyContent: 'space-between', marginBottom: 6 },
    farmStatLabel: { color: t.text.muted, fontSize: fonts.sm },
    farmStatValue: { color: t.text.secondary, fontSize: fonts.sm, fontWeight: fonts.semibold },
    ...
    rewardLabel: { color: t.accent.green, fontSize: fonts.sm },
    rewardValue: { color: t.accent.green, fontSize: fonts.sm, fontWeight: fonts.bold },
    ...
    stakeBtnText: { color: t.accent.green, fontSize: fonts.sm, fontWeight: fonts.bold },
    unstakeBtnText: { color: t.accent.red, fontSize: fonts.sm, fontWeight: fonts.bold },
    claimBtnText: { color: t.accent.purple, fontSize: fonts.sm, fontWeight: fonts.bold },
    multiplierTag: { backgroundColor: t.accent.purple + '20', borderRadius: 6, paddingHorizontal: 6, paddingVertical: 2 },
    multiplierText: { color: t.accent.purple, fontSize: fonts.xs, fontWeight: fonts.bold },
    ...
    emptyText: { color: t.text.muted, fontSize: fonts.md, textAlign: 'center', paddingVertical: 32 },
  }), [t]);
