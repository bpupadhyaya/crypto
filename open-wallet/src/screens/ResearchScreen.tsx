...
export function ResearchScreen({ onClose }: Props) {
  ...
  const s = useMemo(() => StyleSheet.create({
    ...
    catOptionText: { color: t.text.muted, fontSize: fonts.sm, fontWeight: fonts.semibold },
    ...
    typeBtnText: { color: t.text.muted, fontSize: fonts.sm, fontWeight: fonts.bold },
    ...
    detailLead: { color: t.text.muted, fontSize: fonts.sm, marginHorizontal: 20, marginTop: 8 },
    hashText: { color: t.text.muted, fontSize: fonts.xs, fontFamily: 'monospace', marginTop: 4 },
    ...
    eOTKText: { color: '#e91e63', fontSize: fonts.sm, fontWeight: fonts.bold },
  }), [t]);
