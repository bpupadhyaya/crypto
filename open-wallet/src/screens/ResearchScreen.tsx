...
export function ResearchScreen({ onClose }: Props) {
  ...
  const s = useMemo(() => StyleSheet.create({
    ...
    catOptionText: { color: t.text.muted, fontSize: 13, fontWeight: '600' },
    ...
    typeBtnText: { color: t.text.muted, fontSize: 12, fontWeight: '700' },
    ...
    eOTKText: { color: '#e91e63', fontSize: 12, fontWeight: '700' },
  }), [t]);
