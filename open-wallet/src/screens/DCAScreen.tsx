...
export function DCAScreen({ onClose }: Props) {
  ...
  const s = useMemo(() => StyleSheet.create({
    ...
    summaryValue: { color: t.accent.blue, fontSize: 36, fontWeight: fonts.heavy, marginTop: 4 },
    ...
    section: { color: t.text.secondary, fontSize: 12, fontWeight: fonts.bold, textTransform: 'uppercase', letterSpacing: 1.5, marginLeft: 24, marginBottom: 12, marginTop: 8 },
    ...
    badgeTextActive: { color: t.accent.green, fontSize: 11, fontWeight: fonts.bold },
    badgeTextInactive: { color: t.accent.red, fontSize: 11, fontWeight: fonts.bold },
    row: { flexDirection: 'row', justifyContent: 'space-between', marginTop: 6 },
    label: { color: t.text.muted, fontSize: 13 },
    value: { color: t.text.secondary, fontSize: 13, fontWeight: fonts.semibold },
    ...
    toggleBtnText: { color: t.accent.blue, fontSize: 13, fontWeight: fonts.bold },
    deleteBtn: { backgroundColor: t.accent.red + '20', borderRadius: 8, paddingVertical: 8, paddingHorizontal: 16, alignItems: 'center' },
    deleteBtnText: { color: t.accent.red, fontSize: 13, fontWeight: fonts.bold },
    formCard: { backgroundColor: t.bg.card, borderRadius: 16, padding: 20, marginHorizontal: 20, marginBottom: 16 },
    formLabel: { color: t.text.secondary, fontSize: 13, fontWeight: fonts.semibold, marginBottom: 8, marginTop: 12 },
    formInput: { backgroundColor: t.bg.primary, borderRadius: 12, padding: 14, color: t.text.primary, fontSize: 18, fontWeight: fonts.bold, textAlign: 'center' },
    ...
    freqChipText: { color: t.text.secondary, fontSize: 14, fontWeight: fonts.semibold },
    ...
    createBtnText: { color: '#fff', fontSize: 17, fontWeight: fonts.bold },
    gainPositive: { color: t.accent.green, fontSize: 13, fontWeight: fonts.bold },
    gainNegative: { color: t.accent.red, fontSize: 13, fontWeight: fonts.bold },
    perfValue: { color: t.text.primary, fontSize: 22, fontWeight: fonts.heavy, marginTop: 4, marginBottom: 4 },
    historyPrice: { color: t.text.primary, fontSize: 14, fontWeight: fonts.semibold },
