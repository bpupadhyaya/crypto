...
export function DCAScreen({ onClose }: Props) {
  ...
  const s = useMemo(() => StyleSheet.create({
    ...
    summaryValue: { color: t.accent.blue, fontSize: fonts.hero, fontWeight: fonts.heavy, marginTop: 4 },
    ...
    badgeTextActive: { color: t.accent.green, fontSize: fonts.xs, fontWeight: fonts.bold },
    badgeTextInactive: { color: t.accent.red, fontSize: fonts.xs, fontWeight: fonts.bold },
    ...
    toggleBtnText: { color: t.accent.blue, fontSize: fonts.sm, fontWeight: fonts.bold },
    deleteBtn: { backgroundColor: t.accent.red + '20', borderRadius: 8, paddingVertical: 8, paddingHorizontal: 16, alignItems: 'center' },
    deleteBtnText: { color: t.accent.red, fontSize: fonts.sm, fontWeight: fonts.bold },
    formCard: { backgroundColor: t.bg.card, borderRadius: 16, padding: 20, marginHorizontal: 20, marginBottom: 16 },
    formLabel: { color: t.text.secondary, fontSize: fonts.sm, fontWeight: fonts.semibold, marginBottom: 8, marginTop: 12 },
    formInput: { backgroundColor: t.bg.primary, borderRadius: 12, padding: 14, color: t.text.primary, fontSize: fonts.xl, fontWeight: fonts.bold, textAlign: 'center' },
    ...
    gainPositive: { color: t.accent.green, fontSize: fonts.sm, fontWeight: fonts.bold },
    gainNegative: { color: t.accent.red, fontSize: fonts.sm, fontWeight: fonts.bold },
    perfValue: { color: t.text.primary, fontSize: fonts.xxl, fontWeight: fonts.heavy, marginTop: 4, marginBottom: 4 },
    historyPrice: { color: t.text.primary, fontSize: fonts.md, fontWeight: fonts.semibold },
    historyDate: { color: t.text.muted, fontSize: fonts.sm, marginTop: 2 },
