...
export function YieldOptimizerScreen({ onClose }: Props) {
  ...
  const s = useMemo(() => StyleSheet.create({
    ...
    cardTitle: { color: t.text.primary, fontSize: 16, fontWeight: fonts.bold, flex: 1 },
    typeBadge: { paddingHorizontal: 8, paddingVertical: 2, borderRadius: 6 },
    typeBadgeText: { fontSize: 11, fontWeight: fonts.bold },
    row: { flexDirection: 'row', justifyContent: 'space-between', marginTop: 6 },
    label: { color: t.text.muted, fontSize: 13 },
    value: { color: t.text.secondary, fontSize: 13, fontWeight: fonts.semibold },
    apyValue: { color: t.accent.green, fontSize: 13, fontWeight: fonts.bold },
    ...
    compoundLabel: { color: t.text.secondary, fontSize: 13, fontWeight: fonts.semibold },
    ...
    harvestBtnText: { color: '#fff', fontSize: 17, fontWeight: fonts.bold },
    ...
    compareProtocol: { color: t.text.primary, fontSize: 15, fontWeight: fonts.bold },
    riskBadge: { paddingHorizontal: 8, paddingVertical: 2, borderRadius: 6 },
    riskBadgeText: { fontSize: 11, fontWeight: fonts.bold },
    compareApy: { color: t.accent.green, fontSize: 24, fontWeight: fonts.heavy, marginVertical: 4 },
    calcCard: { backgroundColor: t.bg.card, borderRadius: 16, padding: 20, marginHorizontal: 20, marginBottom: 16 },
    calcLabel: { color: t.text.secondary, fontSize: 13, fontWeight: fonts.semibold, marginBottom: 8, marginTop: 12 },
    calcInput: { backgroundColor: t.bg.primary, borderRadius: 12, padding: 14, color: t.text.primary, fontSize: 18, fontWeight: fonts.bold, textAlign: 'center' },
    ...
    resultValue: { color: t.accent.green, fontSize: 32, fontWeight: fonts.heavy, marginTop: 4 },
    ...
    settingLabel: { color: t.text.primary, fontSize: 15, fontWeight: fonts.semibold },
