...
export function YieldOptimizerScreen({ onClose }: Props) {
  ...
  const s = useMemo(() => StyleSheet.create({
    ...
    summarySubtext: { color: t.text.secondary, fontSize: fonts.md, marginTop: 8 },
    ...
    section: { color: t.text.secondary, fontSize: fonts.sm, fontWeight: fonts.bold, textTransform: 'uppercase', letterSpacing: 1.5, marginLeft: 24, marginBottom: 12, marginTop: 8 },
    card: { backgroundColor: t.bg.card, borderRadius: 16, padding: 16, marginHorizontal: 20, marginBottom: 10 },
    cardHeader: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center' },
    cardTitle: { color: t.text.primary, fontSize: fonts.lg, fontWeight: fonts.bold, flex: 1 },
    typeBadge: { paddingHorizontal: 8, paddingVertical: 2, borderRadius: 6 },
    typeBadgeText: { fontSize: fonts.xs, fontWeight: fonts.bold },
    row: { flexDirection: 'row', justifyContent: 'space-between', marginTop: 6 },
    label: { color: t.text.muted, fontSize: fonts.sm },
    value: { color: t.text.secondary, fontSize: fonts.sm, fontWeight: fonts.semibold },
    apyValue: { color: t.accent.green, fontSize: fonts.sm, fontWeight: fonts.bold },
    ...
    compoundLabel: { color: t.text.secondary, fontSize: fonts.sm, fontWeight: fonts.semibold },
    ...
    harvestBtnText: { color: '#fff', fontSize: fonts.lg, fontWeight: fonts.bold },
    ...
    compareProtocol: { color: t.text.primary, fontSize: fonts.md, fontWeight: fonts.bold },
    riskBadge: { paddingHorizontal: 8, paddingVertical: 2, borderRadius: 6 },
    riskBadgeText: { fontSize: fonts.xs, fontWeight: fonts.bold },
    compareApy: { color: t.accent.green, fontSize: fonts.xxl, fontWeight: fonts.heavy, marginVertical: 4 },
    calcCard: { backgroundColor: t.bg.card, borderRadius: 16, padding: 20, marginHorizontal: 20, marginBottom: 16 },
    calcLabel: { color: t.text.secondary, fontSize: fonts.sm, fontWeight: fonts.semibold, marginBottom: 8, marginTop: 12 },
    calcInput: { backgroundColor: t.bg.primary, borderRadius: 12, padding: 14, color: t.text.primary, fontSize: fonts.xl, fontWeight: fonts.bold, textAlign: 'center' },
    ...
    resultLabel: { color: t.text.muted, fontSize: fonts.sm, textTransform: 'uppercase', letterSpacing: 1.5 },
    resultValue: { color: t.accent.green, fontSize: fonts.hero, fontWeight: fonts.heavy, marginTop: 4 },
    resultSub: { color: t.text.secondary, fontSize: fonts.md, marginTop: 8 },
    ...
    settingLabel: { color: t.text.primary, fontSize: fonts.md, fontWeight: fonts.semibold },
    settingDesc: { color: t.text.muted, fontSize: fonts.sm, marginTop: 2, maxWidth: '70%' },
    ...
    freqChipText: { color: t.text.secondary, fontSize: fonts.md, fontWeight: fonts.semibold },
    ...
    infoTitle: { color: t.text.primary, fontSize: fonts.lg, fontWeight: fonts.bold, marginBottom: 8 },
    infoText: { color: t.text.muted, fontSize: fonts.sm, lineHeight: 20 },
  }), [t]);
