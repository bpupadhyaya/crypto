...
export function CoWorkingScreen({ onClose }: Props) {
  ...
  const s = useMemo(() => StyleSheet.create({
    ...
    spaceType: { color: t.accent.blue, fontSize: 11, fontWeight: fonts.semibold },
    ...
    amenityText: { color: t.accent.green, fontSize: 10, fontWeight: fonts.semibold },
    spaceFooter: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', marginTop: 10 },
    spaceRate: { color: t.accent.green, fontSize: 13, fontWeight: fonts.bold },
    ...
    bookBtnText: { color: '#fff', fontSize: 13, fontWeight: fonts.bold },
    // Bookings tab
    ...
    memberXOTK: { color: t.accent.green, fontSize: 12, fontWeight: fonts.semibold },
    collabBadge: { paddingVertical: 4, paddingHorizontal: 10, borderRadius: 8 },
    collabText: { fontSize: 11, fontWeight: fonts.bold },
    ...
    collabBtnText: { color: '#fff', fontSize: 13, fontWeight: fonts.bold },
    // Events tab
    ...
    eventReward: { color: t.accent.green, fontSize: 13, fontWeight: fonts.bold },
