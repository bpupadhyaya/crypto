...
export function CoWorkingScreen({ onClose }: Props) {
  ...
  const s = useMemo(() => StyleSheet.create({
    ...
    spaceName: { color: t.text.primary, fontSize: 15, fontWeight: '700', flex: 1 },
    spaceType: { color: t.accent.blue, fontSize: 11, fontWeight: '600' },
    spaceLocation: { color: t.text.muted, fontSize: 12, marginTop: 4 },
    spaceDesc: { color: t.text.secondary, fontSize: 12, marginTop: 6, lineHeight: 18 },
    ...
    amenityText: { color: t.accent.green, fontSize: 10, fontWeight: '600' },
    spaceFooter: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', marginTop: 10 },
    spaceRate: { color: t.accent.green, fontSize: 13, fontWeight: '700' },
    spaceCapacity: { color: t.text.muted, fontSize: 12 },
    ...
    bookingName: { color: t.text.primary, fontSize: 15, fontWeight: '700' },
    bookingType: { color: t.text.secondary, fontSize: 12, marginTop: 2 },
    bookingDetails: { color: t.text.muted, fontSize: 12, marginTop: 6 },
    bookingStatus: { fontSize: 12, fontWeight: '700', marginTop: 6 },
    // Community tab
    memberCard: { backgroundColor: t.bg.card, borderRadius: 16, padding: 16, marginBottom: 12 },
    memberName: { color: t.text.primary, fontSize: 15, fontWeight: '700' },
    memberUid: { color: t.text.muted, fontSize: 11, marginTop: 2 },
    memberProject: { color: t.text.secondary, fontSize: 13, marginTop: 6 },
    ...
    collabBtnText: { color: '#fff', fontSize: 13, fontWeight: '700' },
    // Events tab
    ...
    eventHost: { color: t.text.secondary, fontSize: 13, marginTop: 2 },
    eventLocation: { color: t.text.muted, fontSize: 12, marginTop: 4 },
    eventDateTime: { color: t.text.muted, fontSize: 12, marginTop: 2 },
    eventDesc: { color: t.text.secondary, fontSize: 12, marginTop: 6, lineHeight: 18 },
    ...
    eventReward: { color: t.accent.green, fontSize: 13, fontWeight: '700' },
