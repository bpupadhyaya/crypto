...
export function AchievementGalleryScreen({ onClose }: Props) {
  ...
  const s = useMemo(() => StyleSheet.create({
    ...
    summaryValue: { color: t.text.primary, fontSize: 24, fontWeight: '800' },
    ...
    achIconText: { color: '#fff', fontSize: 20, fontWeight: '900' },
    achInfo: { flex: 1 },
    achTitle: { color: t.text.primary, fontSize: 15, fontWeight: '700' },
    ...
    rarityText: { fontSize: 10, fontWeight: '700', textTransform: 'uppercase' },
