...
export function AchievementGalleryScreen({ onClose }: Props) {
  ...
  const s = useMemo(() => StyleSheet.create({
    ...
    achIconText: { color: '#fff', fontSize: 20, fontWeight: fonts.heavy },
    achInfo: { flex: 1 },
    achTitle: { color: t.text.primary, fontSize: 15, fontWeight: fonts.bold },
    achDesc: { color: t.text.muted, fontSize: 12, marginTop: 2 },
    achMeta: { color: t.text.muted, fontSize: 11, marginTop: 4 },
    rarityBadge: { paddingHorizontal: 8, paddingVertical: 3, borderRadius: 8, alignSelf: 'flex-start' },
    rarityText: { fontSize: 10, fontWeight: fonts.bold, textTransform: 'uppercase' },
    lockedOverlay: { opacity: 0.5 },
    holdersText: { color: t.text.muted, fontSize: 11, marginTop: 2 },
