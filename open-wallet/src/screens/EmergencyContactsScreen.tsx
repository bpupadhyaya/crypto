...
export function EmergencyContactsScreen({ onClose }: Props) {
  ...
  const s = useMemo(() => StyleSheet.create({
    ...
    contactInfo: { flex: 1 },
    contactName: { color: t.text.primary, fontSize: 16, fontWeight: fonts.bold },
    ...
    priorityText: { color: '#fff', fontSize: 13, fontWeight: fonts.heavy },
    ...
    iceBadgeText: { color: t.accent.red, fontSize: 11, fontWeight: fonts.bold },
    ...
    medicalLabel: { color: t.text.secondary, fontSize: 13, fontWeight: fonts.semibold, textTransform: 'uppercase', letterSpacing: 0.5 },
    medicalValue: { color: t.text.primary, fontSize: 15, fontWeight: fonts.semibold, marginTop: 4 },
    ...
    tagText: { color: t.accent.red, fontSize: 12, fontWeight: fonts.semibold },
    conditionTag: { backgroundColor: t.accent.orange + '15', paddingHorizontal: 10, paddingVertical: 4, borderRadius: 8 },
    conditionTagText: { color: t.accent.orange, fontSize: 12, fontWeight: fonts.semibold },
    medTag: { backgroundColor: t.accent.blue + '15', paddingHorizontal: 10, paddingVertical: 4, borderRadius: 8 },
    medTagText: { color: t.accent.blue, fontSize: 12, fontWeight: fonts.semibold },
    ...
    donorBadgeText: { color: t.accent.green, fontSize: 13, fontWeight: fonts.bold },
    ...
    settingLabel: { color: t.text.primary, fontSize: 15, fontWeight: fonts.semibold, flex: 1 },
    ...
    shareTitle: { color: t.text.primary, fontSize: 18, fontWeight: fonts.heavy, marginBottom: 4 },
    ...
    lockScreenBtnText: { color: t.accent.blue, fontSize: 15, fontWeight: fonts.bold },
    ...
    notifyText: { color: t.accent.green, fontSize: 11, fontWeight: fonts.semibold },
    ...
    <>
      ...
      <View style={s.card}>
        <View style={{ alignItems: 'center', paddingVertical: 12, borderBottomWidth: StyleSheet.hairlineWidth, borderBottomColor: t.border }}>
          <Text style={{ color: t.accent.red, fontSize: 18, fontWeight: fonts.heavy, letterSpacing: 2 }}>{'\u{1F6A8}'} ICE CARD {'\u{1F6A8}'}</Text>
        </View>
