...
export function EmergencyContactsScreen({ onClose }: Props) {
  ...
  const s = useMemo(() => StyleSheet.create({
    ...
    tabLabel: { color: t.text.muted, fontSize: fonts.xs, fontWeight: fonts.semibold },
    ...
    contactInfo: { flex: 1 },
    contactName: { color: t.text.primary, fontSize: fonts.lg, fontWeight: fonts.bold },
    contactDetail: { color: t.text.muted, fontSize: fonts.sm, marginTop: 2 },
    contactPhone: { color: t.accent.blue, fontSize: fonts.sm, marginTop: 2 },
    ...
    priorityText: { color: '#fff', fontSize: fonts.sm, fontWeight: fonts.heavy },
    ...
    iceBadgeText: { color: t.accent.red, fontSize: fonts.xs, fontWeight: fonts.bold },
    actionRow: { flexDirection: 'row', gap: 8, marginTop: 10 },
    smallBtn: { paddingVertical: 6, paddingHorizontal: 12, borderRadius: 8, backgroundColor: t.bg.primary },
    smallBtnText: { color: t.accent.blue, fontSize: fonts.sm, fontWeight: fonts.semibold },
    dangerBtn: { paddingVertical: 6, paddingHorizontal: 12, borderRadius: 8, backgroundColor: t.accent.red + '15' },
    dangerBtnText: { color: t.accent.red, fontSize: fonts.sm, fontWeight: fonts.semibold },
    ...
    inputLabel: { color: t.text.secondary, fontSize: fonts.sm, fontWeight: fonts.semibold, marginBottom: 6, textTransform: 'uppercase', letterSpacing: 1 },
    ...
    medicalLabel: { color: t.text.secondary, fontSize: fonts.sm, fontWeight: fonts.semibold, textTransform: 'uppercase', letterSpacing: 0.5 },
    medicalValue: { color: t.text.primary, fontSize: fonts.md, fontWeight: fonts.semibold, marginTop: 4 },
    ...
    tagText: { color: t.accent.red, fontSize: fonts.sm, fontWeight: fonts.semibold },
    conditionTag: { backgroundColor: t.accent.orange + '15', paddingHorizontal: 10, paddingVertical: 4, borderRadius: 8 },
    conditionTagText: { color: t.accent.orange, fontSize: fonts.sm, fontWeight: fonts.semibold },
    medTag: { backgroundColor: t.accent.blue + '15', paddingHorizontal: 10, paddingVertical: 4, borderRadius: 8 },
    medTagText: { color: t.accent.blue, fontSize: fonts.sm, fontWeight: fonts.semibold },
    ...
    donorBadgeText: { color: t.accent.green, fontSize: fonts.sm, fontWeight: fonts.bold },
    ...
    settingDesc: { color: t.text.muted, fontSize: fonts.sm, marginTop: 2 },
    templateCard: { backgroundColor: t.bg.card, borderRadius: 16, padding: 16, marginHorizontal: 20, marginTop: 12 },
    templateInput: { backgroundColor: t.bg.primary, borderRadius: 12, padding: 14, color: t.text.primary, fontSize: fonts.md, minHeight: 100, textAlignVertical: 'top' },
    ...
    qrText: { color: t.text.muted, fontSize: fonts.md, textAlign: 'center' },
    shareTitle: { color: t.text.primary, fontSize: fonts.xl, fontWeight: fonts.heavy, marginBottom: 4 },
    shareSubtitle: { color: t.text.muted, fontSize: fonts.sm, textAlign: 'center', lineHeight: 20 },
    ...
    lockScreenBtnText: { color: t.accent.blue, fontSize: fonts.md, fontWeight: fonts.bold },
    ...
    emptyText: { color: t.text.muted, fontSize: fonts.md, textAlign: 'center' },
    ...
    notifyText: { color: t.accent.green, fontSize: fonts.xs, fontWeight: fonts.semibold },
    ...
    summaryNumber: { color: t.text.primary, fontSize: fonts.xxl, fontWeight: fonts.heavy },
          ...
          <View key={contact.id} style={s.card}>
            <View style={s.contactRow}>
              ...
              <View style={s.contactInfo}>
                ...
                <Text style={[s.contactDetail, { fontSize: fonts.xs }]}>UID: {contact.uid}</Text>
    ...
    <>
      ...
      <View style={s.card}>
        <View style={{ alignItems: 'center', paddingVertical: 12, borderBottomWidth: StyleSheet.hairlineWidth, borderBottomColor: t.border }}>
          <Text style={{ color: t.accent.red, fontSize: fonts.xl, fontWeight: fonts.heavy, letterSpacing: 2 }}>{'\u{1F6A8}'} ICE CARD {'\u{1F6A8}'}</Text>
        </View>
