...
export function BikeShareScreen({ onClose }: Props) {
  ...
  const s = useMemo(() => StyleSheet.create({
    ...
    vehIconText: { color: t.accent.green, fontSize: fonts.lg, fontWeight: fonts.heavy },
    vehInfo: { flex: 1 },
    vehName: { color: t.text.primary, fontSize: fonts.md, fontWeight: fonts.bold },
    vehMeta: { color: t.text.muted, fontSize: fonts.sm, marginTop: 2 },
    vehRight: { alignItems: 'flex-end' },
    vehRate: { color: t.accent.green, fontSize: fonts.md, fontWeight: fonts.bold },
    vehDist: { color: t.text.muted, fontSize: fonts.xs, marginTop: 2 },
    condBadge: { paddingHorizontal: 8, paddingVertical: 2, borderRadius: 8, alignSelf: 'flex-start', marginTop: 8 },
    condText: { color: '#fff', fontSize: fonts.xs, fontWeight: fonts.semibold },
    ...
    batteryText: { color: t.text.muted, fontSize: fonts.xs },
    ...
    activeText: { color: t.text.primary, fontSize: fonts.md, fontWeight: fonts.semibold, textAlign: 'center', lineHeight: 22 },
    returnBtn: { backgroundColor: '#FF3B30', paddingHorizontal: 20, paddingVertical: 10, borderRadius: 12, marginTop: 12 },
    returnText: { color: '#fff', fontSize: fonts.md, fontWeight: fonts.bold },
    ...
    histIconText: { color: t.accent.green, fontSize: fonts.sm, fontWeight: fonts.bold },
    histInfo: { flex: 1 },
    ...
    histCotk: { color: t.accent.green, fontSize: fonts.sm, fontWeight: fonts.bold },
    histCo2: { color: t.accent.blue, fontSize: fonts.xs, marginTop: 2 },
