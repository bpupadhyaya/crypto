...
export function BikeShareScreen({ onClose }: Props) {
  ...
  const s = useMemo(() => StyleSheet.create({
    ...
    vehIconText: { color: t.accent.green, fontSize: 16, fontWeight: fonts.heavy },
    vehInfo: { flex: 1 },
    vehName: { color: t.text.primary, fontSize: 15, fontWeight: fonts.bold },
    vehMeta: { color: t.text.muted, fontSize: 12, marginTop: 2 },
    vehRight: { alignItems: 'flex-end' },
    vehRate: { color: t.accent.green, fontSize: 14, fontWeight: fonts.bold },
    ...
    condText: { color: '#fff', fontSize: 11, fontWeight: fonts.semibold },
    ...
    activeText: { color: t.text.primary, fontSize: 15, fontWeight: fonts.semibold, textAlign: 'center', lineHeight: 22 },
    returnBtn: { backgroundColor: '#FF3B30', paddingHorizontal: 20, paddingVertical: 10, borderRadius: 12, marginTop: 12 },
    returnText: { color: '#fff', fontSize: 14, fontWeight: fonts.bold },
    ...
    histIconText: { color: t.accent.green, fontSize: 12, fontWeight: fonts.bold },
    histInfo: { flex: 1 },
    ...
    histCotk: { color: t.accent.green, fontSize: 13, fontWeight: fonts.bold },
