...
export function DevToolsScreen({ onClose }: Props) {
  ...
  const st = useMemo(() => StyleSheet.create({
    ...
    sectionTitle: { color: t.text.primary, fontSize: fonts.md, fontWeight: fonts.semibold },
    sectionArrow: { color: t.text.muted, fontSize: fonts.md },
    sectionContent: { backgroundColor: t.bg.card, borderRadius: 12, padding: 16, marginTop: 4 },
    codeBlock: { fontFamily: 'Courier', fontSize: fonts.xs, color: t.text.secondary, lineHeight: 16 },
    row: { flexDirection: 'row', justifyContent: 'space-between', paddingVertical: 6 },
    label: { color: t.text.muted, fontSize: fonts.sm },
    value: { color: t.text.primary, fontSize: fonts.sm, fontWeight: fonts.medium },
    actionBtn: {
      backgroundColor: t.bg.card, borderRadius: 12, padding: 14, marginTop: 8,
      flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center',
    },
    actionLabel: { color: t.text.primary, fontSize: fonts.md },
    actionIcon: { color: t.accent.blue, fontSize: fonts.md },
    ...
    badgeText: { color: t.accent.green, fontSize: fonts.xs, fontWeight: fonts.semibold },
    ...
    netUrl: { color: t.text.primary, fontSize: fonts.sm, fontWeight: fonts.medium },
    netMeta: { color: t.text.muted, fontSize: fonts.xs, marginTop: 2 },
    refreshBtn: { paddingHorizontal: 12, paddingVertical: 4, borderRadius: 8, backgroundColor: t.accent.blue + '20' },
    refreshText: { color: t.accent.blue, fontSize: fonts.sm, fontWeight: fonts.semibold },
  }), [t]);
