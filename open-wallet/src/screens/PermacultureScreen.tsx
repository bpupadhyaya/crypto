...
export function PermacultureScreen({ onClose }: Props) {
  ...
  const s = useMemo(() => StyleSheet.create({
    ...
    zoneBadgeText: { color: '#fff', fontSize: 16, fontWeight: '900' },
    zoneName: { color: t.text.primary, fontSize: 15, fontWeight: '700', flex: 1 },
    ...
    exampleTagText: { fontSize: 11, fontWeight: '600' },
    // Soil
    soilCard: { backgroundColor: t.bg.secondary, borderRadius: 16, padding: 20, marginHorizontal: 20, marginBottom: 16 },
    soilLocation: { color: t.text.primary, fontSize: 16, fontWeight: '700', marginBottom: 12 },
    ...
    soilLabel: { color: t.text.secondary, fontSize: 14, fontWeight: '600' },
    soilValue: { color: t.text.primary, fontSize: 14, fontWeight: '800' },
    ...
    companionIconText: { color: '#fff', fontSize: 11, fontWeight: '800' },
    companionPlus: { color: t.text.muted, fontSize: 18, fontWeight: '300', marginHorizontal: 4 },
    companionNames: { color: t.text.primary, fontSize: 14, fontWeight: '700', flex: 1, marginLeft: 8 },
    ...
    waterName: { color: t.text.primary, fontSize: 15, fontWeight: '700' },
    ...
    seedName: { color: t.text.primary, fontSize: 14, fontWeight: '700' },
    seedVariety: { color: t.accent.green, fontSize: 12, fontWeight: '600', marginTop: 2 },
    seedMeta: { color: t.text.muted, fontSize: 12, marginTop: 4 },
    seedAvailable: { color: t.text.primary, fontSize: 13, fontWeight: '700', marginTop: 4 },
    ...
    requestSeedText: { color: t.accent.green, fontSize: 12, fontWeight: '700' },
    // Projects
    ...
    projectName: { color: t.text.primary, fontSize: 15, fontWeight: '700', flex: 1 },
