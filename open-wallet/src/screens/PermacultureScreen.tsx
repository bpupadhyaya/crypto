...
export function PermacultureScreen({ onClose }: Props) {
  ...
  const s = useMemo(() => StyleSheet.create({
    ...
    zoneBadgeText: { color: '#fff', fontSize: fonts.lg, fontWeight: fonts.heavy },
    zoneName: { color: t.text.primary, fontSize: fonts.md, fontWeight: fonts.bold, flex: 1 },
    zoneDesc: { color: t.text.secondary, fontSize: fonts.sm, lineHeight: 18, marginBottom: 8 },
    exampleRow: { flexDirection: 'row', flexWrap: 'wrap', gap: 6 },
    exampleTag: { paddingHorizontal: 10, paddingVertical: 4, borderRadius: 10 },
    exampleTagText: { fontSize: fonts.xs, fontWeight: fonts.semibold },
    // Soil
    soilCard: { backgroundColor: t.bg.secondary, borderRadius: 16, padding: 20, marginHorizontal: 20, marginBottom: 16 },
    soilLocation: { color: t.text.primary, fontSize: fonts.lg, fontWeight: fonts.bold, marginBottom: 12 },
    ...
    soilLabel: { color: t.text.secondary, fontSize: fonts.md, fontWeight: fonts.semibold },
    soilValue: { color: t.text.primary, fontSize: fonts.md, fontWeight: fonts.heavy },
    ...
    soilMeta: { color: t.text.muted, fontSize: fonts.sm, marginTop: 12, textAlign: 'center' },
    // Companion planting
    ...
    companionIconText: { color: '#fff', fontSize: fonts.xs, fontWeight: fonts.heavy },
    companionPlus: { color: t.text.muted, fontSize: fonts.xl, fontWeight: '300', marginHorizontal: 4 },
    companionNames: { color: t.text.primary, fontSize: fonts.md, fontWeight: fonts.bold, flex: 1, marginLeft: 8 },
    companionBenefit: { color: t.text.secondary, fontSize: fonts.sm, lineHeight: 18 },
    // Water
    waterCard: { backgroundColor: t.bg.secondary, borderRadius: 16, padding: 16, marginHorizontal: 20, marginBottom: 12 },
    waterName: { color: t.text.primary, fontSize: fonts.md, fontWeight: fonts.bold },
    waterDesc: { color: t.text.secondary, fontSize: fonts.sm, lineHeight: 18, marginTop: 4 },
    ...
    difficultyText: { color: '#fff', fontSize: fonts.xs, fontWeight: fonts.bold },
    waterSaved: { color: t.text.muted, fontSize: fonts.sm, flex: 1, marginLeft: 10 },
    // Seeds
    seedCard: { backgroundColor: t.bg.secondary, borderRadius: 14, padding: 14, marginHorizontal: 20, marginBottom: 10 },
    seedName: { color: t.text.primary, fontSize: fonts.md, fontWeight: fonts.bold },
    seedVariety: { color: t.accent.green, fontSize: fonts.sm, fontWeight: fonts.semibold, marginTop: 2 },
    seedMeta: { color: t.text.muted, fontSize: fonts.sm, marginTop: 4 },
    seedAvailable: { color: t.text.primary, fontSize: fonts.sm, fontWeight: fonts.bold, marginTop: 4 },
    ...
    requestSeedText: { color: t.accent.green, fontSize: fonts.sm, fontWeight: fonts.bold },
    // Projects
    ...
    projectName: { color: t.text.primary, fontSize: fonts.md, fontWeight: fonts.bold, flex: 1 },
    ...
    projectMeta: { color: t.text.muted, fontSize: fonts.sm, marginTop: 4 },
    projectDesc: { color: t.text.secondary, fontSize: fonts.sm, lineHeight: 18, marginTop: 6 },
