...
export function CommunityAwardsScreen({ onClose }: Props) {
  ...
  const st = useMemo(() => StyleSheet.create({
    ...
    voteCount: { color: t.accent.blue, fontSize: fonts.md, fontWeight: fonts.bold },
    voteBtn: { backgroundColor: t.accent.blue, borderRadius: 10, paddingVertical: 6, paddingHorizontal: 16 },
    voteBtnText: { color: '#fff', fontSize: fonts.sm, fontWeight: fonts.semibold },
    ...
    badgeText: { color: t.text.secondary, fontSize: fonts.xs, fontWeight: fonts.semibold },
    ...
    catBtnText: { color: t.text.secondary, fontSize: fonts.sm, fontWeight: fonts.semibold },
    ...
    winnerReward: { color: '#f5a623', fontSize: fonts.sm, fontWeight: fonts.bold, marginTop: 6 },
    catIcon: { fontSize: fonts.xxxl, textAlign: 'center', marginBottom: 8 },
