...
export function CommunityAwardsScreen({ onClose }: Props) {
  ...
  const st = useMemo(() => StyleSheet.create({
    ...
    voteCount: { color: t.accent.blue, fontSize: 15, fontWeight: fonts.bold },
    voteBtn: { backgroundColor: t.accent.blue, borderRadius: 10, paddingVertical: 6, paddingHorizontal: 16 },
    voteBtnText: { color: '#fff', fontSize: 13, fontWeight: fonts.semibold },
    ...
    badgeText: { color: t.text.secondary, fontSize: 11, fontWeight: fonts.semibold },
    ...
    catBtnText: { color: t.text.secondary, fontSize: 12, fontWeight: fonts.semibold },
    ...
    winnerReward: { color: '#f5a623', fontSize: 13, fontWeight: fonts.bold, marginTop: 6 },
