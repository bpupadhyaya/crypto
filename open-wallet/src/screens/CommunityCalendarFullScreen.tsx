  ...
  const styles = useMemo(
    () =>
      StyleSheet.create({
        ...
        monthLabel: { fontSize: 14, fontWeight: fonts.semibold, color: t.text.primary, marginBottom: 4 },
        monthCount: { fontSize: 11, color: t.text.secondary },
        ...
        eventTitle: { fontSize: 15, fontWeight: fonts.bold, color: t.text.primary, flex: 1 },
        eventDate: { fontSize: 12, color: t.text.secondary },
        eventDescription: { fontSize: 13, color: t.text.secondary, lineHeight: 18, marginBottom: 8 },
        eventFooter: { flexDirection: 'row', justifyContent: 'space-between' },
        eventCategory: { fontSize: 11, fontWeight: fonts.semibold, textTransform: 'uppercase' },
        eventStats: { fontSize: 12, color: t.text.secondary },
        otkReward: { fontSize: 12, fontWeight: fonts.semibold, color: t.accent.green },
        ...
        categoryChipText: { fontSize: 13, fontWeight: fonts.semibold },
