  ...
  const styles = useMemo(
    () =>
      StyleSheet.create({
        ...
        monthLabel: { fontSize: 14, fontWeight: '600', color: t.text.primary, marginBottom: 4 },
        ...
        eventTitle: { fontSize: 15, fontWeight: '700', color: t.text.primary, flex: 1 },
        ...
        eventCategory: { fontSize: 11, fontWeight: '600', textTransform: 'uppercase' },
        eventStats: { fontSize: 12, color: t.text.secondary },
        otkReward: { fontSize: 12, fontWeight: '600', color: t.accent.green },
