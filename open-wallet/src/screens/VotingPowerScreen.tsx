...
export function VotingPowerScreen({ onClose }: Props) {
  ...
  const s = useMemo(() => StyleSheet.create({
    ...
    heroLabel: { color: t.text.muted, fontSize: 12, textTransform: 'uppercase', letterSpacing: 1.5 },
    heroValue: { color: t.accent.blue, fontSize: 56, fontWeight: fonts.heavy, marginTop: 4 },
    heroUnit: { color: t.text.primary, fontSize: 18, fontWeight: fonts.bold, marginTop: 4 },
    heroSubtext: { color: t.text.muted, fontSize: 13, textAlign: 'center', marginTop: 8, lineHeight: 20 },
    uidBadge: { backgroundColor: t.accent.green + '20', paddingHorizontal: 16, paddingVertical: 8, borderRadius: 20, marginTop: 12 },
    uidBadgeText: { color: t.accent.green, fontSize: 14, fontWeight: fonts.bold },
    ...
    participationLabel: { color: t.text.secondary, fontSize: 13, fontWeight: fonts.semibold },
    participationBar: { height: 12, backgroundColor: t.border, borderRadius: 6, marginTop: 8 },
    participationFill: { height: 12, borderRadius: 6 },
    participationText: { color: t.text.muted, fontSize: 12, marginTop: 6 },
    explainerCard: { backgroundColor: t.bg.card, borderRadius: 16, padding: 20, marginHorizontal: 20, marginTop: 16 },
    explainerTitle: { color: t.text.primary, fontSize: 16, fontWeight: fonts.bold, marginBottom: 12 },
    explainerRow: { marginBottom: 16 },
    explainerSubtitle: { color: t.accent.blue, fontSize: 14, fontWeight: fonts.bold },
    explainerText: { color: t.text.muted, fontSize: 13, lineHeight: 20, marginTop: 4 },
    ...
    historyVote: { fontSize: 13, fontWeight: fonts.bold },
    historyDate: { color: t.text.muted, fontSize: 12 },
    historyOutcome: { fontSize: 11, fontWeight: fonts.bold },
    activeCard: { backgroundColor: t.bg.card, borderRadius: 16, padding: 16, marginHorizontal: 20, marginBottom: 12 },
    activeTitle: { color: t.text.primary, fontSize: 15, fontWeight: fonts.bold },
    activeVotes: { flexDirection: 'row', gap: 12, marginTop: 8 },
    activeVoteCount: { fontSize: 12, fontWeight: fonts.semibold },
    ...
    nudgeText: { color: t.accent.orange, fontSize: 12, fontWeight: fonts.bold },
    ...
    votedText: { color: t.accent.green, fontSize: 12, fontWeight: fonts.bold },
