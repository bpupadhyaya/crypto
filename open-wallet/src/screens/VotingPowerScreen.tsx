...
export function VotingPowerScreen({ onClose }: Props) {
  ...
  const s = useMemo(() => StyleSheet.create({
    ...
    heroValue: { color: t.accent.blue, fontSize: 56, fontWeight: '800', marginTop: 4 },
    heroUnit: { color: t.text.primary, fontSize: 18, fontWeight: '700', marginTop: 4 },
    ...
    uidBadgeText: { color: t.accent.green, fontSize: 14, fontWeight: '700' },
    ...
    participationLabel: { color: t.text.secondary, fontSize: 13, fontWeight: '600' },
    ...
    explainerTitle: { color: t.text.primary, fontSize: 16, fontWeight: '700', marginBottom: 12 },
    explainerRow: { marginBottom: 16 },
    explainerSubtitle: { color: t.accent.blue, fontSize: 14, fontWeight: '700' },
    ...
    historyVote: { fontSize: 13, fontWeight: '700' },
    ...
    activeTitle: { color: t.text.primary, fontSize: 15, fontWeight: '700' },
    activeVotes: { flexDirection: 'row', gap: 12, marginTop: 8 },
    activeVoteCount: { fontSize: 12, fontWeight: '600' },
    ...
    nudgeText: { color: t.accent.orange, fontSize: 12, fontWeight: '700' },
    ...
    votedText: { color: t.accent.green, fontSize: 12, fontWeight: '700' },
