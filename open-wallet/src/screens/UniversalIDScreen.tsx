...
export function UniversalIDScreen({ onClose }: Props) {
  ...
  const s = useMemo(() => StyleSheet.create({
    ...
    heroTitle: { color: t.text.primary, fontSize: 22, fontWeight: fonts.heavy, textAlign: 'center', marginBottom: 8 },
    ...
    infoContent: { flex: 1 },
    infoTitle: { color: t.text.primary, fontSize: 15, fontWeight: fonts.bold, marginBottom: 4 },
    ...
    registerBtnText: { color: '#fff', fontSize: 17, fontWeight: fonts.bold },
    ...
    uidValue: { color: t.accent.green, fontSize: 16, fontWeight: fonts.bold, fontFamily: 'monospace', marginTop: 4 },
    ...
    statusText: { color: '#fff', fontSize: 12, fontWeight: fonts.bold },
