...
export function UniversalIDScreen({ onClose }: Props) {
  ...
  const s = useMemo(() => StyleSheet.create({
    ...
    heroTitle: { color: t.text.primary, fontSize: fonts.xxl, fontWeight: fonts.heavy, textAlign: 'center', marginBottom: 8 },
    heroSubtitle: { color: t.text.secondary, fontSize: fonts.md, textAlign: 'center', lineHeight: 22 },
    section: { color: t.text.secondary, fontSize: fonts.sm, fontWeight: fonts.bold, textTransform: 'uppercase', letterSpacing: 1.5, marginLeft: 24, marginBottom: 12, marginTop: 28 },
    ...
    infoIcon: { fontSize: fonts.xxl, marginRight: 14, marginTop: 2 },
    infoContent: { flex: 1 },
    infoTitle: { color: t.text.primary, fontSize: fonts.md, fontWeight: fonts.bold, marginBottom: 4 },
    ...
    uidLabel: { color: t.text.muted, fontSize: fonts.sm, textTransform: 'uppercase', letterSpacing: 1.5, marginTop: 16 },
    uidValue: { color: t.accent.green, fontSize: fonts.lg, fontWeight: fonts.bold, fontFamily: 'monospace', marginTop: 4 },
    addressLabel: { color: t.text.muted, fontSize: fonts.sm, marginTop: 16 },
    addressValue: { color: t.text.secondary, fontSize: fonts.sm, fontFamily: 'monospace', marginTop: 2 },
    statusBadge: { backgroundColor: t.accent.green, paddingHorizontal: 12, paddingVertical: 4, borderRadius: 8, marginTop: 16 },
    statusText: { color: '#fff', fontSize: fonts.sm, fontWeight: fonts.bold },
    ...
    privacyNote: { color: t.text.muted, fontSize: fonts.sm, textAlign: 'center', marginHorizontal: 24, marginTop: 16, lineHeight: 18 },
    proofCard: { backgroundColor: t.bg.card, borderRadius: 16, padding: 20, marginHorizontal: 20, marginTop: 12 },
    proofLabel: { color: t.text.muted, fontSize: fonts.sm, textTransform: 'uppercase', letterSpacing: 1 },
    proofValue: { color: t.text.secondary, fontSize: fonts.sm, fontFamily: 'monospace', marginTop: 4 },
  }), [t]);
