...
export function CommunityConstitutionScreen({ onClose }: Props) {
  ...
  const st = useMemo(() => StyleSheet.create({
    ...
    articleNumber: { color: t.accent.blue, fontSize: 13, fontWeight: '700', marginBottom: 4 },
    cardTitle: { color: t.text.primary, fontSize: 16, fontWeight: '700', marginBottom: 6 },
    ...
    voteFor: { color: '#34c759', fontSize: 13, fontWeight: '700' },
    voteAgainst: { color: '#ff3b30', fontSize: 13, fontWeight: '700' },
