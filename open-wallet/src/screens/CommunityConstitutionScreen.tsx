...
export function CommunityConstitutionScreen({ onClose }: Props) {
  ...
  const st = useMemo(() => StyleSheet.create({
    ...
    articleNumber: { color: t.accent.blue, fontSize: 13, fontWeight: fonts.bold, marginBottom: 4 },
    cardTitle: { color: t.text.primary, fontSize: 16, fontWeight: fonts.bold, marginBottom: 6 },
    cardText: { color: t.text.secondary, fontSize: 14, lineHeight: 21 },
    cardMeta: { color: t.text.muted, fontSize: 11, marginTop: 10 },
    ...
    voteFor: { color: '#34c759', fontSize: 13, fontWeight: fonts.bold },
    voteAgainst: { color: '#ff3b30', fontSize: 13, fontWeight: fonts.bold },
    voteRemaining: { color: t.text.muted, fontSize: 12 },
    ...
    changeText: { color: t.text.primary, fontSize: 13, lineHeight: 20, fontStyle: 'italic', backgroundColor: t.bg.primary, borderRadius: 8, padding: 12, marginTop: 8 },
    rationaleText: { color: t.text.secondary, fontSize: 13, lineHeight: 19, marginTop: 8 },
    ...
    historyDesc: { color: t.text.primary, fontSize: 14, lineHeight: 20 },
    historyVotes: { color: t.text.secondary, fontSize: 12, marginTop: 4 },
    historyDate: { color: t.text.muted, fontSize: 11, marginTop: 2 },
