...
export function SafetyNetScreen({ onClose }: Props) {
  ...
  const st = useMemo(() => StyleSheet.create({
    ...
    scoreLabel: { color: t.text.muted, fontSize: fonts.xs, fontWeight: fonts.semibold },
    ...
    scorePillNum: { fontSize: fonts.xl, fontWeight: fonts.heavy, marginBottom: 2 },
    scorePillLabel: { color: t.text.muted, fontSize: fonts.xxs, fontWeight: fonts.semibold, textAlign: 'center' },
    ...
    alertTitle: { color: t.text.primary, fontSize: fonts.md, fontWeight: fonts.bold, marginBottom: 2 },
    ...
    alertBadgeText: { color: '#fff', fontSize: fonts.xs, fontWeight: fonts.bold },
    ...
    resolvedText: { color: '#22c55e', fontSize: fonts.xs, fontWeight: fonts.semibold },
    // Watch
    watcherCard: { backgroundColor: t.bg.card, borderRadius: 14, padding: 14, marginBottom: 10 },
    watcherName: { color: t.text.primary, fontSize: fonts.md, fontWeight: fonts.bold },
    watcherZone: { color: t.accent.blue, fontSize: fonts.sm, fontWeight: fonts.semibold },
    watcherSchedule: { color: t.text.muted, fontSize: fonts.xs, marginTop: 2 },
    ...
    checkinName: { color: t.text.primary, fontSize: fonts.md, fontWeight: fonts.semibold },
    checkinStatus: { paddingHorizontal: 8, paddingVertical: 2, borderRadius: 6 },
    checkinStatusText: { color: '#fff', fontSize: fonts.xs, fontWeight: fonts.bold },
    // Mutual Aid
    aidCard: { backgroundColor: t.bg.card, borderRadius: 14, padding: 14, marginBottom: 10, borderLeftWidth: 4 },
    aidTitle: { color: t.text.primary, fontSize: fonts.md, fontWeight: fonts.bold, marginBottom: 2 },
    aidMeta: { color: t.text.muted, fontSize: fonts.xs },
    aidStatusBadge: { paddingHorizontal: 8, paddingVertical: 3, borderRadius: 6, alignSelf: 'flex-start' },
    aidStatusText: { color: '#fff', fontSize: fonts.xs, fontWeight: fonts.bold },
    ...
    resourceContact: { color: t.accent.blue, fontSize: fonts.sm, fontWeight: fonts.bold },
    resourceMeta: { color: t.text.muted, fontSize: fonts.xs },
    // Incident list
    incidentRow: { flexDirection: 'row', gap: 10, paddingVertical: 8, borderBottomWidth: 1, borderBottomColor: t.border },
    incidentType: { color: t.text.secondary, fontSize: fonts.sm, fontWeight: fonts.bold, width: 70 },
    incidentDesc: { color: t.text.primary, fontSize: fonts.sm, flex: 1 },
    incidentLoc: { color: t.text.muted, fontSize: fonts.xs },
    // Summary cards
