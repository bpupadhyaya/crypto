...
export function SafetyNetScreen({ onClose }: Props) {
  ...
  const st = useMemo(() => StyleSheet.create({
    ...
    scoreLabel: { color: t.text.muted, fontSize: 11, fontWeight: '600' },
    ...
    scorePillNum: { fontSize: 18, fontWeight: '800', marginBottom: 2 },
    scorePillLabel: { color: t.text.muted, fontSize: 9, fontWeight: '600', textAlign: 'center' },
    ...
    alertTitle: { color: t.text.primary, fontSize: 14, fontWeight: '700', marginBottom: 2 },
    ...
    resolvedText: { color: '#22c55e', fontSize: 10, fontWeight: '600' },
    // Watch
    watcherCard: { backgroundColor: t.bg.card, borderRadius: 14, padding: 14, marginBottom: 10 },
    watcherName: { color: t.text.primary, fontSize: 15, fontWeight: '700' },
    watcherZone: { color: t.accent.blue, fontSize: 12, fontWeight: '600' },
    ...
    checkinName: { color: t.text.primary, fontSize: 14, fontWeight: '600' },
    checkinStatus: { paddingHorizontal: 8, paddingVertical: 2, borderRadius: 6 },
    checkinStatusText: { color: '#fff', fontSize: 10, fontWeight: '700' },
    // Mutual Aid
    aidCard: { backgroundColor: t.bg.card, borderRadius: 14, padding: 14, marginBottom: 10, borderLeftWidth: 4 },
    aidTitle: { color: t.text.primary, fontSize: 14, fontWeight: '700', marginBottom: 2 },
    ...
    aidStatusText: { color: '#fff', fontSize: 10, fontWeight: '700' },
    ...
    incidentType: { color: t.text.secondary, fontSize: 12, fontWeight: '700', width: 70 },
