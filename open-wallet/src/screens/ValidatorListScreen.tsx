...
export function ValidatorListScreen({ onClose }: Props) {
  ...
  const s = useMemo(() => StyleSheet.create({
    ...
    valInfo: { flex: 1 },
    valName: { color: t.text.primary, fontSize: fonts.md, fontWeight: fonts.bold },
    valMeta: { color: t.text.muted, fontSize: fonts.sm, marginTop: 2 },
    valRight: { alignItems: 'flex-end' },
    valStake: { color: t.accent.green, fontSize: fonts.md, fontWeight: fonts.heavy },
    valUptime: { color: t.text.muted, fontSize: fonts.sm, marginTop: 2 },
    ...
    compareName: { color: t.accent.blue, fontSize: fonts.sm, fontWeight: fonts.bold },
    compareMetricRow: { flexDirection: 'row', paddingVertical: 8, borderBottomColor: t.bg.primary, borderBottomWidth: 1 },
    compareLabel: { width: 80, color: t.text.muted, fontSize: fonts.sm },
    compareValue: { flex: 1, textAlign: 'center', color: t.text.primary, fontSize: fonts.sm, fontWeight: fonts.semibold },
    ...
    selectText: { color: t.text.muted, fontSize: fonts.sm, fontWeight: fonts.semibold },
