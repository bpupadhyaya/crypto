...
export function ValidatorListScreen({ onClose }: Props) {
  ...
  const s = useMemo(() => StyleSheet.create({
    ...
    valInfo: { flex: 1 },
    valName: { color: t.text.primary, fontSize: 14, fontWeight: fonts.bold },
    valMeta: { color: t.text.muted, fontSize: 12, marginTop: 2 },
    valRight: { alignItems: 'flex-end' },
    valStake: { color: t.accent.green, fontSize: 14, fontWeight: fonts.heavy },
    ...
    compareName: { color: t.accent.blue, fontSize: 13, fontWeight: fonts.bold },
    ...
    compareValue: { flex: 1, textAlign: 'center', color: t.text.primary, fontSize: 13, fontWeight: fonts.semibold },
    ...
    selectText: { color: t.text.muted, fontSize: 12, fontWeight: fonts.semibold },
