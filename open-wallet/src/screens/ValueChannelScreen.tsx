...
export function ValueChannelScreen({ onClose, onNavigate }: Props) {
  ...
  const s = useMemo(() => StyleSheet.create({
    ...
    totalLabel: { color: t.text.muted, fontSize: fonts.sm, textTransform: 'uppercase', letterSpacing: 1 },
    totalValue: { color: t.text.primary, fontSize: 48, fontWeight: fonts.heavy, marginTop: 4 },
    totalOtkLabel: { color: t.accent.green, fontSize: fonts.md, fontWeight: fonts.bold, marginTop: 4 },
    compositeRow: { flexDirection: 'row', justifyContent: 'space-around', marginTop: 16, width: '100%' },
    compositeItem: { alignItems: 'center' },
    compositeValue: { color: t.text.primary, fontSize: fonts.xl, fontWeight: fonts.heavy },
    compositeLabel: { color: t.text.muted, fontSize: fonts.xs, marginTop: 2 },
    // Channel weight bar
    ...
    weightLabelText: { color: t.text.muted, fontSize: fonts.xs },
    // Channel grid
    ...
    channelIconText: { color: '#fff', fontSize: fonts.xl, fontWeight: fonts.heavy },
    channelSymbol: { fontSize: fonts.sm, fontWeight: fonts.bold, marginBottom: 2 },
    channelName: { color: t.text.muted, fontSize: fonts.xs, marginBottom: 8 },
    channelBalance: { color: t.text.primary, fontSize: fonts.xl, fontWeight: fonts.heavy },
    channelLevel: { fontSize: fonts.xs, fontWeight: fonts.bold, marginTop: 4 },
    channelActivity: { color: t.text.muted, fontSize: fonts.xs, marginTop: 6, lineHeight: 15 },
    channelDate: { color: t.text.muted, fontSize: fonts.xs, marginTop: 2 },
    channelTapHint: { color: t.accent.blue, fontSize: fonts.xs, fontWeight: fonts.semibold, marginTop: 8 },
    // Philosophy card
    ...
    philosophyText: { color: t.text.primary, fontSize: fonts.md, fontWeight: fonts.semibold, textAlign: 'center', lineHeight: 22 },
