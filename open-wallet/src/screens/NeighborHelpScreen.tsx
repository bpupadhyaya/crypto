...
export function NeighborHelpScreen({ onClose }: Props) {
  ...
  const s = useMemo(() => StyleSheet.create({
    ...
    requestTitle: { color: t.text.primary, fontSize: 16, fontWeight: fonts.bold, flex: 1 },
    requesterName: { color: t.text.muted, fontSize: 13, marginTop: 2 },
    ...
    urgencyText: { color: '#fff', fontSize: 11, fontWeight: fonts.bold, textTransform: 'uppercase' },
    ...
    helpBtnText: { color: '#fff', fontSize: 14, fontWeight: fonts.bold },
    ...
    skillPillText: { color: t.text.muted, fontSize: 13, fontWeight: fonts.semibold },
    ...
    historyTitle: { color: t.text.primary, fontSize: 14, fontWeight: fonts.semibold, flex: 1 },
    historyMeta: { color: t.text.muted, fontSize: 11, marginTop: 2 },
    historyCOTK: { color: t.accent.green, fontSize: 13, fontWeight: fonts.bold },
    payForwardBadge: { backgroundColor: t.accent.purple + '20', paddingHorizontal: 8, paddingVertical: 2, borderRadius: 6, marginLeft: 6 },
    payForwardText: { color: t.accent.purple, fontSize: 10, fontWeight: fonts.bold },
    // Neighbors
    neighborCard: { backgroundColor: t.bg.secondary, borderRadius: 16, padding: 16, marginHorizontal: 20, marginBottom: 12 },
    neighborName: { color: t.text.primary, fontSize: 16, fontWeight: fonts.bold },
    ratingRow: { flexDirection: 'row', marginTop: 8, justifyContent: 'space-between' },
    ratingItem: { alignItems: 'center', flex: 1 },
    ratingValue: { color: t.text.primary, fontSize: 16, fontWeight: fonts.heavy },
    ratingLabel: { color: t.text.muted, fontSize: 10, marginTop: 2 },
    ...
    chainText: { color: t.accent.purple, fontSize: 11, fontWeight: fonts.semibold },
    neighborStats: { flexDirection: 'row', justifyContent: 'space-between', marginTop: 8 },
    neighborStatText: { color: t.text.muted, fontSize: 12 },
    ...
    iconText: { color: t.accent.green, fontSize: 16, fontWeight: fonts.heavy },
    ...
    categoryText: { color: t.accent.blue, fontSize: 11, fontWeight: fonts.semibold },
    ...
    payForwardBtnText: { color: t.accent.purple, fontSize: 15, fontWeight: fonts.bold },
    distanceText: { color: t.text.muted, fontSize: 12 },
    timeText: { color: t.text.muted, fontSize: 11 },
  }), [t]);
              ...
              {history.map((h, i) => (
                <View key={h.id} style={[s.historyItem, i === history.length - 1 && { borderBottomWidth: 0 }]}>
                  <View style={[s.historyIcon, {
                    ...
                    <Text style={{ color: h.type === 'given' ? t.accent.green : t.accent.blue, fontWeight: fonts.heavy, fontSize: 14 }}>
                      {h.type === 'given' ? '>' : '<'}
                    </Text>
                  </View>
                  <View style={{ flex: 1 }}>
