...
export function NeighborHelpScreen({ onClose }: Props) {
  ...
  const s = useMemo(() => StyleSheet.create({
    ...
    requestTitle: { color: t.text.primary, fontSize: 16, fontWeight: '700', flex: 1 },
    ...
    urgencyText: { color: '#fff', fontSize: 11, fontWeight: '700', textTransform: 'uppercase' },
    ...
    skillPillText: { color: t.text.muted, fontSize: 13, fontWeight: '600' },
    ...
    chainText: { color: t.accent.purple, fontSize: 11, fontWeight: '600' },
    ...
    iconText: { color: t.accent.green, fontSize: 16, fontWeight: '800' },
    ...
    categoryText: { color: t.accent.blue, fontSize: 11, fontWeight: '600' },
    ...
    payForwardBtnText: { color: t.accent.purple, fontSize: 15, fontWeight: '700' },
              ...
              {history.map((h, i) => (
                <View key={h.id} style={[s.historyItem, i === history.length - 1 && { borderBottomWidth: 0 }]}>
                  <View style={[s.historyIcon, {
                    ...
                    <Text style={{ color: h.type === 'given' ? t.accent.green : t.accent.blue, fontWeight: '800', fontSize: 14 }}>
                      {h.type === 'given' ? '>' : '<'}
                    </Text>
                  </View>
                  <View style={{ flex: 1 }}>
