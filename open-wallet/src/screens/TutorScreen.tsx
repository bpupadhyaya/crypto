...
export function TutorScreen({ onClose }: Props) {
  ...
  const s = useMemo(() => StyleSheet.create({
    ...
    subjectTagText: { color: t.accent.blue, fontSize: 11, fontWeight: fonts.semibold },
    tutorStats: { flexDirection: 'row', justifyContent: 'space-between', marginTop: 10 },
    tutorStat: { color: t.text.secondary, fontSize: 12 },
    rateTag: { color: t.accent.green, fontSize: 13, fontWeight: fonts.bold, marginTop: 6 },
    ...
    sessionSubject: { color: t.text.primary, fontSize: 15, fontWeight: fonts.bold },
    sessionTutor: { color: t.text.secondary, fontSize: 13, marginTop: 2 },
    sessionDetails: { color: t.text.muted, fontSize: 12, marginTop: 6 },
    sessionStatus: { fontSize: 12, fontWeight: fonts.bold, marginTop: 6 },
    sessionRating: { color: t.accent.orange, fontSize: 13, fontWeight: fonts.bold, marginTop: 4 },
    ...
    roomName: { color: t.text.primary, fontSize: 15, fontWeight: fonts.bold },
    roomHost: { color: t.text.secondary, fontSize: 13, marginTop: 2 },
    roomSubject: { color: t.accent.blue, fontSize: 12, fontWeight: fonts.semibold, marginTop: 4 },
    roomParticipants: { color: t.text.muted, fontSize: 12, marginTop: 6 },
    roomStatus: { fontSize: 12, fontWeight: fonts.bold, marginTop: 4 },
