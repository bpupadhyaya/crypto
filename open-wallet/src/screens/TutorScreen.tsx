...
export function TutorScreen({ onClose }: Props) {
  ...
  const s = useMemo(() => StyleSheet.create({
    ...
    tutorBio: { color: t.text.secondary, fontSize: fonts.sm, marginTop: 6, lineHeight: 18 },
    ...
    subjectTagText: { color: t.accent.blue, fontSize: fonts.xs, fontWeight: fonts.semibold },
    tutorStats: { flexDirection: 'row', justifyContent: 'space-between', marginTop: 10 },
    tutorStat: { color: t.text.secondary, fontSize: fonts.sm },
    rateTag: { color: t.accent.green, fontSize: fonts.sm, fontWeight: fonts.bold, marginTop: 6 },
    ...
    sessionSubject: { color: t.text.primary, fontSize: fonts.md, fontWeight: fonts.bold },
    sessionTutor: { color: t.text.secondary, fontSize: fonts.sm, marginTop: 2 },
    sessionDetails: { color: t.text.muted, fontSize: fonts.sm, marginTop: 6 },
    sessionStatus: { fontSize: fonts.sm, fontWeight: fonts.bold, marginTop: 6 },
    sessionRating: { color: t.accent.orange, fontSize: fonts.sm, fontWeight: fonts.bold, marginTop: 4 },
    sessionNotes: { color: t.text.muted, fontSize: fonts.sm, fontStyle: 'italic', marginTop: 4, lineHeight: 18 },
    // Teach tab
    ...
    regChipText: { color: t.text.secondary, fontSize: fonts.sm },
    regChipTextActive: { color: t.accent.blue, fontWeight: fonts.semibold },
    input: { backgroundColor: t.bg.card, borderRadius: 12, padding: 14, color: t.text.primary, fontSize: fonts.md, borderWidth: 1, borderColor: t.border },
    ...
    roomName: { color: t.text.primary, fontSize: fonts.md, fontWeight: fonts.bold },
    roomHost: { color: t.text.secondary, fontSize: fonts.sm, marginTop: 2 },
    roomSubject: { color: t.accent.blue, fontSize: fonts.sm, fontWeight: fonts.semibold, marginTop: 4 },
    roomParticipants: { color: t.text.muted, fontSize: fonts.sm, marginTop: 6 },
    roomStatus: { fontSize: fonts.sm, fontWeight: fonts.bold, marginTop: 4 },
