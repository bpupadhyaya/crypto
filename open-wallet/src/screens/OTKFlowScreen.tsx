...
export function OTKFlowScreen({ onClose }: Props) {
  ...
  const s = useMemo(() => StyleSheet.create({
    ...
    summaryNum: { fontSize: fonts.xxl, fontWeight: fonts.heavy, marginBottom: 2 },
    ...
    flowIcon: { fontSize: fonts.xxl },
    flowInfo: { flex: 1 },
    flowLabel: { color: t.text.primary, fontSize: fonts.md, fontWeight: fonts.semibold },
    flowMeta: { color: t.text.muted, fontSize: fonts.sm, marginTop: 2 },
    flowAmount: { fontSize: fonts.lg, fontWeight: fonts.heavy },
    channelBreakdown: { backgroundColor: t.bg.card, borderRadius: 14, padding: 16, marginBottom: 20 },
    breakdownTitle: { color: t.text.primary, fontSize: fonts.md, fontWeight: fonts.bold, marginBottom: 12 },
    breakdownRow: { flexDirection: 'row', alignItems: 'center', marginBottom: 10 },
    breakdownLabel: { flex: 1, color: t.text.primary, fontSize: fonts.sm, fontWeight: fonts.semibold },
    breakdownVal: { fontSize: fonts.md, fontWeight: fonts.heavy, marginRight: 8 },
    ...
    netPeriod: { flex: 1, color: t.text.primary, fontSize: fonts.md, fontWeight: fonts.semibold },
    netIn: { color: t.accent.green, fontSize: fonts.sm, fontWeight: fonts.bold, width: 60, textAlign: 'right' },
    netOut: { color: '#ef4444', fontSize: fonts.sm, fontWeight: fonts.bold, width: 60, textAlign: 'right' },
    netVal: { fontSize: fonts.md, fontWeight: fonts.heavy, width: 70, textAlign: 'right' },
    netHeader: { flexDirection: 'row', backgroundColor: t.bg.card, borderRadius: 10, padding: 12, marginBottom: 8 },
    netHeaderLabel: { color: t.text.muted, fontSize: fonts.xs, fontWeight: fonts.bold, textTransform: 'uppercase' },
    ...
    balanceNum: { fontSize: fonts.hero, fontWeight: fonts.heavy },
    balanceLabel: { color: t.text.secondary, fontSize: fonts.sm, fontWeight: fonts.semibold, marginTop: 4 },
  }), [t]);
