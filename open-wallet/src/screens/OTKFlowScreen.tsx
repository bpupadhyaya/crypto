...
export function OTKFlowScreen({ onClose }: Props) {
  ...
  const s = useMemo(() => StyleSheet.create({
    ...
    flowInfo: { flex: 1 },
    flowLabel: { color: t.text.primary, fontSize: 14, fontWeight: fonts.semibold },
    flowMeta: { color: t.text.muted, fontSize: 12, marginTop: 2 },
    flowAmount: { fontSize: 16, fontWeight: fonts.heavy },
    channelBreakdown: { backgroundColor: t.bg.card, borderRadius: 14, padding: 16, marginBottom: 20 },
    breakdownTitle: { color: t.text.primary, fontSize: 14, fontWeight: fonts.bold, marginBottom: 12 },
    breakdownRow: { flexDirection: 'row', alignItems: 'center', marginBottom: 10 },
    breakdownLabel: { flex: 1, color: t.text.primary, fontSize: 13, fontWeight: fonts.semibold },
    breakdownVal: { fontSize: 14, fontWeight: fonts.heavy, marginRight: 8 },
    ...
    netPeriod: { flex: 1, color: t.text.primary, fontSize: 14, fontWeight: fonts.semibold },
    netIn: { color: t.accent.green, fontSize: 13, fontWeight: fonts.bold, width: 60, textAlign: 'right' },
    netOut: { color: '#ef4444', fontSize: 13, fontWeight: fonts.bold, width: 60, textAlign: 'right' },
    netVal: { fontSize: 14, fontWeight: fonts.heavy, width: 70, textAlign: 'right' },
    netHeader: { flexDirection: 'row', backgroundColor: t.bg.card, borderRadius: 10, padding: 12, marginBottom: 8 },
    netHeaderLabel: { color: t.text.muted, fontSize: 11, fontWeight: fonts.bold, textTransform: 'uppercase' },
    ...
    balanceNum: { fontSize: 36, fontWeight: fonts.heavy },
    balanceLabel: { color: t.text.secondary, fontSize: 13, fontWeight: fonts.semibold, marginTop: 4 },
  }), [t]);
