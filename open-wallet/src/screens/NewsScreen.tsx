...
export function NewsScreen({ onClose }: Props) {
  ...
  const s = useMemo(() => StyleSheet.create({
    ...
    catChipText: { fontSize: 12, fontWeight: '600', color: t.text.muted },
    ...
    breakingLabel: { color: '#ef4444', fontSize: 11, fontWeight: '800', textTransform: 'uppercase', letterSpacing: 1.5 },
    breakingTitle: { color: t.text.primary, fontSize: 15, fontWeight: '700', marginTop: 4 },
    ...
    articleAuthor: { color: t.accent.blue, fontSize: 12, fontWeight: '600' },
    articleDate: { color: t.text.muted, fontSize: 12 },
    articleCatBadge: { flexDirection: 'row', alignItems: 'center', marginTop: 8 },
    articleCatText: { fontSize: 12, fontWeight: '600', marginLeft: 4 },
    ...
    factBadgeText: { fontSize: 11, fontWeight: '700', color: '#fff' },
    verifyCount: { fontSize: 12, fontWeight: '600' },
    sourcesLabel: { color: t.text.muted, fontSize: 11, fontWeight: '700', textTransform: 'uppercase', letterSpacing: 1, marginTop: 12 },
    sourceItem: { color: t.accent.blue, fontSize: 12, marginTop: 4 },
    backBtn: { color: t.accent.blue, fontSize: 16 },
    detailTitle: { color: t.text.primary, fontSize: 20, fontWeight: '800', marginHorizontal: 20, marginTop: 8 },
    ...
    factBtnText: { color: '#fff', fontSize: 15, fontWeight: '700' },
    ...
    reporterName: { color: t.text.primary, fontSize: 17, fontWeight: '800' },
    ...
    rStatValue: { color: t.text.primary, fontSize: 18, fontWeight: '700' },
    ...
    specChipText: { color: t.text.secondary, fontSize: 11, fontWeight: '600' },
    ...
    alertTitle: { color: t.text.primary, fontSize: 15, fontWeight: '700', marginTop: 4 },
      ...
      <SafeAreaView style={s.container}>
        ...
        <ScrollView>
          ...
          <View style={s.detailMeta}>
            <Text style={{ color: t.accent.blue, fontSize: 13, fontWeight: '600' }}>{a.author}</Text>
          ...
          {catMeta && (
            <View style={{ flexDirection: 'row', alignItems: 'center', marginHorizontal: 20, marginTop: 8 }}>
              ...
              <Text style={{ color: catMeta.color, fontSize: 13, fontWeight: '600', marginLeft: 4 }}>{catMeta.label}</Text>
            </View>
          )}
        ...
        DEMO_ALERTS.map((alert) => (
          ...
          >
            <View style={{ flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center' }}>
              <Text style={{ color: SEVERITY_COLORS[alert.severity], fontSize: 11, fontWeight: '800', textTransform: 'uppercase', letterSpacing: 1 }}>
                {alert.severity}
              </Text>
