...
export function OracleNetworkScreen({ onClose }: Props) {
  ...
  const s = useMemo(() => StyleSheet.create({
    ...
    verifierInfo: { flex: 1 },
    verifierName: { color: t.text.primary, fontSize: 14, fontWeight: '600' },
    verifierMeta: { color: t.text.muted, fontSize: 12, marginTop: 2 },
    verifierRight: { alignItems: 'flex-end' },
    verifierAccuracy: { fontSize: 16, fontWeight: '800' },
    verifierStatus: { fontSize: 11, fontWeight: '600', marginTop: 2 },
    attRow: { flexDirection: 'row', alignItems: 'center', paddingVertical: 12, borderBottomColor: t.bg.primary, borderBottomWidth: 1 },
    attInfo: { flex: 1 },
    attSubject: { color: t.text.primary, fontSize: 14, fontWeight: '600' },
    attMeta: { color: t.text.muted, fontSize: 12, marginTop: 2 },
    attResult: { fontSize: 12, fontWeight: '700', paddingHorizontal: 10, paddingVertical: 4, borderRadius: 8, overflow: 'hidden' },
    accCard: { alignItems: 'center', paddingVertical: 12, borderBottomColor: t.bg.primary, borderBottomWidth: 1 },
    accName: { color: t.text.primary, fontSize: 14, fontWeight: '600' },
