...
export function GamesScreen({ onClose }: Props) {
  ...
  const s = useMemo(() => StyleSheet.create({
    ...
    nightTitle: { color: t.text.primary, fontSize: 15, fontWeight: fonts.bold },
    ...
    attendingText: { color: t.accent.purple, fontSize: 13, fontWeight: fonts.semibold },
    ...
    gameIconText: { color: t.accent.purple, fontSize: 14, fontWeight: fonts.bold },
    gameInfo: { flex: 1 },
    gameTitle: { color: t.text.primary, fontSize: 14, fontWeight: fonts.semibold },
    gameMeta: { color: t.text.muted, fontSize: 12, marginTop: 2 },
    gameRight: { alignItems: 'flex-end', justifyContent: 'center' },
    gameRating: { color: t.accent.orange, fontSize: 14, fontWeight: fonts.bold },
    ...
    borrowBtnText: { color: '#fff', fontSize: 11, fontWeight: fonts.semibold },
    tournamentCard: { backgroundColor: t.accent.orange + '12', borderRadius: 16, padding: 20, marginHorizontal: 20, marginBottom: 16 },
    tournamentTitle: { color: t.text.primary, fontSize: 16, fontWeight: fonts.heavy },
    ...
    tournamentBadgeText: { color: '#fff', fontSize: 12, fontWeight: fonts.bold, textTransform: 'uppercase' },
    registerBtn: { backgroundColor: t.accent.green, paddingHorizontal: 16, paddingVertical: 8, borderRadius: 10 },
    registerBtnText: { color: '#fff', fontSize: 13, fontWeight: fonts.semibold },
    tradCard: { backgroundColor: t.bg.secondary, borderRadius: 14, padding: 16, marginHorizontal: 20, marginBottom: 12 },
    tradName: { color: t.text.primary, fontSize: 16, fontWeight: fonts.bold },
    tradOrigin: { color: t.accent.purple, fontSize: 12, fontWeight: fonts.semibold, marginTop: 2 },
    tradDesc: { color: t.text.secondary, fontSize: 13, marginTop: 8, lineHeight: 20 },
    tradSection: { marginTop: 12 },
    tradSectionLabel: { color: t.text.primary, fontSize: 13, fontWeight: fonts.bold, marginBottom: 4, textTransform: 'uppercase', letterSpacing: 1 },
