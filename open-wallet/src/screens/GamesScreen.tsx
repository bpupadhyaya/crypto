...
export function GamesScreen({ onClose }: Props) {
  ...
  const s = useMemo(() => StyleSheet.create({
    ...
    nightTitle: { color: t.text.primary, fontSize: fonts.md, fontWeight: fonts.bold },
    nightMeta: { color: t.text.muted, fontSize: fonts.sm, marginTop: 4 },
    nightDesc: { color: t.text.secondary, fontSize: fonts.sm, marginTop: 8, lineHeight: 20 },
    nightFooter: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', marginTop: 12 },
    attendingText: { color: t.accent.purple, fontSize: fonts.sm, fontWeight: fonts.semibold },
    ...
    gameIconText: { color: t.accent.purple, fontSize: fonts.md, fontWeight: fonts.bold },
    gameInfo: { flex: 1 },
    gameTitle: { color: t.text.primary, fontSize: fonts.md, fontWeight: fonts.semibold },
    gameMeta: { color: t.text.muted, fontSize: fonts.sm, marginTop: 2 },
    gameRight: { alignItems: 'flex-end', justifyContent: 'center' },
    gameRating: { color: t.accent.orange, fontSize: fonts.md, fontWeight: fonts.bold },
    gameAvail: { fontSize: fonts.xs, marginTop: 2 },
    borrowBtn: { backgroundColor: t.accent.blue, paddingHorizontal: 12, paddingVertical: 6, borderRadius: 8, marginTop: 4 },
    borrowBtnText: { color: '#fff', fontSize: fonts.xs, fontWeight: fonts.semibold },
    tournamentCard: { backgroundColor: t.accent.orange + '12', borderRadius: 16, padding: 20, marginHorizontal: 20, marginBottom: 16 },
    tournamentTitle: { color: t.text.primary, fontSize: fonts.lg, fontWeight: fonts.heavy },
    tournamentMeta: { color: t.text.muted, fontSize: fonts.sm, marginTop: 4 },
    ...
    tournamentBadgeText: { color: '#fff', fontSize: fonts.sm, fontWeight: fonts.bold, textTransform: 'uppercase' },
    registerBtn: { backgroundColor: t.accent.green, paddingHorizontal: 16, paddingVertical: 8, borderRadius: 10 },
    registerBtnText: { color: '#fff', fontSize: fonts.sm, fontWeight: fonts.semibold },
    tradCard: { backgroundColor: t.bg.secondary, borderRadius: 14, padding: 16, marginHorizontal: 20, marginBottom: 12 },
    tradName: { color: t.text.primary, fontSize: fonts.lg, fontWeight: fonts.bold },
    tradOrigin: { color: t.accent.purple, fontSize: fonts.sm, fontWeight: fonts.semibold, marginTop: 2 },
    tradDesc: { color: t.text.secondary, fontSize: fonts.sm, marginTop: 8, lineHeight: 20 },
    tradSection: { marginTop: 12 },
    tradSectionLabel: { color: t.text.primary, fontSize: fonts.sm, fontWeight: fonts.bold, marginBottom: 4, textTransform: 'uppercase', letterSpacing: 1 },
    tradSectionText: { color: t.text.secondary, fontSize: fonts.sm, lineHeight: 20 },
    ...
    snacksNote: { color: t.text.muted, fontSize: fonts.xs, fontStyle: 'italic', marginTop: -4, marginBottom: 8 },
