...
export function LegalAidScreen({ onClose }: Props) {
  ...
  const s = useMemo(() => StyleSheet.create({
    ...
    rightsCatText: { color: '#fff', fontSize: fonts.xs, fontWeight: fonts.bold, textTransform: 'uppercase' },
    rightsTitle: { color: t.text.primary, fontSize: fonts.lg, fontWeight: fonts.bold },
    rightsSummary: { color: t.text.muted, fontSize: fonts.sm, marginTop: 6, lineHeight: 19 },
    rightsRegion: { color: t.text.muted, fontSize: fonts.xs, marginTop: 4 },
    keyPointsContainer: { marginTop: 12 },
    keyPoint: { color: t.text.primary, fontSize: fonts.sm, marginBottom: 6, lineHeight: 18 },
    ...
    advisorName: { color: t.text.primary, fontSize: fonts.lg, fontWeight: fonts.bold },
    advisorSpecialty: { color: t.accent.blue, fontSize: fonts.sm, fontWeight: fonts.semibold, marginTop: 2 },
    advisorMeta: { color: t.text.muted, fontSize: fonts.sm, marginTop: 4 },
    advisorRow: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', marginTop: 10 },
    advisorStat: { color: t.text.muted, fontSize: fonts.sm },
    advisorRating: { color: t.accent.orange, fontSize: fonts.md, fontWeight: fonts.bold },
    ...
    volunteerText: { color: t.accent.green, fontSize: fonts.xs, fontWeight: fonts.semibold },

    // Help form
    formCard: { backgroundColor: t.bg.secondary, borderRadius: 16, padding: 20, marginHorizontal: 20, marginBottom: 16 },
    inputLabel: { color: t.text.muted, fontSize: fonts.sm, fontWeight: fonts.semibold, marginBottom: 6, textTransform: 'uppercase', letterSpacing: 0.5 },
    input: { backgroundColor: t.bg.primary, borderRadius: 10, padding: 12, color: t.text.primary, fontSize: fonts.md, marginBottom: 16 },
    inputMultiline: { backgroundColor: t.bg.primary, borderRadius: 10, padding: 12, color: t.text.primary, fontSize: fonts.md, marginBottom: 16, minHeight: 80, textAlignVertical: 'top' },
    ...
    urgencyText: { fontSize: fonts.sm, fontWeight: fonts.semibold },
    ...
    caseCat: { color: t.text.primary, fontSize: fonts.md, fontWeight: fonts.bold },
    caseStatusBadge: { paddingHorizontal: 10, paddingVertical: 3, borderRadius: 10 },
    caseStatusText: { color: '#fff', fontSize: fonts.xs, fontWeight: fonts.bold },
    caseDesc: { color: t.text.muted, fontSize: fonts.sm, marginTop: 8, lineHeight: 19 },
    caseRow: { flexDirection: 'row', justifyContent: 'space-between', marginTop: 10 },
    caseMeta: { color: t.text.muted, fontSize: fonts.sm },
    caseAdvisor: { color: t.accent.blue, fontSize: fonts.sm, fontWeight: fonts.semibold },
    urgencyTag: { paddingHorizontal: 8, paddingVertical: 2, borderRadius: 8, alignSelf: 'flex-start', marginTop: 6 },
    urgencyTagText: { color: '#fff', fontSize: fonts.xs, fontWeight: fonts.bold, textTransform: 'uppercase' },
    ...
    violationBtnText: { color: t.accent.red, fontSize: fonts.md, fontWeight: fonts.bold },

    // Templates
    templateCard: { backgroundColor: t.bg.secondary, borderRadius: 16, padding: 16, marginHorizontal: 20, marginBottom: 12 },
    templateName: { color: t.text.primary, fontSize: fonts.md, fontWeight: fonts.bold },
    templateCat: { color: t.accent.blue, fontSize: fonts.sm, fontWeight: fonts.semibold, marginTop: 2 },
    templateDesc: { color: t.text.muted, fontSize: fonts.sm, marginTop: 6, lineHeight: 19 },
    templateRow: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', marginTop: 10 },
    templateDownloads: { color: t.text.muted, fontSize: fonts.sm },
    downloadBtn: { backgroundColor: t.accent.green, paddingHorizontal: 16, paddingVertical: 8, borderRadius: 10 },
    downloadBtnText: { color: '#fff', fontSize: fonts.sm, fontWeight: fonts.semibold },

    // Education
    eduCard: { backgroundColor: t.bg.secondary, borderRadius: 16, padding: 16, marginHorizontal: 20, marginBottom: 12 },
    eduTitle: { color: t.text.primary, fontSize: fonts.md, fontWeight: fonts.bold },
    eduTypeBadge: { paddingHorizontal: 8, paddingVertical: 3, borderRadius: 8, alignSelf: 'flex-start', marginTop: 6 },
    eduTypeText: { fontSize: fonts.xs, fontWeight: fonts.bold, textTransform: 'uppercase' },
    eduMeta: { color: t.text.muted, fontSize: fonts.sm, marginTop: 6 },
