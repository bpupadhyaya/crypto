...
export function LegalAidScreen({ onClose }: Props) {
  ...
  const s = useMemo(() => StyleSheet.create({
    ...
    rightsCatText: { color: '#fff', fontSize: 11, fontWeight: '700', textTransform: 'uppercase' },
    rightsTitle: { color: t.text.primary, fontSize: 16, fontWeight: '700' },
    ...
    expandBtn: { color: t.accent.blue, fontSize: 13, fontWeight: '600', marginTop: 8 },

    // Advisors
    advisorCard: { backgroundColor: t.bg.secondary, borderRadius: 16, padding: 16, marginHorizontal: 20, marginBottom: 12 },
    advisorName: { color: t.text.primary, fontSize: 16, fontWeight: '700' },
    advisorSpecialty: { color: t.accent.blue, fontSize: 13, fontWeight: '600', marginTop: 2 },
    ...
    advisorRating: { color: t.accent.orange, fontSize: 14, fontWeight: '700' },
    ...
    volunteerText: { color: t.accent.green, fontSize: 11, fontWeight: '600' },

    // Help form
    formCard: { backgroundColor: t.bg.secondary, borderRadius: 16, padding: 20, marginHorizontal: 20, marginBottom: 16 },
    inputLabel: { color: t.text.muted, fontSize: 12, fontWeight: '600', marginBottom: 6, textTransform: 'uppercase', letterSpacing: 0.5 },
    ...
    caseCat: { color: t.text.primary, fontSize: 15, fontWeight: '700' },
    caseStatusBadge: { paddingHorizontal: 10, paddingVertical: 3, borderRadius: 10 },
    caseStatusText: { color: '#fff', fontSize: 11, fontWeight: '700' },
    ...
    caseAdvisor: { color: t.accent.blue, fontSize: 12, fontWeight: '600' },
    urgencyTag: { paddingHorizontal: 8, paddingVertical: 2, borderRadius: 8, alignSelf: 'flex-start', marginTop: 6 },
    urgencyTagText: { color: '#fff', fontSize: 10, fontWeight: '700', textTransform: 'uppercase' },
    ...
    violationBtnText: { color: t.accent.red, fontSize: 14, fontWeight: '700' },

    // Templates
    templateCard: { backgroundColor: t.bg.secondary, borderRadius: 16, padding: 16, marginHorizontal: 20, marginBottom: 12 },
    templateName: { color: t.text.primary, fontSize: 15, fontWeight: '700' },
    templateCat: { color: t.accent.blue, fontSize: 12, fontWeight: '600', marginTop: 2 },
    ...
    eduTitle: { color: t.text.primary, fontSize: 15, fontWeight: '700' },
    eduTypeBadge: { paddingHorizontal: 8, paddingVertical: 3, borderRadius: 8, alignSelf: 'flex-start', marginTop: 6 },
    eduTypeText: { fontSize: 11, fontWeight: '700', textTransform: 'uppercase' },
