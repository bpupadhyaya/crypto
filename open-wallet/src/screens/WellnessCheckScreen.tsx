...
export function WellnessCheckScreen({ onClose }: Props) {
  ...
  const s = useMemo(() => StyleSheet.create({
    ...
    dimSelected: { fontSize: fonts.lg, fontWeight: fonts.heavy },
    dimQuestion: { color: t.text.secondary, fontSize: fonts.sm, marginBottom: 12 },
    ...
    scoreBtnNum: { fontSize: fonts.lg, fontWeight: fonts.heavy },
    scoreBtnLabel: { fontSize: fonts.xxs, fontWeight: fonts.semibold, marginTop: 2 },
    tipsSection: { marginTop: 4 },
    tipText: { color: t.text.muted, fontSize: fonts.sm, lineHeight: 18, marginLeft: 8 },
    ...
    submitLabel: { color: t.text.secondary, fontSize: fonts.md, marginBottom: 4 },
    submitMood: { fontSize: fonts.lg, fontWeight: fonts.bold, marginBottom: 16 },
    ...
    historyTitle: { color: t.text.primary, fontSize: fonts.lg, fontWeight: fonts.heavy, marginBottom: 12, marginTop: 8 },
    historyCard: { backgroundColor: t.bg.card, borderRadius: 12, padding: 14, marginBottom: 8 },
    historyDate: { color: t.text.primary, fontSize: fonts.md, fontWeight: fonts.bold, marginBottom: 8 },
    ...
    historyChipIcon: { fontSize: fonts.sm },
    historyChipVal: { fontSize: fonts.sm, fontWeight: fonts.bold, color: '#fff' },
    historyAvg: { color: t.text.secondary, fontSize: fonts.sm, fontWeight: fonts.semibold },
