...
export function WellnessCheckScreen({ onClose }: Props) {
  ...
  const s = useMemo(() => StyleSheet.create({
    ...
    dimSelected: { fontSize: 16, fontWeight: '800' },
    ...
    scoreBtnNum: { fontSize: 16, fontWeight: '800' },
    scoreBtnLabel: { fontSize: 9, fontWeight: '600', marginTop: 2 },
    ...
    submitAvg: { fontSize: 40, fontWeight: '900', marginBottom: 4 },
    submitLabel: { color: t.text.secondary, fontSize: 14, marginBottom: 4 },
    submitMood: { fontSize: 16, fontWeight: '700', marginBottom: 16 },
    submitBtn: { borderRadius: 12, paddingVertical: 14, paddingHorizontal: 40 },
    submitBtnText: { color: '#fff', fontSize: 15, fontWeight: '700' },
    historyTitle: { color: t.text.primary, fontSize: 16, fontWeight: '800', marginBottom: 12, marginTop: 8 },
    historyCard: { backgroundColor: t.bg.card, borderRadius: 12, padding: 14, marginBottom: 8 },
    historyDate: { color: t.text.primary, fontSize: 14, fontWeight: '700', marginBottom: 8 },
    ...
    historyChipVal: { fontSize: 12, fontWeight: '700', color: '#fff' },
    historyAvg: { color: t.text.secondary, fontSize: 12, fontWeight: '600' },
