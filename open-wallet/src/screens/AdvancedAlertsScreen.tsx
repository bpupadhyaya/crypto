...
export const AdvancedAlertsScreen = React.memo(({ onClose }: { onClose: () => void }) => {
  ...
  const s = useMemo(() => StyleSheet.create({
    ...
    formTitle: { color: t.text.primary, fontSize: fonts.lg, fontWeight: fonts.bold, marginBottom: 12 },
    ...
    typeIconText: { color: '#fff', fontSize: fonts.xs, fontWeight: fonts.heavy },
    typeText: { color: t.text.secondary, fontSize: fonts.sm, fontWeight: fonts.semibold },
    typeTextActive: { color: t.accent.green },
    fieldLabel: { color: t.text.muted, fontSize: fonts.sm, fontWeight: fonts.semibold, marginBottom: 6, marginTop: 10 },
    ...
    input: { backgroundColor: t.bg.primary, borderRadius: 12, padding: 14, color: t.text.primary, fontSize: fonts.md, marginTop: 6 },
    ...
    opText: { color: t.text.secondary, fontSize: fonts.md, fontWeight: fonts.bold },
    ...
    alertTagText: { fontSize: fonts.xs, fontWeight: fonts.bold },
    alertName: { color: t.text.primary, fontSize: fonts.md, fontWeight: fonts.semibold },
    alertMeta: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', marginTop: 8 },
    alertStatus: { fontSize: fonts.sm, fontWeight: fonts.semibold },
    alertChecked: { color: t.text.muted, fontSize: fonts.xs },
    alertActions: { flexDirection: 'row', alignItems: 'center', gap: 12 },
    deleteBtn: { color: t.accent.red, fontSize: fonts.lg, fontWeight: fonts.bold },
    // Empty
    empty: { alignItems: 'center', paddingVertical: 60 },
    emptyTitle: { color: t.text.secondary, fontSize: fonts.lg, fontWeight: fonts.bold },
    emptyHint: { color: t.text.muted, fontSize: fonts.sm, marginTop: 4, textAlign: 'center', paddingHorizontal: 40 },
    demoTag: { color: t.accent.yellow, fontSize: fonts.xs, fontWeight: fonts.bold, textAlign: 'center', marginBottom: 8, marginTop: 4 },
    conditionSep: { color: t.accent.blue, fontSize: fonts.sm, fontWeight: fonts.heavy, textAlign: 'center', marginVertical: 8 },
  }), [t]);
