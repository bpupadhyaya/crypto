...
export const AdvancedAlertsScreen = React.memo(({ onClose }: { onClose: () => void }) => {
  ...
  const s = useMemo(() => StyleSheet.create({
    ...
    formTitle: { color: t.text.primary, fontSize: 16, fontWeight: '700', marginBottom: 12 },
    ...
    typeIconText: { color: '#fff', fontSize: 11, fontWeight: '800' },
    typeText: { color: t.text.secondary, fontSize: 13, fontWeight: '600' },
    typeTextActive: { color: t.accent.green },
    fieldLabel: { color: t.text.muted, fontSize: 12, fontWeight: '600', marginBottom: 6, marginTop: 10 },
    ...
    opText: { color: t.text.secondary, fontSize: 14, fontWeight: '700' },
    ...
    alertTagText: { fontSize: 11, fontWeight: '700' },
    alertName: { color: t.text.primary, fontSize: 15, fontWeight: '600' },
    ...
    deleteBtn: { color: t.accent.red, fontSize: 16, fontWeight: '700' },
    // Empty
    empty: { alignItems: 'center', paddingVertical: 60 },
    emptyTitle: { color: t.text.secondary, fontSize: 17, fontWeight: '700' },
    emptyHint: { color: t.text.muted, fontSize: 13, marginTop: 4, textAlign: 'center', paddingHorizontal: 40 },
    demoTag: { color: t.accent.yellow, fontSize: 11, fontWeight: '700', textAlign: 'center', marginBottom: 8, marginTop: 4 },
    conditionSep: { color: t.accent.blue, fontSize: 13, fontWeight: '800', textAlign: 'center', marginVertical: 8 },
  }), [t]);
