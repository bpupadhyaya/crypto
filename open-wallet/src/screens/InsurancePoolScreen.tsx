...
export function InsurancePoolScreen({ onClose }: Props) {
  ...
  const s = useMemo(() => StyleSheet.create({
    ...
    tabText: { color: t.text.muted, fontSize: fonts.sm, fontWeight: fonts.bold },
    ...
    typeText: { color: '#fff', fontSize: fonts.xs, fontWeight: fonts.bold },
    ...
    joinedText: { color: '#4caf50', fontSize: fonts.md, fontWeight: fonts.bold },
    ...
    detailTitle: { color: t.text.primary, fontSize: fonts.xl, fontWeight: fonts.heavy, marginHorizontal: 20 },
    ...
    claimantText: { color: t.text.muted, fontSize: fonts.sm, marginTop: 4 },
    evidenceText: { color: t.text.muted, fontSize: fonts.xs, fontFamily: 'monospace', marginTop: 4 },
    ...
    premiumText: { color: '#ff9800', fontSize: fonts.sm, fontWeight: fonts.bold },
    actionRow: { flexDirection: 'row', gap: 8, marginTop: 12 },
    actionBtn: { flex: 1, borderRadius: 12, paddingVertical: 12, alignItems: 'center', borderWidth: 1, borderColor: t.border },
    actionBtnText: { color: t.accent.blue, fontSize: fonts.sm, fontWeight: fonts.bold },
  }), [t]);
