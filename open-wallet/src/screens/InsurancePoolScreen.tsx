...
export function InsurancePoolScreen({ onClose }: Props) {
  ...
  const s = useMemo(() => StyleSheet.create({
    ...
    typeText: { color: '#fff', fontSize: 11, fontWeight: fonts.bold },
    ...
    joinedText: { color: '#4caf50', fontSize: 14, fontWeight: fonts.bold },
    ...
    premiumText: { color: '#ff9800', fontSize: 12, fontWeight: fonts.bold },
    actionRow: { flexDirection: 'row', gap: 8, marginTop: 12 },
    actionBtn: { flex: 1, borderRadius: 12, paddingVertical: 12, alignItems: 'center', borderWidth: 1, borderColor: t.border },
    actionBtnText: { color: t.accent.blue, fontSize: 13, fontWeight: fonts.bold },
  }), [t]);
