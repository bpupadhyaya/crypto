...
export function TeenScreen({ onClose }: Props) {
  ...
  const s = useMemo(() => StyleSheet.create({
    ...
    eOTKBadge: { color: t.accent.green, fontSize: 13, fontWeight: '700', marginTop: 4 },
    // Challenge styles
    ...
    challengeReward: { color: t.accent.green, fontSize: 14, fontWeight: '700', marginTop: 8 },
    ...
    skillInfo: { flex: 1 },
    skillTitle: { color: t.text.primary, fontSize: 14, fontWeight: '700' },
    ...
    safetyInfo: { flex: 1 },
    safetyTitle: { color: t.text.primary, fontSize: 14, fontWeight: '700' },
    ...
    safetyTypeText: { fontSize: 10, fontWeight: '700' },
    ...
    emergencyTitle: { color: t.accent.red, fontSize: 16, fontWeight: '800', marginTop: 8 },
    ...
    voiceTitle: { color: t.text.primary, fontSize: 15, fontWeight: '700' },
