...
export function BudgetScreen({ onClose }: Props) {
  ...
  const s = useMemo(() => StyleSheet.create({
    ...
    heroValue: { color: t.accent.green, fontSize: 32, fontWeight: fonts.heavy, marginTop: 4 },
    ...
    catName: { color: t.text.primary, fontSize: 14, fontWeight: fonts.semibold },
    catAmount: { color: t.text.secondary, fontSize: 13, textAlign: 'right' },
    ...
    revName: { color: t.text.primary, fontSize: 14, fontWeight: fonts.semibold, flex: 1 },
    revAmount: { color: t.text.secondary, fontSize: 14 },
    ...
    propCategory: { color: t.text.muted, fontSize: 12 },
    propStatus: { fontSize: 12, fontWeight: fonts.bold },
    propAmount: { color: t.accent.blue, fontSize: 16, fontWeight: fonts.heavy, marginTop: 8 },
    propDesc: { color: t.text.secondary, fontSize: 13, lineHeight: 20, marginTop: 8 },
    ...
    txDesc: { color: t.text.primary, fontSize: 14, fontWeight: fonts.semibold },
    txMeta: { flexDirection: 'row', justifyContent: 'space-between', marginTop: 6 },
    txCategory: { color: t.text.muted, fontSize: 12 },
    txDate: { color: t.text.muted, fontSize: 12 },
    txAmount: { color: t.accent.red, fontSize: 15, fontWeight: fonts.bold, marginTop: 6 },
    txHash: { color: t.accent.blue, fontSize: 11, marginTop: 4 },
    txRecipient: { color: t.text.muted, fontSize: 11, marginTop: 2 },
    quarterCard: { backgroundColor: t.bg.card, borderRadius: 16, padding: 16, marginBottom: 16 },
    quarterTitle: { color: t.text.primary, fontSize: 16, fontWeight: fonts.heavy },
    quarterStats: { flexDirection: 'row', gap: 12, marginTop: 12 },
    qStat: { flex: 1, alignItems: 'center' },
    qStatLabel: { color: t.text.muted, fontSize: 11 },
    qStatValue: { color: t.text.primary, fontSize: 14, fontWeight: fonts.bold, marginTop: 2 },
    qCatRow: { flexDirection: 'row', justifyContent: 'space-between', paddingVertical: 6, marginTop: 4 },
    qCatName: { color: t.text.secondary, fontSize: 13 },
    qCatSpent: { color: t.text.primary, fontSize: 13, fontWeight: fonts.semibold },
