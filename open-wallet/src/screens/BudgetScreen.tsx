...
export function BudgetScreen({ onClose }: Props) {
  ...
  const s = useMemo(() => StyleSheet.create({
    ...
    heroValue: { color: t.accent.green, fontSize: 32, fontWeight: '900', marginTop: 4 },
    ...
    catName: { color: t.text.primary, fontSize: 14, fontWeight: '600' },
    ...
    revName: { color: t.text.primary, fontSize: 14, fontWeight: '600', flex: 1 },
    ...
    propStatus: { fontSize: 12, fontWeight: '700' },
    propAmount: { color: t.accent.blue, fontSize: 16, fontWeight: '800', marginTop: 8 },
    ...
    txDesc: { color: t.text.primary, fontSize: 14, fontWeight: '600' },
    ...
    txAmount: { color: t.accent.red, fontSize: 15, fontWeight: '700', marginTop: 6 },
    ...
    quarterTitle: { color: t.text.primary, fontSize: 16, fontWeight: '800' },
    ...
    qStatValue: { color: t.text.primary, fontSize: 14, fontWeight: '700', marginTop: 2 },
    ...
    qCatSpent: { color: t.text.primary, fontSize: 13, fontWeight: '600' },
