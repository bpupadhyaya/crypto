...
export function QRHubScreen({ onClose }: Props) {
  ...
  const s = useMemo(() => StyleSheet.create({
    ...
    scanTitle: { color: t.text.primary, fontSize: fonts.xl, fontWeight: fonts.bold, marginBottom: 8 },
    scanDesc: { color: t.text.secondary, fontSize: fonts.md, textAlign: 'center', lineHeight: 22 },
    ...
    recentLabel: { color: t.text.muted, fontSize: fonts.sm, fontWeight: fonts.bold, textTransform: 'uppercase', letterSpacing: 1.2, marginBottom: 10 },
    ...
    recentInfo: { flex: 1 },
    recentName: { color: t.text.primary, fontSize: fonts.md, fontWeight: fonts.semibold },
    recentTime: { color: t.text.muted, fontSize: fonts.sm, marginTop: 2 },
    ...
    templateIcon: { fontSize: fonts.hero },
    templateInfo: { flex: 1 },
    templateTitle: { color: t.text.primary, fontSize: fonts.md, fontWeight: fonts.bold, marginBottom: 2 },
    templateDesc: { color: t.text.secondary, fontSize: fonts.sm, lineHeight: 18 },
    templateArrow: { color: t.text.muted, fontSize: fonts.xl },
    ...
    historyBadgeText: { fontSize: fonts.xs, fontWeight: fonts.bold, color: '#fff' },
    historyInfo: { flex: 1 },
    historyLabel: { color: t.text.primary, fontSize: fonts.md, fontWeight: fonts.semibold },
    historyMeta: { color: t.text.muted, fontSize: fonts.sm, marginTop: 2 },
    historyCat: { color: t.text.secondary, fontSize: fonts.sm, fontWeight: fonts.semibold },
