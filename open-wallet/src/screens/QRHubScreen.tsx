...
export function QRHubScreen({ onClose }: Props) {
  ...
  const s = useMemo(() => StyleSheet.create({
    ...
    scanTitle: { color: t.text.primary, fontSize: 18, fontWeight: fonts.bold, marginBottom: 8 },
    ...
    scanBtnText: { color: '#fff', fontSize: 15, fontWeight: fonts.bold },
    recentLabel: { color: t.text.muted, fontSize: 12, fontWeight: fonts.bold, textTransform: 'uppercase', letterSpacing: 1.2, marginBottom: 10 },
    ...
    recentInfo: { flex: 1 },
    recentName: { color: t.text.primary, fontSize: 14, fontWeight: fonts.semibold },
    ...
    templateInfo: { flex: 1 },
    templateTitle: { color: t.text.primary, fontSize: 15, fontWeight: fonts.bold, marginBottom: 2 },
    ...
    historyBadgeText: { fontSize: 10, fontWeight: fonts.bold, color: '#fff' },
    historyInfo: { flex: 1 },
    historyLabel: { color: t.text.primary, fontSize: 14, fontWeight: fonts.semibold },
    historyMeta: { color: t.text.muted, fontSize: 12, marginTop: 2 },
    historyCat: { color: t.text.secondary, fontSize: 12, fontWeight: fonts.semibold },
