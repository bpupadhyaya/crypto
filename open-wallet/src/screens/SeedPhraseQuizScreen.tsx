...
export function SeedPhraseQuizScreen({ onClose }: Props) {
  ...
  const s = useMemo(() => StyleSheet.create({
    ...
    healthValue: { fontSize: fonts.xxxl, fontWeight: fonts.heavy },
    healthLabel: { color: t.text.muted, fontSize: fonts.xs, marginTop: 4 },
    healthBar: { height: 8, borderRadius: 4, backgroundColor: t.bg.primary, marginTop: 12 },
    healthFill: { height: 8, borderRadius: 4 },
    healthHint: { color: t.text.muted, fontSize: fonts.sm, marginTop: 8, textAlign: 'center' },
    quizQuestion: { marginBottom: 16 },
    questionLabel: { color: t.text.primary, fontSize: fonts.md, fontWeight: fonts.semibold, marginBottom: 8 },
    questionInput: { backgroundColor: t.bg.primary, borderRadius: 12, padding: 14, color: t.text.primary, fontSize: fonts.lg, borderWidth: 2, borderColor: 'transparent' },
    inputCorrect: { borderColor: t.accent.green },
    inputIncorrect: { borderColor: t.accent.red },
    resultText: { fontSize: fonts.sm, fontWeight: fonts.semibold, marginTop: 4 },
    ...
    retryBtnText: { color: '#fff', fontSize: fonts.md, fontWeight: fonts.bold },
    scoreResult: { alignItems: 'center', paddingVertical: 16 },
    scoreResultValue: { fontSize: fonts.hero, fontWeight: fonts.heavy },
    scoreResultLabel: { color: t.text.secondary, fontSize: fonts.md, marginTop: 4 },
    warningBox: { backgroundColor: t.accent.red + '15', borderRadius: 12, padding: 14, marginBottom: 12 },
    warningText: { color: t.accent.red, fontSize: fonts.sm, fontWeight: fonts.semibold, lineHeight: 20 },
    revealBtn: { backgroundColor: t.accent.orange, borderRadius: 12, paddingVertical: 14, alignItems: 'center' },
    revealBtnText: { color: '#fff', fontSize: fonts.md, fontWeight: fonts.bold },
    hideBtn: { backgroundColor: t.accent.red, borderRadius: 12, paddingVertical: 14, alignItems: 'center' },
    hideBtnText: { color: '#fff', fontSize: fonts.md, fontWeight: fonts.bold },
    ...
    wordNumber: { color: t.text.muted, fontSize: fonts.xs },
    wordText: { color: t.text.primary, fontSize: fonts.md, fontWeight: fonts.semibold },
    ...
    historyDate: { color: t.text.secondary, fontSize: fonts.sm },
    historyScore: { fontSize: fonts.md, fontWeight: fonts.bold },
    historyDetail: { color: t.text.muted, fontSize: fonts.sm },
    ...
    reminderBtnText: { color: t.text.secondary, fontSize: fonts.md, fontWeight: fonts.semibold },
    ...
    setReminderBtnText: { color: '#fff', fontSize: fonts.md, fontWeight: fonts.bold },
  }), [t]);
