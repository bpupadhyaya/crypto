...
export function SeedPhraseQuizScreen({ onClose }: Props) {
  ...
  const s = useMemo(() => StyleSheet.create({
    ...
    questionLabel: { color: t.text.primary, fontSize: 15, fontWeight: '600', marginBottom: 8 },
    ...
    resultText: { fontSize: 13, fontWeight: '600', marginTop: 4 },
    ...
    scoreResultValue: { fontSize: 36, fontWeight: '800' },
    ...
    warningText: { color: t.accent.red, fontSize: 13, fontWeight: '600', lineHeight: 20 },
    ...
    wordText: { color: t.text.primary, fontSize: 14, fontWeight: '600' },
    ...
    reminderBtnText: { color: t.text.secondary, fontSize: 14, fontWeight: '600' },
    reminderBtnTextActive: { color: '#fff', fontWeight: '700' },
    setReminderBtn: { backgroundColor: t.accent.green, borderRadius: 12, paddingVertical: 12, alignItems: 'center', marginTop: 12 },
    setReminderBtnText: { color: '#fff', fontSize: 14, fontWeight: '700' },
  }), [t]);
