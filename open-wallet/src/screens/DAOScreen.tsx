...
export function DAOScreen({ onClose }: Props) {
  ...
  const s = useMemo(() => StyleSheet.create({
    ...
    toggleBtnText: { color: t.text.secondary, fontSize: 13, fontWeight: '600' },
    toggleBtnTextActive: { color: '#fff' },
    detailHeader: { backgroundColor: t.bg.card, borderRadius: 20, padding: 20, marginHorizontal: 20, alignItems: 'center' },
    detailName: { color: t.text.primary, fontSize: 20, fontWeight: '800', textAlign: 'center' },
    ...
    treasuryValue: { color: t.accent.green, fontSize: 28, fontWeight: '800', marginTop: 4 },
    ...
    propType: { fontSize: 11, fontWeight: '700', marginTop: 4 },
    ...
    spendValue: { color: t.text.primary, fontSize: 15, fontWeight: '700', marginTop: 2 },
    votingModelBadge: { backgroundColor: t.accent.blue + '15', paddingHorizontal: 10, paddingVertical: 4, borderRadius: 8, marginTop: 8 },
    votingModelText: { color: t.accent.blue, fontSize: 12, fontWeight: '600' },
