...
export function TimeCapsuleScreen({ onClose }: Props) {
  ...
  const st = useMemo(() => StyleSheet.create({
    ...
    countdownText: { color: t.accent.blue, fontSize: fonts.md, fontWeight: fonts.bold, marginLeft: 6 },
    ...
    recipientBtnText: { color: t.text.secondary, fontSize: fonts.sm, fontWeight: fonts.semibold },
    ...
    sealBtnText: { color: '#fff', fontSize: fonts.lg, fontWeight: fonts.bold },
    sealedIcon: { fontSize: fonts.xxxl, textAlign: 'center', marginBottom: 8 },
    unlockedMsg: { color: t.text.primary, fontSize: fonts.md, lineHeight: 21, fontStyle: 'italic', marginTop: 8 },
