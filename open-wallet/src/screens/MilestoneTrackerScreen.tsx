...
export function MilestoneTrackerScreen({ onClose }: Props) {
  ...
  const s = useMemo(() => StyleSheet.create({
    ...
    msIcon: { fontSize: 24 },
    msTitle: { flex: 1, color: t.text.primary, fontSize: 14, fontWeight: '700' },
    msBadge: { paddingHorizontal: 8, paddingVertical: 3, borderRadius: 6 },
    msBadgeText: { fontSize: 10, fontWeight: '700', color: '#fff' },
    msDesc: { color: t.text.secondary, fontSize: 13, lineHeight: 18, marginBottom: 10 },
    msFooter: { flexDirection: 'row', alignItems: 'center', gap: 12 },
    msChannel: { fontSize: 12, fontWeight: '600' },
    msReward: { color: t.accent.green, fontSize: 13, fontWeight: '800' },
    msVerifiers: { color: t.text.muted, fontSize: 12 },
    msDate: { color: t.text.muted, fontSize: 11, marginLeft: 'auto' as any },
