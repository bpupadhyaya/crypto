...
export function MilestoneTrackerScreen({ onClose }: Props) {
  ...
  const s = useMemo(() => StyleSheet.create({
    ...
    msIcon: { fontSize: 24 },
    msTitle: { flex: 1, color: t.text.primary, fontSize: 14, fontWeight: fonts.bold },
    msBadge: { paddingHorizontal: 8, paddingVertical: 3, borderRadius: 6 },
    msBadgeText: { fontSize: 10, fontWeight: fonts.bold, color: '#fff' },
    ...
    msChannel: { fontSize: 12, fontWeight: fonts.semibold },
    msReward: { color: t.accent.green, fontSize: 13, fontWeight: fonts.heavy },
