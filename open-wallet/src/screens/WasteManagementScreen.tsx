...
export function WasteManagementScreen({ onClose }: Props) {
  ...
  const s = useMemo(() => StyleSheet.create({
    ...
    breakdownValue: { color: t.text.primary, fontSize: fonts.xl, fontWeight: fonts.heavy },
    breakdownLabel: { color: t.text.muted, fontSize: fonts.xs, marginTop: 2, textAlign: 'center' },
    breakdownUnit: { color: t.text.muted, fontSize: fonts.xs },
    communityCard: { backgroundColor: t.accent.green + '12', borderRadius: 16, padding: 20, marginHorizontal: 20, marginBottom: 16 },
    communityTitle: { color: t.text.primary, fontSize: fonts.md, fontWeight: fonts.bold, marginBottom: 12 },
    communityStatRow: { flexDirection: 'row', justifyContent: 'space-between', marginBottom: 8 },
    communityStatLabel: { color: t.text.muted, fontSize: fonts.sm },
    communityStatValue: { color: t.text.primary, fontSize: fonts.sm, fontWeight: fonts.bold },
    scheduleCard: { backgroundColor: t.bg.secondary, borderRadius: 14, padding: 16, marginHorizontal: 20, marginBottom: 12 },
    scheduleArea: { color: t.text.primary, fontSize: fonts.md, fontWeight: fonts.bold, marginBottom: 8 },
    scheduleRow: { flexDirection: 'row', justifyContent: 'space-between', marginBottom: 4 },
    scheduleType: { color: t.text.muted, fontSize: fonts.sm },
    scheduleDay: { color: t.text.primary, fontSize: fonts.sm, fontWeight: fonts.semibold },
    // Guide
    ...
    categoryIconText: { color: '#fff', fontSize: fonts.md, fontWeight: fonts.bold },
    categoryName: { color: t.text.primary, fontSize: fonts.md, fontWeight: fonts.bold, flex: 1 },
    categoryExpand: { color: t.text.muted, fontSize: fonts.lg },
    categoryItems: { marginTop: 12, paddingTop: 12, borderTopColor: t.bg.primary, borderTopWidth: 1 },
    categoryItem: { color: t.text.primary, fontSize: fonts.sm, marginBottom: 4, paddingLeft: 8 },
    categoryTip: { color: t.accent.blue, fontSize: fonts.sm, marginTop: 8, fontStyle: 'italic', lineHeight: 18 },
    // Compost
    compostCard: { backgroundColor: t.bg.secondary, borderRadius: 14, padding: 16, marginHorizontal: 20, marginBottom: 12 },
    compostName: { color: t.text.primary, fontSize: fonts.md, fontWeight: fonts.bold },
    compostLocation: { color: t.text.muted, fontSize: fonts.sm, marginTop: 2 },
    compostMeta: { color: t.text.muted, fontSize: fonts.sm, marginTop: 6 },
    capacityBar: { height: 8, borderRadius: 4, backgroundColor: t.bg.primary, marginTop: 10 },
    capacityFill: { height: 8, borderRadius: 4 },
    capacityText: { color: t.text.muted, fontSize: fonts.xs, marginTop: 4 },
    acceptsTags: { flexDirection: 'row', gap: 8, marginTop: 8 },
    acceptTag: { paddingHorizontal: 10, paddingVertical: 4, borderRadius: 8 },
    acceptTagText: { fontSize: fonts.xs, fontWeight: fonts.semibold },
    // Upcycle
    upcycleCard: { backgroundColor: t.bg.secondary, borderRadius: 14, padding: 16, marginHorizontal: 20, marginBottom: 12 },
    upcycleTitle: { color: t.text.primary, fontSize: fonts.md, fontWeight: fonts.bold },
    upcycleDesc: { color: t.text.muted, fontSize: fonts.sm, marginTop: 4, lineHeight: 18 },
    upcycleMeta: { color: t.text.muted, fontSize: fonts.sm, marginTop: 6 },
    ...
    conditionText: { fontSize: fonts.sm, fontWeight: fonts.semibold },
  ...
  const renderCompost = () => (
    <>
      ...
      <View style={s.card}>
        <Text style={[s.compostMeta, { color: t.text.primary, fontSize: fonts.sm, lineHeight: 20, marginBottom: 0 }]}>
