...
export function WasteManagementScreen({ onClose }: Props) {
  ...
  const s = useMemo(() => StyleSheet.create({
    ...
    breakdownValue: { color: t.text.primary, fontSize: 20, fontWeight: '800' },
    ...
    communityTitle: { color: t.text.primary, fontSize: 15, fontWeight: '700', marginBottom: 12 },
    ...
    categoryIconText: { color: '#fff', fontSize: 14, fontWeight: '700' },
    ...
    compostName: { color: t.text.primary, fontSize: 15, fontWeight: '700' },
