...
export function TextileScreen({ onClose }: Props) {
  ...
  const s = useMemo(() => StyleSheet.create({
    ...
    circleName: { color: t.text.primary, fontSize: 16, fontWeight: '700' },
    ...
    craftBadgeText: { color: '#fff', fontSize: 11, fontWeight: '700', textTransform: 'uppercase' },
    detailRow: { flexDirection: 'row', justifyContent: 'space-between', paddingVertical: 5 },
    detailLabel: { color: t.text.muted, fontSize: 13 },
    detailValue: { color: t.text.primary, fontSize: 13, fontWeight: '600' },
    projectBanner: { backgroundColor: t.accent.green + '10', borderRadius: 12, padding: 12, marginTop: 12 },
    projectLabel: { color: t.accent.green, fontSize: 11, fontWeight: '700', textTransform: 'uppercase', letterSpacing: 1 },
    projectText: { color: t.text.primary, fontSize: 13, fontWeight: '600', marginTop: 4 },
    ...
    patternName: { color: t.text.primary, fontSize: 15, fontWeight: '700' },
    ...
    downloadBtnText: { color: '#AF52DE', fontSize: 13, fontWeight: '700' },
    ...
    secondaryBtnText: { color: '#AF52DE', fontSize: 16, fontWeight: '700' },
    ...
    exchangeIconText: { color: '#FF2D55', fontSize: 16, fontWeight: '800' },
    exchangeInfo: { flex: 1 },
    exchangeName: { color: t.text.primary, fontSize: 15, fontWeight: '700' },
    ...
    condBadgeText: { color: t.accent.green, fontSize: 10, fontWeight: '700' },
