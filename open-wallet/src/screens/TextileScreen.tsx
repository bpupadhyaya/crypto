...
export function TextileScreen({ onClose }: Props) {
  ...
  const s = useMemo(() => StyleSheet.create({
    ...
    circleName: { color: t.text.primary, fontSize: 16, fontWeight: fonts.bold },
    circleMeta: { color: t.text.muted, fontSize: 13, marginTop: 2 },
    craftBadge: { paddingHorizontal: 10, paddingVertical: 4, borderRadius: 10, alignSelf: 'flex-start', marginTop: 8 },
    craftBadgeText: { color: '#fff', fontSize: 11, fontWeight: fonts.bold, textTransform: 'uppercase' },
    ...
    projectLabel: { color: t.accent.green, fontSize: 11, fontWeight: fonts.bold, textTransform: 'uppercase', letterSpacing: 1 },
    projectText: { color: t.text.primary, fontSize: 13, fontWeight: fonts.semibold, marginTop: 4 },
    ...
    patternName: { color: t.text.primary, fontSize: 15, fontWeight: fonts.bold },
    patternMeta: { color: t.text.muted, fontSize: 12, marginTop: 3 },
    diffBadge: { paddingHorizontal: 8, paddingVertical: 3, borderRadius: 8, alignSelf: 'flex-start', marginTop: 6 },
    diffBadgeText: { fontSize: 10, fontWeight: fonts.bold, textTransform: 'uppercase' },
    ...
    downloadBtnText: { color: '#AF52DE', fontSize: 13, fontWeight: fonts.bold },
    ...
    secondaryBtnText: { color: '#AF52DE', fontSize: 16, fontWeight: fonts.bold },
    ...
    exchangeIconText: { color: '#FF2D55', fontSize: 16, fontWeight: fonts.heavy },
    exchangeInfo: { flex: 1 },
    exchangeName: { color: t.text.primary, fontSize: 15, fontWeight: fonts.bold },
    ...
    condBadgeText: { color: t.accent.green, fontSize: 10, fontWeight: fonts.bold },
    ...
    claimBtnText: { color: '#FF2D55', fontSize: 12, fontWeight: fonts.bold },
    demoTag: { backgroundColor: '#AF52DE' + '20', paddingHorizontal: 10, paddingVertical: 4, borderRadius: 8, alignSelf: 'center', marginBottom: 12 },
    demoTagText: { color: '#AF52DE', fontSize: 11, fontWeight: fonts.bold },
    quiltCard: { backgroundColor: '#FF9500' + '08', borderRadius: 16, padding: 20, marginHorizontal: 20, marginBottom: 16 },
    quiltTitle: { color: t.text.primary, fontSize: 16, fontWeight: fonts.bold },
    quiltDesc: { color: t.text.muted, fontSize: 13, marginTop: 4, lineHeight: 20 },
