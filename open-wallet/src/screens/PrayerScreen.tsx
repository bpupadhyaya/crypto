...
export function PrayerScreen({ onClose }: Props) {
  ...
  const s = useMemo(() => StyleSheet.create({
    ...
    observanceIconText: { color: '#fff', fontSize: 16, fontWeight: '800' },
    observanceInfo: { flex: 1 },
    observanceName: { color: t.text.primary, fontSize: 15, fontWeight: '700' },
    observanceTradition: { fontSize: 12, fontWeight: '600', marginTop: 2 },
    ...
    spaceIconText: { color: '#fff', fontSize: 13, fontWeight: '800' },
    spaceName: { color: t.text.primary, fontSize: 15, fontWeight: '700', flex: 1 },
    spaceType: { fontSize: 12, fontWeight: '600' },
    ...
    dialogueTitle: { color: t.text.primary, fontSize: 15, fontWeight: '700' },
    ...
    traditionTagText: { color: '#fff', fontSize: 11, fontWeight: '700' },
    ...
    prayerIntention: { color: t.text.primary, fontSize: 14, fontWeight: '600', lineHeight: 20 },
    ...
    supportBtnText: { color: t.accent.purple, fontSize: 13, fontWeight: '700' },
    ...
    addPrayerBtnText: { color: '#fff', fontSize: 16, fontWeight: '700' },
    // Leaders
    ...
    leaderIconText: { color: '#fff', fontSize: 14, fontWeight: '800' },
    leaderInfo: { flex: 1 },
