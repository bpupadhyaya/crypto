...
export function PrayerScreen({ onClose }: Props) {
  ...
  const s = useMemo(() => StyleSheet.create({
    ...
    observanceIconText: { color: '#fff', fontSize: fonts.lg, fontWeight: fonts.heavy },
    observanceInfo: { flex: 1 },
    observanceName: { color: t.text.primary, fontSize: fonts.md, fontWeight: fonts.bold },
    observanceTradition: { fontSize: fonts.sm, fontWeight: fonts.semibold, marginTop: 2 },
    observanceDate: { color: t.text.muted, fontSize: fonts.sm, marginTop: 2 },
    observanceDesc: { color: t.text.secondary, fontSize: fonts.sm, marginTop: 4, lineHeight: 18 },
    // Spaces
    ...
    spaceIconText: { color: '#fff', fontSize: fonts.sm, fontWeight: fonts.heavy },
    spaceName: { color: t.text.primary, fontSize: fonts.md, fontWeight: fonts.bold, flex: 1 },
    spaceType: { fontSize: fonts.sm, fontWeight: fonts.semibold },
    spaceDetail: { color: t.text.muted, fontSize: fonts.sm, marginTop: 2 },
    // Dialogue
    dialogueCard: { backgroundColor: t.bg.secondary, borderRadius: 16, padding: 16, marginHorizontal: 20, marginBottom: 12 },
    dialogueTitle: { color: t.text.primary, fontSize: fonts.md, fontWeight: fonts.bold },
    dialogueMeta: { color: t.text.muted, fontSize: fonts.sm, marginTop: 4 },
    dialogueDesc: { color: t.text.secondary, fontSize: fonts.sm, marginTop: 6, lineHeight: 18 },
    ...
    supportBtnText: { color: t.accent.purple, fontSize: fonts.sm, fontWeight: fonts.bold },
    ...
    addPrayerBtnText: { color: '#fff', fontSize: fonts.lg, fontWeight: fonts.bold },
    // Leaders
    ...
    leaderIconText: { color: '#fff', fontSize: fonts.md, fontWeight: fonts.heavy },
    leaderInfo: { flex: 1 },
    leaderName: { color: t.text.primary, fontSize: fonts.md, fontWeight: fonts.bold },
    leaderTitle: { color: t.text.muted, fontSize: fonts.sm, marginTop: 2 },
    leaderCommunity: { color: t.text.secondary, fontSize: fonts.sm },
