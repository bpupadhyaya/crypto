...
export function DelegateScreen({ onClose }: Props) {
  ...
  const s = useMemo(() => StyleSheet.create({
    ...
    powerValue: { color: t.accent.purple, fontSize: 42, fontWeight: '900', textAlign: 'center' },
    ...
    activeName: { color: t.text.primary, fontSize: 16, fontWeight: '700', marginTop: 4 },
    ...
    histStatus: { fontSize: 12, fontWeight: '700', paddingHorizontal: 10, paddingVertical: 4, borderRadius: 8, overflow: 'hidden' },
