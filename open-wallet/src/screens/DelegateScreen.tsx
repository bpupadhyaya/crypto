...
export function DelegateScreen({ onClose }: Props) {
  ...
  const s = useMemo(() => StyleSheet.create({
    ...
    powerLabel: { color: t.text.muted, fontSize: 13, textAlign: 'center', marginTop: 4, textTransform: 'uppercase', letterSpacing: 1 },
    activeBox: { backgroundColor: t.accent.green + '12', borderRadius: 12, padding: 16, marginTop: 16 },
    activeLabel: { color: t.text.muted, fontSize: 12 },
    activeName: { color: t.text.primary, fontSize: 16, fontWeight: fonts.bold, marginTop: 4 },
    activeMeta: { color: t.text.muted, fontSize: 12, marginTop: 4 },
    revokeBtn: { backgroundColor: t.accent.red + '20', borderRadius: 10, paddingVertical: 10, alignItems: 'center', marginTop: 12 },
    revokeText: { color: t.accent.red, fontSize: 14, fontWeight: fonts.bold },
    repRow: { flexDirection: 'row', alignItems: 'center', paddingVertical: 14, borderBottomColor: t.bg.primary, borderBottomWidth: 1 },
    repInfo: { flex: 1 },
    repName: { color: t.text.primary, fontSize: 15, fontWeight: fonts.bold },
    repMeta: { color: t.text.muted, fontSize: 12, marginTop: 2 },
    repAlign: { fontSize: 13, fontWeight: fonts.bold, marginRight: 12 },
    delegateBtn: { backgroundColor: t.accent.purple, paddingHorizontal: 14, paddingVertical: 8, borderRadius: 10 },
    delegateBtnText: { color: '#fff', fontSize: 13, fontWeight: fonts.semibold },
    histRow: { flexDirection: 'row', alignItems: 'center', paddingVertical: 12, borderBottomColor: t.bg.primary, borderBottomWidth: 1 },
    histInfo: { flex: 1 },
    histName: { color: t.text.primary, fontSize: 14, fontWeight: fonts.semibold },
    histMeta: { color: t.text.muted, fontSize: 12, marginTop: 2 },
    histStatus: { fontSize: 12, fontWeight: fonts.bold, paddingHorizontal: 10, paddingVertical: 4, borderRadius: 8, overflow: 'hidden' },
