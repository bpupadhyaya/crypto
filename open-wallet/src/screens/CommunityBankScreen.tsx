...
export function CommunityBankScreen({ onClose }: Props) {
  ...
  const s = useMemo(() => StyleSheet.create({
    ...
    summaryValue: { color: t.text.primary, fontSize: 18, fontWeight: fonts.heavy },
    ...
    accountName: { color: t.text.primary, fontSize: 15, fontWeight: fonts.bold },
    accountType: { paddingHorizontal: 8, paddingVertical: 3, borderRadius: 6, backgroundColor: t.accent.blue + '20' },
    accountTypeText: { color: t.accent.blue, fontSize: 10, fontWeight: fonts.bold },
    accountBalance: { color: t.text.primary, fontSize: 24, fontWeight: fonts.heavy, marginTop: 8 },
    accountMeta: { color: t.text.muted, fontSize: 12, marginTop: 4 },
    accountInterest: { color: t.accent.green, fontSize: 13, fontWeight: fonts.bold, marginTop: 4 },
    ...
    loanBorrower: { color: t.text.primary, fontSize: 15, fontWeight: fonts.bold },
    loanStatus: { paddingHorizontal: 10, paddingVertical: 3, borderRadius: 8 },
    loanStatusText: { color: '#fff', fontSize: 11, fontWeight: fonts.bold },
    loanPurpose: { color: t.text.muted, fontSize: 13, marginTop: 6 },
    loanStats: { flexDirection: 'row', justifyContent: 'space-between', marginTop: 10 },
    loanStat: { alignItems: 'center' },
    loanStatVal: { color: t.text.primary, fontSize: 14, fontWeight: fonts.heavy },
    loanStatLabel: { color: t.text.muted, fontSize: 10, marginTop: 2 },
    ...
    poolName: { color: t.text.primary, fontSize: 16, fontWeight: fonts.bold },
    poolDesc: { color: t.text.muted, fontSize: 13, marginTop: 6, lineHeight: 20 },
    poolStats: { flexDirection: 'row', justifyContent: 'space-between', marginTop: 12 },
    poolStat: { alignItems: 'center' },
    poolStatVal: { color: t.text.primary, fontSize: 16, fontWeight: fonts.heavy },
    poolStatLabel: { color: t.text.muted, fontSize: 10, marginTop: 2 },
    poolFooter: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', marginTop: 12 },
    poolRisk: { fontSize: 12, fontWeight: fonts.bold },
    poolBtn: { backgroundColor: t.accent.blue, paddingHorizontal: 16, paddingVertical: 8, borderRadius: 10 },
    poolBtnText: { color: '#fff', fontSize: 13, fontWeight: fonts.semibold },
