...
export function CommunityBankScreen({ onClose }: Props) {
  ...
  const s = useMemo(() => StyleSheet.create({
    ...
    summaryValue: { color: t.text.primary, fontSize: 18, fontWeight: '800' },
    ...
    accountName: { color: t.text.primary, fontSize: 15, fontWeight: '700' },
    accountType: { paddingHorizontal: 8, paddingVertical: 3, borderRadius: 6, backgroundColor: t.accent.blue + '20' },
    accountTypeText: { color: t.accent.blue, fontSize: 10, fontWeight: '700' },
    accountBalance: { color: t.text.primary, fontSize: 24, fontWeight: '900', marginTop: 8 },
    accountMeta: { color: t.text.muted, fontSize: 12, marginTop: 4 },
    accountInterest: { color: t.accent.green, fontSize: 13, fontWeight: '700', marginTop: 4 },
    ...
    loanBorrower: { color: t.text.primary, fontSize: 15, fontWeight: '700' },
    loanStatus: { paddingHorizontal: 10, paddingVertical: 3, borderRadius: 8 },
    loanStatusText: { color: '#fff', fontSize: 11, fontWeight: '700' },
    ...
    loanStatVal: { color: t.text.primary, fontSize: 14, fontWeight: '800' },
    ...
    poolName: { color: t.text.primary, fontSize: 16, fontWeight: '700' },
    ...
    poolStatVal: { color: t.text.primary, fontSize: 16, fontWeight: '800' },
