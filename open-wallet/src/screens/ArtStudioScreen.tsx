...
export function ArtStudioScreen({ onClose }: Props) {
  ...
  const s = useMemo(() => StyleSheet.create({
    ...
    tabLabel: { color: t.text.secondary, fontSize: fonts.sm, fontWeight: fonts.bold },
    ...
    cardDesc: { color: t.text.muted, fontSize: fonts.sm, marginTop: 8, lineHeight: 20 },
    cardRow: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', marginTop: 10 },
    statText: { color: t.text.secondary, fontSize: fonts.sm },
    statValue: { color: t.accent.purple, fontSize: fonts.sm, fontWeight: fonts.bold },
    ...
    hashText: { color: t.text.muted, fontSize: fonts.xs, fontFamily: 'Courier', marginTop: 6 },
    ...
    mediumLabel: { color: t.text.secondary, fontSize: fonts.xs, fontWeight: fonts.semibold },
    ...
    featuredBadgeText: { color: '#fff', fontSize: fonts.xs, fontWeight: fonts.heavy, textTransform: 'uppercase', letterSpacing: 1 },
    featuredName: { color: t.text.primary, fontSize: fonts.xl, fontWeight: fonts.heavy },
    featuredSpecialty: { color: t.accent.purple, fontSize: fonts.sm, fontWeight: fonts.semibold, marginTop: 2 },
    featuredBio: { color: t.text.muted, fontSize: fonts.sm, lineHeight: 20, marginTop: 10 },
    featuredStats: { flexDirection: 'row', gap: 16, marginTop: 14 },
    featuredStat: { alignItems: 'center' },
    featuredStatNum: { color: t.text.primary, fontSize: fonts.lg, fontWeight: fonts.heavy },
    ...
    statusOpen: { color: t.accent.green, fontWeight: fonts.bold, fontSize: fonts.sm },
