...
export function ArtStudioScreen({ onClose }: Props) {
  ...
  const s = useMemo(() => StyleSheet.create({
    ...
    tabLabel: { color: t.text.secondary, fontSize: 12, fontWeight: fonts.bold },
    ...
    statValue: { color: t.accent.purple, fontSize: 13, fontWeight: fonts.bold },
    ...
    appreciateBtnText: { color: '#fff', fontSize: 12, fontWeight: fonts.bold },
    ...
    mediumLabel: { color: t.text.secondary, fontSize: 11, fontWeight: fonts.semibold },
    ...
    featuredBadgeText: { color: '#fff', fontSize: 11, fontWeight: fonts.heavy, textTransform: 'uppercase', letterSpacing: 1 },
    featuredName: { color: t.text.primary, fontSize: 18, fontWeight: fonts.heavy },
    featuredSpecialty: { color: t.accent.purple, fontSize: 13, fontWeight: fonts.semibold, marginTop: 2 },
    ...
    featuredStatNum: { color: t.text.primary, fontSize: 16, fontWeight: fonts.heavy },
    ...
    statusOpen: { color: t.accent.green, fontWeight: fonts.bold, fontSize: 12 },
    ...
    joinBtnText: { color: '#fff', fontSize: 12, fontWeight: fonts.bold },
  }), [t]);
