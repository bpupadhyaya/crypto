...
export function CommunityKitchenScreen({ onClose }: Props) {
  ...
  const s = useMemo(() => StyleSheet.create({
    ...
    slotTitle: { color: t.text.primary, fontSize: 15, fontWeight: fonts.bold },
    slotMeta: { color: t.text.muted, fontSize: 12, marginTop: 4 },
    slotCapacity: { color: t.text.muted, fontSize: 12, marginTop: 4 },
    ...
    fullText: { color: '#fff', fontSize: 12, fontWeight: fonts.semibold },
    shiftCard: { backgroundColor: t.bg.secondary, borderRadius: 14, padding: 16, marginHorizontal: 20, marginBottom: 12 },
    shiftRole: { color: t.text.primary, fontSize: 15, fontWeight: fonts.bold },
    shiftMeta: { color: t.text.muted, fontSize: 12, marginTop: 4 },
    shiftReward: { color: t.accent.green, fontSize: 14, fontWeight: fonts.bold, marginTop: 6 },
    ...
    volBtnText: { color: '#fff', fontSize: 13, fontWeight: fonts.semibold },
    mealCard: { backgroundColor: t.bg.secondary, borderRadius: 14, padding: 16, marginHorizontal: 20, marginBottom: 12 },
    mealName: { color: t.text.primary, fontSize: 15, fontWeight: fonts.bold },
    mealMeta: { color: t.text.muted, fontSize: 12, marginTop: 4 },
    ...
    mealStatVal: { color: t.text.primary, fontSize: 16, fontWeight: fonts.heavy },
    mealStatLabel: { color: t.text.muted, fontSize: 10, marginTop: 2 },
