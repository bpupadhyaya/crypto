...
export function CommunityKitchenScreen({ onClose }: Props) {
  ...
  const s = useMemo(() => StyleSheet.create({
    ...
    slotTitle: { color: t.text.primary, fontSize: 15, fontWeight: '700' },
    ...
    fullText: { color: '#fff', fontSize: 12, fontWeight: '600' },
    shiftCard: { backgroundColor: t.bg.secondary, borderRadius: 14, padding: 16, marginHorizontal: 20, marginBottom: 12 },
    shiftRole: { color: t.text.primary, fontSize: 15, fontWeight: '700' },
    shiftMeta: { color: t.text.muted, fontSize: 12, marginTop: 4 },
    shiftReward: { color: t.accent.green, fontSize: 14, fontWeight: '700', marginTop: 6 },
    ...
    volBtnText: { color: '#fff', fontSize: 13, fontWeight: '600' },
    mealCard: { backgroundColor: t.bg.secondary, borderRadius: 14, padding: 16, marginHorizontal: 20, marginBottom: 12 },
    mealName: { color: t.text.primary, fontSize: 15, fontWeight: '700' },
    ...
    mealStatVal: { color: t.text.primary, fontSize: 16, fontWeight: '800' },
