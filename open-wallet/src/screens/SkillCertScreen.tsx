...
export function SkillCertScreen({ onClose }: Props) {
  ...
  const s = useMemo(() => StyleSheet.create({
    ...
    certBadge: { fontSize: fonts.hero, marginBottom: 8 },
    certSkill: { color: t.text.primary, fontSize: fonts.md, fontWeight: fonts.bold },
    certLevel: { fontSize: fonts.sm, fontWeight: fonts.bold, marginTop: 4 },
    certVerified: { color: t.text.muted, fontSize: fonts.xs, marginTop: 4 },
    certDate: { color: t.text.muted, fontSize: fonts.xs, marginTop: 2 },
    ...
    badgeLabel: { color: t.text.secondary, fontSize: fonts.xs, textAlign: 'center' },
    // Request tab
    ...
    catChipText: { color: t.text.secondary, fontSize: fonts.sm },
    catChipTextActive: { color: t.accent.purple, fontWeight: fonts.semibold },
    ...
    skillChipText: { color: t.text.secondary, fontSize: fonts.sm },
    skillChipTextActive: { color: t.accent.blue, fontWeight: fonts.semibold },
    ...
    levelChipText: { fontSize: fonts.sm, fontWeight: fonts.semibold },
    input: { backgroundColor: t.bg.card, borderRadius: 12, padding: 14, color: t.text.primary, fontSize: fonts.md, borderWidth: 1, borderColor: t.border, marginBottom: 12, height: 80, textAlignVertical: 'top' },
