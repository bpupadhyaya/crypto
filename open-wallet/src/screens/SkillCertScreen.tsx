...
export function SkillCertScreen({ onClose }: Props) {
  ...
  const s = useMemo(() => StyleSheet.create({
    ...
    certSkill: { color: t.text.primary, fontSize: 15, fontWeight: fonts.bold },
    certLevel: { fontSize: 12, fontWeight: fonts.bold, marginTop: 4 },
    ...
    levelChipText: { fontSize: 12, fontWeight: fonts.semibold },
