...
export function RegionalDashboardScreen({ onClose }: Props) {
  ...
  const s = useMemo(() => StyleSheet.create({
    ...
    regionName: { color: t.accent.blue, fontSize: fonts.md, fontWeight: fonts.bold, textAlign: 'center', marginBottom: 16 },
    ...
    metricLabel: { color: t.text.secondary, fontSize: fonts.md },
    metricRight: { flexDirection: 'row', alignItems: 'center' },
    metricValue: { color: t.text.primary, fontSize: fonts.lg, fontWeight: fonts.heavy, marginRight: 8 },
    metricChange: { fontSize: fonts.sm, fontWeight: fonts.semibold },
    ...
    channelInfo: { flex: 1 },
    channelName: { color: t.text.primary, fontSize: fonts.md, fontWeight: fonts.bold },
    channelMeta: { color: t.text.muted, fontSize: fonts.sm, marginTop: 2 },
    channelOtk: { color: t.accent.green, fontSize: fonts.md, fontWeight: fonts.heavy },
    ...
    rankName: { color: t.text.primary, fontSize: fonts.md, fontWeight: fonts.semibold },
    rankMeta: { color: t.text.muted, fontSize: fonts.sm, marginTop: 2 },
    rankScore: { color: t.accent.blue, fontSize: fonts.xl, fontWeight: fonts.heavy },
