...
export function CrossChainBridgeScreen({ onClose }: Props) {
  ...
  const s = useMemo(() => StyleSheet.create({
    ...
    arrow: { color: t.accent.green, fontSize: 24, fontWeight: fonts.heavy },
    // Provider cards
    ...
    providerName: { color: t.text.primary, fontSize: 15, fontWeight: fonts.bold },
    ...
    metaValue: { color: t.text.secondary, fontSize: 14, fontWeight: fonts.semibold },
    ...
    bridgeBtnText: { color: '#fff', fontSize: 16, fontWeight: fonts.heavy },
    ...
    statusRoute: { color: t.text.primary, fontSize: 15, fontWeight: fonts.bold },
    statusAmount: { color: t.accent.green, fontSize: 15, fontWeight: fonts.heavy },
    ...
    historyRoute: { color: t.text.primary, fontSize: 14, fontWeight: fonts.bold },
    historyAmount: { color: t.accent.green, fontSize: 14, fontWeight: fonts.bold },
    ...
    historyValue: { color: t.text.secondary, fontSize: 12, fontWeight: fonts.semibold },
    ...
    completeBadgeText: { color: t.accent.green, fontSize: 11, fontWeight: fonts.bold },
    // Compare tab
    ...
    compareValue: { color: t.text.primary, fontSize: 14, fontWeight: fonts.bold },
