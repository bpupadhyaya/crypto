...
export function CrossChainBridgeScreen({ onClose }: Props) {
  ...
  const s = useMemo(() => StyleSheet.create({
    ...
    arrow: { color: t.accent.green, fontSize: 24, fontWeight: '800' },
    // Provider cards
    ...
    providerName: { color: t.text.primary, fontSize: 15, fontWeight: '700' },
    providerMeta: { flexDirection: 'row', gap: 16, marginTop: 10, flexWrap: 'wrap' },
    metaItem: { gap: 2 },
    metaLabel: { color: t.text.muted, fontSize: 11, textTransform: 'uppercase', letterSpacing: 0.5 },
    metaValue: { color: t.text.secondary, fontSize: 14, fontWeight: '600' },
    ...
    bridgeBtnText: { color: '#fff', fontSize: 16, fontWeight: '800' },
    ...
    statusRoute: { color: t.text.primary, fontSize: 15, fontWeight: '700' },
    statusAmount: { color: t.accent.green, fontSize: 15, fontWeight: '800' },
    statusLabel: { color: t.text.muted, fontSize: 12, marginBottom: 6 },
    ...
    statusMetaText: { color: t.text.muted, fontSize: 12 },
    // History cards
    ...
    historyRoute: { color: t.text.primary, fontSize: 14, fontWeight: '700' },
    historyAmount: { color: t.accent.green, fontSize: 14, fontWeight: '700' },
    historyDate: { color: t.text.muted, fontSize: 12, marginBottom: 4 },
    historyRow: { flexDirection: 'row', justifyContent: 'space-between', marginTop: 4 },
    historyLabel: { color: t.text.muted, fontSize: 11 },
    historyValue: { color: t.text.secondary, fontSize: 12, fontWeight: '600' },
    hashText: { color: t.accent.blue, fontSize: 12, fontWeight: '500' },
    completeBadge: { backgroundColor: t.accent.green + '20', paddingHorizontal: 8, paddingVertical: 2, borderRadius: 8 },
    completeBadgeText: { color: t.accent.green, fontSize: 11, fontWeight: '700' },
    // Compare tab
    compareHeader: { flexDirection: 'row', backgroundColor: t.bg.card, borderRadius: 12, padding: 12, marginBottom: 8, gap: 8 },
    compareCol: { flex: 1, alignItems: 'center' },
    compareLabel: { color: t.text.muted, fontSize: 11, textTransform: 'uppercase', letterSpacing: 0.5, marginBottom: 4 },
    compareValue: { color: t.text.primary, fontSize: 14, fontWeight: '700' },
    compareBest: { color: t.accent.green, fontWeight: '800' },
    emptyText: { color: t.text.muted, fontSize: 14, textAlign: 'center', marginTop: 40 },
    demoTag: { color: t.accent.orange || '#f0a030', fontSize: 11, fontWeight: '700', textAlign: 'center', marginBottom: 8 },
  }), [t]);
