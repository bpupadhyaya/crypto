...
export function FreelanceScreen({ onClose }: Props) {
  ...
  const s = useMemo(() => StyleSheet.create({
    ...
    invoiceClient: { color: t.text.primary, fontSize: 15, fontWeight: '700' },
    invoiceStatus: { paddingHorizontal: 10, paddingVertical: 3, borderRadius: 8 },
    invoiceStatusText: { fontSize: 11, fontWeight: '700', color: '#fff' },
    invoiceDesc: { color: t.text.muted, fontSize: 13, marginTop: 4 },
    invoiceAmount: { color: t.accent.green, fontSize: 16, fontWeight: '800', marginTop: 6 },
    ...
    timeInfo: { flex: 1 },
    timeName: { color: t.text.primary, fontSize: 14, fontWeight: '600' },
    timeMeta: { color: t.text.muted, fontSize: 12, marginTop: 2 },
    timeHours: { color: t.accent.blue, fontSize: 16, fontWeight: '800' },
    clientCard: { backgroundColor: t.bg.secondary, borderRadius: 14, padding: 16, marginHorizontal: 20, marginBottom: 12 },
    clientName: { color: t.text.primary, fontSize: 16, fontWeight: '700' },
    ...
    clientStatValue: { color: t.text.primary, fontSize: 16, fontWeight: '800' },
