...
export function FreelanceScreen({ onClose }: Props) {
  ...
  const s = useMemo(() => StyleSheet.create({
    ...
    invoiceClient: { color: t.text.primary, fontSize: 15, fontWeight: fonts.bold },
    invoiceStatus: { paddingHorizontal: 10, paddingVertical: 3, borderRadius: 8 },
    invoiceStatusText: { fontSize: 11, fontWeight: fonts.bold, color: '#fff' },
    invoiceDesc: { color: t.text.muted, fontSize: 13, marginTop: 4 },
    invoiceAmount: { color: t.accent.green, fontSize: 16, fontWeight: fonts.heavy, marginTop: 6 },
    invoiceMeta: { color: t.text.muted, fontSize: 11, marginTop: 2 },
    ...
    timeInfo: { flex: 1 },
    timeName: { color: t.text.primary, fontSize: 14, fontWeight: fonts.semibold },
    timeMeta: { color: t.text.muted, fontSize: 12, marginTop: 2 },
    timeHours: { color: t.accent.blue, fontSize: 16, fontWeight: fonts.heavy },
    clientCard: { backgroundColor: t.bg.secondary, borderRadius: 14, padding: 16, marginHorizontal: 20, marginBottom: 12 },
    clientName: { color: t.text.primary, fontSize: 16, fontWeight: fonts.bold },
    clientMeta: { color: t.text.muted, fontSize: 12, marginTop: 4 },
    clientStats: { flexDirection: 'row', justifyContent: 'space-between', marginTop: 12 },
    clientStatValue: { color: t.text.primary, fontSize: 16, fontWeight: fonts.heavy },
    clientStatLabel: { color: t.text.muted, fontSize: 10, marginTop: 2 },
