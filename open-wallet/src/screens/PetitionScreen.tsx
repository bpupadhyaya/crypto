...
export function PetitionScreen({ onClose }: Props) {
  ...
  const s = useMemo(() => StyleSheet.create({
    ...
    petTitle: { color: t.text.primary, fontSize: fonts.md, fontWeight: fonts.bold },
    petMeta: { flexDirection: 'row', justifyContent: 'space-between', marginTop: 8 },
    petMetaText: { color: t.text.muted, fontSize: fonts.sm },
    progressBar: { height: 8, backgroundColor: t.border, borderRadius: 4, marginTop: 12 },
    progressFill: { height: 8, borderRadius: 4 },
    sigCount: { color: t.text.secondary, fontSize: fonts.sm, fontWeight: fonts.semibold, marginTop: 6 },
    ...
    milestoneDotText: { fontSize: fonts.xs, fontWeight: fonts.bold, color: '#fff' },
    ...
    signBtnText: { color: '#fff', fontSize: fonts.md, fontWeight: fonts.bold },
    targetLabel: { color: t.text.muted, fontSize: fonts.sm, marginTop: 4 },
    deadlineLabel: { color: t.text.muted, fontSize: fonts.xs, marginTop: 2 },
    outcomeCard: { backgroundColor: '#4caf50' + '15', borderRadius: 12, padding: 14, marginTop: 12 },
    outcomeTitle: { color: '#4caf50', fontSize: fonts.sm, fontWeight: fonts.bold },
    outcomeText: { color: t.text.secondary, fontSize: fonts.sm, lineHeight: 20, marginTop: 4 },
    ...
    signedBadge: { color: '#4caf50', fontSize: fonts.sm, fontWeight: fonts.bold, marginTop: 4 },
  }), [t]);
