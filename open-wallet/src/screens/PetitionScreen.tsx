...
export function PetitionScreen({ onClose }: Props) {
  ...
  const s = useMemo(() => StyleSheet.create({
    ...
    petTitle: { color: t.text.primary, fontSize: 15, fontWeight: fonts.bold },
    ...
    sigCount: { color: t.text.secondary, fontSize: 13, fontWeight: fonts.semibold, marginTop: 6 },
    ...
    milestoneDotText: { fontSize: 10, fontWeight: fonts.bold, color: '#fff' },
    ...
    signBtnText: { color: '#fff', fontSize: 14, fontWeight: fonts.bold },
    ...
    outcomeTitle: { color: '#4caf50', fontSize: 13, fontWeight: fonts.bold },
    ...
    signedBadge: { color: '#4caf50', fontSize: 12, fontWeight: fonts.bold, marginTop: 4 },
  }), [t]);
