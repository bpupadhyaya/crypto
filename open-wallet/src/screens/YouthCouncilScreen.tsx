...
export function YouthCouncilScreen({ onClose }: Props) {
  ...
  const s = useMemo(() => StyleSheet.create({
    ...
    statValue: { color: t.accent.purple, fontSize: fonts.xxl, fontWeight: fonts.heavy },
    ...
    memberName: { color: t.text.primary, fontSize: fonts.lg, fontWeight: fonts.bold },
    memberRole: { color: t.accent.purple, fontSize: fonts.sm, fontWeight: fonts.semibold, marginTop: 2 },
    memberMeta: { color: t.text.muted, fontSize: fonts.sm, marginTop: 4 },
    ...
    badgePillText: { color: t.accent.green, fontSize: fonts.xs, fontWeight: fonts.semibold },
    proposalTitle: { color: t.text.primary, fontSize: fonts.md, fontWeight: fonts.bold },
    proposalAuthor: { color: t.text.muted, fontSize: fonts.sm, marginTop: 2 },
    ...
    proposalDesc: { color: t.text.secondary, fontSize: fonts.sm, lineHeight: 20, marginTop: 10 },
    ...
    voteLegendText: { color: t.text.muted, fontSize: fonts.xs },
    ...
    rewardText: { color: t.accent.green, fontSize: fonts.sm, fontWeight: fonts.semibold, marginTop: 8 },
    discussBtn: { backgroundColor: t.accent.blue + '15', borderRadius: 10, paddingVertical: 10, alignItems: 'center', marginTop: 10 },
    discussBtnText: { color: t.accent.blue, fontSize: fonts.sm, fontWeight: fonts.semibold },
    discussionCard: { backgroundColor: t.bg.primary, borderRadius: 12, padding: 12, marginTop: 8 },
    discussAuthor: { color: t.accent.purple, fontSize: fonts.sm, fontWeight: fonts.bold },
    discussAge: { color: t.text.muted, fontSize: fonts.xs },
    discussMessage: { color: t.text.primary, fontSize: fonts.sm, lineHeight: 19, marginTop: 4 },
    discussMeta: { flexDirection: 'row', justifyContent: 'space-between', marginTop: 6 },
    discussDate: { color: t.text.muted, fontSize: fonts.xs },
    discussLikes: { color: t.text.muted, fontSize: fonts.xs },
    ...
    newProposalBtnText: { color: '#fff', fontSize: fonts.md, fontWeight: fonts.bold },
    mentorNote: { backgroundColor: t.accent.orange + '10', borderRadius: 10, padding: 10, marginTop: 8 },
    mentorNoteText: { color: t.accent.orange, fontSize: fonts.sm, fontStyle: 'italic' },
    initiativeCard: { backgroundColor: t.bg.secondary, borderRadius: 16, padding: 16, marginHorizontal: 20, marginBottom: 12 },
    initiativeTitle: { color: t.text.primary, fontSize: fonts.md, fontWeight: fonts.bold },
    initiativeCategory: { color: t.accent.blue, fontSize: fonts.sm, fontWeight: fonts.semibold, marginTop: 2 },
    initiativeDesc: { color: t.text.secondary, fontSize: fonts.sm, lineHeight: 20, marginTop: 8 },
    ...
    initiativeStatVal: { color: t.accent.green, fontSize: fonts.lg, fontWeight: fonts.heavy },
    initiativeStatLabel: { color: t.text.muted, fontSize: fonts.xs, marginTop: 2 },
    initiativeMeta: { color: t.text.muted, fontSize: fonts.sm, marginTop: 8 },
    leadershipTitle: { color: t.text.primary, fontSize: fonts.lg, fontWeight: fonts.bold, marginBottom: 12, marginHorizontal: 20, marginTop: 20 },
    ...
    badgeIcon: { fontSize: fonts.xxl, marginBottom: 6 },
    badgeName: { color: t.text.primary, fontSize: fonts.sm, fontWeight: fonts.bold },
    badgeDescText: { color: t.text.muted, fontSize: fonts.xs, marginTop: 4 },
    badgeEarnedDate: { color: t.accent.green, fontSize: fonts.xs, fontWeight: fonts.semibold, marginTop: 4 },
    commentRow: { flexDirection: 'row', gap: 8, marginTop: 10 },
    commentInput: { flex: 1, backgroundColor: t.bg.primary, borderRadius: 12, padding: 10, color: t.text.primary, fontSize: fonts.sm },
    commentSendBtn: { backgroundColor: t.accent.blue, borderRadius: 12, paddingHorizontal: 16, justifyContent: 'center' },
    commentSendText: { color: '#fff', fontSize: fonts.sm, fontWeight: fonts.semibold },
  }), [t]);
