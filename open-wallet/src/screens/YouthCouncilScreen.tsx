...
export function YouthCouncilScreen({ onClose }: Props) {
  ...
  const s = useMemo(() => StyleSheet.create({
    ...
    statValue: { color: t.accent.purple, fontSize: 22, fontWeight: fonts.heavy },
    ...
    memberName: { color: t.text.primary, fontSize: 16, fontWeight: fonts.bold },
    memberRole: { color: t.accent.purple, fontSize: 13, fontWeight: fonts.semibold, marginTop: 2 },
    ...
    detailValue: { color: t.text.primary, fontSize: 12, fontWeight: fonts.semibold },
    badgeRow: { flexDirection: 'row', flexWrap: 'wrap', gap: 6, marginTop: 8 },
    badgePill: { backgroundColor: t.accent.green + '20', paddingHorizontal: 10, paddingVertical: 4, borderRadius: 10 },
    badgePillText: { color: t.accent.green, fontSize: 11, fontWeight: fonts.semibold },
    ...
    rewardText: { color: t.accent.green, fontSize: 12, fontWeight: fonts.semibold, marginTop: 8 },
    discussBtn: { backgroundColor: t.accent.blue + '15', borderRadius: 10, paddingVertical: 10, alignItems: 'center', marginTop: 10 },
    discussBtnText: { color: t.accent.blue, fontSize: 13, fontWeight: fonts.semibold },
    discussionCard: { backgroundColor: t.bg.primary, borderRadius: 12, padding: 12, marginTop: 8 },
    discussAuthor: { color: t.accent.purple, fontSize: 12, fontWeight: fonts.bold },
    ...
    newProposalBtnText: { color: '#fff', fontSize: 15, fontWeight: fonts.bold },
    ...
    initiativeTitle: { color: t.text.primary, fontSize: 15, fontWeight: fonts.bold },
    initiativeCategory: { color: t.accent.blue, fontSize: 12, fontWeight: fonts.semibold, marginTop: 2 },
    ...
    initiativeStatVal: { color: t.accent.green, fontSize: 16, fontWeight: fonts.heavy },
    initiativeStatLabel: { color: t.text.muted, fontSize: 11, marginTop: 2 },
    initiativeMeta: { color: t.text.muted, fontSize: 12, marginTop: 8 },
    leadershipTitle: { color: t.text.primary, fontSize: 16, fontWeight: fonts.bold, marginBottom: 12, marginHorizontal: 20, marginTop: 20 },
    ...
    badgeName: { color: t.text.primary, fontSize: 13, fontWeight: fonts.bold },
    badgeDescText: { color: t.text.muted, fontSize: 11, marginTop: 4 },
    badgeEarnedDate: { color: t.accent.green, fontSize: 10, fontWeight: fonts.semibold, marginTop: 4 },
    ...
    commentSendText: { color: '#fff', fontSize: 13, fontWeight: fonts.semibold },
  }), [t]);
