...
export function ChildDevelopmentScreen({ onClose }: Props) {
  ...
  const s = useMemo(() => StyleSheet.create({
    ...
    mileInfo: { flex: 1 },
    mileTitle: { color: t.text.primary, fontSize: 14, fontWeight: fonts.semibold },
    mileMeta: { color: t.text.muted, fontSize: 12, marginTop: 2 },
    mileRight: { alignItems: 'flex-end', justifyContent: 'center' },
    mileNotk: { color: t.accent.green, fontSize: 13, fontWeight: fonts.bold },
    milePending: { color: t.text.muted, fontSize: 11 },
    catBadge: { paddingHorizontal: 6, paddingVertical: 1, borderRadius: 6, alignSelf: 'flex-start', marginTop: 4 },
    catText: { color: '#fff', fontSize: 10, fontWeight: fonts.semibold, textTransform: 'uppercase' },
    actCard: { backgroundColor: t.bg.secondary, borderRadius: 14, padding: 16, marginHorizontal: 20, marginBottom: 12 },
    actTitle: { color: t.text.primary, fontSize: 15, fontWeight: fonts.bold },
    actMeta: { color: t.text.muted, fontSize: 12, marginTop: 4 },
    actDesc: { color: t.text.muted, fontSize: 13, marginTop: 6, lineHeight: 19 },
    actReward: { color: t.accent.green, fontSize: 13, fontWeight: fonts.bold, marginTop: 8 },
    ...
    logBtnText: { color: '#fff', fontSize: 13, fontWeight: fonts.semibold },
    resCard: { backgroundColor: t.bg.secondary, borderRadius: 14, padding: 16, marginHorizontal: 20, marginBottom: 12 },
    resTitle: { color: t.text.primary, fontSize: 15, fontWeight: fonts.bold },
    resMeta: { color: t.text.muted, fontSize: 12, marginTop: 4 },
    resDesc: { color: t.text.muted, fontSize: 13, marginTop: 6, lineHeight: 19 },
    ...
    typeText: { color: t.accent.blue, fontSize: 11, fontWeight: fonts.semibold },
