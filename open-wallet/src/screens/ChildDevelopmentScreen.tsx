...
export function ChildDevelopmentScreen({ onClose }: Props) {
  ...
  const s = useMemo(() => StyleSheet.create({
    ...
    mileInfo: { flex: 1 },
    mileTitle: { color: t.text.primary, fontSize: 14, fontWeight: '600' },
    mileMeta: { color: t.text.muted, fontSize: 12, marginTop: 2 },
    mileRight: { alignItems: 'flex-end', justifyContent: 'center' },
    mileNotk: { color: t.accent.green, fontSize: 13, fontWeight: '700' },
    ...
    resTitle: { color: t.text.primary, fontSize: 15, fontWeight: '700' },
    ...
    typeText: { color: t.accent.blue, fontSize: 11, fontWeight: '600' },
