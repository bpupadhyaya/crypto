...
export const MultiSigScreen = React.memo(({ onClose }: Props) => {
  ...
  const s = useMemo(() => StyleSheet.create({
    ...
    cardSub: { color: t.text.muted, fontSize: fonts.sm, marginBottom: 8 },
    ...
    signerText: { color: t.text.secondary, fontSize: fonts.sm },
    ...
    typeText: { color: t.text.secondary, fontSize: fonts.sm },
