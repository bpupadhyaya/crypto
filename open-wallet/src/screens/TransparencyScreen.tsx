...
export function TransparencyScreen({ onClose }: Props) {
  ...
  const s = useMemo(() => StyleSheet.create({
    ...
    spendDesc: { color: t.text.primary, fontSize: 14, fontWeight: fonts.semibold, flex: 1 },
    spendAmount: { color: t.text.primary, fontSize: 15, fontWeight: fonts.heavy },
    spendMeta: { color: t.text.muted, fontSize: 12, marginTop: 4 },
    spendCat: { paddingHorizontal: 8, paddingVertical: 2, borderRadius: 6, alignSelf: 'flex-start', marginTop: 6 },
    spendCatText: { color: '#fff', fontSize: 10, fontWeight: fonts.bold },
    spendHash: { color: t.accent.blue, fontSize: 11, marginTop: 4, fontFamily: 'monospace' },
    spendApproval: { color: t.accent.green, fontSize: 11, marginTop: 2 },
    flagBtn: { color: t.accent.orange, fontSize: 12, fontWeight: fonts.semibold, marginTop: 6 },
    ...
    auditPeriod: { color: t.text.primary, fontSize: 16, fontWeight: fonts.bold },
    auditStatus: { paddingHorizontal: 10, paddingVertical: 3, borderRadius: 8 },
    auditStatusText: { color: '#fff', fontSize: 11, fontWeight: fonts.bold },
    auditMeta: { color: t.text.muted, fontSize: 12, marginTop: 6 },
    ...
    auditBtnText: { color: '#fff', fontSize: 13, fontWeight: fonts.semibold },
    ...
    reportText: { color: t.text.primary, fontSize: 15, fontWeight: fonts.semibold, textAlign: 'center', lineHeight: 22 },
    bigNumber: { color: t.text.primary, fontSize: 36, fontWeight: fonts.heavy, textAlign: 'center' },
    label: { color: t.text.muted, fontSize: 12, textAlign: 'center', marginTop: 4 },
    ...
    catLabel: { color: t.text.primary, fontSize: 13, fontWeight: fonts.semibold },
    catValue: { color: t.text.primary, fontSize: 13, fontWeight: fonts.bold },
    catPercent: { color: t.text.muted, fontSize: 11 },
    recipientRow: { flexDirection: 'row', justifyContent: 'space-between', paddingVertical: 8 },
    recipientName: { color: t.text.primary, fontSize: 13 },
    recipientAmount: { color: t.accent.green, fontSize: 13, fontWeight: fonts.bold },
