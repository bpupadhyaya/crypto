...
export function TransparencyScreen({ onClose }: Props) {
  ...
  const s = useMemo(() => StyleSheet.create({
    ...
    spendDesc: { color: t.text.primary, fontSize: 14, fontWeight: '600', flex: 1 },
    spendAmount: { color: t.text.primary, fontSize: 15, fontWeight: '800' },
    ...
    spendCatText: { color: '#fff', fontSize: 10, fontWeight: '700' },
    ...
    flagBtn: { color: t.accent.orange, fontSize: 12, fontWeight: '600', marginTop: 6 },
    ...
    auditPeriod: { color: t.text.primary, fontSize: 16, fontWeight: '700' },
    auditStatus: { paddingHorizontal: 10, paddingVertical: 3, borderRadius: 8 },
    auditStatusText: { color: '#fff', fontSize: 11, fontWeight: '700' },
    ...
    auditBtnText: { color: '#fff', fontSize: 13, fontWeight: '600' },
    ...
    reportText: { color: t.text.primary, fontSize: 15, fontWeight: '600', textAlign: 'center', lineHeight: 22 },
    ...
    catLabel: { color: t.text.primary, fontSize: 13, fontWeight: '600' },
    catValue: { color: t.text.primary, fontSize: 13, fontWeight: '700' },
    ...
    recipientAmount: { color: t.accent.green, fontSize: 13, fontWeight: '700' },
