...
export function ProgressReportScreen({ onClose }: Props) {
  ...
  const s = useMemo(() => StyleSheet.create({
    ...
    monthLabel: { color: t.text.secondary, fontSize: 14, fontWeight: fonts.semibold, textAlign: 'center', marginBottom: 4 },
    reportTitle: { color: t.text.primary, fontSize: 22, fontWeight: fonts.heavy, textAlign: 'center', marginBottom: 20 },
    ...
    summaryNum: { fontSize: 28, fontWeight: fonts.heavy, marginBottom: 2 },
    summaryLabel: { color: t.text.muted, fontSize: 11, fontWeight: fonts.semibold },
    ...
    growthText: { color: t.accent.green, fontSize: 13, fontWeight: fonts.bold },
    ...
    channelName: { flex: 1, fontSize: 15, fontWeight: fonts.bold },
    channelOTK: { fontSize: 16, fontWeight: fonts.heavy },
    channelChange: { fontSize: 12, fontWeight: fonts.semibold },
    channelStats: { flexDirection: 'row', gap: 16, marginBottom: 8 },
    channelStat: { flexDirection: 'row', alignItems: 'center', gap: 4 },
    channelStatLabel: { color: t.text.muted, fontSize: 12 },
    channelStatVal: { color: t.text.primary, fontSize: 12, fontWeight: fonts.bold },
    channelHighlight: { color: t.text.secondary, fontSize: 13, fontStyle: 'italic', lineHeight: 18 },
    ...
    weekLabel: { flex: 1, color: t.text.primary, fontSize: 13, fontWeight: fonts.semibold },
    weekOTK: { color: t.accent.green, fontSize: 14, fontWeight: fonts.heavy, marginRight: 12 },
    weekAct: { color: t.text.muted, fontSize: 12, fontWeight: fonts.semibold, width: 50, textAlign: 'right' },
    weekTop: { color: t.text.secondary, fontSize: 12, width: 70, textAlign: 'right' },
    rankCard: { backgroundColor: t.accent.purple + '15', borderRadius: 14, padding: 16, marginBottom: 20, alignItems: 'center' },
    rankNum: { color: t.accent.purple, fontSize: 36, fontWeight: fonts.heavy },
    rankLabel: { color: t.text.secondary, fontSize: 13, fontWeight: fonts.semibold, marginTop: 4 },
    rankChange: { color: t.accent.green, fontSize: 13, fontWeight: fonts.bold, marginTop: 2 },
