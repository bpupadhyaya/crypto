...
export function ProgressReportScreen({ onClose }: Props) {
  ...
  const s = useMemo(() => StyleSheet.create({
    ...
    monthLabel: { color: t.text.secondary, fontSize: 14, fontWeight: '600', textAlign: 'center', marginBottom: 4 },
    reportTitle: { color: t.text.primary, fontSize: 22, fontWeight: '900', textAlign: 'center', marginBottom: 20 },
    ...
    summaryNum: { fontSize: 28, fontWeight: '900', marginBottom: 2 },
    ...
    growthText: { color: t.accent.green, fontSize: 13, fontWeight: '700' },
    sectionTitle: { color: t.text.primary, fontSize: 16, fontWeight: '800', marginBottom: 12, marginTop: 8 },
    ...
    channelOTK: { fontSize: 16, fontWeight: '800' },
    channelChange: { fontSize: 12, fontWeight: '600' },
    ...
    channelStatVal: { color: t.text.primary, fontSize: 12, fontWeight: '700' },
    ...
    weekLabel: { flex: 1, color: t.text.primary, fontSize: 13, fontWeight: '600' },
    weekOTK: { color: t.accent.green, fontSize: 14, fontWeight: '800', marginRight: 12 },
    weekAct: { color: t.text.muted, fontSize: 12, fontWeight: '600', width: 50, textAlign: 'right' },
    ...
    rankNum: { color: t.accent.purple, fontSize: 36, fontWeight: '900' },
    rankLabel: { color: t.text.secondary, fontSize: 13, fontWeight: '600', marginTop: 4 },
    rankChange: { color: t.accent.green, fontSize: 13, fontWeight: '700', marginTop: 2 },
    ...
    footerBold: { color: t.text.primary, fontWeight: '700' },
  }), [t]);
