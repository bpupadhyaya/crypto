...
export function BuySellScreen({ onClose }: Props) {
  ...
  const s = useMemo(() => StyleSheet.create({
    ...
    section: { color: t.text.secondary, fontSize: fonts.sm, fontWeight: fonts.bold, textTransform: 'uppercase', letterSpacing: 1.5, marginLeft: 24, marginBottom: 8, marginTop: 16 },
    ...
    tokenDotText: { color: '#fff', fontSize: fonts.md, fontWeight: fonts.heavy },
    tokenBtnInfo: { flex: 1 },
    tokenBtnSymbol: { color: t.text.primary, fontSize: fonts.xl, fontWeight: fonts.bold },
    tokenBtnName: { color: t.text.muted, fontSize: fonts.sm, marginTop: 2 },
    tokenBtnChevron: { color: t.text.muted, fontSize: fonts.xl },
    // Amount input
    amountCard: { backgroundColor: t.bg.card, borderRadius: 16, padding: 16, marginHorizontal: 20, marginBottom: 16 },
    amountRow: { flexDirection: 'row', alignItems: 'center' },
    currencySymbol: { color: t.text.muted, fontSize: fonts.xxxl, fontWeight: fonts.semibold, marginRight: 8 },
    amountInput: { color: t.text.primary, fontSize: fonts.xxxl, fontWeight: fonts.semibold, flex: 1 },
    amountConverted: { color: t.text.muted, fontSize: fonts.md, marginTop: 8 },
    // Quick amounts
    ...
    quickChipText: { color: t.text.secondary, fontSize: fonts.md, fontWeight: fonts.semibold },
    ...
    quoteLeft: { flex: 1 },
    quoteName: { color: t.text.primary, fontSize: fonts.md, fontWeight: fonts.bold },
    quoteType: { color: t.text.muted, fontSize: fonts.xs, marginTop: 2 },
    quoteRight: { alignItems: 'flex-end' },
    quoteAmount: { color: t.accent.green, fontSize: fonts.lg, fontWeight: fonts.heavy },
    quoteFee: { color: t.text.muted, fontSize: fonts.sm, marginTop: 2 },
    bestBadge: {
      position: 'absolute', top: -8, right: 12,
      backgroundColor: t.accent.green, paddingHorizontal: 8, paddingVertical: 2, borderRadius: 8,
    },
    bestBadgeText: { color: '#fff', fontSize: fonts.xs, fontWeight: fonts.heavy },
    // Rail-specific
    ...
    railBadgeText: { color: t.accent.blue, fontSize: fonts.xs, fontWeight: fonts.semibold },
    // Buy/Sell button
    ...
    // Notes
    testnetNote: { color: t.accent.yellow, fontSize: fonts.sm, textAlign: 'center', marginTop: 12, marginHorizontal: 20 },
    addressNote: { color: t.text.muted, fontSize: fonts.sm, textAlign: 'center', marginTop: 8, marginHorizontal: 20, lineHeight: 18, marginBottom: 20 },
    ...
    intentTitle: { color: t.text.primary, fontSize: fonts.xl, fontWeight: fonts.heavy, textAlign: 'center', marginBottom: 16 },
    intentRow: { flexDirection: 'row', justifyContent: 'space-between', paddingVertical: 8 },
    intentLabel: { color: t.text.muted, fontSize: fonts.md },
    intentValue: { color: t.text.primary, fontSize: fonts.md, fontWeight: fonts.semibold },
    intentQR: {
      backgroundColor: '#fff', borderRadius: 12, padding: 20, marginVertical: 16,
      alignItems: 'center',
    },
    intentQRText: { color: '#333', fontSize: fonts.sm, textAlign: 'center', fontFamily: 'monospace' as string },
    intentUri: {
      backgroundColor: t.bg.primary, borderRadius: 8, padding: 12, marginBottom: 16,
    },
    intentUriText: { color: t.accent.blue, fontSize: fonts.sm, textAlign: 'center' },
    intentExpiry: { color: t.accent.yellow, fontSize: fonts.sm, textAlign: 'center', marginBottom: 12 },
    intentCancel: { color: t.accent.red, fontSize: fonts.md, fontWeight: fonts.semibold, textAlign: 'center', paddingVertical: 12 },
    // Sell balance
    balanceRow: { flexDirection: 'row', justifyContent: 'space-between', marginHorizontal: 20, marginBottom: 12 },
    balanceLabel: { color: t.text.muted, fontSize: fonts.sm },
    balanceValue: { color: t.text.primary, fontSize: fonts.sm, fontWeight: fonts.semibold },
    // Demo badge
    ...
    demoBadgeText: { color: t.accent.purple, fontSize: fonts.sm, fontWeight: fonts.bold },
    scroll: { flex: 1 },
  }), [t]);
