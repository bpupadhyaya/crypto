...
export function BuySellScreen({ onClose }: Props) {
  ...
  const s = useMemo(() => StyleSheet.create({
    ...
    tabText: { color: t.text.secondary, fontSize: 15, fontWeight: fonts.semibold },
    tabTextActive: { color: t.bg.primary },
    section: { color: t.text.secondary, fontSize: 12, fontWeight: fonts.bold, textTransform: 'uppercase', letterSpacing: 1.5, marginLeft: 24, marginBottom: 8, marginTop: 16 },
    ...
    tokenDotText: { color: '#fff', fontSize: 14, fontWeight: fonts.heavy },
    tokenBtnInfo: { flex: 1 },
    tokenBtnSymbol: { color: t.text.primary, fontSize: 18, fontWeight: fonts.bold },
    ...
    currencySymbol: { color: t.text.muted, fontSize: 28, fontWeight: fonts.semibold, marginRight: 8 },
    amountInput: { color: t.text.primary, fontSize: 28, fontWeight: fonts.semibold, flex: 1 },
    ...
    quickChipText: { color: t.text.secondary, fontSize: 14, fontWeight: fonts.semibold },
    ...
    quoteLeft: { flex: 1 },
    quoteName: { color: t.text.primary, fontSize: 15, fontWeight: fonts.bold },
    quoteType: { color: t.text.muted, fontSize: 11, marginTop: 2 },
    quoteRight: { alignItems: 'flex-end' },
    quoteAmount: { color: t.accent.green, fontSize: 16, fontWeight: fonts.heavy },
    ...
    bestBadgeText: { color: '#fff', fontSize: 10, fontWeight: fonts.heavy },
    // Rail-specific
    ...
    railBadgeText: { color: t.accent.blue, fontSize: 11, fontWeight: fonts.semibold },
    // Buy/Sell button
    ...
    intentTitle: { color: t.text.primary, fontSize: 18, fontWeight: fonts.heavy, textAlign: 'center', marginBottom: 16 },
    intentRow: { flexDirection: 'row', justifyContent: 'space-between', paddingVertical: 8 },
    intentLabel: { color: t.text.muted, fontSize: 14 },
    intentValue: { color: t.text.primary, fontSize: 14, fontWeight: fonts.semibold },
    intentQR: {
    ...
    intentCancel: { color: t.accent.red, fontSize: 15, fontWeight: fonts.semibold, textAlign: 'center', paddingVertical: 12 },
    // Sell balance
    ...
    balanceValue: { color: t.text.primary, fontSize: 13, fontWeight: fonts.semibold },
    // Demo badge
    ...
    demoBadgeText: { color: t.accent.purple, fontSize: 12, fontWeight: fonts.bold },
    scroll: { flex: 1 },
  }), [t]);
