...
export function VolunteerLogScreen({ onClose }: Props) {
  ...
  const s = useMemo(() => StyleSheet.create({
    ...
    logOrg: { color: t.text.primary, fontSize: fonts.md, fontWeight: fonts.bold, flex: 1 },
    logHours: { color: t.accent.blue, fontSize: fonts.md, fontWeight: fonts.heavy },
    logDesc: { color: t.text.muted, fontSize: fonts.sm, marginTop: 4 },
    logMeta: { flexDirection: 'row', justifyContent: 'space-between', marginTop: 4 },
    logDate: { color: t.text.muted, fontSize: fonts.xs },
    logCotk: { color: t.accent.green, fontSize: fonts.sm, fontWeight: fonts.bold },
    logVerified: { fontSize: fonts.xs, fontWeight: fonts.semibold },
    ...
    streakText: { color: t.text.primary, fontSize: fonts.md, fontWeight: fonts.semibold, textAlign: 'center', lineHeight: 22 },
    ...
    certTitle: { color: t.text.primary, fontSize: fonts.lg, fontWeight: fonts.bold },
    certMeta: { color: t.text.muted, fontSize: fonts.sm, marginTop: 4 },
    certHash: { color: t.accent.blue, fontSize: fonts.xs, marginTop: 6, fontFamily: 'monospace' },
    ...
    certBadgeText: { color: t.accent.green, fontSize: fonts.xs, fontWeight: fonts.bold },
