...
export function VolunteerLogScreen({ onClose }: Props) {
  ...
  const s = useMemo(() => StyleSheet.create({
    ...
    logOrg: { color: t.text.primary, fontSize: 14, fontWeight: '700', flex: 1 },
    logHours: { color: t.accent.blue, fontSize: 15, fontWeight: '800' },
    ...
    logCotk: { color: t.accent.green, fontSize: 12, fontWeight: '700' },
    logVerified: { fontSize: 11, fontWeight: '600' },
    ...
    streakText: { color: t.text.primary, fontSize: 15, fontWeight: '600', textAlign: 'center', lineHeight: 22 },
    ...
    certTitle: { color: t.text.primary, fontSize: 16, fontWeight: '700' },
    ...
    certBadgeText: { color: t.accent.green, fontSize: 11, fontWeight: '700' },
