...
export function DonorWallScreen({ onClose }: Props) {
  ...
  const s = useMemo(() => StyleSheet.create({
    ...
    donorRank: { width: 28, color: t.text.muted, fontSize: 14, fontWeight: fonts.heavy, textAlign: 'center' },
    donorIcon: { fontSize: 28 },
    donorInfo: { flex: 1 },
    donorName: { color: t.text.primary, fontSize: 14, fontWeight: fonts.bold },
    donorMeta: { color: t.text.muted, fontSize: 12, marginTop: 2 },
    donorAmount: { alignItems: 'flex-end' },
    donorOTK: { fontSize: 16, fontWeight: fonts.heavy },
    tierBadge: { paddingHorizontal: 8, paddingVertical: 2, borderRadius: 6, marginTop: 4 },
    tierText: { fontSize: 10, fontWeight: fonts.bold, color: '#fff' },
    ...
    causeIcon: { fontSize: 28 },
    causeTitle: { flex: 1, fontSize: 15, fontWeight: fonts.bold },
    causeDonors: { color: t.text.muted, fontSize: 12 },
    causeDesc: { color: t.text.secondary, fontSize: 13, lineHeight: 18, marginBottom: 10 },
    ...
    causeRaised: { fontSize: 13, fontWeight: fonts.bold },
    causeGoal: { color: t.text.muted, fontSize: 12 },
    ...
    impactIcon: { fontSize: 32 },
    impactInfo: { flex: 1 },
    impactValue: { color: t.text.primary, fontSize: 22, fontWeight: fonts.heavy },
    impactLabel: { color: t.text.primary, fontSize: 14, fontWeight: fonts.semibold, marginTop: 2 },
    impactDesc: { color: t.text.muted, fontSize: 12, marginTop: 2 },
