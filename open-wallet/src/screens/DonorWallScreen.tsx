...
export function DonorWallScreen({ onClose }: Props) {
  ...
  const s = useMemo(() => StyleSheet.create({
    ...
    donorRank: { width: 28, color: t.text.muted, fontSize: 14, fontWeight: '800', textAlign: 'center' },
    donorIcon: { fontSize: 28 },
    donorInfo: { flex: 1 },
    donorName: { color: t.text.primary, fontSize: 14, fontWeight: '700' },
    donorMeta: { color: t.text.muted, fontSize: 12, marginTop: 2 },
    donorAmount: { alignItems: 'flex-end' },
    donorOTK: { fontSize: 16, fontWeight: '800' },
    ...
    causeTitle: { flex: 1, fontSize: 15, fontWeight: '700' },
    ...
    causeRaised: { fontSize: 13, fontWeight: '700' },
    ...
    impactInfo: { flex: 1 },
    impactValue: { color: t.text.primary, fontSize: 22, fontWeight: '900' },
    impactLabel: { color: t.text.primary, fontSize: 14, fontWeight: '600', marginTop: 2 },
