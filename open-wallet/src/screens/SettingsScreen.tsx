...
import { CrowdfundScreen } from './CrowdfundScreen';
import { ResourceSharingScreen } from './ResourceSharingScreen';
import { HealthRecordScreen } from './HealthRecordScreen';
import { CommunityGoalsScreen } from './CommunityGoalsScreen';
import { EducationFundScreen } from './EducationFundScreen';
import { EnergyAuditScreen } from './EnergyAuditScreen';
import { PeerReviewScreen } from './PeerReviewScreen';
import { TranslationScreen } from './TranslationScreen';
import { LocalCurrencyScreen } from './LocalCurrencyScreen';
import { CompostScreen } from './CompostScreen';
import { RainwaterScreen } from './RainwaterScreen';
import { BikeShareScreen } from './BikeShareScreen';
import { ChildDevelopmentScreen } from './ChildDevelopmentScreen';
import { CommunityKitchenScreen } from './CommunityKitchenScreen';
import { AntiCorruptionScreen } from './AntiCorruptionScreen';
import { AccessibilityMapScreen } from './AccessibilityMapScreen';
import { OpenDataScreen } from './OpenDataScreen';
import { HumanRightsScreen } from './HumanRightsScreen';
import { SocialRecoveryScreen } from './SocialRecoveryScreen';
import { MultiDeviceScreen } from './MultiDeviceScreen';
import { ConstitutionDashboardScreen } from './ConstitutionDashboardScreen';
import { WorldMapScreen } from './WorldMapScreen';
import { DataDashboardScreen } from './DataDashboardScreen';
import { LegacyPlanScreen } from './LegacyPlanScreen';
import { FutureVisionScreen } from './FutureVisionScreen';
import { OnboardingCompleteScreen } from './OnboardingCompleteScreen';
import { RetirementScreen } from './RetirementScreen';
import { FreelanceScreen } from './FreelanceScreen';
import { VolunteerLogScreen } from './VolunteerLogScreen';
import { CarbonTrackerScreen } from './CarbonTrackerScreen';
...
import { CommunityBankScreen } from './CommunityBankScreen';
import { EmergencyFundScreen } from './EmergencyFundScreen';
import { CommunityRadarScreen } from './CommunityRadarScreen';
import { SkillTreeScreen } from './SkillTreeScreen';
import { ImpactCalculatorScreen } from './ImpactCalculatorScreen';
import { TrustNetworkScreen } from './TrustNetworkScreen';
import { HabitTrackerScreen } from './HabitTrackerScreen';
import { MoodMapScreen } from './MoodMapScreen';
import { KnowledgeBaseScreen } from './KnowledgeBaseScreen';
import { CommunityPledgeScreen } from './CommunityPledgeScreen';
import { TokenBurnScreen } from './TokenBurnScreen';
import { ChainExplorerScreen } from './ChainExplorerScreen';
import { QRHubScreen } from './QRHubScreen';
import { CommunityDirectoryScreen } from './CommunityDirectoryScreen';
import { EmergencyKitScreen } from './EmergencyKitScreen';
import { ProgressReportScreen } from './ProgressReportScreen';
import { OTKFlowScreen } from './OTKFlowScreen';
import { CommunityHealthIndexScreen } from './CommunityHealthIndexScreen';
import { MilestoneTrackerScreen } from './MilestoneTrackerScreen';
import { DonorWallScreen } from './DonorWallScreen';
import { SafeSpaceScreen } from './SafeSpaceScreen';
import { LanguageSchoolScreen } from './LanguageSchoolScreen';
import { CommunityRadioLiveScreen } from './CommunityRadioLiveScreen';
import { WellnessCheckScreen } from './WellnessCheckScreen';
import { SuccessStoriesScreen } from './SuccessStoriesScreen';
import { CommunityCalendarFullScreen } from './CommunityCalendarFullScreen';
import { VerifierDashboardScreen } from './VerifierDashboardScreen';
import { GratitudeAnalyticsScreen } from './GratitudeAnalyticsScreen';
import { CommunityPartnerScreen } from './CommunityPartnerScreen';
import { DigitalIdentityScreen } from './DigitalIdentityScreen';
import { RewardShopScreen } from './RewardShopScreen';
import { CommunityMapLiveScreen } from './CommunityMapLiveScreen';
import { PeaceAmbassadorScreen } from './PeaceAmbassadorScreen';
import { OpenSourceScreen } from './OpenSourceScreen';
import { TokenHistoryScreen } from './TokenHistoryScreen';
import { RegionalDashboardScreen } from './RegionalDashboardScreen';
import { DelegateScreen } from './DelegateScreen';
import { ContributionHistoryScreen } from './ContributionHistoryScreen';
import { CommunityVaultScreen } from './CommunityVaultScreen';
import { OracleNetworkScreen } from './OracleNetworkScreen';
import { NetworkStatsScreen } from './NetworkStatsScreen';
import { FeeEstimatorScreen } from './FeeEstimatorScreen';
import { AchievementGalleryScreen } from './AchievementGalleryScreen';
import { ValidatorListScreen } from './ValidatorListScreen';
import { WalletHealthScreen } from './WalletHealthScreen';
import { CrossChainPortfolioScreen } from './CrossChainPortfolioScreen';
import { RoadmapScreen } from './RoadmapScreen';
import { ChangelogScreen } from './ChangelogScreen';
import { FaqScreen } from './FaqScreen';
import { AccessibilitySettingsScreen } from './AccessibilitySettingsScreen';
import { ConnectionScreen } from './ConnectionScreen';
import { BackupVerifyScreen } from './BackupVerifyScreen';
...
export function SettingsScreen() {
  ...
  if (view === 'crowdfund') return <CrowdfundScreen onClose={() => setView('main')} />;
  if (view === 'resource-sharing') return <ResourceSharingScreen onClose={() => setView('main')} />;
  if (view === 'health-record') return <HealthRecordScreen onClose={() => setView('main')} />;
  if (view === 'community-goals') return <CommunityGoalsScreen onClose={() => setView('main')} />;
  if (view === 'education-fund') return <EducationFundScreen onClose={() => setView('main')} />;
  if (view === 'energy-audit') return <EnergyAuditScreen onClose={() => setView('main')} />;
  if (view === 'peer-review') return <PeerReviewScreen onClose={() => setView('main')} />;
  if (view === 'translation') return <TranslationScreen onClose={() => setView('main')} />;
  if (view === 'local-currency') return <LocalCurrencyScreen onClose={() => setView('main')} />;
  if (view === 'compost') return <CompostScreen onClose={() => setView('main')} />;
  if (view === 'rainwater') return <RainwaterScreen onClose={() => setView('main')} />;
  if (view === 'bike-share') return <BikeShareScreen onClose={() => setView('main')} />;
  if (view === 'child-development') return <ChildDevelopmentScreen onClose={() => setView('main')} />;
  if (view === 'community-kitchen') return <CommunityKitchenScreen onClose={() => setView('main')} />;
  if (view === 'anti-corruption') return <AntiCorruptionScreen onClose={() => setView('main')} />;
  if (view === 'accessibility-map') return <AccessibilityMapScreen onClose={() => setView('main')} />;
  if (view === 'open-data') return <OpenDataScreen onClose={() => setView('main')} />;
  if (view === 'human-rights') return <HumanRightsScreen onClose={() => setView('main')} />;
  if (view === 'social-recovery') return <SocialRecoveryScreen onClose={() => setView('main')} />;
  if (view === 'multi-device') return <MultiDeviceScreen onClose={() => setView('main')} />;
  if (view === 'constitution-dashboard') return <ConstitutionDashboardScreen onClose={() => setView('main')} />;
  if (view === 'world-map') return <WorldMapScreen onClose={() => setView('main')} />;
  if (view === 'data-dashboard') return <DataDashboardScreen onClose={() => setView('main')} />;
  if (view === 'legacy-plan') return <LegacyPlanScreen onClose={() => setView('main')} />;
  if (view === 'future-vision') return <FutureVisionScreen onClose={() => setView('main')} />;
  if (view === 'onboarding-complete') return <OnboardingCompleteScreen onClose={() => setView('main')} />;
  if (view === 'retirement') return <RetirementScreen onClose={() => setView('main')} />;
  if (view === 'freelance') return <FreelanceScreen onClose={() => setView('main')} />;
  if (view === 'volunteer-log') return <VolunteerLogScreen onClose={() => setView('main')} />;
  if (view === 'carbon-tracker') return <CarbonTrackerScreen onClose={() => setView('main')} />;
  if (view === 'graduation') return <GraduationScreen onClose={() => setView('main')} />;
  if (view === 'support-group') return <SupportGroupScreen onClose={() => setView('main')} />;
  if (view === 'transparency') return <TransparencyScreen onClose={() => setView('main')} />;
  if (view === 'mentor-directory') return <MentorDirectoryScreen onClose={() => setView('main')} />;
  if (view === 'community-bank') return <CommunityBankScreen onClose={() => setView('main')} />;
  if (view === 'emergency-fund') return <EmergencyFundScreen onClose={() => setView('main')} />;
  if (view === 'community-radar') return <CommunityRadarScreen onClose={() => setView('main')} />;
  if (view === 'skill-tree') return <SkillTreeScreen onClose={() => setView('main')} />;
  if (view === 'impact-calculator') return <ImpactCalculatorScreen onClose={() => setView('main')} />;
  if (view === 'trust-network') return <TrustNetworkScreen onClose={() => setView('main')} />;
  if (view === 'habit-tracker') return <HabitTrackerScreen onClose={() => setView('main')} />;
  if (view === 'mood-map') return <MoodMapScreen onClose={() => setView('main')} />;
  if (view === 'knowledge-base') return <KnowledgeBaseScreen onClose={() => setView('main')} />;
  if (view === 'community-pledge') return <CommunityPledgeScreen onClose={() => setView('main')} />;
  if (view === 'token-burn') return <TokenBurnScreen onClose={() => setView('main')} />;
  if (view === 'chain-explorer') return <ChainExplorerScreen onClose={() => setView('main')} />;
  if (view === 'qr-hub') return <QRHubScreen onClose={() => setView('main')} />;
  if (view === 'community-directory') return <CommunityDirectoryScreen onClose={() => setView('main')} />;
  if (view === 'emergency-kit') return <EmergencyKitScreen onClose={() => setView('main')} />;
  if (view === 'progress-report') return <ProgressReportScreen onClose={() => setView('main')} />;
  if (view === 'otk-flow') return <OTKFlowScreen onClose={() => setView('main')} />;
  if (view === 'community-health-index') return <CommunityHealthIndexScreen onClose={() => setView('main')} />;
  if (view === 'milestone-tracker') return <MilestoneTrackerScreen onClose={() => setView('main')} />;
  if (view === 'donor-wall') return <DonorWallScreen onClose={() => setView('main')} />;
  if (view === 'safe-space') return <SafeSpaceScreen onClose={() => setView('main')} />;
  if (view === 'language-school') return <LanguageSchoolScreen onClose={() => setView('main')} />;
  if (view === 'community-radio-live') return <CommunityRadioLiveScreen onClose={() => setView('main')} />;
  if (view === 'wellness-check') return <WellnessCheckScreen onClose={() => setView('main')} />;
  if (view === 'success-stories') return <SuccessStoriesScreen onClose={() => setView('main')} />;
  if (view === 'community-calendar-full') return <CommunityCalendarFullScreen onClose={() => setView('main')} />;
  if (view === 'verifier-dashboard') return <VerifierDashboardScreen onClose={() => setView('main')} />;
  if (view === 'gratitude-analytics') return <GratitudeAnalyticsScreen onClose={() => setView('main')} />;
  if (view === 'community-partner') return <CommunityPartnerScreen onClose={() => setView('main')} />;
  if (view === 'digital-identity') return <DigitalIdentityScreen onClose={() => setView('main')} />;
  if (view === 'reward-shop') return <RewardShopScreen onClose={() => setView('main')} />;
  if (view === 'community-map-live') return <CommunityMapLiveScreen onClose={() => setView('main')} />;
  if (view === 'peace-ambassador') return <PeaceAmbassadorScreen onClose={() => setView('main')} />;
  if (view === 'open-source') return <OpenSourceScreen onClose={() => setView('main')} />;
  if (view === 'token-history') return <TokenHistoryScreen onClose={() => setView('main')} />;
  if (view === 'regional-dashboard') return <RegionalDashboardScreen onClose={() => setView('main')} />;
  if (view === 'delegate-power') return <DelegateScreen onClose={() => setView('main')} />;
  if (view === 'contribution-history') return <ContributionHistoryScreen onClose={() => setView('main')} />;
  if (view === 'community-vault') return <CommunityVaultScreen onClose={() => setView('main')} />;
  if (view === 'oracle-network') return <OracleNetworkScreen onClose={() => setView('main')} />;
  if (view === 'network-stats') return <NetworkStatsScreen onClose={() => setView('main')} />;
  if (view === 'fee-estimator') return <FeeEstimatorScreen onClose={() => setView('main')} />;
  if (view === 'achievement-gallery') return <AchievementGalleryScreen onClose={() => setView('main')} />;
  if (view === 'validator-list') return <ValidatorListScreen onClose={() => setView('main')} />;
  if (view === 'wallet-health') return <WalletHealthScreen onClose={() => setView('main')} />;
  if (view === 'cross-chain-portfolio') return <CrossChainPortfolioScreen onClose={() => setView('main')} />;
  if (view === 'roadmap') return <RoadmapScreen onClose={() => setView('main')} />;
  if (view === 'changelog') return <ChangelogScreen onClose={() => setView('main')} />;
  if (view === 'faq') return <FaqScreen onClose={() => setView('main')} />;
  if (view === 'accessibility-settings') return <AccessibilitySettingsScreen onClose={() => setView('main')} />;
  if (view === 'connections') return <ConnectionScreen onClose={() => setView('main')} />;
  if (view === 'backup-verify') return <BackupVerifyScreen onClose={() => setView('main')} />;
  if (view === 'night-mode') return <NightModeScreen onClose={() => setView('main')} />;
  if (view === 'feedback-form') return <FeedbackFormScreen onClose={() => setView('main')} />;
  ...
  const chainItems = [
    ...
    {
      label: 'Crowdfunding',
      onPress: () => setView('crowdfund'),
      rightText: 'Back Projects',
      rightColor: t.accent.green,
    },
    {
      label: 'Resource Sharing',
      onPress: () => setView('resource-sharing'),
      rightText: 'Borrow & Share',
      rightColor: t.accent.blue,
    },
    {
      label: 'Health Records',
      onPress: () => setView('health-record'),
      rightText: 'Encrypted PHR',
      rightColor: t.accent.red,
    },
    {
      label: 'Community Goals',
      onPress: () => setView('community-goals'),
      rightText: 'Collective Action',
      rightColor: t.accent.green,
    },
    {
      label: 'Education Fund',
      onPress: () => setView('education-fund'),
      rightText: 'eOTK Scholarships',
      rightColor: t.accent.blue,
    },
    { label: 'Energy Audit', onPress: () => setView('energy-audit'), rightText: 'Efficiency', rightColor: t.accent.green },
    { label: 'Peer Review', onPress: () => setView('peer-review'), rightText: 'Review Proposals', rightColor: t.accent.blue },
    { label: 'Translation Service', onPress: () => setView('translation'), rightText: 'Help Translate', rightColor: t.accent.purple },
    { label: 'Local Currency', onPress: () => setView('local-currency'), rightText: 'Community Money', rightColor: t.accent.yellow },
    { label: 'Composting', onPress: () => setView('compost'), rightText: 'Soil Health', rightColor: t.accent.green },
    { label: 'Rainwater Harvest', onPress: () => setView('rainwater'), rightText: 'Water Collection', rightColor: t.accent.blue },
    { label: 'Bike Share', onPress: () => setView('bike-share'), rightText: 'Green Transport', rightColor: t.accent.green },
    { label: 'Child Development', onPress: () => setView('child-development'), rightText: 'nOTK Milestones', rightColor: t.accent.orange },
    { label: 'Community Kitchen', onPress: () => setView('community-kitchen'), rightText: 'Shared Meals', rightColor: t.accent.red },
    { label: 'Anti-Corruption', onPress: () => setView('anti-corruption'), rightText: 'Transparency', rightColor: t.accent.yellow },
    { label: 'Accessibility Map', onPress: () => setView('accessibility-map'), rightText: 'Inclusive Spaces', rightColor: t.accent.blue },
    { label: 'Open Data', onPress: () => setView('open-data'), rightText: 'Community Data', rightColor: t.accent.green },
    { label: 'Human Rights', onPress: () => setView('human-rights'), rightText: 'Art I Foundation', rightColor: t.accent.red },
    { label: 'Social Recovery', onPress: () => setView('social-recovery'), rightText: 'Guardian Backup', rightColor: t.accent.purple },
    { label: 'Multi-Device Sync', onPress: () => setView('multi-device'), rightText: 'Pair Phones', rightColor: t.accent.blue },
    { label: 'Constitution Dashboard', onPress: () => setView('constitution-dashboard'), rightText: 'All 10 Articles', rightColor: t.accent.green },
    { label: 'World Map', onPress: () => setView('world-map'), rightText: 'Global Regions', rightColor: t.accent.blue },
    { label: 'Data Dashboard', onPress: () => setView('data-dashboard'), rightText: 'Your Analytics', rightColor: t.accent.orange },
    { label: 'Legacy Plan', onPress: () => setView('legacy-plan'), rightText: 'Digital Will', rightColor: t.accent.purple },
    { label: 'Vision 2030/2035', onPress: () => setView('future-vision'), rightText: 'The Future', rightColor: t.accent.green },
    { label: 'Retirement Planning', onPress: () => setView('retirement'), rightText: 'OTK Pension', rightColor: t.accent.blue },
    { label: 'Freelance Tools', onPress: () => setView('freelance'), rightText: 'Invoice & Track', rightColor: t.accent.orange },
    { label: 'Volunteer Log', onPress: () => setView('volunteer-log'), rightText: 'cOTK Hours', rightColor: t.accent.green },
    { label: 'Carbon Tracker', onPress: () => setView('carbon-tracker'), rightText: 'Personal CO2', rightColor: t.accent.green },
    { label: 'Graduation', onPress: () => setView('graduation'), rightText: 'Certificates', rightColor: t.accent.purple },
    { label: 'Support Groups', onPress: () => setView('support-group'), rightText: 'Peer Support', rightColor: t.accent.blue },
    { label: 'Transparency Portal', onPress: () => setView('transparency'), rightText: 'Public Audit', rightColor: t.accent.yellow },
    { label: 'Mentor Directory', onPress: () => setView('mentor-directory'), rightText: 'Find Mentors', rightColor: t.accent.green },
    { label: 'Community Bank', onPress: () => setView('community-bank'), rightText: 'Savings & Loans', rightColor: t.accent.blue },
    { label: 'Emergency Fund', onPress: () => setView('emergency-fund'), rightText: 'Community Pool', rightColor: t.accent.red },
    { label: 'Community Radar', onPress: () => setView('community-radar'), rightText: 'Live Pulse', rightColor: t.accent.green },
    { label: 'Skill Tree', onPress: () => setView('skill-tree'), rightText: 'Progression', rightColor: t.accent.blue },
    { label: 'Impact Calculator', onPress: () => setView('impact-calculator'), rightText: 'Ripple Effect', rightColor: t.accent.purple },
    { label: 'Trust Network', onPress: () => setView('trust-network'), rightText: 'Web of Trust', rightColor: t.accent.blue },
    { label: 'Habit Tracker', onPress: () => setView('habit-tracker'), rightText: 'hOTK Streaks', rightColor: t.accent.green },
    { label: 'Mood Map', onPress: () => setView('mood-map'), rightText: 'Community Mood', rightColor: t.accent.purple },
    { label: 'Knowledge Base', onPress: () => setView('knowledge-base'), rightText: 'Community Wiki', rightColor: t.accent.blue },
    { label: 'Community Pledges', onPress: () => setView('community-pledge'), rightText: 'Sign & Commit', rightColor: t.accent.green },
    { label: 'Token Burns', onPress: () => setView('token-burn'), rightText: 'Correction Log', rightColor: t.accent.red },
    { label: 'Chain Explorer', onPress: () => setView('chain-explorer'), rightText: 'Blocks & Txs', rightColor: t.accent.blue },
    { label: 'QR Hub', onPress: () => setView('qr-hub'), rightText: 'Scan & Generate', rightColor: t.accent.blue },
    { label: 'Community Directory', onPress: () => setView('community-directory'), rightText: 'Find Members', rightColor: t.accent.green },
    { label: 'Emergency Kit', onPress: () => setView('emergency-kit'), rightText: 'Digital Kit', rightColor: t.accent.red },
    { label: 'Progress Report', onPress: () => setView('progress-report'), rightText: 'Monthly Review', rightColor: t.accent.purple },
    { label: 'OTK Flow', onPress: () => setView('otk-flow'), rightText: 'In & Out', rightColor: t.accent.green },
    { label: 'Community Health Index', onPress: () => setView('community-health-index'), rightText: 'Composite Score', rightColor: t.accent.blue },
    { label: 'Milestone Tracker', onPress: () => setView('milestone-tracker'), rightText: 'All Channels', rightColor: t.accent.yellow },
    { label: 'Donor Wall', onPress: () => setView('donor-wall'), rightText: 'Recognition', rightColor: t.accent.green },
    { label: 'Safe Spaces', onPress: () => setView('safe-space'), rightText: 'For Vulnerable', rightColor: t.accent.purple },
    { label: 'Language School', onPress: () => setView('language-school'), rightText: 'eOTK Courses', rightColor: t.accent.blue },
    { label: 'Community Radio Live', onPress: () => setView('community-radio-live'), rightText: 'Streaming', rightColor: t.accent.orange },
    { label: 'Wellness Check', onPress: () => setView('wellness-check'), rightText: 'Daily Self-Check', rightColor: t.accent.green },
    { label: 'Success Stories', onPress: () => setView('success-stories'), rightText: 'Inspire', rightColor: t.accent.green },
    { label: 'Full Year Calendar', onPress: () => setView('community-calendar-full'), rightText: 'All Events', rightColor: t.accent.blue },
    { label: 'Verifier Dashboard', onPress: () => setView('verifier-dashboard'), rightText: 'Oracle Verifiers', rightColor: t.accent.yellow },
    { label: 'Gratitude Analytics', onPress: () => setView('gratitude-analytics'), rightText: 'Patterns', rightColor: t.accent.purple },
    { label: 'Community Partners', onPress: () => setView('community-partner'), rightText: 'Organizations', rightColor: t.accent.blue },
    { label: 'Digital Identity', onPress: () => setView('digital-identity'), rightText: 'All IDs', rightColor: t.accent.blue },
    { label: 'Reward Shop', onPress: () => setView('reward-shop'), rightText: 'Redeem OTK', rightColor: t.accent.green },
    { label: 'Live Community Map', onPress: () => setView('community-map-live'), rightText: 'Real-Time', rightColor: t.accent.orange },
    { label: 'Peace Ambassador', onPress: () => setView('peace-ambassador'), rightText: 'Art X Mission', rightColor: t.accent.green },
    { label: 'Open Source', onPress: () => setView('open-source'), rightText: 'Contribute Code', rightColor: t.accent.blue },
    { label: 'Token History', onPress: () => setView('token-history'), rightText: 'Mint & Burn Log', rightColor: t.accent.green },
    { label: 'Regional Dashboard', onPress: () => setView('regional-dashboard'), rightText: 'Your Region', rightColor: t.accent.blue },
    { label: 'Delegate Power', onPress: () => setView('delegate-power'), rightText: 'Governance Proxy', rightColor: t.accent.purple },
    { label: 'Contribution History', onPress: () => setView('contribution-history'), rightText: 'Full Record', rightColor: t.accent.green },
    { label: 'Community Vault', onPress: () => setView('community-vault'), rightText: 'Shared Savings', rightColor: t.accent.blue },
    { label: 'Oracle Network', onPress: () => setView('oracle-network'), rightText: 'Verifier Status', rightColor: t.accent.yellow },
    { label: 'Network Stats', onPress: () => setView('network-stats'), rightText: 'P2P Health', rightColor: t.accent.green },
    { label: 'Fee Estimator', onPress: () => setView('fee-estimator'), rightText: 'All Chains', rightColor: t.accent.orange },
    { label: 'Achievement Gallery', onPress: () => setView('achievement-gallery'), rightText: 'Soulbound NFTs', rightColor: t.accent.purple },
    { label: 'Validator List', onPress: () => setView('validator-list'), rightText: 'Browse & Stake', rightColor: t.accent.blue },
    { label: 'Wallet Health', onPress: () => setView('wallet-health'), rightText: 'Security Check', rightColor: t.accent.green },
    { label: 'Cross-Chain Portfolio', onPress: () => setView('cross-chain-portfolio'), rightText: 'All Chains', rightColor: t.accent.blue },
    { label: 'Roadmap', onPress: () => setView('roadmap'), rightText: 'Development', rightColor: t.accent.purple },
    { label: 'Changelog', onPress: () => setView('changelog'), rightText: 'Version History', rightColor: t.accent.blue },
    { label: 'FAQ', onPress: () => setView('faq'), rightText: 'Help', rightColor: t.accent.green },
    { label: 'Accessibility Settings', onPress: () => setView('accessibility-settings'), rightText: 'Art IX', rightColor: t.accent.blue },
    { label: 'Connections', onPress: () => setView('connections'), rightText: 'RPC Nodes', rightColor: t.accent.orange },
    { label: 'Backup Verify', onPress: () => setView('backup-verify'), rightText: 'Check Integrity', rightColor: t.accent.yellow },
    { label: 'Night Mode', onPress: () => setView('night-mode'), rightText: 'Blue Light', rightColor: t.accent.purple },
    { label: 'Feedback Form', onPress: () => setView('feedback-form'), rightText: 'Improve App', rightColor: t.accent.green },
    {
