...
export function PaymentRequestScreen({ onClose }: Props) {
  ...
  const s = useMemo(() => StyleSheet.create({
    ...
    label: { color: t.text.secondary, fontSize: 13, fontWeight: fonts.semibold, marginTop: 20, marginBottom: 8 },
    ...
    input: { backgroundColor: t.bg.card, borderRadius: 12, padding: 14, color: t.text.primary, fontSize: 20, fontWeight: fonts.semibold, marginTop: 8 },
    ...
    generateText: { color: '#fff', fontSize: 17, fontWeight: fonts.bold },
    ...
    copyBtnText: { color: t.text.primary, fontSize: 15, fontWeight: fonts.semibold },
    requestSummary: { color: t.text.primary, fontSize: 16, fontWeight: fonts.bold, textAlign: 'center', marginTop: 16 },
  }), [t]);
