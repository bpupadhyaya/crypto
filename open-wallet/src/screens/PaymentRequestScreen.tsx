...
export function PaymentRequestScreen({ onClose }: Props) {
  ...
  const s = useMemo(() => StyleSheet.create({
    ...
    label: { color: t.text.secondary, fontSize: fonts.sm, fontWeight: fonts.semibold, marginTop: 20, marginBottom: 8 },
    ...
    chipText: { color: t.text.secondary, fontSize: fonts.md },
    chipTextActive: { color: '#fff', fontWeight: fonts.bold },
    input: { backgroundColor: t.bg.card, borderRadius: 12, padding: 14, color: t.text.primary, fontSize: fonts.xl, fontWeight: fonts.semibold, marginTop: 8 },
    memoInput: { backgroundColor: t.bg.card, borderRadius: 12, padding: 14, color: t.text.primary, fontSize: fonts.md, marginTop: 8 },
    generateBtn: { backgroundColor: t.accent.green, borderRadius: 16, paddingVertical: 18, alignItems: 'center', marginTop: 24 },
    generateText: { color: '#fff', fontSize: fonts.lg, fontWeight: fonts.bold },
    qrCard: { backgroundColor: '#fff', borderRadius: 20, padding: 24, alignItems: 'center', marginTop: 20 },
    qrLabel: { color: t.text.muted, fontSize: fonts.sm, marginTop: 16, textAlign: 'center' },
    ...
    copyBtnText: { color: t.text.primary, fontSize: fonts.md, fontWeight: fonts.semibold },
    requestSummary: { color: t.text.primary, fontSize: fonts.lg, fontWeight: fonts.bold, textAlign: 'center', marginTop: 16 },
  }), [t]);
