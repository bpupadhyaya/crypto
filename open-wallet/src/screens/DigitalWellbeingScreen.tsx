...
export function DigitalWellbeingScreen({ onClose }: Props) {
  ...
  const s = useMemo(() => StyleSheet.create({
    ...
    heroLabel: { color: t.text.muted, fontSize: fonts.md, fontWeight: fonts.semibold, marginTop: 2 },
    heroSubtext: { color: t.accent.green, fontSize: fonts.sm, fontWeight: fonts.semibold, marginTop: 8 },
    ...
    catIcon: { fontSize: fonts.xxxl },
    catLabel: { color: t.text.primary, fontSize: fonts.md, fontWeight: fonts.bold },
    catHours: { fontSize: fonts.xl, fontWeight: fonts.heavy },
    catTrend: { fontSize: fonts.sm, fontWeight: fonts.bold, marginLeft: 4 },
    ...
    communityScore: { color: t.accent.blue, fontSize: fonts.hero, fontWeight: fonts.heavy },
    communityLabel: { color: t.text.muted, fontSize: fonts.sm, fontWeight: fonts.semibold, marginTop: 4 },
    ...
    challengeIcon: { fontSize: fonts.hero },
    challengeTitle: { color: t.text.primary, fontSize: fonts.md, fontWeight: fonts.bold, flex: 1 },
    challengeActiveBadge: { backgroundColor: t.accent.green + '20', borderRadius: 8, paddingVertical: 3, paddingHorizontal: 8 },
    challengeActiveText: { color: t.accent.green, fontSize: fonts.xs, fontWeight: fonts.bold },
    challengeDesc: { color: t.text.secondary, fontSize: fonts.sm, lineHeight: 20, marginBottom: 12 },
    ...
    challengeProgress: { color: t.accent.green, fontSize: fonts.sm, fontWeight: fonts.bold },
    challengeReward: { color: t.accent.purple, fontSize: fonts.sm, fontWeight: fonts.bold },
    challengeStartBtn: { backgroundColor: t.accent.green + '15', borderRadius: 12, paddingVertical: 10, alignItems: 'center', marginTop: 10 },
    challengeStartText: { color: t.accent.green, fontSize: fonts.md, fontWeight: fonts.bold },
    ...
    tipIcon: { fontSize: fonts.xxxl },
    tipTitle: { color: t.text.primary, fontSize: fonts.md, fontWeight: fonts.bold, flex: 1 },
    tipCatBadge: { backgroundColor: t.accent.blue + '18', borderRadius: 8, paddingVertical: 3, paddingHorizontal: 8 },
    tipCatText: { color: t.accent.blue, fontSize: fonts.xs, fontWeight: fonts.bold },
    tipDesc: { color: t.text.secondary, fontSize: fonts.sm, lineHeight: 20 },
    ...
    reflectIcon: { fontSize: fonts.xxxl },
    reflectActivity: { color: t.text.primary, fontSize: fonts.md, fontWeight: fonts.bold },
    reflectHours: { color: t.text.muted, fontSize: fonts.sm, fontWeight: fonts.semibold },
    reflectFeeling: { flexDirection: 'row', alignItems: 'center', gap: 4, borderRadius: 8, paddingVertical: 3, paddingHorizontal: 8 },
    reflectFeelingIcon: { fontSize: fonts.md },
    reflectFeelingText: { fontSize: fonts.sm, fontWeight: fonts.bold },
    reflectNote: { color: t.text.secondary, fontSize: fonts.sm, lineHeight: 20, fontStyle: 'italic' },

    reflectSummary: { backgroundColor: t.accent.green + '10', borderRadius: 16, padding: 20, marginHorizontal: 20, marginTop: 4 },
    reflectSummaryTitle: { color: t.accent.green, fontSize: fonts.md, fontWeight: fonts.bold, marginBottom: 8 },
    reflectSummaryRow: { flexDirection: 'row', justifyContent: 'space-around', marginTop: 8 },
    reflectSumItem: { alignItems: 'center' },
    reflectSumNum: { fontSize: fonts.xl, fontWeight: fonts.heavy },
    reflectSumLabel: { color: t.text.muted, fontSize: fonts.xs, marginTop: 2 },
