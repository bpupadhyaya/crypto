...
export function DigitalWellbeingScreen({ onClose }: Props) {
  ...
  const s = useMemo(() => StyleSheet.create({
    ...
    heroHours: { color: t.text.primary, fontSize: 42, fontWeight: '900' },
    heroLabel: { color: t.text.muted, fontSize: 14, fontWeight: '600', marginTop: 2 },
    heroSubtext: { color: t.accent.green, fontSize: 13, fontWeight: '600', marginTop: 8 },
    ...
    catIcon: { fontSize: 28 },
    catLabel: { color: t.text.primary, fontSize: 15, fontWeight: '700' },
    catHours: { fontSize: 18, fontWeight: '800' },
    catTrend: { fontSize: 12, fontWeight: '700', marginLeft: 4 },
    ...
    communityScore: { color: t.accent.blue, fontSize: 36, fontWeight: '900' },
    communityLabel: { color: t.text.muted, fontSize: 13, fontWeight: '600', marginTop: 4 },
    ...
    challengeTitle: { color: t.text.primary, fontSize: 15, fontWeight: '700', flex: 1 },
    challengeActiveBadge: { backgroundColor: t.accent.green + '20', borderRadius: 8, paddingVertical: 3, paddingHorizontal: 8 },
    challengeActiveText: { color: t.accent.green, fontSize: 11, fontWeight: '700' },
    ...
    challengeProgress: { color: t.accent.green, fontSize: 13, fontWeight: '700' },
    challengeReward: { color: t.accent.purple, fontSize: 13, fontWeight: '700' },
    challengeStartBtn: { backgroundColor: t.accent.green + '15', borderRadius: 12, paddingVertical: 10, alignItems: 'center', marginTop: 10 },
    challengeStartText: { color: t.accent.green, fontSize: 14, fontWeight: '700' },
    ...
    tipIcon: { fontSize: 28 },
    tipTitle: { color: t.text.primary, fontSize: 15, fontWeight: '700', flex: 1 },
    tipCatBadge: { backgroundColor: t.accent.blue + '18', borderRadius: 8, paddingVertical: 3, paddingHorizontal: 8 },
    tipCatText: { color: t.accent.blue, fontSize: 11, fontWeight: '700' },
    ...
    reflectActivity: { color: t.text.primary, fontSize: 15, fontWeight: '700' },
    reflectHours: { color: t.text.muted, fontSize: 13, fontWeight: '600' },
    ...
    reflectFeelingText: { fontSize: 12, fontWeight: '700' },
    ...
    reflectSummaryTitle: { color: t.accent.green, fontSize: 15, fontWeight: '700', marginBottom: 8 },
    reflectSummaryRow: { flexDirection: 'row', justifyContent: 'space-around', marginTop: 8 },
    reflectSumItem: { alignItems: 'center' },
    reflectSumNum: { fontSize: 20, fontWeight: '800' },
