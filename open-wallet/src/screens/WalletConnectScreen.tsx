...
export function WalletConnectScreen({ onClose }: Props) {
  ...
  const s = useMemo(() => StyleSheet.create({
    ...
    input: { flex: 1, backgroundColor: t.bg.card, borderRadius: 12, padding: 14, color: t.text.primary, fontSize: 14 },
    scanBtn: { backgroundColor: t.accent.blue, borderRadius: 12, paddingHorizontal: 16, justifyContent: 'center' },
    scanBtnText: { color: '#fff', fontSize: 14, fontWeight: fonts.bold },
    ...
    connectBtnText: { color: '#fff', fontSize: 17, fontWeight: fonts.bold },
    emptyState: { alignItems: 'center', marginTop: 60, paddingHorizontal: 40 },
    emptyIcon: { fontSize: 64, marginBottom: 16 },
    emptyTitle: { color: t.text.primary, fontSize: 18, fontWeight: fonts.bold, marginBottom: 8 },
    emptyDesc: { color: t.text.muted, fontSize: 14, textAlign: 'center', lineHeight: 22 },
    ...
    sessionIcon: { fontSize: 32, marginRight: 14 },
    sessionInfo: { flex: 1 },
    sessionName: { color: t.text.primary, fontSize: 16, fontWeight: fonts.bold },
    sessionUrl: { color: t.text.muted, fontSize: 13, marginTop: 2 },
    sessionChain: { color: t.accent.blue, fontSize: 12, marginTop: 4 },
    disconnectBtn: { backgroundColor: t.accent.red + '20', borderRadius: 8, paddingVertical: 6, paddingHorizontal: 12 },
    disconnectText: { color: t.accent.red, fontSize: 12, fontWeight: fonts.bold },
    ...
    dappIcon: { fontSize: 36, marginBottom: 8 },
    dappName: { color: t.text.primary, fontSize: 14, fontWeight: fonts.semibold },
    dappType: { color: t.text.muted, fontSize: 12, marginTop: 2 },
    instructions: { color: t.text.muted, fontSize: 13, textAlign: 'center', marginHorizontal: 24, marginTop: 16, lineHeight: 20 },
  }), [t]);
