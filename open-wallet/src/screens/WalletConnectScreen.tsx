...
export function WalletConnectScreen({ onClose }: Props) {
  ...
  const s = useMemo(() => StyleSheet.create({
    ...
    emptyTitle: { color: t.text.primary, fontSize: 18, fontWeight: '700', marginBottom: 8 },
    ...
    sessionInfo: { flex: 1 },
    sessionName: { color: t.text.primary, fontSize: 16, fontWeight: '700' },
    ...
    disconnectText: { color: t.accent.red, fontSize: 12, fontWeight: '700' },
    ...
    dappName: { color: t.text.primary, fontSize: 14, fontWeight: '600' },
