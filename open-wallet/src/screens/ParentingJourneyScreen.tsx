...
export function ParentingJourneyScreen({ onClose }: Props) {
  ...
  const s = useMemo(() => StyleSheet.create({
    ...
    childBadgeText: { color: t.accent.green, fontSize: fonts.md, fontWeight: fonts.bold },
    ...
    timelineBadge: { fontSize: fonts.xxxl },
    ...
    timelineDate: { color: t.text.secondary, fontSize: fonts.sm, marginTop: 6 },
    timelineOTK: { color: t.accent.green, fontSize: fonts.sm, fontWeight: fonts.bold, marginTop: 4 },
    ...
    upcomingBadge: { fontSize: fonts.xxxl },
    upcomingInfo: { flex: 1 },
    upcomingTitle: { color: t.text.primary, fontSize: fonts.md, fontWeight: fonts.bold },
    upcomingAge: { color: t.text.muted, fontSize: fonts.sm, marginTop: 2 },
    upcomingOTK: { color: t.accent.orange, fontSize: fonts.sm, fontWeight: fonts.bold },
    ...
    communityYou: { color: t.accent.purple, fontSize: fonts.sm, fontWeight: fonts.bold },
    ...
    sleeplessTitle: { color: t.text.primary, fontSize: fonts.lg, fontWeight: fonts.heavy, textAlign: 'center' },
    sleeplessSubtitle: { color: t.text.muted, fontSize: fonts.sm, textAlign: 'center', marginTop: 8, lineHeight: 20 },
