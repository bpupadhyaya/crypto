...
export function AllergyScreen({ onClose }: Props) {
  ...
  const s = useMemo(() => StyleSheet.create({
    ...
    allergyName: { color: t.text.primary, fontSize: 16, fontWeight: '700' },
    ...
    alertTitle: { color: t.text.primary, fontSize: 14, fontWeight: '700', flex: 1, marginRight: 8 },
    alertBadge: { paddingHorizontal: 8, paddingVertical: 3, borderRadius: 8 },
    alertBadgeText: { color: '#fff', fontSize: 10, fontWeight: '700', textTransform: 'uppercase' },
    ...
    venueName: { color: t.text.primary, fontSize: 15, fontWeight: '700', flex: 1 },
    venueType: { color: t.text.muted, fontSize: 11, textTransform: 'uppercase', fontWeight: '600' },
    ...
    venueVerified: { color: t.accent.green, fontSize: 12, fontWeight: '600' },
    ...
    stepContent: { flex: 1 },
    stepTitle: { color: t.text.primary, fontSize: 15, fontWeight: '700' },
    ...
    criticalText: { color: '#FF3B30', fontSize: 10, fontWeight: '700' },
    epiCard: { backgroundColor: t.accent.green + '12', borderRadius: 12, padding: 14, marginTop: 8 },
    epiName: { color: t.text.primary, fontSize: 14, fontWeight: '600' },
    ...
    epiAvailable: { fontSize: 12, fontWeight: '600' },
