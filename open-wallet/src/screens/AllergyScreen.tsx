...
export function AllergyScreen({ onClose }: Props) {
  ...
  const s = useMemo(() => StyleSheet.create({
    ...
    allergyName: { color: t.text.primary, fontSize: fonts.lg, fontWeight: fonts.bold },
    ...
    allergyCategory: { color: t.text.muted, fontSize: fonts.sm, marginTop: 4 },
    allergyTriggers: { color: t.text.primary, fontSize: fonts.sm, marginTop: 6, lineHeight: 20 },
    allergyNotes: { color: t.text.muted, fontSize: fonts.sm, fontStyle: 'italic', marginTop: 4 },
    ...
    alertTitle: { color: t.text.primary, fontSize: fonts.md, fontWeight: fonts.bold, flex: 1, marginRight: 8 },
    alertBadge: { paddingHorizontal: 8, paddingVertical: 3, borderRadius: 8 },
    alertBadgeText: { color: '#fff', fontSize: fonts.xs, fontWeight: fonts.bold, textTransform: 'uppercase' },
    alertDesc: { color: t.text.muted, fontSize: fonts.sm, marginTop: 6, lineHeight: 20 },
    alertMeta: { color: t.text.muted, fontSize: fonts.xs, marginTop: 4 },
    ...
    venueName: { color: t.text.primary, fontSize: fonts.md, fontWeight: fonts.bold, flex: 1 },
    venueType: { color: t.text.muted, fontSize: fonts.xs, textTransform: 'uppercase', fontWeight: fonts.semibold },
    venueAccommodations: { color: t.text.primary, fontSize: fonts.sm, marginTop: 6, lineHeight: 20 },
    venueStats: { flexDirection: 'row', marginTop: 6, gap: 12 },
    venueStat: { color: t.text.muted, fontSize: fonts.sm },
    venueVerified: { color: t.accent.green, fontSize: fonts.sm, fontWeight: fonts.semibold },
    ...
    stepNumberText: { color: '#fff', fontSize: fonts.md, fontWeight: fonts.heavy },
    stepContent: { flex: 1 },
    stepTitle: { color: t.text.primary, fontSize: fonts.md, fontWeight: fonts.bold },
    stepDesc: { color: t.text.muted, fontSize: fonts.sm, marginTop: 4, lineHeight: 20 },
    ...
    criticalText: { color: '#FF3B30', fontSize: fonts.xs, fontWeight: fonts.bold },
    epiCard: { backgroundColor: t.accent.green + '12', borderRadius: 12, padding: 14, marginTop: 8 },
    epiName: { color: t.text.primary, fontSize: fonts.md, fontWeight: fonts.semibold },
    epiAddress: { color: t.text.muted, fontSize: fonts.sm, marginTop: 2 },
    epiStats: { flexDirection: 'row', justifyContent: 'space-between', marginTop: 4 },
    epiDistance: { color: t.text.muted, fontSize: fonts.sm },
    epiAvailable: { fontSize: fonts.sm, fontWeight: fonts.semibold },
