...
export function PhotoScreen({ onClose }: Props) {
  ...
  const s = useMemo(() => StyleSheet.create({
    ...
    photoPlaceholderText: { color: t.text.muted, fontSize: 12, fontWeight: fonts.semibold },
    photoTitle: { color: t.text.primary, fontSize: 16, fontWeight: fonts.bold },
    ...
    challengeTheme: { color: t.text.primary, fontSize: 16, fontWeight: fonts.bold },
    ...
    workshopTitle: { color: t.text.primary, fontSize: 16, fontWeight: fonts.bold },
    ...
    workshopReward: { color: t.accent.orange, fontSize: 13, fontWeight: fonts.bold, marginTop: 8 },
