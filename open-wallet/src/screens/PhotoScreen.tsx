...
export function PhotoScreen({ onClose }: Props) {
  ...
  const s = useMemo(() => StyleSheet.create({
    ...
    photoPlaceholderText: { color: t.text.muted, fontSize: 12, fontWeight: '600' },
    photoTitle: { color: t.text.primary, fontSize: 16, fontWeight: '700' },
    photoMeta: { color: t.text.muted, fontSize: 12, marginTop: 2 },
    photoDesc: { color: t.text.secondary, fontSize: 13, marginTop: 8, lineHeight: 19 },
    ...
    statText: { color: t.text.muted, fontSize: 12, fontWeight: '600' },
    ...
    challengeTheme: { color: t.text.primary, fontSize: 16, fontWeight: '700' },
    challengeDesc: { color: t.text.secondary, fontSize: 13, marginTop: 6, lineHeight: 19 },
    ...
    multiInput: { backgroundColor: t.bg.primary, borderRadius: 12, padding: 14, color: t.text.primary, fontSize: 15, minHeight: 80, textAlignVertical: 'top' },
    ...
    eventParticipants: { color: t.accent.green, fontSize: 12, fontWeight: '600', marginTop: 6 },
    workshopCard: { backgroundColor: t.accent.orange + '12', borderRadius: 16, padding: 20, marginHorizontal: 20, marginBottom: 16 },
    workshopTitle: { color: t.text.primary, fontSize: 16, fontWeight: '700' },
    workshopMeta: { color: t.text.muted, fontSize: 12, marginTop: 4 },
    workshopTopic: { color: t.text.secondary, fontSize: 13, marginTop: 8, lineHeight: 19 },
    workshopReward: { color: t.accent.orange, fontSize: 13, fontWeight: '700', marginTop: 8 },
