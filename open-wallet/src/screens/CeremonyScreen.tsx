...
export function CeremonyScreen({ onClose }: Props) {
  ...
  const s = useMemo(() => StyleSheet.create({
    ...
    ceremonyType: { color: t.accent.purple, fontSize: fonts.xs, fontWeight: fonts.bold, textTransform: 'uppercase', letterSpacing: 1 },
    ceremonyTitle: { color: t.text.primary, fontSize: fonts.lg, fontWeight: fonts.bold, marginTop: 4 },
    ceremonyMeta: { color: t.text.muted, fontSize: fonts.sm, marginTop: 4, lineHeight: 18 },
    ceremonyDesc: { color: t.text.secondary, fontSize: fonts.sm, marginTop: 8, lineHeight: 20 },
    ...
    attendeesText: { color: t.text.muted, fontSize: fonts.sm },
    otkText: { color: t.accent.purple, fontSize: fonts.md, fontWeight: fonts.bold },
    ...
    traditionCulture: { color: t.accent.orange, fontSize: fonts.xs, fontWeight: fonts.bold, textTransform: 'uppercase', letterSpacing: 1 },
    traditionName: { color: t.text.primary, fontSize: fonts.lg, fontWeight: fonts.bold, marginTop: 4 },
    traditionRegion: { color: t.text.muted, fontSize: fonts.sm, marginTop: 2 },
    traditionDesc: { color: t.text.secondary, fontSize: fonts.sm, marginTop: 8, lineHeight: 20 },
    ...
    elementText: { color: t.accent.orange, fontSize: fonts.xs, fontWeight: fonts.semibold },
    requestCard: { backgroundColor: t.bg.secondary, borderRadius: 14, padding: 16, marginHorizontal: 20, marginBottom: 12 },
    requestName: { color: t.text.primary, fontSize: fonts.md, fontWeight: fonts.bold },
    requestType: { color: t.accent.purple, fontSize: fonts.xs, fontWeight: fonts.bold, textTransform: 'uppercase', letterSpacing: 1, marginTop: 2 },
    requestHelp: { color: t.text.secondary, fontSize: fonts.sm, marginTop: 8, lineHeight: 20 },
    ...
    volunteerBtnText: { color: '#fff', fontSize: fonts.sm, fontWeight: fonts.semibold },
    ...
    gratitudeTitle: { color: t.text.primary, fontSize: fonts.md, fontWeight: fonts.bold },
    gratitudeChannel: { color: t.accent.purple, fontSize: fonts.xs, fontWeight: fonts.bold, textTransform: 'uppercase', letterSpacing: 1, marginTop: 2 },
    gratitudeMeta: { color: t.text.muted, fontSize: fonts.sm, marginTop: 6 },
    honoreeList: { marginTop: 8 },
    honoreeItem: { color: t.text.secondary, fontSize: fonts.sm, lineHeight: 22 },
    gratitudeOtk: { color: t.accent.purple, fontSize: fonts.lg, fontWeight: fonts.heavy, marginTop: 8 },
