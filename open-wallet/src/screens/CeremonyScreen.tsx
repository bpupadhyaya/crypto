...
export function CeremonyScreen({ onClose }: Props) {
  ...
  const s = useMemo(() => StyleSheet.create({
    ...
    ceremonyType: { color: t.accent.purple, fontSize: 11, fontWeight: '700', textTransform: 'uppercase', letterSpacing: 1 },
    ceremonyTitle: { color: t.text.primary, fontSize: 16, fontWeight: '700', marginTop: 4 },
    ...
    otkText: { color: t.accent.purple, fontSize: 14, fontWeight: '700' },
    ...
    traditionCulture: { color: t.accent.orange, fontSize: 11, fontWeight: '700', textTransform: 'uppercase', letterSpacing: 1 },
    traditionName: { color: t.text.primary, fontSize: 16, fontWeight: '700', marginTop: 4 },
    ...
    elementText: { color: t.accent.orange, fontSize: 11, fontWeight: '600' },
    requestCard: { backgroundColor: t.bg.secondary, borderRadius: 14, padding: 16, marginHorizontal: 20, marginBottom: 12 },
    requestName: { color: t.text.primary, fontSize: 15, fontWeight: '700' },
    requestType: { color: t.accent.purple, fontSize: 11, fontWeight: '700', textTransform: 'uppercase', letterSpacing: 1, marginTop: 2 },
    ...
    volunteerBtnText: { color: '#fff', fontSize: 13, fontWeight: '600' },
    ...
    gratitudeTitle: { color: t.text.primary, fontSize: 15, fontWeight: '700' },
    gratitudeChannel: { color: t.accent.purple, fontSize: 11, fontWeight: '700', textTransform: 'uppercase', letterSpacing: 1, marginTop: 2 },
    ...
    gratitudeOtk: { color: t.accent.purple, fontSize: 16, fontWeight: '800', marginTop: 8 },
