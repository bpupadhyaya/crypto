...
export function PredictionScreen({ onClose }: Props) {
  ...
  const st = useMemo(() => StyleSheet.create({
    ...
    cardSub: { color: t.text.secondary, fontSize: fonts.sm, lineHeight: 19 },
    ...
    optionLabel: { color: t.text.primary, fontSize: fonts.md, fontWeight: fonts.semibold, flex: 1 },
    optionStake: { color: t.accent.blue, fontSize: fonts.sm, fontWeight: fonts.bold, marginRight: 12 },
    optionVoters: { color: t.text.muted, fontSize: fonts.sm },
    ...
    totalStake: { color: t.text.secondary, fontSize: fonts.sm, fontWeight: fonts.semibold, marginTop: 10 },
    stakeRow: { flexDirection: 'row', gap: 8, marginTop: 10 },
    stakeInput: { flex: 1, backgroundColor: t.bg.primary, borderRadius: 10, padding: 10, color: t.text.primary, fontSize: fonts.md },
    stakeBtn: { backgroundColor: t.accent.blue, borderRadius: 10, paddingVertical: 10, paddingHorizontal: 16, justifyContent: 'center' },
    stakeBtnText: { color: '#fff', fontSize: fonts.sm, fontWeight: fonts.bold },
    ...
    betResult: { fontSize: fonts.sm, fontWeight: fonts.bold, marginTop: 6 },
    ...
    resolvedBadgeText: { color: '#fff', fontSize: fonts.xs, fontWeight: fonts.bold },
