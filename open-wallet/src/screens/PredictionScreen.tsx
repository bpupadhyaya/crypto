...
export function PredictionScreen({ onClose }: Props) {
  ...
  const st = useMemo(() => StyleSheet.create({
    ...
    optionLabel: { color: t.text.primary, fontSize: 14, fontWeight: fonts.semibold, flex: 1 },
    optionStake: { color: t.accent.blue, fontSize: 13, fontWeight: fonts.bold, marginRight: 12 },
    ...
    totalStake: { color: t.text.secondary, fontSize: 13, fontWeight: fonts.semibold, marginTop: 10 },
    ...
    stakeBtnText: { color: '#fff', fontSize: 13, fontWeight: fonts.bold },
    ...
    betResult: { fontSize: 13, fontWeight: fonts.bold, marginTop: 6 },
    ...
    resolvedBadgeText: { color: '#fff', fontSize: 11, fontWeight: fonts.bold },
