...
export function SeasonalScreen({ onClose }: Props) {
  ...
  const s = useMemo(() => StyleSheet.create({
    ...
    heroTitle: { color: t.text.primary, fontSize: 24, fontWeight: fonts.heavy, textAlign: 'center' as const },
    heroSubtitle: { color: t.text.muted, fontSize: 13, textAlign: 'center' as const, marginTop: 4, lineHeight: 20 },
    heroDates: { color: t.accent.green, fontSize: 12, fontWeight: fonts.bold, marginTop: 8 },
    seasonDesc: { color: t.text.secondary, fontSize: 14, lineHeight: 22, marginHorizontal: 20, marginBottom: 16 },
    // Bullet lists
    bulletCard: { backgroundColor: t.bg.secondary, borderRadius: 16, padding: 16, marginHorizontal: 20, marginBottom: 16 },
    bulletTitle: { color: t.text.primary, fontSize: 15, fontWeight: fonts.bold, marginBottom: 10 },
    bulletItem: { flexDirection: 'row', marginBottom: 8 },
    bulletDot: { color: t.accent.green, fontSize: 14, fontWeight: fonts.heavy, marginRight: 8, marginTop: 1 },
    bulletText: { color: t.text.secondary, fontSize: 13, lineHeight: 20, flex: 1 },
    // Festival cards
    festivalCard: { backgroundColor: t.bg.secondary, borderRadius: 16, padding: 16, marginHorizontal: 20, marginBottom: 12 },
    festivalName: { color: t.text.primary, fontSize: 17, fontWeight: fonts.bold },
    festivalCulture: { color: t.accent.purple, fontSize: 12, fontWeight: fonts.semibold, marginTop: 2 },
    festivalDate: { color: t.accent.green, fontSize: 12, fontWeight: fonts.bold, marginTop: 4 },
    festivalDesc: { color: t.text.secondary, fontSize: 13, lineHeight: 20, marginTop: 8 },
    festivalTraditions: { marginTop: 10 },
    traditionLabel: { color: t.text.primary, fontSize: 13, fontWeight: fonts.bold, marginBottom: 6 },
    traditionItem: { flexDirection: 'row', marginBottom: 4 },
    traditionDot: { color: t.accent.orange, fontSize: 12, fontWeight: fonts.heavy, marginRight: 6, marginTop: 1 },
    traditionText: { color: t.text.secondary, fontSize: 13 },
    ...
    foodName: { color: t.text.primary, fontSize: 16, fontWeight: fonts.bold },
    inSeasonBadge: { backgroundColor: t.accent.green + '20', paddingHorizontal: 8, paddingVertical: 2, borderRadius: 8 },
    inSeasonText: { color: t.accent.green, fontSize: 11, fontWeight: fonts.bold },
    foodCategory: { color: t.text.muted, fontSize: 12, marginTop: 2, textTransform: 'capitalize' as const },
    foodRegion: { color: t.accent.purple, fontSize: 12, fontWeight: fonts.semibold, marginTop: 4 },
    foodNutrition: { color: t.text.secondary, fontSize: 13, lineHeight: 20, marginTop: 6 },
    // Activity cards
    activityCard: { backgroundColor: t.bg.secondary, borderRadius: 16, padding: 16, marginHorizontal: 20, marginBottom: 12 },
    activityName: { color: t.text.primary, fontSize: 16, fontWeight: fonts.bold },
    activityMeta: { flexDirection: 'row', gap: 12, marginTop: 4 },
    activityMetaText: { color: t.text.muted, fontSize: 12 },
    activityDesc: { color: t.text.secondary, fontSize: 13, lineHeight: 20, marginTop: 8 },
    // Nature observation
    obsCard: { backgroundColor: t.bg.secondary, borderRadius: 16, padding: 16, marginHorizontal: 20, marginBottom: 12 },
    obsType: { color: t.accent.green, fontSize: 12, fontWeight: fonts.bold, textTransform: 'uppercase' as const, letterSpacing: 1 },
    obsDesc: { color: t.text.primary, fontSize: 14, fontWeight: fonts.semibold, marginTop: 4 },
    obsMeta: { flexDirection: 'row', justifyContent: 'space-between', marginTop: 8 },
    obsLocation: { color: t.text.muted, fontSize: 12 },
    obsDate: { color: t.text.muted, fontSize: 12 },
    obsVerified: { color: t.accent.green, fontSize: 11, fontWeight: fonts.semibold },
    ...
    logObsBtnText: { color: '#fff', fontSize: 16, fontWeight: fonts.bold },
