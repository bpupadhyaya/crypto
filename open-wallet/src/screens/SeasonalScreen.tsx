...
export function SeasonalScreen({ onClose }: Props) {
  ...
  const s = useMemo(() => StyleSheet.create({
    ...
    heroTitle: { color: t.text.primary, fontSize: 24, fontWeight: '900', textAlign: 'center' as const },
    heroSubtitle: { color: t.text.muted, fontSize: 13, textAlign: 'center' as const, marginTop: 4, lineHeight: 20 },
    heroDates: { color: t.accent.green, fontSize: 12, fontWeight: '700', marginTop: 8 },
    ...
    bulletTitle: { color: t.text.primary, fontSize: 15, fontWeight: '700', marginBottom: 10 },
    bulletItem: { flexDirection: 'row', marginBottom: 8 },
    bulletDot: { color: t.accent.green, fontSize: 14, fontWeight: '800', marginRight: 8, marginTop: 1 },
    ...
    festivalName: { color: t.text.primary, fontSize: 17, fontWeight: '700' },
    festivalCulture: { color: t.accent.purple, fontSize: 12, fontWeight: '600', marginTop: 2 },
    festivalDate: { color: t.accent.green, fontSize: 12, fontWeight: '700', marginTop: 4 },
    festivalDesc: { color: t.text.secondary, fontSize: 13, lineHeight: 20, marginTop: 8 },
    festivalTraditions: { marginTop: 10 },
    traditionLabel: { color: t.text.primary, fontSize: 13, fontWeight: '700', marginBottom: 6 },
    traditionItem: { flexDirection: 'row', marginBottom: 4 },
    traditionDot: { color: t.accent.orange, fontSize: 12, fontWeight: '800', marginRight: 6, marginTop: 1 },
    ...
    activityName: { color: t.text.primary, fontSize: 16, fontWeight: '700' },
    ...
    obsType: { color: t.accent.green, fontSize: 12, fontWeight: '700', textTransform: 'uppercase' as const, letterSpacing: 1 },
    obsDesc: { color: t.text.primary, fontSize: 14, fontWeight: '600', marginTop: 4 },
    ...
    obsVerified: { color: t.accent.green, fontSize: 11, fontWeight: '600' },
    ...
    logObsBtnText: { color: '#fff', fontSize: 16, fontWeight: '700' },
