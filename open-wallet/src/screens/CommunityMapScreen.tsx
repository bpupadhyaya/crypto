...
export function CommunityMapScreen({ onClose }: Props) {
  ...
  const st = useMemo(() => StyleSheet.create({
    ...
    ratingText: { color: '#eab308', fontSize: 14, fontWeight: '700' },
    ...
    unverifiedText: { color: t.text.muted, fontSize: 9, fontWeight: '700' },
    ...
    accessText: { color: t.accent.blue, fontSize: 10, fontWeight: '600' },
    favBtn: { padding: 6 },
    favText: { fontSize: 20 },
    ...
    formLabel: { color: t.text.muted, fontSize: 11, fontWeight: '600', textTransform: 'uppercase', letterSpacing: 1, marginBottom: 4 },
    ...
    successText: { color: '#22c55e', fontSize: 16, fontWeight: '700', marginTop: 8 },
