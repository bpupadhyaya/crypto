...
export function KnowledgeBaseScreen({ onClose }: Props) {
  ...
  const st = useMemo(() => StyleSheet.create({
    ...
    catName: { color: t.text.primary, fontSize: 13, fontWeight: '700', textAlign: 'center' },
    catCount: { color: t.text.muted, fontSize: 11, marginTop: 2 },
    articleTitle: { color: t.text.primary, fontSize: 15, fontWeight: '700', marginBottom: 4 },
    ...
    verifiedBadge: { color: t.accent.green, fontSize: 11, fontWeight: '700' },
    ...
    rewardText: { color: t.accent.green, fontSize: 11, fontWeight: '700' },
