...
export function TransportScreen({ onClose }: Props) {
  ...
  const s = useMemo(() => StyleSheet.create({
    ...
    rideDriver: { color: t.text.primary, fontSize: fonts.md, fontWeight: fonts.bold },
    rideAccessibleBadge: { backgroundColor: t.accent.blue + '20', paddingHorizontal: 8, paddingVertical: 2, borderRadius: 6 },
    rideAccessibleText: { color: t.accent.blue, fontSize: fonts.xs, fontWeight: fonts.bold },
    rideRoute: { color: t.text.primary, fontSize: fonts.md, fontWeight: fonts.semibold, marginTop: 8 },
    rideMeta: { color: t.text.muted, fontSize: fonts.sm, marginTop: 4 },
    rideFooter: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', marginTop: 12 },
    rideCO2: { color: t.accent.green, fontSize: fonts.sm, fontWeight: fonts.semibold },
    rideRequestBtn: { backgroundColor: t.accent.blue, paddingHorizontal: 16, paddingVertical: 8, borderRadius: 10 },
    rideRequestText: { color: '#fff', fontSize: fonts.sm, fontWeight: fonts.semibold },
    ...
    accessibleToggleText: { color: t.text.primary, fontSize: fonts.md, fontWeight: fonts.semibold, marginLeft: 8 },
    ...
    routeName: { color: t.text.primary, fontSize: fonts.md, fontWeight: fonts.bold },
    routeMeta: { color: t.text.muted, fontSize: fonts.sm, marginTop: 4 },
    ...
    stopText: { color: t.text.primary, fontSize: fonts.sm },
    ...
    nextDeparture: { color: t.accent.green, fontSize: fonts.md, fontWeight: fonts.bold },
    riderCount: { color: t.text.muted, fontSize: fonts.sm },
    accessCard: { backgroundColor: t.bg.secondary, borderRadius: 14, padding: 16, marginHorizontal: 20, marginBottom: 12 },
    accessType: { color: t.text.primary, fontSize: fonts.md, fontWeight: fonts.bold },
    accessProvider: { color: t.accent.blue, fontSize: fonts.sm, fontWeight: fonts.semibold, marginTop: 2 },
    accessDesc: { color: t.text.muted, fontSize: fonts.sm, marginTop: 6 },
    featureList: { marginTop: 8 },
    featureItem: { color: t.text.primary, fontSize: fonts.sm, marginBottom: 2 },
    accessMeta: { color: t.text.muted, fontSize: fonts.sm, marginTop: 8 },
