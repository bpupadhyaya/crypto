...
export function SkillVerificationScreen({ onClose }: Props) {
  ...
  const s = useMemo(() => StyleSheet.create({
    ...
    credBadge: { fontSize: fonts.hero, marginBottom: 8 },
    credTitle: { color: t.text.primary, fontSize: fonts.md, fontWeight: fonts.bold },
    credType: { fontSize: fonts.xs, fontWeight: fonts.bold, marginTop: 4, textTransform: 'uppercase', letterSpacing: 0.8 },
    credIssuer: { color: t.text.muted, fontSize: fonts.sm, marginTop: 4 },
    credDate: { color: t.text.muted, fontSize: fonts.xs, marginTop: 2 },
    credDesc: { color: t.text.secondary, fontSize: fonts.sm, marginTop: 6, lineHeight: 18 },
    ...
    verifyCount: { color: t.text.muted, fontSize: fonts.xs },
    soulbound: { color: t.accent.orange, fontSize: fonts.xs, fontWeight: fonts.bold, marginTop: 6, textTransform: 'uppercase', letterSpacing: 1 },
    ...
    shareBtnText: { color: t.accent.blue, fontSize: fonts.sm, fontWeight: fonts.semibold },
    shareBox: { backgroundColor: t.bg.primary, borderRadius: 12, padding: 14, marginTop: 8, borderWidth: 1, borderColor: t.border },
    shareTitle: { color: t.text.primary, fontSize: fonts.sm, fontWeight: fonts.bold, marginBottom: 6 },
    shareOption: { flexDirection: 'row', alignItems: 'center', paddingVertical: 8, gap: 10 },
    shareOptionIcon: { fontSize: fonts.xl },
    shareOptionText: { color: t.text.secondary, fontSize: fonts.sm },
    shareNote: { color: t.text.muted, fontSize: fonts.xs, marginTop: 8, fontStyle: 'italic' },
    // Verify tab
    input: { backgroundColor: t.bg.card, borderRadius: 12, padding: 14, color: t.text.primary, fontSize: fonts.md, borderWidth: 1, borderColor: t.border, marginBottom: 12 },
    ...
    secondaryBtnText: { color: '#fff', fontSize: fonts.lg, fontWeight: fonts.bold },
    ...
    scanBtnText: { color: t.text.secondary, fontSize: fonts.md, fontWeight: fonts.semibold },
    orText: { color: t.text.muted, fontSize: fonts.sm, textAlign: 'center', marginBottom: 12 },
    // Workflow
    workflowCard: { backgroundColor: t.bg.card, borderRadius: 16, padding: 16, marginTop: 12 },
    workflowTitle: { color: t.text.primary, fontSize: fonts.md, fontWeight: fonts.bold, marginBottom: 12 },
    workflowStep: { flexDirection: 'row', alignItems: 'flex-start', marginBottom: 12, gap: 12 },
    workflowIcon: { fontSize: fonts.xxl, width: 32, textAlign: 'center' },
    workflowInfo: { flex: 1 },
    workflowLabel: { color: t.text.primary, fontSize: fonts.sm, fontWeight: fonts.bold },
    workflowDesc: { color: t.text.muted, fontSize: fonts.xs, marginTop: 2 },
    ...
    issuerBadge: { fontSize: fonts.xxxl },
    issuerInfo: { flex: 1 },
    issuerName: { color: t.text.primary, fontSize: fonts.md, fontWeight: fonts.bold },
    issuerMeta: { color: t.text.muted, fontSize: fonts.xs, marginTop: 2 },
    issuerTrust: { alignItems: 'center' },
    issuerTrustValue: { color: t.accent.green, fontSize: fonts.lg, fontWeight: fonts.heavy },
    issuerTrustLabel: { color: t.text.muted, fontSize: fonts.xs },
    toggleBtn: { flexDirection: 'row', alignItems: 'center', justifyContent: 'center', paddingVertical: 10, marginTop: 8 },
    toggleBtnText: { color: t.accent.blue, fontSize: fonts.sm, fontWeight: fonts.semibold },
    // Endorsements
    endorseCard: { backgroundColor: t.bg.card, borderRadius: 16, padding: 16, marginBottom: 12 },
    endorseBadge: { fontSize: fonts.hero, marginBottom: 8 },
    endorseSkill: { color: t.text.primary, fontSize: fonts.md, fontWeight: fonts.bold },
    endorseFrom: { color: t.accent.blue, fontSize: fonts.sm, fontWeight: fonts.semibold, marginTop: 4 },
    endorseScore: { color: t.text.muted, fontSize: fonts.xs, marginTop: 2 },
    endorseMessage: { color: t.text.secondary, fontSize: fonts.sm, marginTop: 8, lineHeight: 20, fontStyle: 'italic' },
    endorseDate: { color: t.text.muted, fontSize: fonts.xs, marginTop: 6 },
    endorseNote: { color: t.text.muted, fontSize: fonts.xs, textAlign: 'center', marginTop: 8, lineHeight: 16 },
    emptyText: { color: t.text.muted, fontSize: fonts.sm, textAlign: 'center', marginTop: 24 },
  }), [t]);
