...
export function SkillVerificationScreen({ onClose }: Props) {
  ...
  const s = useMemo(() => StyleSheet.create({
    ...
    credTitle: { color: t.text.primary, fontSize: 15, fontWeight: '700' },
    credType: { fontSize: 11, fontWeight: '700', marginTop: 4, textTransform: 'uppercase', letterSpacing: 0.8 },
    ...
    shareBtnText: { color: t.accent.blue, fontSize: 12, fontWeight: '600' },
    shareBox: { backgroundColor: t.bg.primary, borderRadius: 12, padding: 14, marginTop: 8, borderWidth: 1, borderColor: t.border },
    shareTitle: { color: t.text.primary, fontSize: 13, fontWeight: '700', marginBottom: 6 },
    ...
    scanBtnText: { color: t.text.secondary, fontSize: 14, fontWeight: '600' },
    ...
    workflowTitle: { color: t.text.primary, fontSize: 14, fontWeight: '700', marginBottom: 12 },
    ...
    workflowInfo: { flex: 1 },
    workflowLabel: { color: t.text.primary, fontSize: 13, fontWeight: '700' },
    ...
    issuerInfo: { flex: 1 },
    issuerName: { color: t.text.primary, fontSize: 14, fontWeight: '700' },
    issuerMeta: { color: t.text.muted, fontSize: 11, marginTop: 2 },
    issuerTrust: { alignItems: 'center' },
    issuerTrustValue: { color: t.accent.green, fontSize: 16, fontWeight: '800' },
    ...
    toggleBtnText: { color: t.accent.blue, fontSize: 13, fontWeight: '600' },
    // Endorsements
    endorseCard: { backgroundColor: t.bg.card, borderRadius: 16, padding: 16, marginBottom: 12 },
    endorseBadge: { fontSize: 32, marginBottom: 8 },
    endorseSkill: { color: t.text.primary, fontSize: 15, fontWeight: '700' },
    endorseFrom: { color: t.accent.blue, fontSize: 12, fontWeight: '600', marginTop: 4 },
