...
export function EnergyAuditScreen({ onClose }: Props) {
  ...
  const s = useMemo(() => StyleSheet.create({
    ...
    auditInfo: { flex: 1 },
    auditItem: { color: t.text.primary, fontSize: 14, fontWeight: '600' },
    auditRoom: { color: t.text.muted, fontSize: 12, marginTop: 2 },
    auditSaving: { color: t.accent.green, fontSize: 14, fontWeight: '700' },
    ...
    tipSavings: { color: t.accent.green, fontSize: 14, fontWeight: '700', marginTop: 8 },
    ...
    calcText: { color: '#fff', fontSize: 15, fontWeight: '700' },
