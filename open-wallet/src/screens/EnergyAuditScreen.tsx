...
export function EnergyAuditScreen({ onClose }: Props) {
  ...
  const s = useMemo(() => StyleSheet.create({
    ...
    auditInfo: { flex: 1 },
    auditItem: { color: t.text.primary, fontSize: fonts.md, fontWeight: fonts.semibold },
    auditRoom: { color: t.text.muted, fontSize: fonts.sm, marginTop: 2 },
    auditSaving: { color: t.accent.green, fontSize: fonts.md, fontWeight: fonts.bold },
    ...
    tipMeta: { color: t.text.muted, fontSize: fonts.sm, marginTop: 4 },
    tipSavings: { color: t.accent.green, fontSize: fonts.md, fontWeight: fonts.bold, marginTop: 8 },
    ...
    calcText: { color: '#fff', fontSize: fonts.md, fontWeight: fonts.bold },
