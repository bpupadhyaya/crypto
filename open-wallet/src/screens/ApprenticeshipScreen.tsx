...
export function ApprenticeshipScreen({ onClose }: Props) {
  ...
  const s = useMemo(() => StyleSheet.create({
    ...
    tradeName: { color: t.text.primary, fontSize: 17, fontWeight: '700' },
    ...
    stipend: { color: t.accent.green, fontSize: 15, fontWeight: '700' },
    ...
    progressPercent: { color: t.text.primary, fontSize: 48, fontWeight: '900' },
    ...
    milestoneTitle: { color: t.text.primary, fontSize: 14, fontWeight: '600', flex: 1 },
    milestoneDate: { color: t.text.muted, fontSize: 11, marginTop: 2 },
    milestoneEOTK: { color: t.accent.green, fontSize: 12, fontWeight: '600' },
    ...
    gradBtnText: { color: t.accent.purple, fontSize: 15, fontWeight: '700' },
    // Masters
    masterCard: { backgroundColor: t.bg.secondary, borderRadius: 16, padding: 20, marginHorizontal: 20, marginBottom: 16 },
    masterName: { color: t.text.primary, fontSize: 17, fontWeight: '700' },
    masterTrade: { color: t.accent.orange, fontSize: 13, fontWeight: '600', marginTop: 2 },
    masterBio: { color: t.text.secondary, fontSize: 13, marginTop: 8, lineHeight: 18 },
    masterStat: { alignItems: 'center' },
    masterStatVal: { color: t.text.primary, fontSize: 18, fontWeight: '800' },
    ...
    certText: { color: t.accent.purple, fontSize: 11, fontWeight: '600' },
    ...
    tradePillText: { color: t.text.muted, fontSize: 13, fontWeight: '600' },
    tradePillTextActive: { color: t.accent.orange },
    durationText: { color: t.text.muted, fontSize: 12, marginTop: 4 },
    ratingText: { color: '#FF9500', fontSize: 13, fontWeight: '600' },
    ...
    iconText: { color: t.accent.orange, fontSize: 18, fontWeight: '800' },
  }), [t]);
              ...
              {activeApprenticeship.milestones.map((m) => (
                <View key={m.id} style={s.milestoneItem}>
                  <View style={[s.milestoneCheck, {
                    ...
                    {m.completed && <Text style={{ color: t.accent.green, fontWeight: '800', fontSize: 12 }}>+</Text>}
                  </View>
                  <View style={{ flex: 1 }}>
