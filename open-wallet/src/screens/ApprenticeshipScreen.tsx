...
export function ApprenticeshipScreen({ onClose }: Props) {
  ...
  const s = useMemo(() => StyleSheet.create({
    ...
    tradeName: { color: t.text.primary, fontSize: fonts.lg, fontWeight: fonts.bold },
    masterLabel: { color: t.text.muted, fontSize: fonts.sm, marginTop: 2 },
    ...
    stipend: { color: t.accent.green, fontSize: fonts.md, fontWeight: fonts.bold },
    stipendLabel: { color: t.text.muted, fontSize: fonts.xs },
    ...
    spots: { color: t.text.muted, fontSize: fonts.sm, marginTop: 4 },
    ...
    detailBack: { color: t.accent.blue, fontSize: fonts.md, marginBottom: 12, marginHorizontal: 20 },
    // Progress
    progressHeader: { alignItems: 'center', marginBottom: 16 },
    progressPercent: { color: t.text.primary, fontSize: 48, fontWeight: fonts.heavy },
    progressLabel: { color: t.text.muted, fontSize: fonts.sm, textTransform: 'uppercase', letterSpacing: 1 },
    ...
    milestoneTitle: { color: t.text.primary, fontSize: fonts.md, fontWeight: fonts.semibold, flex: 1 },
    milestoneDate: { color: t.text.muted, fontSize: fonts.xs, marginTop: 2 },
    milestoneEOTK: { color: t.accent.green, fontSize: fonts.sm, fontWeight: fonts.semibold },
    ...
    gradBtnText: { color: t.accent.purple, fontSize: fonts.md, fontWeight: fonts.bold },
    // Masters
    masterCard: { backgroundColor: t.bg.secondary, borderRadius: 16, padding: 20, marginHorizontal: 20, marginBottom: 16 },
    masterName: { color: t.text.primary, fontSize: fonts.lg, fontWeight: fonts.bold },
    masterTrade: { color: t.accent.orange, fontSize: fonts.sm, fontWeight: fonts.semibold, marginTop: 2 },
    masterBio: { color: t.text.secondary, fontSize: fonts.sm, marginTop: 8, lineHeight: 18 },
    masterStat: { alignItems: 'center' },
    masterStatVal: { color: t.text.primary, fontSize: fonts.xl, fontWeight: fonts.heavy },
    masterStatLbl: { color: t.text.muted, fontSize: fonts.xs, marginTop: 2, textAlign: 'center' },
    ...
    certText: { color: t.accent.purple, fontSize: fonts.xs, fontWeight: fonts.semibold },
    ...
    tradePillText: { color: t.text.muted, fontSize: fonts.sm, fontWeight: fonts.semibold },
    tradePillTextActive: { color: t.accent.orange },
    durationText: { color: t.text.muted, fontSize: fonts.sm, marginTop: 4 },
    ratingText: { color: '#FF9500', fontSize: fonts.sm, fontWeight: fonts.semibold },
    ...
    iconText: { color: t.accent.orange, fontSize: fonts.xl, fontWeight: fonts.heavy },
  }), [t]);
              ...
              {activeApprenticeship.milestones.map((m) => (
                <View key={m.id} style={s.milestoneItem}>
                  <View style={[s.milestoneCheck, {
                    ...
                    {m.completed && <Text style={{ color: t.accent.green, fontWeight: fonts.heavy, fontSize: fonts.sm }}>+</Text>}
                  </View>
                  <View style={{ flex: 1 }}>
