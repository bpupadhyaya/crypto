...
export const CloudBackupScreen = React.memo(({ onClose }: Props) => {
  ...
  const s = useMemo(() => StyleSheet.create({
    ...
    infoText: { color: t.text.secondary, fontSize: 13, lineHeight: 20 },
    warningBox: {
      backgroundColor: t.accent.red + '10', borderRadius: 12,
      padding: 16, marginBottom: 16,
    },
    warningText: { color: t.accent.red, fontSize: 13, lineHeight: 20 },
    input: {
      backgroundColor: t.bg.card, borderRadius: 12, padding: 16,
      color: t.text.primary, fontSize: 16, marginBottom: 12,
      borderWidth: 1, borderColor: t.border,
    },
    restoreInput: {
      backgroundColor: t.bg.card, borderRadius: 12, padding: 16,
      color: t.text.primary, fontSize: 13, marginBottom: 12,
      borderWidth: 1, borderColor: t.border,
    ...
    itemDot: { color: t.accent.green, fontSize: 14, marginRight: 8 },
    itemText: { color: t.text.secondary, fontSize: 13, flex: 1 },
    excludeRow: { flexDirection: 'row', paddingVertical: 6, paddingHorizontal: 16 },
    excludeDot: { color: t.accent.red, fontSize: 14, marginRight: 8 },
    excludeText: { color: t.text.muted, fontSize: 13, flex: 1 },
  }), [t]);
