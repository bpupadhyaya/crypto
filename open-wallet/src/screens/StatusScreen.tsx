...
export function StatusScreen({ onClose }: Props) {
  ...
  const s = useMemo(() => StyleSheet.create({
    ...
    overallLabel: { color: t.text.muted, fontSize: fonts.sm, textTransform: 'uppercase', letterSpacing: 1 },
    overallValue: { color: t.accent.green, fontSize: fonts.hero, fontWeight: fonts.heavy, marginTop: 4 },
    overallSub: { color: t.text.muted, fontSize: fonts.sm, marginTop: 8 },
    ...
    rowLabel: { color: t.text.primary, fontSize: fonts.md, fontWeight: fonts.semibold, flex: 1 },
    rowValue: { fontSize: fonts.md, fontWeight: fonts.semibold, textAlign: 'right' },
    ...
    syncIconText: { fontSize: fonts.lg },
    syncInfo: { flex: 1 },
    syncType: { color: t.text.primary, fontSize: fonts.md, fontWeight: fonts.semibold },
    syncTarget: { color: t.text.muted, fontSize: fonts.sm, marginTop: 2 },
    syncBadge: { paddingHorizontal: 10, paddingVertical: 4, borderRadius: 10 },
    syncBadgeText: { fontSize: fonts.xs, fontWeight: fonts.bold, textTransform: 'uppercase' },
    ...
    actionBtnText: { fontSize: fonts.md, fontWeight: fonts.bold },
    philosophy: { color: t.text.muted, fontSize: fonts.xs, textAlign: 'center', marginHorizontal: 40, marginTop: 16, lineHeight: 16 },
  }), [t]);
