...
export function TranslationScreen({ onClose }: Props) {
  ...
  const s = useMemo(() => StyleSheet.create({
    ...
    reqTitle: { color: t.text.primary, fontSize: 15, fontWeight: '700' },
    reqMeta: { color: t.text.muted, fontSize: 12, marginTop: 4 },
    langRow: { flexDirection: 'row', alignItems: 'center', marginTop: 8 },
    langText: { color: t.accent.blue, fontSize: 13, fontWeight: '600' },
    ...
    urgencyText: { color: '#fff', fontSize: 11, fontWeight: '600', textTransform: 'uppercase' },
    ...
    langChipText: { color: t.text.muted, fontSize: 12, fontWeight: '600' },
    ...
    histTitle: { color: t.text.primary, fontSize: 14, fontWeight: '600' },
    histMeta: { color: t.text.muted, fontSize: 12, marginTop: 4 },
    histCotk: { color: t.accent.green, fontSize: 13, fontWeight: '700', marginTop: 4 },
