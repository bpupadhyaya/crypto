...
export function TranslationScreen({ onClose }: Props) {
  ...
  const s = useMemo(() => StyleSheet.create({
    ...
    reqTitle: { color: t.text.primary, fontSize: fonts.md, fontWeight: fonts.bold },
    reqMeta: { color: t.text.muted, fontSize: fonts.sm, marginTop: 4 },
    langRow: { flexDirection: 'row', alignItems: 'center', marginTop: 8 },
    langText: { color: t.accent.blue, fontSize: fonts.sm, fontWeight: fonts.semibold },
    langArrow: { color: t.text.muted, fontSize: fonts.sm, marginHorizontal: 8 },
    urgencyBadge: { paddingHorizontal: 8, paddingVertical: 2, borderRadius: 8, alignSelf: 'flex-start', marginTop: 6 },
    urgencyText: { color: '#fff', fontSize: fonts.xs, fontWeight: fonts.semibold, textTransform: 'uppercase' },
    ...
    acceptText: { color: '#fff', fontSize: fonts.sm, fontWeight: fonts.semibold },
    input: { backgroundColor: t.bg.primary, borderRadius: 12, padding: 14, color: t.text.primary, fontSize: fonts.md, marginBottom: 12, minHeight: 80, textAlignVertical: 'top' },
    ...
    langChipText: { color: t.text.muted, fontSize: fonts.sm, fontWeight: fonts.semibold },
    ...
    histTitle: { color: t.text.primary, fontSize: fonts.md, fontWeight: fonts.semibold },
    histMeta: { color: t.text.muted, fontSize: fonts.sm, marginTop: 4 },
    histCotk: { color: t.accent.green, fontSize: fonts.sm, fontWeight: fonts.bold, marginTop: 4 },
