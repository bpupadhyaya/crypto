...
export function LivingLedgerScreen({ onClose, onSendGratitude }: Props) {
  ...
  const s = useMemo(() => StyleSheet.create({
    ...
    summaryNumber: { color: t.text.primary, fontSize: 20, fontWeight: fonts.heavy },
    summaryLabel: { color: t.text.muted, fontSize: 11, marginTop: 2 },
    section: { color: t.text.secondary, fontSize: 12, fontWeight: fonts.bold, textTransform: 'uppercase', letterSpacing: 1.5, marginLeft: 24, marginBottom: 12, marginTop: 28 },
    ...
    channelInfo: { flex: 1 },
    channelName: { color: t.text.primary, fontSize: 14, fontWeight: fonts.semibold },
    channelValues: { color: t.text.muted, fontSize: 12, marginTop: 2 },
    channelBar: { height: 4, borderRadius: 2, marginTop: 6 },
    channelAmount: { color: t.text.secondary, fontSize: 14, fontWeight: fonts.bold },
    ...
    entryType: { fontSize: 12, fontWeight: fonts.bold, textTransform: 'uppercase', letterSpacing: 1 },
    entryTime: { color: t.text.muted, fontSize: 11 },
    entryMessage: { color: t.text.secondary, fontSize: 13, marginTop: 4, fontStyle: 'italic' },
    entryAmount: { color: t.accent.green, fontSize: 14, fontWeight: fonts.bold, marginTop: 4 },
    ...
    gratitudeBtnText: { color: '#fff', fontSize: 17, fontWeight: fonts.bold },
