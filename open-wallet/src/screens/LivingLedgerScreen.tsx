...
export function LivingLedgerScreen({ onClose, onSendGratitude }: Props) {
  ...
  const s = useMemo(() => StyleSheet.create({
    ...
    scoreLabel: { color: t.text.muted, fontSize: fonts.sm, textTransform: 'uppercase', letterSpacing: 1.5 },
    scoreValue: { color: t.accent.green, fontSize: 42, fontWeight: fonts.heavy, marginTop: 4 },
    scoreSubtext: { color: t.text.secondary, fontSize: fonts.sm, marginTop: 8 },
    summaryRow: { flexDirection: 'row', justifyContent: 'space-around', marginTop: 20 },
    summaryItem: { alignItems: 'center' },
    summaryNumber: { color: t.text.primary, fontSize: fonts.xl, fontWeight: fonts.heavy },
    ...
    channelIcon: { fontSize: fonts.xxl, marginRight: 12 },
    channelInfo: { flex: 1 },
    channelName: { color: t.text.primary, fontSize: fonts.md, fontWeight: fonts.semibold },
    channelValues: { color: t.text.muted, fontSize: fonts.sm, marginTop: 2 },
    channelBar: { height: 4, borderRadius: 2, marginTop: 6 },
    channelAmount: { color: t.text.secondary, fontSize: fonts.md, fontWeight: fonts.bold },
    ...
    entryType: { fontSize: fonts.sm, fontWeight: fonts.bold, textTransform: 'uppercase', letterSpacing: 1 },
    entryTime: { color: t.text.muted, fontSize: fonts.xs },
    entryMessage: { color: t.text.secondary, fontSize: fonts.sm, marginTop: 4, fontStyle: 'italic' },
    entryAmount: { color: t.accent.green, fontSize: fonts.md, fontWeight: fonts.bold, marginTop: 4 },
    ...
    gratitudeBtnText: { color: '#fff', fontSize: fonts.lg, fontWeight: fonts.bold },
    quote: { color: t.text.muted, fontSize: fonts.sm, fontStyle: 'italic', textAlign: 'center', marginHorizontal: 32, marginTop: 24, lineHeight: 20 },
    loadingContainer: { flex: 1, justifyContent: 'center', alignItems: 'center', paddingVertical: 80 },
    errorText: { color: t.accent.red ?? '#ef4444', fontSize: fonts.md, textAlign: 'center', marginHorizontal: 24, marginTop: 20 },
  }), [t]);
