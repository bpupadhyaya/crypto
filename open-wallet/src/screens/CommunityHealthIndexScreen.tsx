...
export function CommunityHealthIndexScreen({ onClose }: Props) {
  ...
  const s = useMemo(() => StyleSheet.create({
    ...
    scoreLabel: { color: t.text.secondary, fontSize: 14, fontWeight: '600', marginTop: 4 },
    scoreChange: { fontSize: 14, fontWeight: '700', marginTop: 6 },
    ...
    gradeLabel: { color: t.text.muted, fontSize: 12, fontWeight: '600' },
    ...
    dimIcon: { fontSize: 24 },
    dimTitle: { flex: 1, fontSize: 15, fontWeight: '700' },
    dimScore: { fontSize: 20, fontWeight: '900' },
    dimChange: { fontSize: 12, fontWeight: '600', marginLeft: 4 },
    ...
    indicatorText: { color: t.text.primary, fontSize: 12, fontWeight: '600' },
    trendArrow: { fontSize: 10, fontWeight: '800' },
    historyCard: { backgroundColor: t.bg.card, borderRadius: 14, padding: 16, marginBottom: 20 },
    historyTitle: { color: t.text.primary, fontSize: 14, fontWeight: '700', marginBottom: 12 },
    historyRow: { flexDirection: 'row', alignItems: 'center', marginBottom: 8 },
    historyMonth: { flex: 1, color: t.text.secondary, fontSize: 12 },
    historyScore: { color: t.text.primary, fontSize: 13, fontWeight: '700', width: 36, textAlign: 'right', marginRight: 10 },
