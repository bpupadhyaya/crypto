...
export function CommunityHealthIndexScreen({ onClose }: Props) {
  ...
  const s = useMemo(() => StyleSheet.create({
    ...
    scoreLabel: { color: t.text.secondary, fontSize: fonts.md, fontWeight: fonts.semibold, marginTop: 4 },
    scoreChange: { fontSize: fonts.md, fontWeight: fonts.bold, marginTop: 6 },
    ...
    gradeText: { color: '#fff', fontSize: fonts.lg, fontWeight: fonts.heavy },
    gradeLabel: { color: t.text.muted, fontSize: fonts.sm, fontWeight: fonts.semibold },
    ...
    dimIcon: { fontSize: fonts.xxl },
    dimTitle: { flex: 1, fontSize: fonts.md, fontWeight: fonts.bold },
    dimScore: { fontSize: fonts.xl, fontWeight: fonts.heavy },
    dimChange: { fontSize: fonts.sm, fontWeight: fonts.semibold, marginLeft: 4 },
    ...
    indicatorLabel: { color: t.text.muted, fontSize: fonts.sm },
    indicatorValue: { flexDirection: 'row', alignItems: 'center', gap: 4 },
    indicatorText: { color: t.text.primary, fontSize: fonts.sm, fontWeight: fonts.semibold },
    trendArrow: { fontSize: fonts.xs, fontWeight: fonts.heavy },
    historyCard: { backgroundColor: t.bg.card, borderRadius: 14, padding: 16, marginBottom: 20 },
    historyTitle: { color: t.text.primary, fontSize: fonts.md, fontWeight: fonts.bold, marginBottom: 12 },
    historyRow: { flexDirection: 'row', alignItems: 'center', marginBottom: 8 },
    historyMonth: { flex: 1, color: t.text.secondary, fontSize: fonts.sm },
    historyScore: { color: t.text.primary, fontSize: fonts.sm, fontWeight: fonts.bold, width: 36, textAlign: 'right', marginRight: 10 },
