...
export function ElectionScreen({ onClose }: Props) {
  ...
  const s = useMemo(() => StyleSheet.create({
    ...
    checkText: { color: '#fff', fontSize: fonts.md, fontWeight: fonts.heavy },
    ...
    winnerText: { color: '#fff', fontSize: fonts.xs, fontWeight: fonts.bold },
    endorseCount: { color: t.accent.orange, fontSize: fonts.sm, fontWeight: fonts.bold, marginTop: 4 },
    platformText: { color: t.text.secondary, fontSize: fonts.sm, lineHeight: 20, marginTop: 8 },
    experienceText: { color: t.text.muted, fontSize: fonts.sm, lineHeight: 18, marginTop: 6, fontStyle: 'italic' },
    ...
    runBtnText: { color: '#fff', fontSize: fonts.lg, fontWeight: fonts.bold },
    ...
    votedText: { color: t.accent.green, fontSize: fonts.md, fontWeight: fonts.bold },
    anonNote: { color: t.text.muted, fontSize: fonts.xs, textAlign: 'center', marginHorizontal: 24, marginTop: 8, lineHeight: 16 },
    ...
    <>
      ...
      {activeElection.candidates.map((cand) => (
        <View key={cand.id} style={s.card}>
          <View style={s.row}>
            <Text style={{ fontSize: fonts.xxl }}>{'\u{1F9D1}\u{200D}\u{1F4BC}'}</Text>
            <View style={{ flex: 1 }}>
              <Text style={s.cardTitle}>{cand.name}</Text>
              <Text style={s.cardMuted}>{cand.uid}</Text>
            </View>
