...
export function LibraryScreen({ onClose }: Props) {
  ...
  const s = useMemo(() => StyleSheet.create({
    ...
    genreChipText: { color: t.text.muted, fontSize: 12, fontWeight: '600' },
    ...
    bookTitle: { color: t.text.primary, fontSize: 15, fontWeight: '700' },
    ...
    bookGenre: { color: t.accent.blue, fontSize: 12, fontWeight: '600', textTransform: 'capitalize' },
    ...
    eOTKText: { color: t.accent.blue, fontSize: 13, fontWeight: '700' },
    // Borrow
    ...
    borrowIconText: { color: t.accent.blue, fontSize: 14, fontWeight: '700' },
    borrowInfo: { flex: 1 },
    borrowTitle: { color: t.text.primary, fontSize: 14, fontWeight: '600' },
    ...
    groupReward: { color: t.accent.blue, fontSize: 14, fontWeight: '700' },
    ...
    knowledgeTitle: { color: t.text.primary, fontSize: 14, fontWeight: '600' },
