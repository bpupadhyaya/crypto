...
export function LibraryScreen({ onClose }: Props) {
  ...
  const s = useMemo(() => StyleSheet.create({
    ...
    genreChipText: { color: t.text.muted, fontSize: fonts.sm, fontWeight: fonts.semibold },
    ...
    bookTitle: { color: t.text.primary, fontSize: fonts.md, fontWeight: fonts.bold },
    bookAuthor: { color: t.text.muted, fontSize: fonts.sm, marginTop: 2 },
    bookMeta: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', marginTop: 10 },
    bookGenre: { color: t.accent.blue, fontSize: fonts.sm, fontWeight: fonts.semibold, textTransform: 'capitalize' },
    bookPages: { color: t.text.muted, fontSize: fonts.sm },
    ...
    availableText: { fontSize: fonts.sm, fontWeight: fonts.bold },
    ...
    eOTKText: { color: t.accent.blue, fontSize: fonts.sm, fontWeight: fonts.bold },
    // Borrow
    ...
    borrowIconText: { color: t.accent.blue, fontSize: fonts.md, fontWeight: fonts.bold },
    borrowInfo: { flex: 1 },
    borrowTitle: { color: t.text.primary, fontSize: fonts.md, fontWeight: fonts.semibold },
    borrowMeta: { color: t.text.muted, fontSize: fonts.sm, marginTop: 2 },
    ...
    groupDesc: { color: t.text.muted, fontSize: fonts.sm, marginTop: 4, lineHeight: 18 },
    groupMeta: { color: t.text.muted, fontSize: fonts.sm, marginTop: 6 },
    groupFooter: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', marginTop: 10 },
    groupReward: { color: t.accent.blue, fontSize: fonts.md, fontWeight: fonts.bold },
    ...
    knowledgeTitle: { color: t.text.primary, fontSize: fonts.md, fontWeight: fonts.semibold },
    knowledgeMeta: { color: t.text.muted, fontSize: fonts.sm, marginTop: 2 },
    knowledgeRight: { alignItems: 'flex-end', justifyContent: 'center' },
    knowledgeViews: { color: t.text.muted, fontSize: fonts.sm },
