...
export function TreePlantingScreen({ onClose }: Props) {
  ...
  const s = useMemo(() => StyleSheet.create({
    ...
    treeSpecies: { color: t.text.primary, fontSize: 15, fontWeight: fonts.bold },
    growthBadge: { paddingHorizontal: 10, paddingVertical: 4, borderRadius: 10 },
    growthText: { color: '#fff', fontSize: 11, fontWeight: fonts.bold, textTransform: 'uppercase' },
    ...
    treeStatValue: { color: t.text.primary, fontSize: 14, fontWeight: fonts.bold },
    cotkValue: { color: t.accent.green, fontSize: 14, fontWeight: fonts.bold },
    ...
    adoptSpecies: { color: t.text.primary, fontSize: 15, fontWeight: fonts.bold },
    ...
    adoptedText: { color: t.text.muted, fontSize: 11, fontWeight: fonts.semibold },
    ...
    seedlingSpecies: { color: t.text.primary, fontSize: 15, fontWeight: fonts.bold },
    seedlingMeta: { color: t.text.muted, fontSize: 12, marginTop: 4 },
    seedlingQty: { color: t.accent.green, fontSize: 14, fontWeight: fonts.bold, marginTop: 4 },
