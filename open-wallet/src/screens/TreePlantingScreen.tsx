...
export function TreePlantingScreen({ onClose }: Props) {
  ...
  const s = useMemo(() => StyleSheet.create({
    ...
    treeSpecies: { color: t.text.primary, fontSize: 15, fontWeight: '700' },
    growthBadge: { paddingHorizontal: 10, paddingVertical: 4, borderRadius: 10 },
    growthText: { color: '#fff', fontSize: 11, fontWeight: '700', textTransform: 'uppercase' },
    treeMeta: { color: t.text.muted, fontSize: 12, marginTop: 4 },
    ...
    treeStatLabel: { color: t.text.muted, fontSize: 11 },
    treeStatValue: { color: t.text.primary, fontSize: 14, fontWeight: '700' },
    cotkValue: { color: t.accent.green, fontSize: 14, fontWeight: '700' },
    ...
    rewardText: { color: t.accent.green, fontSize: 14, fontWeight: '700' },
    ...
    adoptSpecies: { color: t.text.primary, fontSize: 15, fontWeight: '700' },
    ...
    adoptedText: { color: t.text.muted, fontSize: 11, fontWeight: '600' },
    adoptInput: { backgroundColor: t.bg.primary, borderRadius: 12, padding: 12, color: t.text.primary, fontSize: 14, marginTop: 10 },
    ...
    seedlingSpecies: { color: t.text.primary, fontSize: 15, fontWeight: '700' },
    seedlingMeta: { color: t.text.muted, fontSize: 12, marginTop: 4 },
    seedlingQty: { color: t.accent.green, fontSize: 14, fontWeight: '700', marginTop: 4 },
    ...
    unavailableText: { color: t.text.muted, fontSize: 12, fontStyle: 'italic', marginTop: 8 },
    // Misc
