...
export function MoodMapScreen({ onClose }: Props) {
  ...
  const st = useMemo(() => StyleSheet.create({
    ...
    moodLabel: { color: t.text.primary, fontSize: 14, fontWeight: '700' },
    barContainer: { height: 10, backgroundColor: t.border, borderRadius: 5, overflow: 'hidden', flex: 1, marginHorizontal: 10 },
    barFill: { height: 10, borderRadius: 5 },
    moodCount: { color: t.text.muted, fontSize: 12, fontWeight: '600', width: 50, textAlign: 'right' },
    moodPct: { color: t.text.secondary, fontSize: 13, fontWeight: '800', width: 40 },
    overallScore: { fontSize: 48, fontWeight: '900', textAlign: 'center' },
    overallLabel: { color: t.text.muted, fontSize: 14, textAlign: 'center', marginBottom: 16 },
    trendScore: { fontSize: 18, fontWeight: '800' },
    trendChange: { fontSize: 12, fontWeight: '700' },
    trendPeriod: { color: t.text.primary, fontSize: 14, fontWeight: '700' },
    privacyNote: { color: t.text.muted, fontSize: 11, textAlign: 'center', fontStyle: 'italic', marginBottom: 16 },
    resourceTitle: { color: t.text.primary, fontSize: 14, fontWeight: '700', marginBottom: 4 },
