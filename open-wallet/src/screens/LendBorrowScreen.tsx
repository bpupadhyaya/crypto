...
export function LendBorrowScreen({ onClose }: Props) {
  ...
  const s = useMemo(() => StyleSheet.create({
    ...
    summaryValueRed: { color: t.accent.red, fontSize: 14, fontWeight: '600' },
    ...
    warningTitle: { color: t.accent.red, fontSize: 14, fontWeight: '800', marginBottom: 4 },
    ...
    cautionTitle: { color: t.accent.yellow, fontSize: 14, fontWeight: '800', marginBottom: 4 },
    ...
    marketToken: { color: t.text.primary, fontSize: 16, fontWeight: '700' },
    ...
    apyValueGreen: { color: t.accent.green, fontSize: 12, fontWeight: '700' },
    apyValueRed: { color: t.accent.red, fontSize: 12, fontWeight: '600' },
    statsRow: { flexDirection: 'row', justifyContent: 'space-between', marginBottom: 4 },
    statLabel: { color: t.text.muted, fontSize: 11 },
    statValue: { color: t.text.secondary, fontSize: 11, fontWeight: '600' },
    ...
    borrowedValue: { color: t.accent.red, fontSize: 12, fontWeight: '600' },
    ...
    supplyBtnText: { color: t.accent.green, fontSize: 12, fontWeight: '700' },
    withdrawBtnText: { color: t.accent.yellow, fontSize: 12, fontWeight: '700' },
    borrowBtnText: { color: t.accent.blue, fontSize: 12, fontWeight: '700' },
    repayBtnText: { color: t.accent.red, fontSize: 12, fontWeight: '700' },
    ...
    collateralText: { color: t.text.muted, fontSize: 10, fontWeight: '600' },
  }), [t]);
