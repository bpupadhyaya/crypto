...
export function HardwareWalletScreen({ onClose }: Props) {
  ...
  const s = useMemo(() => StyleSheet.create({
    ...
    deviceIcon: { fontSize: fonts.hero, marginRight: 16 },
    deviceInfo: { flex: 1 },
    deviceName: { color: t.text.primary, fontSize: fonts.lg, fontWeight: fonts.bold },
    deviceModels: { color: t.text.muted, fontSize: fonts.sm, marginTop: 2 },
    comingSoon: { color: t.accent.yellow, fontSize: fonts.xs, fontWeight: fonts.bold, marginTop: 4 },
    ...
    scanBtnText: { color: '#fff', fontSize: fonts.lg, fontWeight: fonts.bold },
    ...
    discoveredName: { color: t.text.primary, fontSize: fonts.md, fontWeight: fonts.semibold },
    discoveredModel: { color: t.text.muted, fontSize: fonts.sm },
    ...
    statusText: { color: t.text.primary, fontSize: fonts.xl, fontWeight: fonts.bold },
    statusSub: { color: t.text.muted, fontSize: fonts.md, marginTop: 8, textAlign: 'center', lineHeight: 20 },
    ...
    instructions: { color: t.text.muted, fontSize: fonts.sm, textAlign: 'center', marginHorizontal: 24, marginTop: 24, lineHeight: 20 },
  }), [t]);
