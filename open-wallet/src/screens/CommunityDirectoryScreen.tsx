...
export function CommunityDirectoryScreen({ onClose }: Props) {
  ...
  const s = useMemo(() => StyleSheet.create({
    ...
    memberInfo: { flex: 1 },
    memberName: { color: t.text.primary, fontSize: 15, fontWeight: '700', marginBottom: 2 },
    memberRole: { fontSize: 12, fontWeight: '600', textTransform: 'capitalize', marginBottom: 4 },
    memberSkills: { color: t.text.secondary, fontSize: 12, lineHeight: 18 },
    memberOTK: { alignItems: 'flex-end' },
    memberOTKNum: { color: t.accent.green, fontSize: 16, fontWeight: '800' },
    ...
    roleInfo: { flex: 1 },
    roleTitle: { color: t.text.primary, fontSize: 15, fontWeight: '700' },
    ...
    resultCount: { color: t.text.muted, fontSize: 12, fontWeight: '600', marginBottom: 12 },
  }), [t]);
