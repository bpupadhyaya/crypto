...
export function CommunityDirectoryScreen({ onClose }: Props) {
  ...
  const s = useMemo(() => StyleSheet.create({
    ...
    searchBox: { backgroundColor: t.bg.card, borderRadius: 12, paddingHorizontal: 16, paddingVertical: 12, fontSize: 15, color: t.text.primary, marginBottom: 16, borderWidth: 1, borderColor: t.border },
    ...
    memberIcon: { fontSize: 36 },
    memberInfo: { flex: 1 },
    memberName: { color: t.text.primary, fontSize: 15, fontWeight: fonts.bold, marginBottom: 2 },
    memberRole: { fontSize: 12, fontWeight: fonts.semibold, textTransform: 'capitalize', marginBottom: 4 },
    memberSkills: { color: t.text.secondary, fontSize: 12, lineHeight: 18 },
    memberOTK: { alignItems: 'flex-end' },
    memberOTKNum: { color: t.accent.green, fontSize: 16, fontWeight: fonts.heavy },
    memberOTKLabel: { color: t.text.muted, fontSize: 10 },
    memberJoined: { color: t.text.muted, fontSize: 10, marginTop: 4 },
    ...
    statNum: { fontSize: 24, fontWeight: fonts.heavy, marginBottom: 4 },
    statLabel: { color: t.text.muted, fontSize: 11, fontWeight: fonts.semibold, textAlign: 'center' },
    ...
    roleInfo: { flex: 1 },
    roleTitle: { color: t.text.primary, fontSize: 15, fontWeight: fonts.bold },
    roleCount: { color: t.text.secondary, fontSize: 13 },
    roleArrow: { color: t.text.muted, fontSize: 18 },
    emptyText: { color: t.text.muted, fontSize: 14, textAlign: 'center', marginTop: 40 },
    resultCount: { color: t.text.muted, fontSize: 12, fontWeight: fonts.semibold, marginBottom: 12 },
  }), [t]);
