...
export function LanguageSchoolScreen({ onClose }: Props) {
  ...
  const s = useMemo(() => StyleSheet.create({
    ...
    courseIcon: { fontSize: fonts.xxxl },
    courseInfo: { flex: 1 },
    courseLang: { color: t.text.primary, fontSize: fonts.md, fontWeight: fonts.bold },
    courseLevel: { color: t.text.muted, fontSize: fonts.sm },
    courseInstructor: { color: t.text.secondary, fontSize: fonts.sm, marginBottom: 6 },
    courseStats: { flexDirection: 'row', gap: 12, marginBottom: 8 },
    courseStat: { color: t.text.muted, fontSize: fonts.sm },
    ...
    courseReward: { color: t.accent.green, fontSize: fonts.sm, fontWeight: fonts.bold },
    enrollBtn: { paddingHorizontal: 16, paddingVertical: 8, borderRadius: 8 },
    enrollBtnText: { color: '#fff', fontSize: fonts.sm, fontWeight: fonts.bold },
    ...
    partnerIcon: { fontSize: fonts.xxxl },
    partnerInfo: { flex: 1 },
    partnerName: { color: t.text.primary, fontSize: fonts.md, fontWeight: fonts.bold },
    partnerLang: { color: t.text.secondary, fontSize: fonts.sm },
    partnerSessions: { color: t.text.muted, fontSize: fonts.xs, marginTop: 2 },
    partnerAvail: { paddingHorizontal: 10, paddingVertical: 6, borderRadius: 8 },
    partnerAvailText: { fontSize: fonts.sm, fontWeight: fonts.bold, color: '#fff' },
    ...
    progressIcon: { fontSize: fonts.xxl },
    progressLang: { flex: 1, color: t.text.primary, fontSize: fonts.md, fontWeight: fonts.bold },
    progressLevel: { color: t.text.muted, fontSize: fonts.sm, fontWeight: fonts.semibold },
    ...
    progressStatNum: { fontSize: fonts.xl, fontWeight: fonts.heavy },
