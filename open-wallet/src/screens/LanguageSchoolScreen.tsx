...
export function LanguageSchoolScreen({ onClose }: Props) {
  ...
  const s = useMemo(() => StyleSheet.create({
    ...
    courseInfo: { flex: 1 },
    courseLang: { color: t.text.primary, fontSize: 15, fontWeight: fonts.bold },
    ...
    courseReward: { color: t.accent.green, fontSize: 13, fontWeight: fonts.bold },
    enrollBtn: { paddingHorizontal: 16, paddingVertical: 8, borderRadius: 8 },
    enrollBtnText: { color: '#fff', fontSize: 13, fontWeight: fonts.bold },
    ...
    partnerAvailText: { fontSize: 12, fontWeight: fonts.bold, color: '#fff' },
    ...
    progressLang: { flex: 1, color: t.text.primary, fontSize: 15, fontWeight: fonts.bold },
    progressLevel: { color: t.text.muted, fontSize: 12, fontWeight: fonts.semibold },
    ...
    progressStatNum: { fontSize: 18, fontWeight: fonts.heavy },
