...
export function AstronomyScreen({ onClose }: Props) {
  ...
  const s = useMemo(() => StyleSheet.create({
    ...
    heroTitle: { color: '#E0E1DD', fontSize: 18, fontWeight: fonts.heavy, textAlign: 'center' },
    ...
    moonPhase: { color: '#E0E1DD', fontSize: 18, fontWeight: fonts.heavy },
    ...
    moonTimeLabel: { color: '#778DA9', fontSize: 11, fontWeight: fonts.semibold },
    moonTimeValue: { color: '#E0E1DD', fontSize: 14, fontWeight: fonts.bold, marginTop: 2 },
    ...
    planetName: { color: t.text.primary, fontSize: 16, fontWeight: fonts.bold },
    ...
    eventDate: { color: t.accent.blue, fontSize: 12, fontWeight: fonts.semibold },
    ...
    telescopeTitle: { color: t.text.primary, fontSize: 16, fontWeight: fonts.bold },
    telescopeType: { color: t.accent.blue, fontSize: 12, fontWeight: fonts.semibold, textTransform: 'uppercase', marginTop: 4 },
    ...
    telescopeValue: { color: t.text.primary, fontSize: 13, fontWeight: fonts.semibold },
    ...
    constName: { color: t.text.primary, fontSize: 16, fontWeight: fonts.bold },
    ...
    visibleBadgeText: { color: '#22c55e', fontSize: 11, fontWeight: fonts.bold },
    notVisibleBadge: { backgroundColor: t.text.muted + '20', paddingHorizontal: 8, paddingVertical: 2, borderRadius: 8 },
    notVisibleText: { color: t.text.muted, fontSize: 11, fontWeight: fonts.bold },
    ...
    moduleTitle: { color: t.text.primary, fontSize: 15, fontWeight: fonts.bold, flex: 1 },
    moduleReward: { color: t.accent.purple, fontSize: 12, fontWeight: fonts.bold },
    ...
    actionBtnText: { color: '#E0E1DD', fontSize: 16, fontWeight: fonts.bold },
    ...
    secondaryBtnText: { color: t.accent.blue, fontSize: 16, fontWeight: fonts.bold },
