...
export function AstronomyScreen({ onClose }: Props) {
  ...
  const s = useMemo(() => StyleSheet.create({
    ...
    heroTitle: { color: '#E0E1DD', fontSize: fonts.xl, fontWeight: fonts.heavy, textAlign: 'center' },
    heroSubtitle: { color: '#778DA9', fontSize: fonts.sm, textAlign: 'center', marginTop: 4, lineHeight: 20 },
    ...
    cardSubtitle: { color: t.text.secondary, fontSize: fonts.sm, marginTop: 2 },
    cardMeta: { color: t.text.muted, fontSize: fonts.xs, marginTop: 4 },
    ...
    moonPhase: { color: '#E0E1DD', fontSize: fonts.xl, fontWeight: fonts.heavy },
    moonIllum: { color: '#778DA9', fontSize: fonts.md, marginTop: 4 },
    moonTimesRow: { flexDirection: 'row', justifyContent: 'space-around', width: '100%', marginTop: 16 },
    moonTimeBox: { alignItems: 'center' },
    moonTimeLabel: { color: '#778DA9', fontSize: fonts.xs, fontWeight: fonts.semibold },
    moonTimeValue: { color: '#E0E1DD', fontSize: fonts.md, fontWeight: fonts.bold, marginTop: 2 },
    ...
    planetName: { color: t.text.primary, fontSize: fonts.lg, fontWeight: fonts.bold },
    planetDetail: { color: t.text.secondary, fontSize: fonts.sm, marginTop: 2 },
    planetMag: { color: t.text.muted, fontSize: fonts.xs, marginTop: 2 },
    planetIcon: { fontSize: fonts.hero },
    ...
    eventDate: { color: t.accent.blue, fontSize: fonts.sm, fontWeight: fonts.semibold },
    eventDesc: { color: t.text.secondary, fontSize: fonts.sm, lineHeight: 20 },
    eventMeta: { color: t.text.muted, fontSize: fonts.xs, marginTop: 8 },
    telescopeCard: { backgroundColor: t.bg.card, borderRadius: 16, padding: 16, marginHorizontal: 20, marginBottom: 12 },
    telescopeTitle: { color: t.text.primary, fontSize: fonts.lg, fontWeight: fonts.bold },
    telescopeType: { color: t.accent.blue, fontSize: fonts.sm, fontWeight: fonts.semibold, textTransform: 'uppercase', marginTop: 4 },
    telescopeInfo: { color: t.text.secondary, fontSize: fonts.sm, marginTop: 8, lineHeight: 20 },
    telescopeRow: { flexDirection: 'row', justifyContent: 'space-between', marginTop: 12 },
    telescopeLabel: { color: t.text.muted, fontSize: fonts.sm },
    telescopeValue: { color: t.text.primary, fontSize: fonts.sm, fontWeight: fonts.semibold },
    ...
    attendeeText: { color: t.text.muted, fontSize: fonts.xs, marginTop: 4 },
    ...
    constName: { color: t.text.primary, fontSize: fonts.lg, fontWeight: fonts.bold },
    constSeason: { color: t.text.muted, fontSize: fonts.sm },
    constDesc: { color: t.text.secondary, fontSize: fonts.sm, lineHeight: 20, marginTop: 8 },
    constMeta: { color: t.text.muted, fontSize: fonts.xs, marginTop: 6 },
    visibleBadge: { backgroundColor: '#22c55e20', paddingHorizontal: 8, paddingVertical: 2, borderRadius: 8 },
    visibleBadgeText: { color: '#22c55e', fontSize: fonts.xs, fontWeight: fonts.bold },
    notVisibleBadge: { backgroundColor: t.text.muted + '20', paddingHorizontal: 8, paddingVertical: 2, borderRadius: 8 },
    notVisibleText: { color: t.text.muted, fontSize: fonts.xs, fontWeight: fonts.bold },
    ...
    moduleIcon: { fontSize: fonts.hero, marginRight: 12 },
    moduleTitle: { color: t.text.primary, fontSize: fonts.md, fontWeight: fonts.bold, flex: 1 },
    moduleReward: { color: t.accent.purple, fontSize: fonts.sm, fontWeight: fonts.bold },
    ...
    actionBtnText: { color: '#E0E1DD', fontSize: fonts.lg, fontWeight: fonts.bold },
    ...
    secondaryBtnText: { color: t.accent.blue, fontSize: fonts.lg, fontWeight: fonts.bold },
