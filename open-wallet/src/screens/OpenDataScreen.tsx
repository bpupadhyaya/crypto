...
export function OpenDataScreen({ onClose }: Props) {
  ...
  const s = useMemo(() => StyleSheet.create({
    ...
    dsName: { color: t.text.primary, fontSize: 15, fontWeight: fonts.bold },
    dsMeta: { color: t.text.muted, fontSize: 12, marginTop: 4 },
    dsDesc: { color: t.text.muted, fontSize: 13, marginTop: 6, lineHeight: 19 },
    ...
    dsStatVal: { color: t.text.primary, fontSize: 16, fontWeight: fonts.heavy },
    dsStatLabel: { color: t.text.muted, fontSize: 10, marginTop: 2 },
    catBadge: { paddingHorizontal: 8, paddingVertical: 2, borderRadius: 8, alignSelf: 'flex-start', marginTop: 8 },
    catText: { color: '#fff', fontSize: 11, fontWeight: fonts.semibold },
    vizCard: { backgroundColor: t.bg.secondary, borderRadius: 16, padding: 20, marginHorizontal: 20, marginBottom: 16 },
    vizTitle: { color: t.text.primary, fontSize: 15, fontWeight: fonts.bold, marginBottom: 12 },
    vizDataset: { color: t.text.muted, fontSize: 12, marginBottom: 12 },
    barRow: { flexDirection: 'row', alignItems: 'center', marginBottom: 8 },
    barLabel: { color: t.text.muted, fontSize: 11, width: 60 },
    ...
    privacyNote: { color: t.text.muted, fontSize: 11, textAlign: 'center', marginTop: 12, fontStyle: 'italic' },
