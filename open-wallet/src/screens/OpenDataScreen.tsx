...
export function OpenDataScreen({ onClose }: Props) {
  ...
  const s = useMemo(() => StyleSheet.create({
    ...
    dsName: { color: t.text.primary, fontSize: 15, fontWeight: '700' },
    ...
    dsStatVal: { color: t.text.primary, fontSize: 16, fontWeight: '800' },
    ...
    vizTitle: { color: t.text.primary, fontSize: 15, fontWeight: '700', marginBottom: 12 },
