...
export function PeerReviewScreen({ onClose }: Props) {
  ...
  const s = useMemo(() => StyleSheet.create({
    ...
    rewardText: { color: t.accent.green, fontSize: 13, fontWeight: '700', marginTop: 6 },
    reviewRow: { paddingVertical: 14, borderBottomColor: t.bg.primary, borderBottomWidth: 1 },
    reviewTitle: { color: t.text.primary, fontSize: 14, fontWeight: '600' },
    ...
    verdictText: { color: '#fff', fontSize: 11, fontWeight: '600', textTransform: 'uppercase' },
    ratingText: { color: t.accent.orange, fontSize: 13, fontWeight: '700', marginTop: 4 },
