...
export function PeerReviewScreen({ onClose }: Props) {
  ...
  const s = useMemo(() => StyleSheet.create({
    ...
    proposalMeta: { color: t.text.muted, fontSize: fonts.sm, marginTop: 4 },
    ...
    progressText: { color: t.text.muted, fontSize: fonts.xs },
    ...
    reviewBtnText: { color: '#fff', fontSize: fonts.sm, fontWeight: fonts.semibold },
    rewardText: { color: t.accent.green, fontSize: fonts.sm, fontWeight: fonts.bold, marginTop: 6 },
    reviewRow: { paddingVertical: 14, borderBottomColor: t.bg.primary, borderBottomWidth: 1 },
    reviewTitle: { color: t.text.primary, fontSize: fonts.md, fontWeight: fonts.semibold },
    reviewMeta: { color: t.text.muted, fontSize: fonts.sm, marginTop: 4 },
    verdictBadge: { paddingHorizontal: 8, paddingVertical: 2, borderRadius: 8, alignSelf: 'flex-start', marginTop: 6 },
    verdictText: { color: '#fff', fontSize: fonts.xs, fontWeight: fonts.semibold, textTransform: 'uppercase' },
    ratingText: { color: t.accent.orange, fontSize: fonts.sm, fontWeight: fonts.bold, marginTop: 4 },
    ...
    guideDesc: { color: t.text.muted, fontSize: fonts.sm, marginTop: 6, lineHeight: 20 },
