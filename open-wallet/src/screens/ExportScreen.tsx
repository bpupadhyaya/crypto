...
export const ExportScreen = React.memo(({ onClose }: Props) => {
  ...
  const s = useMemo(() => StyleSheet.create({
    ...
    formatLabel: { color: t.text.secondary, fontSize: 15, fontWeight: '700' },
    ...
    previewTitle: { color: t.text.primary, fontSize: 15, fontWeight: '700', marginBottom: 12 },
    previewRow: { flexDirection: 'row', justifyContent: 'space-between', paddingVertical: 6 },
    previewLabel: { color: t.text.muted, fontSize: 13 },
    previewValue: { color: t.text.primary, fontSize: 13, fontWeight: '600' },
    ...
    sampleType: { fontSize: 12, fontWeight: '600', width: 50 },
    sampleToken: { color: t.text.primary, fontSize: 12, fontWeight: '600', width: 45 },
