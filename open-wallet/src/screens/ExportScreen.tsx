...
export const ExportScreen = React.memo(({ onClose }: Props) => {
  ...
  const s = useMemo(() => StyleSheet.create({
    ...
    sectionLabel: { color: t.text.secondary, fontSize: fonts.sm, fontWeight: fonts.bold, textTransform: 'uppercase', letterSpacing: 1.2, marginBottom: 8, marginTop: 16 },
    ...
    chipText: { color: t.text.secondary, fontSize: fonts.md, fontWeight: fonts.semibold },
    ...
    formatIcon: { fontSize: fonts.xxxl, marginBottom: 6 },
    formatLabel: { color: t.text.secondary, fontSize: fonts.md, fontWeight: fonts.bold },
    formatLabelActive: { color: t.accent.green },
    formatDesc: { color: t.text.muted, fontSize: fonts.xs, marginTop: 2 },
    previewCard: { backgroundColor: t.bg.card, borderRadius: 16, padding: 16, marginTop: 16 },
    previewTitle: { color: t.text.primary, fontSize: fonts.md, fontWeight: fonts.bold, marginBottom: 12 },
    previewRow: { flexDirection: 'row', justifyContent: 'space-between', paddingVertical: 6 },
    previewLabel: { color: t.text.muted, fontSize: fonts.sm },
    previewValue: { color: t.text.primary, fontSize: fonts.sm, fontWeight: fonts.semibold },
    exportBtn: { backgroundColor: t.accent.green, borderRadius: 16, paddingVertical: 18, alignItems: 'center', marginTop: 24 },
    exportBtnText: { color: '#fff', fontSize: fonts.lg, fontWeight: fonts.bold },
    cancelBtn: { paddingVertical: 20, alignItems: 'center' },
    cancelText: { color: t.accent.blue, fontSize: fonts.lg },
    hint: { color: t.text.muted, fontSize: fonts.sm, marginTop: 8, textAlign: 'center', lineHeight: 18 },
    ...
    sampleDate: { color: t.text.muted, fontSize: fonts.xs, width: 70 },
    sampleType: { fontSize: fonts.sm, fontWeight: fonts.semibold, width: 50 },
    sampleToken: { color: t.text.primary, fontSize: fonts.sm, fontWeight: fonts.semibold, width: 45 },
    sampleAmount: { color: t.text.secondary, fontSize: fonts.sm, textAlign: 'right', flex: 1 },
  }), [t]);
