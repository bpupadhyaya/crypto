...
export function PledgeScreen({ onClose }: Props) {
  ...
  const s = useMemo(() => StyleSheet.create({
    ...
    subtitle: { color: t.text.secondary, fontSize: fonts.md, lineHeight: 22, marginBottom: 24, textAlign: 'center' },
    globalCounter: { backgroundColor: t.accent.purple + '15', borderRadius: 16, padding: 20, alignItems: 'center', marginBottom: 24 },
    counterNum: { color: t.accent.purple, fontSize: fonts.hero, fontWeight: fonts.heavy },
    counterLabel: { color: t.text.secondary, fontSize: fonts.sm, marginTop: 4 },
    ...
    oathIcon: { fontSize: fonts.xxl, marginBottom: 8 },
    oathText: { color: t.text.primary, fontSize: fonts.md, lineHeight: 24, fontStyle: 'italic' },
    ...
    pledgeBtnText: { color: '#fff', fontSize: fonts.lg, fontWeight: fonts.heavy },
    signingRow: { flexDirection: 'row', justifyContent: 'center', alignItems: 'center', gap: 8, paddingVertical: 16 },
    signingText: { color: t.text.secondary, fontSize: fonts.md },
    ...
    pledgedTitle: { color: t.accent.green, fontSize: fonts.xl, fontWeight: fonts.heavy, marginBottom: 4 },
    pledgedSub: { color: t.text.secondary, fontSize: fonts.sm, marginBottom: 12, textAlign: 'center' },
    infoRow: { flexDirection: 'row', justifyContent: 'space-between', width: '100%', paddingVertical: 6 },
    infoLabel: { color: t.text.muted, fontSize: fonts.sm, fontWeight: fonts.semibold },
    infoValue: { color: t.text.primary, fontSize: fonts.sm, fontWeight: fonts.bold },
    soulboundNote: { color: t.text.muted, fontSize: fonts.sm, textAlign: 'center', marginTop: 8, fontStyle: 'italic' },
