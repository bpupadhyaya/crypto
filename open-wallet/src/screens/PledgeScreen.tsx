...
export function PledgeScreen({ onClose }: Props) {
  ...
  const s = useMemo(() => StyleSheet.create({
    ...
    counterNum: { color: t.accent.purple, fontSize: 36, fontWeight: '900' },
    ...
    pledgeBtnText: { color: '#fff', fontSize: 17, fontWeight: '800' },
    ...
    pledgedTitle: { color: t.accent.green, fontSize: 18, fontWeight: '800', marginBottom: 4 },
    ...
    infoLabel: { color: t.text.muted, fontSize: 12, fontWeight: '600' },
    infoValue: { color: t.text.primary, fontSize: 12, fontWeight: '700' },
