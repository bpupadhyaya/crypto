...
export function FilmScreen({ onClose }: Props) {
  ...
  const s = useMemo(() => StyleSheet.create({
    ...
    emptyText: { color: t.text.muted, fontSize: fonts.md, textAlign: 'center', marginTop: 40, paddingHorizontal: 40, lineHeight: 22 },
    ...
    genreLabel: { color: t.text.secondary, fontSize: fonts.sm, fontWeight: fonts.semibold },
    ...
    themeText: { color: t.accent.purple, fontSize: fonts.sm, fontWeight: fonts.semibold },
    filmHashLabel: { color: t.text.muted, fontSize: fonts.xs, fontFamily: 'monospace', marginTop: 4 },
    statsRow: { flexDirection: 'row', gap: 16, marginTop: 6 },
    statText: { color: t.text.muted, fontSize: fonts.sm },
    ...
    typeBadgeText: { fontSize: fonts.sm, fontWeight: fonts.semibold },
  }), [t]);
