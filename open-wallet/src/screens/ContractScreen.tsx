...
export function ContractScreen({ onClose }: Props) {
  ...
  const s = useMemo(() => StyleSheet.create({
    ...
    contractName: { color: t.text.primary, fontSize: 16, fontWeight: fonts.bold },
    ...
    deployBtnText: { color: '#fff', fontSize: 15, fontWeight: fonts.bold },
    ...
    funcName: { color: t.text.primary, fontSize: 14, fontWeight: fonts.semibold },
    funcType: { fontSize: 11, fontWeight: fonts.bold, paddingHorizontal: 8, paddingVertical: 2, borderRadius: 8 },
    callBtn: { backgroundColor: t.accent.blue, borderRadius: 10, paddingVertical: 10, alignItems: 'center', marginTop: 12 },
    callBtnText: { color: '#fff', fontSize: 14, fontWeight: fonts.semibold },
    ...
    templateName: { color: t.text.primary, fontSize: 15, fontWeight: fonts.bold, marginTop: 6 },
    ...
    useBtnText: { color: '#fff', fontSize: 13, fontWeight: fonts.semibold },
