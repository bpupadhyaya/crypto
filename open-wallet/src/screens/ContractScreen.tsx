...
export function ContractScreen({ onClose }: Props) {
  ...
  const s = useMemo(() => StyleSheet.create({
    ...
    contractName: { color: t.text.primary, fontSize: fonts.lg, fontWeight: fonts.bold },
    contractAddress: { color: t.text.muted, fontSize: fonts.sm, marginTop: 4 },
    contractMeta: { flexDirection: 'row', justifyContent: 'space-between', marginTop: 8 },
    metaText: { color: t.text.secondary, fontSize: fonts.sm },
    ...
    deployBtnText: { color: '#fff', fontSize: fonts.md, fontWeight: fonts.bold },
    ...
    funcName: { color: t.text.primary, fontSize: fonts.md, fontWeight: fonts.semibold },
    funcType: { fontSize: fonts.xs, fontWeight: fonts.bold, paddingHorizontal: 8, paddingVertical: 2, borderRadius: 8 },
    callBtn: { backgroundColor: t.accent.blue, borderRadius: 10, paddingVertical: 10, alignItems: 'center', marginTop: 12 },
    callBtnText: { color: '#fff', fontSize: fonts.md, fontWeight: fonts.semibold },
    resultBox: { backgroundColor: t.bg.primary, borderRadius: 12, padding: 14, marginTop: 10 },
    resultText: { color: t.accent.green, fontSize: fonts.sm, fontFamily: 'Courier' },
    templateIcon: { fontSize: fonts.xxxl },
    templateName: { color: t.text.primary, fontSize: fonts.md, fontWeight: fonts.bold, marginTop: 6 },
    templateDesc: { color: t.text.secondary, fontSize: fonts.sm, marginTop: 4, lineHeight: 18 },
    templatePop: { color: t.text.muted, fontSize: fonts.xs, marginTop: 6 },
    useBtn: { backgroundColor: t.accent.blue, borderRadius: 10, paddingVertical: 8, alignItems: 'center', marginTop: 10 },
    useBtnText: { color: '#fff', fontSize: fonts.sm, fontWeight: fonts.semibold },
    ...
    selectHint: { color: t.text.muted, fontSize: fonts.md, textAlign: 'center', paddingTop: 40 },
  }), [t]);
