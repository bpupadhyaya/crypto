...
export function VolunteerAbroadScreen({ onClose }: Props) {
  ...
  const s = useMemo(() => StyleSheet.create({
    ...
    oppTitle: { color: t.text.primary, fontSize: 16, fontWeight: '700' },
    ...
    iconText: { color: t.accent.blue, fontSize: 18, fontWeight: '800' },
    oppRow: { flexDirection: 'row', alignItems: 'center', marginBottom: 12 },
    countryText: { color: t.accent.blue, fontSize: 13, fontWeight: '600' },
    durationText: { color: t.text.muted, fontSize: 12 },
    stipendText: { color: t.accent.green, fontSize: 18, fontWeight: '800' },
    ...
    detailValue: { color: t.text.primary, fontSize: 18, fontWeight: '800' },
    ...
    stepLabel: { color: t.text.primary, fontSize: 14, fontWeight: '700' },
    ...
    appTitle: { color: t.text.primary, fontSize: 15, fontWeight: '700' },
    ...
    storyTitle: { color: t.text.primary, fontSize: 15, fontWeight: '700', marginBottom: 8 },
    storyExcerpt: { color: t.text.muted, fontSize: 13, lineHeight: 20 },
    storyVolunteer: { color: t.accent.blue, fontSize: 12, fontWeight: '600', marginTop: 8 },
    ...
    metricValue: { color: t.text.primary, fontSize: 18, fontWeight: '800' },
    ...
    guideRegion: { color: t.text.primary, fontSize: 16, fontWeight: '700', marginBottom: 4 },
    guideLanguage: { color: t.accent.blue, fontSize: 13, marginBottom: 8 },
    guideGreeting: { color: t.accent.green, fontSize: 14, fontWeight: '600', fontStyle: 'italic', marginBottom: 12 },
    ...
    guideSubhead: { color: t.text.muted, fontSize: 11, fontWeight: '700', textTransform: 'uppercase', letterSpacing: 1, marginTop: 12, marginBottom: 6 },
    ...
    demoText: { color: t.accent.orange || '#FF9500', fontSize: 12, textAlign: 'center', fontWeight: '600' },
    spotsText: { color: t.accent.green, fontSize: 12, fontWeight: '600' },
  }), [t]);
