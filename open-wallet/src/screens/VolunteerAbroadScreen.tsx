...
export function VolunteerAbroadScreen({ onClose }: Props) {
  ...
  const s = useMemo(() => StyleSheet.create({
    ...
    subText: { color: t.text.muted, fontSize: fonts.sm, marginTop: 4 },
    ...
    oppTitle: { color: t.text.primary, fontSize: fonts.lg, fontWeight: fonts.bold },
    oppCategory: { color: t.text.muted, fontSize: fonts.sm, textTransform: 'uppercase', letterSpacing: 1, marginTop: 2 },
    ...
    iconText: { color: t.accent.blue, fontSize: fonts.xl, fontWeight: fonts.heavy },
    oppRow: { flexDirection: 'row', alignItems: 'center', marginBottom: 12 },
    countryText: { color: t.accent.blue, fontSize: fonts.sm, fontWeight: fonts.semibold },
    durationText: { color: t.text.muted, fontSize: fonts.sm },
    stipendText: { color: t.accent.green, fontSize: fonts.xl, fontWeight: fonts.heavy },
    stipendLabel: { color: t.text.muted, fontSize: fonts.xs, textTransform: 'uppercase' },
    ...
    urgencyText: { fontSize: fonts.xs, fontWeight: fonts.bold, textTransform: 'uppercase' },
    ...
    detailBack: { color: t.accent.blue, fontSize: fonts.md, marginHorizontal: 20, marginBottom: 12 },
    detailDesc: { color: t.text.primary, fontSize: fonts.md, lineHeight: 22, marginBottom: 12 },
    detailRow: { flexDirection: 'row', justifyContent: 'space-around', marginVertical: 12 },
    detailItem: { alignItems: 'center' },
    detailValue: { color: t.text.primary, fontSize: fonts.xl, fontWeight: fonts.heavy },
    detailLabel: { color: t.text.muted, fontSize: fonts.xs, marginTop: 2 },
    housingText: { color: t.text.primary, fontSize: fonts.sm, marginTop: 4 },
    housingLabel: { color: t.text.muted, fontSize: fonts.xs, textTransform: 'uppercase', letterSpacing: 1, marginTop: 12 },
    ...
    stepLabel: { color: t.text.primary, fontSize: fonts.md, fontWeight: fonts.bold },
    stepDesc: { color: t.text.muted, fontSize: fonts.sm, marginTop: 2 },
    appCard: { backgroundColor: t.bg.secondary, borderRadius: 16, padding: 16, marginHorizontal: 20, marginBottom: 16 },
    appTitle: { color: t.text.primary, fontSize: fonts.md, fontWeight: fonts.bold },
    appCountry: { color: t.accent.blue, fontSize: fonts.sm, marginTop: 2 },
    statusBadge: { paddingHorizontal: 10, paddingVertical: 4, borderRadius: 10 },
    statusText: { fontSize: fonts.xs, fontWeight: fonts.bold, textTransform: 'uppercase' },
    appNotes: { color: t.text.muted, fontSize: fonts.sm, marginTop: 8, fontStyle: 'italic' },
    storyCard: { backgroundColor: t.bg.secondary, borderRadius: 16, padding: 20, marginHorizontal: 20, marginBottom: 16 },
    storyTitle: { color: t.text.primary, fontSize: fonts.md, fontWeight: fonts.bold, marginBottom: 8 },
    storyExcerpt: { color: t.text.muted, fontSize: fonts.sm, lineHeight: 20 },
    storyVolunteer: { color: t.accent.blue, fontSize: fonts.sm, fontWeight: fonts.semibold, marginTop: 8 },
    ...
    metricLabel: { color: t.text.muted, fontSize: fonts.xs, marginTop: 2, textAlign: 'center' },
    guideCard: { backgroundColor: t.bg.secondary, borderRadius: 16, padding: 20, marginHorizontal: 20, marginBottom: 16 },
    guideRegion: { color: t.text.primary, fontSize: fonts.lg, fontWeight: fonts.bold, marginBottom: 4 },
    guideLanguage: { color: t.accent.blue, fontSize: fonts.sm, marginBottom: 8 },
    guideGreeting: { color: t.accent.green, fontSize: fonts.md, fontWeight: fonts.semibold, fontStyle: 'italic', marginBottom: 12 },
    guideTip: { color: t.text.primary, fontSize: fonts.sm, marginBottom: 6, paddingLeft: 8 },
    guideClimate: { color: t.text.muted, fontSize: fonts.sm, marginTop: 8, fontStyle: 'italic' },
    guidePacking: { color: t.text.primary, fontSize: fonts.sm, marginLeft: 8, marginBottom: 4 },
    guideSubhead: { color: t.text.muted, fontSize: fonts.xs, fontWeight: fonts.bold, textTransform: 'uppercase', letterSpacing: 1, marginTop: 12, marginBottom: 6 },
    partnerCard: { backgroundColor: t.bg.secondary, borderRadius: 12, padding: 14, marginHorizontal: 20, marginBottom: 10 },
    partnerName: { color: t.text.primary, fontSize: fonts.md, fontWeight: fonts.bold },
    partnerCountry: { color: t.accent.blue, fontSize: fonts.sm, marginTop: 2 },
    partnerFocus: { color: t.text.muted, fontSize: fonts.sm, marginTop: 4 },
    partnerStat: { color: t.text.primary, fontSize: fonts.sm, marginTop: 4 },
    ...
    demoText: { color: t.accent.orange || '#FF9500', fontSize: fonts.sm, textAlign: 'center', fontWeight: fonts.semibold },
    spotsText: { color: t.accent.green, fontSize: fonts.sm, fontWeight: fonts.semibold },
  }), [t]);
