...
export function AccessibilityScreen({ onClose }: Props) {
  ...
  const st = StyleSheet.create({
    ...
    title: { color: hcText, fontSize: fonts.xl * scale, fontWeight: fonts.bold },
    backText: { color: t.accent.blue, fontSize: fonts.lg * scale },
    section: { color: hcSecondary, fontSize: fonts.sm * scale, fontWeight: fonts.bold, textTransform: 'uppercase', letterSpacing: 1.5, marginTop: 24, marginBottom: 8, marginLeft: 4 },
    card: { backgroundColor: hcCard, borderRadius: 16, padding: 4 },
    row: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', padding: 16 },
    label: { color: hcText, fontSize: fonts.md * scale, flex: 1 },
    sublabel: { color: hcSecondary, fontSize: fonts.sm * scale, marginTop: 2 },
    ...
    sizeBtnText: { color: hcSecondary, fontSize: fonts.sm * scale, fontWeight: fonts.semibold },
    sizeBtnTextActive: { color: hcBg },
    previewCard: { backgroundColor: hcCard, borderRadius: 16, padding: 20, marginTop: 8 },
    previewTitle: { color: hcText, fontSize: fonts.xl * scale, fontWeight: fonts.bold, marginBottom: 12 },
    previewBalance: { color: t.accent.green, fontSize: fonts.xxxl * scale, fontWeight: fonts.bold, marginBottom: 4 },
    previewSub: { color: hcSecondary, fontSize: fonts.sm * scale },
    previewRow: { flexDirection: 'row', justifyContent: 'space-between', marginTop: 16 },
    previewToken: { color: hcText, fontSize: fonts.md * scale, fontWeight: fonts.semibold },
    previewAmount: { color: hcSecondary, fontSize: fonts.md * scale },
  });
