...
export function DeFiScreen({ onClose }: Props) {
  ...
  const s = useMemo(() => StyleSheet.create({
    ...
    statValue: { color: t.text.primary, fontSize: fonts.md, fontWeight: fonts.semibold },
    statValueGreen: { color: t.accent.green, fontSize: fonts.md, fontWeight: fonts.semibold },
    bigStat: { alignItems: 'center', paddingVertical: 12 },
    bigNumber: { color: t.accent.green, fontSize: fonts.hero, fontWeight: fonts.heavy },
    bigLabel: { color: t.text.muted, fontSize: fonts.sm, marginTop: 4 },
    divider: { height: 1, backgroundColor: t.border, marginVertical: 10 },
    stakingRow: { marginBottom: 8 },
    validatorName: { color: t.text.primary, fontSize: fonts.md, fontWeight: fonts.semibold },
    stakingDetail: { color: t.text.muted, fontSize: fonts.sm, marginTop: 2 },
    emptyText: { color: t.text.muted, fontSize: fonts.md, textAlign: 'center', paddingVertical: 16 },
  }), [t]);
