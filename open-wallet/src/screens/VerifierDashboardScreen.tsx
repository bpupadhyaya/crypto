  ...
  const styles = useMemo(
    () =>
      StyleSheet.create({
        ...
        pendingChannel: { fontSize: fonts.xs, fontWeight: fonts.semibold, color: t.accent.green, textTransform: 'uppercase', marginBottom: 4 },
        pendingMilestone: { fontSize: fonts.md, fontWeight: fonts.bold, color: t.text.primary, marginBottom: 4 },
        pendingEvidence: { fontSize: fonts.sm, color: t.text.secondary, lineHeight: 18, marginBottom: 8 },
        pendingMeta: { flexDirection: 'row', justifyContent: 'space-between', marginBottom: 10 },
        pendingSubmitter: { fontSize: fonts.sm, color: t.text.secondary },
        pendingOtk: { fontSize: fonts.sm, fontWeight: fonts.semibold, color: t.accent.green },
        actionRow: { flexDirection: 'row', gap: 8 },
        approveButton: { flex: 1, paddingVertical: 10, borderRadius: 8, backgroundColor: t.accent.green + '20', alignItems: 'center' },
        approveText: { fontSize: fonts.sm, fontWeight: fonts.semibold, color: t.accent.green },
        rejectButton: { flex: 1, paddingVertical: 10, borderRadius: 8, backgroundColor: '#F4433620', alignItems: 'center' },
        rejectText: { fontSize: fonts.sm, fontWeight: fonts.semibold, color: '#F44336' },
        flagButton: { flex: 1, paddingVertical: 10, borderRadius: 8, backgroundColor: '#FF980020', alignItems: 'center' },
        flagText: { fontSize: fonts.sm, fontWeight: fonts.semibold, color: '#FF9800' },
        ...
        attestInfo: { flex: 1 },
        attestMilestone: { fontSize: fonts.md, fontWeight: fonts.semibold, color: t.text.primary, marginBottom: 2 },
        attestDate: { fontSize: fonts.sm, color: t.text.secondary },
        attestRight: { alignItems: 'flex-end' },
        verdictBadge: { fontSize: fonts.sm, fontWeight: fonts.bold, textTransform: 'uppercase', marginBottom: 2 },
        consensusText: { fontSize: fonts.xs, color: t.text.secondary },
        ...
        metricLabel: { fontSize: fonts.md, color: t.text.secondary },
