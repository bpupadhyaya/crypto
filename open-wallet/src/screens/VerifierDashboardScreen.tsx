  ...
  const styles = useMemo(
    () =>
      StyleSheet.create({
        ...
        pendingChannel: { fontSize: 11, fontWeight: fonts.semibold, color: t.accent.green, textTransform: 'uppercase', marginBottom: 4 },
        pendingMilestone: { fontSize: 15, fontWeight: fonts.bold, color: t.text.primary, marginBottom: 4 },
        ...
        attestInfo: { flex: 1 },
        attestMilestone: { fontSize: 14, fontWeight: fonts.semibold, color: t.text.primary, marginBottom: 2 },
        attestDate: { fontSize: 12, color: t.text.secondary },
        attestRight: { alignItems: 'flex-end' },
        verdictBadge: { fontSize: 12, fontWeight: fonts.bold, textTransform: 'uppercase', marginBottom: 2 },
