...
export function VeteranScreen({ onClose }: Props) {
  ...
  const s = useMemo(() => StyleSheet.create({
    ...
    tabLabel: { color: t.text.secondary, fontSize: 11, fontWeight: '700' },
    ...
    mentorName: { color: t.text.primary, fontSize: 16, fontWeight: '700' },
    mentorBranch: { fontSize: 12, fontWeight: '700', marginTop: 4 },
    ...
    specialtyText: { color: t.accent.blue, fontSize: 11, fontWeight: '600' },
    ...
    availableText: { color: '#34C759', fontSize: 12, fontWeight: '600' },
    ...
    skillMilitary: { color: t.text.primary, fontSize: 15, fontWeight: '700' },
    skillRole: { color: t.text.muted, fontSize: 12, marginTop: 2 },
    skillArrow: { color: t.accent.blue, fontSize: 14, fontWeight: '700', marginTop: 8, marginBottom: 4 },
    ...
    certText: { color: t.accent.green, fontSize: 11, fontWeight: '600' },
    salaryText: { color: t.accent.purple, fontSize: 13, fontWeight: '700', marginTop: 8 },
    ...
    crisisName: { color: '#FF3B30', fontSize: 16, fontWeight: '800' },
    crisisContact: { color: t.text.primary, fontSize: 20, fontWeight: '700', marginTop: 6 },
    ...
    peerName: { color: t.text.primary, fontSize: 15, fontWeight: '700' },
    ...
    interestText: { color: t.text.secondary, fontSize: 11, fontWeight: '600' },
    ...
    demoLabel: { color: t.accent.purple, fontSize: 11, fontWeight: '700', textAlign: 'center', marginTop: 12 },
    ...
    recognitionTitle: { color: t.text.primary, fontSize: 16, fontWeight: '800', marginTop: 8 },
      ...
      {DEMO_PEERS.map(peer => (
        <View key={peer.id} style={s.peerCard}>
          ...
          <View style={[s.statusChip, { backgroundColor: peer.transitioned ? '#34C75920' : '#FF950020' }]}>
            <Text style={{ color: peer.transitioned ? '#34C759' : '#FF9500', fontSize: 11, fontWeight: '700' }}>
