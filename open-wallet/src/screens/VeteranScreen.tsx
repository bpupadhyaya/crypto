...
export function VeteranScreen({ onClose }: Props) {
  ...
  const s = useMemo(() => StyleSheet.create({
    ...
    categoryLabel: { color: t.text.secondary, fontSize: 11, fontWeight: fonts.semibold },
    categoryLabelActive: { color: '#fff' },
    mentorCard: { backgroundColor: t.bg.card, borderRadius: 16, padding: 16, marginHorizontal: 20, marginBottom: 12 },
    mentorName: { color: t.text.primary, fontSize: 16, fontWeight: fonts.bold },
    mentorBranch: { fontSize: 12, fontWeight: fonts.bold, marginTop: 4 },
    mentorRole: { color: t.text.muted, fontSize: 13, marginTop: 4 },
    ...
    specialtyText: { color: t.accent.blue, fontSize: 11, fontWeight: fonts.semibold },
    ...
    availableText: { color: '#34C759', fontSize: 12, fontWeight: fonts.semibold },
    ...
    skillMilitary: { color: t.text.primary, fontSize: 15, fontWeight: fonts.bold },
    skillRole: { color: t.text.muted, fontSize: 12, marginTop: 2 },
    skillArrow: { color: t.accent.blue, fontSize: 14, fontWeight: fonts.bold, marginTop: 8, marginBottom: 4 },
    civilianList: { marginTop: 4 },
    civilianItem: { color: t.text.primary, fontSize: 13, marginBottom: 2, paddingLeft: 8 },
    ...
    certText: { color: t.accent.green, fontSize: 11, fontWeight: fonts.semibold },
    salaryText: { color: t.accent.purple, fontSize: 13, fontWeight: fonts.bold, marginTop: 8 },
    ...
    crisisName: { color: '#FF3B30', fontSize: 16, fontWeight: fonts.heavy },
    crisisContact: { color: t.text.primary, fontSize: 20, fontWeight: fonts.bold, marginTop: 6 },
    crisisAvail: { color: t.text.secondary, fontSize: 12, marginTop: 4 },
    crisisDesc: { color: t.text.muted, fontSize: 13, marginTop: 6, lineHeight: 20 },
    peerCard: { backgroundColor: t.bg.card, borderRadius: 16, padding: 16, marginHorizontal: 20, marginBottom: 12 },
    peerName: { color: t.text.primary, fontSize: 15, fontWeight: fonts.bold },
    peerLocation: { color: t.text.muted, fontSize: 12, marginTop: 2 },
    ...
    interestText: { color: t.text.secondary, fontSize: 11, fontWeight: fonts.semibold },
    ...
    recognitionTitle: { color: t.text.primary, fontSize: 16, fontWeight: fonts.heavy, marginTop: 8 },
    recognitionDesc: { color: t.text.muted, fontSize: 13, textAlign: 'center', marginTop: 6, lineHeight: 20 },
  }), [t]);
      ...
      {DEMO_PEERS.map(peer => (
        <View key={peer.id} style={s.peerCard}>
          ...
          <View style={[s.statusChip, { backgroundColor: peer.transitioned ? '#34C75920' : '#FF950020' }]}>
            <Text style={{ color: peer.transitioned ? '#34C759' : '#FF9500', fontSize: 11, fontWeight: fonts.bold }}>
