  ...
  const styles = useMemo(
    () =>
      StyleSheet.create({
        ...
        summaryValue: { fontSize: 16, fontWeight: '700', color: t.accent.green },
        ...
        activityType: { fontSize: 11, fontWeight: '600', color: t.accent.green, textTransform: 'uppercase', marginBottom: 2 },
        activityDesc: { fontSize: 14, fontWeight: '600', color: t.text.primary, marginBottom: 4 },
        ...
        activityOtk: { fontSize: 12, fontWeight: '600', color: t.accent.green },
        ...
        resourceInfo: { flex: 1 },
        resourceName: { fontSize: 14, fontWeight: '600', color: t.text.primary, marginBottom: 2 },
        ...
        alertTitle: { fontSize: 15, fontWeight: '700', color: t.text.primary, marginBottom: 4 },
                ...
                <View key={alert.id} style={[styles.alertCard, { borderColor: a.border, borderLeftColor: a.border, backgroundColor: a.bg }]}>
                  ...
                  {alert.severity === 'urgent' && (
                    <TouchableOpacity style={styles.respondButton}>
                      <Text style={{ fontSize: 13, fontWeight: '600', color: '#FFFFFF' }}>Respond</Text>
                    </TouchableOpacity>
                  )}
                </View>
              );
