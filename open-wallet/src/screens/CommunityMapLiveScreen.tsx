  ...
  const styles = useMemo(
    () =>
      StyleSheet.create({
        ...
        summaryValue: { fontSize: 16, fontWeight: fonts.bold, color: t.accent.green },
        summaryLabel: { fontSize: 10, color: t.text.secondary },
        ...
        activityType: { fontSize: 11, fontWeight: fonts.semibold, color: t.accent.green, textTransform: 'uppercase', marginBottom: 2 },
        activityDesc: { fontSize: 14, fontWeight: fonts.semibold, color: t.text.primary, marginBottom: 4 },
        activityLocation: { fontSize: 13, color: t.text.secondary, marginBottom: 6 },
        activityFooter: { flexDirection: 'row', justifyContent: 'space-between' },
        activityStat: { fontSize: 12, color: t.text.secondary },
        activityOtk: { fontSize: 12, fontWeight: fonts.semibold, color: t.accent.green },
        ...
        resourceInfo: { flex: 1 },
        resourceName: { fontSize: 14, fontWeight: fonts.semibold, color: t.text.primary, marginBottom: 2 },
        resourceMeta: { fontSize: 12, color: t.text.secondary },
        statusDot: { width: 10, height: 10, borderRadius: 5, marginRight: 6 },
        statusLabel: { fontSize: 12, fontWeight: fonts.semibold },
        alertCard: { marginHorizontal: 16, marginTop: 12, padding: 14, borderRadius: 12, borderWidth: 1, borderLeftWidth: 4 },
        alertTitle: { fontSize: 15, fontWeight: fonts.bold, color: t.text.primary, marginBottom: 4 },
        alertMessage: { fontSize: 13, color: t.text.secondary, lineHeight: 18, marginBottom: 6 },
        alertMeta: { fontSize: 11, color: t.text.secondary },
                ...
                <View key={alert.id} style={[styles.alertCard, { borderColor: a.border, borderLeftColor: a.border, backgroundColor: a.bg }]}>
                  ...
                  {alert.severity === 'urgent' && (
                    <TouchableOpacity style={styles.respondButton}>
                      <Text style={{ fontSize: 13, fontWeight: fonts.semibold, color: '#FFFFFF' }}>Respond</Text>
                    </TouchableOpacity>
                  )}
                </View>
              );
