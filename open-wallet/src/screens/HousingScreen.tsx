...
export function HousingScreen({ onClose }: Props) {
  ...
  const st = useMemo(() => StyleSheet.create({
    ...
    scoreNum: { fontSize: fonts.xxl, fontWeight: fonts.heavy, color: '#fff' },
    scoreLabel: { color: t.text.muted, fontSize: fonts.xs, textAlign: 'center', marginBottom: 12 },
    dimRow: { flexDirection: 'row', alignItems: 'center', marginBottom: 10 },
    dimIcon: { fontSize: fonts.xl, width: 28 },
    dimContent: { flex: 1 },
    dimLabel: { color: t.text.primary, fontSize: fonts.sm, fontWeight: fonts.semibold },
    dimDesc: { color: t.text.muted, fontSize: fonts.xs },
    dimScore: { color: t.text.primary, fontSize: fonts.md, fontWeight: fonts.heavy, width: 36, textAlign: 'right' },
    badge: { paddingHorizontal: 8, paddingVertical: 3, borderRadius: 6, alignSelf: 'flex-start' },
    badgeText: { color: '#fff', fontSize: fonts.xs, fontWeight: fonts.bold, textTransform: 'uppercase' },
    cardTitle: { color: t.text.primary, fontSize: fonts.md, fontWeight: fonts.bold, marginBottom: 4 },
    cardDesc: { color: t.text.muted, fontSize: fonts.sm, lineHeight: 18, marginBottom: 8 },
    ...
    availText: { color: '#16a34a', fontSize: fonts.xs, fontWeight: fonts.bold },
    phone: { color: t.accent.blue, fontSize: fonts.sm, fontWeight: fonts.semibold, marginBottom: 6 },
    inputLabel: { color: t.text.secondary, fontSize: fonts.sm, fontWeight: fonts.semibold, marginBottom: 6, marginTop: 12 },
    input: { backgroundColor: t.bg.card, borderRadius: 10, padding: 12, color: t.text.primary, fontSize: fonts.md, borderWidth: 1, borderColor: t.border },
    textArea: { backgroundColor: t.bg.card, borderRadius: 10, padding: 12, color: t.text.primary, fontSize: fonts.md, borderWidth: 1, borderColor: t.border, minHeight: 80, textAlignVertical: 'top' },
    ...
    urgencyText: { fontSize: fonts.xs, fontWeight: fonts.bold },
    ...
    successTitle: { color: t.accent.green, fontSize: fonts.lg, fontWeight: fonts.bold, marginBottom: 4 },
    successText: { color: t.text.muted, fontSize: fonts.sm, textAlign: 'center', lineHeight: 20 },
    ...
    fundTitle: { color: t.accent.green, fontSize: fonts.md, fontWeight: fonts.bold, marginBottom: 4 },
    fundRow: { flexDirection: 'row', justifyContent: 'space-between', marginBottom: 2 },
    fundLabel: { color: t.text.muted, fontSize: fonts.sm },
    fundVal: { color: t.text.primary, fontSize: fonts.sm, fontWeight: fonts.bold },
    ...
    skillIcon: { fontSize: fonts.lg, marginRight: 8 },
    skillName: { color: t.text.primary, fontSize: fonts.md, fontWeight: fonts.bold, flex: 1 },
    skillDetail: { color: t.text.muted, fontSize: fonts.xs },
