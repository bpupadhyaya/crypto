...
export function HousingScreen({ onClose }: Props) {
  ...
  const st = useMemo(() => StyleSheet.create({
    ...
    scoreNum: { fontSize: 22, fontWeight: fonts.heavy, color: '#fff' },
    ...
    dimContent: { flex: 1 },
    dimLabel: { color: t.text.primary, fontSize: 13, fontWeight: fonts.semibold },
    dimDesc: { color: t.text.muted, fontSize: 11 },
    dimScore: { color: t.text.primary, fontSize: 15, fontWeight: fonts.heavy, width: 36, textAlign: 'right' },
    badge: { paddingHorizontal: 8, paddingVertical: 3, borderRadius: 6, alignSelf: 'flex-start' },
    badgeText: { color: '#fff', fontSize: 10, fontWeight: fonts.bold, textTransform: 'uppercase' },
    ...
    availText: { color: '#16a34a', fontSize: 11, fontWeight: fonts.bold },
    phone: { color: t.accent.blue, fontSize: 13, fontWeight: fonts.semibold, marginBottom: 6 },
    ...
    urgencyText: { fontSize: 11, fontWeight: fonts.bold },
    ...
    successTitle: { color: t.accent.green, fontSize: 16, fontWeight: fonts.bold, marginBottom: 4 },
    ...
    fundTitle: { color: t.accent.green, fontSize: 14, fontWeight: fonts.bold, marginBottom: 4 },
    fundRow: { flexDirection: 'row', justifyContent: 'space-between', marginBottom: 2 },
    fundLabel: { color: t.text.muted, fontSize: 12 },
    fundVal: { color: t.text.primary, fontSize: 12, fontWeight: fonts.bold },
    ...
    skillName: { color: t.text.primary, fontSize: 14, fontWeight: fonts.bold, flex: 1 },
