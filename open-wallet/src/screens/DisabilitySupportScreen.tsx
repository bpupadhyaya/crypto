...
export function DisabilitySupportScreen({ onClose }: Props) {
  ...
  const s = useMemo(() => StyleSheet.create({
    ...
    needLabel: { color: t.text.primary, fontSize: 16, fontWeight: '700', flex: 1 },
    ...
    resourceName: { color: t.text.primary, fontSize: 15, fontWeight: '700', flex: 1 },
    availBadge: { paddingHorizontal: 8, paddingVertical: 3, borderRadius: 8 },
    availText: { fontSize: 10, fontWeight: '700' },
    resourceType: { color: t.accent.blue, fontSize: 12, fontWeight: '600', marginBottom: 4 },
    ...
    venueName: { color: t.text.primary, fontSize: 15, fontWeight: '700', marginBottom: 4 },
    ...
    venueVerified: { color: t.accent.green, fontSize: 11, fontWeight: '600' },
    ...
    featureText: { color: t.accent.green, fontSize: 11, fontWeight: '600' },
    ...
    barrierLocation: { color: t.text.primary, fontSize: 14, fontWeight: '700', flex: 1 },
    statusBadge: { paddingHorizontal: 8, paddingVertical: 3, borderRadius: 8 },
    statusText: { color: '#fff', fontSize: 10, fontWeight: '700', textTransform: 'uppercase' },
    barrierType: { color: t.accent.orange, fontSize: 12, fontWeight: '600', marginBottom: 4 },
    ...
    peerNeedText: { color: '#fff', fontSize: 10, fontWeight: '600' },
    ...
    addNeedText: { color: t.accent.blue, fontSize: 14, fontWeight: '600' },
  }), [t]);
