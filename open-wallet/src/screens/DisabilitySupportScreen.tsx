...
export function DisabilitySupportScreen({ onClose }: Props) {
  ...
  const s = useMemo(() => StyleSheet.create({
    ...
    needIcon: { fontSize: 22, marginRight: 10 },
    needLabel: { color: t.text.primary, fontSize: 16, fontWeight: fonts.bold, flex: 1 },
    ...
    toolText: { color: t.text.secondary, fontSize: 12 },
    ...
    resourceName: { color: t.text.primary, fontSize: 15, fontWeight: fonts.bold, flex: 1 },
    availBadge: { paddingHorizontal: 8, paddingVertical: 3, borderRadius: 8 },
    availText: { fontSize: 10, fontWeight: fonts.bold },
    resourceType: { color: t.accent.blue, fontSize: 12, fontWeight: fonts.semibold, marginBottom: 4 },
    resourceProvider: { color: t.text.muted, fontSize: 12, marginBottom: 4 },
    resourceDesc: { color: t.text.secondary, fontSize: 13, lineHeight: 18 },
    resourceDistance: { color: t.text.muted, fontSize: 11, marginTop: 6 },
    venueCard: { backgroundColor: t.bg.secondary, borderRadius: 14, padding: 16, marginHorizontal: 20, marginBottom: 12 },
    venueName: { color: t.text.primary, fontSize: 15, fontWeight: fonts.bold, marginBottom: 4 },
    venueAddress: { color: t.text.muted, fontSize: 12, marginBottom: 8 },
    venueRating: { flexDirection: 'row', alignItems: 'center', marginBottom: 8 },
    venueStars: { color: t.accent.orange, fontSize: 14, marginRight: 6 },
    venueVerified: { color: t.accent.green, fontSize: 11, fontWeight: fonts.semibold },
    ...
    featureText: { color: t.accent.green, fontSize: 11, fontWeight: fonts.semibold },
    ...
    barrierLocation: { color: t.text.primary, fontSize: 14, fontWeight: fonts.bold, flex: 1 },
    statusBadge: { paddingHorizontal: 8, paddingVertical: 3, borderRadius: 8 },
    statusText: { color: '#fff', fontSize: 10, fontWeight: fonts.bold, textTransform: 'uppercase' },
    barrierType: { color: t.accent.orange, fontSize: 12, fontWeight: fonts.semibold, marginBottom: 4 },
    barrierDesc: { color: t.text.secondary, fontSize: 13, lineHeight: 18 },
    barrierDate: { color: t.text.muted, fontSize: 11, marginTop: 6 },
    ...
    peerActive: { color: t.text.muted, fontSize: 11 },
    ...
    peerNeedText: { color: '#fff', fontSize: 10, fontWeight: fonts.semibold },
    peerInterests: { color: t.text.secondary, fontSize: 12 },
    ...
    connectText: { color: '#fff', fontSize: 13, fontWeight: fonts.semibold },
    ...
    reportText: { color: '#fff', fontSize: 14, fontWeight: fonts.bold },
    ...
    addNeedText: { color: t.accent.blue, fontSize: 14, fontWeight: fonts.semibold },
  }), [t]);
