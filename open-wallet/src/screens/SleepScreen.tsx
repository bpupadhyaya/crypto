...
export function SleepScreen({ onClose }: Props) {
  ...
  const s = useMemo(() => StyleSheet.create({
    ...
    qualityNumber: { fontSize: fonts.lg, fontWeight: fonts.bold },
    qualityLabel: { fontSize: fonts.xs, marginTop: 2 },
    ...
    chartDate: { color: t.text.muted, fontSize: fonts.xs, width: 50 },
    chartBar: { color: t.accent.blue, fontSize: fonts.xs, fontFamily: 'Courier', flex: 1 },
    chartHours: { color: t.text.primary, fontSize: fonts.sm, fontWeight: fonts.semibold, width: 45, textAlign: 'right' },
    ...
    entryIconText: { fontSize: fonts.md, fontWeight: fonts.bold },
    entryInfo: { flex: 1 },
    entryTitle: { color: t.text.primary, fontSize: fonts.md, fontWeight: fonts.semibold },
    entryMeta: { color: t.text.muted, fontSize: fonts.sm, marginTop: 2 },
    entryRight: { alignItems: 'flex-end', justifyContent: 'center' },
    entryHotk: { color: t.accent.green, fontSize: fonts.md, fontWeight: fonts.bold },
    ...
    tipIconText: { color: t.accent.blue, fontSize: fonts.md, fontWeight: fonts.bold },
    tipTitle: { color: t.text.primary, fontSize: fonts.md, fontWeight: fonts.bold, marginTop: 10 },
    tipDetail: { color: t.text.muted, fontSize: fonts.sm, lineHeight: 20, marginTop: 6 },
    ...
    challengeMeta: { color: t.text.muted, fontSize: fonts.sm, marginTop: 8 },
    ...
    challengeBtnText: { fontSize: fonts.sm, fontWeight: fonts.bold },
