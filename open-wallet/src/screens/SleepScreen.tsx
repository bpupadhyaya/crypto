...
export function SleepScreen({ onClose }: Props) {
  ...
  const s = useMemo(() => StyleSheet.create({
    ...
    qualityNumber: { fontSize: 16, fontWeight: fonts.bold },
    ...
    chartHours: { color: t.text.primary, fontSize: 12, fontWeight: fonts.semibold, width: 45, textAlign: 'right' },
    ...
    entryIconText: { fontSize: 14, fontWeight: fonts.bold },
    entryInfo: { flex: 1 },
    entryTitle: { color: t.text.primary, fontSize: 14, fontWeight: fonts.semibold },
    entryMeta: { color: t.text.muted, fontSize: 12, marginTop: 2 },
    entryRight: { alignItems: 'flex-end', justifyContent: 'center' },
    entryHotk: { color: t.accent.green, fontSize: 14, fontWeight: fonts.bold },
    ...
    tipIconText: { color: t.accent.blue, fontSize: 14, fontWeight: fonts.bold },
    tipTitle: { color: t.text.primary, fontSize: 15, fontWeight: fonts.bold, marginTop: 10 },
    ...
    challengeBtnText: { fontSize: 13, fontWeight: fonts.bold },
