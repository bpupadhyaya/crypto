...
export function FeedbackFormScreen({ onClose }: Props) {
  ...
  const st = useMemo(() => StyleSheet.create({
    ...
    ratingLabel: { fontSize: 10, fontWeight: fonts.semibold, marginTop: 4 },
    ...
    categoryText: { fontSize: 12, fontWeight: fonts.semibold },
    ...
    successTitle: { color: t.accent.green, fontSize: 18, fontWeight: fonts.bold, marginBottom: 4 },
    ...
    resetText: { color: t.accent.blue, fontSize: 14, fontWeight: fonts.semibold },
    ...
    recentInfo: { flex: 1 },
    recentTitle: { color: t.text.primary, fontSize: 13, fontWeight: fonts.semibold },
    recentMeta: { color: t.text.muted, fontSize: 11, marginTop: 2 },
    recentStatus: { fontSize: 11, fontWeight: fonts.bold },
  }), [t]);
