...
export function FeedbackFormScreen({ onClose }: Props) {
  ...
  const st = useMemo(() => StyleSheet.create({
    ...
    ratingIcon: { fontSize: fonts.xxxl },
    ratingLabel: { fontSize: fonts.xs, fontWeight: fonts.semibold, marginTop: 4 },
    ...
    categoryText: { fontSize: fonts.sm, fontWeight: fonts.semibold },
    ...
    successTitle: { color: t.accent.green, fontSize: fonts.xl, fontWeight: fonts.bold, marginBottom: 4 },
    successText: { color: t.text.secondary, fontSize: fonts.sm, textAlign: 'center' },
    ...
    resetText: { color: t.accent.blue, fontSize: fonts.md, fontWeight: fonts.semibold },
    recentCard: { backgroundColor: t.bg.card, borderRadius: 12, padding: 14, marginBottom: 8, flexDirection: 'row', alignItems: 'center' },
    recentIcon: { fontSize: fonts.xl, marginRight: 10 },
    recentInfo: { flex: 1 },
    recentTitle: { color: t.text.primary, fontSize: fonts.sm, fontWeight: fonts.semibold },
    recentMeta: { color: t.text.muted, fontSize: fonts.xs, marginTop: 2 },
    recentStatus: { fontSize: fonts.xs, fontWeight: fonts.bold },
  }), [t]);
