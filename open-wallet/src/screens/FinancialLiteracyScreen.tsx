...
export function FinancialLiteracyScreen({ onClose }: Props) {
  ...
  const s = useMemo(() => StyleSheet.create({
    ...
    xotkBadge: { color: t.accent.green, fontSize: fonts.sm, fontWeight: fonts.bold, marginTop: 4 },
    ...
    quizQuestion: { color: t.text.primary, fontSize: fonts.md, fontWeight: fonts.bold, marginBottom: 12 },
    ...
    quizOptionText: { color: t.text.primary, fontSize: fonts.md },
    quizReward: { color: t.accent.green, fontSize: fonts.sm, fontWeight: fonts.semibold, textAlign: 'center', marginTop: 8 },
    // Calculator styles
    calcCard: { backgroundColor: t.bg.card, borderRadius: 20, padding: 20, marginBottom: 16 },
    calcTitle: { color: t.text.primary, fontSize: fonts.lg, fontWeight: fonts.bold, marginBottom: 12 },
    calcRow: { flexDirection: 'row', justifyContent: 'space-between', marginBottom: 10 },
    calcLabel: { color: t.text.secondary, fontSize: fonts.sm },
    calcValue: { color: t.text.primary, fontSize: fonts.sm, fontWeight: fonts.bold },
    calcResult: { backgroundColor: t.accent.green + '15', borderRadius: 14, padding: 16, alignItems: 'center', marginTop: 8 },
    calcResultLabel: { color: t.text.muted, fontSize: fonts.sm },
    calcResultValue: { color: t.accent.green, fontSize: fonts.xxxl, fontWeight: fonts.heavy, marginTop: 4 },
    calcResultGain: { color: t.text.secondary, fontSize: fonts.sm, marginTop: 4 },
    // Mentor styles
    mentorCard: { backgroundColor: t.bg.card, borderRadius: 16, padding: 16, marginBottom: 12, flexDirection: 'row', alignItems: 'center' },
    mentorIcon: { fontSize: fonts.hero, marginRight: 14 },
    mentorInfo: { flex: 1 },
    mentorName: { color: t.text.primary, fontSize: fonts.md, fontWeight: fonts.bold },
    mentorSpecialty: { color: t.text.muted, fontSize: fonts.sm, marginTop: 2 },
    mentorStats: { flexDirection: 'row', marginTop: 6, gap: 12 },
    mentorStat: { color: t.text.secondary, fontSize: fonts.xs },
    ...
    healthScoreValue: { fontSize: fonts.hero, fontWeight: fonts.heavy },
    healthScoreLabel: { color: t.text.muted, fontSize: fonts.sm },
    ...
    healthMetricIcon: { fontSize: fonts.xxl, marginRight: 10 },
    healthMetricLabel: { color: t.text.primary, fontSize: fonts.md, fontWeight: fonts.semibold, flex: 1 },
    healthMetricValue: { fontSize: fonts.md, fontWeight: fonts.bold },
    ...
    goalDesc: { color: t.text.muted, fontSize: fonts.sm, marginTop: 4 },
    goalAmount: { color: t.accent.blue, fontSize: fonts.xl, fontWeight: fonts.heavy, marginTop: 8 },
  }), [t]);
