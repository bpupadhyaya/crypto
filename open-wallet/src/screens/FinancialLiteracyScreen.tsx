...
export function FinancialLiteracyScreen({ onClose }: Props) {
  ...
  const s = useMemo(() => StyleSheet.create({
    ...
    cardInfo: { flex: 1 },
    cardTitle: { color: t.text.primary, fontSize: 14, fontWeight: '700' },
    ...
    xotkBadge: { color: t.accent.green, fontSize: 13, fontWeight: '700', marginTop: 4 },
    ...
    quizQuestion: { color: t.text.primary, fontSize: 15, fontWeight: '700', marginBottom: 12 },
    ...
    quizReward: { color: t.accent.green, fontSize: 12, fontWeight: '600', textAlign: 'center', marginTop: 8 },
    // Calculator styles
    calcCard: { backgroundColor: t.bg.card, borderRadius: 20, padding: 20, marginBottom: 16 },
    calcTitle: { color: t.text.primary, fontSize: 16, fontWeight: '700', marginBottom: 12 },
    calcRow: { flexDirection: 'row', justifyContent: 'space-between', marginBottom: 10 },
    calcLabel: { color: t.text.secondary, fontSize: 13 },
    calcValue: { color: t.text.primary, fontSize: 13, fontWeight: '700' },
    ...
    calcResultValue: { color: t.accent.green, fontSize: 28, fontWeight: '800', marginTop: 4 },
    ...
    healthMetricLabel: { color: t.text.primary, fontSize: 14, fontWeight: '600', flex: 1 },
    healthMetricValue: { fontSize: 14, fontWeight: '700' },
    ...
    goalTitle: { color: t.text.primary, fontSize: 14, fontWeight: '700' },
    goalDesc: { color: t.text.muted, fontSize: 12, marginTop: 4 },
    goalAmount: { color: t.accent.blue, fontSize: 20, fontWeight: '800', marginTop: 8 },
  }), [t]);
