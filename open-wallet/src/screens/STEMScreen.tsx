...
export function STEMScreen({ onClose }: Props) {
  ...
  const s = useMemo(() => StyleSheet.create({
    ...
    ageChipText: { color: t.text.muted, fontSize: 12, fontWeight: '600' },
    ...
    mentorName: { color: t.text.primary, fontSize: 15, fontWeight: '700' },
    mentorField: { color: t.accent.blue, fontSize: 12, fontWeight: '600', marginTop: 2 },
    ...
    expTitle: { color: t.text.primary, fontSize: 14, fontWeight: '700' },
    expCategory: { color: t.accent.blue, fontSize: 11, fontWeight: '600', marginTop: 2 },
    expMeta: { flexDirection: 'row', gap: 12, marginTop: 8 },
    expMetaText: { color: t.text.muted, fontSize: 11 },
    materialsTitle: { color: t.text.secondary, fontSize: 11, fontWeight: '600', marginTop: 10, marginBottom: 4 },
    ...
    fairTitle: { color: t.text.primary, fontSize: 17, fontWeight: '800', textAlign: 'center', marginTop: 8 },
    fairDate: { color: t.accent.purple, fontSize: 13, fontWeight: '600', textAlign: 'center', marginTop: 4 },
    fairStatus: { color: t.accent.orange, fontSize: 12, fontWeight: '700', textAlign: 'center', marginTop: 4, textTransform: 'uppercase' },
    fairStats: { flexDirection: 'row', justifyContent: 'space-around', marginTop: 16 },
    fairStatValue: { color: t.text.primary, fontSize: 22, fontWeight: '800', textAlign: 'center' },
