...
export function HelpScreen({ onClose }: Props) {
  ...
  const st = useMemo(() => StyleSheet.create({
    ...
    searchInput: { color: t.text.primary, fontSize: 15 },
    ...
    questionText: { color: t.text.primary, fontSize: 14, flex: 1, paddingRight: 8 },
    questionArrow: { color: t.text.muted, fontSize: 14 },
    answerContainer: {
      paddingHorizontal: 16, paddingVertical: 12,
      backgroundColor: t.bg.primary, borderBottomWidth: 1, borderBottomColor: t.border,
    },
    answerText: { color: t.text.secondary, fontSize: 13, lineHeight: 20 },
    linksContainer: {
    ...
    linkText: { color: t.accent.blue, fontSize: 14 },
    linkArrow: { color: t.text.muted, fontSize: 14 },
    noResults: { color: t.text.muted, fontSize: 14, textAlign: 'center', marginTop: 40 },
  }), [t]);
