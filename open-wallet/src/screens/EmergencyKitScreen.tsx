...
export function EmergencyKitScreen({ onClose }: Props) {
  ...
  const s = useMemo(() => StyleSheet.create({
    ...
    warningText: { color: '#ef4444', fontSize: 13, fontWeight: '600', lineHeight: 20 },
    docCard: { backgroundColor: t.bg.card, borderRadius: 14, padding: 16, marginBottom: 10, flexDirection: 'row', alignItems: 'center', gap: 14 },
    docIcon: { fontSize: 28 },
    docInfo: { flex: 1 },
    docTitle: { color: t.text.primary, fontSize: 14, fontWeight: '700', marginBottom: 2 },
    ...
    addBtnText: { color: t.accent.blue, fontSize: 14, fontWeight: '700' },
    ...
    contactInfo: { flex: 1 },
    contactName: { color: t.text.primary, fontSize: 14, fontWeight: '700', marginBottom: 2 },
    ...
    stepCheckText: { color: '#fff', fontSize: 12, fontWeight: '800' },
    stepInfo: { flex: 1 },
    stepTitle: { color: t.text.primary, fontSize: 14, fontWeight: '700', marginBottom: 2 },
    stepDesc: { color: t.text.secondary, fontSize: 13, lineHeight: 20 },
    stepNum: { color: t.text.muted, fontSize: 11, fontWeight: '700', marginTop: 4 },
