...
export function EmergencyKitScreen({ onClose }: Props) {
  ...
  const s = useMemo(() => StyleSheet.create({
    ...
    warningText: { color: '#ef4444', fontSize: fonts.sm, fontWeight: fonts.semibold, lineHeight: 20 },
    docCard: { backgroundColor: t.bg.card, borderRadius: 14, padding: 16, marginBottom: 10, flexDirection: 'row', alignItems: 'center', gap: 14 },
    docIcon: { fontSize: fonts.xxxl },
    docInfo: { flex: 1 },
    docTitle: { color: t.text.primary, fontSize: fonts.md, fontWeight: fonts.bold, marginBottom: 2 },
    docMeta: { color: t.text.muted, fontSize: fonts.sm },
    docBadge: { paddingHorizontal: 8, paddingVertical: 3, borderRadius: 6 },
    docBadgeText: { fontSize: fonts.xs, fontWeight: fonts.bold },
    ...
    addBtnText: { color: t.accent.blue, fontSize: fonts.md, fontWeight: fonts.bold },
    ...
    contactIcon: { fontSize: fonts.xxxl },
    contactInfo: { flex: 1 },
    contactName: { color: t.text.primary, fontSize: fonts.md, fontWeight: fonts.bold, marginBottom: 2 },
    contactRelation: { color: t.text.secondary, fontSize: fonts.sm },
    ...
    stepCheckText: { color: '#fff', fontSize: fonts.sm, fontWeight: fonts.heavy },
    stepInfo: { flex: 1 },
    stepTitle: { color: t.text.primary, fontSize: fonts.md, fontWeight: fonts.bold, marginBottom: 2 },
    stepDesc: { color: t.text.secondary, fontSize: fonts.sm, lineHeight: 20 },
    stepNum: { color: t.text.muted, fontSize: fonts.xs, fontWeight: fonts.bold, marginTop: 4 },
