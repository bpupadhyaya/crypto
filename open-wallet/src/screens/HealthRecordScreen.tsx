...
export function HealthRecordScreen({ onClose }: Props) {
  ...
  const s = useMemo(() => StyleSheet.create({
    ...
    encryptedText: { color: t.accent.green, fontSize: fonts.sm, fontWeight: fonts.bold, flex: 1 },
    lockIcon: { color: t.accent.green, fontSize: fonts.lg, marginRight: 8 },
    recordCard: { backgroundColor: t.bg.secondary, borderRadius: 14, padding: 16, marginHorizontal: 20, marginBottom: 12 },
    recordTitle: { color: t.text.primary, fontSize: fonts.md, fontWeight: fonts.bold },
    recordMeta: { color: t.text.muted, fontSize: fonts.sm, marginTop: 4 },
    recordDate: { color: t.accent.blue, fontSize: fonts.sm, fontWeight: fonts.semibold, marginTop: 4 },
    recordNotes: { color: t.text.muted, fontSize: fonts.sm, lineHeight: 19, marginTop: 6, fontStyle: 'italic' },
    ...
    nextDue: { color: t.accent.orange, fontSize: fonts.sm, fontWeight: fonts.semibold, marginTop: 4 },
    medCard: { backgroundColor: t.bg.secondary, borderRadius: 14, padding: 16, marginHorizontal: 20, marginBottom: 12 },
    medName: { color: t.text.primary, fontSize: fonts.md, fontWeight: fonts.bold },
    medDosage: { color: t.accent.purple, fontSize: fonts.sm, fontWeight: fonts.semibold, marginTop: 4 },
    medFrequency: { color: t.text.muted, fontSize: fonts.sm, marginTop: 2 },
    medPrescriber: { color: t.text.muted, fontSize: fonts.sm, marginTop: 4 },
    medRefill: { color: t.accent.orange, fontSize: fonts.sm, fontWeight: fonts.semibold, marginTop: 4 },
    ...
    activeText: { color: t.accent.green, fontSize: fonts.xs, fontWeight: fonts.bold },
    ...
    inactiveText: { color: t.text.muted, fontSize: fonts.xs, fontWeight: fonts.bold },
    labCard: { backgroundColor: t.bg.secondary, borderRadius: 14, padding: 16, marginHorizontal: 20, marginBottom: 12 },
    labName: { color: t.text.primary, fontSize: fonts.md, fontWeight: fonts.bold },
    labMeta: { color: t.text.muted, fontSize: fonts.sm, marginTop: 4 },
    labSummary: { color: t.text.muted, fontSize: fonts.sm, lineHeight: 19, marginTop: 6 },
    labStatus: { fontSize: fonts.sm, fontWeight: fonts.bold, marginTop: 6 },
    shareCard: { backgroundColor: t.bg.secondary, borderRadius: 14, padding: 16, marginHorizontal: 20, marginBottom: 12 },
    shareProvider: { color: t.text.primary, fontSize: fonts.md, fontWeight: fonts.bold },
    shareFields: { color: t.accent.purple, fontSize: fonts.sm, fontWeight: fonts.semibold, marginTop: 4 },
    shareDates: { color: t.text.muted, fontSize: fonts.sm, marginTop: 4 },
    shareActive: { color: t.accent.green, fontSize: fonts.sm, fontWeight: fonts.bold, marginTop: 4 },
    ...
    zkNote: { color: t.accent.blue, fontSize: fonts.sm, fontStyle: 'italic', marginTop: 8, textAlign: 'center' },
  }), [t]);
  ...
  const renderShare = () => (
    <>
      ...
      <View style={s.card}>
        ...
        <Text style={{ color: t.text.muted, fontSize: fonts.sm, marginBottom: 8 }}>Select records to share (selective disclosure)</Text>
