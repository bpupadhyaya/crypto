...
export function HealthRecordScreen({ onClose }: Props) {
  ...
  const s = useMemo(() => StyleSheet.create({
    ...
    encryptedText: { color: t.accent.green, fontSize: 12, fontWeight: '700', flex: 1 },
    ...
    recordTitle: { color: t.text.primary, fontSize: 15, fontWeight: '700' },
    recordMeta: { color: t.text.muted, fontSize: 12, marginTop: 4 },
    recordDate: { color: t.accent.blue, fontSize: 12, fontWeight: '600', marginTop: 4 },
    ...
    nextDue: { color: t.accent.orange, fontSize: 12, fontWeight: '600', marginTop: 4 },
    medCard: { backgroundColor: t.bg.secondary, borderRadius: 14, padding: 16, marginHorizontal: 20, marginBottom: 12 },
    medName: { color: t.text.primary, fontSize: 15, fontWeight: '700' },
    medDosage: { color: t.accent.purple, fontSize: 13, fontWeight: '600', marginTop: 4 },
    medFrequency: { color: t.text.muted, fontSize: 12, marginTop: 2 },
    medPrescriber: { color: t.text.muted, fontSize: 12, marginTop: 4 },
    medRefill: { color: t.accent.orange, fontSize: 12, fontWeight: '600', marginTop: 4 },
    ...
    activeText: { color: t.accent.green, fontSize: 11, fontWeight: '700' },
