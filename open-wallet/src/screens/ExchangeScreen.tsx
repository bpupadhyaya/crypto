...
export function ExchangeScreen({ onClose }: Props) {
  ...
  const s = useMemo(() => StyleSheet.create({
    ...
    title: { color: t.text.primary, fontSize: 24, fontWeight: fonts.heavy },
    closeBtn: { padding: 8 },
    closeText: { color: t.accent.blue, fontSize: 16, fontWeight: fonts.semibold },
    ...
    tokenSymbol: { color: t.text.primary, fontSize: 20, fontWeight: fonts.heavy },
    ...
    amountInput: { color: t.text.primary, fontSize: 24, fontWeight: fonts.semibold, marginTop: 10, borderTopWidth: 1, borderTopColor: t.border, paddingTop: 10 },
    // Flip button
    ...
    outputAmount: { color: t.accent.green, fontSize: 22, fontWeight: fonts.heavy, textAlign: 'center' },
    ...
    routeName: { color: t.text.primary, fontSize: 15, fontWeight: fonts.bold, flex: 1 },
    routeOutput: { color: t.accent.green, fontSize: 16, fontWeight: fonts.heavy },
    ...
    btnText: { color: '#fff', fontSize: 17, fontWeight: fonts.bold },
    // Loading
    ...
    modalTitle: { color: t.text.primary, fontSize: 20, fontWeight: fonts.heavy, marginBottom: 16 },
    modalClose: { color: t.accent.blue, fontSize: 16, fontWeight: fonts.semibold, textAlign: 'right', paddingBottom: 10 },
    ...
    tokenListLeft: { gap: 2 },
    tokenListSymbol: { color: t.text.primary, fontSize: 16, fontWeight: fonts.bold },
    tokenListName: { color: t.text.muted, fontSize: 13 },
    tokenListRight: { alignItems: 'flex-end' },
    tokenListPrice: { color: t.text.secondary, fontSize: 14, fontWeight: fonts.semibold },
