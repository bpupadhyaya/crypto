...
export function ExchangeScreen({ onClose }: Props) {
  ...
  const s = useMemo(() => StyleSheet.create({
    ...
    closeBtn: { padding: 8 },
    closeText: { color: t.accent.blue, fontSize: fonts.lg, fontWeight: fonts.semibold },
    subtitle: { color: t.text.muted, fontSize: fonts.sm, marginBottom: 16 },
    ...
    tokenSymbol: { color: t.text.primary, fontSize: fonts.xl, fontWeight: fonts.heavy },
    tokenChain: { color: t.text.muted, fontSize: fonts.sm },
    tokenBalance: { color: t.text.secondary, fontSize: fonts.sm, marginTop: 2 },
    tokenPrice: { color: t.text.muted, fontSize: fonts.xs },
    chevron: { color: t.text.muted, fontSize: fonts.xl },
    amountInput: { color: t.text.primary, fontSize: fonts.xxl, fontWeight: fonts.semibold, marginTop: 10, borderTopWidth: 1, borderTopColor: t.border, paddingTop: 10 },
    // Flip button
    ...
    outputAmount: { color: t.accent.green, fontSize: fonts.xxl, fontWeight: fonts.heavy, textAlign: 'center' },
    outputSub: { color: t.text.muted, fontSize: fonts.sm, textAlign: 'center', marginTop: 4 },
    // Route cards
    ...
    routeName: { color: t.text.primary, fontSize: fonts.md, fontWeight: fonts.bold, flex: 1 },
    routeOutput: { color: t.accent.green, fontSize: fonts.lg, fontWeight: fonts.heavy },
    ...
    stepMeta: { color: t.text.muted, fontSize: fonts.xs },
    ...
    btnText: { color: '#fff', fontSize: fonts.lg, fontWeight: fonts.bold },
    // Loading
    ...
    modalClose: { color: t.accent.blue, fontSize: fonts.lg, fontWeight: fonts.semibold, textAlign: 'right', paddingBottom: 10 },
    ...
    tokenListLeft: { gap: 2 },
    tokenListSymbol: { color: t.text.primary, fontSize: fonts.lg, fontWeight: fonts.bold },
    tokenListName: { color: t.text.muted, fontSize: fonts.sm },
    tokenListRight: { alignItems: 'flex-end' },
    tokenListPrice: { color: t.text.secondary, fontSize: fonts.md, fontWeight: fonts.semibold },
    tokenListChain: { color: t.text.muted, fontSize: fonts.xs, marginTop: 2 },
    // Fallback note
