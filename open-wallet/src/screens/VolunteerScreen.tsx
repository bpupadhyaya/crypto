...
export function VolunteerScreen({ onClose }: Props) {
  ...
  const s = useMemo(() => StyleSheet.create({
    ...
    hoursLabel: { color: t.text.muted, fontSize: fonts.sm, textTransform: 'uppercase', letterSpacing: 1 },
    ...
    serviceIconText: { color: t.accent.green, fontSize: fonts.md, fontWeight: fonts.bold },
    serviceInfo: { flex: 1 },
    serviceTitle: { color: t.text.primary, fontSize: fonts.md, fontWeight: fonts.semibold },
    serviceMeta: { color: t.text.muted, fontSize: fonts.sm, marginTop: 2 },
    serviceRight: { alignItems: 'flex-end', justifyContent: 'center' },
    serviceCotk: { color: t.accent.green, fontSize: fonts.md, fontWeight: fonts.bold },
    serviceVerified: { fontSize: fonts.xs, marginTop: 2 },
    ...
    oppMeta: { color: t.text.muted, fontSize: fonts.sm, marginTop: 4 },
    oppReward: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', marginTop: 10 },
    oppCotkText: { color: t.accent.green, fontSize: fonts.md, fontWeight: fonts.bold },
    oppSignup: { backgroundColor: t.accent.blue, paddingHorizontal: 16, paddingVertical: 8, borderRadius: 10 },
    oppSignupText: { color: '#fff', fontSize: fonts.sm, fontWeight: fonts.semibold },
    ...
    leaderHoursText: { color: t.accent.green, fontSize: fonts.lg, fontWeight: fonts.heavy },
    leaderHoursLabel: { color: t.text.muted, fontSize: fonts.xs },
