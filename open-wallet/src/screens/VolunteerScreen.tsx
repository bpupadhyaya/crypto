...
export function VolunteerScreen({ onClose }: Props) {
  ...
  const s = useMemo(() => StyleSheet.create({
    ...
    hoursText: { color: t.text.primary, fontSize: 48, fontWeight: '900', marginTop: 4 },
    ...
    serviceIconText: { color: t.accent.green, fontSize: 14, fontWeight: '700' },
    serviceInfo: { flex: 1 },
    serviceTitle: { color: t.text.primary, fontSize: 14, fontWeight: '600' },
    serviceMeta: { color: t.text.muted, fontSize: 12, marginTop: 2 },
    serviceRight: { alignItems: 'flex-end', justifyContent: 'center' },
    serviceCotk: { color: t.accent.green, fontSize: 14, fontWeight: '700' },
    ...
    oppTitle: { color: t.text.primary, fontSize: 15, fontWeight: '700' },
    ...
    oppCotkText: { color: t.accent.green, fontSize: 14, fontWeight: '700' },
    oppSignup: { backgroundColor: t.accent.blue, paddingHorizontal: 16, paddingVertical: 8, borderRadius: 10 },
    oppSignupText: { color: '#fff', fontSize: 13, fontWeight: '600' },
    ...
    leaderHoursText: { color: t.accent.green, fontSize: 16, fontWeight: '800' },
