...
export function TravelScreen({ onClose }: Props) {
  ...
  const s = useMemo(() => StyleSheet.create({
    ...
    stayTitle: { color: t.text.primary, fontSize: fonts.lg, fontWeight: fonts.bold, marginBottom: 4 },
    stayHost: { color: t.accent.blue, fontSize: fonts.sm, fontWeight: fonts.semibold, marginBottom: 2 },
    stayRegion: { color: t.accent.purple, fontSize: fonts.sm, fontWeight: fonts.bold, textTransform: 'uppercase', letterSpacing: 1, marginBottom: 8 },
    stayDesc: { color: t.text.secondary, fontSize: fonts.md, lineHeight: 22, marginBottom: 12 },
    stayMeta: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', marginBottom: 8 },
    stayRate: { color: t.accent.green, fontSize: fonts.md, fontWeight: fonts.bold },
    stayRating: { color: t.accent.orange || '#FF9500', fontSize: fonts.sm, fontWeight: fonts.bold },
    ...
    stayAvail: { fontSize: fonts.sm, fontWeight: fonts.semibold, marginBottom: 8 },
    ...
    expTitle: { color: t.text.primary, fontSize: fonts.lg, fontWeight: fonts.bold, marginBottom: 4 },
    expHost: { color: t.accent.blue, fontSize: fonts.sm, fontWeight: fonts.semibold, marginBottom: 2 },
    expCategory: { color: t.accent.purple, fontSize: fonts.xs, fontWeight: fonts.bold, textTransform: 'uppercase', letterSpacing: 1, marginBottom: 8 },
    expDesc: { color: t.text.secondary, fontSize: fonts.md, lineHeight: 22, marginBottom: 12 },
    expMeta: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', marginBottom: 4 },
    expCost: { color: t.accent.green, fontSize: fonts.md, fontWeight: fonts.bold },
    expDuration: { color: t.text.muted, fontSize: fonts.sm },
    expSpots: { color: t.accent.orange || '#FF9500', fontSize: fonts.sm, fontWeight: fonts.semibold, marginBottom: 8 },
    expDate: { color: t.text.muted, fontSize: fonts.sm, marginBottom: 10 },
    ...
    descInput: { backgroundColor: t.bg.primary, borderRadius: 12, padding: 14, color: t.text.primary, fontSize: fonts.md, minHeight: 120, textAlignVertical: 'top' },
    ...
    guideTitle: { color: t.text.primary, fontSize: fonts.lg, fontWeight: fonts.bold, marginBottom: 4 },
    guideRegion: { color: t.accent.purple, fontSize: fonts.sm, fontWeight: fonts.bold, textTransform: 'uppercase', letterSpacing: 1, marginBottom: 12 },
    guideNotes: { color: t.text.secondary, fontSize: fonts.md, lineHeight: 22, marginBottom: 12 },
    guideSubhead: { color: t.text.primary, fontSize: fonts.md, fontWeight: fonts.bold, marginBottom: 6, marginTop: 8 },
    guidePrinciple: { color: t.text.secondary, fontSize: fonts.sm, lineHeight: 20, marginBottom: 4, paddingLeft: 8 },
    guideDo: { color: t.accent.green, fontSize: fonts.sm, lineHeight: 20, marginBottom: 4, paddingLeft: 8 },
    guideDont: { color: '#FF3B30', fontSize: fonts.sm, lineHeight: 20, marginBottom: 4, paddingLeft: 8 },
    heroCard: { backgroundColor: t.accent.purple + '10', borderRadius: 16, padding: 16, marginHorizontal: 20, marginTop: 8, marginBottom: 8 },
    heroText: { color: t.text.secondary, fontSize: fonts.md, lineHeight: 22 },
    heroTitle: { color: t.text.primary, fontSize: fonts.lg, fontWeight: fonts.bold, marginBottom: 8 },
    emptyText: { color: t.text.muted, fontSize: fonts.md, textAlign: 'center', marginTop: 40, paddingHorizontal: 40 },
    reviewCount: { color: t.text.muted, fontSize: fonts.sm, marginLeft: 4 },
  }), [t]);
    ...
    <>
      ...
      {DEMO_STAYS.map((stay) => (
        <View key={stay.id} style={s.stayCard}>
          ...
          <Text style={{ color: t.text.muted, fontSize: fonts.sm, marginBottom: 10 }}>
