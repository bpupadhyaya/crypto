...
export function TravelScreen({ onClose }: Props) {
  ...
  const s = useMemo(() => StyleSheet.create({
    ...
    stayTitle: { color: t.text.primary, fontSize: 16, fontWeight: fonts.bold, marginBottom: 4 },
    stayHost: { color: t.accent.blue, fontSize: 13, fontWeight: fonts.semibold, marginBottom: 2 },
    stayRegion: { color: t.accent.purple, fontSize: 12, fontWeight: fonts.bold, textTransform: 'uppercase', letterSpacing: 1, marginBottom: 8 },
    ...
    stayRate: { color: t.accent.green, fontSize: 15, fontWeight: fonts.bold },
    stayRating: { color: t.accent.orange || '#FF9500', fontSize: 13, fontWeight: fonts.bold },
    ...
    amenityText: { color: t.text.secondary, fontSize: 11, fontWeight: fonts.semibold },
    stayAvail: { fontSize: 12, fontWeight: fonts.semibold, marginBottom: 8 },
    ...
    bookBtnText: { color: '#fff', fontSize: 14, fontWeight: fonts.bold },
    ...
    expTitle: { color: t.text.primary, fontSize: 16, fontWeight: fonts.bold, marginBottom: 4 },
    expHost: { color: t.accent.blue, fontSize: 13, fontWeight: fonts.semibold, marginBottom: 2 },
    expCategory: { color: t.accent.purple, fontSize: 11, fontWeight: fonts.bold, textTransform: 'uppercase', letterSpacing: 1, marginBottom: 8 },
    ...
    expCost: { color: t.accent.green, fontSize: 15, fontWeight: fonts.bold },
    expDuration: { color: t.text.muted, fontSize: 12 },
    expSpots: { color: t.accent.orange || '#FF9500', fontSize: 12, fontWeight: fonts.semibold, marginBottom: 8 },
    ...
    guideTitle: { color: t.text.primary, fontSize: 16, fontWeight: fonts.bold, marginBottom: 4 },
    guideRegion: { color: t.accent.purple, fontSize: 12, fontWeight: fonts.bold, textTransform: 'uppercase', letterSpacing: 1, marginBottom: 12 },
    guideNotes: { color: t.text.secondary, fontSize: 14, lineHeight: 22, marginBottom: 12 },
    guideSubhead: { color: t.text.primary, fontSize: 14, fontWeight: fonts.bold, marginBottom: 6, marginTop: 8 },
    ...
    heroTitle: { color: t.text.primary, fontSize: 16, fontWeight: fonts.bold, marginBottom: 8 },
