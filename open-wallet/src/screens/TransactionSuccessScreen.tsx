...
export const TransactionSuccessScreen = React.memo(({
  ...
  const s = useMemo(() => StyleSheet.create({
    ...
    title: { color: t.text.primary, fontSize: fonts.xxxl, fontWeight: fonts.heavy, marginBottom: 8 },
    subtitle: { color: t.accent.green, fontSize: fonts.lg, fontWeight: fonts.semibold, marginBottom: 32 },
    ...
    value: { color: t.text.primary, fontSize: fonts.md, fontWeight: fonts.semibold, maxWidth: '60%', textAlign: 'right' },
    hashRow: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', paddingVertical: 10 },
    hashText: { color: t.accent.blue, fontSize: fonts.md, fontWeight: fonts.semibold },
    copyBtn: { paddingVertical: 4, paddingHorizontal: 12, borderRadius: 8, backgroundColor: t.accent.blue + '20' },
    copyBtnText: { color: t.accent.blue, fontSize: fonts.sm, fontWeight: fonts.bold },
    ...
    explorerBtnText: { color: t.accent.blue, fontSize: fonts.lg, fontWeight: fonts.bold },
    shareBtn: {
      width: '100%', paddingVertical: 16, borderRadius: 16,
      backgroundColor: t.accent.purple + '15', alignItems: 'center', marginBottom: 12,
    },
    shareBtnText: { color: t.accent.purple, fontSize: fonts.lg, fontWeight: fonts.bold },
    doneBtn: {
      width: '100%', paddingVertical: 16, borderRadius: 16,
      backgroundColor: t.accent.green, alignItems: 'center', marginBottom: 32,
    },
    doneBtnText: { color: '#000', fontSize: fonts.lg, fontWeight: fonts.heavy },
  }), [t]);
