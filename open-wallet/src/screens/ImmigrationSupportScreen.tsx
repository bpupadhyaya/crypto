...
export function ImmigrationSupportScreen({ onClose }: Props) {
  ...
  const s = useMemo(() => StyleSheet.create({
    ...
    scoreNumber: { color: t.accent.blue, fontSize: 48, fontWeight: '900' },
    ...
    stepCheckText: { color: '#fff', fontSize: 14, fontWeight: '700' },
    stepInfo: { flex: 1 },
    stepTitle: { color: t.text.primary, fontSize: 14, fontWeight: '600' },
    ...
    stepCategory: { color: t.accent.blue, fontSize: 11, fontWeight: '600', textTransform: 'uppercase', marginTop: 4 },
    progressText: { color: t.text.secondary, fontSize: 13, fontWeight: '600', textAlign: 'center', marginBottom: 12 },
    // Buddy cards
    ...
    buddyName: { color: t.text.primary, fontSize: 16, fontWeight: '700' },
    buddyMatch: { color: t.accent.green, fontSize: 13, fontWeight: '700' },
    buddyDetail: { color: t.text.muted, fontSize: 13, marginBottom: 4 },
    buddySpecialty: { color: t.accent.blue, fontSize: 13, fontWeight: '600', marginBottom: 8 },
    ...
    resourceTagText: { fontSize: 11, fontWeight: '700' },
    ...
    eventTitle: { color: t.text.primary, fontSize: 16, fontWeight: '700', marginBottom: 4 },
    ...
    serviceName: { color: t.text.primary, fontSize: 15, fontWeight: '700', marginBottom: 4 },
