...
export function ImmigrationSupportScreen({ onClose }: Props) {
  ...
  const s = useMemo(() => StyleSheet.create({
    ...
    stepCheckText: { color: '#fff', fontSize: 14, fontWeight: fonts.bold },
    stepInfo: { flex: 1 },
    stepTitle: { color: t.text.primary, fontSize: 14, fontWeight: fonts.semibold },
    stepTitleDone: { textDecorationLine: 'line-through', color: t.text.muted },
    stepDesc: { color: t.text.muted, fontSize: 12, marginTop: 4, lineHeight: 18 },
    stepCategory: { color: t.accent.blue, fontSize: 11, fontWeight: fonts.semibold, textTransform: 'uppercase', marginTop: 4 },
    progressText: { color: t.text.secondary, fontSize: 13, fontWeight: fonts.semibold, textAlign: 'center', marginBottom: 12 },
    // Buddy cards
    ...
    buddyName: { color: t.text.primary, fontSize: 16, fontWeight: fonts.bold },
    buddyMatch: { color: t.accent.green, fontSize: 13, fontWeight: fonts.bold },
    buddyDetail: { color: t.text.muted, fontSize: 13, marginBottom: 4 },
    buddySpecialty: { color: t.accent.blue, fontSize: 13, fontWeight: fonts.semibold, marginBottom: 8 },
    ...
    resourceTagText: { fontSize: 11, fontWeight: fonts.bold },
    ...
    eventTitle: { color: t.text.primary, fontSize: 16, fontWeight: fonts.bold, marginBottom: 4 },
    eventDesc: { color: t.text.muted, fontSize: 13, lineHeight: 20, marginBottom: 8 },
    eventMeta: { color: t.text.secondary, fontSize: 12, marginBottom: 4 },
    ...
    serviceName: { color: t.text.primary, fontSize: 15, fontWeight: fonts.bold, marginBottom: 4 },
    serviceDesc: { color: t.text.muted, fontSize: 13, lineHeight: 20, marginBottom: 8 },
    serviceMeta: { color: t.text.secondary, fontSize: 12, marginBottom: 4 },
