...
export const AutomationScreen = React.memo(({ onClose }: Props) => {
  ...
  const s = useMemo(() => StyleSheet.create({
    ...
    cardDesc: { color: t.text.primary, fontSize: 14, fontWeight: '600', lineHeight: 20, marginBottom: 8 },
    ...
    deleteBtnText: { color: t.accent.red, fontSize: 13, fontWeight: '600' },
    sectionLabel: { color: t.text.secondary, fontSize: 12, fontWeight: '700', textTransform: 'uppercase', letterSpacing: 1, marginHorizontal: 16, marginTop: 16, marginBottom: 8 },
