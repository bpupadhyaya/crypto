  ...
  const styles = useMemo(
    () =>
      StyleSheet.create({
        ...
        storyChannel: { fontSize: 11, fontWeight: fonts.semibold, color: t.accent.green, textTransform: 'uppercase', marginBottom: 4 },
        storyTitle: { fontSize: 16, fontWeight: fonts.bold, color: t.text.primary, marginBottom: 4 },
        storyExcerpt: { fontSize: 13, color: t.text.secondary, lineHeight: 18, marginBottom: 8 },
        storyMeta: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center' },
        storyAuthor: { fontSize: 12, color: t.text.secondary },
        storyStats: { flexDirection: 'row', gap: 12 },
        statText: { fontSize: 12, color: t.text.secondary },
        otkBadge: { fontSize: 12, fontWeight: fonts.semibold, color: t.accent.green },
        formContainer: { padding: 16 },
        label: { fontSize: 14, fontWeight: fonts.semibold, color: t.text.primary, marginBottom: 6, marginTop: 16 },
        ...
        submitButtonText: { fontSize: 16, fontWeight: fonts.bold, color: '#FFFFFF' },
        demoNotice: { margin: 16, padding: 12, backgroundColor: t.bg.card, borderRadius: 8, borderWidth: 1, borderColor: t.border },
        demoText: { fontSize: 12, color: t.text.secondary, textAlign: 'center' },
        ...
        quoteText: { fontSize: 16, fontStyle: 'italic', color: t.text.primary, lineHeight: 24, marginBottom: 8 },
        quoteAttribution: { fontSize: 12, color: t.text.secondary, textAlign: 'right' },
        sectionHeader: { fontSize: 14, fontWeight: fonts.semibold, color: t.text.secondary, marginHorizontal: 16, marginTop: 20, marginBottom: 4 },
