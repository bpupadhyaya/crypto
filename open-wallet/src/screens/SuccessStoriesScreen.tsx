  ...
  const styles = useMemo(
    () =>
      StyleSheet.create({
        ...
        storyChannel: { fontSize: 11, fontWeight: '600', color: t.accent.green, textTransform: 'uppercase', marginBottom: 4 },
        storyTitle: { fontSize: 16, fontWeight: '700', color: t.text.primary, marginBottom: 4 },
        ...
        otkBadge: { fontSize: 12, fontWeight: '600', color: t.accent.green },
        ...
        sectionHeader: { fontSize: 14, fontWeight: '600', color: t.text.secondary, marginHorizontal: 16, marginTop: 20, marginBottom: 4 },
