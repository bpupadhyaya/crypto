...
export function AntiCorruptionScreen({ onClose }: Props) {
  ...
  const s = useMemo(() => StyleSheet.create({
    ...
    reportTitle: { color: t.text.primary, fontSize: 15, fontWeight: '700' },
    ...
    spendInst: { color: t.text.primary, fontSize: 14, fontWeight: '600' },
    spendMeta: { color: t.text.muted, fontSize: 12, marginTop: 2 },
    spendAmount: { color: t.text.primary, fontSize: 16, fontWeight: '800', marginTop: 4 },
    ...
    flagText: { color: '#FF3B30', fontSize: 11, fontWeight: '600' },
    ...
    scoreNum: { color: '#fff', fontSize: 18, fontWeight: '900' },
    scoreInfo: { flex: 1 },
    scoreName: { color: t.text.primary, fontSize: 15, fontWeight: '700' },
