...
export function AntiCorruptionScreen({ onClose }: Props) {
  ...
  const s = useMemo(() => StyleSheet.create({
    ...
    reportTitle: { color: t.text.primary, fontSize: fonts.md, fontWeight: fonts.bold },
    reportMeta: { color: t.text.muted, fontSize: fonts.sm, marginTop: 4 },
    reportDesc: { color: t.text.muted, fontSize: fonts.sm, marginTop: 6, lineHeight: 19 },
    badgeRow: { flexDirection: 'row', gap: 8, marginTop: 8 },
    badge: { paddingHorizontal: 8, paddingVertical: 2, borderRadius: 8 },
    badgeText: { color: '#fff', fontSize: fonts.xs, fontWeight: fonts.semibold, textTransform: 'uppercase' },
    upvotes: { color: t.text.muted, fontSize: fonts.sm, marginTop: 6 },
    ...
    spendInst: { color: t.text.primary, fontSize: fonts.md, fontWeight: fonts.semibold },
    spendMeta: { color: t.text.muted, fontSize: fonts.sm, marginTop: 2 },
    spendAmount: { color: t.text.primary, fontSize: fonts.lg, fontWeight: fonts.heavy, marginTop: 4 },
    ...
    flagText: { color: '#FF3B30', fontSize: fonts.xs, fontWeight: fonts.semibold },
    ...
    scoreNum: { color: '#fff', fontSize: fonts.xl, fontWeight: fonts.heavy },
    scoreInfo: { flex: 1 },
    scoreName: { color: t.text.primary, fontSize: fonts.md, fontWeight: fonts.bold },
    scoreMeta: { color: t.text.muted, fontSize: fonts.sm, marginTop: 2 },
