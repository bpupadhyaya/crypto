...
export function ResourceSharingScreen({ onClose }: Props) {
  ...
  const s = useMemo(() => StyleSheet.create({
    ...
    resourceName: { color: t.text.primary, fontSize: 15, fontWeight: '700' },
    ...
    resourceOwner: { color: t.accent.blue, fontSize: 12, fontWeight: '600' },
    resourceDeposit: { color: t.accent.orange, fontSize: 13, fontWeight: '700', marginTop: 6 },
    resourceCondition: { color: t.accent.green, fontSize: 12, fontWeight: '600' },
    ...
    reserveBtnText: { color: '#fff', fontSize: 13, fontWeight: '600' },
    ...
    cancelText: { color: t.accent.blue, fontSize: 13, fontWeight: '600' },
    reservationCard: { backgroundColor: t.bg.secondary, borderRadius: 14, padding: 16, marginHorizontal: 20, marginBottom: 12 },
    resName: { color: t.text.primary, fontSize: 14, fontWeight: '700' },
    resDates: { color: t.text.muted, fontSize: 12, marginTop: 4 },
    resStatus: { fontSize: 12, fontWeight: '700', marginTop: 6 },
    resDeposit: { color: t.accent.orange, fontSize: 12, fontWeight: '600', marginTop: 4 },
    ...
    unavailableText: { color: t.accent.orange, fontSize: 11, fontWeight: '600' },
