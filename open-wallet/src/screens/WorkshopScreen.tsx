...
export function WorkshopScreen({ onClose }: Props) {
  ...
  const s = useMemo(() => StyleSheet.create({
    ...
    toolBadgeText: { fontSize: 11, fontWeight: fonts.bold },
    ...
    borrowIconText: { color: t.accent.orange, fontSize: 16, fontWeight: fonts.bold },
    borrowInfo: { flex: 1 },
    borrowName: { color: t.text.primary, fontSize: 14, fontWeight: fonts.semibold },
    borrowDue: { color: t.text.muted, fontSize: 12, marginTop: 2 },
    borrowStatus: { fontSize: 11, fontWeight: fonts.bold, marginTop: 2 },
    ...
    slotArea: { color: t.text.primary, fontSize: 15, fontWeight: fonts.bold },
    slotDate: { color: t.text.muted, fontSize: 12, marginTop: 4 },
    slotTime: { color: t.accent.blue, fontSize: 13, fontWeight: fonts.semibold, marginTop: 2 },
    ...
    slotBookBtnText: { color: '#fff', fontSize: 13, fontWeight: fonts.semibold },
    skillCard: { backgroundColor: t.bg.secondary, borderRadius: 14, padding: 16, marginHorizontal: 20, marginBottom: 12 },
    skillTitle: { color: t.text.primary, fontSize: 15, fontWeight: fonts.bold },
    skillTeacher: { color: t.accent.blue, fontSize: 13, fontWeight: fonts.semibold, marginTop: 4 },
    ...
    skillReward: { color: t.accent.green, fontSize: 14, fontWeight: fonts.bold },
    skillJoinBtn: { backgroundColor: t.accent.green, paddingHorizontal: 16, paddingVertical: 8, borderRadius: 10 },
    skillJoinText: { color: '#fff', fontSize: 13, fontWeight: fonts.semibold },
    ...
    maintenanceTool: { color: t.text.primary, fontSize: 13, fontWeight: fonts.semibold },
    ...
    maintenanceTypeText: { fontSize: 10, fontWeight: fonts.bold, textTransform: 'uppercase' },
