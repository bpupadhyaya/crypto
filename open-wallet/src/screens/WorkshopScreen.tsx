...
export function WorkshopScreen({ onClose }: Props) {
  ...
  const s = useMemo(() => StyleSheet.create({
    ...
    toolName: { color: t.text.primary, fontSize: fonts.md, fontWeight: fonts.bold, flex: 1 },
    toolBadge: { paddingHorizontal: 10, paddingVertical: 4, borderRadius: 8 },
    toolBadgeText: { fontSize: fonts.xs, fontWeight: fonts.bold },
    toolMeta: { color: t.text.muted, fontSize: fonts.sm, marginTop: 4 },
    ...
    conditionText: { color: t.text.muted, fontSize: fonts.sm },
    ...
    borrowBtnText: { color: '#fff', fontSize: fonts.sm, fontWeight: fonts.semibold },
    ...
    borrowIconText: { color: t.accent.orange, fontSize: fonts.lg, fontWeight: fonts.bold },
    borrowInfo: { flex: 1 },
    borrowName: { color: t.text.primary, fontSize: fonts.md, fontWeight: fonts.semibold },
    borrowDue: { color: t.text.muted, fontSize: fonts.sm, marginTop: 2 },
    borrowStatus: { fontSize: fonts.xs, fontWeight: fonts.bold, marginTop: 2 },
    returnBtn: { backgroundColor: t.accent.green, paddingHorizontal: 14, paddingVertical: 8, borderRadius: 10, alignSelf: 'center' },
    returnBtnText: { color: '#fff', fontSize: fonts.sm, fontWeight: fonts.semibold },
    ...
    slotArea: { color: t.text.primary, fontSize: fonts.md, fontWeight: fonts.bold },
    slotDate: { color: t.text.muted, fontSize: fonts.sm, marginTop: 4 },
    slotTime: { color: t.accent.blue, fontSize: fonts.sm, fontWeight: fonts.semibold, marginTop: 2 },
    slotFooter: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', marginTop: 12 },
    slotCapacity: { color: t.text.muted, fontSize: fonts.sm },
    ...
    slotBookBtnText: { color: '#fff', fontSize: fonts.sm, fontWeight: fonts.semibold },
    ...
    skillTeacher: { color: t.accent.blue, fontSize: fonts.sm, fontWeight: fonts.semibold, marginTop: 4 },
    skillMeta: { color: t.text.muted, fontSize: fonts.sm, marginTop: 4 },
    skillFooter: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', marginTop: 12 },
    skillReward: { color: t.accent.green, fontSize: fonts.md, fontWeight: fonts.bold },
    skillJoinBtn: { backgroundColor: t.accent.green, paddingHorizontal: 16, paddingVertical: 8, borderRadius: 10 },
    skillJoinText: { color: '#fff', fontSize: fonts.sm, fontWeight: fonts.semibold },
    ...
    maintenanceTool: { color: t.text.primary, fontSize: fonts.sm, fontWeight: fonts.semibold },
    maintenanceNotes: { color: t.text.muted, fontSize: fonts.sm, marginTop: 2 },
    maintenanceDate: { color: t.text.muted, fontSize: fonts.xs, marginTop: 2 },
    maintenanceType: { paddingHorizontal: 8, paddingVertical: 3, borderRadius: 6, alignSelf: 'flex-start' },
    maintenanceTypeText: { fontSize: fonts.xs, fontWeight: fonts.bold, textTransform: 'uppercase' },
