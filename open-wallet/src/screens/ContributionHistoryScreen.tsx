...
export function ContributionHistoryScreen({ onClose }: Props) {
  ...
  const s = useMemo(() => StyleSheet.create({
    ...
    totalValue: { color: t.accent.green, fontSize: 36, fontWeight: '900' },
    ...
    contribInfo: { flex: 1 },
    contribDesc: { color: t.text.primary, fontSize: 14, fontWeight: '600' },
    contribMeta: { color: t.text.muted, fontSize: 12, marginTop: 2 },
    contribOtk: { color: t.accent.green, fontSize: 15, fontWeight: '800' },
    ...
    filterText: { color: t.text.muted, fontSize: 12, fontWeight: '600', textTransform: 'capitalize' },
    ...
    channelInfo: { flex: 1 },
    channelName: { color: t.text.primary, fontSize: 15, fontWeight: '700', textTransform: 'capitalize' },
    channelMeta: { color: t.text.muted, fontSize: 12, marginTop: 2 },
    channelOtk: { color: t.accent.green, fontSize: 16, fontWeight: '800' },
