...
export function ContributionHistoryScreen({ onClose }: Props) {
  ...
  const s = useMemo(() => StyleSheet.create({
    ...
    totalValue: { color: t.accent.green, fontSize: fonts.hero, fontWeight: fonts.heavy },
    totalLabel: { color: t.text.muted, fontSize: fonts.sm, textTransform: 'uppercase', letterSpacing: 1, marginTop: 4 },
    ...
    contribInfo: { flex: 1 },
    contribDesc: { color: t.text.primary, fontSize: fonts.md, fontWeight: fonts.semibold },
    contribMeta: { color: t.text.muted, fontSize: fonts.sm, marginTop: 2 },
    contribOtk: { color: t.accent.green, fontSize: fonts.md, fontWeight: fonts.heavy },
    ...
    filterText: { color: t.text.muted, fontSize: fonts.sm, fontWeight: fonts.semibold, textTransform: 'capitalize' },
    ...
    channelInfo: { flex: 1 },
    channelName: { color: t.text.primary, fontSize: fonts.md, fontWeight: fonts.bold, textTransform: 'capitalize' },
    channelMeta: { color: t.text.muted, fontSize: fonts.sm, marginTop: 2 },
    channelOtk: { color: t.accent.green, fontSize: fonts.lg, fontWeight: fonts.heavy },
