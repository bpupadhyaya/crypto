...
export function MeditationScreen({ onClose }: Props) {
  ...
  const s = useMemo(() => StyleSheet.create({
    ...
    wisdomText: { color: t.text.primary, fontSize: 15, fontStyle: 'italic', lineHeight: 22, textAlign: 'center' },
    wisdomSource: { color: t.text.muted, fontSize: 12, textAlign: 'center', marginTop: 8 },
    ...
    wisdomItemText: { color: t.text.primary, fontSize: 14, fontStyle: 'italic', lineHeight: 20, marginBottom: 8 },
    wisdomItemSource: { color: t.text.muted, fontSize: 12 },
    wisdomItemTradition: { color: t.text.secondary, fontSize: 11, marginTop: 2 },
