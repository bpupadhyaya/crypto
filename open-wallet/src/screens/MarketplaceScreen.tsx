...
export function MarketplaceScreen({ onClose }: Props) {
  ...
  const s = useMemo(() => StyleSheet.create({
    ...
    listingTitle: { fontSize: 15, fontWeight: '700', color: t.text.primary, marginBottom: 4 },
    ...
    listingPrice: { fontSize: 14, fontWeight: '700', color: '#34C759' },
    ...
    contactBtnTxt: { fontSize: 13, fontWeight: '600', color: '#FFFFFF' },
    freeTag: { backgroundColor: '#AF52DE', paddingHorizontal: 8, paddingVertical: 3, borderRadius: 10 },
    freeTagTxt: { fontSize: 11, fontWeight: '600', color: '#FFFFFF' },
    ...
    txTitle: { fontSize: 15, fontWeight: '700', color: t.text.primary, marginBottom: 2 },
    ...
    txPrice: { fontSize: 13, fontWeight: '700', color: t.text.primary },
    txRating: { fontSize: 13, fontWeight: '600', letterSpacing: 2 },
    ...
    txRoleTxt: { fontSize: 11, fontWeight: '600', color: t.text.muted },
    ...
    statsHighlight: { fontSize: 14, fontWeight: '700', color: '#AF52DE', textAlign: 'center', marginTop: 8 },
