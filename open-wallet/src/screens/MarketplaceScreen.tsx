...
export function MarketplaceScreen({ onClose }: Props) {
  ...
  const s = useMemo(() => StyleSheet.create({
    ...
    closeTxt: { fontSize: fonts.lg, color: t.accent.blue },
    ...
    tabTxt: { fontSize: fonts.sm, color: t.text.muted },
    tabTxtActive: { fontSize: fonts.sm, color: t.accent.blue, fontWeight: fonts.semibold },
    scroll: { flex: 1 },
    pad: { padding: 16 },
    sectionTitle: { fontSize: fonts.lg, fontWeight: fonts.bold, color: t.text.primary, marginBottom: 12 },
    subTitle: { fontSize: fonts.md, fontWeight: fonts.semibold, color: t.text.primary, marginBottom: 8, marginTop: 12 },
    ...
    filterChipTxt: { fontSize: fonts.sm, color: t.text.muted },
    filterChipTxtActive: { fontSize: fonts.sm, color: '#FFFFFF', fontWeight: fonts.semibold },
    ...
    listingTitle: { fontSize: fonts.md, fontWeight: fonts.bold, color: t.text.primary, marginBottom: 4 },
    listingSeller: { fontSize: fonts.sm, color: t.accent.blue, marginBottom: 6 },
    listingDesc: { fontSize: fonts.sm, color: t.text.secondary, marginBottom: 8, lineHeight: 18 },
    ...
    listingTagTxt: { fontSize: fonts.xs, color: t.text.muted },
    listingFooter: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center' },
    listingPrice: { fontSize: fonts.md, fontWeight: fonts.bold, color: '#34C759' },
    listingViews: { fontSize: fonts.sm, color: t.text.muted },
    contactBtn: { backgroundColor: t.accent.blue, paddingHorizontal: 16, paddingVertical: 8, borderRadius: 8 },
    contactBtnTxt: { fontSize: fonts.sm, fontWeight: fonts.semibold, color: '#FFFFFF' },
    freeTag: { backgroundColor: '#AF52DE', paddingHorizontal: 8, paddingVertical: 3, borderRadius: 10 },
    freeTagTxt: { fontSize: fonts.xs, fontWeight: fonts.semibold, color: '#FFFFFF' },
    ...
    txTitle: { fontSize: fonts.md, fontWeight: fonts.bold, color: t.text.primary, marginBottom: 2 },
    txParty: { fontSize: fonts.sm, color: t.text.secondary, marginBottom: 6 },
    txRow: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', marginBottom: 4 },
    txDate: { fontSize: fonts.sm, color: t.text.muted },
    txPrice: { fontSize: fonts.sm, fontWeight: fonts.bold, color: t.text.primary },
    txRating: { fontSize: fonts.sm, fontWeight: fonts.semibold, letterSpacing: 2 },
    txReview: { fontSize: fonts.sm, color: t.text.secondary, fontStyle: 'italic', marginTop: 6, lineHeight: 18 },
    txRole: { paddingHorizontal: 8, paddingVertical: 2, borderRadius: 8, backgroundColor: t.bg.primary },
    txRoleTxt: { fontSize: fonts.xs, fontWeight: fonts.semibold, color: t.text.muted },

    // Sell form
    label: { fontSize: fonts.sm, fontWeight: fonts.semibold, color: t.text.secondary, marginBottom: 4, marginTop: 12 },
    input: { backgroundColor: t.bg.secondary, borderRadius: 10, paddingHorizontal: 14, paddingVertical: 10, fontSize: fonts.md, color: t.text.primary, borderWidth: StyleSheet.hairlineWidth, borderColor: t.border },
    ...
    pickerChipTxt: { fontSize: fonts.sm, color: t.text.muted },
    pickerChipTxtActive: { fontSize: fonts.sm, color: '#FFFFFF', fontWeight: fonts.semibold },
    postBtn: { backgroundColor: '#34C759', paddingVertical: 14, borderRadius: 12, alignItems: 'center', marginTop: 20 },
    postBtnTxt: { fontSize: fonts.lg, fontWeight: fonts.bold, color: '#FFFFFF' },
    ...
    statsRegion: { fontSize: fonts.lg, fontWeight: fonts.bold, color: t.text.primary, marginBottom: 12, textAlign: 'center' },
    statsRow: { flexDirection: 'row', justifyContent: 'space-between', marginBottom: 8 },
    statsLabel: { fontSize: fonts.sm, color: t.text.secondary },
    statsValue: { fontSize: fonts.sm, fontWeight: fonts.bold, color: t.text.primary },
    ...
    statsHighlight: { fontSize: fonts.md, fontWeight: fonts.bold, color: '#AF52DE', textAlign: 'center', marginTop: 8 },

    empty: { fontSize: fonts.md, color: t.text.muted, textAlign: 'center', marginTop: 40 },
    demoBanner: { backgroundColor: '#FF9500', paddingVertical: 4, alignItems: 'center' },
    demoBannerTxt: { fontSize: fonts.xs, fontWeight: fonts.semibold, color: '#FFFFFF' },
  }), [t]);
