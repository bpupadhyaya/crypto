...
export function NotificationCenterScreen({ onClose }: Props) {
  ...
  const st = useMemo(() => StyleSheet.create({
    ...
    badgeText: { color: '#fff', fontSize: fonts.xs, fontWeight: fonts.bold },
    ...
    filterChipText: { color: t.text.secondary, fontSize: fonts.xs, fontWeight: fonts.semibold },
    ...
    actionBtnText: { color: t.accent.blue, fontSize: fonts.sm, fontWeight: fonts.semibold },
    ...
    cardCategory: { fontSize: fonts.xs, fontWeight: fonts.bold, textTransform: 'uppercase', letterSpacing: 1 },
    cardTime: { color: t.text.muted, fontSize: fonts.xs },
    cardTitle: { color: t.text.primary, fontSize: fonts.md, fontWeight: fonts.bold, marginBottom: 3 },
    cardBody: { color: t.text.secondary, fontSize: fonts.sm, lineHeight: 17, marginBottom: 8 },
    cardActions: { flexDirection: 'row', gap: 10 },
    cardActionBtn: { paddingVertical: 5, paddingHorizontal: 10, borderRadius: 6, backgroundColor: t.accent.blue },
    cardActionText: { color: '#fff', fontSize: fonts.xs, fontWeight: fonts.bold },
    cardDeleteBtn: { paddingVertical: 5, paddingHorizontal: 10, borderRadius: 6, backgroundColor: t.bg.primary },
    cardDeleteText: { color: '#FF3B30', fontSize: fonts.xs, fontWeight: fonts.semibold },
    cardMarkBtn: { paddingVertical: 5, paddingHorizontal: 10, borderRadius: 6, backgroundColor: t.bg.primary },
    cardMarkText: { color: t.accent.blue, fontSize: fonts.xs, fontWeight: fonts.semibold },
    ...
    prefLabel: { color: t.text.primary, fontSize: fonts.md, fontWeight: fonts.semibold },
    prefIcon: { fontSize: fonts.xl, marginRight: 10 },
