...
export function NotificationCenterScreen({ onClose }: Props) {
  ...
  const st = useMemo(() => StyleSheet.create({
    ...
    filterChipText: { color: t.text.secondary, fontSize: 11, fontWeight: fonts.semibold },
    ...
    actionBtnText: { color: t.accent.blue, fontSize: 12, fontWeight: fonts.semibold },
    ...
    cardCategory: { fontSize: 10, fontWeight: fonts.bold, textTransform: 'uppercase', letterSpacing: 1 },
    cardTime: { color: t.text.muted, fontSize: 10 },
    cardTitle: { color: t.text.primary, fontSize: 14, fontWeight: fonts.bold, marginBottom: 3 },
    ...
    cardActionText: { color: '#fff', fontSize: 11, fontWeight: fonts.bold },
    cardDeleteBtn: { paddingVertical: 5, paddingHorizontal: 10, borderRadius: 6, backgroundColor: t.bg.primary },
    cardDeleteText: { color: '#FF3B30', fontSize: 11, fontWeight: fonts.semibold },
    cardMarkBtn: { paddingVertical: 5, paddingHorizontal: 10, borderRadius: 6, backgroundColor: t.bg.primary },
    cardMarkText: { color: t.accent.blue, fontSize: 11, fontWeight: fonts.semibold },
    ...
    prefLabel: { color: t.text.primary, fontSize: 14, fontWeight: fonts.semibold },
