...
export function SupportGroupScreen({ onClose }: Props) {
  ...
  const s = useMemo(() => StyleSheet.create({
    ...
    groupName: { color: t.text.primary, fontSize: 15, fontWeight: '700', flex: 1 },
    groupCat: { paddingHorizontal: 8, paddingVertical: 3, borderRadius: 6 },
    groupCatText: { color: '#fff', fontSize: 10, fontWeight: '700' },
    ...
    groupTag: { color: t.accent.blue, fontSize: 11, fontWeight: '600' },
    ...
    joinedBadge: { color: t.accent.green, fontSize: 13, fontWeight: '700' },
    myGroupCard: { backgroundColor: t.bg.secondary, borderRadius: 14, padding: 16, marginHorizontal: 20, marginBottom: 12 },
    myGroupName: { color: t.text.primary, fontSize: 15, fontWeight: '700' },
    ...
    myGroupStatVal: { color: t.text.primary, fontSize: 18, fontWeight: '800' },
    ...
    toggleLabel: { color: t.text.primary, fontSize: 14, fontWeight: '600' },
  ...
  const renderCreate = () => (
    <View style={s.card}>
      ...
      <View style={s.toggleRow}>
        ...
        >
          <Text style={{ color: newAnonymous ? t.accent.blue : t.text.muted, fontSize: 12, fontWeight: '600' }}>{newAnonymous ? 'Yes' : 'No'}</Text>
        </TouchableOpacity>
      </View>
