...
export function SupportGroupScreen({ onClose }: Props) {
  ...
  const s = useMemo(() => StyleSheet.create({
    ...
    groupName: { color: t.text.primary, fontSize: 15, fontWeight: fonts.bold, flex: 1 },
    groupCat: { paddingHorizontal: 8, paddingVertical: 3, borderRadius: 6 },
    groupCatText: { color: '#fff', fontSize: 10, fontWeight: fonts.bold },
    groupDesc: { color: t.text.muted, fontSize: 13, marginTop: 6, lineHeight: 20 },
    groupMeta: { color: t.text.muted, fontSize: 12, marginTop: 8 },
    groupTags: { flexDirection: 'row', gap: 8, marginTop: 6 },
    groupTag: { color: t.accent.blue, fontSize: 11, fontWeight: fonts.semibold },
    groupFooter: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', marginTop: 10 },
    groupMembers: { color: t.text.muted, fontSize: 12 },
    ...
    joinedBadge: { color: t.accent.green, fontSize: 13, fontWeight: fonts.bold },
    myGroupCard: { backgroundColor: t.bg.secondary, borderRadius: 14, padding: 16, marginHorizontal: 20, marginBottom: 12 },
    myGroupName: { color: t.text.primary, fontSize: 15, fontWeight: fonts.bold },
    myGroupMeta: { color: t.text.muted, fontSize: 12, marginTop: 4 },
    myGroupStats: { flexDirection: 'row', justifyContent: 'space-between', marginTop: 10 },
    myGroupStat: { alignItems: 'center' },
    myGroupStatVal: { color: t.text.primary, fontSize: 18, fontWeight: fonts.heavy },
    myGroupStatLabel: { color: t.text.muted, fontSize: 10, marginTop: 2 },
    ...
    toggleLabel: { color: t.text.primary, fontSize: 14, fontWeight: fonts.semibold },
  ...
  const renderCreate = () => (
    <View style={s.card}>
      ...
      <View style={s.toggleRow}>
        ...
        >
          <Text style={{ color: newAnonymous ? t.accent.blue : t.text.muted, fontSize: 12, fontWeight: fonts.semibold }}>{newAnonymous ? 'Yes' : 'No'}</Text>
        </TouchableOpacity>
      </View>
