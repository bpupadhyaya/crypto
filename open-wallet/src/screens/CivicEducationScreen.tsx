...
export function CivicEducationScreen({ onClose }: Props) {
  ...
  const s = useMemo(() => StyleSheet.create({
    ...
    levelText: { color: '#fff', fontSize: 14, fontWeight: fonts.bold },
    ...
    progressLabel: { color: t.text.muted, fontSize: 11, marginTop: 4, textAlign: 'center' },
    ...
    explainerTitle: { color: t.text.primary, fontSize: 15, fontWeight: fonts.bold, flex: 1 },
    difficultyBadge: { paddingHorizontal: 8, paddingVertical: 3, borderRadius: 8 },
    difficultyText: { fontSize: 10, fontWeight: fonts.bold, textTransform: 'uppercase' },
    explainerSummary: { color: t.text.muted, fontSize: 13, marginTop: 8, lineHeight: 19 },
    explainerFooter: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', marginTop: 12 },
    explainerMeta: { color: t.text.muted, fontSize: 12 },
    explainerReward: { color: t.accent.green, fontSize: 13, fontWeight: fonts.bold },
    ...
    readBtnText: { color: '#fff', fontSize: 12, fontWeight: fonts.semibold },
    ...
    quizTitle: { color: t.text.primary, fontSize: 15, fontWeight: fonts.bold },
    quizMeta: { color: t.text.muted, fontSize: 12, marginTop: 4 },
    quizFooter: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', marginTop: 12 },
    quizScore: { fontSize: 14, fontWeight: fonts.bold },
    quizReward: { color: t.accent.green, fontSize: 13, fontWeight: fonts.bold },
    ...
    quizBtnText: { color: '#fff', fontSize: 12, fontWeight: fonts.semibold },
    ...
    urgentText: { color: '#FF3B30', fontSize: 10, fontWeight: fonts.bold },
    eventType: { paddingHorizontal: 8, paddingVertical: 3, borderRadius: 8, marginTop: 6, alignSelf: 'flex-start' },
    eventTypeText: { fontSize: 10, fontWeight: fonts.bold, textTransform: 'uppercase' },
    eventDesc: { color: t.text.muted, fontSize: 13, marginTop: 8, lineHeight: 19 },
    eventDate: { color: t.accent.blue, fontSize: 13, fontWeight: fonts.semibold, marginTop: 8 },
    ...
    eventBtnText: { color: '#fff', fontSize: 12, fontWeight: fonts.semibold },
    ...
    articleNumText: { color: '#fff', fontSize: 16, fontWeight: fonts.heavy },
    articleTitle: { color: t.text.primary, fontSize: 15, fontWeight: fonts.bold, flex: 1 },
    articleStudied: { color: t.accent.green, fontSize: 11, fontWeight: fonts.bold },
    articleSummary: { color: t.text.muted, fontSize: 13, marginTop: 8, lineHeight: 19 },
    ...
    rightText: { color: t.accent.blue, fontSize: 11, fontWeight: fonts.semibold },
    ...
    summaryValue: { color: t.text.primary, fontSize: 24, fontWeight: fonts.heavy },
    ...
    infoText: { color: t.text.primary, fontSize: 15, fontWeight: fonts.semibold, textAlign: 'center', lineHeight: 22 },
  }), [t]);
