...
export function CivicEducationScreen({ onClose }: Props) {
  ...
  const s = useMemo(() => StyleSheet.create({
    ...
    scoreText: { color: t.text.primary, fontSize: 56, fontWeight: '900' },
    ...
    explainerTitle: { color: t.text.primary, fontSize: 15, fontWeight: '700', flex: 1 },
    ...
    explainerReward: { color: t.accent.green, fontSize: 13, fontWeight: '700' },
    ...
    quizTitle: { color: t.text.primary, fontSize: 15, fontWeight: '700' },
    ...
    quizReward: { color: t.accent.green, fontSize: 13, fontWeight: '700' },
    ...
    quizBtnText: { color: '#fff', fontSize: 12, fontWeight: '600' },
    ...
    urgentText: { color: '#FF3B30', fontSize: 10, fontWeight: '700' },
    ...
    eventDate: { color: t.accent.blue, fontSize: 13, fontWeight: '600', marginTop: 8 },
    ...
    eventBtnText: { color: '#fff', fontSize: 12, fontWeight: '600' },
    ...
    articleNumText: { color: '#fff', fontSize: 16, fontWeight: '800' },
    articleTitle: { color: t.text.primary, fontSize: 15, fontWeight: '700', flex: 1 },
    articleStudied: { color: t.accent.green, fontSize: 11, fontWeight: '700' },
    ...
    rightText: { color: t.accent.blue, fontSize: 11, fontWeight: '600' },
    ...
    infoText: { color: t.text.primary, fontSize: 15, fontWeight: '600', textAlign: 'center', lineHeight: 22 },
  }), [t]);
