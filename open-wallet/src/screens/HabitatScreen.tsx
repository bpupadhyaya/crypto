...
export function HabitatScreen({ onClose }: Props) {
  ...
  const s = useMemo(() => StyleSheet.create({
    ...
    projectName: { color: t.text.primary, fontSize: fonts.md, fontWeight: fonts.bold },
    projectMeta: { color: t.text.muted, fontSize: fonts.sm, marginTop: 4 },
    projectStatus: { fontSize: fonts.sm, fontWeight: fonts.bold, marginTop: 6 },
    ...
    pledgeLand: { color: t.text.primary, fontSize: fonts.md, fontWeight: fonts.semibold },
    pledgeMeta: { color: t.text.muted, fontSize: fonts.sm, marginTop: 4 },
    pledgeCotk: { color: t.accent.green, fontSize: fonts.md, fontWeight: fonts.bold, marginTop: 4 },
    pledgeActivitiesList: { color: t.text.secondary, fontSize: fonts.sm, marginTop: 4, fontStyle: 'italic' },
    ...
    speciesName: { color: t.text.primary, fontSize: fonts.md, fontWeight: fonts.bold },
    speciesScientific: { color: t.text.muted, fontSize: fonts.sm, fontStyle: 'italic', marginTop: 2 },
    speciesMeta: { color: t.text.secondary, fontSize: fonts.sm, marginTop: 6 },
    speciesBenefits: { color: t.accent.green, fontSize: fonts.sm, marginTop: 4 },
    difficultyBadge: { paddingHorizontal: 8, paddingVertical: 2, borderRadius: 8, alignSelf: 'flex-start', marginTop: 6 },
    difficultyText: { fontSize: fonts.xs, fontWeight: fonts.bold },
    metricCard: { backgroundColor: t.bg.secondary, borderRadius: 14, padding: 16, marginHorizontal: 20, marginBottom: 12 },
    metricArea: { color: t.text.primary, fontSize: fonts.md, fontWeight: fonts.bold },
    metricDate: { color: t.text.muted, fontSize: fonts.xs, marginTop: 2 },
    ...
    metricValue: { color: t.text.primary, fontSize: fonts.xxl, fontWeight: fonts.heavy },
    ...
    alertSpeciesName: { color: t.text.primary, fontSize: fonts.md, fontWeight: fonts.bold },
    alertMeta: { color: t.text.muted, fontSize: fonts.sm, marginTop: 4 },
    alertDesc: { color: t.text.secondary, fontSize: fonts.sm, marginTop: 6, lineHeight: 20 },
    alertStatusBadge: { paddingHorizontal: 10, paddingVertical: 4, borderRadius: 8, alignSelf: 'flex-start', marginTop: 8 },
    alertStatusText: { fontSize: fonts.xs, fontWeight: fonts.bold, textTransform: 'uppercase' },
