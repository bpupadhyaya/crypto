...
export function HabitatScreen({ onClose }: Props) {
  ...
  const s = useMemo(() => StyleSheet.create({
    ...
    projectName: { color: t.text.primary, fontSize: 15, fontWeight: '700' },
    projectMeta: { color: t.text.muted, fontSize: 12, marginTop: 4 },
    projectStatus: { fontSize: 12, fontWeight: '700', marginTop: 6 },
    ...
    pledgeLand: { color: t.text.primary, fontSize: 14, fontWeight: '600' },
    pledgeMeta: { color: t.text.muted, fontSize: 12, marginTop: 4 },
    pledgeCotk: { color: t.accent.green, fontSize: 14, fontWeight: '700', marginTop: 4 },
    ...
    speciesName: { color: t.text.primary, fontSize: 14, fontWeight: '700' },
    ...
    metricArea: { color: t.text.primary, fontSize: 15, fontWeight: '700' },
    ...
    metricValue: { color: t.text.primary, fontSize: 22, fontWeight: '800' },
    ...
    alertSpeciesName: { color: t.text.primary, fontSize: 15, fontWeight: '700' },
    ...
    alertStatusText: { fontSize: 11, fontWeight: '700', textTransform: 'uppercase' },
