...
export function TeacherImpactScreen({ onClose }: Props) {
  ...
  const s = useMemo(() => StyleSheet.create({
    ...
    statValue: { color: t.accent.blue, fontSize: 24, fontWeight: fonts.heavy },
    statLabel: { color: t.text.muted, fontSize: 10, fontWeight: fonts.semibold, marginTop: 4, textTransform: 'uppercase', letterSpacing: 1, textAlign: 'center' },
    // Impact message
    ...
    impactText: { color: t.accent.green, fontSize: 15, fontWeight: fonts.bold, textAlign: 'center' },
    ...
    studentIcon: { fontSize: 28 },
    studentInfo: { flex: 1 },
    studentName: { color: t.text.primary, fontSize: 14, fontWeight: fonts.bold },
    studentMeta: { color: t.text.muted, fontSize: 12, marginTop: 2 },
    studentEOTK: { alignItems: 'flex-end' },
    studentEOTKValue: { color: t.accent.green, fontSize: 15, fontWeight: fonts.bold },
    studentEOTKLabel: { color: t.text.muted, fontSize: 10 },
    pendingBadge: { color: t.accent.yellow, fontSize: 11, fontWeight: fonts.semibold },
    // Chart
    ...
    chartLabel: { color: t.text.muted, fontSize: 9, marginTop: 4, textAlign: 'center' },
    chartValue: { color: t.accent.blue, fontSize: 10, fontWeight: fonts.bold, marginBottom: 4 },
    // Gratitude
    gratitudeCard: { backgroundColor: t.bg.card, borderRadius: 16, padding: 16, marginHorizontal: 20, marginBottom: 8 },
    gratitudeFrom: { color: t.text.primary, fontSize: 14, fontWeight: fonts.bold },
    gratitudeMsg: { color: t.text.secondary, fontSize: 13, marginTop: 4, fontStyle: 'italic', lineHeight: 20 },
    gratitudeBottom: { flexDirection: 'row', justifyContent: 'space-between', marginTop: 8 },
    gratitudeDate: { color: t.text.muted, fontSize: 11 },
    gratitudeAmount: { color: t.accent.purple, fontSize: 12, fontWeight: fonts.bold },
