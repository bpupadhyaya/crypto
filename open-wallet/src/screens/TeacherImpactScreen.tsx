...
export function TeacherImpactScreen({ onClose }: Props) {
  ...
  const s = useMemo(() => StyleSheet.create({
    ...
    statValue: { color: t.accent.blue, fontSize: 24, fontWeight: '800' },
    statLabel: { color: t.text.muted, fontSize: 10, fontWeight: '600', marginTop: 4, textTransform: 'uppercase', letterSpacing: 1, textAlign: 'center' },
    // Impact message
    ...
    impactText: { color: t.accent.green, fontSize: 15, fontWeight: '700', textAlign: 'center' },
    ...
    studentEOTKValue: { color: t.accent.green, fontSize: 15, fontWeight: '700' },
    studentEOTKLabel: { color: t.text.muted, fontSize: 10 },
    pendingBadge: { color: t.accent.yellow, fontSize: 11, fontWeight: '600' },
    // Chart
    ...
    chartValue: { color: t.accent.blue, fontSize: 10, fontWeight: '700', marginBottom: 4 },
    // Gratitude
    gratitudeCard: { backgroundColor: t.bg.card, borderRadius: 16, padding: 16, marginHorizontal: 20, marginBottom: 8 },
    gratitudeFrom: { color: t.text.primary, fontSize: 14, fontWeight: '700' },
    ...
    gratitudeAmount: { color: t.accent.purple, fontSize: 12, fontWeight: '700' },
