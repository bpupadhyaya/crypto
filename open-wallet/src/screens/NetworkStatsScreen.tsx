...
export function NetworkStatsScreen({ onClose }: Props) {
  ...
  const s = useMemo(() => StyleSheet.create({
    ...
    peerInfo: { flex: 1 },
    peerAddr: { color: t.text.primary, fontSize: 13, fontWeight: fonts.semibold, fontFamily: 'monospace' },
    peerMeta: { color: t.text.muted, fontSize: 12, marginTop: 2 },
    peerLatency: { fontSize: 14, fontWeight: fonts.bold },
    ...
    blockNum: { color: t.accent.blue, fontSize: 14, fontWeight: fonts.heavy },
    blockInfo: { flex: 1 },
    blockHash: { color: t.text.primary, fontSize: 13, fontWeight: fonts.semibold, fontFamily: 'monospace' },
    blockMeta: { color: t.text.muted, fontSize: 12, marginTop: 2 },
    blockSize: { color: t.text.secondary, fontSize: 13, fontWeight: fonts.semibold },
    ...
    bwValue: { color: t.text.primary, fontSize: 14, fontWeight: fonts.bold },
