...
export function NetworkStatsScreen({ onClose }: Props) {
  ...
  const s = useMemo(() => StyleSheet.create({
    ...
    peerInfo: { flex: 1 },
    peerAddr: { color: t.text.primary, fontSize: fonts.sm, fontWeight: fonts.semibold, fontFamily: 'monospace' },
    peerMeta: { color: t.text.muted, fontSize: fonts.sm, marginTop: 2 },
    peerLatency: { fontSize: fonts.md, fontWeight: fonts.bold },
    ...
    blockNum: { color: t.accent.blue, fontSize: fonts.md, fontWeight: fonts.heavy },
    blockInfo: { flex: 1 },
    blockHash: { color: t.text.primary, fontSize: fonts.sm, fontWeight: fonts.semibold, fontFamily: 'monospace' },
    blockMeta: { color: t.text.muted, fontSize: fonts.sm, marginTop: 2 },
    blockSize: { color: t.text.secondary, fontSize: fonts.sm, fontWeight: fonts.semibold },
    ...
    bwLabel: { color: t.text.secondary, fontSize: fonts.md },
    bwValue: { color: t.text.primary, fontSize: fonts.md, fontWeight: fonts.bold },
