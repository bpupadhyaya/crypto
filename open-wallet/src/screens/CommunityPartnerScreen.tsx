  ...
  const styles = useMemo(
    () =>
      StyleSheet.create({
        ...
        partnerName: { fontSize: fonts.lg, fontWeight: fonts.bold, color: t.text.primary, marginBottom: 2 },
        partnerType: { fontSize: fonts.xs, fontWeight: fonts.semibold, color: t.accent.green, textTransform: 'uppercase', marginBottom: 6 },
        partnerFocus: { fontSize: fonts.sm, color: t.text.secondary, lineHeight: 18, marginBottom: 8 },
        partnerStats: { flexDirection: 'row', justifyContent: 'space-between' },
        partnerStat: { alignItems: 'center' },
        statValue: { fontSize: fonts.md, fontWeight: fonts.bold, color: t.text.primary },
        ...
        programName: { fontSize: fonts.md, fontWeight: fonts.bold, color: t.text.primary, marginBottom: 2 },
        programPartner: { fontSize: fonts.sm, color: t.accent.green, marginBottom: 6 },
        programDesc: { fontSize: fonts.sm, color: t.text.secondary, lineHeight: 18, marginBottom: 8 },
        programFooter: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center' },
        programOtk: { fontSize: fonts.sm, fontWeight: fonts.semibold, color: t.accent.green },
        programParticipants: { fontSize: fonts.sm, color: t.text.secondary },
