  ...
  const styles = useMemo(
    () =>
      StyleSheet.create({
        ...
        partnerName: { fontSize: 16, fontWeight: fonts.bold, color: t.text.primary, marginBottom: 2 },
        partnerType: { fontSize: 11, fontWeight: fonts.semibold, color: t.accent.green, textTransform: 'uppercase', marginBottom: 6 },
        ...
        statValue: { fontSize: 14, fontWeight: fonts.bold, color: t.text.primary },
        ...
        programName: { fontSize: 15, fontWeight: fonts.bold, color: t.text.primary, marginBottom: 2 },
        ...
        programOtk: { fontSize: 12, fontWeight: fonts.semibold, color: t.accent.green },
