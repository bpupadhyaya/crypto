...
export function CommunityVaultScreen({ onClose }: Props) {
  ...
  const s = useMemo(() => StyleSheet.create({
    ...
    vaultTotal: { color: t.accent.green, fontSize: 42, fontWeight: '900', textAlign: 'center' },
    vaultLabel: { color: t.text.muted, fontSize: 12, textAlign: 'center', textTransform: 'uppercase', letterSpacing: 1, marginTop: 4 },
    ...
    memberMeta: { color: t.text.muted, fontSize: 12, marginTop: 2 },
    memberShare: { color: t.accent.blue, fontSize: 14, fontWeight: '700' },
    ...
    txMeta: { color: t.text.muted, fontSize: 12, marginTop: 2 },
    txAmount: { fontSize: 15, fontWeight: '800' },
    txStatus: { fontSize: 11, fontWeight: '600', marginTop: 2, textAlign: 'right' },
    ...
    infoText: { color: t.text.muted, fontSize: 12, textAlign: 'center', marginTop: 8, lineHeight: 18 },
