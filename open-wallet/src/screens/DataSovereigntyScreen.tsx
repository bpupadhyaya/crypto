...
export function DataSovereigntyScreen({ onClose }: Props) {
  ...
  const s = useMemo(() => StyleSheet.create({
    ...
    scoreLabel: { color: t.text.secondary, fontSize: 13, fontWeight: '600' },
    ...
    categoryLabel: { color: t.text.primary, fontSize: 15, fontWeight: '700', flex: 1 },
    ...
    levelBtnText: { fontSize: 11, fontWeight: '700', marginTop: 2 },
    ...
    logEntity: { color: t.text.primary, fontSize: 14, fontWeight: '700', flex: 1 },
    ...
    logAction: { fontSize: 11, fontWeight: '700', paddingHorizontal: 8, paddingVertical: 2, borderRadius: 6, overflow: 'hidden' },
    ...
    revokeBtnText: { color: '#f44336', fontSize: 12, fontWeight: '700' },
    ...
    exportTitle: { color: t.text.primary, fontSize: 15, fontWeight: '700', marginBottom: 4 },
    ...
    deletedBadgeText: { color: '#f44336', fontSize: 15, fontWeight: '700' },
