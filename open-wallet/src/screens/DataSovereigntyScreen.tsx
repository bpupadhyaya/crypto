...
export function DataSovereigntyScreen({ onClose }: Props) {
  ...
  const s = useMemo(() => StyleSheet.create({
    ...
    scoreValue: { color: '#fff', fontSize: 20, fontWeight: fonts.heavy },
    scoreLabel: { color: t.text.secondary, fontSize: 13, fontWeight: fonts.semibold },
    scoreDesc: { color: t.text.muted, fontSize: 12 },
    ...
    tabTextActive: { color: '#fff', fontSize: 13, fontWeight: fonts.semibold },
    ...
    categoryLabel: { color: t.text.primary, fontSize: 15, fontWeight: fonts.bold, flex: 1 },
    categoryDesc: { color: t.text.muted, fontSize: 12, marginBottom: 12 },
    ...
    levelBtnText: { fontSize: 11, fontWeight: fonts.bold, marginTop: 2 },
    ...
    logEntity: { color: t.text.primary, fontSize: 14, fontWeight: fonts.bold, flex: 1 },
    logTime: { color: t.text.muted, fontSize: 11 },
    logDetail: { flexDirection: 'row', alignItems: 'center', marginTop: 8, gap: 8 },
    logCategory: { color: t.text.secondary, fontSize: 12 },
    logAction: { fontSize: 11, fontWeight: fonts.bold, paddingHorizontal: 8, paddingVertical: 2, borderRadius: 6, overflow: 'hidden' },
    ...
    revokeBtnText: { color: '#f44336', fontSize: 12, fontWeight: fonts.bold },
    entityIcon: { fontSize: 18, marginRight: 8 },
    exportCard: { backgroundColor: t.bg.card, borderRadius: 16, padding: 20, marginHorizontal: 20, marginBottom: 12 },
    exportTitle: { color: t.text.primary, fontSize: 15, fontWeight: fonts.bold, marginBottom: 4 },
    exportDesc: { color: t.text.muted, fontSize: 13, lineHeight: 20, marginBottom: 16 },
    exportBtn: { backgroundColor: t.accent.blue, borderRadius: 12, paddingVertical: 14, alignItems: 'center' },
    exportBtnText: { color: '#fff', fontSize: 15, fontWeight: fonts.bold },
    deleteBtn: { backgroundColor: '#f44336', borderRadius: 12, paddingVertical: 14, alignItems: 'center' },
    deleteBtnText: { color: '#fff', fontSize: 15, fontWeight: fonts.bold },
    deletedBadge: { backgroundColor: '#f44336' + '15', borderRadius: 12, paddingVertical: 14, alignItems: 'center' },
    deletedBadgeText: { color: '#f44336', fontSize: 15, fontWeight: fonts.bold },
    constitutionNote: { color: t.text.muted, fontSize: 12, textAlign: 'center', marginHorizontal: 24, marginTop: 16, marginBottom: 24, lineHeight: 18 },
        ...
        return (
          <View key={cat.id} style={s.categoryCard}>
            <View style={s.categoryHeader}>
              ...
              <Text style={{ fontSize: 14 }}>{LEVEL_ICONS[currentLevel]}</Text>
            </View>
