...
export function CurriculumScreen({ onClose }: Props) {
  ...
  const s = useMemo(() => StyleSheet.create({
    ...
    pathwayName: { color: t.text.primary, fontSize: 15, fontWeight: '700', flex: 1 },
    pathwayCategory: { fontSize: 11, fontWeight: '600', marginTop: 2 },
    ...
    nodeReward: { color: t.accent.green, fontSize: 12, fontWeight: '700' },
    ...
    mentorName: { color: t.text.primary, fontSize: 13, fontWeight: '600' },
    ...
    certName: { color: t.accent.purple, fontSize: 12, fontWeight: '700' },
    certSoulbound: { color: t.accent.orange, fontSize: 10, fontWeight: '700', textTransform: 'uppercase', letterSpacing: 1, marginLeft: 8 },
    // Recommended
    recommendCard: { backgroundColor: t.accent.blue + '10', borderRadius: 14, padding: 14, marginTop: 8 },
    recommendLabel: { color: t.accent.blue, fontSize: 11, fontWeight: '700', textTransform: 'uppercase', letterSpacing: 0.5 },
    recommendTitle: { color: t.text.primary, fontSize: 14, fontWeight: '700', marginTop: 4 },
    recommendReward: { color: t.accent.green, fontSize: 12, fontWeight: '600', marginTop: 2 },
    // Study groups
    groupCard: { backgroundColor: t.bg.card, borderRadius: 16, padding: 16, marginBottom: 12 },
    groupName: { color: t.text.primary, fontSize: 15, fontWeight: '700' },
    ...
    groupDetailValue: { color: t.text.primary, fontSize: 14, fontWeight: '700' },
    ...
    joinBtnText: { color: t.bg.primary, fontSize: 13, fontWeight: '700' },
    ...
    progressName: { color: t.text.primary, fontSize: 14, fontWeight: '700' },
    progressStats: { flexDirection: 'row', justifyContent: 'space-between', marginTop: 8 },
    progressStatItem: { alignItems: 'center' },
    progressStatValue: { color: t.text.primary, fontSize: 16, fontWeight: '800' },
