...
export function RecoveryScreen({ onClose }: Props) {
  ...
  const s = useMemo(() => StyleSheet.create({
    ...
    heroTitle: { color: t.text.primary, fontSize: 18, fontWeight: '800', textAlign: 'center', marginTop: 8 },
    heroSubtitle: { color: t.text.muted, fontSize: 13, textAlign: 'center', marginTop: 4, lineHeight: 20 },
    streakNumber: { color: t.accent.green, fontSize: 56, fontWeight: '900' },
    ...
    nextMilestone: { color: t.accent.purple, fontSize: 13, fontWeight: '600', marginTop: 8 },
    ...
    milestoneText: { color: t.text.muted, fontSize: 12, fontWeight: '600' },
    ...
    moodValue: { color: t.text.secondary, fontSize: 18, fontWeight: '700' },
    ...
    cravingsLabel: { color: t.text.secondary, fontSize: 14, fontWeight: '600' },
    cravingsValue: { color: t.text.primary, fontSize: 20, fontWeight: '800' },
    ...
    triggerTextActive: { color: t.accent.orange, fontWeight: '600' },
    ...
    checkInDate: { color: t.text.muted, fontSize: 11, fontWeight: '600', textTransform: 'uppercase', letterSpacing: 1 },
    checkInRow: { flexDirection: 'row', justifyContent: 'space-between', marginTop: 8 },
    checkInMood: { color: t.text.primary, fontSize: 14, fontWeight: '600' },
    checkInCravings: { fontSize: 14, fontWeight: '600' },
    ...
    sponsorName: { color: t.text.primary, fontSize: 15, fontWeight: '700' },
    sponsorMeta: { color: t.accent.green, fontSize: 12, fontWeight: '600', marginTop: 2 },
    ...
    sponsorStatus: { fontSize: 12, fontWeight: '600', marginTop: 4 },
    ...
    meetingName: { color: t.text.primary, fontSize: 15, fontWeight: '700' },
    meetingCategory: { color: t.accent.green, fontSize: 11, fontWeight: '600', textTransform: 'uppercase', letterSpacing: 1, marginTop: 2 },
    meetingDetail: { color: t.text.muted, fontSize: 13, marginTop: 4 },
    meetingFormat: { color: t.accent.blue, fontSize: 12, fontWeight: '600', marginTop: 6 },
    meetingAnon: { color: t.accent.purple, fontSize: 11, fontWeight: '600', marginTop: 2 },
    ...
    resourceBtnText: { color: t.accent.blue, fontSize: 14, fontWeight: '600' },
    ...
    resourceType: { color: t.accent.blue, fontSize: 11, fontWeight: '600', textTransform: 'uppercase', letterSpacing: 1, marginTop: 2 },
    resourceDesc: { color: t.text.muted, fontSize: 13, marginTop: 8, lineHeight: 19 },
    resourcePhone: { color: t.accent.green, fontSize: 16, fontWeight: '800', marginTop: 4 },
    ...
    sliderBtnText: { color: t.text.muted, fontSize: 11, fontWeight: '700' },
