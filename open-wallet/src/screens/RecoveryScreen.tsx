...
export function RecoveryScreen({ onClose }: Props) {
  ...
  const s = useMemo(() => StyleSheet.create({
    ...
    streakLabel: { color: t.text.muted, fontSize: fonts.md, textTransform: 'uppercase', letterSpacing: 1.5, marginTop: 4 },
    streakSince: { color: t.text.secondary, fontSize: fonts.sm, marginTop: 8 },
    nextMilestone: { color: t.accent.purple, fontSize: fonts.sm, fontWeight: fonts.semibold, marginTop: 8 },
    ...
    milestoneText: { color: t.text.muted, fontSize: fonts.sm, fontWeight: fonts.semibold },
    ...
    moodValue: { color: t.text.secondary, fontSize: fonts.xl, fontWeight: fonts.bold },
    moodValueActive: { color: '#fff' },
    moodLabel: { color: t.text.muted, fontSize: fonts.xxs, marginTop: 2 },
    moodLabelActive: { color: '#fff' },
    cravingsRow: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', marginBottom: 8 },
    cravingsLabel: { color: t.text.secondary, fontSize: fonts.md, fontWeight: fonts.semibold },
    cravingsValue: { color: t.text.primary, fontSize: fonts.xl, fontWeight: fonts.heavy },
    ...
    triggerText: { color: t.text.secondary, fontSize: fonts.sm },
    ...
    checkInDate: { color: t.text.muted, fontSize: fonts.xs, fontWeight: fonts.semibold, textTransform: 'uppercase', letterSpacing: 1 },
    checkInRow: { flexDirection: 'row', justifyContent: 'space-between', marginTop: 8 },
    checkInMood: { color: t.text.primary, fontSize: fonts.md, fontWeight: fonts.semibold },
    checkInCravings: { fontSize: fonts.md, fontWeight: fonts.semibold },
    checkInWin: { color: t.accent.green, fontSize: fonts.sm, marginTop: 6, fontStyle: 'italic' },
    checkInTriggers: { color: t.accent.orange, fontSize: fonts.sm, marginTop: 4 },
    sponsorCard: { backgroundColor: t.bg.secondary, borderRadius: 16, padding: 16, marginHorizontal: 20, marginBottom: 12 },
    sponsorName: { color: t.text.primary, fontSize: fonts.md, fontWeight: fonts.bold },
    sponsorMeta: { color: t.accent.green, fontSize: fonts.sm, fontWeight: fonts.semibold, marginTop: 2 },
    sponsorBio: { color: t.text.muted, fontSize: fonts.sm, marginTop: 8, lineHeight: 19 },
    sponsorSpecialties: { color: t.text.secondary, fontSize: fonts.sm, marginTop: 8 },
    sponsorStatus: { fontSize: fonts.sm, fontWeight: fonts.semibold, marginTop: 4 },
    ...
    contactBtnText: { color: '#fff', fontSize: fonts.md, fontWeight: fonts.bold },
    ...
    meetingName: { color: t.text.primary, fontSize: fonts.md, fontWeight: fonts.bold },
    meetingCategory: { color: t.accent.green, fontSize: fonts.xs, fontWeight: fonts.semibold, textTransform: 'uppercase', letterSpacing: 1, marginTop: 2 },
    meetingDetail: { color: t.text.muted, fontSize: fonts.sm, marginTop: 4 },
    meetingFormat: { color: t.accent.blue, fontSize: fonts.sm, fontWeight: fonts.semibold, marginTop: 6 },
    meetingAnon: { color: t.accent.purple, fontSize: fonts.xs, fontWeight: fonts.semibold, marginTop: 2 },
    ...
    resourceBtnText: { color: t.accent.blue, fontSize: fonts.md, fontWeight: fonts.semibold },
    ...
    resourceType: { color: t.accent.blue, fontSize: fonts.xs, fontWeight: fonts.semibold, textTransform: 'uppercase', letterSpacing: 1, marginTop: 2 },
    resourceDesc: { color: t.text.muted, fontSize: fonts.sm, marginTop: 8, lineHeight: 19 },
    resourcePhone: { color: t.accent.green, fontSize: fonts.lg, fontWeight: fonts.heavy, marginTop: 4 },
    resourceMeta: { color: t.text.secondary, fontSize: fonts.sm, marginTop: 6 },
    encryptionNote: { color: t.text.muted, fontSize: fonts.xs, textAlign: 'center', marginHorizontal: 32, marginTop: 8, marginBottom: 16, lineHeight: 16 },
    ...
    sliderBtnText: { color: t.text.muted, fontSize: fonts.xs, fontWeight: fonts.bold },
