...
export function EducationFundScreen({ onClose }: Props) {
  ...
  const s = useMemo(() => StyleSheet.create({
    ...
    overviewTitle: { color: t.text.primary, fontSize: 18, fontWeight: fonts.heavy, textAlign: 'center', marginBottom: 16 },
    statRow: { flexDirection: 'row', flexWrap: 'wrap', justifyContent: 'space-around', gap: 12 },
    statBox: { alignItems: 'center', minWidth: 100 },
    statValue: { fontSize: 22, fontWeight: fonts.heavy },
    statLabel: { color: t.text.muted, fontSize: 11, fontWeight: fonts.semibold, marginTop: 4, textAlign: 'center' },
    ...
    donationDonor: { color: t.text.primary, fontSize: 13, fontWeight: fonts.semibold, flex: 1 },
    donationAmount: { color: t.accent.green, fontSize: 13, fontWeight: fonts.bold },
    donationDate: { color: t.text.muted, fontSize: 11, marginLeft: 8 },
    storyCard: { backgroundColor: t.bg.secondary, borderRadius: 14, padding: 16, marginHorizontal: 20, marginBottom: 12 },
    storyName: { color: t.text.primary, fontSize: 16, fontWeight: fonts.bold },
    storyField: { color: t.accent.purple, fontSize: 13, fontWeight: fonts.semibold, marginTop: 4 },
    storyAmount: { color: t.accent.green, fontSize: 14, fontWeight: fonts.bold, marginTop: 4 },
    storyText: { color: t.text.muted, fontSize: 13, lineHeight: 20, marginTop: 8 },
    storyImpact: { color: t.accent.blue, fontSize: 13, fontWeight: fonts.semibold, marginTop: 8, fontStyle: 'italic' },
    storyStatus: { fontSize: 12, fontWeight: fonts.bold, marginTop: 6 },
    storyDate: { color: t.text.muted, fontSize: 11, marginTop: 4 },
    ...
    donateText: { color: '#fff', fontSize: 15, fontWeight: fonts.bold },
    ...
    quickAmountText: { color: t.text.primary, fontSize: 14, fontWeight: fonts.semibold },
    ...
    impactText: { color: t.accent.blue, fontSize: 13, fontWeight: fonts.semibold, textAlign: 'center' },
  }), [t]);
  ...
  const renderDonate = () => (
    <View style={s.card}>
      ...
      <Text style={{ color: t.text.muted, fontSize: 13, marginBottom: 12 }}>Quick amounts</Text>
