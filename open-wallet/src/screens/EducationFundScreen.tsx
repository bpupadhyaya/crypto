...
export function EducationFundScreen({ onClose }: Props) {
  ...
  const s = useMemo(() => StyleSheet.create({
    ...
    overviewTitle: { color: t.text.primary, fontSize: 18, fontWeight: '800', textAlign: 'center', marginBottom: 16 },
    statRow: { flexDirection: 'row', flexWrap: 'wrap', justifyContent: 'space-around', gap: 12 },
    statBox: { alignItems: 'center', minWidth: 100 },
    statValue: { fontSize: 22, fontWeight: '800' },
    statLabel: { color: t.text.muted, fontSize: 11, fontWeight: '600', marginTop: 4, textAlign: 'center' },
    ...
    donationDonor: { color: t.text.primary, fontSize: 13, fontWeight: '600', flex: 1 },
    donationAmount: { color: t.accent.green, fontSize: 13, fontWeight: '700' },
    ...
    storyName: { color: t.text.primary, fontSize: 16, fontWeight: '700' },
    storyField: { color: t.accent.purple, fontSize: 13, fontWeight: '600', marginTop: 4 },
    storyAmount: { color: t.accent.green, fontSize: 14, fontWeight: '700', marginTop: 4 },
    storyText: { color: t.text.muted, fontSize: 13, lineHeight: 20, marginTop: 8 },
    storyImpact: { color: t.accent.blue, fontSize: 13, fontWeight: '600', marginTop: 8, fontStyle: 'italic' },
    storyStatus: { fontSize: 12, fontWeight: '700', marginTop: 6 },
    ...
    donateText: { color: '#fff', fontSize: 15, fontWeight: '700' },
    ...
    quickAmountText: { color: t.text.primary, fontSize: 14, fontWeight: '600' },
    ...
    impactText: { color: t.accent.blue, fontSize: 13, fontWeight: '600', textAlign: 'center' },
  }), [t]);
