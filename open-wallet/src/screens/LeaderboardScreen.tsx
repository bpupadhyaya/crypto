...
export function LeaderboardScreen({ onClose }: Props) {
  ...
  const s = useMemo(() => StyleSheet.create({
    ...
    tabText: { color: t.text.muted, fontSize: fonts.xs, fontWeight: fonts.bold, textTransform: 'uppercase' },
    ...
    bannerLabel: { color: t.text.muted, fontSize: fonts.sm, textTransform: 'uppercase', letterSpacing: 1 },
    bannerValue: { color: t.accent.green, fontSize: fonts.hero, fontWeight: fonts.heavy, marginTop: 4 },
    bannerSub: { color: t.text.muted, fontSize: fonts.sm, marginTop: 8, textAlign: 'center', lineHeight: 18 },
    ...
    rankBadgeText: { color: '#fff', fontSize: fonts.md, fontWeight: fonts.heavy },
    rowInfo: { flex: 1 },
    rowName: { color: t.text.primary, fontSize: fonts.md, fontWeight: fonts.bold },
    rowCategory: { color: t.text.muted, fontSize: fonts.sm, marginTop: 2 },
    rowScore: { color: t.accent.green, fontSize: fonts.md, fontWeight: fonts.heavy },
    ...
    channelTabText: { color: t.text.muted, fontSize: fonts.sm, fontWeight: fonts.bold },
    ...
    timeTabText: { color: t.text.muted, fontSize: fonts.sm, fontWeight: fonts.semibold },
    ...
    myRankLabel: { color: t.text.muted, fontSize: fonts.sm, textTransform: 'uppercase', letterSpacing: 1, marginTop: 4 },
    percentileRow: { flexDirection: 'row', gap: 32, marginTop: 20 },
    percentileItem: { alignItems: 'center' },
    percentileValue: { color: t.text.primary, fontSize: fonts.xxl, fontWeight: fonts.heavy },
    percentileLabel: { color: t.text.muted, fontSize: fonts.xs, marginTop: 4 },
    ...
    philosophy: { color: t.text.muted, fontSize: fonts.xs, textAlign: 'center', marginHorizontal: 40, marginTop: 20, lineHeight: 16, fontStyle: 'italic' },
  }), [t]);
