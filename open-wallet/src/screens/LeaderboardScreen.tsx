...
export function LeaderboardScreen({ onClose }: Props) {
  ...
  const s = useMemo(() => StyleSheet.create({
    ...
    tabText: { color: t.text.muted, fontSize: 11, fontWeight: '700', textTransform: 'uppercase' },
    ...
    bannerValue: { color: t.accent.green, fontSize: 36, fontWeight: '900', marginTop: 4 },
    ...
    rowInfo: { flex: 1 },
    rowName: { color: t.text.primary, fontSize: 15, fontWeight: '700' },
    rowCategory: { color: t.text.muted, fontSize: 12, marginTop: 2 },
    rowScore: { color: t.accent.green, fontSize: 15, fontWeight: '800' },
    ...
    channelTabText: { color: t.text.muted, fontSize: 12, fontWeight: '700' },
    ...
    timeTabText: { color: t.text.muted, fontSize: 12, fontWeight: '600' },
    ...
    myRankNumber: { color: t.accent.blue, fontSize: 56, fontWeight: '900' },
    ...
    percentileValue: { color: t.text.primary, fontSize: 22, fontWeight: '800' },
