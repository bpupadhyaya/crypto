...
export function SocialRecoveryScreen({ onClose }: Props) {
  ...
  const styles = useMemo(() => StyleSheet.create({
    ...
    label: { fontSize: fonts.sm, color: t.text.secondary, marginBottom: 4 },
    ...
    metricValue: { fontSize: fonts.xxl, fontWeight: fonts.bold, color: t.text.primary },
    ...
    warningText: { fontSize: fonts.sm, color: '#92400e', lineHeight: 18 },
  }), [t]);
