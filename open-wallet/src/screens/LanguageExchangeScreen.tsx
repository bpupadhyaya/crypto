...
export function LanguageExchangeScreen({ onClose }: Props) {
  ...
  const s = useMemo(() => StyleSheet.create({
    ...
    profileLabel: { color: t.text.muted, fontSize: 12, fontWeight: '600', marginBottom: 4 },
    profileValue: { color: t.text.primary, fontSize: 14, fontWeight: '600' },
    langTag: { backgroundColor: t.accent.blue + '20', paddingVertical: 4, paddingHorizontal: 10, borderRadius: 8, marginRight: 6, marginTop: 4 },
    langTagText: { color: t.accent.blue, fontSize: 12, fontWeight: '600' },
    ...
    learningTagText: { color: t.accent.green, fontSize: 12, fontWeight: '600' },
    ...
    sessionPartner: { color: t.text.primary, fontSize: 15, fontWeight: '700' },
    ...
    sessionVocab: { color: t.accent.green, fontSize: 12, fontWeight: '600', marginTop: 6 },
    ...
    phraseLabel: { color: t.accent.blue, fontSize: 11, fontWeight: '700', textTransform: 'uppercase', letterSpacing: 1 },
    phraseMain: { color: t.text.primary, fontSize: 28, fontWeight: '800', marginTop: 12, textAlign: 'center' },
    phraseTranslation: { color: t.text.secondary, fontSize: 14, marginTop: 8, textAlign: 'center', lineHeight: 20 },
    phrasePronunciation: { color: t.accent.blue, fontSize: 16, fontWeight: '600', marginTop: 12, textAlign: 'center' },
    ...
    culturalCategory: { color: t.accent.blue, fontSize: 11, fontWeight: '700', textTransform: 'uppercase', letterSpacing: 1 },
    culturalTitle: { color: t.text.primary, fontSize: 15, fontWeight: '700', marginTop: 4 },
    ...
    eventType: { color: t.accent.blue, fontSize: 11, fontWeight: '600', textTransform: 'uppercase', letterSpacing: 0.5, marginTop: 2 },
