...
export function LanguageExchangeScreen({ onClose }: Props) {
  ...
  const s = useMemo(() => StyleSheet.create({
    ...
    profileLabel: { color: t.text.muted, fontSize: fonts.sm, fontWeight: fonts.semibold, marginBottom: 4 },
    ...
    langTagText: { color: t.accent.blue, fontSize: fonts.sm, fontWeight: fonts.semibold },
    ...
    learningTagText: { color: t.accent.green, fontSize: fonts.sm, fontWeight: fonts.semibold },
    ...
    fluencyText: { color: t.text.secondary, fontSize: fonts.sm, marginTop: 4 },
    // Partners
    ...
    partnerLocation: { color: t.text.muted, fontSize: fonts.sm, marginTop: 2 },
    partnerBio: { color: t.text.secondary, fontSize: fonts.sm, marginTop: 8, lineHeight: 18 },
    ...
    partnerStat: { color: t.text.secondary, fontSize: fonts.sm },
    ...
    sessionPartner: { color: t.text.primary, fontSize: fonts.md, fontWeight: fonts.bold },
    sessionLang: { color: t.text.secondary, fontSize: fonts.sm, marginTop: 2 },
    sessionDateTime: { color: t.text.muted, fontSize: fonts.sm, marginTop: 4 },
    sessionNotes: { color: t.text.secondary, fontSize: fonts.sm, marginTop: 8, lineHeight: 18, fontStyle: 'italic' },
    sessionVocab: { color: t.accent.green, fontSize: fonts.sm, fontWeight: fonts.semibold, marginTop: 6 },
    ...
    phraseLabel: { color: t.accent.blue, fontSize: fonts.xs, fontWeight: fonts.bold, textTransform: 'uppercase', letterSpacing: 1 },
    phraseMain: { color: t.text.primary, fontSize: fonts.xxxl, fontWeight: fonts.heavy, marginTop: 12, textAlign: 'center' },
    phraseTranslation: { color: t.text.secondary, fontSize: fonts.md, marginTop: 8, textAlign: 'center', lineHeight: 20 },
    phrasePronunciation: { color: t.accent.blue, fontSize: fonts.lg, fontWeight: fonts.semibold, marginTop: 12, textAlign: 'center' },
    phraseCulturalNote: { color: t.text.muted, fontSize: fonts.sm, marginTop: 16, lineHeight: 18, fontStyle: 'italic', textAlign: 'center' },
    // Cultural notes
    culturalCard: { backgroundColor: t.bg.card, borderRadius: 16, padding: 16, marginBottom: 12 },
    culturalCategory: { color: t.accent.blue, fontSize: fonts.xs, fontWeight: fonts.bold, textTransform: 'uppercase', letterSpacing: 1 },
    culturalTitle: { color: t.text.primary, fontSize: fonts.md, fontWeight: fonts.bold, marginTop: 4 },
    culturalContent: { color: t.text.secondary, fontSize: fonts.sm, marginTop: 8, lineHeight: 20 },
    // Events
    ...
    eventIcon: { fontSize: fonts.xxxl },
    eventTitle: { color: t.text.primary, fontSize: fonts.md, fontWeight: fonts.bold, flex: 1 },
    eventType: { color: t.accent.blue, fontSize: fonts.xs, fontWeight: fonts.semibold, textTransform: 'uppercase', letterSpacing: 0.5, marginTop: 2 },
    eventDesc: { color: t.text.secondary, fontSize: fonts.sm, marginTop: 10, lineHeight: 18 },
    eventMeta: { flexDirection: 'row', justifyContent: 'space-between', marginTop: 10, alignItems: 'center' },
    eventDate: { color: t.text.muted, fontSize: fonts.sm },
    eventAttendees: { color: t.text.secondary, fontSize: fonts.sm },
    registerBtn: { borderRadius: 10, paddingVertical: 8, paddingHorizontal: 16, alignSelf: 'flex-end', marginTop: 8 },
    registerBtnText: { fontSize: fonts.sm, fontWeight: fonts.bold },
