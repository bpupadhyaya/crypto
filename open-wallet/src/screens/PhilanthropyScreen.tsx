...
export function PhilanthropyScreen({ onClose }: Props) {
  ...
  const s = useMemo(() => StyleSheet.create({
    ...
    dashboardValue: { color: t.text.primary, fontSize: 48, fontWeight: '900', marginTop: 4 },
    dashboardLabel: { color: t.text.muted, fontSize: 13, textTransform: 'uppercase', letterSpacing: 1 },
    dashboardSub: { color: t.accent.green, fontSize: 15, fontWeight: '700', marginTop: 4 },
    ...
    fundraiserTitle: { color: t.text.primary, fontSize: 15, fontWeight: '700', marginBottom: 4 },
    fundraiserOrganizer: { color: t.text.secondary, fontSize: 12, marginBottom: 8 },
    fundraiserStory: { color: t.text.muted, fontSize: 13, lineHeight: 20, marginBottom: 12 },
    ...
    fundraiserStatText: { color: t.text.muted, fontSize: 12 },
    fundraiserStatValue: { color: t.text.primary, fontSize: 12, fontWeight: '700' },
    donateRow: { flexDirection: 'row', gap: 8, alignItems: 'center' },
    donateInput: { flex: 1, backgroundColor: t.bg.primary, borderRadius: 12, padding: 12, color: t.text.primary, fontSize: 14 },
    ...
    causeTagText: { fontSize: 11, fontWeight: '700', textTransform: 'uppercase' },
    ...
    completedText: { color: t.accent.green, fontSize: 11, fontWeight: '700' },
    impactCard: { backgroundColor: t.bg.secondary, borderRadius: 16, padding: 16, marginHorizontal: 20, marginBottom: 12 },
    impactTitle: { color: t.text.primary, fontSize: 15, fontWeight: '700', marginBottom: 4 },
    impactDesc: { color: t.text.muted, fontSize: 13, lineHeight: 20, marginBottom: 8 },
    impactMeta: { flexDirection: 'row', gap: 16 },
    impactMetaText: { color: t.text.secondary, fontSize: 12 },
    circleCard: { backgroundColor: t.bg.secondary, borderRadius: 16, padding: 16, marginHorizontal: 20, marginBottom: 12 },
    circleName: { color: t.text.primary, fontSize: 15, fontWeight: '700', marginBottom: 4 },
    circleFocus: { color: t.text.secondary, fontSize: 13, marginBottom: 8 },
    circleStats: { flexDirection: 'row', justifyContent: 'space-between' },
    circleStatText: { color: t.text.muted, fontSize: 12 },
    ...
    receiptInfo: { flex: 1 },
    receiptRecipient: { color: t.text.primary, fontSize: 14, fontWeight: '600' },
    receiptMeta: { color: t.text.muted, fontSize: 12, marginTop: 2 },
    receiptAmount: { color: t.accent.green, fontSize: 14, fontWeight: '700' },
    input: { backgroundColor: t.bg.primary, borderRadius: 12, padding: 14, color: t.text.primary, fontSize: 15, marginBottom: 12 },
    textArea: { backgroundColor: t.bg.primary, borderRadius: 12, padding: 14, color: t.text.primary, fontSize: 15, marginBottom: 12, minHeight: 100, textAlignVertical: 'top' },
