...
export function PhilanthropyScreen({ onClose }: Props) {
  ...
  const s = useMemo(() => StyleSheet.create({
    ...
    dashboardSub: { color: t.accent.green, fontSize: 15, fontWeight: fonts.bold, marginTop: 4 },
    ...
    fundraiserTitle: { color: t.text.primary, fontSize: 15, fontWeight: fonts.bold, marginBottom: 4 },
    ...
    fundraiserStatValue: { color: t.text.primary, fontSize: 12, fontWeight: fonts.bold },
    ...
    donateBtnText: { color: '#fff', fontSize: 14, fontWeight: fonts.bold },
    causeTag: { alignSelf: 'flex-start', paddingHorizontal: 10, paddingVertical: 4, borderRadius: 10, marginBottom: 8 },
    causeTagText: { fontSize: 11, fontWeight: fonts.bold, textTransform: 'uppercase' },
    ...
    impactTitle: { color: t.text.primary, fontSize: 15, fontWeight: fonts.bold, marginBottom: 4 },
    ...
    circleName: { color: t.text.primary, fontSize: 15, fontWeight: fonts.bold, marginBottom: 4 },
    ...
    receiptInfo: { flex: 1 },
    receiptRecipient: { color: t.text.primary, fontSize: 14, fontWeight: fonts.semibold },
    receiptMeta: { color: t.text.muted, fontSize: 12, marginTop: 2 },
    receiptAmount: { color: t.accent.green, fontSize: 14, fontWeight: fonts.bold },
