...
export function DigitalArchiveScreen({ onClose }: Props) {
  ...
  const s = useMemo(() => StyleSheet.create({
    ...
    timelineYear: { color: t.accent.purple, fontSize: 14, fontWeight: '800' },
    ...
    photoTitle: { color: t.text.primary, fontSize: 15, fontWeight: '700' },
    photoDate: { color: t.accent.purple, fontSize: 12, fontWeight: '600', marginTop: 4 },
    ...
    personText: { color: t.accent.purple, fontSize: 11, fontWeight: '600' },
    hashRow: { flexDirection: 'row', alignItems: 'center', marginTop: 10 },
    hashLabel: { color: t.text.secondary, fontSize: 11, fontWeight: '600' },
    ...
    docTypeText: { color: t.accent.blue, fontSize: 11, fontWeight: '700' },
    docTitle: { color: t.text.primary, fontSize: 15, fontWeight: '700', marginTop: 8 },
    ...
    oralTitle: { color: t.text.primary, fontSize: 15, fontWeight: '700' },
    oralNarrator: { color: t.accent.purple, fontSize: 13, fontWeight: '600', marginTop: 4 },
    ...
    topicText: { color: t.text.secondary, fontSize: 11, fontWeight: '600' },
    formatBadge: { paddingHorizontal: 10, paddingVertical: 4, borderRadius: 8, alignSelf: 'flex-start', marginTop: 8 },
    formatText: { fontSize: 11, fontWeight: '700', color: '#fff' },
    ...
    infoTitle: { color: t.accent.green, fontSize: 14, fontWeight: '700' },
