...
export function DigitalArchiveScreen({ onClose }: Props) {
  ...
  const s = useMemo(() => StyleSheet.create({
    ...
    timelineYear: { color: t.accent.purple, fontSize: fonts.md, fontWeight: fonts.heavy },
    timelineMonth: { color: t.text.muted, fontSize: fonts.sm },
    timelineTitle: { color: t.text.primary, fontSize: fonts.md, fontWeight: fonts.bold, marginTop: 4 },
    timelineDesc: { color: t.text.muted, fontSize: fonts.sm, marginTop: 6, lineHeight: 20 },
    categoryBadge: { paddingHorizontal: 10, paddingVertical: 4, borderRadius: 8, alignSelf: 'flex-start', marginTop: 8 },
    categoryBadgeText: { fontSize: fonts.xs, fontWeight: fonts.bold, color: '#fff' },
    ...
    photoTitle: { color: t.text.primary, fontSize: fonts.md, fontWeight: fonts.bold },
    photoDate: { color: t.accent.purple, fontSize: fonts.sm, fontWeight: fonts.semibold, marginTop: 4 },
    photoLocation: { color: t.text.secondary, fontSize: fonts.sm, marginTop: 2 },
    photoDesc: { color: t.text.muted, fontSize: fonts.sm, marginTop: 8, lineHeight: 20 },
    ...
    personText: { color: t.accent.purple, fontSize: fonts.xs, fontWeight: fonts.semibold },
    hashRow: { flexDirection: 'row', alignItems: 'center', marginTop: 10 },
    hashLabel: { color: t.text.secondary, fontSize: fonts.xs, fontWeight: fonts.semibold },
    hashValue: { color: t.accent.green, fontSize: fonts.xs, fontFamily: 'monospace', marginLeft: 6 },
    ...
    docTypeText: { color: t.accent.blue, fontSize: fonts.xs, fontWeight: fonts.bold },
    docTitle: { color: t.text.primary, fontSize: fonts.md, fontWeight: fonts.bold, marginTop: 8 },
    docDate: { color: t.text.secondary, fontSize: fonts.sm, marginTop: 4 },
    docDesc: { color: t.text.muted, fontSize: fonts.sm, marginTop: 8, lineHeight: 20 },
    preservedDate: { color: t.accent.green, fontSize: fonts.xs, marginTop: 8 },
    ...
    oralTitle: { color: t.text.primary, fontSize: fonts.md, fontWeight: fonts.bold },
    oralNarrator: { color: t.accent.purple, fontSize: fonts.sm, fontWeight: fonts.semibold, marginTop: 4 },
    oralMeta: { color: t.text.muted, fontSize: fonts.sm, marginTop: 4 },
    ...
    topicText: { color: t.text.secondary, fontSize: fonts.xs, fontWeight: fonts.semibold },
    formatBadge: { paddingHorizontal: 10, paddingVertical: 4, borderRadius: 8, alignSelf: 'flex-start', marginTop: 8 },
    formatText: { fontSize: fonts.xs, fontWeight: fonts.bold, color: '#fff' },
    ...
    typeIcon: { fontSize: fonts.xl, marginBottom: 2 },
    ...
    input: { backgroundColor: t.bg.primary, borderRadius: 12, padding: 14, color: t.text.primary, fontSize: fonts.md, marginBottom: 16 },
    textArea: { backgroundColor: t.bg.primary, borderRadius: 12, padding: 14, color: t.text.primary, fontSize: fonts.md, minHeight: 100, textAlignVertical: 'top', marginBottom: 16 },
    ...
    infoTitle: { color: t.accent.green, fontSize: fonts.md, fontWeight: fonts.bold },
    infoDesc: { color: t.text.muted, fontSize: fonts.sm, marginTop: 6, lineHeight: 20 },
    ...
    statLabel: { color: t.text.muted, fontSize: fonts.xs, marginTop: 4 },
