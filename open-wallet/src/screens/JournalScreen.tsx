...
export function JournalScreen({ onClose }: Props) {
  ...
  const s = useMemo(() => StyleSheet.create({
    ...
    moodScore: { fontSize: 16, fontWeight: '700' },
    ...
    entryDate: { color: t.text.muted, fontSize: 12, fontWeight: '600' },
    entryMoodBadge: { paddingHorizontal: 10, paddingVertical: 3, borderRadius: 10 },
    entryMoodText: { color: '#fff', fontSize: 11, fontWeight: '700' },
    ...
    promptCategory: { color: t.accent.purple, fontSize: 12, fontWeight: '700', textTransform: 'uppercase', letterSpacing: 1 },
    ...
    promptUseBtnText: { color: t.accent.purple, fontSize: 13, fontWeight: '700' },
    ...
    privacyText: { color: t.text.primary, fontSize: 15, fontWeight: '600', textAlign: 'center', lineHeight: 22 },
