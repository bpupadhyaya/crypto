...
export function JournalScreen({ onClose }: Props) {
  ...
  const s = useMemo(() => StyleSheet.create({
    ...
    inputLabel: { color: t.text.muted, fontSize: 13, fontWeight: fonts.semibold, marginBottom: 6 },
    journalInput: { backgroundColor: t.bg.primary, borderRadius: 12, padding: 14, color: t.text.primary, fontSize: 15, marginBottom: 12, minHeight: 120, textAlignVertical: 'top' },
    ...
    moodScore: { fontSize: 16, fontWeight: fonts.bold },
    moodLabel: { fontSize: 9, marginTop: 2 },
    ...
    tagText: { fontSize: 13, fontWeight: fonts.semibold },
    ...
    entryDate: { color: t.text.muted, fontSize: 12, fontWeight: fonts.semibold },
    entryMoodBadge: { paddingHorizontal: 10, paddingVertical: 3, borderRadius: 10 },
    entryMoodText: { color: '#fff', fontSize: 11, fontWeight: fonts.bold },
    entryText: { color: t.text.primary, fontSize: 14, lineHeight: 21 },
    entryTagRow: { flexDirection: 'row', gap: 6, marginTop: 10 },
    entryTag: { paddingHorizontal: 8, paddingVertical: 3, borderRadius: 8 },
    entryTagText: { fontSize: 11, fontWeight: fonts.semibold },
    entryFooter: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', marginTop: 10 },
    entryWordCount: { color: t.text.muted, fontSize: 11 },
    ...
    promptCategory: { color: t.accent.purple, fontSize: 12, fontWeight: fonts.bold, textTransform: 'uppercase', letterSpacing: 1 },
    promptText: { color: t.text.primary, fontSize: 15, lineHeight: 22, marginTop: 8, fontStyle: 'italic' },
    promptUseBtn: { marginTop: 12, paddingVertical: 10, borderRadius: 12, backgroundColor: t.accent.purple + '15', alignItems: 'center' },
    promptUseBtnText: { color: t.accent.purple, fontSize: 13, fontWeight: fonts.bold },
    searchInput: { backgroundColor: t.bg.secondary, borderRadius: 12, padding: 14, color: t.text.primary, fontSize: 15, marginHorizontal: 20, marginBottom: 12 },
    ...
    filterChipText: { fontSize: 12, fontWeight: fonts.semibold },
    ...
    trendValue: { fontSize: 20, fontWeight: fonts.heavy },
    trendLabel: { color: t.text.muted, fontSize: 11, marginTop: 2 },
    ...
    privacyText: { color: t.text.primary, fontSize: 15, fontWeight: fonts.semibold, textAlign: 'center', lineHeight: 22 },
    lockIcon: { color: t.accent.purple, fontSize: 24, marginBottom: 8 },
