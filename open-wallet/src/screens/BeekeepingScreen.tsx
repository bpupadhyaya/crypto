...
export function BeekeepingScreen({ onClose }: Props) {
  ...
  const s = useMemo(() => StyleSheet.create({
    ...
    hiveName: { color: t.text.primary, fontSize: fonts.lg, fontWeight: fonts.bold },
    hiveLocation: { color: t.text.muted, fontSize: fonts.sm, marginTop: 2 },
    healthBadge: { paddingHorizontal: 10, paddingVertical: 4, borderRadius: 10, alignSelf: 'flex-start', marginTop: 8 },
    healthText: { color: '#fff', fontSize: fonts.xs, fontWeight: fonts.bold, textTransform: 'uppercase' },
    ...
    inspDate: { color: t.text.muted, fontSize: fonts.sm, marginBottom: 6 },
    inspRow: { flexDirection: 'row', justifyContent: 'space-between', paddingVertical: 4 },
    inspLabel: { color: t.text.secondary, fontSize: fonts.sm },
    inspValue: { color: t.text.primary, fontSize: fonts.sm, fontWeight: fonts.semibold },
    inspNotes: { color: t.text.secondary, fontSize: fonts.sm, fontStyle: 'italic', marginTop: 8, lineHeight: 18 },
    warningBadge: { backgroundColor: '#FF3B30' + '20', paddingHorizontal: 8, paddingVertical: 2, borderRadius: 6 },
    warningText: { color: '#FF3B30', fontSize: fonts.xs, fontWeight: fonts.semibold },
    ...
    swarmBtnText: { color: '#fff', fontSize: fonts.lg, fontWeight: fonts.bold },
    ...
    harvestUnit: { color: t.text.muted, fontSize: fonts.md, textAlign: 'center', marginTop: 2 },
    ...
    plantIconText: { color: t.accent.green, fontSize: fonts.lg, fontWeight: fonts.heavy },
    plantInfo: { flex: 1 },
    plantName: { color: t.text.primary, fontSize: fonts.md, fontWeight: fonts.bold },
    plantMeta: { color: t.text.muted, fontSize: fonts.sm, marginTop: 2 },
    valueBadge: { paddingHorizontal: 8, paddingVertical: 3, borderRadius: 8, alignSelf: 'flex-start', marginTop: 4 },
    valueBadgeText: { fontSize: fonts.xs, fontWeight: fonts.bold, textTransform: 'uppercase' },
