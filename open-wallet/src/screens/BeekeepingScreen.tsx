...
export function BeekeepingScreen({ onClose }: Props) {
  ...
  const s = useMemo(() => StyleSheet.create({
    ...
    hiveName: { color: t.text.primary, fontSize: 16, fontWeight: '700' },
    ...
    healthText: { color: '#fff', fontSize: 11, fontWeight: '700', textTransform: 'uppercase' },
    ...
    inspValue: { color: t.text.primary, fontSize: 13, fontWeight: '600' },
    ...
    warningText: { color: '#FF3B30', fontSize: 11, fontWeight: '600' },
    ...
    toggleText: { color: t.text.secondary, fontSize: 13, fontWeight: '600' },
    ...
    swarmBtnText: { color: '#fff', fontSize: 16, fontWeight: '700' },
    harvestCard: { backgroundColor: t.accent.orange + '08', borderRadius: 16, padding: 20, marginHorizontal: 20, marginBottom: 16 },
    harvestBig: { color: t.text.primary, fontSize: 42, fontWeight: '900', textAlign: 'center' },
    ...
    plantIconText: { color: t.accent.green, fontSize: 16, fontWeight: '800' },
    plantInfo: { flex: 1 },
    ...
    valueBadgeText: { fontSize: 10, fontWeight: '700', textTransform: 'uppercase' },
