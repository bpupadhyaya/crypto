...
export function RelationshipScreen({ onClose }: Props) {
  ...
  const s = useMemo(() => StyleSheet.create({
    ...
    dimensionIconText: { color: t.accent.purple, fontSize: 14, fontWeight: fonts.bold },
    dimensionInfo: { flex: 1 },
    dimensionLabel: { color: t.text.primary, fontSize: 14, fontWeight: fonts.semibold },
    ...
    scoreBtnText: { color: t.text.muted, fontSize: 12, fontWeight: fonts.bold },
    scoreBtnTextActive: { color: '#fff' },
    goalRow: { borderBottomColor: t.bg.primary, borderBottomWidth: 1, paddingVertical: 14 },
    goalHeader: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center' },
    goalTitle: { color: t.text.primary, fontSize: 14, fontWeight: fonts.semibold, flex: 1 },
    goalProgress: { color: t.accent.purple, fontSize: 14, fontWeight: fonts.bold },
    ...
    goalCategoryText: { color: t.accent.purple, fontSize: 11, fontWeight: fonts.semibold },
    ...
    dateTypeText: { fontSize: 11, fontWeight: fonts.bold, textTransform: 'uppercase' },
    dateTitle: { color: t.text.primary, fontSize: 15, fontWeight: fonts.bold, marginBottom: 4 },
    ...
    exerciseTypeText: { color: t.accent.blue, fontSize: 11, fontWeight: fonts.bold, textTransform: 'uppercase' },
    exerciseTitle: { color: t.text.primary, fontSize: 15, fontWeight: fonts.bold, marginBottom: 6 },
    ...
    resourceTypeText: { fontSize: 11, fontWeight: fonts.bold, textTransform: 'uppercase' },
    resourceTitle: { color: t.text.primary, fontSize: 15, fontWeight: fonts.bold, marginBottom: 2 },
