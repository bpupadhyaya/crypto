...
export function RelationshipScreen({ onClose }: Props) {
  ...
  const s = useMemo(() => StyleSheet.create({
    ...
    dimensionIconText: { color: t.accent.purple, fontSize: fonts.md, fontWeight: fonts.bold },
    dimensionInfo: { flex: 1 },
    dimensionLabel: { color: t.text.primary, fontSize: fonts.md, fontWeight: fonts.semibold },
    dimensionDesc: { color: t.text.muted, fontSize: fonts.sm, marginTop: 2 },
    ...
    scoreBtnText: { color: t.text.muted, fontSize: fonts.sm, fontWeight: fonts.bold },
    scoreBtnTextActive: { color: '#fff' },
    goalRow: { borderBottomColor: t.bg.primary, borderBottomWidth: 1, paddingVertical: 14 },
    goalHeader: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center' },
    goalTitle: { color: t.text.primary, fontSize: fonts.md, fontWeight: fonts.semibold, flex: 1 },
    goalProgress: { color: t.accent.purple, fontSize: fonts.md, fontWeight: fonts.bold },
    ...
    goalMeta: { color: t.text.muted, fontSize: fonts.sm, marginTop: 6 },
    goalCategoryTag: { backgroundColor: t.accent.purple + '20', paddingHorizontal: 8, paddingVertical: 2, borderRadius: 8, marginRight: 8 },
    goalCategoryText: { color: t.accent.purple, fontSize: fonts.xs, fontWeight: fonts.semibold },
    ...
    dateTypeText: { fontSize: fonts.xs, fontWeight: fonts.bold, textTransform: 'uppercase' },
    dateTitle: { color: t.text.primary, fontSize: fonts.md, fontWeight: fonts.bold, marginBottom: 4 },
    dateDesc: { color: t.text.muted, fontSize: fonts.sm, lineHeight: 20, marginBottom: 8 },
    dateMeta: { flexDirection: 'row', gap: 16 },
    dateMetaText: { color: t.text.secondary, fontSize: fonts.sm },
    ...
    exerciseTypeText: { color: t.accent.blue, fontSize: fonts.xs, fontWeight: fonts.bold, textTransform: 'uppercase' },
    exerciseTitle: { color: t.text.primary, fontSize: fonts.md, fontWeight: fonts.bold, marginBottom: 6 },
    exercisePrompt: { color: t.text.muted, fontSize: fonts.sm, lineHeight: 20, marginBottom: 8 },
    exerciseDuration: { color: t.text.secondary, fontSize: fonts.sm },
    ...
    resourceTypeText: { fontSize: fonts.xs, fontWeight: fonts.bold, textTransform: 'uppercase' },
    resourceTitle: { color: t.text.primary, fontSize: fonts.md, fontWeight: fonts.bold, marginBottom: 2 },
    resourceAuthor: { color: t.text.secondary, fontSize: fonts.sm, marginBottom: 6 },
    resourceDesc: { color: t.text.muted, fontSize: fonts.sm, lineHeight: 20 },
