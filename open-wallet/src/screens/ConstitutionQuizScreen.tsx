...
export function ConstitutionQuizScreen({ onClose }: Props) {
  ...
  const s = useMemo(() => StyleSheet.create({
    ...
    cardDesc: { color: t.text.secondary, fontSize: fonts.sm, lineHeight: 20, marginTop: 6 },
    ...
    articleNumText: { color: t.accent.blue, fontSize: fonts.lg, fontWeight: fonts.heavy },
    articleInfo: { flex: 1 },
    articleTitle: { color: t.text.primary, fontSize: fonts.md, fontWeight: fonts.bold },
    articleStatus: { fontSize: fonts.sm, marginTop: 3 },
    ...
    questionText: { color: t.text.primary, fontSize: fonts.lg, fontWeight: fonts.bold, lineHeight: 24, marginBottom: 20 },
    ...
    optionText: { color: t.text.primary, fontSize: fonts.md },
    ...
    navBtnText: { color: '#fff', fontSize: fonts.md, fontWeight: fonts.bold },
    ...
    resultLabel: { color: t.text.muted, fontSize: fonts.md, marginTop: 4 },
    resultReward: { color: t.accent.green, fontSize: fonts.xl, fontWeight: fonts.bold, marginTop: 16 },
    historyCard: { backgroundColor: t.bg.card, borderRadius: 16, padding: 16, marginHorizontal: 20, marginBottom: 10 },
    historyRow: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center' },
    historyTitle: { color: t.text.primary, fontSize: fonts.md, fontWeight: fonts.bold },
    historyScore: { color: t.accent.green, fontSize: fonts.md, fontWeight: fonts.bold },
    historyDate: { color: t.text.muted, fontSize: fonts.sm, marginTop: 4 },
    historyReward: { color: t.accent.blue, fontSize: fonts.sm, fontWeight: fonts.semibold },
    ...
    lbRank: { width: 30, color: t.text.primary, fontSize: fonts.md, fontWeight: fonts.heavy },
    lbName: { flex: 1, color: t.text.primary, fontSize: fonts.md, fontWeight: fonts.semibold },
    lbScore: { color: t.accent.green, fontSize: fonts.md, fontWeight: fonts.bold, width: 45, textAlign: 'right' },
    lbGotk: { color: t.accent.blue, fontSize: fonts.sm, fontWeight: fonts.semibold, width: 60, textAlign: 'right' },
    ...
    certTitle: { color: t.accent.yellow ?? '#ffd700', fontSize: fonts.xl, fontWeight: fonts.heavy, textAlign: 'center' },
    certSubtitle: { color: t.text.primary, fontSize: fonts.lg, fontWeight: fonts.bold, textAlign: 'center', marginTop: 8 },
    certDesc: { color: t.text.secondary, fontSize: fonts.md, textAlign: 'center', marginTop: 12, lineHeight: 22 },
    certStatus: { color: t.text.muted, fontSize: fonts.sm, marginTop: 20 },
    certProgress: { color: t.accent.blue, fontSize: fonts.lg, fontWeight: fonts.heavy, marginTop: 8 },
    ...
    overallValue: { color: t.text.primary, fontSize: fonts.xxl, fontWeight: fonts.heavy },
    overallLabel: { color: t.text.muted, fontSize: fonts.xs, marginTop: 4 },
  }), [t]);
        ...
        {ARTICLE_QUIZZES.map((aq) => {
          ...
          return (
            <View key={aq.article} style={[s.card, { flexDirection: 'row', alignItems: 'center' }]}>
              <Text style={{ fontSize: fonts.xl, marginRight: 12 }}>{passed ? '\u2705' : '\u2B1C'}</Text>
              <View style={{ flex: 1 }}>
                <Text style={s.cardTitle}>Art. {aq.article} — {aq.title}</Text>
                <Text style={{ color: passed ? t.accent.green : t.text.muted, fontSize: fonts.sm, marginTop: 2 }}>
