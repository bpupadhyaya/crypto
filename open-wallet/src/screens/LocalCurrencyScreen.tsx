...
export function LocalCurrencyScreen({ onClose }: Props) {
  ...
  const s = useMemo(() => StyleSheet.create({
    ...
    currName: { color: t.text.primary, fontSize: fonts.lg, fontWeight: fonts.bold },
    currSymbol: { color: t.accent.green, fontSize: fonts.sm, fontWeight: fonts.bold, marginTop: 2 },
    currMeta: { color: t.text.muted, fontSize: fonts.sm, marginTop: 4 },
    currDesc: { color: t.text.muted, fontSize: fonts.sm, marginTop: 8, lineHeight: 19 },
