...
export const TokenDetailScreen = React.memo(({ token, price, onClose, onSend }: Props) => {
  ...
  const s = useMemo(() => StyleSheet.create({
    ...
    backBtn: { color: t.accent.blue, fontSize: fonts.lg, fontWeight: fonts.semibold },
    ...
    price: { color: t.text.primary, fontSize: fonts.hero, fontWeight: fonts.heavy },
    change: { fontSize: fonts.lg, fontWeight: fonts.bold, marginTop: 4 },
    fullName: { color: t.text.muted, fontSize: fonts.md, marginTop: 4 },
    ...
    tfText: { color: t.text.secondary, fontSize: fonts.sm, fontWeight: fonts.semibold },
    ...
    balanceAmount: { color: t.text.primary, fontSize: fonts.xxl, fontWeight: fonts.bold, marginTop: 8 },
    balanceUsd: { color: t.text.secondary, fontSize: fonts.lg, marginTop: 4 },
    actions: { flexDirection: 'row', gap: 12, marginHorizontal: 16, marginTop: 16 },
    actionBtn: { flex: 1, paddingVertical: 14, borderRadius: 12, alignItems: 'center' },
    actionText: { fontSize: fonts.md, fontWeight: fonts.bold },
    ...
    stakingLabel: { color: t.accent.green, fontSize: fonts.sm, fontWeight: fonts.bold, textTransform: 'uppercase', letterSpacing: 1 },
    stakingApy: { color: t.accent.green, fontSize: fonts.hero, fontWeight: fonts.heavy, marginTop: 4 },
    stakingNote: { color: t.text.muted, fontSize: fonts.sm, marginTop: 4 },
    ...
    infoLabel: { color: t.text.muted, fontSize: fonts.md },
    infoValue: { color: t.text.secondary, fontSize: fonts.md },
  }), [t]);
