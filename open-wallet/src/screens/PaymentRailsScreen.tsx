...
export function PaymentRailsScreen({ onClose }: Props) {
  ...
  const s = useMemo(() => StyleSheet.create({
    ...
    section: { color: t.text.secondary, fontSize: fonts.sm, fontWeight: fonts.bold, textTransform: 'uppercase', letterSpacing: 1.5, marginBottom: 10, marginTop: 16 },
    ...
    railIcon: { fontSize: fonts.xxxl, marginRight: 12 },
    railInfo: { flex: 1 },
    railName: { color: t.text.primary, fontSize: fonts.md, fontWeight: fonts.bold },
    railRegion: { color: t.text.muted, fontSize: fonts.sm, marginTop: 2 },
    railMeta: { color: t.text.secondary, fontSize: fonts.xs, marginTop: 2 },
    railFee: { alignItems: 'flex-end' },
    railFeeText: { color: t.accent.green, fontSize: fonts.sm, fontWeight: fonts.semibold },
    railTime: { color: t.text.muted, fontSize: fonts.xs, marginTop: 2 },
    detected: { backgroundColor: t.accent.green + '20', borderRadius: 8, paddingHorizontal: 8, paddingVertical: 2, marginLeft: 8 },
    detectedText: { color: t.accent.green, fontSize: fonts.xs, fontWeight: fonts.bold },
    ...
    input: { backgroundColor: t.bg.primary, borderRadius: 12, padding: 14, color: t.text.primary, fontSize: fonts.xl, fontWeight: fonts.semibold },
    ...
    cryptoText: { color: t.text.secondary, fontSize: fonts.sm },
    cryptoTextActive: { color: '#fff', fontWeight: fonts.bold },
    estimate: { color: t.text.muted, fontSize: fonts.sm, textAlign: 'center', marginTop: 12 },
    buyBtn: { backgroundColor: t.accent.green, borderRadius: 16, paddingVertical: 18, alignItems: 'center', marginTop: 20 },
    buyBtnText: { color: '#fff', fontSize: fonts.lg, fontWeight: fonts.bold },
  }), [t]);
