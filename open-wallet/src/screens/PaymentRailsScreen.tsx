...
export function PaymentRailsScreen({ onClose }: Props) {
  ...
  const s = useMemo(() => StyleSheet.create({
    ...
    section: { color: t.text.secondary, fontSize: 12, fontWeight: fonts.bold, textTransform: 'uppercase', letterSpacing: 1.5, marginBottom: 10, marginTop: 16 },
    ...
    railInfo: { flex: 1 },
    railName: { color: t.text.primary, fontSize: 15, fontWeight: fonts.bold },
    ...
    railFeeText: { color: t.accent.green, fontSize: 13, fontWeight: fonts.semibold },
    ...
    detectedText: { color: t.accent.green, fontSize: 10, fontWeight: fonts.bold },
    ...
    input: { backgroundColor: t.bg.primary, borderRadius: 12, padding: 14, color: t.text.primary, fontSize: 20, fontWeight: fonts.semibold },
    ...
    buyBtnText: { color: '#fff', fontSize: 17, fontWeight: fonts.bold },
  }), [t]);
