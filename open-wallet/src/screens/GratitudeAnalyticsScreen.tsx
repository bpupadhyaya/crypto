  ...
  const styles = useMemo(
    () =>
      StyleSheet.create({
        ...
        summaryValue: { fontSize: fonts.xxl, fontWeight: fonts.bold, color: t.accent.green },
        summaryLabel: { fontSize: fonts.xs, color: t.text.secondary, marginTop: 2 },
        ...
        entryPerson: { fontSize: fonts.md, fontWeight: fonts.bold, color: t.text.primary, marginBottom: 4 },
        entryMessage: { fontSize: fonts.sm, color: t.text.secondary, lineHeight: 18, fontStyle: 'italic', marginBottom: 8 },
        entryFooter: { flexDirection: 'row', justifyContent: 'space-between' },
        entryChannel: { fontSize: fonts.xs, fontWeight: fonts.semibold, color: t.accent.green, textTransform: 'uppercase' },
        entryOtk: { fontSize: fonts.sm, fontWeight: fonts.semibold, color: t.accent.green },
        entryDate: { fontSize: fonts.sm, color: t.text.secondary },
        ...
        trendPeriod: { fontSize: fonts.md, fontWeight: fonts.bold, color: t.text.primary, marginBottom: 8 },
        trendRow: { flexDirection: 'row', justifyContent: 'space-between', marginBottom: 4 },
        trendLabel: { fontSize: fonts.sm, color: t.text.secondary },
        trendValue: { fontSize: fonts.sm, fontWeight: fonts.semibold, color: t.text.primary },
        ...
        insightText: { fontSize: fonts.sm, color: t.text.primary, lineHeight: 18 },
