  ...
  const styles = useMemo(
    () =>
      StyleSheet.create({
        ...
        summaryValue: { fontSize: 22, fontWeight: '700', color: t.accent.green },
        ...
        entryPerson: { fontSize: 15, fontWeight: '700', color: t.text.primary, marginBottom: 4 },
        ...
        entryChannel: { fontSize: 11, fontWeight: '600', color: t.accent.green, textTransform: 'uppercase' },
        entryOtk: { fontSize: 12, fontWeight: '600', color: t.accent.green },
        ...
        trendPeriod: { fontSize: 14, fontWeight: '700', color: t.text.primary, marginBottom: 8 },
        trendRow: { flexDirection: 'row', justifyContent: 'space-between', marginBottom: 4 },
        trendLabel: { fontSize: 13, color: t.text.secondary },
        trendValue: { fontSize: 13, fontWeight: '600', color: t.text.primary },
