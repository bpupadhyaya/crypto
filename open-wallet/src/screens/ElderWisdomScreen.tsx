...
export function ElderWisdomScreen({ onClose }: Props) {
  ...
  const s = useMemo(() => StyleSheet.create({
    ...
    catLabel: { color: t.text.secondary, fontSize: 11, fontWeight: '600' },
    ...
    wisdomCatText: { color: t.accent.purple, fontSize: 10, fontWeight: '600' },
    wisdomTitle: { color: t.text.primary, fontSize: 15, fontWeight: '700', marginTop: 8 },
    ...
    nOTKText: { color: t.accent.green, fontSize: 11, fontWeight: '700' },
    // Ask section
    ...
    askSubmitText: { color: '#fff', fontSize: 15, fontWeight: '700' },
    questionCard: { backgroundColor: t.bg.card, borderRadius: 16, padding: 16, marginBottom: 12 },
    questionText: { color: t.text.primary, fontSize: 14, fontWeight: '600', lineHeight: 20 },
    ...
    questionStatusText: { fontSize: 11, fontWeight: '700' },
    ...
    elderName: { color: t.text.primary, fontSize: 16, fontWeight: '700' },
    ...
    expertTagText: { color: t.accent.purple, fontSize: 11, fontWeight: '600' },
    ...
    elderStatVal: { color: t.text.primary, fontSize: 16, fontWeight: '800' },
    elderStatLabel: { color: t.text.muted, fontSize: 10, fontWeight: '600', marginTop: 2, textTransform: 'uppercase', letterSpacing: 0.5 },
    ...
    gratitudeBtnText: { color: '#fff', fontSize: 13, fontWeight: '700' },
    // Legacy stories
    ...
    legacyTitle: { color: t.text.primary, fontSize: 15, fontWeight: '700' },
    legacyElder: { color: t.accent.purple, fontSize: 12, fontWeight: '600', marginTop: 4 },
