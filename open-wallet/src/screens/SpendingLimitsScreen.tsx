...
export const SpendingLimitsScreen = React.memo(({ onClose }: Props) => {
  ...
  const s = useMemo(() => StyleSheet.create({
    ...
    subtitle: { color: t.text.muted, fontSize: fonts.md, marginBottom: 20 },
    card: { backgroundColor: t.bg.card, borderRadius: 16, padding: 16, marginBottom: 12 },
    cardHeader: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', marginBottom: 8 },
    tokenName: { color: t.text.primary, fontSize: fonts.xl, fontWeight: fonts.heavy },
    chainBadge: { backgroundColor: t.border, borderRadius: 8, paddingVertical: 2, paddingHorizontal: 8 },
    chainText: { color: t.text.secondary, fontSize: fonts.xs, fontWeight: fonts.semibold },
    periodBadge: { borderRadius: 8, paddingVertical: 2, paddingHorizontal: 8, marginLeft: 6 },
    periodText: { fontSize: fonts.xs, fontWeight: fonts.bold },
    row: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', marginBottom: 4 },
    label: { color: t.text.secondary, fontSize: fonts.sm },
    value: { color: t.text.primary, fontSize: fonts.sm, fontWeight: fonts.semibold },
    progressContainer: { height: 10, backgroundColor: t.border, borderRadius: 5, marginTop: 8, marginBottom: 4, overflow: 'hidden' },
    progressFill: { height: 10, borderRadius: 5 },
    warningText: { color: t.accent.orange, fontSize: fonts.sm, fontWeight: fonts.semibold, marginTop: 4 },
    blockedText: { color: t.accent.red, fontSize: fonts.sm, fontWeight: fonts.bold, marginTop: 4 },
    statusText: { color: t.accent.green, fontSize: fonts.sm, fontWeight: fonts.semibold, marginTop: 4 },
    ...
    btnTextRed: { color: t.accent.red, fontSize: fonts.md, fontWeight: fonts.bold },
    input: { backgroundColor: t.bg.primary, borderRadius: 12, padding: 14, color: t.text.primary, fontSize: fonts.md, marginBottom: 12, borderWidth: 1, borderColor: t.border },
    ...
    periodBtnText: { color: t.text.secondary, fontSize: fonts.md, fontWeight: fonts.semibold },
      ...
      <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={s.scroll}>
        ...
        {!showAdd ? (
          ...
          <View style={[s.card, { marginBottom: 20 }]}>
            <Text style={{ color: t.text.primary, fontSize: fonts.lg, fontWeight: fonts.bold, marginBottom: 12 }}>
