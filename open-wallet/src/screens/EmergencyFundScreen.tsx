...
export function EmergencyFundScreen({ onClose }: Props) {
  ...
  const s = useMemo(() => StyleSheet.create({
    ...
    contributeBtnText: { color: '#fff', fontSize: 14, fontWeight: fonts.bold },
    requestCard: { backgroundColor: t.bg.secondary, borderRadius: 14, padding: 16, marginHorizontal: 20, marginBottom: 12 },
    requestHeader: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center' },
    requestName: { color: t.text.primary, fontSize: 15, fontWeight: fonts.bold, flex: 1 },
    urgencyBadge: { paddingHorizontal: 8, paddingVertical: 3, borderRadius: 6 },
    urgencyText: { color: '#fff', fontSize: 10, fontWeight: fonts.bold },
    ...
    requestAmount: { color: t.text.primary, fontSize: 14, fontWeight: fonts.bold },
    requestStatus: { paddingHorizontal: 8, paddingVertical: 2, borderRadius: 6 },
    requestStatusText: { color: '#fff', fontSize: 10, fontWeight: fonts.bold },
    ...
    historyName: { color: t.text.primary, fontSize: 15, fontWeight: fonts.bold },
    historyMeta: { color: t.text.muted, fontSize: 12, marginTop: 4 },
    historyAmount: { color: t.accent.green, fontSize: 16, fontWeight: fonts.heavy, marginTop: 6 },
