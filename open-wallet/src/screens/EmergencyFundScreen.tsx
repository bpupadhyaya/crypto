...
export function EmergencyFundScreen({ onClose }: Props) {
  ...
  const s = useMemo(() => StyleSheet.create({
    ...
    contributeInput: { flex: 1, backgroundColor: t.bg.primary, borderRadius: 12, padding: 14, color: t.text.primary, fontSize: fonts.md },
    contributeBtn: { backgroundColor: t.accent.green, borderRadius: 12, paddingHorizontal: 20, justifyContent: 'center' },
    contributeBtnText: { color: '#fff', fontSize: fonts.md, fontWeight: fonts.bold },
    requestCard: { backgroundColor: t.bg.secondary, borderRadius: 14, padding: 16, marginHorizontal: 20, marginBottom: 12 },
    requestHeader: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center' },
    requestName: { color: t.text.primary, fontSize: fonts.md, fontWeight: fonts.bold, flex: 1 },
    urgencyBadge: { paddingHorizontal: 8, paddingVertical: 3, borderRadius: 6 },
    urgencyText: { color: '#fff', fontSize: fonts.xs, fontWeight: fonts.bold },
    requestDesc: { color: t.text.muted, fontSize: fonts.sm, marginTop: 6, lineHeight: 20 },
    requestMeta: { flexDirection: 'row', justifyContent: 'space-between', marginTop: 8 },
    requestAmount: { color: t.text.primary, fontSize: fonts.md, fontWeight: fonts.bold },
    requestStatus: { paddingHorizontal: 8, paddingVertical: 2, borderRadius: 6 },
    requestStatusText: { color: '#fff', fontSize: fonts.xs, fontWeight: fonts.bold },
    requestVerifier: { color: t.text.muted, fontSize: fonts.xs, marginTop: 4 },
    ...
    historyName: { color: t.text.primary, fontSize: fonts.md, fontWeight: fonts.bold },
    historyMeta: { color: t.text.muted, fontSize: fonts.sm, marginTop: 4 },
    historyAmount: { color: t.accent.green, fontSize: fonts.lg, fontWeight: fonts.heavy, marginTop: 6 },
    historyHash: { color: t.accent.blue, fontSize: fonts.xs, marginTop: 4, fontFamily: 'monospace' },
    historyOutcome: { color: t.text.primary, fontSize: fonts.sm, marginTop: 6, fontStyle: 'italic', lineHeight: 20 },
