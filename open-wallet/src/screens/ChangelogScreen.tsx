...
export function ChangelogScreen({ onClose }: Props) {
  ...
  const st = useMemo(() => StyleSheet.create({
    ...
    versionText: { color: t.text.primary, fontSize: fonts.xl, fontWeight: fonts.heavy },
    dateText: { color: t.text.muted, fontSize: fonts.sm, fontWeight: fonts.semibold },
    currentBadge: { backgroundColor: t.accent.green + '30', borderRadius: 6, paddingVertical: 2, paddingHorizontal: 8, marginLeft: 8 },
    currentBadgeText: { color: t.accent.green, fontSize: fonts.xs, fontWeight: fonts.bold },
    highlight: { color: t.text.secondary, fontSize: fonts.md, fontWeight: fonts.semibold, marginBottom: 12, lineHeight: 20 },
    changeRow: { flexDirection: 'row', alignItems: 'flex-start', marginBottom: 6, paddingLeft: 4 },
    changeIcon: { fontSize: fonts.sm, marginRight: 8, marginTop: 2 },
    changeType: { fontSize: fonts.xs, fontWeight: fonts.bold, width: 64, marginRight: 4, marginTop: 1 },
    changeText: { color: t.text.secondary, fontSize: fonts.sm, flex: 1, lineHeight: 18 },
    divider: { height: 1, backgroundColor: t.border, marginVertical: 8 },
    footerText: { color: t.text.muted, fontSize: fonts.sm, textAlign: 'center', marginTop: 20, fontStyle: 'italic' },
  }), [t]);
