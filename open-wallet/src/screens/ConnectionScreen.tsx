...
export function ConnectionScreen({ onClose }: Props) {
  ...
  const st = useMemo(() => StyleSheet.create({
    ...
    connChain: { color: t.text.primary, fontSize: 15, fontWeight: fonts.bold },
    connStatus: { fontSize: 12 },
    connUrl: { color: t.text.muted, fontSize: 11, fontFamily: 'Courier', marginBottom: 6 },
    connLatency: { fontSize: 13, fontWeight: fonts.bold },
    customBadge: { backgroundColor: t.accent.purple + '30', borderRadius: 4, paddingVertical: 1, paddingHorizontal: 6 },
    customBadgeText: { color: t.accent.purple, fontSize: 9, fontWeight: fonts.bold },
    inputCard: { backgroundColor: t.bg.card, borderRadius: 14, padding: 16, marginBottom: 16 },
    inputLabel: { color: t.text.secondary, fontSize: 12, fontWeight: fonts.semibold, marginBottom: 6 },
    ...
    testBtnText: { color: '#fff', fontSize: 13, fontWeight: fonts.semibold },
    testResult: { color: t.text.secondary, fontSize: 12, marginTop: 6, textAlign: 'center' },
