  ...
  const styles = useMemo(
    () =>
      StyleSheet.create({
        ...
        idType: { fontSize: 15, fontWeight: fonts.bold, color: t.text.primary, marginBottom: 2 },
        idIssuer: { fontSize: 12, color: t.accent.green, marginBottom: 6 },
        idIdentifier: { fontSize: 13, fontFamily: 'monospace', color: t.text.secondary, backgroundColor: t.bg.primary, padding: 6, borderRadius: 6, marginBottom: 8 },
        idFooter: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center' },
        idDates: { fontSize: 11, color: t.text.secondary },
        ...
        docInfo: { flex: 1 },
        docName: { fontSize: 14, fontWeight: fonts.semibold, color: t.text.primary, marginBottom: 2 },
        docMeta: { fontSize: 12, color: t.text.secondary },
        docVerified: { fontSize: 11, fontWeight: fonts.semibold },
        ...
        verifyRequester: { fontSize: 14, fontWeight: fonts.bold, color: t.text.primary, marginBottom: 2 },
        verifyField: { fontSize: 12, color: t.accent.green, marginBottom: 4 },
        verifyPurpose: { fontSize: 13, color: t.text.secondary, lineHeight: 18, marginBottom: 8 },
        verifyFooter: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center' },
        verifyDate: { fontSize: 11, color: t.text.secondary },
        actionRow: { flexDirection: 'row', gap: 8 },
        approveBtn: { paddingHorizontal: 14, paddingVertical: 6, borderRadius: 8, backgroundColor: t.accent.green + '20' },
        approveBtnText: { fontSize: 12, fontWeight: fonts.semibold, color: t.accent.green },
        denyBtn: { paddingHorizontal: 14, paddingVertical: 6, borderRadius: 8, backgroundColor: '#F4433620' },
        denyBtnText: { fontSize: 12, fontWeight: fonts.semibold, color: '#F44336' },
