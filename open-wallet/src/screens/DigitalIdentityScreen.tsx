  ...
  const styles = useMemo(
    () =>
      StyleSheet.create({
        ...
        idType: { fontSize: 15, fontWeight: '700', color: t.text.primary, marginBottom: 2 },
        ...
        docInfo: { flex: 1 },
        docName: { fontSize: 14, fontWeight: '600', color: t.text.primary, marginBottom: 2 },
        docMeta: { fontSize: 12, color: t.text.secondary },
        docVerified: { fontSize: 11, fontWeight: '600' },
        ...
        verifyRequester: { fontSize: 14, fontWeight: '700', color: t.text.primary, marginBottom: 2 },
        ...
        approveBtnText: { fontSize: 12, fontWeight: '600', color: t.accent.green },
        denyBtn: { paddingHorizontal: 14, paddingVertical: 6, borderRadius: 8, backgroundColor: '#F4433620' },
        denyBtnText: { fontSize: 12, fontWeight: '600', color: '#F44336' },
