...
export const ImportWalletScreen = React.memo(({ onClose }: Props) => {
  ...
  const s = useMemo(() => StyleSheet.create({
    ...
    methodBtnText: { color: t.text.secondary, fontSize: fonts.sm, fontWeight: fonts.semibold },
    ...
    importBtnText: { color: '#fff', fontSize: fonts.lg, fontWeight: fonts.bold },
    ...
    walletName: { color: t.text.primary, fontSize: fonts.md, fontWeight: fonts.semibold },
    walletMeta: { color: t.text.muted, fontSize: fonts.sm, marginTop: 2 },
    walletType: { fontSize: fonts.xs, fontWeight: fonts.semibold, paddingHorizontal: 8, paddingVertical: 3, borderRadius: 6, overflow: 'hidden' },
    removeBtn: { paddingHorizontal: 10, paddingVertical: 6 },
    removeText: { color: t.accent.red, fontSize: fonts.sm, fontWeight: fonts.semibold },
    demoTag: { color: t.accent.purple, fontSize: fonts.xs, fontWeight: fonts.bold, marginLeft: 6 },
  }), [t]);
