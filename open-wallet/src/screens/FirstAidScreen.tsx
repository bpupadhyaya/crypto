...
export function FirstAidScreen({ onClose }: Props) {
  ...
  const s = useMemo(() => StyleSheet.create({
    ...
    guideSummary: { color: t.text.secondary, fontSize: fonts.sm, marginTop: 6, lineHeight: 20 },
    stepsList: { marginTop: 12, backgroundColor: t.bg.primary, borderRadius: 10, padding: 12 },
    stepItem: { flexDirection: 'row', marginBottom: 8 },
    stepNumber: { color: '#FF3B30', fontSize: fonts.sm, fontWeight: fonts.heavy, width: 24 },
    stepText: { color: t.text.primary, fontSize: fonts.sm, flex: 1, lineHeight: 20 },
    ...
    offlineText: { color: t.accent.green, fontSize: fonts.xs, fontWeight: fonts.bold },
    courseCard: { backgroundColor: t.bg.secondary, borderRadius: 14, padding: 16, marginHorizontal: 20, marginBottom: 12 },
    courseName: { color: t.text.primary, fontSize: fonts.md, fontWeight: fonts.bold },
    courseMeta: { color: t.text.muted, fontSize: fonts.sm, marginTop: 4 },
    courseDesc: { color: t.text.secondary, fontSize: fonts.sm, marginTop: 8, lineHeight: 20 },
    ...
    courseHotk: { color: '#FF3B30', fontSize: fonts.md, fontWeight: fonts.bold },
    enrollBtn: { backgroundColor: '#FF3B30', paddingHorizontal: 16, paddingVertical: 8, borderRadius: 10 },
    enrollBtnText: { color: '#fff', fontSize: fonts.sm, fontWeight: fonts.semibold },
    ...
    certText: { color: t.accent.blue, fontSize: fonts.xs, fontWeight: fonts.bold },
    drillCard: { backgroundColor: t.bg.secondary, borderRadius: 14, padding: 16, marginHorizontal: 20, marginBottom: 12 },
    drillTitle: { color: t.text.primary, fontSize: fonts.md, fontWeight: fonts.bold },
    drillScenario: { color: t.text.secondary, fontSize: fonts.sm, marginTop: 8, lineHeight: 20 },
    drillMeta: { color: t.text.muted, fontSize: fonts.sm, marginTop: 8 },
    ...
    startBtnText: { color: '#fff', fontSize: fonts.sm, fontWeight: fonts.semibold },
    diffBadge: { paddingHorizontal: 8, paddingVertical: 2, borderRadius: 8, alignSelf: 'flex-start', marginTop: 6 },
    diffText: { fontSize: fonts.xs, fontWeight: fonts.bold },
    registerCard: { backgroundColor: '#FF3B30' + '10', borderRadius: 16, padding: 20, marginHorizontal: 20, marginBottom: 16, alignItems: 'center' },
    registerTitle: { color: t.text.primary, fontSize: fonts.lg, fontWeight: fonts.bold, textAlign: 'center' },
    registerDesc: { color: t.text.muted, fontSize: fonts.sm, textAlign: 'center', marginTop: 8, lineHeight: 20 },
    registerBtn: { backgroundColor: '#FF3B30', borderRadius: 14, paddingVertical: 14, paddingHorizontal: 32, marginTop: 16 },
    registerBtnText: { color: '#fff', fontSize: fonts.md, fontWeight: fonts.bold },
    registeredBadge: { backgroundColor: t.accent.green + '20', borderRadius: 14, paddingVertical: 14, paddingHorizontal: 32, marginTop: 16 },
    registeredText: { color: t.accent.green, fontSize: fonts.md, fontWeight: fonts.bold },
    supplyCategory: { color: t.text.secondary, fontSize: fonts.sm, fontWeight: fonts.bold, textTransform: 'uppercase', letterSpacing: 1, marginTop: 12, marginBottom: 6 },
    ...
    supplyName: { color: t.text.primary, fontSize: fonts.md, fontWeight: fonts.semibold, flex: 1 },
    supplyQty: { color: t.text.muted, fontSize: fonts.sm, marginLeft: 12 },
    supplyNotes: { color: t.text.muted, fontSize: fonts.xs, marginTop: 2 },
