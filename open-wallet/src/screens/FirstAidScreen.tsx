...
export function FirstAidScreen({ onClose }: Props) {
  ...
  const s = useMemo(() => StyleSheet.create({
    ...
    stepNumber: { color: '#FF3B30', fontSize: 13, fontWeight: '800', width: 24 },
    ...
    offlineText: { color: t.accent.green, fontSize: 11, fontWeight: '700' },
    courseCard: { backgroundColor: t.bg.secondary, borderRadius: 14, padding: 16, marginHorizontal: 20, marginBottom: 12 },
    courseName: { color: t.text.primary, fontSize: 15, fontWeight: '700' },
    ...
    courseHotk: { color: '#FF3B30', fontSize: 14, fontWeight: '700' },
    ...
    certText: { color: t.accent.blue, fontSize: 11, fontWeight: '700' },
    drillCard: { backgroundColor: t.bg.secondary, borderRadius: 14, padding: 16, marginHorizontal: 20, marginBottom: 12 },
    drillTitle: { color: t.text.primary, fontSize: 15, fontWeight: '700' },
    ...
    registerTitle: { color: t.text.primary, fontSize: 16, fontWeight: '700', textAlign: 'center' },
    ...
    registeredText: { color: t.accent.green, fontSize: 15, fontWeight: '700' },
    supplyCategory: { color: t.text.secondary, fontSize: 13, fontWeight: '700', textTransform: 'uppercase', letterSpacing: 1, marginTop: 12, marginBottom: 6 },
    ...
    supplyName: { color: t.text.primary, fontSize: 14, fontWeight: '600', flex: 1 },
