  ...
  const styles = useMemo(
    () =>
      StyleSheet.create({
        ...
        levelTitle: { fontSize: 15, fontWeight: '700', color: t.text.primary },
        levelBadge: { fontSize: 11, fontWeight: '600' },
        ...
        levelReward: { fontSize: 12, fontWeight: '600', color: t.accent.green },
        ...
        missionTitle: { fontSize: 15, fontWeight: '700', color: t.text.primary, marginBottom: 4 },
        ...
        missionOtk: { fontSize: 13, fontWeight: '600', color: t.accent.green },
        ...
        impactValue: { fontSize: 24, fontWeight: '700', color: t.accent.green, marginBottom: 2 },
        impactLabel: { fontSize: 14, fontWeight: '600', color: t.text.primary, marginBottom: 2 },
