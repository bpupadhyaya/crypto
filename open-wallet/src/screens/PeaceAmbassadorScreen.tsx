  ...
  const styles = useMemo(
    () =>
      StyleSheet.create({
        ...
        levelTitle: { fontSize: fonts.md, fontWeight: fonts.bold, color: t.text.primary },
        levelBadge: { fontSize: fonts.xs, fontWeight: fonts.semibold },
        levelDesc: { fontSize: fonts.sm, color: t.text.secondary, lineHeight: 18, marginBottom: 6 },
        levelReq: { fontSize: fonts.sm, color: t.accent.green, marginBottom: 4 },
        levelReward: { fontSize: fonts.sm, fontWeight: fonts.semibold, color: t.accent.green },
        ...
        missionTitle: { fontSize: fonts.md, fontWeight: fonts.bold, color: t.text.primary, marginBottom: 4 },
        missionDesc: { fontSize: fonts.sm, color: t.text.secondary, lineHeight: 18, marginBottom: 8 },
        ...
        metaChipText: { fontSize: fonts.xs, color: t.text.secondary },
        missionFooter: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center' },
        missionOtk: { fontSize: fonts.sm, fontWeight: fonts.semibold, color: t.accent.green },
        missionParticipants: { fontSize: fonts.sm, color: t.text.secondary },
        ...
        impactValue: { fontSize: fonts.xxl, fontWeight: fonts.bold, color: t.accent.green, marginBottom: 2 },
        impactLabel: { fontSize: fonts.md, fontWeight: fonts.semibold, color: t.text.primary, marginBottom: 2 },
        impactDesc: { fontSize: fonts.sm, color: t.text.secondary },
        ...
        principleText: { fontSize: fonts.md, fontStyle: 'italic', color: t.text.primary, lineHeight: 20 },
