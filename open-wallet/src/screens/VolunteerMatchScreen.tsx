...
export function VolunteerMatchScreen({ onClose }: Props) {
  ...
  const st = useMemo(() => StyleSheet.create({
    ...
    matchScore: { fontSize: 28, fontWeight: '800' },
    ...
    profileLabel: { color: t.text.muted, fontSize: 11, fontWeight: '600', textTransform: 'uppercase', letterSpacing: 1, marginBottom: 6 },
