...
export function HomeSchoolScreen({ onClose }: Props) {
  ...
  const s = useMemo(() => StyleSheet.create({
    ...
    studentName: { color: t.text.primary, fontSize: 15, fontWeight: fonts.bold, marginBottom: 2 },
    studentGrade: { color: t.text.muted, fontSize: 12 },
    studentEotk: { color: t.accent.purple, fontSize: 13, fontWeight: fonts.bold, marginTop: 4 },
    ...
    summaryTitle: { color: t.text.primary, fontSize: 16, fontWeight: fonts.bold, marginBottom: 4 },
    summaryText: { color: t.text.muted, fontSize: 13, marginTop: 2 },
    summaryEotk: { color: t.accent.purple, fontSize: 22, fontWeight: fonts.heavy, marginTop: 8 },
    summaryEotkLabel: { color: t.text.muted, fontSize: 11, textTransform: 'uppercase', letterSpacing: 1 },
    ...
    subjectDotText: { color: '#fff', fontSize: 14, fontWeight: fonts.bold },
    lessonInfo: { flex: 1 },
    lessonTitle: { color: t.text.primary, fontSize: 14, fontWeight: fonts.semibold },
    lessonMeta: { color: t.text.muted, fontSize: 12, marginTop: 2 },
    lessonRight: { alignItems: 'flex-end' },
    lessonEotk: { color: t.accent.purple, fontSize: 13, fontWeight: fonts.bold },
    lessonCheck: { color: '#34C759', fontSize: 18, fontWeight: fonts.bold, marginTop: 2 },
    completeBtn: { backgroundColor: t.accent.purple + '20', borderRadius: 8, paddingHorizontal: 10, paddingVertical: 4, marginTop: 4 },
    completeBtnText: { color: t.accent.purple, fontSize: 11, fontWeight: fonts.bold },
    ...
    portfolioTitle: { color: t.text.primary, fontSize: 15, fontWeight: fonts.bold, flex: 1 },
    typeBadge: { paddingHorizontal: 10, paddingVertical: 3, borderRadius: 8 },
    typeBadgeText: { color: '#fff', fontSize: 11, fontWeight: fonts.bold },
    portfolioDesc: { color: t.text.muted, fontSize: 13, lineHeight: 19, marginBottom: 8 },
    portfolioFooter: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center' },
    portfolioDate: { color: t.text.muted, fontSize: 12 },
    portfolioEotk: { color: t.accent.purple, fontSize: 13, fontWeight: fonts.bold },
    portfolioSubject: { color: t.text.secondary, fontSize: 12, fontWeight: fonts.semibold },

    // Co-op
    coopCard: { backgroundColor: t.bg.secondary, borderRadius: 16, padding: 20, marginHorizontal: 20, marginBottom: 16 },
    coopName: { color: t.text.primary, fontSize: 18, fontWeight: fonts.heavy, marginBottom: 8 },
    coopStat: { flexDirection: 'row', justifyContent: 'space-around', marginBottom: 16 },
    coopStatItem: { alignItems: 'center' },
    coopStatValue: { color: t.text.primary, fontSize: 20, fontWeight: fonts.heavy },
    coopStatLabel: { color: t.text.muted, fontSize: 11, marginTop: 2 },
    coopSection: { marginTop: 12 },
    coopLabel: { color: t.text.secondary, fontSize: 12, fontWeight: fonts.bold, textTransform: 'uppercase', letterSpacing: 1, marginBottom: 6 },
    coopValue: { color: t.text.primary, fontSize: 14, fontWeight: fonts.semibold, marginBottom: 4 },
    coopSubjects: { flexDirection: 'row', gap: 8, marginTop: 8 },
    coopSubjectChip: { paddingHorizontal: 10, paddingVertical: 4, borderRadius: 8 },
    coopSubjectText: { color: '#fff', fontSize: 11, fontWeight: fonts.bold },
    joinBtn: { backgroundColor: t.accent.purple, borderRadius: 14, paddingVertical: 14, alignItems: 'center', marginTop: 16 },
    joinBtnText: { color: '#fff', fontSize: 15, fontWeight: fonts.bold },
    coopNote: { color: t.text.muted, fontSize: 12, textAlign: 'center', marginHorizontal: 20, marginTop: 8, lineHeight: 18 },
    ...
    resourceIconText: { color: '#fff', fontSize: 14, fontWeight: fonts.bold },
    resourceInfo: { flex: 1 },
    resourceTitle: { color: t.text.primary, fontSize: 14, fontWeight: fonts.semibold },
    resourceMeta: { color: t.text.muted, fontSize: 12, marginTop: 2 },
    ...
    resourceBadgeText: { color: '#fff', fontSize: 10, fontWeight: fonts.bold },
    openBtn: { backgroundColor: t.accent.purple + '20', borderRadius: 8, paddingHorizontal: 12, paddingVertical: 6 },
    openBtnText: { color: t.accent.purple, fontSize: 12, fontWeight: fonts.bold },

    emptyText: { color: t.text.muted, fontSize: 14, textAlign: 'center', marginTop: 40, marginHorizontal: 20 },
  }), [t]);
