...
export function HomeSchoolScreen({ onClose }: Props) {
  ...
  const s = useMemo(() => StyleSheet.create({
    ...
    studentName: { color: t.text.primary, fontSize: 15, fontWeight: '700', marginBottom: 2 },
    studentGrade: { color: t.text.muted, fontSize: 12 },
    studentEotk: { color: t.accent.purple, fontSize: 13, fontWeight: '700', marginTop: 4 },
    ...
    summaryTitle: { color: t.text.primary, fontSize: 16, fontWeight: '700', marginBottom: 4 },
    summaryText: { color: t.text.muted, fontSize: 13, marginTop: 2 },
    summaryEotk: { color: t.accent.purple, fontSize: 22, fontWeight: '900', marginTop: 8 },
    ...
    subjectDotText: { color: '#fff', fontSize: 14, fontWeight: '700' },
    lessonInfo: { flex: 1 },
    lessonTitle: { color: t.text.primary, fontSize: 14, fontWeight: '600' },
    lessonMeta: { color: t.text.muted, fontSize: 12, marginTop: 2 },
    lessonRight: { alignItems: 'flex-end' },
    lessonEotk: { color: t.accent.purple, fontSize: 13, fontWeight: '700' },
    lessonCheck: { color: '#34C759', fontSize: 18, fontWeight: '700', marginTop: 2 },
    completeBtn: { backgroundColor: t.accent.purple + '20', borderRadius: 8, paddingHorizontal: 10, paddingVertical: 4, marginTop: 4 },
    completeBtnText: { color: t.accent.purple, fontSize: 11, fontWeight: '700' },
    ...
    portfolioTitle: { color: t.text.primary, fontSize: 15, fontWeight: '700', flex: 1 },
    ...
    portfolioEotk: { color: t.accent.purple, fontSize: 13, fontWeight: '700' },
    portfolioSubject: { color: t.text.secondary, fontSize: 12, fontWeight: '600' },

    // Co-op
    coopCard: { backgroundColor: t.bg.secondary, borderRadius: 16, padding: 20, marginHorizontal: 20, marginBottom: 16 },
    coopName: { color: t.text.primary, fontSize: 18, fontWeight: '800', marginBottom: 8 },
    coopStat: { flexDirection: 'row', justifyContent: 'space-around', marginBottom: 16 },
    coopStatItem: { alignItems: 'center' },
    coopStatValue: { color: t.text.primary, fontSize: 20, fontWeight: '800' },
    coopStatLabel: { color: t.text.muted, fontSize: 11, marginTop: 2 },
    coopSection: { marginTop: 12 },
    coopLabel: { color: t.text.secondary, fontSize: 12, fontWeight: '700', textTransform: 'uppercase', letterSpacing: 1, marginBottom: 6 },
    coopValue: { color: t.text.primary, fontSize: 14, fontWeight: '600', marginBottom: 4 },
    coopSubjects: { flexDirection: 'row', gap: 8, marginTop: 8 },
    coopSubjectChip: { paddingHorizontal: 10, paddingVertical: 4, borderRadius: 8 },
    coopSubjectText: { color: '#fff', fontSize: 11, fontWeight: '700' },
    ...
    resourceIconText: { color: '#fff', fontSize: 14, fontWeight: '700' },
    resourceInfo: { flex: 1 },
    resourceTitle: { color: t.text.primary, fontSize: 14, fontWeight: '600' },
    ...
    resourceBadgeText: { color: '#fff', fontSize: 10, fontWeight: '700' },
    openBtn: { backgroundColor: t.accent.purple + '20', borderRadius: 8, paddingHorizontal: 12, paddingVertical: 6 },
    openBtnText: { color: t.accent.purple, fontSize: 12, fontWeight: '700' },
