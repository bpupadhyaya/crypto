...
export function ChildSafetyScreen({ onClose }: Props) {
  ...
  const st = useMemo(() => StyleSheet.create({
    ...
    featureText: { color: t.text.secondary, fontSize: fonts.xs },
    featureRow: { flexDirection: 'row', flexWrap: 'wrap', marginTop: 8 },
    stars: { color: '#f59e0b', fontSize: fonts.md, letterSpacing: 2 },
    ...
    lessonMeta: { flex: 1 },
    lessonCategory: { fontSize: fonts.xs, fontWeight: fonts.bold, textTransform: 'uppercase', letterSpacing: 1 },
    lessonTitle: { color: t.text.primary, fontSize: fonts.md, fontWeight: fonts.bold, marginTop: 2 },
    lessonDesc: { color: t.text.muted, fontSize: fonts.sm, marginTop: 4, lineHeight: 17 },
    ...
    checkinMeta: { flex: 1 },
    checkinChild: { color: t.text.primary, fontSize: fonts.md, fontWeight: fonts.bold },
    checkinDest: { color: t.text.secondary, fontSize: fonts.sm, marginTop: 1 },
    checkinTime: { color: t.text.muted, fontSize: fonts.xs, marginTop: 2 },
    sosBtn: { backgroundColor: '#ef4444', borderRadius: 14, padding: 18, alignItems: 'center', marginBottom: 16 },
    sosBtnText: { color: '#fff', fontSize: fonts.xl, fontWeight: fonts.heavy },
    sosSubtext: { color: 'rgba(255,255,255,0.8)', fontSize: fonts.sm, marginTop: 4 },
    alertBtn: { backgroundColor: '#f59e0b', borderRadius: 14, padding: 16, alignItems: 'center', marginBottom: 20 },
    alertBtnText: { color: '#fff', fontSize: fonts.lg, fontWeight: fonts.bold },
    alertSubtext: { color: 'rgba(255,255,255,0.8)', fontSize: fonts.xs, marginTop: 4 },
  }), [t]);
