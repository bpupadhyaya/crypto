...
export function ChildSafetyScreen({ onClose }: Props) {
  ...
  const st = useMemo(() => StyleSheet.create({
    ...
    lessonMeta: { flex: 1 },
    lessonCategory: { fontSize: 10, fontWeight: fonts.bold, textTransform: 'uppercase', letterSpacing: 1 },
    lessonTitle: { color: t.text.primary, fontSize: 15, fontWeight: fonts.bold, marginTop: 2 },
    ...
    checkinMeta: { flex: 1 },
    checkinChild: { color: t.text.primary, fontSize: 14, fontWeight: fonts.bold },
    ...
    sosBtnText: { color: '#fff', fontSize: 18, fontWeight: fonts.heavy },
    ...
    alertBtnText: { color: '#fff', fontSize: 16, fontWeight: fonts.bold },
