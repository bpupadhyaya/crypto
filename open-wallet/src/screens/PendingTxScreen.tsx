...
export function PendingTxScreen({ onClose }: Props) {
  ...
  const st = useMemo(() => StyleSheet.create({
    ...
    autoRefreshNote: { color: t.text.muted, fontSize: fonts.xs, textAlign: 'center', marginBottom: 12 },
    ...
    typeText: { color: t.text.primary, fontSize: fonts.md, fontWeight: fonts.bold },
    chainText: { color: t.text.secondary, fontSize: fonts.sm },
    elapsedText: { color: t.text.muted, fontSize: fonts.sm },
    amountRow: { flexDirection: 'row', alignItems: 'baseline', marginBottom: 6 },
    amount: { color: t.text.primary, fontSize: fonts.xl, fontWeight: fonts.semibold },
    token: { color: t.text.secondary, fontSize: fonts.md, marginLeft: 4 },
    description: { color: t.text.muted, fontSize: fonts.sm, marginBottom: 10 },
    statusRow: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', marginBottom: 8 },
    statusBadge: { paddingHorizontal: 10, paddingVertical: 4, borderRadius: 8 },
    statusText: { fontSize: fonts.sm, fontWeight: fonts.bold },
    confirmText: { color: t.text.muted, fontSize: fonts.sm },
    hashRow: { flexDirection: 'row', alignItems: 'center', gap: 8 },
    hashLabel: { color: t.text.muted, fontSize: fonts.xs },
    hashValue: { color: t.accent.blue, fontSize: fonts.xs, fontFamily: 'monospace' as const },
    etaText: { color: t.text.muted, fontSize: fonts.sm, marginTop: 4 },
    ...
    sectionHeader: { color: t.text.secondary, fontSize: fonts.sm, fontWeight: fonts.bold, textTransform: 'uppercase', letterSpacing: 1, marginLeft: 20, marginBottom: 8, marginTop: 8 },
  }), [t]);
