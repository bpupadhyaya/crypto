...
export function CommunityGoalsScreen({ onClose }: Props) {
  ...
  const s = useMemo(() => StyleSheet.create({
    ...
    goalDesc: { color: t.text.muted, fontSize: fonts.sm, lineHeight: 19, marginTop: 6 },
    goalMeta: { color: t.text.muted, fontSize: fonts.sm, marginTop: 8 },
    ...
    currentText: { color: t.accent.green, fontSize: fonts.md, fontWeight: fonts.bold },
    targetText: { color: t.text.muted, fontSize: fonts.sm },
    contributorsText: { color: t.accent.blue, fontSize: fonts.sm, fontWeight: fonts.semibold, marginTop: 4 },
    deadlineText: { color: t.accent.orange, fontSize: fonts.sm, fontWeight: fonts.semibold, marginTop: 4 },
    myContribution: { color: t.accent.purple, fontSize: fonts.sm, fontWeight: fonts.semibold, marginTop: 4 },
    contributeRow: { flexDirection: 'row', alignItems: 'center', marginTop: 12, gap: 8 },
    contributeInput: { flex: 1, backgroundColor: t.bg.primary, borderRadius: 10, padding: 10, color: t.text.primary, fontSize: fonts.md },
    contributeBtn: { backgroundColor: t.accent.green, paddingHorizontal: 16, paddingVertical: 10, borderRadius: 10 },
    contributeText: { color: '#fff', fontSize: fonts.sm, fontWeight: fonts.semibold },
    achievedBanner: { backgroundColor: t.accent.green + '20', borderRadius: 10, padding: 10, marginTop: 8, alignItems: 'center' },
    achievedText: { color: t.accent.green, fontSize: fonts.sm, fontWeight: fonts.bold },
    achievedDate: { color: t.accent.green, fontSize: fonts.xs, marginTop: 2 },
    celebrationText: { color: t.text.primary, fontSize: fonts.xxl, textAlign: 'center', marginTop: 4 },
    ...
    categoryTag: { color: t.accent.purple, fontSize: fonts.sm, fontWeight: fonts.semibold, marginTop: 4 },
  }), [t]);
