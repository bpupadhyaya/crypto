...
export function CommunityGoalsScreen({ onClose }: Props) {
  ...
  const s = useMemo(() => StyleSheet.create({
    ...
    currentText: { color: t.accent.green, fontSize: 14, fontWeight: '700' },
    targetText: { color: t.text.muted, fontSize: 12 },
    contributorsText: { color: t.accent.blue, fontSize: 12, fontWeight: '600', marginTop: 4 },
    deadlineText: { color: t.accent.orange, fontSize: 12, fontWeight: '600', marginTop: 4 },
    myContribution: { color: t.accent.purple, fontSize: 12, fontWeight: '600', marginTop: 4 },
    ...
    contributeText: { color: '#fff', fontSize: 13, fontWeight: '600' },
    achievedBanner: { backgroundColor: t.accent.green + '20', borderRadius: 10, padding: 10, marginTop: 8, alignItems: 'center' },
    achievedText: { color: t.accent.green, fontSize: 13, fontWeight: '700' },
    ...
    categoryTag: { color: t.accent.purple, fontSize: 12, fontWeight: '600', marginTop: 4 },
  }), [t]);
