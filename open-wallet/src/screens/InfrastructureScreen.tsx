...
export function InfrastructureScreen({ onClose }: Props) {
  ...
  const st = useMemo(() => StyleSheet.create({
    ...
    categoryIconText: { fontSize: fonts.xl },
    categoryLabel: { color: t.text.primary, fontSize: fonts.md, fontWeight: fonts.semibold, flex: 1 },
    ...
    statusLabel: { fontSize: fonts.xxs, marginTop: 2 },
    divider: { height: 1, backgroundColor: t.border, marginVertical: 8 },
    issueTitle: { color: t.text.primary, fontSize: fonts.md, fontWeight: fonts.bold, marginBottom: 2 },
    issueDesc: { color: t.text.muted, fontSize: fonts.sm, lineHeight: 17, marginBottom: 4 },
    issueLocation: { color: t.text.secondary, fontSize: fonts.xs },
    ...
    reportOptionText: { color: t.text.primary, fontSize: fonts.md, fontWeight: fonts.semibold },
    reportOptionIcon: { fontSize: fonts.xxl },
    ...
    confirmText: { color: t.text.primary, fontSize: fonts.md, fontWeight: fonts.semibold, textAlign: 'center', marginTop: 8 },
    confirmSub: { color: t.text.muted, fontSize: fonts.sm, textAlign: 'center', marginTop: 4 },
    scheduleDate: { color: t.accent.blue, fontSize: fonts.md, fontWeight: fonts.bold, marginBottom: 2 },
    scheduleDuration: { color: t.text.secondary, fontSize: fonts.sm, marginBottom: 4 },
    scheduleImpact: { color: t.text.muted, fontSize: fonts.xs, lineHeight: 16 },
      ...
      {CATEGORIES.map(cat => (
        <View key={cat.id} style={st.card}>
          <View style={st.row}>
            ...
            <Text style={[st.val, { color: scoreColor(cat.score), fontSize: fonts.lg, fontWeight: fonts.heavy }]}>{cat.score}</Text>
          </View>
