...
export function DanceScreen({ onClose }: Props) {
  ...
  const s = useMemo(() => StyleSheet.create({
    ...
    classTitle: { color: t.text.primary, fontSize: fonts.md, fontWeight: fonts.bold },
    classMeta: { color: t.text.muted, fontSize: fonts.sm, marginTop: 4 },
    classFooter: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', marginTop: 10 },
    classEotk: { color: t.accent.green, fontSize: fonts.md, fontWeight: fonts.bold },
    classJoinBtn: { backgroundColor: t.accent.blue, paddingHorizontal: 16, paddingVertical: 8, borderRadius: 10 },
    classJoinText: { color: '#fff', fontSize: fonts.sm, fontWeight: fonts.semibold },
    levelBadge: { paddingHorizontal: 10, paddingVertical: 3, borderRadius: 8, alignSelf: 'flex-start', marginTop: 6 },
    levelText: { color: '#fff', fontSize: fonts.xs, fontWeight: fonts.bold, textTransform: 'uppercase' },
    spotsText: { color: t.text.muted, fontSize: fonts.xs, marginTop: 4 },
    // Styles directory
    ...
    styleIconText: { color: t.accent.green, fontSize: fonts.md, fontWeight: fonts.bold },
    styleInfo: { flex: 1 },
    styleName: { color: t.text.primary, fontSize: fonts.md, fontWeight: fonts.semibold },
    styleMeta: { color: t.text.muted, fontSize: fonts.sm, marginTop: 2 },
    // Events
    ...
    eventType: { color: t.accent.blue, fontSize: fonts.xs, fontWeight: fonts.bold, textTransform: 'uppercase', marginTop: 2 },
    eventMeta: { color: t.text.muted, fontSize: fonts.sm, marginTop: 4 },
    eventDesc: { color: t.text.secondary, fontSize: fonts.sm, marginTop: 8, lineHeight: 19 },
    ...
    eventEotk: { color: t.accent.green, fontSize: fonts.md, fontWeight: fonts.bold },
    eventRsvp: { backgroundColor: t.accent.green, paddingHorizontal: 16, paddingVertical: 8, borderRadius: 10 },
    eventRsvpText: { color: '#fff', fontSize: fonts.sm, fontWeight: fonts.semibold },
    // Preserve
    preserveCard: { backgroundColor: t.bg.secondary, borderRadius: 14, padding: 16, marginHorizontal: 20, marginBottom: 12 },
    preserveName: { color: t.text.primary, fontSize: fonts.md, fontWeight: fonts.bold },
    preserveRegion: { color: t.accent.blue, fontSize: fonts.sm, fontWeight: fonts.semibold, marginTop: 2 },
    preserveMeta: { color: t.text.muted, fontSize: fonts.sm, marginTop: 4 },
    preserveStats: { flexDirection: 'row', justifyContent: 'space-between', marginTop: 10 },
    preserveEotk: { color: t.accent.green, fontSize: fonts.md, fontWeight: fonts.bold },
    preserveViews: { color: t.text.muted, fontSize: fonts.sm },
    ...
    documentBtnText: { color: '#fff', fontSize: fonts.md, fontWeight: fonts.bold },
    // Partners
    ...
    partnerLevel: { fontSize: fonts.xs, fontWeight: fonts.bold, textTransform: 'uppercase', marginTop: 2 },
    partnerMeta: { color: t.text.muted, fontSize: fonts.sm, marginTop: 4 },
    partnerStyles: { color: t.text.secondary, fontSize: fonts.sm, marginTop: 2 },
    partnerFooter: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', marginTop: 10 },
    partnerRating: { color: t.accent.orange, fontSize: fonts.md, fontWeight: fonts.bold },
    partnerConnect: { backgroundColor: t.accent.blue, paddingHorizontal: 16, paddingVertical: 8, borderRadius: 10 },
    partnerConnectText: { color: '#fff', fontSize: fonts.sm, fontWeight: fonts.semibold },
    // Demo
