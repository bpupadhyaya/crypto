...
export function DanceScreen({ onClose }: Props) {
  ...
  const s = useMemo(() => StyleSheet.create({
    ...
    classTitle: { color: t.text.primary, fontSize: 15, fontWeight: '700' },
    ...
    styleIconText: { color: t.accent.green, fontSize: 14, fontWeight: '700' },
    styleInfo: { flex: 1 },
    styleName: { color: t.text.primary, fontSize: 14, fontWeight: '600' },
    ...
    eventType: { color: t.accent.blue, fontSize: 11, fontWeight: '700', textTransform: 'uppercase', marginTop: 2 },
    ...
    eventEotk: { color: t.accent.green, fontSize: 14, fontWeight: '700' },
    eventRsvp: { backgroundColor: t.accent.green, paddingHorizontal: 16, paddingVertical: 8, borderRadius: 10 },
    eventRsvpText: { color: '#fff', fontSize: 13, fontWeight: '600' },
    // Preserve
    preserveCard: { backgroundColor: t.bg.secondary, borderRadius: 14, padding: 16, marginHorizontal: 20, marginBottom: 12 },
    preserveName: { color: t.text.primary, fontSize: 15, fontWeight: '700' },
    preserveRegion: { color: t.accent.blue, fontSize: 12, fontWeight: '600', marginTop: 2 },
    ...
    preserveEotk: { color: t.accent.green, fontSize: 14, fontWeight: '700' },
    ...
    partnerName: { color: t.text.primary, fontSize: 15, fontWeight: '700' },
    partnerLevel: { fontSize: 11, fontWeight: '700', textTransform: 'uppercase', marginTop: 2 },
    ...
    partnerRating: { color: t.accent.orange, fontSize: 14, fontWeight: '700' },
    partnerConnect: { backgroundColor: t.accent.blue, paddingHorizontal: 16, paddingVertical: 8, borderRadius: 10 },
    partnerConnectText: { color: '#fff', fontSize: 13, fontWeight: '600' },
    // Demo
