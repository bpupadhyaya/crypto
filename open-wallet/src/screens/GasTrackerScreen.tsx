...
export function GasTrackerScreen({ onClose }: Props) {
  ...
  const st = useMemo(() => StyleSheet.create({
    ...
    summaryValue: { color: t.text.primary, fontSize: 28, fontWeight: fonts.bold },
    ...
    feeValue: { color: t.text.primary, fontSize: 15, fontWeight: fonts.semibold },
    trendUp: { color: t.accent.red, fontSize: 13, fontWeight: fonts.semibold },
    trendDown: { color: t.accent.green, fontSize: 13, fontWeight: fonts.semibold },
    trendStable: { color: t.text.muted, fontSize: 13, fontWeight: fonts.semibold },
    ...
    speedValue: { color: t.text.secondary, fontSize: 13, fontWeight: fonts.semibold },
    ...
    tipSaving: { color: t.accent.green, fontSize: 13, fontWeight: fonts.bold, marginTop: 4 },
