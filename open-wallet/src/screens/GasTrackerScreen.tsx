...
export function GasTrackerScreen({ onClose }: Props) {
  ...
  const st = useMemo(() => StyleSheet.create({
    ...
    summaryValue: { color: t.text.primary, fontSize: fonts.xxxl, fontWeight: fonts.bold },
    summaryLabel: { color: t.text.muted, fontSize: fonts.sm, marginTop: 4 },
    row: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center' },
    chainName: { color: t.text.primary, fontSize: fonts.lg, fontWeight: fonts.bold },
    chainSymbol: { color: t.text.muted, fontSize: fonts.sm },
    feeValue: { color: t.text.primary, fontSize: fonts.md, fontWeight: fonts.semibold },
    trendUp: { color: t.accent.red, fontSize: fonts.sm, fontWeight: fonts.semibold },
    trendDown: { color: t.accent.green, fontSize: fonts.sm, fontWeight: fonts.semibold },
    trendStable: { color: t.text.muted, fontSize: fonts.sm, fontWeight: fonts.semibold },
    ...
    speedLabel: { color: t.text.muted, fontSize: fonts.xs, marginBottom: 4 },
    speedValue: { color: t.text.secondary, fontSize: fonts.sm, fontWeight: fonts.semibold },
    infoRow: { flexDirection: 'row', justifyContent: 'space-between', marginTop: 8 },
    infoLabel: { color: t.text.muted, fontSize: fonts.sm },
    infoValue: { color: t.text.secondary, fontSize: fonts.sm },
    tipCard: { backgroundColor: t.bg.card, borderRadius: 12, padding: 14, marginBottom: 8 },
    tipText: { color: t.text.secondary, fontSize: fonts.md, lineHeight: 20 },
    tipSaving: { color: t.accent.green, fontSize: fonts.sm, fontWeight: fonts.bold, marginTop: 4 },
