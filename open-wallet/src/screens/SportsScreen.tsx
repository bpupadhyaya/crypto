...
export function SportsScreen({ onClose }: Props) {
  ...
  const s = useMemo(() => StyleSheet.create({
    ...
    leagueName: { color: t.text.primary, fontSize: 16, fontWeight: fonts.bold, flex: 1 },
    leagueSport: { color: t.accent.green, fontSize: 13, fontWeight: fonts.bold },
    leagueMeta: { color: t.text.muted, fontSize: 13, marginBottom: 4 },
    ...
    spotsText: { fontSize: 11, fontWeight: fonts.bold },
    ...
    groupName: { color: t.text.primary, fontSize: 16, fontWeight: fonts.bold, marginBottom: 4 },
    groupActivity: { color: t.accent.blue, fontSize: 13, fontWeight: fonts.semibold, marginBottom: 8 },
    groupMeta: { color: t.text.muted, fontSize: 13, marginBottom: 4 },
    // Activity log
    ...
    activitySteps: { color: t.text.muted, fontSize: 11, marginTop: 2 },
    ...
    logBtnText: { color: '#fff', fontSize: 15, fontWeight: fonts.bold },
    // Challenges
    challengeCard: { backgroundColor: t.accent.orange + '12', borderRadius: 16, padding: 20, marginHorizontal: 20, marginBottom: 16 },
    challengeTitle: { color: t.text.primary, fontSize: 16, fontWeight: fonts.bold, marginBottom: 4 },
    challengeDesc: { color: t.text.muted, fontSize: 13, lineHeight: 20, marginBottom: 12 },
    challengeMeta: { color: t.text.secondary, fontSize: 12, marginBottom: 4 },
    ...
    progressText: { color: t.accent.orange, fontSize: 13, fontWeight: fonts.bold, textAlign: 'center', marginTop: 4 },
    challengeBtn: { backgroundColor: t.accent.orange, borderRadius: 12, paddingVertical: 10, alignItems: 'center', marginTop: 8 },
    challengeBtnText: { color: '#fff', fontSize: 14, fontWeight: fonts.bold },
    // Facilities
    ...
    facilityName: { color: t.text.primary, fontSize: 15, fontWeight: fonts.bold },
    facilityDistance: { color: t.accent.blue, fontSize: 13, fontWeight: fonts.semibold },
    facilityType: { color: t.text.secondary, fontSize: 12, marginBottom: 8 },
    facilityMeta: { color: t.text.muted, fontSize: 13, marginBottom: 4 },
    ...
    freeTagText: { color: t.accent.green, fontSize: 11, fontWeight: fonts.bold },
    // Misc
    ...
    <>
      ...
      <View style={s.statsCard}>
        ...
        <View style={{ alignItems: 'center', marginTop: 12 }}>
          <Text style={[s.statValue, { color: t.accent.green, fontSize: 24 }]}>+{weeklyStats.totalHOTK} hOTK</Text>
