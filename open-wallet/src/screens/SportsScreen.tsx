...
export function SportsScreen({ onClose }: Props) {
  ...
  const s = useMemo(() => StyleSheet.create({
    ...
    leagueName: { color: t.text.primary, fontSize: 16, fontWeight: '700', flex: 1 },
    leagueSport: { color: t.accent.green, fontSize: 13, fontWeight: '700' },
    ...
    groupName: { color: t.text.primary, fontSize: 16, fontWeight: '700', marginBottom: 4 },
    groupActivity: { color: t.accent.blue, fontSize: 13, fontWeight: '600', marginBottom: 8 },
    ...
    activityIconText: { color: t.accent.green, fontSize: 14, fontWeight: '700' },
    activityInfo: { flex: 1 },
    ...
    activityHotk: { color: t.accent.green, fontSize: 14, fontWeight: '700' },
    ...
    challengeTitle: { color: t.text.primary, fontSize: 16, fontWeight: '700', marginBottom: 4 },
    ...
    progressText: { color: t.accent.orange, fontSize: 13, fontWeight: '700', textAlign: 'center', marginTop: 4 },
    ...
    facilityName: { color: t.text.primary, fontSize: 15, fontWeight: '700' },
    facilityDistance: { color: t.accent.blue, fontSize: 13, fontWeight: '600' },
    ...
    freeTagText: { color: t.accent.green, fontSize: 11, fontWeight: '700' },
    // Misc
