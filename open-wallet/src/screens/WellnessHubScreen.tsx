...
export function WellnessHubScreen({ onClose }: Props) {
  ...
  const s = useMemo(() => StyleSheet.create({
    ...
    scoreBand: { color: t.text.primary, fontSize: 16, fontWeight: '700' },
    ...
    categoryScore: { fontSize: 16, fontWeight: '800' },
    ...
    todayValue: { color: t.text.primary, fontSize: 14, fontWeight: '700', textAlign: 'center' },
    ...
    quickLabel: { color: t.text.primary, fontSize: 12, fontWeight: '600', textAlign: 'center' },
    ...
    goalTitle: { color: t.text.primary, fontSize: 14, fontWeight: '700', flex: 1 },
    goalStreak: { color: t.accent.orange, fontSize: 12, fontWeight: '700' },
    ...
    weeklyValue: { color: t.text.primary, fontSize: 13, fontWeight: '700' },
    weeklyTrend: { flexDirection: 'row', alignItems: 'center', justifyContent: 'center', marginTop: 8, gap: 6 },
    weeklyTrendIcon: { fontSize: 20 },
    weeklyTrendText: { color: t.accent.green, fontSize: 14, fontWeight: '700' },
  }), [t]);
