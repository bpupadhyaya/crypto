...
export function WellnessHubScreen({ onClose }: Props) {
  ...
  const s = useMemo(() => StyleSheet.create({
    ...
    scoreValue: { fontSize: 36, fontWeight: fonts.heavy },
    scoreBand: { color: t.text.primary, fontSize: 16, fontWeight: fonts.bold },
    scoreSubtitle: { color: t.text.muted, fontSize: 13, marginTop: 4 },
    ...
    categoryScore: { fontSize: 16, fontWeight: fonts.heavy },
    categoryLabel: { color: t.text.muted, fontSize: 10, marginTop: 2 },
    ...
    todayValue: { color: t.text.primary, fontSize: 14, fontWeight: fonts.bold, textAlign: 'center' },
    todayLabel: { color: t.text.muted, fontSize: 10, marginTop: 2, textAlign: 'center' },
    ...
    quickLabel: { color: t.text.primary, fontSize: 12, fontWeight: fonts.semibold, textAlign: 'center' },
    ...
    goalTitle: { color: t.text.primary, fontSize: 14, fontWeight: fonts.bold, flex: 1 },
    goalStreak: { color: t.accent.orange, fontSize: 12, fontWeight: fonts.bold },
    ...
    goalTarget: { color: t.text.muted, fontSize: 11, marginTop: 6 },
    ...
    weeklyLabel: { color: t.text.muted, fontSize: 13 },
    weeklyValue: { color: t.text.primary, fontSize: 13, fontWeight: fonts.bold },
    weeklyTrend: { flexDirection: 'row', alignItems: 'center', justifyContent: 'center', marginTop: 8, gap: 6 },
    weeklyTrendIcon: { fontSize: 20 },
    weeklyTrendText: { color: t.accent.green, fontSize: 14, fontWeight: fonts.bold },
  }), [t]);
