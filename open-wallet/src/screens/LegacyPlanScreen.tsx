...
export function LegacyPlanScreen({ onClose }: Props) {
  ...
  const styles = useMemo(() => StyleSheet.create({
    ...
    label: { fontSize: fonts.sm, color: t.text.secondary, marginBottom: 2 },
    ...
    badgeText: { fontSize: fonts.xs, fontWeight: fonts.semibold, color: '#fff' },
    assetChip: {
      paddingHorizontal: 8, paddingVertical: 3, borderRadius: 6,
      backgroundColor: t.bg.primary, marginRight: 6, marginBottom: 4,
    },
    assetText: { fontSize: fonts.xs, color: t.text.primary },
    ...
    lockText: { fontSize: fonts.sm, color: '#92400e', lineHeight: 18 },
    infoText: { fontSize: fonts.sm, color: t.text.secondary, lineHeight: 20, marginTop: 4 },
    triggerBadge: {
      paddingHorizontal: 6, paddingVertical: 2, borderRadius: 4,
      backgroundColor: t.bg.primary, marginTop: 4, alignSelf: 'flex-start',
    },
    triggerText: { fontSize: fonts.xs, color: t.text.secondary, fontWeight: fonts.semibold },
    switchRow: {
