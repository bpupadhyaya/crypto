...
export function DigitalLiteracyScreen({ onClose }: Props) {
  ...
  const s = useMemo(() => StyleSheet.create({
    ...
    muted: { color: t.text.muted, fontSize: fonts.xs },
    ...
    levelChipText: { fontSize: fonts.sm, fontWeight: fonts.bold },
    // Age track
    ...
    ageChipText: { color: t.text.secondary, fontSize: fonts.sm, fontWeight: fonts.semibold },
    ...
    lessonIcon: { fontSize: fonts.xxxl, marginRight: 12 },
    lessonInfo: { flex: 1 },
    lessonTitle: { color: t.text.primary, fontSize: fonts.md, fontWeight: fonts.bold },
    lessonDesc: { color: t.text.muted, fontSize: fonts.sm, marginTop: 2 },
    ...
    completedBadge: { color: t.accent.green, fontSize: fonts.xs, fontWeight: fonts.bold, marginTop: 4 },
    // Tutorials
    ...
    tutorialIcon: { fontSize: fonts.xxxl, marginRight: 12 },
    tutorialTitle: { color: t.text.primary, fontSize: fonts.md, fontWeight: fonts.bold, flex: 1 },
    tutorialMeta: { color: t.text.muted, fontSize: fonts.xs, marginTop: 4 },
    stepItem: { flexDirection: 'row', alignItems: 'flex-start', paddingVertical: 8, paddingLeft: 8 },
    stepNumber: { color: t.accent.blue, fontSize: fonts.md, fontWeight: fonts.heavy, marginRight: 10, width: 22 },
    stepText: { color: t.text.secondary, fontSize: fonts.sm, flex: 1 },
    expandArrow: { color: t.text.muted, fontSize: fonts.lg },
    // Safety
    ...
    safetyIcon: { fontSize: fonts.xxxl, marginRight: 12 },
    safetyTitle: { color: t.text.primary, fontSize: fonts.md, fontWeight: fonts.bold, flex: 1 },
    safetyDesc: { color: t.text.muted, fontSize: fonts.sm, marginTop: 4 },
    severityTag: { paddingHorizontal: 8, paddingVertical: 2, borderRadius: 6, marginTop: 8, alignSelf: 'flex-start' },
    severityText: { fontSize: fonts.xs, fontWeight: fonts.bold, textTransform: 'uppercase', letterSpacing: 0.5 },
    tipItem: { flexDirection: 'row', paddingVertical: 6, paddingLeft: 8 },
    tipBullet: { color: t.accent.blue, fontSize: fonts.md, marginRight: 8 },
    tipText: { color: t.text.secondary, fontSize: fonts.sm, flex: 1, lineHeight: 18 },
    // Tutors
    tutorCard: { backgroundColor: t.bg.card, borderRadius: 16, padding: 16, marginBottom: 12 },
    tutorName: { color: t.text.primary, fontSize: fonts.md, fontWeight: fonts.bold },
    tutorUid: { color: t.text.muted, fontSize: fonts.xs, marginTop: 2 },
    tutorSpecialties: { color: t.text.secondary, fontSize: fonts.sm, marginTop: 6 },
    tutorStats: { flexDirection: 'row', justifyContent: 'space-between', marginTop: 10 },
    tutorStat: { alignItems: 'center' },
    tutorStatValue: { color: t.text.primary, fontSize: fonts.lg, fontWeight: fonts.heavy },
    tutorStatLabel: { color: t.text.muted, fontSize: fonts.xs, marginTop: 2 },
    ...
    connectBtnText: { color: t.bg.primary, fontSize: fonts.md, fontWeight: fonts.bold },
    // Progress / Badges
    badgeGrid: { flexDirection: 'row', flexWrap: 'wrap', gap: 12, marginTop: 8 },
    badgeItem: { width: 80, alignItems: 'center', padding: 8 },
    badgeIcon: { fontSize: fonts.hero, marginBottom: 4 },
    badgeName: { color: t.text.primary, fontSize: fonts.xs, fontWeight: fonts.semibold, textAlign: 'center' },
    badgeDate: { color: t.text.muted, fontSize: fonts.xs, marginTop: 2 },
    badgeLocked: { opacity: 0.35 },
    overallCard: { backgroundColor: t.bg.card, borderRadius: 16, padding: 20, marginBottom: 16 },
    overallTitle: { color: t.text.primary, fontSize: fonts.lg, fontWeight: fonts.heavy, marginBottom: 12, textAlign: 'center' },
    ...
    bigProgressText: { color: t.text.primary, fontSize: fonts.xxl, fontWeight: fonts.heavy, textAlign: 'center' },
    bigProgressLabel: { color: t.text.muted, fontSize: fonts.sm, textAlign: 'center', marginTop: 2 },
    levelProgress: { backgroundColor: t.bg.card, borderRadius: 14, padding: 14, marginBottom: 10 },
    levelName: { color: t.text.primary, fontSize: fonts.md, fontWeight: fonts.bold },
    levelDetail: { color: t.text.muted, fontSize: fonts.sm, marginTop: 4 },
  }), [t]);
