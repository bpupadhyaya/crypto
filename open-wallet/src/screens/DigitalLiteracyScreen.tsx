...
export function DigitalLiteracyScreen({ onClose }: Props) {
  ...
  const s = useMemo(() => StyleSheet.create({
    ...
    levelChipText: { fontSize: 12, fontWeight: fonts.bold },
    // Age track
    ...
    ageChipText: { color: t.text.secondary, fontSize: 12, fontWeight: fonts.semibold },
    ...
    lessonInfo: { flex: 1 },
    lessonTitle: { color: t.text.primary, fontSize: 14, fontWeight: fonts.bold },
    ...
    completedBadge: { color: t.accent.green, fontSize: 11, fontWeight: fonts.bold, marginTop: 4 },
    // Tutorials
    ...
    tutorialTitle: { color: t.text.primary, fontSize: 14, fontWeight: fonts.bold, flex: 1 },
    ...
    stepNumber: { color: t.accent.blue, fontSize: 14, fontWeight: fonts.heavy, marginRight: 10, width: 22 },
    ...
    safetyTitle: { color: t.text.primary, fontSize: 14, fontWeight: fonts.bold, flex: 1 },
    ...
    severityText: { fontSize: 10, fontWeight: fonts.bold, textTransform: 'uppercase', letterSpacing: 0.5 },
    ...
    tutorName: { color: t.text.primary, fontSize: 15, fontWeight: fonts.bold },
    ...
    tutorStatValue: { color: t.text.primary, fontSize: 16, fontWeight: fonts.heavy },
    ...
    availableText: { fontSize: 11, fontWeight: fonts.bold },
    connectBtn: { backgroundColor: t.accent.blue, borderRadius: 10, paddingVertical: 10, alignItems: 'center', marginTop: 10 },
    connectBtnText: { color: t.bg.primary, fontSize: 14, fontWeight: fonts.bold },
    // Progress / Badges
    ...
    badgeName: { color: t.text.primary, fontSize: 11, fontWeight: fonts.semibold, textAlign: 'center' },
    ...
    overallTitle: { color: t.text.primary, fontSize: 16, fontWeight: fonts.heavy, marginBottom: 12, textAlign: 'center' },
    ...
    bigProgressText: { color: t.text.primary, fontSize: 24, fontWeight: fonts.heavy, textAlign: 'center' },
    ...
    levelName: { color: t.text.primary, fontSize: 14, fontWeight: fonts.bold },
