...
export function MentalWellnessScreen({ onClose }: Props) {
  ...
  const s = useMemo(() => StyleSheet.create({
    ...
    moodLabel: { color: t.text.muted, fontSize: 10, fontWeight: '600' },
    ...
    secondaryBtnText: { color: t.accent.red, fontSize: 16, fontWeight: '700' },
    ...
    listenerInfo: { flex: 1 },
    listenerName: { color: t.text.primary, fontSize: 15, fontWeight: '700' },
    ...
    crisisRegion: { color: t.accent.red, fontSize: 11, fontWeight: '700', textTransform: 'uppercase', letterSpacing: 1 },
    crisisName: { color: t.text.primary, fontSize: 15, fontWeight: '700', marginTop: 4 },
    crisisNumber: { color: t.accent.blue, fontSize: 18, fontWeight: '800', marginTop: 4 },
    ...
    circleName: { color: t.text.primary, fontSize: 16, fontWeight: '700', flex: 1 },
    ...
    exerciseTitle: { color: t.text.primary, fontSize: 15, fontWeight: '700', flex: 1 },
    ...
    exerciseStepNum: { color: t.accent.purple, fontSize: 13, fontWeight: '700' },
    ...
    eventInfo: { flex: 1 },
    eventTitle: { color: t.text.primary, fontSize: 14, fontWeight: '700' },
