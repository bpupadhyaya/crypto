...
export function IncidentReportScreen({ onClose }: Props) {
  ...
  const s = useMemo(() => StyleSheet.create({
    ...
    severityChipText: { fontSize: 13, fontWeight: fonts.semibold },
    anonymousRow: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', marginBottom: 16 },
    anonymousLabel: { color: t.text.primary, fontSize: 15, fontWeight: fonts.semibold },
    ...
    reportType: { color: t.text.primary, fontSize: 14, fontWeight: fonts.bold },
    ...
    reportResolution: { color: t.accent.green, fontSize: 13, fontWeight: fonts.semibold, marginTop: 6, lineHeight: 20 },
    ...
    anonymousTagText: { color: t.accent.orange, fontSize: 10, fontWeight: fonts.bold },
    ...
    trendingTitle: { color: t.accent.orange, fontSize: 14, fontWeight: fonts.bold, marginBottom: 8 },
