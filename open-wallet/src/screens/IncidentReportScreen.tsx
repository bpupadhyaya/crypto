...
export function IncidentReportScreen({ onClose }: Props) {
  ...
  const s = useMemo(() => StyleSheet.create({
    ...
    severityChipText: { fontSize: 13, fontWeight: '600' },
    anonymousRow: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', marginBottom: 16 },
    anonymousLabel: { color: t.text.primary, fontSize: 15, fontWeight: '600' },
    anonymousHint: { color: t.text.muted, fontSize: 12, marginTop: 2 },
    ...
    reportType: { color: t.text.primary, fontSize: 14, fontWeight: '700' },
    statusBadge: { paddingHorizontal: 10, paddingVertical: 4, borderRadius: 10 },
    statusText: { color: '#fff', fontSize: 11, fontWeight: '700', textTransform: 'uppercase' },
    reportDesc: { color: t.text.primary, fontSize: 13, marginTop: 6, lineHeight: 20 },
    reportMeta: { color: t.text.muted, fontSize: 12, marginTop: 4 },
    reportLocation: { color: t.text.muted, fontSize: 12, marginTop: 2 },
    reportResolution: { color: t.accent.green, fontSize: 13, fontWeight: '600', marginTop: 6, lineHeight: 20 },
    ...
    statusStepLabel: { color: t.text.muted, fontSize: 9, textAlign: 'center', marginTop: 4 },
    ...
    photoHash: { color: t.text.muted, fontSize: 11, fontFamily: 'monospace', marginTop: 4 },
    ...
    anonymousTagText: { color: t.accent.orange, fontSize: 10, fontWeight: '700' },
    ...
    communityStatValue: { color: t.text.primary, fontSize: 14, fontWeight: '700' },
    ...
    trendingTitle: { color: t.accent.orange, fontSize: 14, fontWeight: '700', marginBottom: 8 },
    trendingText: { color: t.text.primary, fontSize: 14, lineHeight: 20 },
  ...
  const renderStats = () => (
    <>
      ...
      <View style={s.card}>
        ...
        <Text style={[s.statValue, { textAlign: 'center', fontSize: 36 }]}>{communityStats.resolutionRate}%</Text>
