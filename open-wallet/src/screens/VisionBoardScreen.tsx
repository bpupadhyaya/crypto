...
export function VisionBoardScreen({ onClose }: Props) {
  ...
  const s = useMemo(() => StyleSheet.create({
    ...
    categoryLabel: { color: t.text.secondary, fontSize: fonts.sm, fontWeight: fonts.semibold },
    categoryLabelActive: { color: '#fff' },
    goalTitle: { color: t.text.primary, fontSize: fonts.lg, fontWeight: fonts.bold },
    goalDesc: { color: t.text.muted, fontSize: fonts.sm, marginTop: 4, lineHeight: 19 },
    ...
    goalCategoryText: { fontSize: fonts.xs, fontWeight: fonts.bold },
    goalDate: { color: t.text.muted, fontSize: fonts.sm },
    progressBar: { height: 8, borderRadius: 4, backgroundColor: t.bg.primary, marginTop: 12 },
    progressFill: { height: 8, borderRadius: 4 },
    progressText: { color: t.text.secondary, fontSize: fonts.sm, fontWeight: fonts.semibold, marginTop: 6, textAlign: 'right' },
    ...
    milestoneCheckMark: { color: '#fff', fontSize: fonts.sm, fontWeight: fonts.heavy },
    milestoneTitle: { color: t.text.primary, fontSize: fonts.md, flex: 1 },
    ...
    completedBadgeText: { color: t.accent.green, fontSize: fonts.sm, fontWeight: fonts.bold },
    ...
    voteCount: { color: t.text.secondary, fontSize: fonts.md, fontWeight: fonts.bold },
    supporterCount: { color: t.text.muted, fontSize: fonts.sm, marginTop: 4 },
    communityAuthor: { color: t.accent.blue, fontSize: fonts.sm, fontWeight: fonts.semibold, marginTop: 6 },
    ...
    celebrationTitle: { color: t.text.primary, fontSize: fonts.xxl, fontWeight: fonts.heavy, textAlign: 'center' },
    celebrationSubtitle: { color: t.text.muted, fontSize: fonts.md, textAlign: 'center', marginTop: 8, lineHeight: 20 },
    celebrationBtn: { backgroundColor: t.accent.purple, borderRadius: 14, paddingVertical: 14, paddingHorizontal: 32, marginTop: 20 },
    celebrationBtnText: { color: '#fff', fontSize: fonts.lg, fontWeight: fonts.bold },
    ...
    sharedBadgeText: { color: t.accent.blue, fontSize: fonts.xs, fontWeight: fonts.bold },
    ...
    inspireQuote: { color: t.text.primary, fontSize: fonts.md, fontStyle: 'italic', lineHeight: 22 },
    inspireAuthor: { color: t.text.muted, fontSize: fonts.sm, marginTop: 8 },
    inspireGoalTitle: { color: t.accent.purple, fontSize: fonts.md, fontWeight: fonts.bold, marginTop: 12 },
    inspireProgress: { color: t.text.secondary, fontSize: fonts.sm, marginTop: 4 },
  }), [t]);
