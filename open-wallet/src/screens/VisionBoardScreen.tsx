...
export function VisionBoardScreen({ onClose }: Props) {
  ...
  const s = useMemo(() => StyleSheet.create({
    ...
    categoryLabel: { color: t.text.secondary, fontSize: 12, fontWeight: '600' },
    categoryLabelActive: { color: '#fff' },
    goalTitle: { color: t.text.primary, fontSize: 16, fontWeight: '700' },
    ...
    goalCategoryText: { fontSize: 11, fontWeight: '700' },
    ...
    progressText: { color: t.text.secondary, fontSize: 12, fontWeight: '600', marginTop: 6, textAlign: 'right' },
    ...
    milestoneCheckMark: { color: '#fff', fontSize: 13, fontWeight: '800' },
    ...
    completedBadgeText: { color: t.accent.green, fontSize: 13, fontWeight: '700' },
    ...
    voteCount: { color: t.text.secondary, fontSize: 14, fontWeight: '700' },
    supporterCount: { color: t.text.muted, fontSize: 12, marginTop: 4 },
    communityAuthor: { color: t.accent.blue, fontSize: 12, fontWeight: '600', marginTop: 6 },
    ...
    celebrationTitle: { color: t.text.primary, fontSize: 22, fontWeight: '800', textAlign: 'center' },
    ...
    sharedBadgeText: { color: t.accent.blue, fontSize: 11, fontWeight: '700' },
    ...
    inspireGoalTitle: { color: t.accent.purple, fontSize: 14, fontWeight: '700', marginTop: 12 },
