...
export function ZKProofScreen({ onClose }: Props) {
  ...
  const s = useMemo(() => StyleSheet.create({
    ...
    privacyTitle: { color: t.text.primary, fontSize: 15, fontWeight: '700' },
    privacyPct: { fontSize: 24, fontWeight: '900' },
    ...
    proofInfo: { flex: 1 },
    proofLabel: { color: t.text.primary, fontSize: 15, fontWeight: '700' },
    ...
    proofStatusText: { color: '#fff', fontSize: 11, fontWeight: '700', textTransform: 'uppercase' },
    ...
    proofMetaLabel: { color: t.text.muted, fontSize: 10, fontWeight: '600', textTransform: 'uppercase', letterSpacing: 0.5 },
    proofMetaValue: { color: t.text.primary, fontSize: 13, fontWeight: '700', marginTop: 2 },
    ...
    claimInfo: { flex: 1 },
    claimLabel: { color: t.text.primary, fontSize: 14, fontWeight: '700' },
    ...
    optionText: { color: t.text.primary, fontSize: 14, fontWeight: '600' },
    ...
    genTitle: { color: t.text.primary, fontSize: 18, fontWeight: '800', marginBottom: 8 },
    ...
    successTitle: { color: t.accent.green, fontSize: 18, fontWeight: '800', marginBottom: 8 },
    ...
    hashLabel: { color: t.text.muted, fontSize: 10, fontWeight: '600', textTransform: 'uppercase', letterSpacing: 1, marginBottom: 4 },
    ...
    resetBtnText: { color: t.accent.blue, fontSize: 14, fontWeight: '600' },
    // Verify
    verifyCard: { backgroundColor: t.bg.card, borderRadius: 16, padding: 20, marginBottom: 20 },
    verifyTitle: { color: t.text.primary, fontSize: 16, fontWeight: '800', marginBottom: 8 },
    ...
    historyTitle: { color: t.text.primary, fontSize: 16, fontWeight: '800', marginTop: 20, marginBottom: 12 },
    ...
    historyInfo: { flex: 1 },
    historyAction: { color: t.text.primary, fontSize: 13, fontWeight: '600' },
    historyTime: { color: t.text.muted, fontSize: 11, marginTop: 2 },
    historyCount: { color: t.accent.blue, fontSize: 13, fontWeight: '700' },
      ...
      <View style={s.verifyCard}>
        ...
        {[
          ...
          <View key={idx} style={{ flexDirection: 'row', alignItems: 'flex-start', marginBottom: idx < 3 ? 14 : 0 }}>
            ...
            <View style={{ flex: 1 }}>
              <Text style={{ color: t.text.primary, fontSize: 14, fontWeight: '700', marginBottom: 2 }}>{item.title}</Text>
