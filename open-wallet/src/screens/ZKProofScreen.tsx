...
export function ZKProofScreen({ onClose }: Props) {
  ...
  const s = useMemo(() => StyleSheet.create({
    ...
    privacyTitle: { color: t.text.primary, fontSize: fonts.md, fontWeight: fonts.bold },
    privacyPct: { fontSize: fonts.xxl, fontWeight: fonts.heavy },
    ...
    privacyLabel: { color: t.text.muted, fontSize: fonts.sm, marginTop: 8 },
    // Proof cards
    ...
    proofIcon: { fontSize: fonts.xxxl, marginRight: 12 },
    proofInfo: { flex: 1 },
    proofLabel: { color: t.text.primary, fontSize: fonts.md, fontWeight: fonts.bold },
    proofStatement: { color: t.text.secondary, fontSize: fonts.sm, marginTop: 2 },
    proofStatusBadge: { paddingHorizontal: 10, paddingVertical: 3, borderRadius: 8 },
    proofStatusText: { color: '#fff', fontSize: fonts.xs, fontWeight: fonts.bold, textTransform: 'uppercase' },
    ...
    proofMetaLabel: { color: t.text.muted, fontSize: fonts.xs, fontWeight: fonts.semibold, textTransform: 'uppercase', letterSpacing: 0.5 },
    proofMetaValue: { color: t.text.primary, fontSize: fonts.sm, fontWeight: fonts.bold, marginTop: 2 },
    proofHash: { color: t.text.muted, fontSize: fonts.xs, fontFamily: 'monospace', marginTop: 8 },
    ...
    stepDotText: { color: '#fff', fontSize: fonts.sm, fontWeight: fonts.heavy },
    ...
    sectionSubtitle: { color: t.text.secondary, fontSize: fonts.sm, lineHeight: 20, marginBottom: 16 },
    ...
    claimIcon: { fontSize: fonts.xxxl, marginRight: 14 },
    claimInfo: { flex: 1 },
    claimLabel: { color: t.text.primary, fontSize: fonts.md, fontWeight: fonts.bold },
    claimDesc: { color: t.text.muted, fontSize: fonts.sm, marginTop: 2 },
    ...
    optionText: { color: t.text.primary, fontSize: fonts.md, fontWeight: fonts.semibold },
    ...
    nextBtnText: { color: '#fff', fontSize: fonts.lg, fontWeight: fonts.bold },
    ...
    genTitle: { color: t.text.primary, fontSize: fonts.xl, fontWeight: fonts.heavy, marginBottom: 8 },
    genSubtitle: { color: t.text.secondary, fontSize: fonts.sm, textAlign: 'center', lineHeight: 20 },
    successCard: { backgroundColor: t.accent.green + '10', borderRadius: 16, padding: 24, alignItems: 'center', marginBottom: 20 },
    successIcon: { fontSize: 48, marginBottom: 12 },
    successTitle: { color: t.accent.green, fontSize: fonts.xl, fontWeight: fonts.heavy, marginBottom: 8 },
    successSubtitle: { color: t.text.secondary, fontSize: fonts.sm, textAlign: 'center', lineHeight: 20, marginBottom: 12 },
    hashBox: { backgroundColor: t.bg.card, borderRadius: 10, padding: 12, width: '100%', marginBottom: 16 },
    hashLabel: { color: t.text.muted, fontSize: fonts.xs, fontWeight: fonts.semibold, textTransform: 'uppercase', letterSpacing: 1, marginBottom: 4 },
    hashValue: { color: t.text.primary, fontSize: fonts.sm, fontFamily: 'monospace' },
    ...
    resetBtnText: { color: t.accent.blue, fontSize: fonts.md, fontWeight: fonts.semibold },
    // Verify
    verifyCard: { backgroundColor: t.bg.card, borderRadius: 16, padding: 20, marginBottom: 20 },
    verifyTitle: { color: t.text.primary, fontSize: fonts.lg, fontWeight: fonts.heavy, marginBottom: 8 },
    verifyDesc: { color: t.text.secondary, fontSize: fonts.sm, lineHeight: 20, marginBottom: 16 },
    verifyInput: { backgroundColor: t.bg.primary, borderRadius: 10, padding: 14, color: t.text.primary, fontSize: fonts.md, fontFamily: 'monospace', minHeight: 80, textAlignVertical: 'top', borderWidth: 1, borderColor: t.border },
    verifyBtn: { backgroundColor: t.accent.blue, borderRadius: 14, paddingVertical: 16, alignItems: 'center', marginTop: 12 },
    verifyBtnText: { color: '#fff', fontSize: fonts.lg, fontWeight: fonts.bold },
    resultCard: { borderRadius: 16, padding: 24, alignItems: 'center', marginBottom: 20 },
    resultIcon: { fontSize: 48, marginBottom: 12 },
    resultTitle: { fontSize: fonts.xl, fontWeight: fonts.heavy, marginBottom: 8 },
    resultSubtitle: { color: t.text.secondary, fontSize: fonts.sm, textAlign: 'center', lineHeight: 20 },
    // History section in my-proofs
    historyTitle: { color: t.text.primary, fontSize: fonts.lg, fontWeight: fonts.heavy, marginTop: 20, marginBottom: 12 },
    historyRow: { flexDirection: 'row', alignItems: 'center', backgroundColor: t.bg.card, borderRadius: 10, padding: 12, marginBottom: 8 },
    historyIcon: { fontSize: fonts.xl, marginRight: 10 },
    historyInfo: { flex: 1 },
    historyAction: { color: t.text.primary, fontSize: fonts.sm, fontWeight: fonts.semibold },
    historyTime: { color: t.text.muted, fontSize: fonts.xs, marginTop: 2 },
    historyCount: { color: t.accent.blue, fontSize: fonts.sm, fontWeight: fonts.bold },
    constitutionLink: { color: t.accent.blue, fontSize: fonts.sm, fontWeight: fonts.semibold, textAlign: 'center', marginTop: 20, marginBottom: 20 },
  }), [t]);
      ...
      <View style={s.verifyCard}>
        ...
        {[
          ...
          <View key={idx} style={{ flexDirection: 'row', alignItems: 'flex-start', marginBottom: idx < 3 ? 14 : 0 }}>
            <Text style={{ fontSize: fonts.xxl, marginRight: 12, marginTop: 2 }}>{item.icon}</Text>
            <View style={{ flex: 1 }}>
              <Text style={{ color: t.text.primary, fontSize: fonts.md, fontWeight: fonts.bold, marginBottom: 2 }}>{item.title}</Text>
              <Text style={{ color: t.text.secondary, fontSize: fonts.sm, lineHeight: 20 }}>{item.desc}</Text>
            </View>
          </View>
        ))}
      </View>
