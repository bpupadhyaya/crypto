...
export function PetWelfareScreen({ onClose }: Props) {
  ...
  const s = useMemo(() => StyleSheet.create({
    ...
    adoptName: { color: t.text.primary, fontSize: 17, fontWeight: fonts.bold },
    urgentBadge: { backgroundColor: '#FF3B30' + '20', paddingHorizontal: 10, paddingVertical: 4, borderRadius: 8 },
    urgentText: { color: '#FF3B30', fontSize: 11, fontWeight: fonts.bold },
    adoptSpecies: { color: t.accent.purple, fontSize: 13, fontWeight: fonts.semibold },
    adoptDesc: { color: t.text.muted, fontSize: 13, lineHeight: 19, marginTop: 8 },
    adoptMeta: { color: t.text.muted, fontSize: 12, marginTop: 4 },
    ...
    goodWithText: { color: t.text.secondary, fontSize: 11, fontWeight: fonts.semibold },
    adoptBtn: { backgroundColor: t.accent.purple, borderRadius: 12, paddingVertical: 12, alignItems: 'center', marginTop: 12 },
    adoptBtnText: { color: '#fff', fontSize: 14, fontWeight: fonts.bold },
    ...
    vetName: { color: t.text.primary, fontSize: 15, fontWeight: fonts.bold, flex: 1 },
    vetTypeBadge: { paddingHorizontal: 10, paddingVertical: 4, borderRadius: 8 },
    vetTypeText: { fontSize: 11, fontWeight: fonts.bold },
    vetMeta: { color: t.text.muted, fontSize: 12, marginTop: 4 },
    ...
    serviceText: { color: t.text.secondary, fontSize: 11, fontWeight: fonts.semibold },
    ratingRow: { flexDirection: 'row', alignItems: 'center', gap: 6, marginTop: 8 },
    ratingText: { color: t.accent.orange, fontSize: 14, fontWeight: fonts.bold },
    otkBadge: { backgroundColor: t.accent.green + '20', paddingHorizontal: 10, paddingVertical: 4, borderRadius: 8 },
    otkText: { color: t.accent.green, fontSize: 11, fontWeight: fonts.bold },
    sitterCard: { backgroundColor: t.bg.secondary, borderRadius: 14, padding: 16, marginHorizontal: 20, marginBottom: 12 },
    sitterName: { color: t.text.primary, fontSize: 15, fontWeight: fonts.bold },
    sitterBio: { color: t.text.muted, fontSize: 13, lineHeight: 19, marginTop: 8 },
    sitterMeta: { color: t.text.muted, fontSize: 12, marginTop: 4 },
    sitterRate: { color: t.accent.green, fontSize: 14, fontWeight: fonts.bold, marginTop: 8 },
    ...
    lostTypeText: { fontSize: 11, fontWeight: fonts.bold },
    lostDesc: { color: t.text.muted, fontSize: 13, lineHeight: 19, marginTop: 8 },
    lostMeta: { color: t.text.muted, fontSize: 12, marginTop: 4 },
    ...
    welfareBtnText: { color: '#fff', fontSize: 15, fontWeight: fonts.bold },
      ...
      {DEMO_VETS.map((vet) => (
        <View key={vet.id} style={s.vetCard}>
          ...
          <View style={s.ratingRow}>
            ...
            <Text style={{ color: t.text.muted, fontSize: 12 }}>/ 5.0</Text>
            {vet.acceptsOtk && (
