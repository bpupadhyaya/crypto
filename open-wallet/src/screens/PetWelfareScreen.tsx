...
export function PetWelfareScreen({ onClose }: Props) {
  ...
  const s = useMemo(() => StyleSheet.create({
    ...
    adoptName: { color: t.text.primary, fontSize: 17, fontWeight: '700' },
    urgentBadge: { backgroundColor: '#FF3B30' + '20', paddingHorizontal: 10, paddingVertical: 4, borderRadius: 8 },
    urgentText: { color: '#FF3B30', fontSize: 11, fontWeight: '700' },
    adoptSpecies: { color: t.accent.purple, fontSize: 13, fontWeight: '600' },
    ...
    goodWithText: { color: t.text.secondary, fontSize: 11, fontWeight: '600' },
    ...
    vetName: { color: t.text.primary, fontSize: 15, fontWeight: '700', flex: 1 },
    vetTypeBadge: { paddingHorizontal: 10, paddingVertical: 4, borderRadius: 8 },
    vetTypeText: { fontSize: 11, fontWeight: '700' },
    ...
    lostTypeText: { fontSize: 11, fontWeight: '700' },
    ...
    welfareBtnText: { color: '#fff', fontSize: 15, fontWeight: '700' },
