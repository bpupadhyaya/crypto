...
export function TokenSelector({ visible, onSelect, onClose, title, filterChain }: TokenSelectorProps) {
  ...
  const s = useMemo(() => StyleSheet.create({
    ...
    sectionTitle: {
      color: t.text.muted, fontSize: 12, fontWeight: '700',
    ...
    dotText: { color: '#fff', fontSize: 13, fontWeight: '800' },
    tokenInfo: { flex: 1 },
    tokenSymbol: { color: t.text.primary, fontSize: 16, fontWeight: '700' },
    tokenName: { color: t.text.muted, fontSize: 13, marginTop: 1 },
    tokenChainBadge: { color: t.text.muted, fontSize: 11, marginTop: 2 },
    tokenRight: { alignItems: 'flex-end' },
    tokenPrice: { color: t.text.secondary, fontSize: 14, fontWeight: '600' },
