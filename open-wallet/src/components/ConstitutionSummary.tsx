...
export function ConstitutionSummary({ initialExpanded = false, onReadFull }: Props) {
  ...
  const s = useMemo(() => StyleSheet.create({
    ...
    compactIcon: { fontSize: fonts.lg, color: '#d4a017' },
    compactText: { color: t.text.secondary, fontSize: fonts.sm, flex: 1 },
    compactBold: { color: t.text.primary, fontWeight: fonts.bold },
    expandIcon: { color: t.text.muted, fontSize: fonts.md },
    expandedCard: {
      backgroundColor: t.bg.card,
      borderRadius: 16,
      padding: 16,
    ...
    expandedTitle: { color: '#d4a017', fontSize: fonts.md, fontWeight: fonts.heavy },
    collapseBtn: { color: t.text.muted, fontSize: fonts.md },
    principleRow: { flexDirection: 'row', gap: 10, marginBottom: 12, alignItems: 'flex-start' },
    principleIcon: { fontSize: fonts.lg, marginTop: 2 },
    principleInfo: { flex: 1 },
    principleTitle: { color: t.text.primary, fontSize: fonts.sm, fontWeight: fonts.bold, marginBottom: 2 },
    principleText: { color: t.text.secondary, fontSize: fonts.sm, lineHeight: 18 },
    readBtn: { backgroundColor: '#d4a017' + '15', borderRadius: 10, paddingVertical: 10, alignItems: 'center', marginTop: 4 },
    readBtnText: { color: '#d4a017', fontSize: fonts.sm, fontWeight: fonts.bold },
  }), [t]);
