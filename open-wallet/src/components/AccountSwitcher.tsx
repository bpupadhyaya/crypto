...
const s = StyleSheet.create({
  ...
  accountName: { color: '#a0a0b0', fontSize: 13, fontWeight: fonts.semibold },
  ...
  modalTitle: { color: '#f0f0f5', fontSize: 18, fontWeight: fonts.heavy, marginBottom: 16 },
  ...
  checkmark: { color: '#22c55e', fontSize: 18, fontWeight: fonts.bold },
  ...
  addBtnText: { color: '#22c55e', fontSize: 15, fontWeight: fonts.bold },
});
