...
const s = StyleSheet.create({
  ...
  accountName: { color: '#a0a0b0', fontSize: fonts.sm, fontWeight: fonts.semibold },
  arrow: { color: '#606070', fontSize: fonts.sm },
  overlay: { flex: 1, backgroundColor: 'rgba(0,0,0,0.7)', justifyContent: 'center', alignItems: 'center' },
  modal: { backgroundColor: '#16161f', borderRadius: 20, padding: 20, width: '80%', maxWidth: 320 },
  modalTitle: { color: '#f0f0f5', fontSize: fonts.xl, fontWeight: fonts.heavy, marginBottom: 16 },
  ...
  accountRowName: { color: '#f0f0f5', fontSize: fonts.lg },
  checkmark: { color: '#22c55e', fontSize: fonts.xl, fontWeight: fonts.bold },
  addSection: { marginTop: 12, borderTopWidth: 1, borderTopColor: 'rgba(255,255,255,0.06)', paddingTop: 12 },
  addInput: { backgroundColor: '#0a0a0f', borderRadius: 12, padding: 12, color: '#f0f0f5', fontSize: fonts.md, marginBottom: 8 },
  addBtn: { backgroundColor: '#22c55e20', borderRadius: 12, paddingVertical: 12, alignItems: 'center' },
  addBtnText: { color: '#22c55e', fontSize: fonts.md, fontWeight: fonts.bold },
});
