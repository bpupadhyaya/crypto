...
const s = StyleSheet.create({
  ...
  closeBtn: { color: '#3b82f6', fontSize: fonts.lg, fontWeight: fonts.semibold },
  headerTitle: { color: '#f0f0f5', fontSize: fonts.xl, fontWeight: fonts.heavy },
  ...
  hint: { color: '#a0a0b0', fontSize: fonts.md, textAlign: 'center', marginTop: 16, marginBottom: 8 },
  title: { color: '#f0f0f5', fontSize: fonts.xxl, fontWeight: fonts.heavy, textAlign: 'center', marginTop: 100 },
  text: { color: '#a0a0b0', fontSize: fonts.md, textAlign: 'center', marginTop: 12, marginHorizontal: 40 },
  grantBtn: { backgroundColor: '#22c55e', borderRadius: 16, paddingVertical: 16, marginHorizontal: 40, marginTop: 24, alignItems: 'center' },
  grantText: { color: '#0a0a0f', fontSize: fonts.lg, fontWeight: fonts.bold },
  cancelBtn: { paddingVertical: 16, alignItems: 'center', marginTop: 8 },
  cancelText: { color: '#606070', fontSize: fonts.lg },
  ...
  rescanText: { color: '#22c55e', fontSize: fonts.md, fontWeight: fonts.bold },
});
