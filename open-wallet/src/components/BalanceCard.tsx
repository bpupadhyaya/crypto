...
const styles = StyleSheet.create({
  ...
  simpleLabel: { color: '#a0a0b0', fontSize: fonts.lg, marginBottom: 8 },
  simpleAmount: { color: '#f0f0f5', fontSize: 48, fontWeight: fonts.heavy },
  simpleHint: { color: '#606070', fontSize: fonts.md, marginTop: 8 },
  proCard: {
    backgroundColor: '#16161f',
    borderRadius: 16,
    padding: 20,
  ...
  proLabel: { color: '#a0a0b0', fontSize: fonts.sm, textTransform: 'uppercase', letterSpacing: 1 },
  proAmount: { color: '#f0f0f5', fontSize: fonts.hero, fontWeight: fonts.bold, marginTop: 4 },
  proBreakdown: {
    borderTopWidth: 1,
  ...
  proTokenSymbol: { color: '#f0f0f5', fontSize: fonts.md, fontWeight: fonts.semibold, width: 60 },
  proTokenChain: { color: '#606070', fontSize: fonts.sm, width: 80 },
  proTokenValue: { color: '#a0a0b0', fontSize: fonts.md, flex: 1, textAlign: 'right' },
  proTokenAllocation: { color: '#606070', fontSize: fonts.sm, width: 50, textAlign: 'right' },
});
